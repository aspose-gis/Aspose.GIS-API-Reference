---
title: "GdalOptions Sınıfı"
type: docs
weight: 20
url: /tr/python-net/aspose.gis.formats.gdal/gdaloptions/
---
...
| **Name** | **Description** |
| :- | :- |
| [GdalOptions(temp_directory)](#GdalOptions_temp_directory_1) | Yeni bir örnek oluştur. |
## **Properties**
...
| file_name | string | r/w | Başlatılacak uygulamanın adı |
...
| path_to_temp_file | string | r | Geçici dosyaların yolu. |
...
| :- | :- | :- |
| temp_directory | string | Geçici dosyaların yolu. Kullanıcının geçici klasörü varsayılan olarak. |
