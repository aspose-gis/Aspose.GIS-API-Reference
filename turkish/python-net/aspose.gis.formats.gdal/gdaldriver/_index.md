---
title: "GdalDriver Sınıfı"
type: docs
weight: 10
url: /tr/python-net/aspose.gis.formats.gdal/gdaldriver/
---
...
| [create_layer(path, options, spatial_reference_system)](#create_layer_path_options_spatial_reference_system_9) | Bir katman oluşturur ve yeni özellikler eklemek için açar. |
...
| [open_layer(path)](#open_layer_path_19) | Katmanı okuma için açar. |
| [open_layer(path)](#open_layer_path_20) | Katmanı okuma için açar. |
| [open_layer(path, options)](#open_layer_path_options_21) | Bir katmanı okuma için açar. |
| [open_layer(path, options)](#open_layer_path_options_22) | Bir katmanı okuma için açar. |
| [open_layer(path, options)](#open_layer_path_options_23) | Bir katmanı okuma için açar. |
...
| :- | :- | :- |
| yol | string | Dosyanın yolu. |
| options | [GdalOptions](/psd/python-net/aspose.gis.formats.gdal/gdaloptions) | Sürücüye özgü seçenekler. |
