---
title: "ProjectedSpatialReferenceSystem Sınıfı"
type: docs
weight: 150
url: /tr/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/
---
...
| :- | :- | :- | :- |
| angular_unit | [Unit](/psd/python-net/aspose.gis.spatialreferencing/unit) | r | Bu SRS'de açısal değerler ve [ProjectedSpatialReferenceSystem.projection](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/) öğesinin açısal parametreleri için kullanılan birim.<br/>            [ProjectedSpatialReferenceSystem.base](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/) öğesinin açısal birimiyle eşleşir. |
...
| as_projected | [ProjectedSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem) | r | Bunu döndür. |
...
| axises_order | [ProjectedAxisesOrder](/psd/python-net/aspose.gis.spatialreferencing/projectedaxisesorder) | r | Bu SRS'deki eksen sırası.<br/>            Bu SRS geçerli değilse ve eksen yönleri yanlışsa, [ProjectedAxisesOrder.INVALID](/psd/python-net/aspose.gis.spatialreferencing/projectedaxisesorder/) döndürülür. |
| base | [GeographicSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/geographicspatialreferencesystem) | r | Bu SRS'yi elde etmek için [ProjectedSpatialReferenceSystem.projection](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/) uygulanan Coğrafi SRS. |
| dimensions_count | int | r | Bu SRS'deki boyut sayısını döndürür. Projeksiyonlu SRS için bu şu olabilir:<br/>            iki - eğer bu tek projeksiyonlu SRS ise.<br/>            üç - eğer bu, tek, iki boyutlu, projeksiyonlu SRS ve üçüncü boyutu ekleyen dikey SRS'den oluşan birleşik SRS ise. |
...
| has_geographic_datum | bool | r | Doğru döndürür, çünkü projeksiyonlu SRS her zaman baş meridyene sahiptir. |
| has_prime_meridian | bool | r | Doğru döndürür, çünkü projeksiyonlu SRS her zaman baş meridyene sahiptir. |
...
| linear_unit | [Unit](/psd/python-net/aspose.gis.spatialreferencing/unit) | r | Bu SRS'deki lineer boyutlar ve [ProjectedSpatialReferenceSystem.projection](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/) lineer parametreleri için kullanılan birim. |
...
| projection | [Projection](/psd/python-net/aspose.gis.spatialreferencing/projection) | r | Bu SRS'yi elde etmek için [ProjectedSpatialReferenceSystem.base](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/) üzerine uygulanan projeksiyon. |
| type | [SpatialReferenceSystemType](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype) | r | Döndürür [SpatialReferenceSystemType.PROJECTED](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/). |
