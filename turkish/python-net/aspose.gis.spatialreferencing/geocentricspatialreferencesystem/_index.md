---
title: "GeocentricSpatialReferenceSystem Sınıfı"
type: docs
weight: 50
url: /tr/python-net/aspose.gis.spatialreferencing/geocentricspatialreferencesystem/
---
...
| as_geocentric | [GeocentricSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/geocentricspatialreferencesystem) | r | Bunu döndür. |
...
| axises_order | [GeocentricAxisesOrder](/psd/python-net/aspose.gis.spatialreferencing/geocentricaxisesorder) | r | Bu SRS'deki eksenlerin sırası.<br/>            Bu SRS geçerli değilse ve eksen yönleri yanlışsa, [GeocentricAxisesOrder.INVALID](/psd/python-net/aspose.gis.spatialreferencing/geocentricaxisesorder/) döndürülür. |
| dimensions_count | int | r | 3 döndürür, çünkü jeosantrik SRS her zaman üç boyutludur. |
...
| has_geographic_datum | bool | r | <see langword=\"true\" /> döndürür, çünkü jeosantrik SRS her zaman coğrafi datum içerir. |
| has_prime_meridian | bool | r | <see langword=\"true\" /> döndürür, çünkü jeosantrik SRS her zaman baş meridyeni içerir. |
...
| linear_unit | [Unit](/psd/python-net/aspose.gis.spatialreferencing/unit) | r | Bu SRS'de kullanılan birim. |
...
| type | [SpatialReferenceSystemType](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype) | r | [SpatialReferenceSystemType.GEOCENTRIC](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/) döndürür. |
