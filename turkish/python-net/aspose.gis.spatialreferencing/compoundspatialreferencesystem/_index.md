---
title: "CompoundSpatialReferenceSystem Sınıfı"
type: docs
weight: 30
url: /tr/python-net/aspose.gis.spatialreferencing/compoundspatialreferencesystem/
---
...
| :- | :- | :- | :- |
| as_compound | [CompoundSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/compoundspatialreferencesystem) | r | Bunu döndür. |
...
| as_geographic | [GeographicSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/geographicspatialreferencesystem) | r | Bu SRS'nin coğrafi temsilini döndürür. Bu bileşik SRS gerçekten bir coğrafi SRS temsil ediyorsa, sonuç<br/>            üç boyutlu bir coğrafi SRS olur (boylam, enlem, yükseklik boyutlarıyla). Aksi takdirde bir istisna fırlatılır. |
...
| as_projected | [ProjectedSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem) | r | Bu SRS'nin projeksiyon temsilini döndürür. Bu bileşik SRS gerçekten bir projeksiyon SRS temsil ediyorsa, sonuç<br/>            üç boyutlu bir projeksiyon SRS olur (X, Y, yükseklik boyutlarıyla). Aksi takdirde bir istisna fırlatılır. |
...
| dimensions_count | int | r | Boyut sayısı. Bileşik SRS için bu, temel SRS'lerin boyut sayısının toplamıdır. |
...
| geographic_datum | [GeographicDatum](/psd/python-net/aspose.gis.spatialreferencing/geographicdatum) | r | Bu SRS'nin coğrafi datumunu döndürür.<br/> Eğer hem [CompoundSpatialReferenceSystem.head](/psd/python-net/aspose.gis.spatialreferencing/compoundspatialreferencesystem/) ve [CompoundSpatialReferenceSystem.tail](/psd/python-net/aspose.gis.spatialreferencing/compoundspatialreferencesystem/) coğrafi datum içeriyorsa - başın coğrafi datumunu döndür. |
| has_geographic_datum | bool | r | Bileşik SRS, temel SRS'lerden herhangi biri coğrafi datum içeriyorsa coğrafi datum içerir. |
| has_prime_meridian | bool | r | Bileşik SRS, temel SRS'lerden herhangi biri baş meridyeni içeriyorsa baş meridyeni içerir. |
| head | [SpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem) | r | İlk temel SRS. |
| identifier | [Identifier](/psd/python-net/aspose.gis.spatialreferencing/identifier) | r | Bu tanımlanabilir nesnenin tanımlayıcısı. |
| is_compound | bool | r | True döndürür <see langword="true" />. |
...
| prime_meridian | [PrimeMeridian](/psd/python-net/aspose.gis.spatialreferencing/primemeridian) | r | Bu SRS'nin baş meridyenini döndürür.<br/> Eğer hem [CompoundSpatialReferenceSystem.head](/psd/python-net/aspose.gis.spatialreferencing/compoundspatialreferencesystem/) ve [CompoundSpatialReferenceSystem.tail](/psd/python-net/aspose.gis.spatialreferencing/compoundspatialreferencesystem/) baş meridyenine sahipse - başın baş meridyenini döndür. |
| tail | [SpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem) | r | İkinci temel SRS. |
| type | [SpatialReferenceSystemType](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype) | r | Bu Bileşik SRS'nin türü. Eğer<br/> bu Bileşik SRS coğrafi ve dikey SRS'nin birleşimi ise [SpatialReferenceSystemType.GEOGRAPHIC](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/), ya da<br/> bu Bileşik SRS projeksiyonlu ve dikey SRS'nin birleşimi ise [SpatialReferenceSystemType.PROJECTED](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/) olabilir. |
...
| [validate(error_message)](#validate_error_message_18) | Bu SRS'nin geçerli olup olmadığını belirleyin. Geçerlilik açıklaması için <see cref=\"M:Aspose.Gis.SpatialReferencing.SpatialReferenceSystem.Validate(string@)\" /> bakın. |
...
Bu SRS'nin geçerli olup olmadığını belirleyin. Geçerlilik açıklaması için <see cref=\"M:Aspose.Gis.SpatialReferencing.SpatialReferenceSystem.Validate(string@)\" /> bakın.

**Parameters:**

| Parametre | Tür | Açıklama |
| :- | :- | :- |
| error_message | Dize | Geçersizlik açıklaması (sonuç <see langword=\"false\" /> ise) |

**Returns**

| Tür | Açıklama |
| :- | :- |
| bool | Bu SRS geçerliyse - <see langword=\"true\" />, aksi takdirde - <see langword=\"false\" />. |
