---
title: "LocalSpatialReferenceSystem Sınıfı"
type: docs
weight: 130
url: /tr/python-net/aspose.gis.spatialreferencing/localspatialreferencesystem/
---
...
| as_local | [LocalSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/localspatialreferencesystem) | r | Bunu döndür. |
...
| dimensions_count | int | r | Bu SRS'deki boyut sayısı. |
...
| geographic_datum | [GeographicDatum](/psd/python-net/aspose.gis.spatialreferencing/geographicdatum) | r | Local SRS coğrafi datum içermediği için InvalidOperationException fırlatır. |
| has_geographic_datum | bool | r | Local SRS coğrafi datum içermediği için <see langword=\"false\" /> döndürür. |
| has_prime_meridian | bool | r | Local SRS prime meridian içermediği için <see langword=\"false\" /> döndürür. |
...
| local_datum | [LocalDatum](/psd/python-net/aspose.gis.spatialreferencing/localdatum) | r | Ölçüm yöntemini tanımlayan datum. |
...
| prime_meridian | [PrimeMeridian](/psd/python-net/aspose.gis.spatialreferencing/primemeridian) | r | Local SRS prime meridian içermediği için InvalidOperationException fırlatır. |
| type | [SpatialReferenceSystemType](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype) | r | Döndür [SpatialReferenceSystemType.LOCAL](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/). |
| unit | [Unit](/psd/python-net/aspose.gis.spatialreferencing/unit) | r | Bu SRS'nin birimi. |
...
| [get_unit(dimension)](#get_unit_dimension_12) | Boyutun [LocalSpatialReferenceSystem.unit](/psd/python-net/aspose.gis.spatialreferencing/localspatialreferencesystem/) değerini alın. |
...
Boyutun [LocalSpatialReferenceSystem.unit](/psd/python-net/aspose.gis.spatialreferencing/localspatialreferencesystem/) değerini alın.
