---
title: "LinePlacerContext Sınıfı"
type: docs
weight: 50
url: /tr/python-net/aspose.gis.labeling.line/lineplacercontext/
---
...
| **Name** | **Description** |
| :- | :- |
| [LinePlacerContext()](#LinePlacerContext__1) | LinePlacerContext sınıfının yeni bir örneğini başlatır |
## **Properties**
...
LinePlacerContext sınıfının yeni bir örneğini başlatır
