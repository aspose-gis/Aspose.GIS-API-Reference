---
title: "CircularArc Sınıfı"
type: docs
weight: 140
url: /tr/python-net/aspose.gis.common/circulararc/
---
...
| **Name** | **Description** |
| :- | :- |
| [CircularArc()](#CircularArc__1) | CircularArc sınıfının yeni bir örneğini başlatır |
| [CircularArc(start, mid, end)](#CircularArc_start_mid_end_2) | CircularArc sınıfının yeni bir örneğini başlatır |
| [CircularArc(x0, y0, x1, y1, x2, y2)](#CircularArc_x0_y0_x1_y1_x2_y2_3) | CircularArc sınıfının yeni bir örneğini başlatır |
## **Properties**
...
CircularArc sınıfının yeni bir örneğini başlatır
