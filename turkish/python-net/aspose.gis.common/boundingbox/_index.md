---
title: "BoundingBox Sınıfı"
type: docs
weight: 90
url: /tr/python-net/aspose.gis.common/boundingbox/
---
...
| **Name** | **Description** |
| :- | :- |
| [BoundingBox()](#BoundingBox__1) | BoundingBox sınıfının yeni bir örneğini başlatır |
## **Properties**
...
BoundingBox sınıfının yeni bir örneğini başlatır
