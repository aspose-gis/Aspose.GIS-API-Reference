---
title: "KmlDriver Sınıfı"
type: docs
weight: 50
url: /tr/python-net/aspose.gis.formats.kml/kmldriver/
---
...
| [open_as_kml_layer(path, options)](#open_as_kml_layer_path_options_18) | Okuma için bir Kml katmanı açar. |
...
| :- | :- | :- |
| yol | string | Dosyanın yolu. |
| options | [KmlOptions](/psd/python-net/aspose.gis.formats.kml/kmloptions) | Sürücüye özgü seçenekler. |
...
Okuma için bir Kml katmanı açar.
...
| Tür | Açıklama |
| :- | :- |
| [KmlLayer](/psd/python-net/aspose.gis.formats.kml/kmllayer) | Belirli alanlara sahip KmlLayer |
