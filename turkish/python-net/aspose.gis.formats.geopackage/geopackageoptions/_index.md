---
title: "GeoPackageOptions Sınıfı"
type: docs
weight: 30
url: /tr/python-net/aspose.gis.formats.geopackage/geopackageoptions/
---
...
| **Name** | **Description** |
| :- | :- |
| [GeoPackageOptions()](#GeoPackageOptions__1) | GeoPackageOptions sınıfının yeni bir örneğini başlatır. |
## **Properties**
...
GeoPackageOptions sınıfının yeni bir örneğini başlatır.
