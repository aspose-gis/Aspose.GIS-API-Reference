---
title: "InFileOptions Sınıfı"
type: docs
weight: 20
url: /tr/python-net/aspose.gis.formats.infile/infileoptions/
---
...
| **Name** | **Description** |
| :- | :- |
| [InFileOptions()](#InFileOptions__1) | Yeni bir örnek oluştur. |
## **Properties**
...
| count_of_feature_in_part | int | r/w | Dosyanın her bölümündeki maksimum özellik sayısı |
