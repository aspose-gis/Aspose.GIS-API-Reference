---
title: "MapHeader Sınıfı"
type: docs
weight: 30
url: /tr/python-net/aspose.gis.common.formats.mapinfo.tabformat.map/mapheader/
---
...
| **Name** | **Description** |
| :- | :- |
| [MapHeader()](#MapHeader__1) | MapHeader sınıfının yeni bir örneğini başlatır |
## **Properties**
...
| semboller_sayısı | int | r/w |  |
| metinler_sayısı | int | r/w |  |
| araç_blokları_sayısı | int | r/w |  |
...
MapHeader sınıfının yeni bir örneğini başlatır
