---
title: "MapTransform Sınıf"
type: docs
weight: 70
url: /tr/python-net/aspose.gis.common.formats.mapinfo.tabformat.map/maptransform/
---
...
| **Name** | **Description** |
| :- | :- |
| [MapTransform(x_displacement, y_displacement, x_scale, y_scale, coordinates_origin_quadrant)](#MapTransform_x_displacement_y_displacement_x_scale_y_scale_coordinates_origin_quadrant_1) | MapTransform sınıfının yeni bir örneğini başlatır |
## **Properties**
...
MapTransform sınıfının yeni bir örneğini başlatır
