---
title: "MultiStreamPath Sınıfı"
type: docs
weight: 2760
url: /tr/python-net/aspose.gis/multistreampath/
---
...
| **Name** | **Description** |
| :- | :- |
| [MultiStreamPath(entry_file_name, file_names, streams)](#MultiStreamPath_entry_file_name_file_names_streams_1) | Yeni bir [MultiStreamPath](/psd/python-net/aspose.gis/multistreampath/) sınıfı örneği başlatır. |
## **Properties**
| **Name** | **Type** | **Access** | **Description** |
| :- | :- | :- | :- |
| konum | string | r | Bu <c>AbstractPath</c> konumunun dize temsili alınır. |
| separator | char | r | Bu [MultiStreamPath.location](/psd/python-net/aspose.gis/multistreampath/) dizesinin dizin seviyelerini ayırmak için kullanılan ayırıcı karakter alınır. |
## **Methods**
| **Name** | **Description** |
| :- | :- |
...
| [open(access)](#open_access_9) | Veriye erişmek için bir yol sağlayan açık akışlı çoklu dosya formatlarının bir kümesini soyutlar. |
...
Yeni bir [MultiStreamPath](/psd/python-net/aspose.gis/multistreampath/) sınıfı örneği başlatır.

**Parameters:**

| Parametre | Tür | Açıklama |
| :- | :- | :- |
| entry_file_name | string | Giriş dosyasının adı. |
| file_names | string | Dosya adları. |
| streams | _io.BufferedRandom[] | Akışlar. |
...
Veriye erişmek için bir yol sağlayan açık akışlı çoklu dosya formatlarının bir kümesini soyutlar.
...
| Tür | Açıklama |
| :- | :- |
| _io.BufferedRandom | Bu, bir   veya istemci tarafından başlangıçta verilen akış olabilir. |
