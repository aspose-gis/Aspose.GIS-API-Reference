---
title: "TopoJsonOptions Sınıfı"
type: docs
weight: 20
url: /tr/python-net/aspose.gis.formats.topojson/topojsonoptions/
---
...
| **Name** | **Description** |
| :- | :- |
| [TopoJsonOptions()](#TopoJsonOptions__1) | Yeni bir örnek oluştur. |
## **Properties**
...
| default_object_name | string | r/w | Özelliklerin varsayılan olarak yerleştirildiği nesnenin adı. |
...
| object_name_attribute | string | r/w | Bir özelliği içeren nesnenin adını yansıtan öznitelik adı. |
| quantization_number | Nullable<int> | r/w | Çıktı TopoJSON'unda koordinatları nicelleştirmek ve yayları delta kodlamak için kullanılacak nicelleştirme sayısını belirtir. |
...
| transform | [TopoJsonTransform](/psd/python-net/aspose.gis.formats.topojson/topojsontransform) | r/w | Çıktı TopoJSON'unda koordinatları nicelleştirmek ve yayları delta kodlamak için kullanılacak dönüşüm nesnesini belirtir. |
