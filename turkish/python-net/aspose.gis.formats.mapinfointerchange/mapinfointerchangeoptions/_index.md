---
title: "MapInfoInterchangeOptions Sınıf"
type: docs
weight: 20
url: /tr/python-net/aspose.gis.formats.mapinfointerchange/mapinfointerchangeoptions/
---
...
| **Name** | **Description** |
| :- | :- |
| [MapInfoInterchangeOptions()](#MapInfoInterchangeOptions__1) | Yeni bir örnek oluştur. |
## **Properties**
| **Name** | **Type** | **Access** | **Description** |
| :- | :- | :- | :- |
| karakter kümesi | string | r/w | Karakter kümesini belirler, varsayılan olarak Neutral'dır |
...
| ayırıcı | string | r/w | Mid dosyasında öznitelikler için ayırıcıyı belirler, varsayılan olarak sekme karakteridir |
