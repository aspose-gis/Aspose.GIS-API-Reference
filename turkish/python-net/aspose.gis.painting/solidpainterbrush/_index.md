---
title: "SolidPainterBrush Sınıfı"
type: docs
weight: 130
url: /tr/python-net/aspose.gis.painting/solidpainterbrush/
---
...
| **Name** | **Description** |
| :- | :- |
| [SolidPainterBrush()](#SolidPainterBrush__1) | SolidPainterBrush sınıfının yeni bir örneğini başlatır |
| [SolidPainterBrush(color, style)](#SolidPainterBrush_color_style_2) | SolidPainterBrush sınıfının yeni bir örneğini başlatır |
## **Properties**
| **Name** | **Type** | **Access** | **Description** |
| :- | :- | :- | :- |
| renk | System.Drawing.Color | r |  |
...
### Constructor: SolidPainterBrush() {#SolidPainterBrush__1}
...
SolidPainterBrush sınıfının yeni bir örneğini başlatır
