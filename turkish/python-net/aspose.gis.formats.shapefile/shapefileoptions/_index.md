---
title: "ShapefileOptions Sınıfı"
type: docs
weight: 20
url: /tr/python-net/aspose.gis.formats.shapefile/shapefileoptions/
---
...
| **Name** | **Description** |
| :- | :- |
| [ShapefileOptions()](#ShapefileOptions__1) | Yeni bir örnek oluştur. |
## **Properties**
...
| is_ignore_wrong_data | bool | r/w | Yanlış veriyi ayrıştırırken istisna fırlatmamız mı yoksa varsayılan değerleri ayarlamamız mı gerektiğini belirler |
