---
title: "CsvDriver Sınıfı"
type: docs
weight: 10
url: /tr/python-net/aspose.gis.formats.csv/csvdriver/
---
...
| **Name** | **Description** |
| :- | :- |
| [CsvDriver()](#CsvDriver__1) | CsvDriver sınıfının yeni bir örneğini başlatır |
## **Properties**
...
CsvDriver sınıfının yeni bir örneğini başlatır
...
| :- | :- | :- |
| yol | string | Dosyanın yolu. |
| options | [CsvOptions](/psd/python-net/aspose.gis.formats.csv/csvoptions) | Sürücüye özgü seçenekler. |
