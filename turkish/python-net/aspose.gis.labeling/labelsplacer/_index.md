---
title: "LabelsPlacer Sınıfı"
type: docs
weight: 90
url: /tr/python-net/aspose.gis.labeling/labelsplacer/
---
...
| **Name** | **Description** |
| :- | :- |
| [LabelsPlacer(bounding_rectangle)](#LabelsPlacer_bounding_rectangle_1) | LabelsPlacer sınıfının yeni bir örneğini başlatır |
| [LabelsPlacer(x_min, y_min, x_max, y_max)](#LabelsPlacer_x_min_y_min_x_max_y_max_2) | LabelsPlacer sınıfının yeni bir örneğini başlatır |
## **Methods**
| **Name** | **Description** |
| :- | :- |
...
LabelsPlacer sınıfının yeni bir örneğini başlatır
