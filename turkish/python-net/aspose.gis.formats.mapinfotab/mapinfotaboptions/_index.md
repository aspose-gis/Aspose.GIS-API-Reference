---
title: "MapInfoTabOptions Sınıfı"
type: docs
weight: 20
url: /tr/python-net/aspose.gis.formats.mapinfotab/mapinfotaboptions/
---
...
| **Name** | **Description** |
| :- | :- |
| [MapInfoTabOptions()](#MapInfoTabOptions__1) | Yeni bir örnek oluştur. |
## **Properties**
| **Name** | **Type** | **Access** | **Description** |
| :- | :- | :- | :- |
| block_size | int | r/w | '*.map' dosyaları için blok boyutu (512'nin katları). Varsayılan değer 16384'tir. Geçerli değerler: 512 ile 32256 arasında. |
...
| is_ignore_wrong_data | bool | r/w | Yanlış veriyle çalışırken istisna fırlatıp fırlatmayacağımızı veya varsayılan değerleri ayarlayıp ayarlamayacağımızı belirler. |
...
| text_string_attribute | string | r/w | ‘Text’ grafik nesnesinin metnini temsil eden öznitelik adını belirtir. |
