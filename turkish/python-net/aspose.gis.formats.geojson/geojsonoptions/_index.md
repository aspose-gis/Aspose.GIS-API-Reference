---
title: "GeoJsonOptions Sınıfı"
type: docs
weight: 20
url: /tr/python-net/aspose.gis.formats.geojson/geojsonoptions/
---
...
| **Name** | **Description** |
| :- | :- |
| [GeoJsonOptions()](#GeoJsonOptions__1) | Yeni bir örnek oluştur. |
## **Properties**
...
| açıklama | string | r/w | Özellik koleksiyonu seviyesindeki açıklama (katman oluşturma için) |
...
| ad | string | r/w | Özellik koleksiyonu seviyesindeki ad (katman oluşturma için) |
...
| read_bounding_boxes | bool | r/w | Bounding Boxes ('bbox')'in 'bbox_0', 'bbox_1' vb. adlarıyla öznitelik olarak okunup okunmayacağını belirler.<br/>            Varsayılan değer <see langword=\"false\" />'dir.<br/>            [GeoJsonOptions.nested_properties_separator](/psd/python-net/aspose.gis.formats.geojson/geojsonoptions/) dizesi bbox_0, bbox_1,.. adlarında kullanılır. |
...
| write_bounding_boxes | bool | r/w | GeoJSON nesnelerinin Geometrileri için koordinat aralığı bilgisi içerip içermeyeceğini belirler.<br/>            <see langword=\"true\" /> olarak ayarlanırsa, katmana eklendiğinde (null olmayan) her geometri için bir \"bbox\" üyesi oluşturulur.<br/>            Varsayılan değer <see langword=\"false\" />'dir. |
