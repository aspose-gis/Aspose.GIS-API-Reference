---
title: "IGeometry Sınıfı"
type: docs
weight: 110
url: /tr/python-net/aspose.gis.geometries/igeometry/
---
...
| [to_linear_geometry()](#to_linear_geometry__31) | Bu geometrinin varsayılan <c>tolerance</c> kullanılarak yaklaşık veya eşdeğer eğri olmayan sürümünü alır. |
| [to_linear_geometry(tolerance)](#to_linear_geometry_tolerance_32) | Bu geometrinin belirtilen <c>tolerance</c> kullanılarak yaklaşık veya eşdeğer eğri olmayan sürümünü alır. |
| [touches(other)](#touches_other_33) | Bu geometri ile belirtilen geometrinin temas edip etmediğini belirler. |
| [union(other)](#union_other_34) | Bu geometriyi ve belirtilen geometriyi birleştirir. |
| [union(other)](#union_other_35) | Bu geometriyi ve belirtilen geometriyi birleştirir. |
| [within(extent)](#within_extent_36) | Bu geometrinin belirtilen kapsam içinde olup olmadığını belirler. |
| [within(other)](#within_other_37) | Bu geometrinin belirtilen geometri içinde olup olmadığını belirler. |
