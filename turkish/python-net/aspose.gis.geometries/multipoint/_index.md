---
title: "MultiPoint Sınıfı"
type: docs
weight: 270
url: /tr/python-net/aspose.gis.geometries/multipoint/
---
...
| **Name** | **Description** |
| :- | :- |
| [MultiPoint()](#MultiPoint__1) | Yeni bir [MultiPoint](/psd/python-net/aspose.gis.geometries/multipoint/) sınıfının örneğini başlatır. |
## **Properties**
...
Yeni bir [MultiPoint](/psd/python-net/aspose.gis.geometries/multipoint/) sınıfının örneğini başlatır.
...
| Tür | Açıklama |
| :- | :- |
| [MultiPoint](/psd/python-net/aspose.gis.geometries/multipoint) | Bu geometrinin düzenlenebilir bir kopyası. |
