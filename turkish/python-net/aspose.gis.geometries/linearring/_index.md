---
title: "LinearRing Sınıfı"
type: docs
weight: 240
url: /tr/python-net/aspose.gis.geometries/linearring/
---
...
| **Name** | **Description** |
| :- | :- |
| [LinearRing()](#LinearRing__1) | Yeni bir [LinearRing](/psd/python-net/aspose.gis.geometries/linearring/) sınıfının örneğini başlatır. |
| [LinearRing(collection)](#LinearRing_collection_2) | Yeni bir [LinearRing](/psd/python-net/aspose.gis.geometries/linearring/) sınıfının örneğini başlatır. |
| [LinearRing(other)](#LinearRing_other_3) | Yeni bir [LinearRing](/psd/python-net/aspose.gis.geometries/linearring/) sınıfının örneğini başlatır. |
## **Properties**
...
| is_closed | bool | r | Bir eğrinin kapalı olup olmadığını gösteren bir değer alır.<br/>            Bir eğri, başlangıç noktası bitiş noktasına eşitse kapalıdır. |
...
| [is_clockwise()](#is_clockwise__33) | Halkanın saat yönünde sarılıp sarıldığını belirler. |
| [overlaps(other)](#overlaps_other_34) | Bu geometrinin belirtilen bir geometriyle örtüşüp örtüşmediğini belirler. |
| [relate(other, intersection_pattern_matrix)](#relate_other_intersection_pattern_matrix_35) | Bu geometri ve belirtilen bir geometri için DE-9IM kesişim matrisinin sağlanan desenle eşleşip eşleşmediğini belirler. |
| [replace_polygons_by_lines()](#replace_polygons_by_lines__36) | Bu geometrinin çizgi olarak temsil edilen çokgenlerini alır. |
| reverse() | Bu [LineString](/psd/python-net/aspose.gis.geometries/linestring/) içindeki nokta sırasını tersine çevirir. |
| [round_m(digits)](#round_m_digits_37) | M koordinatını belirtilen sayıda ondalık basamağa yuvarlar. |
| [round_xy(digits)](#round_xy_digits_38) | X ve Y koordinatlarını belirtilen sayıda ondalık basamağa yuvarlar. |
| [round_z(digits)](#round_z_digits_39) | Z koordinatını belirtilen sayıda ondalık basamağa yuvarlar. |
| set_empty() | Bu [Geometry](/psd/python-net/aspose.gis.geometries/geometry/) nesnesini boş hale getirir. |
| [spatially_contains(other)](#spatially_contains_other_40) | Bu geometrinin belirtilen bir geometriyi mekânsal olarak içerip içermediğini belirler. |
| [spatially_equals(other)](#spatially_equals_other_41) | Bu geometrinin belirtilen bir geometriye mekânsal olarak eşit olup olmadığını belirler. |
| [sym_difference(other)](#sym_difference_other_42) | Bu geometri ile belirtilen geometri arasında simetrik fark oluşturur. |
| [to_editable()](#to_editable__43) | Bu geometrinin düzenlenebilir bir kopyasını alır. |
| [to_linear_geometry()](#to_linear_geometry__44) | Bu geometrinin varsayılan <c>tolerance</c> kullanılarak yaklaşık veya eşdeğer eğri olmayan sürümünü alır. |
| [to_linear_geometry(tolerance)](#to_linear_geometry_tolerance_45) | Bu geometrinin belirtilen <c>tolerance</c> kullanılarak yaklaşık veya eşdeğer eğri olmayan sürümünü alır. |
| [to_svg(extent)](#to_svg_extent_46) | Bu geometriyi Svg temsiline dönüştürür. |
| [touches(other)](#touches_other_47) | Bu geometri ile belirtilen geometrinin temas edip etmediğini belirler. |
| [union(other)](#union_other_48) | Bu geometriyi ve belirtilen geometriyi birleştirir. |
| [union(other)](#union_other_49) | Bu geometriyi ve belirtilen geometriyi birleştirir. |
| [within(extent)](#within_extent_50) | Bu geometrinin belirtilen kapsam içinde olup olmadığını belirler. |
| [within(other)](#within_other_51) | Bu geometrinin belirtilen geometri içinde olup olmadığını belirler. |
...
Yeni bir [LinearRing](/psd/python-net/aspose.gis.geometries/linearring/) sınıfının örneğini başlatır.
...
Halkanın saat yönünde sarılıp sarıldığını belirler.

**Returns**

| Tür | Açıklama |
| :- | :- |
| bool | <see langword="true" /> eğer saat yönündeyse; aksi takdirde <see langword="false" />. |
...
| Tür | Açıklama |
| :- | :- |
| [LinearRing](/psd/python-net/aspose.gis.geometries/linearring) | Bu geometrinin düzenlenebilir bir kopyası. |
