---
title: "IPolygon Sınıfı"
type: docs
weight: 210
url: /tr/python-net/aspose.gis.geometries/ipolygon/
---
...
| exterior_ring | [ILinearRing](/psd/python-net/aspose.gis.geometries/ilinearring) | r | Dış halkayı alır. |
...
| [get_interior_ring(index)](#get_interior_ring_index_21) | İç halkayı indeksine göre alır. |
| [get_length()](#get_length__22) | Bu geometrinin uzunluğunu hesaplar. |
| [get_point_on_surface()](#get_point_on_surface__23) | Bu yüzeyde olması garanti olan bir nokta bulur. |
| [intersection(other)](#intersection_other_24) | Bu geometri ile belirtilen bir geometri arasında bir kesişim oluşturur. |
| [intersects(extent)](#intersects_extent_25) | Bu geometrinin belirtilen bir kapsamla kesişip kesişmediğini belirler. |
| [intersects(other)](#intersects_other_26) | Bu geometri ile belirtilen bir geometrinin kesişip kesişmediğini belirler. |
| [overlaps(other)](#overlaps_other_27) | Bu geometrinin belirtilen bir geometriyle örtüşüp örtüşmediğini belirler. |
| [relate(other, intersection_pattern_matrix)](#relate_other_intersection_pattern_matrix_28) | Bu geometri ve belirtilen bir geometri için DE-9IM kesişim matrisinin sağlanan desenle eşleşip eşleşmediğini belirler. |
| [replace_polygons_by_lines()](#replace_polygons_by_lines__29) | Bu geometrinin çizgi olarak temsil edilen çokgenlerini alır. |
| [spatially_contains(other)](#spatially_contains_other_30) | Bu geometrinin belirtilen bir geometriyi mekânsal olarak içerip içermediğini belirler. |
| [spatially_equals(other)](#spatially_equals_other_31) | Bu geometrinin belirtilen bir geometriye mekânsal olarak eşit olup olmadığını belirler. |
| [sym_difference(other)](#sym_difference_other_32) | Bu geometri ile belirtilen geometri arasında simetrik fark oluşturur. |
| [to_editable()](#to_editable__33) | Bu geometrinin düzenlenebilir bir kopyasını alır. |
| [to_linear_geometry()](#to_linear_geometry__34) | Bu geometrinin varsayılan <c>tolerance</c> kullanılarak yaklaşık veya eşdeğer eğri olmayan sürümünü alır. |
| [to_linear_geometry(tolerance)](#to_linear_geometry_tolerance_35) | Bu geometrinin belirtilen <c>tolerance</c> kullanılarak yaklaşık veya eşdeğer eğri olmayan sürümünü alır. |
| [touches(other)](#touches_other_36) | Bu geometri ile belirtilen geometrinin temas edip etmediğini belirler. |
| [union(other)](#union_other_37) | Bu geometriyi ve belirtilen geometriyi birleştirir. |
| [union(other)](#union_other_38) | Bu geometriyi ve belirtilen geometriyi birleştirir. |
| [within(extent)](#within_extent_39) | Bu geometrinin belirtilen kapsam içinde olup olmadığını belirler. |
| [within(other)](#within_other_40) | Bu geometrinin belirtilen geometri içinde olup olmadığını belirler. |
...
| Tür | Açıklama |
| :- | :- |
| [ILinearRing](/psd/python-net/aspose.gis.geometries/ilinearring) | İç halka. |
...
Bu yüzeyde olması garanti olan bir nokta bulur.

**Returns**

| Tür | Açıklama |
| :- | :- |
| [IPoint](/psd/python-net/aspose.gis.geometries/ipoint) | Bu yüzeyde bir nokta. Yüzeyin içi yoksa boş bir nokta. |
...
| Tür | Açıklama |
| :- | :- |
| [Polygon](/psd/python-net/aspose.gis.geometries/polygon) | Bu geometrinin düzenlenebilir bir kopyası. |
