...
type: docs
weight: 200
url: /tr/python-net/aspose.gis.geometries/ipoint/
---
...
| m | double | r | m-koordinatını alır. |
...
| x | double | r | x-koordinatını alır. |
| y | double | r | y-koordinatını alır. |
| z | double | r | z-koordinatını alır. |
## **Methods**
| **Name** | **Description** |
| :- | :- |
...
| Tür | Açıklama |
| :- | :- |
| [Point](/psd/python-net/aspose.gis.geometries/point) | Bu geometrinin düzenlenebilir bir kopyası. |
