---
title: "Polygon Sınıfı"
type: docs
weight: 310
url: /tr/python-net/aspose.gis.geometries/polygon/
---
...
| **Name** | **Description** |
| :- | :- |
| [Polygon()](#Polygon__1) | Yeni bir [Polygon](/psd/python-net/aspose.gis.geometries/polygon/) sınıfının örneğini başlatır. |
| [Polygon(exterior_ring)](#Polygon_exterior_ring_2) | Yeni bir [Polygon](/psd/python-net/aspose.gis.geometries/polygon/) sınıfının örneğini başlatır. |
| [Polygon(exterior_ring, interior_rings)](#Polygon_exterior_ring_interior_rings_3) | Yeni bir [Polygon](/psd/python-net/aspose.gis.geometries/polygon/) sınıfının örneğini başlatır. |
## **Properties**
...
| exterior_ring | [ILinearRing](/psd/python-net/aspose.gis.geometries/ilinearring) | r/w | Dış halkayı alır. |
...
| [get_point_on_surface()](#get_point_on_surface__28) | Bu çokgenin üzerinde olması garanti olan bir nokta bulur. |
...
Yeni bir [Polygon](/psd/python-net/aspose.gis.geometries/polygon/) sınıfının örneğini başlatır.
...
| :- | :- | :- |
| exterior_ring | [ILinearRing](/psd/python-net/aspose.gis.geometries/ilinearring) | Dış halka. |
...
| :- | :- | :- |
| exterior_ring | [ILinearRing](/psd/python-net/aspose.gis.geometries/ilinearring) | Dış halka. |
| iç_halkalar | System.Collections.Generic.IEnumerable<ILinearRing> | İç halkalar. |
...
| Parametre | Tür | Açıklama |
| :- | :- | :- |
| ring | [ILinearRing](/psd/python-net/aspose.gis.geometries/ilinearring) | Eklenecek halka. |
...
Bu çokgenin üzerinde olması garanti olan bir nokta bulur.

**Returns**

| Tür | Açıklama |
| :- | :- |
| [IPoint](/psd/python-net/aspose.gis.geometries/ipoint) | Bu çokgen üzerindeki bir nokta. Çokgenin içi yoksa boş bir nokta. |
