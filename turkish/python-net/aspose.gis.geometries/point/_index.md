...
type: docs
weight: 300
url: /tr/python-net/aspose.gis.geometries/point/
---
...
| **Name** | **Description** |
| :- | :- |
| [Point()](#Point__1) | Yeni bir [Point](/psd/python-net/aspose.gis.geometries/point/) sınıfı örneği başlatır. |
| [Point(other)](#Point_other_2) | Yeni bir [Point](/psd/python-net/aspose.gis.geometries/point/) sınıfı örneği başlatır. |
| [Point(x, y)](#Point_x_y_3) | Yeni bir [Point](/psd/python-net/aspose.gis.geometries/point/) sınıfı örneği başlatır. |
| [Point(x, y, z)](#Point_x_y_z_4) | Yeni bir [Point](/psd/python-net/aspose.gis.geometries/point/) sınıfı örneği başlatır. |
| [Point(x, y, z, m)](#Point_x_y_z_m_5) | Yeni bir [Point](/psd/python-net/aspose.gis.geometries/point/) sınıfı örneği başlatır. |
## **Properties**
...
| m | double | r/w | m-koordinatı için bir değer alır veya ayarlar. |
...
| x | double | r/w | x-koordinatı için bir değer alır veya ayarlar. |
| y | double | r/w | y-koordinatı için bir değer alır veya ayarlar. |
| z | double | r/w | z-koordinatı için bir değer alır veya ayarlar. |
## **Methods**
| **Name** | **Description** |
| :- | :- |
...
Yeni bir [Point](/psd/python-net/aspose.gis.geometries/point/) sınıfı örneği başlatır.
...
| :- | :- | :- |
| other | [IPoint](/psd/python-net/aspose.gis.geometries/ipoint) | Verileri kopyalanacak diğer [IPoint](/psd/python-net/aspose.gis.geometries/ipoint/). |
