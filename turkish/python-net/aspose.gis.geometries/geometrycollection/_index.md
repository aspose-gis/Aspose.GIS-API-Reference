---
title: "GeometryCollection Sınıfı"
type: docs
weight: 60
url: /tr/python-net/aspose.gis.geometries/geometrycollection/
---
...
| **Name** | **Description** |
| :- | :- |
| [GeometryCollection()](#GeometryCollection__1) | Yeni bir [GeometryCollection](/psd/python-net/aspose.gis.geometries/geometrycollection/) sınıfı örneği başlatır. |
## **Properties**
...
| dimension | [GeometryDimension](/psd/python-net/aspose.gis.geometries/geometrydimension) | r | Bu [Geometry](/psd/python-net/aspose.gis.geometries/geometry/) nesnesinin topolojik boyutunu alır.<br/>            Eğer koleksiyon Boş ise, [GeometryDimension.POINT](/psd/python-net/aspose.gis.geometries/geometrydimension/) döndürülür. |
...
Yeni bir [GeometryCollection](/psd/python-net/aspose.gis.geometries/geometrycollection/) sınıfı örneği başlatır.
...
| Tür | Açıklama |
| :- | :- |
| [GeometryCollection](/psd/python-net/aspose.gis.geometries/geometrycollection) | Bu geometrinin düzenlenebilir bir kopyası. |
...
| Tür | Açıklama |
| :- | :- |
| [IGeometryCollection](/psd/python-net/aspose.gis.geometries/igeometrycollection) | Eğri geometrileri içermeyen bir geometri. Bu, <DOM Element: class at 0x2a1791cc040>.IGeometryCollection.to_linear_geometry()(float) metodunun varsayılan <c>tolerance</c> ile kullanılan eşdeğeridir.<br/>            Varsayılan <c>tolerance</c> değeri bu geometrinin [SpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem/) bağımlıdır:<br/>            <ul><br/>            <li> Projeksiyonlu SRS için Tolerans 0.001 metre (SRS birimlerinde) </li><br/>            <li> Coğrafi SRS için Tolerans <c>1e-5</c> derece (SRS birimlerinde) </li><br/>            <li> Bilinmeyen SRS için Tolerans <c>1e-5</c> </li><br/>            </ul><br/>            Uygulanan dönüşümler hakkında daha fazla ayrıntı için <DOM Element: class at 0x2a1791cc040>.IGeometryCollection.to_linear_geometry()(float) spesifikasyonuna bakınız. |
