---
title: "CircularString Sınıfı"
type: docs
weight: 10
url: /tr/python-net/aspose.gis.geometries/circularstring/
---
...
| **Name** | **Description** |
| :- | :- |
| [CircularString()](#CircularString__1) | Yeni bir [CircularString](/psd/python-net/aspose.gis.geometries/circularstring/) sınıfı örneği başlatır. |
| [CircularString(collection)](#CircularString_collection_2) | Yeni bir [CircularString](/psd/python-net/aspose.gis.geometries/circularstring/) sınıfı örneği başlatır. |
| [CircularString(other)](#CircularString_other_3) | Yeni bir [CircularString](/psd/python-net/aspose.gis.geometries/circularstring/) sınıfı örneği başlatır. |
## **Properties**
...
| **Name** | **Description** |
| :- | :- |
| [add_point(point)](#add_point_point_1) | Dairesel dize sonuna bir nokta ekler. |
| [add_point(x, y)](#add_point_x_y_2) | Dairesel dize sonuna bir nokta ekler. |
| [add_point(x, y, z)](#add_point_x_y_z_3) | Dairesel dize sonuna bir nokta ekler. |
| [add_point(x, y, z, m)](#add_point_x_y_z_m_4) | Dairesel dize sonuna bir nokta ekler. |
...
| reverse() | Bu [CircularString](/psd/python-net/aspose.gis.geometries/circularstring/) içindeki nokta sırasını tersine çevirir. |
...
Yeni bir [CircularString](/psd/python-net/aspose.gis.geometries/circularstring/) sınıfı örneği başlatır.
...
| Parametre | Tür | Açıklama |
| :- | :- | :- |
| other | [ICircularString](/psd/python-net/aspose.gis.geometries/icircularstring) | Verilerin kopyalanacağı diğer dize. |
...
Dairesel dize sonuna bir nokta ekler.
