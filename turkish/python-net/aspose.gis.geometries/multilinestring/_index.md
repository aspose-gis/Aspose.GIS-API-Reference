---
title: "MultiLineString Sınıfı"
type: docs
weight: 260
url: /tr/python-net/aspose.gis.geometries/multilinestring/
---
...
| **Name** | **Description** |
| :- | :- |
| [MultiLineString()](#MultiLineString__1) | Yeni bir [MultiLineString](/psd/python-net/aspose.gis.geometries/multilinestring/) sınıfı örneği başlatır. |
## **Properties**
...
| is_closed | bool | r | Bu eğrinin kapalı olup olmadığını belirler. |
...
Yeni bir [MultiLineString](/psd/python-net/aspose.gis.geometries/multilinestring/) sınıfı örneği başlatır.
...
| Tür | Açıklama |
| :- | :- |
| [MultiLineString](/psd/python-net/aspose.gis.geometries/multilinestring) | Bu geometrinin düzenlenebilir bir kopyası. |
