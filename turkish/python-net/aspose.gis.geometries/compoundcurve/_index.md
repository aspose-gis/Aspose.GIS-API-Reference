---
title: "CompoundCurve Sınıfı"
type: docs
weight: 20
url: /tr/python-net/aspose.gis.geometries/compoundcurve/
---
...
| **Name** | **Description** |
| :- | :- |
| [CompoundCurve()](#CompoundCurve__1) | Yeni bir [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/) sınıfı örneği başlatır. |
| [CompoundCurve(curves)](#CompoundCurve_curves_2) | Yeni bir [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/) sınıfı örneği başlatır. |
| [CompoundCurve(other)](#CompoundCurve_other_3) | Yeni bir [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/) sınıfı örneği başlatır. |
## **Properties**
...
| count | int | r | [ICompoundCurve](/psd/python-net/aspose.gis.geometries/icompoundcurve/) içindeki eğrilerin sayısını alır. |
...
| **Name** | **Description** |
| :- | :- |
| [add_curve(curve)](#add_curve_curve_1) | Bu [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/) sonuna bir eğri ekler. |
...
| [get_length()](#get_length__26) | Bu geometrinin uzunluğunu hesaplar. |
| [intersection(other)](#intersection_other_27) | Bu geometri ile belirtilen bir geometri arasında bir kesişim oluşturur. |
| [intersects(extent)](#intersects_extent_28) | Bu geometrinin belirtilen bir kapsamla kesişip kesişmediğini belirler. |
| [intersects(other)](#intersects_other_29) | Bu geometri ile belirtilen bir geometrinin kesişip kesişmediğini belirler. |
| [overlaps(other)](#overlaps_other_30) | Bu geometrinin belirtilen bir geometriyle örtüşüp örtüşmediğini belirler. |
| [relate(other, intersection_pattern_matrix)](#relate_other_intersection_pattern_matrix_31) | Bu geometri ve belirtilen bir geometri için DE-9IM kesişim matrisinin sağlanan desenle eşleşip eşleşmediğini belirler. |
| [replace_polygons_by_lines()](#replace_polygons_by_lines__32) | Bu geometrinin çizgi olarak temsil edilen çokgenlerini alır. |
| reverse() | Bu [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/) tersine çevirir. Yani - eğrilerin sırasını ve bu birleşik eğri içindeki her bir eğriyi tersine çevirir. |
| [round_m(digits)](#round_m_digits_33) | M koordinatını belirtilen sayıda ondalık basamağa yuvarlar. |
| [round_xy(digits)](#round_xy_digits_34) | X ve Y koordinatlarını belirtilen sayıda ondalık basamağa yuvarlar. |
| [round_z(digits)](#round_z_digits_35) | Z koordinatını belirtilen sayıda ondalık basamağa yuvarlar. |
| set_empty() | Bu [Geometry](/psd/python-net/aspose.gis.geometries/geometry/) nesnesini boş hale getirir. |
| [spatially_contains(other)](#spatially_contains_other_36) | Bu geometrinin belirtilen bir geometriyi mekânsal olarak içerip içermediğini belirler. |
| [spatially_equals(other)](#spatially_equals_other_37) | Bu geometrinin belirtilen bir geometriye mekânsal olarak eşit olup olmadığını belirler. |
| [sym_difference(other)](#sym_difference_other_38) | Bu geometri ile belirtilen geometri arasında simetrik fark oluşturur. |
| [to_editable()](#to_editable__39) | Bu geometrinin düzenlenebilir bir kopyasını alır. |
| [to_linear_geometry()](#to_linear_geometry__40) | Bu geometrinin varsayılan <c>tolerance</c> kullanılarak yaklaşık veya eşdeğer eğri olmayan sürümünü alır. |
| [to_linear_geometry(tolerance)](#to_linear_geometry_tolerance_41) | Bu geometrinin belirtilen <c>tolerance</c> kullanılarak yaklaşık veya eşdeğer eğri olmayan sürümünü alır. |
| [to_svg(extent)](#to_svg_extent_42) | Bu geometriyi Svg temsiline dönüştürür. |
| [touches(other)](#touches_other_43) | Bu geometri ile belirtilen geometrinin temas edip etmediğini belirler. |
| [union(other)](#union_other_44) | Bu geometriyi ve belirtilen geometriyi birleştirir. |
| [union(other)](#union_other_45) | Bu geometriyi ve belirtilen geometriyi birleştirir. |
| [within(extent)](#within_extent_46) | Bu geometrinin belirtilen kapsam içinde olup olmadığını belirler. |
| [within(other)](#within_other_47) | Bu geometrinin belirtilen geometri içinde olup olmadığını belirler. |
...
Yeni bir [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/) sınıfı örneği başlatır.
...
| :- | :- | :- |
| eğriler | System.Collections.Generic.IEnumerable<ICurve> | Eğrilerin koleksiyonu. |
...
| Parametre | Tür | Açıklama |
| :- | :- | :- |
| other | [ICompoundCurve](/psd/python-net/aspose.gis.geometries/icompoundcurve) | Verilerin kopyalanacağı diğer çizgi. |
...
Bu [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/) sonuna bir eğri ekler.

**Parameters:**

| Parametre | Tür | Açıklama |
| :- | :- | :- |
| curve | [ICurve](/psd/python-net/aspose.gis.geometries/icurve) | Eklenecek eğri. |
...
| Tür | Açıklama |
| :- | :- |
| [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve) | Bu geometrinin düzenlenebilir bir kopyası. |
