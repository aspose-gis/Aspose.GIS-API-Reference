---
title: "IGeometryCollection Sınıfı"
type: docs
weight: 120
url: /tr/python-net/aspose.gis.geometries/igeometrycollection/
---
...
| Parametre | Tür | Açıklama |
| :- | :- | :- |
| tolerans | double | Kullanılacak <c>tolerance</c>. Sonuç, eğri geometriye olan mesafesi <c>tolerance</c> değerinden daha az olacak şekilde garantilenir,<br/>            geometrinin doğrusallaştırılması için gereken nokta sayısı bölge başına maksimum değeri aşmadığı sürece,<br/>            şu anda 10000 nokta eşittir. |
