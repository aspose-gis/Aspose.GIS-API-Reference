---
title: "GdbCircularArcSegment Sınıf"
type: docs
weight: 40
url: /tr/python-net/aspose.gis.common.formats.gdbtable/gdbcirculararcsegment/
---
...
| **Name** | **Description** |
| :- | :- |
| [GdbCircularArcSegment()](#GdbCircularArcSegment__1) | GdbCircularArcSegment sınıfının yeni bir örneğini başlatır |
## **Properties**
...
GdbCircularArcSegment sınıfının yeni bir örneğini başlatır
