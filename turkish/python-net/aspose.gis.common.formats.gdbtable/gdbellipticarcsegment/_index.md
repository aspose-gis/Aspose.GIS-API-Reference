---
title: "GdbEllipticArcSegment Sınıf"
type: docs
weight: 60
url: /tr/python-net/aspose.gis.common.formats.gdbtable/gdbellipticarcsegment/
---
...
| **Name** | **Description** |
| :- | :- |
| [GdbEllipticArcSegment()](#GdbEllipticArcSegment__1) | GdbEllipticArcSegment sınıfının yeni bir örneğini başlatır |
## **Properties**
...
GdbEllipticArcSegment sınıfının yeni bir örneğini başlatır
