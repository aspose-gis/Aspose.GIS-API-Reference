---
title: "GdbMultiPartShape Sınıfı"
type: docs
weight: 80
url: /tr/python-net/aspose.gis.common.formats.gdbtable/gdbmultipartshape/
---
...
| **Name** | **Description** |
| :- | :- |
| [GdbMultiPartShape()](#GdbMultiPartShape__1) | GdbMultiPartShape sınıfının yeni bir örneğini başlatır |
## **Properties**
...
GdbMultiPartShape sınıfının yeni bir örneğini başlatır
