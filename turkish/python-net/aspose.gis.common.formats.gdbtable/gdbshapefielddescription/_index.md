---
title: "GdbShapeFieldDescription Sınıfı"
type: docs
weight: 120
url: /tr/python-net/aspose.gis.common.formats.gdbtable/gdbshapefielddescription/
---
...
| **Name** | **Description** |
| :- | :- |
| [GdbShapeFieldDescription()](#GdbShapeFieldDescription__1) | GdbShapeFieldDescription sınıfının yeni bir örneğini başlatır |
## **Properties**
...
GdbShapeFieldDescription sınıfının yeni bir örneğini başlatır
