---
title: "ProjectedCrsEntry Sınıfı"
type: docs
weight: 80
url: /tr/python-net/aspose.gis.epsg/projectedcrsentry/
---
...
| **Name** | **Description** |
| :- | :- |
| [ProjectedCrsEntry()](#ProjectedCrsEntry__1) | ProjectedCrsEntry sınıfının yeni bir örneğini başlatır |
## **Properties**
...
ProjectedCrsEntry sınıfının yeni bir örneğini başlatır
