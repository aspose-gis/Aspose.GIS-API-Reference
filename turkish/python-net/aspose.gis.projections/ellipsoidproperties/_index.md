---
title: "EllipsoidProperties Sınıfı"
type: docs
weight: 10
url: /tr/python-net/aspose.gis.projections/ellipsoidproperties/
---
...
| **Name** | **Description** |
| :- | :- |
| [EllipsoidProperties(semi_major_axis, inverse_flattening)](#EllipsoidProperties_semi_major_axis_inverse_flattening_1) | EllipsoidProperties sınıfının yeni bir örneğini başlatır |
## **Properties**
...
EllipsoidProperties sınıfının yeni bir örneğini başlatır
