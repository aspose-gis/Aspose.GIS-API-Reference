---
title: "ProjectionParameters Sınıfı"
type: docs
weight: 40
url: /tr/python-net/aspose.gis.projections/projectionparameters/
---
...
| **Name** | **Description** |
| :- | :- |
| [ProjectionParameters()](#ProjectionParameters__1) | ProjectionParameters sınıfının yeni bir örneğini başlatır |
## **Properties**
...
ProjectionParameters sınıfının yeni bir örneğini başlatır
