---
title: "RTreeOptions Sınıfı"
type: docs
weight: 20
url: /tr/python-net/aspose.gis.indexing.rtree/rtreeoptions/
---
...
| **Name** | **Description** |
| :- | :- |
| [RTreeOptions()](#RTreeOptions__1) | RTreeOptions sınıfının yeni bir örneğini başlatır |
## **Properties**
...
RTreeOptions sınıfının yeni bir örneğini başlatır
