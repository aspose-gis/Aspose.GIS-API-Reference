---
title: "KmlLodSettings Sınıfı"
type: docs
weight: 50
url: /tr/python-net/aspose.gis.formats.kml.specificfields/kmllodsettings/
---
...
| max_fade_extent | int | r/w | 'Lod' düğümünün MaxFadeExtent değeri. |
| max_lod_pixels | int | r/w | 'Lod' düğümünün MaxLodPixels değeri. |
| min_fade_extent | int | r/w | 'Lod' düğümünün MinFadeExtent değeri. |
| min_lod_pixels | int | r/w | MinLodPixels 'Lod' düğümünün. |
