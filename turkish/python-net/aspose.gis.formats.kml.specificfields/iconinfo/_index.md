---
title: "IconInfo Sınıfı"
type: docs
weight: 10
url: /tr/python-net/aspose.gis.formats.kml.specificfields/iconinfo/
---
...
| **Name** | **Description** |
| :- | :- |
| [IconInfo(link)](#IconInfo_link_1) | [IconInfo](/psd/python-net/aspose.gis.formats.kml.specificfields/iconinfo/) sınıfının yeni bir örneğini başlatır. |
## **Properties**
| **Name** | **Type** | **Access** | **Description** |
| :- | :- | :- | :- |
| children | [NodeLink[]](/psd/python-net/aspose.gis/nodelink) | r | Çocukları alır. |
| href | string | r/w | href'yi alır veya ayarlar. |
...
[IconInfo](/psd/python-net/aspose.gis.formats.kml.specificfields/iconinfo/) sınıfının yeni bir örneğini başlatır.

**Parameters:**

| Parametre | Tür | Açıklama |
| :- | :- | :- |
| link | [NodeLink](/psd/python-net/aspose.gis/nodelink) | Oluşturulacağı düğüm |
