---
title: "KmlGroundOverlayInfo Sınıfı"
type: docs
weight: 20
url: /tr/python-net/aspose.gis.formats.kml.specificfields/kmlgroundoverlayinfo/
---
...
| draw_order | double | r/w | DrawOrder 'GroundOverlay' düğümünün. |
| icon | [IconInfo](/psd/python-net/aspose.gis.formats.kml.specificfields/iconinfo) | r/w | IconPath 'GroundOverlay' düğümünün. |
| lat_lon_box | [KmlLatLonBox](/psd/python-net/aspose.gis.formats.kml.specificfields/kmllatlonbox) | r/w | Kml 'LatLonAltBox' düğümünden nesneyi belirtir. |
| ad | string | r/w | Ground Overlay adı |
...
| visibility | bool | r/w | Ground Overlay görünürlüğü |
## **Methods**
| **Name** | **Description** |
| :- | :- |
