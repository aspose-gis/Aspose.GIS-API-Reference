---
title: "KmlLatLonAltBox Sınıfı"
type: docs
weight: 30
url: /tr/python-net/aspose.gis.formats.kml.specificfields/kmllatlonaltbox/
---
...
| doğu | double | r/w | 'LatLonBox' düğümünün doğusu. |
| max_altitude | Nullable<double> | r/w | 'LatLonBox' düğümünün MaxAltitude değeri. |
| min_altitude | Nullable<double> | r/w | 'LatLonBox' düğümünün MinAltitude değeri. |
...
| kuzey | double | r/w | 'LatLonBox' düğümünün kuzeyi. |
| ön ek | string | r | Ön eki alır. |
| rotasyon | Nullable<double> | r/w | 'LatLonBox' düğümünün Rotasyonu. |
| güney | double | r/w | 'LatLonBox' düğümünün güneyi. |
| batı | double | r/w | 'LatLonBox' düğümünün batısı. |
## **Methods**
| **Name** | **Description** |
| :- | :- |
