...
| [CreateLayer](../../aspose.gis.formats.gpx/gpxdriver/createlayer#createlayer_3)(AbstractPath, GpxOptions) | Bir katman oluşturur ve onu yeni özellikler eklemek için açar. |
...
| [CreateLayer](../../aspose.gis.formats.gpx/gpxdriver/createlayer#createlayer_9)(string, GpxOptions) | Bir katman oluşturur ve onu yeni özellikler eklemek için açar. |
| [CreateLayer](../../aspose.gis/filedriver/createlayer)(string, SpatialReferenceSystem) | Katmanı oluşturur ve ekleme için açar. |
| override [CreateLayer](../../aspose.gis.formats.gpx/gpxdriver/createlayer#createlayer_2)(AbstractPath, DriverOptions, SpatialReferenceSystem) | Bir katman oluşturur ve onu yeni özellikler eklemek için açar. |
| [CreateLayer](../../aspose.gis.formats.gpx/gpxdriver/createlayer#createlayer_4)(AbstractPath, GpxOptions, SpatialReferenceSystem) | Bir katman oluşturur ve onu yeni özellikler eklemek için açar. |
...
| override [OpenLayer](../../aspose.gis.formats.gpx/gpxdriver/openlayer#openlayer_1)(AbstractPath, DriverOptions) | Okuma için bir katman açar. |
| [OpenLayer](../../aspose.gis.formats.gpx/gpxdriver/openlayer#openlayer_2)(AbstractPath, GpxOptions) | Okuma için bir katman açar. |
| [OpenLayer](../../aspose.gis/filedriver/openlayer)(string, DriverOptions) | Okuma için katmanı açar. |
| [OpenLayer](../../aspose.gis.formats.gpx/gpxdriver/openlayer#openlayer_5)(string, GpxOptions) | Okuma için bir katman açar. |
