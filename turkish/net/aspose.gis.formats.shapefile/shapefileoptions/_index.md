...
description: Aspose.Gis.Formats.Shapefile.ShapefileOptions sınıf. Shapefile formatı için sürücüye özgü seçenekler. Şu anda sürücü hiçbir özelleştirilebilir seçenek sunmuyor.
type: docs
weight: 670
url: /tr/net/aspose.gis.formats.shapefile/shapefileoptions/
---
## ShapefileOptions class

Shapefile formatı için sürücüye özgü seçenekler. Şu anda, sürücü hiçbir özelleştirilebilir seçenek sunmuyor.
...
| İsim | Tanım |
| --- | --- |
| [ShapefileOptions](shapefileoptions/)() | Yeni örnek oluştur. |
