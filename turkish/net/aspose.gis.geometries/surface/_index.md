...
description: Aspose.Gis.Geometries.Surface sınıf. birSurface iki boyutlu geometrik bir nesnedir.
type: docs
weight: 1210
...
bir`Surface` iki boyutlu geometrik bir nesnedir.
...
| abstract [GetPointOnSurface](../../aspose.gis.geometries/surface/getpointonsurface/)() | Bu yüzeyde olması garanti olan bir nokta bulur. |
...
| [ToLinearGeometry](../../aspose.gis.geometries/surface/tolineargeometry/#tolineargeometry_3)(double) | Belirtilen geometriyi kullanarak bu geometrinin yaklaşık veya eşdeğer eğri olmayan versiyonunu alır.`hata payı` . (2 methods) |
