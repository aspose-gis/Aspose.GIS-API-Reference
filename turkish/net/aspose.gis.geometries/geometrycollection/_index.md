...
description: Aspose.Gis.Geometries.GeometryCollection sınıf. birGeometryCollection birGeometry bu bir veya daha fazla geometriden oluşan bir koleksiyondur.
type: docs
weight: 930
...
bir`GeometryCollection` bir[`Geometry`](../geometry/) bu, bir veya daha fazla geometriden oluşan bir koleksiyondur.
...
| İsim | Tanım |
| --- | --- |
| [GeometryCollection](geometrycollection/)() | Yeni bir örneğini başlatır.`GeometryCollection` sınıf. |
...
| [Equals](../../aspose.gis.geometries/geometrycollection/equals/#equals)(IGeometryCollection) | Geçerli nesnenin aynı türden başka bir nesneye eşit olup olmadığını gösterir. |
...
| [ToLinearGeometry](../../aspose.gis.geometries/geometrycollection/tolineargeometry/#tolineargeometry_3)(double) | Belirtilen geometriyi kullanarak bu geometrinin yaklaşık veya eşdeğer eğri olmayan versiyonunu alır.`hata payı` . (2 methods) |
