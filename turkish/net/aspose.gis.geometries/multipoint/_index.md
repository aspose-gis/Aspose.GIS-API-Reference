...
description: AMultiPoint./multipoint tek boyutludurGeometryCollection./geometrycollection öğeleri olanPoint./point s.
type: docs
weight: 1060
...
A[`MultiPoint`](../multipoint) tek boyutludur[`GeometryCollection`](../geometrycollection) öğeleri olan[`Point`](../point) s.
...
| İsim | Tanım |
| --- | --- |
| [MultiPoint](multipoint)() | Yeni bir örneğini başlatır[`MultiPoint`](../multipoint) sınıf. |
...
| [ToLinearGeometry](../../aspose.gis.geometries/geometrycollection/tolineargeometry)(double) | Belirtilen geometriyi kullanarak bu geometrinin yaklaşık veya eşdeğer eğri olmayan sürümünü alır`hata payı` . (2 methods) |
