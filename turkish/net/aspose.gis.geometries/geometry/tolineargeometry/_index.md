...
Eğri geometrisi olmayan bir geometri. Aşağıdaki dönüşümler uygulanır: CircularString s doğrusallaştırılmış (dönüştürülmüşLineString s ile belirtilen*tolerance* )CompoundCurve s birleştirilir`Çizgi Dizisi` sCurvePolygon s dönüştürülürPolygon sMultiCurve s dönüştürülürMultiLineString sMultiSurface s dönüştürülürMultiPolygon s Sonuç olarak,[`HasCurveGeometry`](../../igeometry/hascurvegeometry) çıkış geometrisi`false` .
