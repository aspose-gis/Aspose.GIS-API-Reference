...
description: Aspose.Gis.Geometries.LineString sınıf. Çok köşeli bir çizgi.
type: docs
weight: 1120
url: /tr/net/aspose.gis.geometries/linestring/
---
## LineString class

Çok köşeli bir çizgi.
...
| İsim | Tanım |
| --- | --- |
| [LineString](linestring/#constructor)() | Yeni bir örneğini başlatır.`LineString` sınıf. |
| [LineString](linestring/#constructor_2)(IEnumerable&lt;IPoint&gt;) | Yeni bir örneğini başlatır.`LineString` sınıf. |
| [LineString](linestring/#constructor_1)(ILineString) | Yeni bir örneğini başlatır.`LineString` sınıf. |
...
| [Count](../../aspose.gis.geometries/linestring/count/) { get; } | İçindeki puan sayısını alır.`LineString` . |
...
| override [GeometryType](../../aspose.gis.geometries/linestring/geometrytype/) { get; } | Geometrinin türünü alır. |
...
| [Item](../../aspose.gis.geometries/linestring/item/) { get; set; } | Şunu alır veya ayarlar:[`IPoint`](../ipoint/) belirtilen dizinde. |
| [SpatialReferenceSystem](../../aspose.gis.geometries/linestring/spatialreferencesystem/) { get; set; } | Bu örneğin SpatialReferenceSystem'ını alır. Bu özellik şu şekilde olabilir:`null` , SpatialReferenceSystem ayarlanmamışsa. Yeni SpatialReferenceSystem atandığında herhangi bir koordinat dönüşümü gerçekleştirilmez, sadece referans değişir. |
...
| İsim | Tanım |
| --- | --- |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint/#addpoint)(IPoint) | Satırın sonuna bir nokta ekler. |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint/#addpoint_1)(double, double) | Satırın sonuna bir nokta ekler. |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint/#addpoint_2)(double, double, double) | Satırın sonuna bir nokta ekler. |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint/#addpoint_3)(double, double, double, double) | Satırın sonuna bir nokta ekler. |
...
| override [Clone](../../aspose.gis.geometries/linestring/clone/)() | Bu örneği klonlar. |
...
| [Equals](../../aspose.gis.geometries/linestring/equals/#equals)(ILineString) | Geçerli nesnenin aynı türden başka bir nesneye eşit olup olmadığını gösterir. |
| override [Equals](../../aspose.gis.geometries/linestring/equals/#equals_1)(object) | Belirtilen nesnenin geçerli nesneye eşit olup olmadığını belirler. |
...
| override [GetHashCode](../../aspose.gis.geometries/linestring/gethashcode/)() | Varsayılan karma işlevi olarak işlev görür. |
...
| override [Reverse](../../aspose.gis.geometries/linestring/reverse/)() | Buradaki noktaların sırasını tersine çevirir`LineString` . |
...
| [ToEditable](../../aspose.gis.geometries/linestring/toeditable/#toeditable_2)() | Bu geometrinin düzenlenebilir bir kopyasını alır. (3 methods) |
...
| [operator ==](../../aspose.gis.geometries/linestring/op_equality/) | ==. operatörünü uygular |
| [operator !=](../../aspose.gis.geometries/linestring/op_inequality/) | !=. operatörünü uygular |
