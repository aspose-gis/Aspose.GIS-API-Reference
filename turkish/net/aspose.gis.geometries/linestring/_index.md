...
description: Çoklu köşe çizgisi.
type: docs
weight: 1020
...
| İsim | Tanım |
| --- | --- |
| [LineString](linestring#constructor)() | Yeni bir örneğini başlatır[`LineString`](../linestring) sınıf. |
| [LineString](linestring#constructor_2)(IEnumerable&lt;IPoint&gt;) | Yeni bir örneğini başlatır[`LineString`](../linestring) sınıf. |
| [LineString](linestring#constructor_1)(ILineString) | Yeni bir örneğini başlatır[`LineString`](../linestring) sınıf. |
...
| [Equals](../../aspose.gis.geometries/linestring/equals#equals)(ILineString) | Geçerli nesnenin aynı türdeki başka bir nesneye eşit olup olmadığını gösterir. |
