...
description: Aspose.Gis.Geometries.Polygon sınıf. birPolygon 1 dış sınır ve 0 veya daha fazla iç sınır tarafından tanımlanan düzlemsel bir yüzeydir.
type: docs
weight: 1200
url: /tr/net/aspose.gis.geometries/polygon/
---
## Polygon class

bir`Polygon` 1 dış sınır ve 0 veya daha fazla iç sınır tarafından tanımlanan, düzlemsel bir yüzeydir.
...
| İsim | Tanım |
| --- | --- |
| [Polygon](polygon/#constructor)() | Yeni bir örneğini başlatır.`Polygon` sınıf. |
| [Polygon](polygon/#constructor_1)(ILinearRing) | Yeni bir örneğini başlatır.`Polygon` sınıf. |
| [Polygon](polygon/#constructor_2)(ILinearRing, IEnumerable&lt;ILinearRing&gt;) | Yeni bir örneğini başlatır.`Polygon` sınıf. |
...
| [ExteriorRing](../../aspose.gis.geometries/polygon/exteriorring/) { get; set; } | Dış halkayı alır. |
| override [GeometryType](../../aspose.gis.geometries/polygon/geometrytype/) { get; } | Geometrinin türünü alır. |
...
| override [HasM](../../aspose.gis.geometries/polygon/hasm/) { get; set; } | Bu örneğin M koordinatına sahip olup olmadığını gösteren bir değer alır. |
| override [HasZ](../../aspose.gis.geometries/polygon/hasz/) { get; set; } | Bu örneğin Z koordinatına sahip olup olmadığını gösteren bir değer alır. |
| [InteriorRingsCount](../../aspose.gis.geometries/polygon/interiorringscount/) { get; } | İç halkaların sayısını alır. |
| override [IsEmpty](../../aspose.gis.geometries/polygon/isempty/) { get; } | Bu örneğin boş olup olmadığını gösteren bir değer alır. |
...
| override [SpatialReferenceSystem](../../aspose.gis.geometries/polygon/spatialreferencesystem/) { get; set; } | Bu örneğin SpatialReferenceSystem'ını alır. Bu özellik şu şekilde olabilir:`null` , SpatialReferenceSystem isknown. Yeni SpatialReferenceSystem ataması herhangi bir koordinat dönüşümü gerçekleştirmeyecek, sadece referans değişecek. |

## yöntemler

| İsim | Tanım |
| --- | --- |
| [AddInteriorRing](../../aspose.gis.geometries/polygon/addinteriorring/)(ILinearRing) | Bir iç halka ekler. |
...
| override [Clone](../../aspose.gis.geometries/polygon/clone/)() | Bu örneği klonlar. |
...
| [Equals](../../aspose.gis.geometries/polygon/equals/#equals)(ICurvePolygon) | Belirtilen nesnenin geçerli nesneye eşit olup olmadığını belirler. |
| [Equals](../../aspose.gis.geometries/polygon/equals/#equals_1)(IPolygon) | Belirtilen nesnenin geçerli nesneye eşit olup olmadığını belirler. |
| override [Equals](../../aspose.gis.geometries/polygon/equals/#equals_2)(object) | Belirtilen nesnenin geçerli nesneye eşit olup olmadığını belirler. |
...
| override [GetHashCode](../../aspose.gis.geometries/polygon/gethashcode/)() | Varsayılan karma işlevi olarak işlev görür. |
| [GetInteriorRing](../../aspose.gis.geometries/polygon/getinteriorring/)(int) | İç halkayı indeksine göre alır. |
| [GetLength](../../aspose.gis.geometries/geometry/getlength/)() | Bu geometrinin uzunluğunu hesaplar. |
| override [GetPointOnSurface](../../aspose.gis.geometries/polygon/getpointonsurface/)() | Bu çokgen üzerinde olması garanti olan bir nokta bulur. |
...
| override [SetEmpty](../../aspose.gis.geometries/polygon/setempty/)() | Bunu yapar[`Geometry`](../geometry/) boş. |
...
| [ToEditable](../../aspose.gis.geometries/polygon/toeditable/#toeditable_1)() | Bu geometrinin düzenlenebilir bir kopyasını alır. (3 methods) |
...
| [ToLinearGeometry](../../aspose.gis.geometries/surface/tolineargeometry/)(double) | Belirtilen geometriyi kullanarak bu geometrinin yaklaşık veya eşdeğer eğri olmayan versiyonunu alır.`hata payı` . (2 methods) |
...
| [operator ==](../../aspose.gis.geometries/polygon/op_equality/) | ==. operatörünü uygular |
| [operator !=](../../aspose.gis.geometries/polygon/op_inequality/) | !=. operatörünü uygular |
