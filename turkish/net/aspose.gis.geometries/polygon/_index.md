...
description: APolygon./polygon düzlemsel bir yüzeydir 1 dış sınır ve 0 veya daha fazla iç sınır ile tanımlanır.
type: docs
weight: 1100
...
A[`Polygon`](../polygon) düzlemsel bir yüzeydir, 1 dış sınır ve 0 veya daha fazla iç sınır ile tanımlanır.
...
| İsim | Tanım |
| --- | --- |
| [Polygon](polygon#constructor)() | Yeni bir örneğini başlatır[`Polygon`](../polygon) sınıf. |
| [Polygon](polygon#constructor_1)(ILinearRing) | Yeni bir örneğini başlatır[`Polygon`](../polygon) sınıf. |
| [Polygon](polygon#constructor_2)(ILinearRing, IEnumerable&lt;ILinearRing&gt;) | Yeni bir örneğini başlatır[`Polygon`](../polygon) sınıf. |
...
| override [SpatialReferenceSystem](../../aspose.gis.geometries/polygon/spatialreferencesystem) { get; set; } | Bu örneğin SpatialReferenceSystem'ını alır. Bu özellik`null` , SpatialReferenceSystem bilinmiyor. Yeni SpatialReferenceSystem atamak herhangi bir koordinat dönüşümü gerçekleştirmez, yalnızca referans değişir. |
...
| override [GetHashCode](../../aspose.gis.geometries/polygon/gethashcode)() | Varsayılan karma işlevi olarak hizmet eder. |
| [GetInteriorRing](../../aspose.gis.geometries/polygon/getinteriorring)(int) | Dizinine göre iç halkayı alır. |
| [GetLength](../../aspose.gis.geometries/geometry/getlength)() | Bu geometrinin uzunluğunu hesaplar. |
| override [GetPointOnSurface](../../aspose.gis.geometries/polygon/getpointonsurface)() | Bu çokgen üzerinde olması garanti edilen bir nokta bulur. |
