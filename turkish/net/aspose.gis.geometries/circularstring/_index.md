...
type: docs
weight: 780
url: /tr/net/aspose.gis.geometries/circularstring/
---
...
| İsim | Tanım |
| --- | --- |
| [CircularString](circularstring#constructor)() | Yeni bir örneğini başlatır[`CircularString`](../circularstring) sınıf. |
| [CircularString](circularstring#constructor_1)(ICircularString) | Yeni bir örneğini başlatır[`CircularString`](../circularstring) sınıf. |
| [CircularString](circularstring#constructor_2)(IEnumerable&lt;IPoint&gt;) | Yeni bir örneğini başlatır[`CircularString`](../circularstring) sınıf. |
...
| [Count](../../aspose.gis.geometries/circularstring/count) { get; } | [`CircularString`](../circularstring) . |
| [Dimension](../../aspose.gis.geometries/curve/dimension) { get; } | Bunun topolojik boyutunu alır[`Geometry`](../geometry) . |
| override [EndPoint](../../aspose.gis.geometries/circularstring/endpoint) { get; } | Eğrinin bitiş noktasının bir kopyasını döndürür. |
| override [GeometryType](../../aspose.gis.geometries/circularstring/geometrytype) { get; } | Geometrinin türünü alır. |
| override [HasCurveGeometry](../../aspose.gis.geometries/circularstring/hascurvegeometry) { get; } | Bu geometrinin eğri (doğrusal değil) geometrisi olup olmadığını veya içerip içermediğini gösteren bir değer alır. |
| [HasM](../../aspose.gis.geometries/circularstring/hasm) { get; set; } | Bu örneğin M koordinatına sahip olup olmadığını gösteren bir değer alır. |
| [HasZ](../../aspose.gis.geometries/circularstring/hasz) { get; set; } | Bu örneğin Z koordinatına sahip olup olmadığını gösteren bir değer alır. |
...
| override [IsEmpty](../../aspose.gis.geometries/circularstring/isempty) { get; } | Bu örneğin boş olup olmadığını gösteren bir değer alır. |
...
| [Item](../../aspose.gis.geometries/circularstring/item) { get; set; } | Alır veya ayarlar[`IPoint`](../ipoint) belirtilen dizinde. |
| [SpatialReferenceSystem](../../aspose.gis.geometries/circularstring/spatialreferencesystem) { get; set; } | Bu örneğin SpatialReferenceSystem'ını alır. Bu özellik`null` , eğer SpatialReferenceSystem ayarlanmamışsa. Yeni SpatialReferenceSystem atamak herhangi bir koordinat dönüşümü gerçekleştirmez, sadece referans değişir. |
| override [StartPoint](../../aspose.gis.geometries/circularstring/startpoint) { get; } | Eğrinin başlangıç noktasının bir kopyasını döndürür. |

## yöntemler

| İsim | Tanım |
| --- | --- |
| [AddPoint](../../aspose.gis.geometries/circularstring/addpoint#addpoint)(IPoint) | Dairesel dizenin sonuna bir nokta ekler. |
| [AddPoint](../../aspose.gis.geometries/circularstring/addpoint#addpoint_1)(double, double) | Dairesel dizenin sonuna bir nokta ekler. |
| [AddPoint](../../aspose.gis.geometries/circularstring/addpoint#addpoint_2)(double, double, double) | Dairesel dizenin sonuna bir nokta ekler. |
| [AddPoint](../../aspose.gis.geometries/circularstring/addpoint#addpoint_3)(double, double, double, double) | Dairesel dizenin sonuna bir nokta ekler. |
...
| override [Clone](../../aspose.gis.geometries/circularstring/clone)() | Bu örneği klonlar. |
...
| [Equals](../../aspose.gis.geometries/circularstring/equals#equals)(ICircularString) | Geçerli nesnenin aynı türdeki başka bir nesneye eşit olup olmadığını gösterir. |
| override [Equals](../../aspose.gis.geometries/circularstring/equals#equals_1)(object) | Belirtilen nesnenin geçerli nesneye eşit olup olmadığını belirler. |
...
| [GetEnumerator](../../aspose.gis.geometries/circularstring/getenumerator)() | Koleksiyon boyunca yinelenen bir Numaralandırıcı döndürür. |
| [GetExtent](../../aspose.gis.geometries/geometry/getextent)() | Bu geometrinin sınırlayıcı bir kapsamını hesaplar ve döndürür. |
| override [GetHashCode](../../aspose.gis.geometries/circularstring/gethashcode)() | Varsayılan karma işlevi olarak hizmet eder. |
...
| override [Reverse](../../aspose.gis.geometries/circularstring/reverse)() | Buradaki noktaların sırasını tersine çevirir[`CircularString`](../circularstring) . |
...
| override [SetEmpty](../../aspose.gis.geometries/circularstring/setempty)() | Bunu yapar[`Geometry`](../geometry) boş. |
...
| [ToEditable](../../aspose.gis.geometries/circularstring/toeditable#toeditable)() | Bu geometrinin düzenlenebilir bir kopyasını alır. (3 methods) |
...
| [operator ==](../../aspose.gis.geometries/circularstring/op_equality) | ==. operatörünü uygular |
| [operator !=](../../aspose.gis.geometries/circularstring/op_inequality) | Operatörünü uygular !=. |
