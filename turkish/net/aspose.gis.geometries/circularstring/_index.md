...
description: Aspose.Gis.Geometries.CircularString sınıf. Noktalar arasında dairesel enterpolasyona sahip çok köşeli bir eğri.
type: docs
weight: 880
...
| İsim | Tanım |
| --- | --- |
| [CircularString](circularstring/#constructor)() | Yeni bir örneğini başlatır.`CircularString` sınıf. |
| [CircularString](circularstring/#constructor_1)(ICircularString) | Yeni bir örneğini başlatır.`CircularString` sınıf. |
| [CircularString](circularstring/#constructor_2)(IEnumerable&lt;IPoint&gt;) | Yeni bir örneğini başlatır.`CircularString` sınıf. |
...
| [Count](../../aspose.gis.geometries/circularstring/count/) { get; } | İçindeki puan sayısını alır.`CircularString` . |
...
| override [HasCurveGeometry](../../aspose.gis.geometries/circularstring/hascurvegeometry/) { get; } | Bu geometrinin eğri (doğrusal olmayan) geometri olup olmadığını veya içerip içermediğini gösteren bir değer alır. |
...
| [Item](../../aspose.gis.geometries/circularstring/item/) { get; set; } | Şunu alır veya ayarlar:[`IPoint`](../ipoint/) belirtilen dizinde. |
| [SpatialReferenceSystem](../../aspose.gis.geometries/circularstring/spatialreferencesystem/) { get; set; } | Bu örneğin SpatialReferenceSystem'ını alır. Bu özellik şu şekilde olabilir:`null` , SpatialReferenceSystem ayarlanmamışsa. Yeni SpatialReferenceSystem atandığında herhangi bir koordinat dönüşümü gerçekleştirilmez, sadece referans değişir. |
...
| İsim | Tanım |
| --- | --- |
| [AddPoint](../../aspose.gis.geometries/circularstring/addpoint/#addpoint)(IPoint) | Dairesel dizinin sonuna bir nokta ekler. |
| [AddPoint](../../aspose.gis.geometries/circularstring/addpoint/#addpoint_1)(double, double) | Dairesel dizinin sonuna bir nokta ekler. |
| [AddPoint](../../aspose.gis.geometries/circularstring/addpoint/#addpoint_2)(double, double, double) | Dairesel dizinin sonuna bir nokta ekler. |
| [AddPoint](../../aspose.gis.geometries/circularstring/addpoint/#addpoint_3)(double, double, double, double) | Dairesel dizinin sonuna bir nokta ekler. |
...
| [Equals](../../aspose.gis.geometries/circularstring/equals/#equals)(ICircularString) | Geçerli nesnenin aynı türden başka bir nesneye eşit olup olmadığını gösterir. |
...
| override [GetHashCode](../../aspose.gis.geometries/circularstring/gethashcode/)() | Varsayılan karma işlevi olarak işlev görür. |
...
| override [Reverse](../../aspose.gis.geometries/circularstring/reverse/)() | Buradaki noktaların sırasını tersine çevirir`CircularString` . |
