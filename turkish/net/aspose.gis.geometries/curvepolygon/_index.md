...
description: Aspose.Gis.Geometries.CurvePolygon sınıf. 1 dış sınır ve 0 veya daha fazla iç sınır tarafından tanımlanan düzlemsel bir yüzey.
type: docs
weight: 910
...
1 dış sınır ve 0 veya daha fazla iç sınır tarafından tanımlanan düzlemsel bir yüzey.
...
| İsim | Tanım |
| --- | --- |
| [CurvePolygon](curvepolygon/#constructor)() | Yeni bir örneğini başlatır.`CurvePolygon` sınıf. |
| [CurvePolygon](curvepolygon/#constructor_1)(ICurve) | Yeni bir örneğini başlatır.`CurvePolygon` sınıf. |
| [CurvePolygon](curvepolygon/#constructor_2)(ICurve, IEnumerable&lt;ICurve&gt;) | Yeni bir örneğini başlatır.`CurvePolygon` sınıf. |
...
| override [HasCurveGeometry](../../aspose.gis.geometries/curvepolygon/hascurvegeometry/) { get; } | Bu geometrinin eğri (doğrusal olmayan) geometri olup olmadığını veya içerip içermediğini gösteren bir değer alır. |
...
| [SpatialReferenceSystem](../../aspose.gis.geometries/curvepolygon/spatialreferencesystem/) { get; set; } | Bu örneğin SpatialReferenceSystem'ını alır. Bu özellik şu şekilde olabilir:`null` , SpatialReferenceSystem isknown. Yeni SpatialReferenceSystem ataması herhangi bir koordinat dönüşümü gerçekleştirmeyecek, sadece referans değişecek. |
...
| [Equals](../../aspose.gis.geometries/curvepolygon/equals/#equals)(ICurvePolygon) | Geçerli nesnenin aynı türden başka bir nesneye eşit olup olmadığını gösterir. |
...
| override [GetHashCode](../../aspose.gis.geometries/curvepolygon/gethashcode/)() | Varsayılan karma işlevi olarak işlev görür. |
| [GetInteriorRing](../../aspose.gis.geometries/curvepolygon/getinteriorring/)(int) | İç halkayı indeksine göre alır. |
| [GetLength](../../aspose.gis.geometries/geometry/getlength/)() | Bu geometrinin uzunluğunu hesaplar. |
| override [GetPointOnSurface](../../aspose.gis.geometries/curvepolygon/getpointonsurface/)() | Bu eğri çokgen üzerinde olması garanti olan bir nokta bulur. |
