...
description: Aspose.Gis.Geometries.MultiPolygon sınıf. birMultiPolygon tek boyutlu bir GeometryCollection elementleri olanPolygon s.
type: docs
weight: 1170
...
bir`MultiPolygon` tek boyutlu bir [`GeometryCollection`](../geometrycollection/) elementleri olan[`Polygon`](../polygon/) s.
...
| İsim | Tanım |
| --- | --- |
| [MultiPolygon](multipolygon/)() | Yeni bir örneğini başlatır.`MultiPolygon` sınıf. |
...
| [ToLinearGeometry](../../aspose.gis.geometries/multisurface/tolineargeometry/)(double) | Belirtilen geometriyi kullanarak bu geometrinin yaklaşık veya eşdeğer eğri olmayan versiyonunu alır.`hata payı` . (3 methods) |
