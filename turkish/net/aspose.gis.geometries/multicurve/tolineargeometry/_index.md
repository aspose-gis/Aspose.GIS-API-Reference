...
description: MultiCurve yöntem. Belirtilen geometriyi kullanarak bu geometrinin yaklaşık veya eşdeğer eğri olmayan versiyonunu alır.hata payı .
type: docs
weight: 70
...
Bir[`IMultiLineString`](../../imultilinestring/) buna yaklaşan veya buna eşdeğer olan[`IMultiCurve`](../../imulticurve/) :  Bu nesne ise[`IMultiLineString`](../../imultilinestring/) kendisi sonuç bu object ile eşdeğerdir Bu nesne değilse[`IMultiLineString`](../../imultilinestring/) - tüm eğriler doğrusallaştırılmıştır ve yenidir`IMultiLineString` oluşturuldu
