...
description: Aspose.Gis.Geometries.MultiCurve sınıf. birMultiCurve tek boyutluGeometryCollection öğeleri olan Curve s.
type: docs
weight: 1140
...
bir`MultiCurve` tek boyutlu[`GeometryCollection`](../geometrycollection/) öğeleri olan [`Curve`](../curve/) s.
...
| İsim | Tanım |
| --- | --- |
| [MultiCurve](multicurve/)() | Yeni bir örneğini başlatır.`MultiCurve` sınıf. |
...
| [ToLinearGeometry](../../aspose.gis.geometries/multicurve/tolineargeometry/#tolineargeometry_5)(double) | Belirtilen geometriyi kullanarak bu geometrinin yaklaşık veya eşdeğer eğri olmayan versiyonunu alır.`hata payı` . (3 methods) |
