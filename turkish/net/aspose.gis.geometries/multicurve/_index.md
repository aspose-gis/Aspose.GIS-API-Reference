...
type: docs
weight: 1040
url: /tr/net/aspose.gis.geometries/multicurve/
---
## MultiCurve class
...
| İsim | Tanım |
| --- | --- |
| [MultiCurve](multicurve)() | Yeni bir örneğini başlatır[`MultiCurve`](../multicurve) sınıf. |
...
| override [GeometryType](../../aspose.gis.geometries/multicurve/geometrytype) { get; } | Geometrinin türünü alır. |
...
| override [Clone](../../aspose.gis.geometries/multicurve/clone)() | Bu örneği klonlar. |
...
| [ToEditable](../../aspose.gis.geometries/multicurve/toeditable#toeditable_2)() | Bu geometrinin düzenlenebilir bir kopyasını alır. (3 methods) |
| [ToEditable&lt;T&gt;](../../aspose.gis.geometries/geometry/toeditable)() | Bu geometrinin düzenlenebilir bir kopyasını alır. |
| [ToLinearGeometry](../../aspose.gis.geometries/multicurve/tolineargeometry#tolineargeometry_4)() | Varsayılanı kullanarak bu geometrinin yaklaşık veya eşdeğer eğri olmayan sürümünü alır`hata payı` . (3 methods) |
| [ToLinearGeometry](../../aspose.gis.geometries/multicurve/tolineargeometry#tolineargeometry_5)(double) | Belirtilen geometriyi kullanarak bu geometrinin yaklaşık veya eşdeğer eğri olmayan sürümünü alır`hata payı` . (3 methods) |
