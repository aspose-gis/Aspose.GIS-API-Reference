...
description: Aspose.Gis.Geometries.MultiLineString sınıf. birMultiLineString tek boyutluGeometryCollection öğeleri olan LineString s.
type: docs
weight: 1150
...
bir`MultiLineString` tek boyutlu[`GeometryCollection`](../geometrycollection/) öğeleri olan [`LineString`](../linestring/) s.
...
| İsim | Tanım |
| --- | --- |
| [MultiLineString](multilinestring/)() | Yeni bir örneğini başlatır.`MultiLineString` sınıf. |
...
| [ToLinearGeometry](../../aspose.gis.geometries/multicurve/tolineargeometry/)(double) | Belirtilen geometriyi kullanarak bu geometrinin yaklaşık veya eşdeğer eğri olmayan versiyonunu alır.`hata payı` . (3 methods) |
