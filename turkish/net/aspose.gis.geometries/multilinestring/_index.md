...
type: docs
weight: 1050
url: /tr/net/aspose.gis.geometries/multilinestring/
---
...
| İsim | Tanım |
| --- | --- |
| [MultiLineString](multilinestring)() | Yeni bir örneğini başlatır[`MultiLineString`](../multilinestring) sınıf. |
...
| [Dimension](../../aspose.gis.geometries/multicurve/dimension) { get; } | Bunun topolojik boyutunu alır[`Geometry`](../geometry) . |
| override [GeometryType](../../aspose.gis.geometries/multilinestring/geometrytype) { get; } | Geometrinin türünü alır. |
...
| virtual [IsClosed](../../aspose.gis.geometries/multicurve/isclosed) { get; } | Bu eğrinin kapalı olup olmadığını belirler. |
...
| override [Clone](../../aspose.gis.geometries/multilinestring/clone)() | Bu örneği klonlar. |
...
| [ToEditable](../../aspose.gis.geometries/multilinestring/toeditable#toeditable_3)() | Bu geometrinin düzenlenebilir bir kopyasını alır. (4 methods) |
| [ToEditable&lt;T&gt;](../../aspose.gis.geometries/geometry/toeditable)() | Bu geometrinin düzenlenebilir bir kopyasını alır. |
| [ToLinearGeometry](../../aspose.gis.geometries/multicurve/tolineargeometry)() | Varsayılanı kullanarak bu geometrinin yaklaşık veya eşdeğer eğri olmayan sürümünü alır`hata payı` . (3 methods) |
| [ToLinearGeometry](../../aspose.gis.geometries/multicurve/tolineargeometry)(double) | Belirtilen geometriyi kullanarak bu geometrinin yaklaşık veya eşdeğer eğri olmayan sürümünü alır`hata payı` . (3 methods) |
