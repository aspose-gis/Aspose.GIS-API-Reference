...
description: Aspose.Gis.Geometries.LinearRing sınıf. birLinearRing birLineString bu hem kapalı hem de basit.
type: docs
weight: 1130
...
bir`LinearRing` bir[`LineString`](../linestring/) bu hem kapalı hem de basit.
...
| İsim | Tanım |
| --- | --- |
| [LinearRing](linearring/#constructor)() | Yeni bir örneğini başlatır.`LinearRing` sınıf. |
| [LinearRing](linearring/#constructor_2)(IEnumerable&lt;IPoint&gt;) | Yeni bir örneğini başlatır.`LinearRing` sınıf. |
| [LinearRing](linearring/#constructor_1)(ILineString) | Yeni bir örneğini başlatır.`LinearRing` sınıf. |
...
| [Count](../../aspose.gis.geometries/linestring/count/) { get; } | İçindeki puan sayısını alır.[`LineString`](../linestring/) . |
...
| [Equals](../../aspose.gis.geometries/linestring/equals/)(ILineString) | Geçerli nesnenin aynı türden başka bir nesneye eşit olup olmadığını gösterir. |
...
| [IsClockwise](../../aspose.gis.geometries/linearring/isclockwise/)() | Halkanın saat yönünde sarımı olup olmadığını belirler. |
