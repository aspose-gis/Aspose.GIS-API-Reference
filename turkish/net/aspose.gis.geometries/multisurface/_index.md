...
description: Aspose.Gis.Geometries.MultiSurface sınıf. birMultiSurface tek boyutluGeometryCollection elementleri olanISurface s.
type: docs
weight: 1180
...
bir`MultiSurface` tek boyutlu[`GeometryCollection`](../geometrycollection/) elementleri olan[`ISurface`](../isurface/) s.
...
| İsim | Tanım |
| --- | --- |
| [MultiSurface](multisurface/)() | Yeni bir örneğini başlatır.`MultiSurface` sınıf. |
...
| [ToLinearGeometry](../../aspose.gis.geometries/multisurface/tolineargeometry/#tolineargeometry_5)(double) | Belirtilen geometriyi kullanarak bu geometrinin yaklaşık veya eşdeğer eğri olmayan versiyonunu alır.`hata payı` . (3 methods) |
