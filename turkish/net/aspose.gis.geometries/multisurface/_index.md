...
description: AMultiSurface./multisurface tek boyutludurGeometryCollection./geometrycollection kimin unsurlarıISurface./isurface s.
type: docs
weight: 1080
url: /tr/net/aspose.gis.geometries/multisurface/
---
## MultiSurface class

A[`MultiSurface`](../multisurface) tek boyutludur[`GeometryCollection`](../geometrycollection) kimin unsurları[`ISurface`](../isurface) s.
...
| İsim | Tanım |
| --- | --- |
| [MultiSurface](multisurface)() | Yeni bir örneğini başlatır[`MultiSurface`](../multisurface) sınıf. |
...
| override [GeometryType](../../aspose.gis.geometries/multisurface/geometrytype) { get; } | Geometrinin türünü alır. |
...
| override [Clone](../../aspose.gis.geometries/multisurface/clone)() | Bu örneği klonlar. |
...
| [ToEditable](../../aspose.gis.geometries/multisurface/toeditable#toeditable_2)() | Bu geometrinin düzenlenebilir bir kopyasını alır. (3 methods) |
| [ToEditable&lt;T&gt;](../../aspose.gis.geometries/geometry/toeditable)() | Bu geometrinin düzenlenebilir bir kopyasını alır. |
| [ToLinearGeometry](../../aspose.gis.geometries/multisurface/tolineargeometry#tolineargeometry_4)() | Varsayılanı kullanarak bu geometrinin yaklaşık veya eşdeğer eğri olmayan sürümünü alır`hata payı` . (3 methods) |
| [ToLinearGeometry](../../aspose.gis.geometries/multisurface/tolineargeometry#tolineargeometry_5)(double) | Belirtilen geometriyi kullanarak bu geometrinin yaklaşık veya eşdeğer eğri olmayan sürümünü alır`hata payı` . (3 methods) |
