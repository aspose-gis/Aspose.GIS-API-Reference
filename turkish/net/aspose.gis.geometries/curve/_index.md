...
description: Aspose.Gis.Geometries.Curve sınıf. birCurve bir nokta dizisidir.
type: docs
weight: 900
url: /tr/net/aspose.gis.geometries/curve/
---
## Curve class

bir`Curve` bir nokta dizisidir.
...
| abstract [EndPoint](../../aspose.gis.geometries/curve/endpoint/) { get; } | Eğrinin bitiş noktasının bir kopyasını döndürür. |
...
| abstract [StartPoint](../../aspose.gis.geometries/curve/startpoint/) { get; } | Eğrinin başlangıç noktasının bir kopyasını döndürür. |
...
| abstract [Reverse](../../aspose.gis.geometries/curve/reverse/)() | Bu eğriyi tersine çevirir. |
...
| [ToEditable](../../aspose.gis.geometries/curve/toeditable/#toeditable)() | Bu geometrinin düzenlenebilir bir kopyasını alır. (2 methods) |
| [ToEditable&lt;T&gt;](../../aspose.gis.geometries/geometry/toeditable/)() | Bu geometrinin düzenlenebilir bir kopyasını alır. |
| [ToLinearGeometry](../../aspose.gis.geometries/curve/tolineargeometry/#tolineargeometry_2)() | Varsayılanı kullanarak bu geometrinin yaklaşık veya eşdeğer eğri olmayan sürümünü alır`hata payı` . (2 methods) |
| [ToLinearGeometry](../../aspose.gis.geometries/curve/tolineargeometry/#tolineargeometry_3)(double) | Belirtilen geometriyi kullanarak bu geometrinin yaklaşık veya eşdeğer eğri olmayan versiyonunu alır.`hata payı` . (2 methods) |
