...
description: ACurve./curve noktalar dizisidir.
type: docs
weight: 800
...
A[`Curve`](../curve) noktalar dizisidir.
...
| [ToLinearGeometry](../../aspose.gis.geometries/curve/tolineargeometry#tolineargeometry_3)(double) | Belirtilen geometriyi kullanarak bu geometrinin yaklaşık veya eşdeğer eğri olmayan sürümünü alır`hata payı` . (2 methods) |
