...
description: IMultiSurface yöntem. Varsayılanı kullanarak bu geometrinin yaklaşık veya eşdeğer eğri olmayan sürümünü alırhata payı .
type: docs
weight: 20
...
Bir[`IMultiPolygon`](../../imultipolygon/) buna yaklaşan veya buna eşdeğer olan[`IMultiSurface`](../) :  Bu nesne ise[`IMultiPolygon`](../../imultipolygon/) kendisi sonuç bu object ile eşdeğerdir Bu nesne değilse[`IMultiPolygon`](../../imultipolygon/) - tüm yüzeyler doğrusallaştırılmış ve yeni`IMultiPolygon` oluşturuldu
