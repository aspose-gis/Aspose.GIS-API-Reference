...
description: Aspose.Gis.Formats.TopoJson.TopoJsonOptions sınıf. TopoJSON biçimi için sürücüye özgü seçenekler.
type: docs
weight: 710
...
| [DefaultObjectName](../../aspose.gis.formats.topojson/topojsonoptions/defaultobjectname/) { get; set; } | Özelliklerin varsayılan olarak konulduğu nesnenin adı. |
...
| [NestedPropertiesSeparator](../../aspose.gis.formats.topojson/topojsonoptions/nestedpropertiesseparator/) { get; set; } | İç içe özniteliklerin bileşenlerini ayırmak için kullanılan bir dizeyi alır veya ayarlar. Varsayılan değer "_". |
| [ObjectNameAttribute](../../aspose.gis.formats.topojson/topojsonoptions/objectnameattribute/) { get; set; } | Bir özellik içeren nesnenin adını yansıtan özelliğin adı. |
| [QuantizationNumber](../../aspose.gis.formats.topojson/topojsonoptions/quantizationnumber/) { get; set; } | TopoJSON. çıktısında koordinatları nicelemek ve yayları delta kodlamak için kullanılacak niceleme sayısını belirtir |
