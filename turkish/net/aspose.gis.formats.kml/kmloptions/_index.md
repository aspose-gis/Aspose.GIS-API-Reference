...
description: KML formatı için sürücüye özel seçenekler.
type: docs
weight: 340
...
KML formatı için sürücüye özel seçenekler.
...
| [SymbolToReplaceInvalidChars](../../aspose.gis.formats.kml/kmloptions/symboltoreplaceinvalidchars) { get; set; } | Okuma sırasında geçersiz karakterleri değiştirmek için hangi sembolün kullanılacağını belirler. Değer '\0' ise değiştirme atlanır. Varsayılan değer '\0' karakterdir. |
