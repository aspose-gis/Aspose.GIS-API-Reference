...
description: Aspose.Gis.Formats.Kml.KmlOptions sınıf. KML formatı için sürücüye özgü seçenekler.
type: docs
weight: 410
url: /tr/net/aspose.gis.formats.kml/kmloptions/
---
## KmlOptions class

KML formatı için sürücüye özgü seçenekler.
...
| İsim | Tanım |
| --- | --- |
| [KmlOptions](kmloptions/)() | Yeni örnek oluştur. |

## Özellikleri

| İsim | Tanım |
| --- | --- |
| [AltitudeMode](../../aspose.gis.formats.kml/kmloptions/altitudemode/) { get; set; } | KML geometrileri için kullanılacak AltitudeMode'ları belirtmenize izin verir |
| [AutoId](../../aspose.gis.formats.kml/kmloptions/autoid/) { get; set; } | Kimlikleri otomatik oluştur |
...
| [DocumentId](../../aspose.gis.formats.kml/kmloptions/documentid/) { get; set; } | Kök 'Belge' düğümünün kimliğini belirtmek için kullanılır |
...
| [SymbolToReplaceInvalidChars](../../aspose.gis.formats.kml/kmloptions/symboltoreplaceinvalidchars/) { get; set; } | Okuma sırasında geçersiz karakterleri değiştirmek için hangi sembolün kullanılacağını belirler. Değer '\0' ise değiştirme atlanır. Varsayılan değer olarak '\0' char. |
