...
description: Aspose.Gis.Formats.MapInfoInterchange.MapInfoInterchangeOptions sınıf. MapInfo Değişim formatı için sürücüye özgü seçenekler.
type: docs
weight: 590
...
MapInfo Değişim formatı için sürücüye özgü seçenekler.
