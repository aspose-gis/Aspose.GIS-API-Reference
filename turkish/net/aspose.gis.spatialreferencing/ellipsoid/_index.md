...
description: Elipsoid dünyaya yaklaşan bir elipsoidi temsil eder.
type: docs
weight: 1970
...
| İsim | Tanım |
| --- | --- |
| [IsEquivalent](../../aspose.gis.spatialreferencing/ellipsoid/isequivalent)(Ellipsoid) | İki elipsoidin eşdeğer olup olmadığını belirler. Elipsoid A, elipsoid B'ye eşdeğerse, aynı yarı ana eksene ve ters düzleştirmeye sahiptirler. |
...
| static [IsEquivalent](../../aspose.gis.spatialreferencing/ellipsoid/isequivalent)(Ellipsoid, Ellipsoid) | İki elipsoidin eşdeğer olup olmadığını belirler. Elipsoid A, elipsoid B'ye eşdeğerse, aynı yarı ana eksene ve ters düzleştirmeye sahiptirler. |
