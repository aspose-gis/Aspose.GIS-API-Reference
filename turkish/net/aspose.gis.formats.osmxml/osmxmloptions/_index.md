...
description: Aspose.Gis.Formats.OsmXml.OsmXmlOptions sınıf. OSM XML formatı için sürücüye özgü seçenekler.
type: docs
weight: 630
...
OSM XML formatı için sürücüye özgü seçenekler.
...
| [ReportCommonAttributes](../../aspose.gis.formats.osmxml/osmxmloptions/reportcommonattributes/) { get; set; } | Ortak OSM özniteliklerini bildirin: görünür, sürüm, değişiklik kümesi, zaman damgası, kullanıcı ve uid. Ortak öznitelikler, "osm_" önekiyle özellik öznitelikleri olarak rapor edilir, örn. osm_user, osm_timestamp, etc. |
