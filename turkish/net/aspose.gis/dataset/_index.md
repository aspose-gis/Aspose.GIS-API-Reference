...
description: Bir veri kümesiVectorLayer./vectorlayer örnekler.
type: docs
weight: 70
...
| abstract [Driver](../../aspose.gis/dataset/driver) { get; } | [`Driver`](./driver) bu veri kümesini başlatan. |
...
| virtual [CreateLayer](../../aspose.gis/dataset/createlayer#createlayer)() | Yeni bir vektör katmanı oluşturur ve onu eklemek için açar. |
| virtual [CreateLayer](../../aspose.gis/dataset/createlayer#createlayer_2)(SpatialReferenceSystem) | Yeni bir vektör katmanı oluşturur ve onu eklemek için açar. |
| virtual [CreateLayer](../../aspose.gis/dataset/createlayer#createlayer_1)(DriverOptions, SpatialReferenceSystem) | Yeni bir vektör katmanı oluşturur ve onu eklemek için açar. |
| virtual [CreateLayer](../../aspose.gis/dataset/createlayer#createlayer_4)(string, SpatialReferenceSystem) | Belirtilen ada sahip yeni bir vektör katmanı oluşturur ve onu eklemek için açar. |
| virtual [CreateLayer](../../aspose.gis/dataset/createlayer#createlayer_3)(string, DriverOptions, SpatialReferenceSystem) | Belirtilen ada sahip yeni bir vektör katmanı oluşturur ve onu eklemek için açar. |
| [Dispose](../../aspose.gis/dataset/dispose)() | tarafından kullanılan kaynakları serbest bırakır.[`Dataset`](../dataset) . |
| abstract [EditLayer](../../aspose.gis/dataset/editlayer)(string, DriverOptions, SpatialReferenceSystem) | Düzenleme için belirtilen ada sahip katmanı açar. |
| abstract [GetLayerName](../../aspose.gis/dataset/getlayername)(int) | Belirtilen dizindeki katmanın adını alır. |
| abstract [OpenLayer](../../aspose.gis/dataset/openlayer)(string, DriverOptions) | Okuma için belirtilen ada sahip katmanı açar. |
| abstract [OpenLayerAt](../../aspose.gis/dataset/openlayerat)(int, DriverOptions) | Okuma için belirtilen dizindeki katmanı açar. |
| virtual [RemoveLayer](../../aspose.gis/dataset/removelayer)(string) | Belirtilen ada sahip vektör katmanını kaldırır. |
| virtual [RemoveLayerAt](../../aspose.gis/dataset/removelayerat)(int) | Belirtilen dizindeki vektör katmanını kaldırır. |
