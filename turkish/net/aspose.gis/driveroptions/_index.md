...
description: için seçeneklerDriver./driver .
type: docs
weight: 90
...
| [DeleteNearPointsDistance](../../aspose.gis/driveroptions/deletenearpointsdistance) { get; set; } | için mesafeyi belirler[`DeleteNearPoints`](./deletenearpoints) . Varsayılan`0` . |
...
| [SimplifySegmentsDistance](../../aspose.gis/driveroptions/simplifysegmentsdistance) { get; set; } | için mesafeyi belirler[`SimplifySegments`](./simplifysegments) . Varsayılan`0` . |
