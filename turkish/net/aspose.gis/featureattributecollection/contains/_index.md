...
description: Öznitelik koleksiyonunun belirtilen ada sahip bir öznitelik içerip içermediğini belirler.
type: docs
weight: 50
url: /tr/net/aspose.gis/featureattributecollection/contains/
---
...
`true` öznitelik koleksiyonu belirtilen ada sahip öznitelik içeriyorsa; aksi halde,`false` .
