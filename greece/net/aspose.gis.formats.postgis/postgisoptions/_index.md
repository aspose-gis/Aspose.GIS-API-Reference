...
description: Aspose.Gis.Formats.PostGis.PostGisOptions τάξη. Επιλογές ειδικά για το πρόγραμμα οδήγησης για τη μορφή PostGis. Προς το παρόν το πρόγραμμα οδήγησης δεν παρέχει προσαρμόσιμες επιλογές.
type: docs
weight: 650
url: /el/net/aspose.gis.formats.postgis/postgisoptions/
---
## PostGisOptions class

Επιλογές ειδικά για το πρόγραμμα οδήγησης για τη μορφή PostGis. Προς το παρόν, το πρόγραμμα οδήγησης δεν παρέχει προσαρμόσιμες επιλογές.
...
| Ονομα | Περιγραφή |
| --- | --- |
| [PostGisOptions](postgisoptions/)() | Δημιουργία νέου στιγμιότυπου. |
