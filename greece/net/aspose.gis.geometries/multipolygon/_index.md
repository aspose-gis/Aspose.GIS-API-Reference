...
description: Aspose.Gis.Geometries.MultiPolygon τάξη. ΑMultiPolygon είναι ένα μονοδιάστατο GeometryCollection των οποίων τα στοιχεία είναιPolygon s.
type: docs
weight: 1170
url: /el/net/aspose.gis.geometries/multipolygon/
---
## MultiPolygon class

Α`MultiPolygon` είναι ένα μονοδιάστατο [`GeometryCollection`](../geometrycollection/) των οποίων τα στοιχεία είναι[`Polygon`](../polygon/) s.
...
| Ονομα | Περιγραφή |
| --- | --- |
| [MultiPolygon](multipolygon/)() | Αρχικοποιεί μια νέα παρουσία του`MultiPolygon` τάξη. |
...
| override [GeometryType](../../aspose.gis.geometries/multipolygon/geometrytype/) { get; } | Παίρνει τον τύπο της γεωμετρίας. |
...
| override [Clone](../../aspose.gis.geometries/multipolygon/clone/)() | Κλωνοποιεί αυτήν την παρουσία. |
...
| [ToEditable](../../aspose.gis.geometries/multipolygon/toeditable/#toeditable_2)() | Λαμβάνει ένα επεξεργάσιμο αντίγραφο αυτής της γεωμετρίας. (4 methods) |
| [ToEditable&lt;T&gt;](../../aspose.gis.geometries/geometry/toeditable/)() | Λαμβάνει ένα επεξεργάσιμο αντίγραφο αυτής της γεωμετρίας. |
| [ToLinearGeometry](../../aspose.gis.geometries/multisurface/tolineargeometry/)() | Λαμβάνει κατά προσέγγιση ή ισοδύναμη μη καμπύλη έκδοση αυτής της γεωμετρίας χρησιμοποιώντας την προεπιλογή`ανοχή` . (3 methods) |
| [ToLinearGeometry](../../aspose.gis.geometries/multisurface/tolineargeometry/)(double) | Λαμβάνει κατά προσέγγιση ή ισοδύναμη μη καμπύλη έκδοση αυτής της γεωμετρίας χρησιμοποιώντας την καθορισμένη`ανοχή` . (3 methods) |
