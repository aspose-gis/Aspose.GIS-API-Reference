...
description: Aspose.Gis.Geometries.LinearRing τάξη. ΑLinearRing είναι έναLineString που είναι και κλειστό και απλό.
type: docs
weight: 1130
url: /el/net/aspose.gis.geometries/linearring/
---
## LinearRing class

Α`LinearRing` είναι ένα[`LineString`](../linestring/) που είναι και κλειστό και απλό.
...
| Ονομα | Περιγραφή |
| --- | --- |
| [LinearRing](linearring/#constructor)() | Αρχικοποιεί μια νέα παρουσία του`LinearRing` τάξη. |
| [LinearRing](linearring/#constructor_2)(IEnumerable&lt;IPoint&gt;) | Αρχικοποιεί μια νέα παρουσία του`LinearRing` τάξη. |
| [LinearRing](linearring/#constructor_1)(ILineString) | Αρχικοποιεί μια νέα παρουσία του`LinearRing` τάξη. |
...
| [Count](../../aspose.gis.geometries/linestring/count/) { get; } | Παίρνει τον αριθμό των πόντων στο[`LineString`](../linestring/) . |
...
| override [GeometryType](../../aspose.gis.geometries/linearring/geometrytype/) { get; } | Παίρνει τον τύπο της γεωμετρίας. |
...
| Ονομα | Περιγραφή |
| --- | --- |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint/)(IPoint) | Προσθέτει ένα σημείο στο τέλος της γραμμής. |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint/)(double, double) | Προσθέτει ένα σημείο στο τέλος της γραμμής. |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint/)(double, double, double) | Προσθέτει ένα σημείο στο τέλος της γραμμής. |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint/)(double, double, double, double) | Προσθέτει ένα σημείο στο τέλος της γραμμής. |
...
| override [Clone](../../aspose.gis.geometries/linearring/clone/)() | Κλωνοποιεί αυτήν την παρουσία. |
...
| [Equals](../../aspose.gis.geometries/linestring/equals/)(ILineString) | Υποδεικνύει εάν το τρέχον αντικείμενο είναι ίσο με άλλο αντικείμενο του ίδιου τύπου. |
| override [Equals](../../aspose.gis.geometries/linestring/equals/)(object) | Καθορίζει εάν το καθορισμένο αντικείμενο είναι ίσο με το τρέχον αντικείμενο. |
...
| [IsClockwise](../../aspose.gis.geometries/linearring/isclockwise/)() | Καθορίζει εάν ο δακτύλιος έχει δεξιόστροφη περιέλιξη. |
...
| override [Reverse](../../aspose.gis.geometries/linestring/reverse/)() | Αντιστρέφει τη σειρά των πόντων σε αυτό[`LineString`](../linestring/) . |
...
| [ToEditable](../../aspose.gis.geometries/linearring/toeditable/#toeditable_2)() | Λαμβάνει ένα επεξεργάσιμο αντίγραφο αυτής της γεωμετρίας. (4 methods) |
