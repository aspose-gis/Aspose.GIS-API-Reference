...
description: Aspose.Gis.Geometries.CurvePolygon τάξη. Μια επίπεδη επιφάνεια που ορίζεται από 1 εξωτερικό όριο και 0 ή περισσότερα εσωτερικά όρια.
type: docs
weight: 910
url: /el/net/aspose.gis.geometries/curvepolygon/
---
## CurvePolygon class

Μια επίπεδη επιφάνεια, που ορίζεται από 1 εξωτερικό όριο και 0 ή περισσότερα εσωτερικά όρια.
...
| Ονομα | Περιγραφή |
| --- | --- |
| [CurvePolygon](curvepolygon/#constructor)() | Αρχικοποιεί μια νέα παρουσία του`CurvePolygon` τάξη. |
| [CurvePolygon](curvepolygon/#constructor_1)(ICurve) | Αρχικοποιεί μια νέα παρουσία του`CurvePolygon` τάξη. |
| [CurvePolygon](curvepolygon/#constructor_2)(ICurve, IEnumerable&lt;ICurve&gt;) | Αρχικοποιεί μια νέα παρουσία του`CurvePolygon` τάξη. |
...
| [ExteriorRing](../../aspose.gis.geometries/curvepolygon/exteriorring/) { get; set; } | Παίρνει το εξωτερικό δαχτυλίδι. |
| override [GeometryType](../../aspose.gis.geometries/curvepolygon/geometrytype/) { get; } | Παίρνει τον τύπο της γεωμετρίας. |
| override [HasCurveGeometry](../../aspose.gis.geometries/curvepolygon/hascurvegeometry/) { get; } | Λαμβάνει μια τιμή που υποδεικνύει εάν αυτή η γεωμετρία είναι ή περιέχει καμπύλη (όχι γραμμική) γεωμετρία. |
| [HasM](../../aspose.gis.geometries/curvepolygon/hasm/) { get; set; } | Λαμβάνει μια τιμή που υποδεικνύει εάν αυτή η παρουσία έχει συντεταγμένες M. |
| [HasZ](../../aspose.gis.geometries/curvepolygon/hasz/) { get; set; } | Λαμβάνει μια τιμή που υποδεικνύει εάν αυτή η παρουσία έχει συντεταγμένες Z. |
| [InteriorRingsCount](../../aspose.gis.geometries/curvepolygon/interiorringscount/) { get; } | Λαμβάνει τον αριθμό των εσωτερικών δακτυλίων. |
| override [IsEmpty](../../aspose.gis.geometries/curvepolygon/isempty/) { get; } | Λαμβάνει μια τιμή που υποδεικνύει εάν αυτή η παρουσία είναι κενή. |
...
| [SpatialReferenceSystem](../../aspose.gis.geometries/curvepolygon/spatialreferencesystem/) { get; set; } | Παίρνει το SpatialReferenceSystem αυτής της παρουσίας. Αυτή η ιδιότητα μπορεί να είναι`null` , είναι άγνωστο το SpatialReferenceSystem. Η εκχώρηση νέου SpatialReferenceSystem δεν θα εκτελέσει μετασχηματισμό συντεταγμένων, αλλά μόνο η αναφορά. |

## Μέθοδοι

| Ονομα | Περιγραφή |
| --- | --- |
| [AddInteriorRing](../../aspose.gis.geometries/curvepolygon/addinteriorring/)(ICurve) | Προσθέτει έναν εσωτερικό δακτύλιο. |
...
| override [Clone](../../aspose.gis.geometries/curvepolygon/clone/)() | Κλωνοποιεί αυτήν την παρουσία. |
...
| [Equals](../../aspose.gis.geometries/curvepolygon/equals/#equals)(ICurvePolygon) | Υποδεικνύει εάν το τρέχον αντικείμενο είναι ίσο με άλλο αντικείμενο του ίδιου τύπου. |
| override [Equals](../../aspose.gis.geometries/curvepolygon/equals/#equals_1)(object) | Καθορίζει εάν το καθορισμένο αντικείμενο είναι ίσο με το τρέχον αντικείμενο. |
...
| override [GetHashCode](../../aspose.gis.geometries/curvepolygon/gethashcode/)() | Λειτουργεί ως η προεπιλεγμένη συνάρτηση κατακερματισμού. |
| [GetInteriorRing](../../aspose.gis.geometries/curvepolygon/getinteriorring/)(int) | Παίρνει τον εσωτερικό δακτύλιο από τον δείκτη του. |
| [GetLength](../../aspose.gis.geometries/geometry/getlength/)() | Υπολογίζει το μήκος αυτής της γεωμετρίας. |
| override [GetPointOnSurface](../../aspose.gis.geometries/curvepolygon/getpointonsurface/)() | Βρίσκει ένα σημείο που είναι εγγυημένο ότι βρίσκεται σε αυτό το καμπύλο πολύγωνο. |
...
| override [SetEmpty](../../aspose.gis.geometries/curvepolygon/setempty/)() | Το κάνει αυτό[`Geometry`](../geometry/) κενό. |
...
| [ToEditable](../../aspose.gis.geometries/curvepolygon/toeditable/#toeditable)() | Λαμβάνει ένα επεξεργάσιμο αντίγραφο αυτής της γεωμετρίας. (3 methods) |
...
| [operator ==](../../aspose.gis.geometries/curvepolygon/op_equality/) | Υλοποιεί τον τελεστή ==. |
| [operator !=](../../aspose.gis.geometries/curvepolygon/op_inequality/) | Υλοποιεί τον τελεστή !=. |
