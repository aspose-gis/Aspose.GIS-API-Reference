...
description: Geometry μέθοδος. Καθορίζει εάν ο πίνακας τομής DE9IM αυτής της γεωμετρίας και μια καθορισμένη γεωμετρία ταιριάζει με το παρεχόμενο μοτίβο.
type: docs
weight: 300
url: /el/net/aspose.gis.geometries/geometry/relate/
---
