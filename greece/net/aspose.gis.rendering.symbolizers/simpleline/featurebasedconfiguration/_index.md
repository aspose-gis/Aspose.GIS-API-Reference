...
description: SimpleLine ιδιοκτησία. Μια επιστροφή κλήσης που χρησιμοποιείται για τη διαμόρφωση αυτού του συμβολοποιητή πριν από την απόδοση μιας δυνατότητας.
type: docs
weight: 60
url: /el/net/aspose.gis.rendering.symbolizers/simpleline/featurebasedconfiguration/
---
