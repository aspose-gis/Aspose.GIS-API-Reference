...
description: Aspose.Gis.Formats.EsriJson.EsriJsonOptions τάξη. Επιλογές ειδικά για προγράμματα οδήγησης για μορφή EsriJson.
type: docs
weight: 240
url: /el/net/aspose.gis.formats.esrijson/esrijsonoptions/
---
## EsriJsonOptions class

Επιλογές ειδικά για προγράμματα οδήγησης για μορφή EsriJson.
...
| Ονομα | Περιγραφή |
| --- | --- |
| [EsriJsonOptions](esrijsonoptions/)() | Δημιουργία νέας παρουσίας. |
...
| [NestedPropertiesSeparator](../../aspose.gis.formats.esrijson/esrijsonoptions/nestedpropertiesseparator/) { get; set; } | Λαμβάνει ή ορίζει μια συμβολοσειρά που χρησιμοποιείται για τον διαχωρισμό στοιχείων ένθετων χαρακτηριστικών. Η προεπιλογή είναι "_". |
