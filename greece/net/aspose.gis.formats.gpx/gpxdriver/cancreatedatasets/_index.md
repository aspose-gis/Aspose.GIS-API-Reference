...
description: GpxDriver ιδιοκτησία. Λαμβάνει μια τιμή που υποδεικνύει εάν αυτό το πρόγραμμα οδήγησης μπορεί να δημιουργήσει σύνολα δεδομένων.
type: docs
weight: 10
url: /el/net/aspose.gis.formats.gpx/gpxdriver/cancreatedatasets/
---
...
* class [GpxDriver](../)
* χώρος ονομάτων [Aspose.Gis.Formats.Gpx](../../gpxdriver/)
