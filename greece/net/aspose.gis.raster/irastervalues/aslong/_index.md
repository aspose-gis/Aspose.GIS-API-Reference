...
description: IRasterValues μέθοδος. Μετατρέπει τα δεδομένα της καθορισμένης ζώνης σε αlong τιμή.
type: docs
weight: 70
url: /el/net/aspose.gis.raster/irastervalues/aslong/
---
## IRasterValues.AsLong method

Μετατρέπει τα δεδομένα της καθορισμένης ζώνης σε α`long` τιμή.
