...
description: GmlDriver μέθοδος. Ανοίγει ένα επίπεδο για ανάγνωση.
type: docs
weight: 50
url: /el/net/aspose.gis.formats.gml/gmldriver/openlayer/
---
...
| options | GmlOptions | Επιλογές για συγκεκριμένα προγράμματα οδήγησης. |
...
* class [GmlDriver](../)
* χώρος ονομάτων [Aspose.Gis.Formats.Gml](../../gmldriver/)
