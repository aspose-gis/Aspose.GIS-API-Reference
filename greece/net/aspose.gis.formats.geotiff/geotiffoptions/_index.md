...
description: Aspose.Gis.Formats.GeoTiff.GeoTiffOptions τάξη. Επιλογές ειδικές για το πρόγραμμα οδήγησης για τη μορφή GeoTiff.
type: docs
weight: 330
url: /el/net/aspose.gis.formats.geotiff/geotiffoptions/
---
## GeoTiffOptions class

Επιλογές ειδικές για το πρόγραμμα οδήγησης για τη μορφή GeoTiff.
...
| Ονομα | Περιγραφή |
| --- | --- |
| [GeoTiffOptions](geotiffoptions/)() | Δημιουργία νέας παρουσίας. |
...
* χώρος ονομάτων [Aspose.Gis.Formats.GeoTiff](../../aspose.gis.formats.geotiff/)
