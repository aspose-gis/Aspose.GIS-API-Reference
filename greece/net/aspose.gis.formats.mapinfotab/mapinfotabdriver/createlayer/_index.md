...
description: MapInfoTabDriver μέθοδος. Δημιουργεί ένα επίπεδο και το ανοίγει για την προσθήκη νέων χαρακτηριστικών.
type: docs
weight: 40
url: /el/net/aspose.gis.formats.mapinfotab/mapinfotabdriver/createlayer/
---
...
| options | MapInfoTabOptions | Επιλογές για συγκεκριμένα προγράμματα οδήγησης. |
