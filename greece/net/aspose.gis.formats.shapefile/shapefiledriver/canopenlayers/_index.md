...
description: ShapefileDriver ιδιοκτησία. Λαμβάνει μια τιμή που υποδεικνύει εάν αυτό το πρόγραμμα οδήγησης μπορεί να ανοίξει διανυσματικά επίπεδα.
type: docs
weight: 30
url: /el/net/aspose.gis.formats.shapefile/shapefiledriver/canopenlayers/
---
