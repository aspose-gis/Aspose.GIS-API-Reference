...
description: Aspose.Gis.Formats.Shapefile.ShapefileOptions τάξη. Επιλογές ειδικά για το πρόγραμμα οδήγησης για μορφή Shapefile. Προς το παρόν το πρόγραμμα οδήγησης δεν παρέχει προσαρμόσιμες επιλογές.
type: docs
weight: 670
url: /el/net/aspose.gis.formats.shapefile/shapefileoptions/
---
## ShapefileOptions class

Επιλογές ειδικά για το πρόγραμμα οδήγησης για μορφή Shapefile. Προς το παρόν, το πρόγραμμα οδήγησης δεν παρέχει προσαρμόσιμες επιλογές.
...
| Ονομα | Περιγραφή |
| --- | --- |
| [ShapefileOptions](shapefileoptions/)() | Δημιουργία νέας παρουσίας. |
