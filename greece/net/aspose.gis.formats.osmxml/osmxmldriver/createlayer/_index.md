...
description: OsmXmlDriver μέθοδος. Δημιουργεί ένα επίπεδο και το ανοίγει για την προσθήκη νέων χαρακτηριστικών.
type: docs
weight: 40
url: /el/net/aspose.gis.formats.osmxml/osmxmldriver/createlayer/
---
...
| options | OsmXmlOptions | Επιλογές για συγκεκριμένα προγράμματα οδήγησης. |
...
* class [OsmXmlDriver](../)
* χώρος ονομάτων [Aspose.Gis.Formats.OsmXml](../../osmxmldriver/)
