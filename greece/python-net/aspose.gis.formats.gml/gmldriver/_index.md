---
title: "GmlDriver Κλάση"
type: docs
weight: 10
url: /el/python-net/aspose.gis.formats.gml/gmldriver/
---
...
| [create_layer(path, options, spatial_reference_system)](#create_layer_path_options_spatial_reference_system_14) | Δημιουργεί ένα στρώμα και το ανοίγει για την προσθήκη νέων χαρακτηριστικών. |
...
| :- | :- | :- |
| path | string | Διαδρομή προς το αρχείο. |
| options | [GmlOptions](/psd/python-net/aspose.gis.formats.gml/gmloptions) | Επιλογές ειδικές για τον οδηγό. |
