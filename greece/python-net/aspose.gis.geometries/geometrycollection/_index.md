---
title: "GeometryCollection Κλάση"
type: docs
weight: 60
url: /el/python-net/aspose.gis.geometries/geometrycollection/
---
...
| **Name** | **Description** |
| :- | :- |
| [GeometryCollection()](#GeometryCollection__1) | Αρχικοποιεί μια νέα παρουσία της κλάσης [GeometryCollection](/psd/python-net/aspose.gis.geometries/geometrycollection/). |
## **Properties**
...
| dimension | [GeometryDimension](/psd/python-net/aspose.gis.geometries/geometrydimension) | r | Λαμβάνει τη τοπολογική διάσταση αυτού του [Geometry](/psd/python-net/aspose.gis.geometries/geometry/).<br/>            Αν η συλλογή είναι κενή, επιστρέφεται το [GeometryDimension.POINT](/psd/python-net/aspose.gis.geometries/geometrydimension/). |
...
Αρχικοποιεί μια νέα παρουσία της κλάσης [GeometryCollection](/psd/python-net/aspose.gis.geometries/geometrycollection/).
...
| Παράμετρος | Τύπος | Περιγραφή |
| :- | :- | :- |
| ανοχή | double | Το <c>tolerance</c> προς χρήση. Το αποτέλεσμα εγγυάται ότι είναι μικρότερο από το <c>tolerance</c> από την<br/>            καμπυλωτή γεωμετρία. |
