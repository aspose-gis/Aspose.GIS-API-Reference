---
title: "ISurface Κλάση"
type: docs
weight: 220
url: /el/python-net/aspose.gis.geometries/isurface/
---
...
| [get_point_on_surface()](#get_point_on_surface__22) | Βρίσκει ένα σημείο που είναι εγγυημένα πάνω σε αυτή την επιφάνεια. |
...
| Τύπος | Περιγραφή |
| :- | :- |
| [Surface](/psd/python-net/aspose.gis.geometries/surface) | Ένα επεξεργάσιμο αντίγραφο αυτής της γεωμετρίας. |
