...
type: docs
weight: 300
url: /el/python-net/aspose.gis.geometries/point/
---
...
| **Name** | **Description** |
| :- | :- |
| [Point()](#Point__1) | Αρχικοποιεί μια νέα παρουσία της [Point](/psd/python-net/aspose.gis.geometries/point/) κλάσης. |
| [Point(other)](#Point_other_2) | Αρχικοποιεί μια νέα παρουσία της [Point](/psd/python-net/aspose.gis.geometries/point/) κλάσης. |
| [Point(x, y)](#Point_x_y_3) | Αρχικοποιεί μια νέα παρουσία της [Point](/psd/python-net/aspose.gis.geometries/point/) κλάσης. |
| [Point(x, y, z)](#Point_x_y_z_4) | Αρχικοποιεί μια νέα παρουσία της [Point](/psd/python-net/aspose.gis.geometries/point/) κλάσης. |
| [Point(x, y, z, m)](#Point_x_y_z_m_5) | Αρχικοποιεί μια νέα παρουσία της [Point](/psd/python-net/aspose.gis.geometries/point/) κλάσης. |
## **Properties**
...
| m | double | r/w | Λαμβάνει ή ορίζει μια τιμή για τη συντεταγμένη m. |
...
| x | double | r/w | Λαμβάνει ή ορίζει μια τιμή για τη συντεταγμένη x. |
| y | double | r/w | Λαμβάνει ή ορίζει μια τιμή για τη συντεταγμένη y. |
| z | double | r/w | Λαμβάνει ή ορίζει μια τιμή για τη συντεταγμένη z. |
## **Methods**
| **Name** | **Description** |
| :- | :- |
...
Αρχικοποιεί μια νέα παρουσία της [Point](/psd/python-net/aspose.gis.geometries/point/) κλάσης.
...
| :- | :- | :- |
| other | [IPoint](/psd/python-net/aspose.gis.geometries/ipoint) | Το άλλο [IPoint](/psd/python-net/aspose.gis.geometries/ipoint/) για αντιγραφή δεδομένων από. |
