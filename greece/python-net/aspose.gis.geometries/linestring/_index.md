---
title: "Κλάση LineString"
type: docs
weight: 230
url: /el/python-net/aspose.gis.geometries/linestring/
---
...
| **Name** | **Description** |
| :- | :- |
| [LineString()](#LineString__1) | Αρχικοποιεί μια νέα παρουσία της κλάσης [LineString](/psd/python-net/aspose.gis.geometries/linestring/) . |
| [LineString(collection)](#LineString_collection_2) | Αρχικοποιεί μια νέα παρουσία της κλάσης [LineString](/psd/python-net/aspose.gis.geometries/linestring/) . |
| [LineString(other)](#LineString_other_3) | Αρχικοποιεί μια νέα παρουσία της κλάσης [LineString](/psd/python-net/aspose.gis.geometries/linestring/) . |
## **Properties**
...
Αρχικοποιεί μια νέα παρουσία της κλάσης [LineString](/psd/python-net/aspose.gis.geometries/linestring/) .
...
| Τύπος | Περιγραφή |
| :- | :- |
| [LineString](/psd/python-net/aspose.gis.geometries/linestring) | Ένα επεξεργάσιμο αντίγραφο αυτής της γεωμετρίας. |
