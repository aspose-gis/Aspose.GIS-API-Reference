---
title: "CircularString Κλάση"
type: docs
weight: 10
url: /el/python-net/aspose.gis.geometries/circularstring/
---
...
| **Name** | **Description** |
| :- | :- |
| [CircularString()](#CircularString__1) | Αρχικοποιεί μια νέα παρουσία της κλάσης [CircularString](/psd/python-net/aspose.gis.geometries/circularstring/). |
| [CircularString(collection)](#CircularString_collection_2) | Αρχικοποιεί μια νέα παρουσία της κλάσης [CircularString](/psd/python-net/aspose.gis.geometries/circularstring/). |
| [CircularString(other)](#CircularString_other_3) | Αρχικοποιεί μια νέα παρουσία της κλάσης [CircularString](/psd/python-net/aspose.gis.geometries/circularstring/). |
## **Properties**
...
| **Name** | **Description** |
| :- | :- |
| [add_point(point)](#add_point_point_1) | Προσθέτει ένα σημείο στο τέλος της κυκλικής συμβολοσειράς. |
| [add_point(x, y)](#add_point_x_y_2) | Προσθέτει ένα σημείο στο τέλος της κυκλικής συμβολοσειράς. |
| [add_point(x, y, z)](#add_point_x_y_z_3) | Προσθέτει ένα σημείο στο τέλος της κυκλικής συμβολοσειράς. |
| [add_point(x, y, z, m)](#add_point_x_y_z_m_4) | Προσθέτει ένα σημείο στο τέλος της κυκλικής συμβολοσειράς. |
...
| [overlaps(other)](#overlaps_other_33) | Καθορίζει εάν αυτή η γεωμετρία επικαλύπτεται με μια καθορισμένη γεωμετρία. |
| [relate(other, intersection_pattern_matrix)](#relate_other_intersection_pattern_matrix_34) | Καθορίζει εάν ο πίνακας τομής DE-9IM αυτής της γεωμετρίας και μιας καθορισμένης γεωμετρίας ταιριάζει με το παρεχόμενο μοτίβο. |
...
| reverse() | Αντιστρέφει τη σειρά των σημείων σε αυτήν τη [CircularString](/psd/python-net/aspose.gis.geometries/circularstring/). |
...
Αρχικοποιεί μια νέα παρουσία της κλάσης [CircularString](/psd/python-net/aspose.gis.geometries/circularstring/).
...
| Παράμετρος | Τύπος | Περιγραφή |
| :- | :- | :- |
| other | [ICircularString](/psd/python-net/aspose.gis.geometries/icircularstring) | Η άλλη συμβολοσειρά από την οποία θα αντιγραφούν τα δεδομένα. |
...
| Τύπος | Περιγραφή |
| :- | :- |
| [CircularString](/psd/python-net/aspose.gis.geometries/circularstring) | Ένα επεξεργάσιμο αντίγραφο αυτής της γεωμετρίας. |
