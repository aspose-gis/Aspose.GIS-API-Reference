...
type: docs
weight: 310
url: /el/python-net/aspose.gis.geometries/polygon/
---
...
| **Name** | **Description** |
| :- | :- |
| [Polygon()](#Polygon__1) | Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης [Polygon](/psd/python-net/aspose.gis.geometries/polygon/). |
| [Polygon(exterior_ring)](#Polygon_exterior_ring_2) | Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης [Polygon](/psd/python-net/aspose.gis.geometries/polygon/). |
| [Polygon(exterior_ring, interior_rings)](#Polygon_exterior_ring_interior_rings_3) | Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης [Polygon](/psd/python-net/aspose.gis.geometries/polygon/). |
## **Properties**
...
| exterior_ring | [ILinearRing](/psd/python-net/aspose.gis.geometries/ilinearring) | r/w | Λαμβάνει το εξωτερικό δακτύλιο. |
...
| [get_point_on_surface()](#get_point_on_surface__28) | Βρίσκει ένα σημείο που είναι εγγυημένα πάνω σε αυτό το πολύγωνο. |
...
Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης [Polygon](/psd/python-net/aspose.gis.geometries/polygon/).
...
| :- | :- | :- |
| exterior_ring | [ILinearRing](/psd/python-net/aspose.gis.geometries/ilinearring) | Ο εξωτερικός δακτύλιος. |
...
| :- | :- | :- |
| exterior_ring | [ILinearRing](/psd/python-net/aspose.gis.geometries/ilinearring) | Ο εξωτερικός δακτύλιος. |
| interior_rings | System.Collections.Generic.IEnumerable<ILinearRing> | Οι εσωτερικοί δακτύλιοι. |
...
| Παράμετρος | Τύπος | Περιγραφή |
| :- | :- | :- |
| ring | [ILinearRing](/psd/python-net/aspose.gis.geometries/ilinearring) | Ο δακτύλιος προς προσθήκη. |
...
Βρίσκει ένα σημείο που είναι εγγυημένα πάνω σε αυτό το πολύγωνο.

**Returns**

| Τύπος | Περιγραφή |
| :- | :- |
| [IPoint](/psd/python-net/aspose.gis.geometries/ipoint) | Ένα σημείο σε αυτό το πολύγωνο. Ένα κενό σημείο εάν αυτό το πολύγωνο δεν έχει εσωτερικό. |
