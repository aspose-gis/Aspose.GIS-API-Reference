---
title: "ILinearRing Κλάση"
type: docs
weight: 140
url: /el/python-net/aspose.gis.geometries/ilinearring/
---
...
| [is_clockwise()](#is_clockwise__25) | Καθορίζει εάν το δακτύλιο έχει δεξιόστροφη περιδίνηση |
...
| Τύπος | Περιγραφή |
| :- | :- |
| [ILineString](/psd/python-net/aspose.gis.geometries/ilinestring) | Μια γεωμετρία που δεν έχει γεωμετρίες καμπύλης. Εφαρμόζονται οι ακόλουθοι μετασχηματισμοί:<br/>            <ul><br/>            <li> Τα [GeometryType.CIRCULAR_STRING]s μετατρέπονται σε γραμμικές μορφές (μετατρέπονται σε [GeometryType.LINE_STRING]s με καθορισμένο <paramref name="tolerance" />) </li><br/>            <li> Τα [GeometryType.COMPOUND_CURVE]s ενώνται σε <c>LineString</c>s </li><br/>            <li> Τα [GeometryType.CURVE_POLYGON]s μετατρέπονται σε [GeometryType.POLYGON]s </li><br/>            <li> Τα [GeometryType.MULTI_CURVE]s μετατρέπονται σε [GeometryType.MULTI_LINE_STRING]s </li><br/>            <li> Τα [GeometryType.MULTI_SURFACE]s μετατρέπονται σε [GeometryType.MULTI_POLYGON]s </li><br/>            </ul><br/>            Ως αποτέλεσμα, το [IGeometry.has_curve_geometry] είναι <see langword="false" />. |
