---
title: "Κλάση MultiPolygon"
type: docs
weight: 280
url: /el/python-net/aspose.gis.geometries/multipolygon/
---
...
| **Name** | **Description** |
| :- | :- |
| [MultiPolygon()](#MultiPolygon__1) | Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης [MultiPolygon](/psd/python-net/aspose.gis.geometries/multipolygon/). |
## **Properties**
...
| spatial_reference_system | [SpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem/) | r/w | Λαμβάνει το SpatialReferenceSystem αυτού του αντικειμένου.<br/>            Αυτή η ιδιότητα μπορεί να είναι <see langword="null" />, εάν το SpatialReferenceSystem είναι άγνωστο. |
## **Methods**
| **Name** | **Description** |
| :- | :- |
...
Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης [MultiPolygon](/psd/python-net/aspose.gis.geometries/multipolygon/).
