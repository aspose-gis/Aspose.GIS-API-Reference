---
title: "Κλάση IMultiSurface"
type: docs
weight: 190
url: /el/python-net/aspose.gis.geometries/imultisurface/
---
...
| Τύπος | Περιγραφή |
| :- | :- |
| [MultiSurface](/psd/python-net/aspose.gis.geometries/multisurface) | Ένα επεξεργάσιμο αντίγραφο αυτής της γεωμετρίας. |
...
| Τύπος | Περιγραφή |
| :- | :- |
| [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon) | Ένα [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon/) που προσεγγίζει ή είναι ισοδύναμο με αυτό το [IMultiSurface](/psd/python-net/aspose.gis.geometries/imultisurface/).<br/>            Αυτή είναι η ισοδυναμία του <DOM Element: class at 0x2a1792e8790>.IMultiSurface.to_linear_geometry()(float) με<br/>            προεπιλεγμένο <c>tolerance</c>. Η προεπιλεγμένη τιμή του <c>tolerance</c> εξαρτάται από το [SpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem/)<br/>            αυτής της γεωμετρίας:<br/>            <ul><br/>            <li> Για προβλεπόμενο SRS η ανοχή είναι 0.001 μέτρα (σε μονάδες SRS) </li><br/>            <li> Για γεωγραφικό SRS η ανοχή είναι <c>1e-5</c> μοίρες (σε μονάδες SRS) </li><br/>            <li> Για άγνωστο SRS η ανοχή είναι <c>1e-5</c> </li><br/>            </ul><br/>            Για περισσότερες λεπτομέρειες σχετικά με τις μετασχηματισμούς που εφαρμόζονται, ανατρέξτε στην προδιαγραφή του <DOM Element: class at 0x2a1792e8790>.IMultiSurface.to_linear_geometry()(float). |
...
| Τύπος | Περιγραφή |
| :- | :- |
| [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon) | Ένα [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon/) που προσεγγίζει ή είναι ισοδύναμο με αυτό το [IMMultiSurface](/psd/python-net/aspose.gis.geometries/imultisurface/):<br/>             <ul><br/>             Εάν αυτό το αντικείμενο είναι το ίδιο το [IMMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon/) το αποτέλεσμα είναι ισοδύναμο με αυτό το αντικείμενο<br/>             Εάν αυτό το αντικείμενο δεν είναι το [IMMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon/) - όλες οι επιφάνειες γραμμικοποιούνται και δημιουργείται νέο <c>IMultiPolygon</c> <br/>            </ul> |
