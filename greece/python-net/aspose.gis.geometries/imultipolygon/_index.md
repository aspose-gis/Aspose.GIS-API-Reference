---
title: "IMultiPolygon Κλάση"
type: docs
weight: 180
url: /el/python-net/aspose.gis.geometries/imultipolygon/
---
...
| Τύπος | Περιγραφή |
| :- | :- |
| [MultiPolygon](/psd/python-net/aspose.gis.geometries/multipolygon) | Ένα επεξεργάσιμο αντίγραφο αυτής της γεωμετρίας. |
...
| Τύπος | Περιγραφή |
| :- | :- |
| [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon) | Μια γεωμετρία που δεν έχει γεωμετρίες καμπύλης. Εφαρμόζονται οι ακόλουθοι μετασχηματισμοί:<br/>            <ul><br/>            <li> Τα [GeometryType.CIRCULAR_STRING]s μετατρέπονται σε γραμμικές μορφές (μετατρέπονται σε [GeometryType.LINE_STRING]s με καθορισμένο <paramref name="tolerance" />) </li><br/>            <li> Τα [GeometryType.COMPOUND_CURVE]s ενώνται σε <c>LineString</c>s </li><br/>            <li> Τα [GeometryType.CURVE_POLYGON]s μετατρέπονται σε [GeometryType.POLYGON]s </li><br/>            <li> Τα [GeometryType.MULTI_CURVE]s μετατρέπονται σε [GeometryType.MULTI_LINE_STRING]s </li><br/>            <li> Τα [GeometryType.MULTI_SURFACE]s μετατρέπονται σε [GeometryType.MULTI_POLYGON]s </li><br/>            </ul><br/>            Ως αποτέλεσμα, το [IGeometry.has_curve_geometry] είναι <see langword="false" />. |
