---
title: "LinearRing Κλάση"
type: docs
weight: 240
url: /el/python-net/aspose.gis.geometries/linearring/
---
...
| **Name** | **Description** |
| :- | :- |
| [LinearRing()](#LinearRing__1) | Αρχικοποιεί μια νέα παρουσία της [LinearRing](/psd/python-net/aspose.gis.geometries/linearring/) κλάσης. |
| [LinearRing(collection)](#LinearRing_collection_2) | Αρχικοποιεί μια νέα παρουσία της [LinearRing](/psd/python-net/aspose.gis.geometries/linearring/) κλάσης. |
| [LinearRing(other)](#LinearRing_other_3) | Αρχικοποιεί μια νέα παρουσία της [LinearRing](/psd/python-net/aspose.gis.geometries/linearring/) κλάσης. |
## **Properties**
...
| **Name** | **Description** |
| :- | :- |
| [add_point(point)](#add_point_point_1) | Προσθέτει ένα σημείο στο τέλος της γραμμής. |
| [add_point(x, y)](#add_point_x_y_2) | Προσθέτει ένα σημείο στο τέλος της γραμμής. |
| [add_point(x, y, z)](#add_point_x_y_z_3) | Προσθέτει ένα σημείο στο τέλος της γραμμής. |
| [add_point(x, y, z, m)](#add_point_x_y_z_m_4) | Προσθέτει ένα σημείο στο τέλος της γραμμής. |
| [as_binary()](#as_binary__5) | Μετατρέπει αυτή τη γεωμετρία στην αναπαράστασή της Well-Known Binary. |
| [as_binary(variant)](#as_binary_variant_6) | Μετατρέπει αυτή τη γεωμετρία στην αναπαράστασή της Well-Known Binary. |
| [as_image(output_path, width, height, renderer, symbolizer)](#as_image_output_path_width_height_renderer_symbolizer_7) | Εξάγει αυτή τη γεωμετρία σε αναπαράσταση εικόνας. |
| [as_image(output_path, width, height, renderer, symbolizer)](#as_image_output_path_width_height_renderer_symbolizer_8) | Εξάγει αυτή τη γεωμετρία σε αναπαράσταση εικόνας. |
| [as_image(width, height, renderer, symbolizer)](#as_image_width_height_renderer_symbolizer_9) | Εξάγει αυτή τη γεωμετρία σε αναπαράσταση εικόνας. |
| [as_text()](#as_text__10) | Μετατρέπει αυτή τη γεωμετρία στην αναπαράστασή της Well-Known Text. |
| [as_text(variant)](#as_text_variant_11) | Μετατρέπει αυτή τη γεωμετρία στην αναπαράστασή της Well-Known Text. |
| [as_text(variant, format)](#as_text_variant_format_12) | Μετατρέπει αυτή τη γεωμετρία στην αναπαράστασή της Well-Known Text. |
| [clone()](#clone__13) | Κλωνοποιεί αυτό το παράδειγμα. |
| [covered_by(other)](#covered_by_other_14) | Καθορίζει εάν αυτή η γεωμετρία καλύπτεται από μια καθορισμένη γεωμετρία. |
| [covers(other)](#covers_other_15) | Καθορίζει εάν αυτή η γεωμετρία καλύπτει μια καθορισμένη γεωμετρία. |
| [crosses(other)](#crosses_other_16) | Καθορίζει εάν αυτή η γεωμετρία και μια καθορισμένη γεωμετρία διασχίζουν. |
| [difference(other)](#difference_other_17) | Αφαιρεί μια καθορισμένη γεωμετρία από αυτή τη γεωμετρία. |
| [disjoint(other)](#disjoint_other_18) | Καθορίζει εάν αυτή η γεωμετρία είναι διακριτή από μια καθορισμένη γεωμετρία. |
| [from_binary(wkb)](#from_binary_wkb_19) | Δημιουργεί μια γεωμετρία από την αναπαράστασή της σε Well-Known Binary. |
| [from_binary(wkb, spatial_reference_system)](#from_binary_wkb_spatial_reference_system_20) | Δημιουργεί μια γεωμετρία από την αναπαράστασή της σε Well-Known Binary. |
| [from_text(wkt)](#from_text_wkt_21) | Δημιουργεί μια γεωμετρία από την αναπαράστασή της σε Well-Known Text. |
| [from_text(wkt, spatial_reference_system)](#from_text_wkt_spatial_reference_system_22) | Δημιουργεί μια γεωμετρία από την αναπαράστασή της σε Well-Known Text. |
| [get_area()](#get_area__23) | Υπολογίζει το εμβαδόν αυτής της γεωμετρίας. |
| [get_buffer(distance, quadrant_segments)](#get_buffer_distance_quadrant_segments_24) | Υπολογίζει μια περιοχή buffer γύρω από αυτή τη γεωμετρία. |
| [get_centroid()](#get_centroid__25) | Υπολογίζει το κέντρο μάζας αυτής της γεωμετρίας. |
| [get_convex_hull()](#get_convex_hull__26) | Υπολογίζει το κυρτό περίβλημα αυτής της γεωμετρίας. |
| [get_distance_to(other)](#get_distance_to_other_27) | Υπολογίζει την ελάχιστη απόσταση μεταξύ αυτής της γεωμετρίας και μιας καθορισμένης γεωμετρίας. |
| [get_extent()](#get_extent__28) | Υπολογίζει και επιστρέφει το περιβάλλον όριο αυτής της γεωμετρίας. |
| [get_length()](#get_length__29) | Υπολογίζει το μήκος αυτής της γεωμετρίας. |
| [intersection(other)](#intersection_other_30) | Δημιουργεί μια τομή μεταξύ αυτής της γεωμετρίας και μιας καθορισμένης γεωμετρίας. |
| [intersects(extent)](#intersects_extent_31) | Καθορίζει εάν αυτή η γεωμετρία τέμνει ένα καθορισμένο εύρος. |
| [intersects(other)](#intersects_other_32) | Καθορίζει εάν αυτή η γεωμετρία και μια καθορισμένη γεωμετρία τέμνονται. |
| [is_clockwise()](#is_clockwise__33) | Καθορίζει εάν το δακτύλιο έχει δεξιόστροφη περιδίνηση. |
| [overlaps(other)](#overlaps_other_34) | Καθορίζει εάν αυτή η γεωμετρία επικαλύπτεται με μια καθορισμένη γεωμετρία. |
| [relate(other, intersection_pattern_matrix)](#relate_other_intersection_pattern_matrix_35) | Καθορίζει εάν ο πίνακας τομής DE-9IM αυτής της γεωμετρίας και μιας καθορισμένης γεωμετρίας ταιριάζει με το παρεχόμενο μοτίβο. |
| [replace_polygons_by_lines()](#replace_polygons_by_lines__36) | Λαμβάνει τα πολύγωνα που αναπαρίστανται ως γραμμές αυτής της γεωμετρίας. |
| reverse() | Αντιστρέφει τη σειρά των σημείων σε αυτό το [LineString](/psd/python-net/aspose.gis.geometries/linestring/) . |
| [round_m(digits)](#round_m_digits_37) | Στρογγυλοποιεί την συντεταγμένη M σε καθορισμένο αριθμό δεκαδικών ψηφίων. |
| [round_xy(digits)](#round_xy_digits_38) | Στρογγυλοποιεί τις συντεταγμένες X και Y σε καθορισμένο αριθμό δεκαδικών ψηφίων. |
| [round_z(digits)](#round_z_digits_39) | Στρογγυλοποιεί τη συντεταγμένη Z σε καθορισμένο αριθμό δεκαδικών ψηφίων. |
| set_empty() | Κάνει αυτή τη [Geometry](/psd/python-net/aspose.gis.geometries/geometry/) κενή. |
| [spatially_contains(other)](#spatially_contains_other_40) | Καθορίζει εάν αυτή η γεωμετρία χωρικά περιέχει μια καθορισμένη γεωμετρία. |
| [spatially_equals(other)](#spatially_equals_other_41) | Καθορίζει εάν αυτή η γεωμετρία είναι χωρικά ίση με μια καθορισμένη γεωμετρία. |
| [sym_difference(other)](#sym_difference_other_42) | Δημιουργεί τη συμμετρική διαφορά μεταξύ αυτού του γεωμετρικού αντικειμένου και ενός καθορισμένου γεωμετρικού αντικειμένου. |
| [to_editable()](#to_editable__43) | Λαμβάνει ένα επεξεργάσιμο αντίγραφο αυτού του γεωμετρικού αντικειμένου. |
| [to_linear_geometry()](#to_linear_geometry__44) | Λαμβάνει μια προσεγγιστική ή ισοδύναμη μη-καμπυλική έκδοση αυτού του γεωμετρικού αντικειμένου χρησιμοποιώντας την προεπιλεγμένη <c>tolerance</c>. |
| [to_linear_geometry(tolerance)](#to_linear_geometry_tolerance_45) | Λαμβάνει μια προσεγγιστική ή ισοδύναμη μη-καμπυλική έκδοση αυτού του γεωμετρικού αντικειμένου χρησιμοποιώντας την καθορισμένη <c>tolerance</c>. |
| [to_svg(extent)](#to_svg_extent_46) | Μετατρέπει αυτό το γεωμετρικό αντικείμενο σε αναπαράσταση Svg. |
| [touches(other)](#touches_other_47) | Καθορίζει εάν αυτό το γεωμετρικό αντικείμενο και ένα καθορισμένο γεωμετρικό αντικείμενο αγγίζουν. |
| [union(other)](#union_other_48) | Ενώνει αυτό το γεωμετρικό αντικείμενο και ένα καθορισμένο γεωμετρικό αντικείμενο. |
| [union(other)](#union_other_49) | Ενώνει αυτό το γεωμετρικό αντικείμενο και ένα καθορισμένο γεωμετρικό αντικείμενο. |
| [within(extent)](#within_extent_50) | Καθορίζει εάν αυτό το γεωμετρικό αντικείμενο βρίσκεται εντός ενός καθορισμένου εύρους. |
| [within(other)](#within_other_51) | Καθορίζει εάν αυτό το γεωμετρικό αντικείμενο βρίσκεται εντός ενός καθορισμένου γεωμετρικού αντικειμένου. |
...
Αρχικοποιεί μια νέα παρουσία της [LinearRing](/psd/python-net/aspose.gis.geometries/linearring/) κλάσης.
...
| :- | :- | :- |
| συλλογή | System.Collections.Generic.IEnumerable<IPoint> | Η συλλογή των σημείων. |
...
| Παράμετρος | Τύπος | Περιγραφή |
| :- | :- | :- |
| other | [ILineString](/psd/python-net/aspose.gis.geometries/ilinestring) | Η άλλη γραμμή από την οποία θα αντιγραφούν τα δεδομένα. |
...
Προσθέτει ένα σημείο στο τέλος της γραμμής.

**Parameters:**

| Παράμετρος | Τύπος | Περιγραφή |
| :- | :- | :- |
| point | [IPoint](/psd/python-net/aspose.gis.geometries/ipoint) | Το σημείο προς προσθήκη. |
...
| Παράμετρος | Τύπος | Περιγραφή |
| :- | :- | :- |
| x | double | Η τιμή για τη συντεταγμένη X. |
| y | double | Η τιμή για τη συντεταγμένη Y. |
...
Καθορίζει εάν το δακτύλιο έχει δεξιόστροφη περιδίνηση.

**Returns**

| Τύπος | Περιγραφή |
| :- | :- |
| bool | <see langword=\"true\" /> εάν δεξιόστροφη· διαφορετικά <see langword=\"false\" />. |
...
| Τύπος | Περιγραφή |
| :- | :- |
| [LinearRing](/psd/python-net/aspose.gis.geometries/linearring) | Ένα επεξεργάσιμο αντίγραφο αυτής της γεωμετρίας. |
