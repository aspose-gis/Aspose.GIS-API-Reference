---
title: "Κλάση TopoJsonDriver"
type: docs
weight: 10
url: /el/python-net/aspose.gis.formats.topojson/topojsondriver/
---
...
| :- | :- | :- |
| path | string | Διαδρομή προς το αρχείο. |
| options | [TopoJsonOptions](/psd/python-net/aspose.gis.formats.topojson/topojsonoptions) | Επιλογές ειδικές για τον οδηγό. |
