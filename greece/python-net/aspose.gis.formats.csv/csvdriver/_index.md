---
title: "Κλάση CsvDriver"
type: docs
weight: 10
url: /el/python-net/aspose.gis.formats.csv/csvdriver/
---
...
| **Name** | **Description** |
| :- | :- |
| [CsvDriver()](#CsvDriver__1) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης CsvDriver |
## **Properties**
...
Αρχικοποιεί ένα νέο αντικείμενο της κλάσης CsvDriver
...
| :- | :- | :- |
| path | string | Διαδρομή προς το αρχείο. |
| options | [CsvOptions](/psd/python-net/aspose.gis.formats.csv/csvoptions) | Επιλογές ειδικές για τον οδηγό. |
