---
title: "InFileDriver Κλάση"
type: docs
weight: 10
url: /el/python-net/aspose.gis.formats.infile/infiledriver/
---
...
| :- | :- | :- |
| path | string | Διαδρομή προς το αρχείο. |
| options | [InFileOptions](/psd/python-net/aspose.gis.formats.infile/infileoptions) | Επιλογές ειδικές για τον οδηγό. |
