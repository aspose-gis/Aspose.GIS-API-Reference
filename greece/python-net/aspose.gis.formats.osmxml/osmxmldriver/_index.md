---
title: "Κλάση OsmXmlDriver"
type: docs
weight: 10
url: /el/python-net/aspose.gis.formats.osmxml/osmxmldriver/
---
...
| :- | :- | :- |
| path | string | Διαδρομή προς το αρχείο. |
| options | [OsmXmlOptions](/psd/python-net/aspose.gis.formats.osmxml/osmxmloptions) | Επιλογές ειδικές για τον οδηγό. |
