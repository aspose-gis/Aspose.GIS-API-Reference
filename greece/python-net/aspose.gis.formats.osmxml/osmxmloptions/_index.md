---
title: "Κλάση OsmXmlOptions"
type: docs
weight: 20
url: /el/python-net/aspose.gis.formats.osmxml/osmxmloptions/
---
...
| **Name** | **Description** |
| :- | :- |
| [OsmXmlOptions()](#OsmXmlOptions__1) | Δημιουργήστε νέα παρουσία. |
## **Properties**
...
| report_all_nodes | bool | r/w | Αναφορά όλων των κόμβων ως χαρακτηριστικά, ακόμη και αν δεν έχουν σημαντικές ετικέτες. |
| report_all_ways | bool | r/w | Αναφορά όλων των διαδρομών ως χαρακτηριστικά, ακόμη και αν δεν έχουν σημαντικές ετικέτες ή δεν έχουν καν κόμβους. |
| report_common_attributes | bool | r/w | Αναφορά κοινών χαρακτηριστικών OSM: visible, version, changeset, timestamp, user και uid.<br/>            Τα κοινά χαρακτηριστικά θα αναφέρονται ως χαρακτηριστικά του στοιχείου με πρόθεμα \"osm_\", π.χ. osm_user, osm_timestamp, κλπ. |
...
| write_common_attributes | bool | r/w | Εγγραφή κοινών χαρακτηριστικών OSM: visible, version, changeset, timestamp, user και uid. |
