...
type: docs
weight: 830
url: /el/python-net/aspose.gis/feature/
---
...
| [get_value(attribute_name)](#get_value_attribute_name_2) | Λαμβάνει την τιμή ενός χαρακτηριστικού. |
| [get_value_or_default(attribute_name, default_value)](#get_value_or_default_attribute_name_default_value_3) | Λαμβάνει την τιμή ενός χαρακτηριστικού, ή [FeatureAttribute.default_value](/psd/python-net/aspose.gis/featureattribute/) εάν η τιμή δεν έχει οριστεί ή είναι <c>null</c>. |
| [get_values(values, default_value)](#get_values_values_default_value_4) | Επιστρέφει τις τιμές για όλα τα χαρακτηριστικά σε έναν πίνακα. |
| [get_values(values_count, default_value)](#get_values_values_count_default_value_5) | Επιστρέφει τις τιμές για όλα τα χαρακτηριστικά σε έναν πίνακα. |
| [get_values_dump(default_value)](#get_values_dump_default_value_6) | Επιστρέφει τις τιμές για όλα τα χαρακτηριστικά σε έναν πίνακα.<br/>            Σκεφτείτε να χρησιμοποιήσετε τη μέθοδο Aspose.Gis.Feature.GetValues(int,System.Object) για να αποφύγετε επιπλέον κατανομή μνήμης. |
| [get_values_list(attribute_name, separator, count)](#get_values_list_attribute_name_separator_count_7) | Λαμβάνει τη λίστα τιμών. Μη-γενική αναλογία του List T GetValuesList |
| [is_value_null(attribute_name)](#is_value_null_attribute_name_8) | Καθορίζει εάν το καθορισμένο χαρακτηριστικό έχει οριστεί ρητά σε τιμή <c>null</c>. |
| [is_value_set(attribute_name)](#is_value_set_attribute_name_9) | Ελέγχει εάν η τιμή του χαρακτηριστικού έχει οριστεί σε αυτό το χαρακτηριστικό. |
| [set_value(attribute_name, value)](#set_value_attribute_name_value_10) | Ορίζει την τιμή. Μη-γενική αναλογία του void SetValue (string attributeName, T value) |
| [set_value_null(attribute_name)](#set_value_null_attribute_name_11) | Ορίζει την τιμή του χαρακτηριστικού σε <c>null</c>. |
| [set_values(values)](#set_values_values_12) | Ορίζει νέες τιμές για όλα τα χαρακτηριστικά.<br/>            Επίσης, σκεφτείτε να χρησιμοποιήσετε τη μέθοδο [Feature.copy_values(input_feature)](/psd/python-net/aspose.gis/feature/) για να απλοποιήσετε τον ορισμό τιμών σε μία κλήση. |
| [unset_value(attribute_name)](#unset_value_attribute_name_13) | Αφαιρεί την τιμή του χαρακτηριστικού από αυτό το χαρακτηριστικό. |
...
Επιστρέφει τις τιμές για όλα τα χαρακτηριστικά σε έναν πίνακα.<br/>            Σκεφτείτε να χρησιμοποιήσετε τη μέθοδο Aspose.Gis.Feature.GetValues(int,System.Object) για να αποφύγετε επιπλέον κατανομή μνήμης.
...
Λαμβάνει τη λίστα τιμών. Μη-γενική αναλογία του List T GetValuesList
...
Ορίζει την τιμή. Μη-γενική αναλογία του void SetValue (string attributeName, T value)
...
Ορίζει νέες τιμές για όλα τα χαρακτηριστικά.<br/>            Επίσης, σκεφτείτε να χρησιμοποιήσετε τη μέθοδο [Feature.copy_values(input_feature)](/psd/python-net/aspose.gis/feature/) για να απλοποιήσετε τον ορισμό τιμών σε μία κλήση.
