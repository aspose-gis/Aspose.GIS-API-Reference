---
title: "MultiStreamPath Κλάση"
type: docs
weight: 2760
url: /el/python-net/aspose.gis/multistreampath/
---
...
| **Name** | **Description** |
| :- | :- |
| [MultiStreamPath(entry_file_name, file_names, streams)](#MultiStreamPath_entry_file_name_file_names_streams_1) | Αρχικοποιεί μια νέα παρουσία της κλάσης [MultiStreamPath](/psd/python-net/aspose.gis/multistreampath/). |
## **Properties**
| **Name** | **Type** | **Access** | **Description** |
| :- | :- | :- | :- |
| τοποθεσία | string | r | Λαμβάνει μια αναπαράσταση συμβολοσειράς της τοποθεσίας αυτού του <c>AbstractPath</c>. |
| separator | char | r | Λαμβάνει έναν χαρακτήρα διαχωριστή που χρησιμοποιείται για το διαχωρισμό επιπέδων καταλόγου της συμβολοσειράς [MultiStreamPath.location](/psd/python-net/aspose.gis/multistreampath/). |
## **Methods**
| **Name** | **Description** |
| :- | :- |
...
| [open(access)](#open_access_9) | Αφηρεί ένα σύνολο ανοιχτών ροών πολλαπλών αρχείων ως διαδρομή για πρόσβαση στα δεδομένα. |
...
Αρχικοποιεί μια νέα παρουσία της κλάσης [MultiStreamPath](/psd/python-net/aspose.gis/multistreampath/).

**Parameters:**

| Παράμετρος | Τύπος | Περιγραφή |
| :- | :- | :- |
| entry_file_name | string | Όνομα του αρχείου εισόδου. |
| file_names | string | Τα ονόματα αρχείων. |
| ροές | _io.BufferedRandom[] | Οι ροές. |
...
Αφηρεί ένα σύνολο ανοιχτών ροών πολλαπλών αρχείων ως διαδρομή για πρόσβαση στα δεδομένα.
...
| Τύπος | Περιγραφή |
| :- | :- |
| _io.BufferedRandom | Αυτό μπορεί να είναι είτε ένα   ή η ροή που αρχικά περάστηκε από τον πελάτη. |
