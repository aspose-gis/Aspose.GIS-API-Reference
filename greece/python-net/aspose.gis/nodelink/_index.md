---
title: "Κλάση NodeLink"
type: docs
weight: 2800
url: /el/python-net/aspose.gis/nodelink/
---
...
| [find_nodes_by_name(name)](#find_nodes_by_name_name_5) | Βρίσκει τους κόμβους με βάση το όνομα |
...
Βρίσκει τους κόμβους με βάση το όνομα
...
| Τύπος | Περιγραφή |
| :- | :- |
| [NodeLink[]](/psd/python-net/aspose.gis/nodelink) | Πίνακας κόμβων μορφής κατά όνομα |
