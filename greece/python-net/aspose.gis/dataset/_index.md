...
type: docs
weight: 590
url: /el/python-net/aspose.gis/dataset/
---
...
| driver | [Driver](/psd/python-net/aspose.gis/driver) | r | Λαμβάνει το [Dataset.driver](/psd/python-net/aspose.gis/dataset/) που δημιούργησε αυτό το σύνολο δεδομένων. |
...
| [edit_layer(name, options, spatial_reference_system)](#edit_layer_name_options_spatial_reference_system_10) | Ανοίγει το στρώμα με το καθορισμένο όνομα για επεξεργασία. |
| [edit_layer_at(index, options, spatial_reference_system)](#edit_layer_at_index_options_spatial_reference_system_11) | Ανοίγει το στρώμα με το καθορισμένο όνομα για επεξεργασία. |
| [get_layer_name(index)](#get_layer_name_index_12) | Λαμβάνει το όνομα του στρώματος στον καθορισμένο δείκτη. |
| [has_layer_with_name(name)](#has_layer_with_name_name_13) | Ελέγχει αν το τρέχον σύνολο δεδομένων έχει στρώμα με συγκεκριμένο όνομα. |
| [open(path, driver)](#open_path_driver_14) | Ανοίγει το σύνολο δεδομένων. |
| [open(path, driver)](#open_path_driver_15) | Ανοίγει το σύνολο δεδομένων. |
| [open(path, driver, options)](#open_path_driver_options_16) | Ανοίγει το σύνολο δεδομένων. |
| [open(path, driver, options)](#open_path_driver_options_17) | Ανοίγει το σύνολο δεδομένων. |
| [open_layer(name, options)](#open_layer_name_options_18) | Ανοίγει το στρώμα με το καθορισμένο όνομα για ανάγνωση. |
| [open_layer_at(index, options)](#open_layer_at_index_options_19) | Ανοίγει το στρώμα στον καθορισμένο δείκτη για ανάγνωση. |
| [remove_layer(name)](#remove_layer_name_20) | Αφαιρεί το διανυσματικό στρώμα με το καθορισμένο όνομα. |
| [remove_layer_at(index)](#remove_layer_at_index_21) | Αφαιρεί το διανυσματικό στρώμα στον καθορισμένο δείκτη. |
| [rename_layer(current_name, new_name)](#rename_layer_current_name_new_name_22) | Μετονομασία στρώματος στο σύνολο δεδομένων |
...
Ανοίγει το στρώμα με το καθορισμένο όνομα για επεξεργασία.
...
| Τύπος | Περιγραφή |
| :- | :- |
| [VectorLayer](/psd/python-net/aspose.gis/vectorlayer) | Το στρώμα ανοιγμένο για επεξεργασία. |
