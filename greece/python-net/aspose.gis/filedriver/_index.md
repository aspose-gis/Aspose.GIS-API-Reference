---
title: "FileDriver Κλάση"
type: docs
weight: 880
url: /el/python-net/aspose.gis/filedriver/
---
...
| [open_layer(path, options)](#open_layer_path_options_21) | Ανοίγει το στρώμα για ανάγνωση. |
| [open_layer(path, options)](#open_layer_path_options_22) | Ανοίγει το στρώμα για ανάγνωση. |
| [supports_spatial_reference_system(spatial_reference_system)](#supports_spatial_reference_system_spatial_reference_system_23) | Καθορίζει εάν το καθορισμένο σύστημα αναφοράς χώρου υποστηρίζεται από τον οδηγό. |
