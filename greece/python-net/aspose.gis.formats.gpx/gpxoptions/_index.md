---
title: "GpxOptions Κλάση"
type: docs
weight: 20
url: /el/python-net/aspose.gis.formats.gpx/gpxoptions/
---
...
| **Name** | **Description** |
| :- | :- |
| [GpxOptions()](#GpxOptions__1) | Δημιουργήστε νέα παρουσία. |
## **Properties**
...
| m_attribute | string | r/w | Καθορίζει ποιο χαρακτηριστικό GPX θα εξαχθεί ως συντεταγμένη 'M' των σημείων διαδρομής, σημείων διαδρομής και σημείων ίχνους.<br/> Συμπεριφορά είναι η ίδια με [GpxOptions.z_attribute](/psd/python-net/aspose.gis.formats.gpx/gpxoptions/), προεπιλογή είναι <see langword=\"null\" />. |
...
| nested_attribute_separator | string | r | Μια συμβολοσειρά για το διαχωρισμό του ονόματος του ένθετου χαρακτηριστικού και των δεικτών του. Προεπιλογή είναι το διπλό κάτω παύλο \"__\". |
| read_nested_attributes | bool | r/w | Καθορίζει εάν τα σημεία GPX, όπως 'trkpt' και 'rtept', περιέχουν εσωτερικά χαρακτηριστικά και εάν πρέπει να διαβαστούν. Προεπιλογή είναι <see langword=\"false\" />. |
...
| z_attribute | string | r/w | Καθορίζει ποιο χαρακτηριστικό GPX θα εξαχθεί ως συντεταγμένη 'Z' των σημείων διαδρομής, σημείων διαδρομής και σημείων ίχνους.<br/> Εάν <see langword=\"null\" /> - κανένα χαρακτηριστικό δεν θα εξαχθεί ως συντεταγμένη 'Z'.<br/> Προεπιλογή είναι \"ele\".<br/> Πιθανές τιμές είναι τα ονόματα όλων των χαρακτηριστικών GPX XML που μπορούν να αναπαρασταθούν ως δεκαδικός αριθμός (π.χ. \"speed\", \"magvar\", \"geoidheight\" κλ.). |
