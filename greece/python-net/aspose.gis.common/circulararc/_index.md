---
title: "CircularArc Κλάση"
type: docs
weight: 140
url: /el/python-net/aspose.gis.common/circulararc/
---
...
| **Name** | **Description** |
| :- | :- |
| [CircularArc()](#CircularArc__1) | Αρχικοποιεί μια νέα παρουσία της κλάσης CircularArc |
| [CircularArc(start, mid, end)](#CircularArc_start_mid_end_2) | Αρχικοποιεί μια νέα παρουσία της κλάσης CircularArc |
| [CircularArc(x0, y0, x1, y1, x2, y2)](#CircularArc_x0_y0_x1_y1_x2_y2_3) | Αρχικοποιεί μια νέα παρουσία της κλάσης CircularArc |
## **Properties**
...
Αρχικοποιεί μια νέα παρουσία της κλάσης CircularArc
