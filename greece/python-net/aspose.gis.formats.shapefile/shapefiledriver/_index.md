---
title: "Κλάση ShapefileDriver"
type: docs
weight: 10
url: /el/python-net/aspose.gis.formats.shapefile/shapefiledriver/
---
...
| :- | :- | :- |
| path | string | Διαδρομή προς το αρχείο. |
| options | [ShapefileOptions](/psd/python-net/aspose.gis.formats.shapefile/shapefileoptions) | Επιλογές ειδικές για τον οδηγό. |
