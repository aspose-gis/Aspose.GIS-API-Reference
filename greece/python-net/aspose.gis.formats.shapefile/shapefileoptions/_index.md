---
title: "Κλάση ShapefileOptions"
type: docs
weight: 20
url: /el/python-net/aspose.gis.formats.shapefile/shapefileoptions/
---
...
| **Name** | **Description** |
| :- | :- |
| [ShapefileOptions()](#ShapefileOptions__1) | Δημιουργήστε νέα παρουσία. |
## **Properties**
...
| is_ignore_wrong_data | bool | r/w | Καθορίζει αν πρέπει να ρίξουμε εξαίρεση κατά την ανάλυση λανθασμένων δεδομένων ή να ορίσουμε προεπιλεγμένες τιμές για αυτά |
