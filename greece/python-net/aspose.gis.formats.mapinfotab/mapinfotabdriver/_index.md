---
title: "MapInfoTabDriver Κλάση"
type: docs
weight: 10
url: /el/python-net/aspose.gis.formats.mapinfotab/mapinfotabdriver/
---
...
| :- | :- | :- |
| path | string | Διαδρομή προς το αρχείο. |
| options | [MapInfoTabOptions](/psd/python-net/aspose.gis.formats.mapinfotab/mapinfotaboptions) | Επιλογές ειδικές για τον οδηγό. |
