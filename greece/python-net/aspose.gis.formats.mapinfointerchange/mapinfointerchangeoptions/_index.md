---
title: "MapInfoInterchangeOptions Κλάση"
type: docs
weight: 20
url: /el/python-net/aspose.gis.formats.mapinfointerchange/mapinfointerchangeoptions/
---
...
| **Name** | **Description** |
| :- | :- |
| [MapInfoInterchangeOptions()](#MapInfoInterchangeOptions__1) | Δημιουργήστε νέα παρουσία. |
## **Properties**
| **Name** | **Type** | **Access** | **Description** |
| :- | :- | :- | :- |
| charset | string | r/w | Καθορίζει το charset, από προεπιλογή είναι Neutral |
...
| delimiter | string | r/w | Καθορίζει το delimiter για τα χαρακτηριστικά στο αρχείο mid, από προεπιλογή είναι ο χαρακτήρας tab |
...
| text_string_attribute | string | r/w | Καθορίζει το όνομα του χαρακτηριστικού που αντιπροσωπεύει το κείμενο του γραφικού αντικειμένου 'Text'. |
