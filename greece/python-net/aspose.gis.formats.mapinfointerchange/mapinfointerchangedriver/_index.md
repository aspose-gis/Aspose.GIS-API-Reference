---
title: "MapInfoInterchangeDriver Κλάση"
type: docs
weight: 10
url: /el/python-net/aspose.gis.formats.mapinfointerchange/mapinfointerchangedriver/
---
...
| :- | :- | :- |
| path | string | Διαδρομή προς το αρχείο. |
| options | [MapInfoInterchangeOptions](/psd/python-net/aspose.gis.formats.mapinfointerchange/mapinfointerchangeoptions) | Επιλογές ειδικές για τον οδηγό. |
