---
title: "GeoJsonDriver Κλάση"
type: docs
weight: 10
url: /el/python-net/aspose.gis.formats.geojson/geojsondriver/
---
...
| :- | :- | :- |
| path | string | Διαδρομή προς το αρχείο. |
| options | [GeoJsonOptions](/psd/python-net/aspose.gis.formats.geojson/geojsonoptions) | Επιλογές ειδικές για τον οδηγό. |
