---
title: "Κλάση KmlLodSettings"
type: docs
weight: 50
url: /el/python-net/aspose.gis.formats.kml.specificfields/kmllodsettings/
---
...
| max_fade_extent | int | r/w | MaxFadeExtent του κόμβου 'Lod'. |
| max_lod_pixels | int | r/w | MaxLodPixels του κόμβου 'Lod'. |
| min_fade_extent | int | r/w | MinFadeExtent του κόμβου 'Lod'. |
| min_lod_pixels | int | r/w | MinLodPixels του κόμβου 'Lod'. |
