---
title: "KmlLatLonAltBox Κλάση"
type: docs
weight: 30
url: /el/python-net/aspose.gis.formats.kml.specificfields/kmllatlonaltbox/
---
...
| ανατολικά | double | r/w | Ανατολικά του κόμβου 'LatLonBox'. |
| max_altitude | Nullable<double> | r/w | MaxAltitude του κόμβου 'LatLonBox'. |
| min_altitude | Nullable<double> | r/w | MinAltitude του κόμβου 'LatLonBox'. |
...
| βόρεια | double | r/w | Βόρεια του κόμβου 'LatLonBox'. |
| πρόθεμα | string | r | Λαμβάνει το πρόθεμα. |
| περιστροφή | Nullable<double> | r/w | Περιστροφή του κόμβου 'LatLonBox'. |
| νότια | double | r/w | Νότια του κόμβου 'LatLonBox'. |
| δυτικά | double | r/w | Δυτικά του κόμβου 'LatLonBox'. |
## **Methods**
| **Name** | **Description** |
| :- | :- |
