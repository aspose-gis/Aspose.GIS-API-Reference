---
title: "KmlGroundOverlayInfo Κλάση"
type: docs
weight: 20
url: /el/python-net/aspose.gis.formats.kml.specificfields/kmlgroundoverlayinfo/
---
...
| draw_order | double | r/w | DrawOrder του κόμβου 'GroundOverlay'. |
| icon | [IconInfo](/psd/python-net/aspose.gis.formats.kml.specificfields/iconinfo) | r/w | IconPath του κόμβου 'GroundOverlay'. |
| lat_lon_box | [KmlLatLonBox](/psd/python-net/aspose.gis.formats.kml.specificfields/kmllatlonbox) | r/w | Καθορίζει αντικείμενο από τον κόμβο Kml 'LatLonAltBox'. |
| όνομα | string | r/w | Όνομα του Ground Overlay |
...
| visibility | bool | r/w | Ορατότητα του Ground Overlay |
## **Methods**
| **Name** | **Description** |
| :- | :- |
