---
title: "KmlRegionInfo Κλάση"
type: docs
weight: 70
url: /el/python-net/aspose.gis.formats.kml.specificfields/kmlregioninfo/
---
...
| id | string | r/w | Id του κόμβου 'Region'. |
| lat_lon_alt_box | [KmlLatLonAltBox](/psd/python-net/aspose.gis.formats.kml.specificfields/kmllatlonaltbox) | r/w | Καθορίζει αντικείμενο από τον κόμβο Kml 'LatLonAltBox'. |
| lod | [KmlLodSettings](/psd/python-net/aspose.gis.formats.kml.specificfields/kmllodsettings) | r/w | Καθορίζει αντικείμενο από τον κόμβο Kml 'Lod'. |
