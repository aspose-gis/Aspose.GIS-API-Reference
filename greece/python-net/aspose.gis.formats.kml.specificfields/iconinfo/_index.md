---
title: "Κλάση IconInfo"
type: docs
weight: 10
url: /el/python-net/aspose.gis.formats.kml.specificfields/iconinfo/
---
...
| **Name** | **Description** |
| :- | :- |
| [IconInfo(link)](#IconInfo_link_1) | Αρχικοποιεί μια νέα παρουσία της κλάσης [IconInfo](/psd/python-net/aspose.gis.formats.kml.specificfields/iconinfo/). |
## **Properties**
| **Name** | **Type** | **Access** | **Description** |
| :- | :- | :- | :- |
| children | [NodeLink[]](/psd/python-net/aspose.gis/nodelink) | r | Λαμβάνει τα παιδιά. |
| href | string | r/w | Λαμβάνει ή ορίζει το href. |
...
Αρχικοποιεί μια νέα παρουσία της κλάσης [IconInfo](/psd/python-net/aspose.gis.formats.kml.specificfields/iconinfo/).

**Parameters:**

| Παράμετρος | Τύπος | Περιγραφή |
| :- | :- | :- |
| link | [NodeLink](/psd/python-net/aspose.gis/nodelink) | Ο κόμβος από τον οποίο θα δημιουργηθεί |
