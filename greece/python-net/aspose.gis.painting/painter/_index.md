...
type: docs
weight: 60
url: /el/python-net/aspose.gis.painting/painter/
---
...
| **Name** | **Description** |
| :- | :- |
| [Painter(engine)](#Painter_engine_1) | Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης Painter |
## **Properties**
...
Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης Painter
