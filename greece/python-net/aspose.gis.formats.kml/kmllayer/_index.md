---
title: "Κλάση KmlLayer"
type: docs
weight: 140
url: /el/python-net/aspose.gis.formats.kml/kmllayer/
---
...
| driver | [Driver](/psd/python-net/aspose.gis/driver) | r | Λαμβάνει το [KmlLayer.driver](/psd/python-net/aspose.gis.formats.kml/kmllayer/) που δημιούργησε αυτό το επίπεδο. |
| features | [Feature[]](/psd/python-net/aspose.gis/feature) | r | Λαμβάνει τη λίστα χαρακτηριστικών. |
...
| ground_overlay_list | System.Collections.Generic.List<Aspose.Gis.Formats.Kml.SpecificFields.KmlGroundOverlayInfo> | r | Λίστα των KmlGroundOverlayInfo από κόμβους GroundOverlay |
| network_link_list | System.Collections.Generic.List<Aspose.Gis.Formats.Kml.SpecificFields.KmlNetworkLinkInfo> | r | Λίστα των KmlNetworkLinkInfo από κόμβους NetworkLink |
| region_list | System.Collections.Generic.List<Aspose.Gis.Formats.Kml.SpecificFields.KmlRegionInfo> | r | Λίστα των KmlRegionInfo από κόμβους Region |
| spatial_reference_system | [SpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem/) | r | Λάβετε το σύστημα αναφοράς χώρου αυτού του επιπέδου. Για KML αυτό είναι πάντα WGS84. |
## **Methods**
| **Name** | **Description** |
| :- | :- |
