---
title: "EsriJsonDriver Κλάση"
type: docs
weight: 10
url: /el/python-net/aspose.gis.formats.esrijson/esrijsondriver/
---
...
| :- | :- | :- |
| path | string | Διαδρομή προς το αρχείο. |
| options | [EsriJsonOptions](/psd/python-net/aspose.gis.formats.esrijson/esrijsonoptions) | Επιλογές ειδικές για τον οδηγό. |
