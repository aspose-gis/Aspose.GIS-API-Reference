...
type: docs
weight: 20
url: /el/python-net/aspose.gis.projections/projection/
---
...
| Παράμετρος | Τύπος | Περιγραφή |
| :- | :- | :- |
| ανατολική συντεταγμένη | double |  |
| βόρεια συντεταγμένη | double |  |
| γεωγραφικό μήκος | float[] |  |
| γεωγραφικό πλάτος | float[] |  |
...
| Παράμετρος | Τύπος | Περιγραφή |
| :- | :- | :- |
| γεωγραφικό μήκος | double |  |
| γεωγραφικό πλάτος | double |  |
| ανατολική συντεταγμένη | float[] |  |
| βόρεια συντεταγμένη | float[] |  |
