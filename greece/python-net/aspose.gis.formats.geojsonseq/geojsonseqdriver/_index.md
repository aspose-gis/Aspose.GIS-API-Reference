---
title: "GeoJsonSeqDriver Κλάση"
type: docs
weight: 10
url: /el/python-net/aspose.gis.formats.geojsonseq/geojsonseqdriver/
---
...
| :- | :- | :- |
| path | string | Διαδρομή προς το αρχείο. |
| options | [GeoJsonSeqOptions](/psd/python-net/aspose.gis.formats.geojsonseq/geojsonseqoptions) | Επιλογές ειδικές για τον οδηγό. |
