...
type: docs
weight: 80
url: /el/python-net/aspose.gis.common.formats.mapinfo.graphicalobjects/point/
---
...
| **Name** | **Description** |
| :- | :- |
| [Point()](#Point__1) | Αρχικοποιεί μια νέα παρουσία της κλάσης Point |
## **Properties**
...
| σύμβολο | Nullable<Aspose.Gis.Common.Formats.MapInfo.Styling.Symbol> | r/w |  |
| symbol_id | byte | r/w |  |
## **Methods**
| **Name** | **Description** |
| :- | :- |
...
Αρχικοποιεί μια νέα παρουσία της κλάσης Point
