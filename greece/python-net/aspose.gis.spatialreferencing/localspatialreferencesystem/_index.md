---
title: "Κλάση LocalSpatialReferenceSystem."
type: docs
weight: 130
url: /el/python-net/aspose.gis.spatialreferencing/localspatialreferencesystem/
---
...
| as_local | [LocalSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/localspatialreferencesystem) | r | Επιστρέψτε αυτό. |
| as_projected | [ProjectedSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem) | r | Επιστρέφει αυτό το SRS μετατρεπόμενο σε [ProjectedSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/).<br/>            Χρησιμοποιήστε [SpatialReferenceSystem.type](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem/) για να διαπιστώσετε εάν η μετατροπή είναι δυνατή. |
...
| dimensions_count | int | r | Αριθμός διαστάσεων σε αυτό το SRS. |
...
| geographic_datum | [GeographicDatum](/psd/python-net/aspose.gis.spatialreferencing/geographicdatum) | r | Εκτοπίζει InvalidOperationException, επειδή το Local SRS δεν έχει γεωγραφικό datum. |
| has_geographic_datum | bool | r | Επιστρέφει <see langword="false" />, επειδή το Local SRS δεν έχει γεωγραφικό datum. |
| has_prime_meridian | bool | r | Επιστρέφει <see langword="false" />, επειδή το Local SRS δεν έχει πρώτο μεσημβαίο. |
...
| local_datum | [LocalDatum](/psd/python-net/aspose.gis.spatialreferencing/localdatum) | r | Datum που περιγράφει τη μέθοδο μέτρησης. |
...
| prime_meridian | [PrimeMeridian](/psd/python-net/aspose.gis.spatialreferencing/primemeridian) | r | Εκτοπίζει InvalidOperationException, επειδή το Local SRS δεν έχει πρώτο μεσημβαίο. |
| type | [SpatialReferenceSystemType](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype) | r | Επιστρέφει [SpatialReferenceSystemType.LOCAL](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/). |
| unit | [Unit](/psd/python-net/aspose.gis.spatialreferencing/unit) | r | Μονάδα αυτού του SRS. |
...
| [get_unit(dimension)](#get_unit_dimension_12) | Λάβετε [LocalSpatialReferenceSystem.unit](/psd/python-net/aspose.gis.spatialreferencing/localspatialreferencesystem/) της διάστασης. |
...
Λάβετε [LocalSpatialReferenceSystem.unit](/psd/python-net/aspose.gis.spatialreferencing/localspatialreferencesystem/) της διάστασης.
