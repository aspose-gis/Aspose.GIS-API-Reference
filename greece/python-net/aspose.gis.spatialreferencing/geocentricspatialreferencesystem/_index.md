---
title: "GeocentricSpatialReferenceSystem Κλάση"
type: docs
weight: 50
url: /el/python-net/aspose.gis.spatialreferencing/geocentricspatialreferencesystem/
---
...
| as_geocentric | [GeocentricSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/geocentricspatialreferencesystem) | r | Επιστρέψτε αυτό. |
...
| axises_order | [GeocentricAxisesOrder](/psd/python-net/aspose.gis.spatialreferencing/geocentricaxisesorder) | r | Σειρά αξόνων σε αυτό το SRS.<br/>            Εάν αυτό το SRS δεν είναι έγκυρο και έχει λανθασμένες κατευθύνσεις αξόνων, επιστρέφεται το [GeocentricAxisesOrder.INVALID](/psd/python-net/aspose.gis.spatialreferencing/geocentricaxisesorder/). |
| dimensions_count | int | r | Επιστρέφει 3, επειδή το γεωκεντρικό SRS είναι πάντα τρισδιάστατο. |
...
| has_geographic_datum | bool | r | Επιστρέφει <see langword=\"true\" />, επειδή το γεωκεντρικό SRS έχει πάντα γεωγραφικό datum. |
| has_prime_meridian | bool | r | Επιστρέφει <see langword=\"true\" />, επειδή το γεωκεντρικό SRS έχει πάντα πρωτεύον μεσημβρινό. |
...
| linear_unit | [Unit](/psd/python-net/aspose.gis.spatialreferencing/unit) | r | Μονάδα, που χρησιμοποιείται σε αυτό το SRS. |
...
| type | [SpatialReferenceSystemType](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype) | r | Επιστρέφει το [SpatialReferenceSystemType.GEOCENTRIC](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/). |
