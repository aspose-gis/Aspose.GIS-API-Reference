---
title: "Κλάση GeographicSpatialReferenceSystem"
type: docs
weight: 80
url: /el/python-net/aspose.gis.spatialreferencing/geographicspatialreferencesystem/
---
...
| :- | :- | :- | :- |
| angular_unit | [Unit](/psd/python-net/aspose.gis.spatialreferencing/unit) | r | Μονάδα, που χρησιμοποιείται για γωνιακές διαστάσεις, σε αυτό το SRS. |
...
| as_geographic | [GeographicSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/geographicspatialreferencesystem) | r | Επιστρέφει αυτό. |
...
| axises_order | [GeographicAxisesOrder](/psd/python-net/aspose.gis.spatialreferencing/geographicaxisesorder) | r | Σειρά αξόνων σε αυτό το SRS.<br/>            Εάν αυτό το SRS δεν είναι έγκυρο και έχει λανθασμένες κατευθύνσεις αξόνων, επιστρέφεται το [GeographicAxisesOrder.INVALID](/psd/python-net/aspose.gis.spatialreferencing/geographicaxisesorder/). |
| dimensions_count | int | r | Επιστρέφει τον αριθμό διαστάσεων σε αυτό το SRS. Για γεωγραφικό SRS αυτό μπορεί να είναι:<br/>            δύο - εάν αυτό είναι μοναδικό γεωγραφικό SRS.<br/>            τρία - εάν αυτό είναι σύνθετο SRS, που αποτελείται από μοναδικό, δισδιάστατο, γεωγραφικό SRS και κάθετο SRS, που προσθέτει τρίτη διάσταση. |
...
| has_geographic_datum | bool | r | Επιστρέφει <see langword=\"true\" />, καθώς το γεωγραφικό SRS έχει πάντα τον αρχικό μεσημβρινό. |
| has_prime_meridian | bool | r | Επιστρέφει <see langword=\"true\" />, καθώς το γεωγραφικό SRS έχει πάντα τον αρχικό μεσημβρινό. |
...
| type | [SpatialReferenceSystemType](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype) | r | Επιστρέφει το [SpatialReferenceSystemType.GEOGRAPHIC](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/). |
