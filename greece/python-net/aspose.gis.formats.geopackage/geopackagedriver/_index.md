---
title: "GeoPackageDriver Κλάση"
type: docs
weight: 20
url: /el/python-net/aspose.gis.formats.geopackage/geopackagedriver/
---
...
| **Name** | **Description** |
| :- | :- |
| [GeoPackageDriver()](#GeoPackageDriver__1) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης GeoPackageDriver |
## **Properties**
...
| [create_layer(path, options)](#create_layer_path_options_7) | Δημιουργεί το στρώμα και το ανοίγει για προσθήκη. |
| [create_layer(path, options)](#create_layer_path_options_8) | Δημιουργεί το στρώμα και το ανοίγει για προσθήκη. |
| [create_layer(path, options, spatial_reference_system)](#create_layer_path_options_spatial_reference_system_9) | Δημιουργεί το στρώμα και το ανοίγει για προσθήκη. |
| [create_layer(path, options, spatial_reference_system)](#create_layer_path_options_spatial_reference_system_10) | Δημιουργεί το στρώμα και το ανοίγει για προσθήκη. |
| [create_layer(path, spatial_reference_system)](#create_layer_path_spatial_reference_system_11) | Δημιουργεί το στρώμα και το ανοίγει για προσθήκη. |
| [create_layer(path, spatial_reference_system)](#create_layer_path_spatial_reference_system_12) | Δημιουργεί το στρώμα και το ανοίγει για προσθήκη. |
| [edit_layer(path, options)](#edit_layer_path_options_13) | Ανοίγει ένα στρώμα για επεξεργασία. |
| [edit_layer(path, options)](#edit_layer_path_options_14) | Ανοίγει ένα στρώμα για επεξεργασία. |
| [open_dataset(path)](#open_dataset_path_15) | Ανοίγει το σύνολο δεδομένων. |
| [open_dataset(path)](#open_dataset_path_16) | Ανοίγει το σύνολο δεδομένων. |
| [open_dataset(path, options)](#open_dataset_path_options_17) | Ανοίγει το σύνολο δεδομένων. |
| [open_dataset(path, options)](#open_dataset_path_options_18) | Ανοίγει το σύνολο δεδομένων. |
| [open_dataset(path, options)](#open_dataset_path_options_19) | Ανοίγει το σύνολο δεδομένων. |
| [open_layer(path)](#open_layer_path_20) | Ανοίγει το στρώμα για ανάγνωση. |
| [open_layer(path)](#open_layer_path_21) | Ανοίγει το στρώμα για ανάγνωση. |
| [open_layer(path, options)](#open_layer_path_options_22) | Ανοίγει το στρώμα για ανάγνωση. |
| [open_layer(path, options)](#open_layer_path_options_23) | Ανοίγει το στρώμα για ανάγνωση. |
| [supports_spatial_reference_system(spatial_reference_system)](#supports_spatial_reference_system_spatial_reference_system_24) | Καθορίζει εάν το καθορισμένο σύστημα αναφοράς χώρου υποστηρίζεται από τον οδηγό. |
...
Αρχικοποιεί ένα νέο αντικείμενο της κλάσης GeoPackageDriver
...
| :- | :- | :- |
| path | [AbstractPath](/psd/python-net/aspose.gis/abstractpath) | Διαδρομή προς το σύνολο δεδομένων. |
| options | [GeoPackageOptions](/psd/python-net/aspose.gis.formats.geopackage/geopackageoptions) | Επιλογές ειδικές για τον οδηγό. |

**Returns**

| Τύπος | Περιγραφή |
| :- | :- |
| [GeoPackageDataset](/psd/python-net/aspose.gis.formats.geopackage/geopackagedataset) | Μια παρουσία του [Dataset](/psd/python-net/aspose.gis/dataset/). |
...
| Τύπος | Περιγραφή |
| :- | :- |
| bool | Τιμή Boolean, που υποδεικνύει εάν το καθορισμένο σύστημα αναφοράς χώρου υποστηρίζεται από τον οδηγό.<br/>            <see langword="null" /> θεωρείται υποστηριζόμενο από οποιονδήποτε οδηγό. |
