---
title: "LabelsPlacer Κλάση"
type: docs
weight: 90
url: /el/python-net/aspose.gis.labeling/labelsplacer/
---
...
| **Name** | **Description** |
| :- | :- |
| [LabelsPlacer(bounding_rectangle)](#LabelsPlacer_bounding_rectangle_1) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης LabelsPlacer |
| [LabelsPlacer(x_min, y_min, x_max, y_max)](#LabelsPlacer_x_min_y_min_x_max_y_max_2) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης LabelsPlacer |
## **Methods**
| **Name** | **Description** |
| :- | :- |
...
Αρχικοποιεί ένα νέο αντικείμενο της κλάσης LabelsPlacer
