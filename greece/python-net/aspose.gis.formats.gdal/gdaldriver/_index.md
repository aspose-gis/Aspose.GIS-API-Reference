---
title: "GdalDriver Κλάση"
type: docs
weight: 10
url: /el/python-net/aspose.gis.formats.gdal/gdaldriver/
---
...
| [create_layer(path, options, spatial_reference_system)](#create_layer_path_options_spatial_reference_system_9) | Δημιουργεί ένα στρώμα και το ανοίγει για την προσθήκη νέων χαρακτηριστικών. |
| [create_layer(path, options, spatial_reference_system)](#create_layer_path_options_spatial_reference_system_10) | Δημιουργεί ένα στρώμα και το ανοίγει για την προσθήκη νέων χαρακτηριστικών. |
...
| [open_layer(path)](#open_layer_path_19) | Ανοίγει το στρώμα για ανάγνωση. |
| [open_layer(path)](#open_layer_path_20) | Ανοίγει το στρώμα για ανάγνωση. |
| [open_layer(path, options)](#open_layer_path_options_21) | Ανοίγει ένα στρώμα για ανάγνωση. |
| [open_layer(path, options)](#open_layer_path_options_22) | Ανοίγει ένα στρώμα για ανάγνωση. |
| [open_layer(path, options)](#open_layer_path_options_23) | Ανοίγει ένα στρώμα για ανάγνωση. |
...
| :- | :- | :- |
| path | string | Διαδρομή προς το αρχείο. |
| options | [GdalOptions](/psd/python-net/aspose.gis.formats.gdal/gdaloptions) | Επιλογές ειδικές για τον οδηγό. |
