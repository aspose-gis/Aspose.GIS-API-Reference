---
title: "Clase GmlDriver"
type: docs
weight: 10
url: /es/python-net/aspose.gis.formats.gml/gmldriver/
---
...
| [create_layer(path, options, spatial_reference_system)](#create_layer_path_options_spatial_reference_system_14) | Crea una capa y la abre para agregar nuevas características. |
...
| :- | :- | :- |
| path | string | Ruta al archivo. |
| options | [GmlOptions](/psd/python-net/aspose.gis.formats.gml/gmloptions) | Opciones específicas del controlador. |
