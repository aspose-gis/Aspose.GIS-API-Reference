---
title: "Clase MapInfoInterchangeOptions"
type: docs
weight: 20
url: /es/python-net/aspose.gis.formats.mapinfointerchange/mapinfointerchangeoptions/
---
...
| **Name** | **Descripción** |
| :- | :- |
| [MapInfoInterchangeOptions()](#MapInfoInterchangeOptions__1) | Crear una nueva instancia. |
## **Properties**
| **Name** | **Type** | **Access** | **Descripción** |
| :- | :- | :- | :- |
| charset | string | r/w | Determina charset, por defecto es Neutral |
...
| delimitador | string | r/w | Determina el delimitador para los atributos en el archivo mid, por defecto es el carácter de tabulación |
