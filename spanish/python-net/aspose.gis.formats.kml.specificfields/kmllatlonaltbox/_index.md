---
title: "Clase KmlLatLonAltBox"
type: docs
weight: 30
url: /es/python-net/aspose.gis.formats.kml.specificfields/kmllatlonaltbox/
---
...
| este | double | r/w | Este del nodo 'LatLonBox'. |
| max_altitude | Nullable<double> | r/w | MaxAltitude del nodo 'LatLonBox'. |
| min_altitude | Nullable<double> | r/w | MinAltitude del nodo 'LatLonBox'. |
...
| norte | double | r/w | Norte del nodo 'LatLonBox'. |
| prefijo | string | r | Obtiene el prefijo. |
| rotación | Nullable<double> | r/w | Rotación del nodo 'LatLonBox'. |
| sur | double | r/w | Sur del nodo 'LatLonBox'. |
| oeste | double | r/w | Oeste del nodo 'LatLonBox'. |
## **Methods**
| **Name** | **Descripción** |
| :- | :- |
