---
title: "Clase KmlGroundOverlayInfo"
type: docs
weight: 20
url: /es/python-net/aspose.gis.formats.kml.specificfields/kmlgroundoverlayinfo/
---
...
| draw_order | double | r/w | DrawOrder del nodo 'GroundOverlay'. |
| icon | [IconInfo](/psd/python-net/aspose.gis.formats.kml.specificfields/iconinfo) | r/w | IconPath del nodo 'GroundOverlay'. |
| lat_lon_box | [KmlLatLonBox](/psd/python-net/aspose.gis.formats.kml.specificfields/kmllatlonbox) | r/w | Especifica el objeto del nodo Kml 'LatLonAltBox'. |
| nombre | string | r/w | Nombre del Ground Overlay |
...
| visibility | bool | r/w | Visibilidad del Ground Overlay |
## **Methods**
| **Name** | **Descripción** |
| :- | :- |
