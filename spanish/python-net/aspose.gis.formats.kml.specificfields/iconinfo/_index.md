---
title: "Clase IconInfo"
type: docs
weight: 10
url: /es/python-net/aspose.gis.formats.kml.specificfields/iconinfo/
---
...
| **Name** | **Descripción** |
| :- | :- |
| [IconInfo(link)](#IconInfo_link_1) | Inicializa una nueva instancia de la clase [IconInfo](/psd/python-net/aspose.gis.formats.kml.specificfields/iconinfo/). |
## **Properties**
| **Name** | **Type** | **Access** | **Descripción** |
| :- | :- | :- | :- |
| children | [NodeLink[]](/psd/python-net/aspose.gis/nodelink) | r | Obtiene los hijos. |
| href | string | r/w | Obtiene o establece el href. |
...
Inicializa una nueva instancia de la clase [IconInfo](/psd/python-net/aspose.gis.formats.kml.specificfields/iconinfo/).

**Parameters:**

| Parámetro | Tipo | Descripción |
| :- | :- | :- |
| link | [NodeLink](/psd/python-net/aspose.gis/nodelink) | El nodo desde el cual se creará |
