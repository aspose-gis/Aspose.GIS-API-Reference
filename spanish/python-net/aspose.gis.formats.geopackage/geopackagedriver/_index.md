---
title: "Clase GeoPackageDriver"
type: docs
weight: 20
url: /es/python-net/aspose.gis.formats.geopackage/geopackagedriver/
---
...
| **Name** | **Descripción** |
| :- | :- |
| [GeoPackageDriver()](#GeoPackageDriver__1) | Inicializa una nueva instancia de la clase GeoPackageDriver |
## **Properties**
...
| [open_dataset(path, options)](#open_dataset_path_options_19) | Abre el conjunto de datos. |
| [open_layer(path)](#open_layer_path_20) | Abre la capa para lectura. |
| [open_layer(path)](#open_layer_path_21) | Abre la capa para lectura. |
| [open_layer(path, options)](#open_layer_path_options_22) | Abre la capa para lectura. |
| [open_layer(path, options)](#open_layer_path_options_23) | Abre la capa para lectura. |
...
Inicializa una nueva instancia de la clase GeoPackageDriver
...
| :- | :- | :- |
| path | [AbstractPath](/psd/python-net/aspose.gis/abstractpath) | Ruta al conjunto de datos. |
| options | [GeoPackageOptions](/psd/python-net/aspose.gis.formats.geopackage/geopackageoptions) | Opciones específicas del controlador. |

**Returns**

| Tipo | Descripción |
| :- | :- |
| [GeoPackageDataset](/psd/python-net/aspose.gis.formats.geopackage/geopackagedataset) | Una instancia de [Dataset](/psd/python-net/aspose.gis/dataset/). |
