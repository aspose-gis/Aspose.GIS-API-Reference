---
title: "Clase GdalDriver"
type: docs
weight: 10
url: /es/python-net/aspose.gis.formats.gdal/gdaldriver/
---
...
| [create_layer(path, options, spatial_reference_system)](#create_layer_path_options_spatial_reference_system_9) | Crea una capa y la abre para agregar nuevas características. |
| [create_layer(path, options, spatial_reference_system)](#create_layer_path_options_spatial_reference_system_10) | Crea una capa y la abre para agregar nuevas características. |
...
| [open_layer(path, options)](#open_layer_path_options_21) | Abre una capa para lectura. |
| [open_layer(path, options)](#open_layer_path_options_22) | Abre una capa para lectura. |
| [open_layer(path, options)](#open_layer_path_options_23) | Abre una capa para lectura. |
| [supports_spatial_reference_system(spatial_reference_system)](#supports_spatial_reference_system_spatial_reference_system_24) | Determina si el sistema de referencia espacial especificado es compatible con el controlador. |
...
| :- | :- | :- |
| path | string | Ruta al archivo. |
| options | [GdalOptions](/psd/python-net/aspose.gis.formats.gdal/gdaloptions) | Opciones específicas del controlador. |
