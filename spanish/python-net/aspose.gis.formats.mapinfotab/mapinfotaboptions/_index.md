---
title: "Clase MapInfoTabOptions"
type: docs
weight: 20
url: /es/python-net/aspose.gis.formats.mapinfotab/mapinfotaboptions/
---
...
| **Name** | **Descripción** |
| :- | :- |
| [MapInfoTabOptions()](#MapInfoTabOptions__1) | Crear una nueva instancia. |
## **Properties**
| **Name** | **Type** | **Access** | **Descripción** |
| :- | :- | :- | :- |
| block_size | int | r/w | Tamaño de bloque para archivos '*.map' (múltiplos de 512). El valor predeterminado es 16384. Valores válidos: de 512 a 32256. |
...
| is_ignore_wrong_data | bool | r/w | Determina si debemos lanzar una excepción al trabajar con datos incorrectos o establecer valores predeterminados para ellos |
...
| text_string_attribute | string | r/w | Especifica el nombre del atributo que representa el texto del objeto gráfico 'Text'. |
