---
title: "CircularArc Clase"
type: docs
weight: 140
url: /es/python-net/aspose.gis.common/circulararc/
---
...
| **Name** | **Descripción** |
| :- | :- |
| [CircularArc()](#CircularArc__1) | Inicializa una nueva instancia de la clase CircularArc |
| [CircularArc(start, mid, end)](#CircularArc_start_mid_end_2) | Inicializa una nueva instancia de la clase CircularArc |
| [CircularArc(x0, y0, x1, y1, x2, y2)](#CircularArc_x0_y0_x1_y1_x2_y2_3) | Inicializa una nueva instancia de la clase CircularArc |
## **Properties**
...
Inicializa una nueva instancia de la clase CircularArc
