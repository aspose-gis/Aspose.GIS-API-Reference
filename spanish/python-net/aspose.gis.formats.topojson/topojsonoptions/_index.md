---
title: "TopoJsonOptions Clase"
type: docs
weight: 20
url: /es/python-net/aspose.gis.formats.topojson/topojsonoptions/
---
...
| **Name** | **Descripción** |
| :- | :- |
| [TopoJsonOptions()](#TopoJsonOptions__1) | Crear una nueva instancia. |
## **Properties**
...
| default_object_name | string | r/w | Nombre del objeto donde se colocan las características por defecto. |
...
| object_name_attribute | string | r/w | Nombre del atributo que refleja el nombre del objeto que contiene una característica. |
| quantization_number | Nullable<int> | r/w | Especifica el número de cuantización a usar para cuantizar coordenadas y codificar en delta los arcos en el TopoJSON de salida. |
...
| transform | [TopoJsonTransform](/psd/python-net/aspose.gis.formats.topojson/topojsontransform) | r/w | Especifica el objeto de transformación a usar para cuantizar coordenadas y codificar en delta los arcos en el TopoJSON de salida. |
