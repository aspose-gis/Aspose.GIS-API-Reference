---
title: "Clase KmlOptions"
type: docs
weight: 190
url: /es/python-net/aspose.gis.formats.kml/kmloptions/
---
...
| **Name** | **Descripción** |
| :- | :- |
| [KmlOptions()](#KmlOptions__1) | Crear una nueva instancia. |
## **Properties**
| **Name** | **Type** | **Access** | **Descripción** |
| :- | :- | :- | :- |
| altitude_mode | [AltitudeModes](/psd/python-net/aspose.gis.formats.kml/altitudemodes) | r/w | Le permite especificar los AltitudeModes a usar para geometrías KML |
...
| document_id | string | r/w | Se usa para especificar el id del nodo raíz 'Document' |
...
| symbol_to_replace_invalid_chars | char | r/w | Determina qué símbolo se usará para reemplazar caracteres inválidos al leer.<br/>            El reemplazo se omite si el valor es '\\0'. Por defecto, el valor es el carácter '\\0'. |
