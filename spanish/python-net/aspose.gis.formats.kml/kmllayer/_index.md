---
title: "Clase KmlLayer"
type: docs
weight: 140
url: /es/python-net/aspose.gis.formats.kml/kmllayer/
---
...
| driver | [Driver](/psd/python-net/aspose.gis/driver) | r | Obtiene el [KmlLayer.driver](/psd/python-net/aspose.gis.formats.kml/kmllayer/) que instanció esta capa. |
| features | [Feature[]](/psd/python-net/aspose.gis/feature) | r | Obtiene la lista de características. |
...
| ground_overlay_list | System.Collections.Generic.List<Aspose.Gis.Formats.Kml.SpecificFields.KmlGroundOverlayInfo> | r | Lista de KmlGroundOverlayInfo de los nodos GroundOverlay |
| network_link_list | System.Collections.Generic.List<Aspose.Gis.Formats.Kml.SpecificFields.KmlNetworkLinkInfo> | r | Lista de KmlNetworkLinkInfo de los nodos NetworkLink |
| region_list | System.Collections.Generic.List<Aspose.Gis.Formats.Kml.SpecificFields.KmlRegionInfo> | r | Lista de KmlRegionInfo de los nodos Region |
| spatial_reference_system | [SpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem/) | r | Obtiene el sistema de referencia espacial de esta capa. Para KML siempre es WGS84. |
## **Methods**
| **Name** | **Descripción** |
| :- | :- |
