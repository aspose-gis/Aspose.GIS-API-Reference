---
title: "Clase KmlDriver"
type: docs
weight: 50
url: /es/python-net/aspose.gis.formats.kml/kmldriver/
---
...
| [open_as_kml_layer(path, options)](#open_as_kml_layer_path_options_18) | Abre una capa Kml para lectura. |
...
| [open_layer(path)](#open_layer_path_24) | Abre la capa para lectura. |
...
| [supports_spatial_reference_system(spatial_reference_system)](#supports_spatial_reference_system_spatial_reference_system_29) | Determina si el sistema de referencia espacial especificado es compatible con el controlador. |
...
| :- | :- | :- |
| path | string | Ruta al archivo. |
| options | [KmlOptions](/psd/python-net/aspose.gis.formats.kml/kmloptions) | Opciones específicas del controlador. |
...
Abre una capa Kml para lectura.
...
| Tipo | Descripción |
| :- | :- |
| [KmlLayer](/psd/python-net/aspose.gis.formats.kml/kmllayer) | KmlLayer con campos específicos |
