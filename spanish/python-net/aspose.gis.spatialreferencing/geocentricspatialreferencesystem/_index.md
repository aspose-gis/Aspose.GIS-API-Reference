---
title: "Clase GeocentricSpatialReferenceSystem"
type: docs
weight: 50
url: /es/python-net/aspose.gis.spatialreferencing/geocentricspatialreferencesystem/
---
...
| as_geocentric | [GeocentricSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/geocentricspatialreferencesystem) | r | Devuelve esto. |
...
| axises_order | [GeocentricAxisesOrder](/psd/python-net/aspose.gis.spatialreferencing/geocentricaxisesorder) | r | Orden de ejes en este SRS.<br/>            Si este SRS no es válido y tiene direcciones de ejes incorrectas, se devuelve [GeocentricAxisesOrder.INVALID](/psd/python-net/aspose.gis.spatialreferencing/geocentricaxisesorder/). |
| dimensions_count | int | r | Devuelve 3, ya que el SRS geocéntrico es siempre tridimensional. |
...
| has_geographic_datum | bool | r | Devuelve <see langword=\"true\" />, ya que el SRS geocéntrico siempre tiene datum geográfico. |
| has_prime_meridian | bool | r | Devuelve <see langword=\"true\" />, ya que el SRS geocéntrico siempre tiene meridiano principal. |
...
| linear_unit | [Unit](/psd/python-net/aspose.gis.spatialreferencing/unit) | r | Unidad, utilizada en este SRS. |
...
| type | [SpatialReferenceSystemType](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype) | r | Devuelve [SpatialReferenceSystemType.GEOCENTRIC](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/). |
