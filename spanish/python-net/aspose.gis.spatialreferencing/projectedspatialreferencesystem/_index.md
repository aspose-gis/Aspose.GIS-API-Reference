---
title: "Clase ProjectedSpatialReferenceSystem"
type: docs
weight: 150
url: /es/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/
---
...
| :- | :- | :- | :- |
| angular_unit | [Unit](/psd/python-net/aspose.gis.spatialreferencing/unit) | r | Unidad que se usa para los valores angulares en este SRS y para los parámetros angulares de [ProjectedSpatialReferenceSystem.projection](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/).<br/>            Coincide con la unidad angular de [ProjectedSpatialReferenceSystem.base](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/). |
| as_compound | [CompoundSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/compoundspatialreferencesystem) | r | Devuelve este SRS convertido a [CompoundSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/compoundspatialreferencesystem/).<br/>            Utilice [SpatialReferenceSystem.is_compound](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem/) para averiguar si la conversión es posible. |
...
| as_geographic | [GeographicSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/geographicspatialreferencesystem) | r | Devuelve este SRS convertido a [GeographicSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/geographicspatialreferencesystem/).<br/>            Utilice [SpatialReferenceSystem.type](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem/) para averiguar si la conversión es posible. |
...
| as_projected | [ProjectedSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem) | r | Devuelve esto. |
...
| axises_order | [ProjectedAxisesOrder](/psd/python-net/aspose.gis.spatialreferencing/projectedaxisesorder) | r | Orden de ejes en este SRS.<br/>            Si este SRS no es válido y tiene direcciones de ejes incorrectas, se devuelve [ProjectedAxisesOrder.INVALID](/psd/python-net/aspose.gis.spatialreferencing/projectedaxisesorder/). |
| base | [GeographicSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/geographicspatialreferencesystem) | r | SRS geográfico al que se aplicó [ProjectedSpatialReferenceSystem.projection](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/) para obtener este SRS. |
| dimensions_count | int | r | Devuelve el recuento de dimensiones en este SRS. Para SRS proyectados esto puede ser:<br/>            dos - si es un SRS proyectado único.<br/>            tres - si es un SRS compuesto, que consiste en un SRS proyectado único, bidimensional, y un SRS vertical, que añade la tercera dimensión. |
...
| geographic_datum | [GeographicDatum](/psd/python-net/aspose.gis.spatialreferencing/geographicdatum) | r | Devuelve el datum geográfico de este SRS. |
| has_geographic_datum | bool | r | Devuelve true, ya que los SRS proyectados siempre tienen meridiano principal. |
| has_prime_meridian | bool | r | Devuelve true, ya que los SRS proyectados siempre tienen meridiano principal. |
...
| is_compound | bool | r | Devuelve si este SRS es compuesto (una unión de dos SRS).<br/>            Las siguientes combinaciones de SRS en un SRS compuesto se consideran válidas:<br/>            SRS geográfico + SRS vertical, en este caso el tipo de SRS compuesto será [SpatialReferenceSystemType.GEOGRAPHIC](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/).<br/>            SRS proyectado + SRS vertical, en este caso el tipo de SRS compuesto será [SpatialReferenceSystemType.PROJECTED](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/).<br/>            Si la combinación de SRS difiere, el tipo de SRS compuesto será [SpatialReferenceSystemType.UNKNOWN](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/). |
...
| linear_unit | [Unit](/psd/python-net/aspose.gis.spatialreferencing/unit) | r | Unidad que se utiliza para dimensiones lineales en este SRS y para parámetros lineales de [ProjectedSpatialReferenceSystem.projection](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/). |
...
| prime_meridian | [PrimeMeridian](/psd/python-net/aspose.gis.spatialreferencing/primemeridian) | r | Devuelve el meridiano principal de este SRS. |
| projection | [Projection](/psd/python-net/aspose.gis.spatialreferencing/projection) | r | Proyección que se aplicó a [ProjectedSpatialReferenceSystem.base](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/) para obtener este SRS. |
| type | [SpatialReferenceSystemType](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype) | r | Devuelve [SpatialReferenceSystemType.PROJECTED](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/). |
...
| [validate(error_message)](#validate_error_message_18) | Determinar si este SRS es válido. |
...
| Parámetro | Tipo | Descripción |
| :- | :- | :- |
| error_message | Cadena | Si el método devuelve <see langword=\"false\" />, entonces esta es la descripción de la invalidez. |

**Returns**

| Tipo | Descripción |
| :- | :- |
| bool | <see langword=\"true\" /> si el SRS es válido, <see langword=\"false\" /> de lo contrario. |
