---
title: "Clase GeographicSpatialReferenceSystem"
type: docs
weight: 80
url: /es/python-net/aspose.gis.spatialreferencing/geographicspatialreferencesystem/
---
...
| :- | :- | :- | :- |
| angular_unit | [Unit](/psd/python-net/aspose.gis.spatialreferencing/unit) | r | Unidad, utilizada para dimensiones angulares, en este SRS. |
...
| as_geographic | [GeographicSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/geographicspatialreferencesystem) | r | Devuelve esto. |
...
| axises_order | [GeographicAxisesOrder](/psd/python-net/aspose.gis.spatialreferencing/geographicaxisesorder) | r | Orden de ejes en este SRS.<br/>            Si este SRS no es válido y tiene direcciones de ejes incorrectas, se devuelve [GeographicAxisesOrder.INVALID](/psd/python-net/aspose.gis.spatialreferencing/geographicaxisesorder/). |
| dimensions_count | int | r | Devuelve el recuento de dimensiones en este SRS. Para SRS geográficos esto puede ser:<br/>            dos - si es un SRS geográfico único.<br/>            tres - si es un SRS compuesto, que consta de un SRS geográfico único, bidimensional, y un SRS vertical, que añade la tercera dimensión. |
...
| has_geographic_datum | bool | r | Devuelve <see langword=\"true\" />, ya que los SRS geográficos siempre tienen meridiano principal. |
| has_prime_meridian | bool | r | Devuelve <see langword=\"true\" />, ya que los SRS geográficos siempre tienen meridiano principal. |
...
| type | [SpatialReferenceSystemType](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype) | r | Devuelve [SpatialReferenceSystemType.GEOGRAPHIC](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/). |
