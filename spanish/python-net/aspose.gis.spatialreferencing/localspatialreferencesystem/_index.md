---
title: "Clase LocalSpatialReferenceSystem"
type: docs
weight: 130
url: /es/python-net/aspose.gis.spatialreferencing/localspatialreferencesystem/
---
...
| as_local | [LocalSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/localspatialreferencesystem) | r | Devuelve esto. |
...
| dimensions_count | int | r | Número de dimensiones en este SRS. |
...
| geographic_datum | [GeographicDatum](/psd/python-net/aspose.gis.spatialreferencing/geographicdatum) | r | Lanza InvalidOperationException, ya que el SRS local no tiene datum geográfico. |
| has_geographic_datum | bool | r | Devuelve <see langword="false" />, ya que el SRS local no tiene datum geográfico. |
| has_prime_meridian | bool | r | Devuelve <see langword="false" />, ya que el SRS local no tiene meridiano principal. |
...
| local_datum | [LocalDatum](/psd/python-net/aspose.gis.spatialreferencing/localdatum) | r | Datum que describe el método de mediciones. |
...
| prime_meridian | [PrimeMeridian](/psd/python-net/aspose.gis.spatialreferencing/primemeridian) | r | Lanza InvalidOperationException, ya que el SRS local no tiene meridiano principal. |
| type | [SpatialReferenceSystemType](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype) | r | Devuelve [SpatialReferenceSystemType.LOCAL](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/). |
| unit | [Unit](/psd/python-net/aspose.gis.spatialreferencing/unit) | r | Unidad de este SRS. |
...
| [get_unit(dimension)](#get_unit_dimension_12) | Obtener [LocalSpatialReferenceSystem.unit](/psd/python-net/aspose.gis.spatialreferencing/localspatialreferencesystem/) de dimensión. |
...
Obtener [LocalSpatialReferenceSystem.unit](/psd/python-net/aspose.gis.spatialreferencing/localspatialreferencesystem/) de dimensión.
