---
title: "Clase InMemoryDriver"
type: docs
weight: 10
url: /es/python-net/aspose.gis.formats.inmemory/inmemorydriver/
---
...
| [create_layer()](#create_layer__5) | Crea una capa y la abre para agregar nuevas características. |
| [create_layer(features_sequence)](#create_layer_features_sequence_6) | Crea una capa a partir de una secuencia de entidades y la abre para agregar nuevas entidades. |
...
| [create_layer(path, options)](#create_layer_path_options_9) | Crea la capa y la abre para añadir. |
| [create_layer(path, options)](#create_layer_path_options_10) | Crea la capa y la abre para añadir. |
...
| [create_layer(path, spatial_reference_system)](#create_layer_path_spatial_reference_system_13) | Crea la capa y la abre para añadir. |
...
| [create_layer(spatial_reference_system)](#create_layer_spatial_reference_system_15) | Crea una capa y la abre para agregar nuevas características. |
...
| [supports_spatial_reference_system(spatial_reference_system)](#supports_spatial_reference_system_spatial_reference_system_26) | Determina si el sistema de referencia espacial especificado es compatible con el controlador. |
...
Crea una capa a partir de una secuencia de entidades y la abre para agregar nuevas entidades.
