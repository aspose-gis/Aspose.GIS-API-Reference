---
title: "Clase MultiStreamPath"
type: docs
weight: 2760
url: /es/python-net/aspose.gis/multistreampath/
---
...
| **Name** | **Descripción** |
| :- | :- |
| [MultiStreamPath(entry_file_name, file_names, streams)](#MultiStreamPath_entry_file_name_file_names_streams_1) | Inicializa una nueva instancia de la clase [MultiStreamPath](/psd/python-net/aspose.gis/multistreampath/). |
## **Properties**
| **Name** | **Type** | **Access** | **Descripción** |
| :- | :- | :- | :- |
| ubicación | string | r | Obtiene una representación en cadena de la ubicación de este <c>AbstractPath</c>. |
| separator | char | r | Obtiene un carácter separador usado para separar los niveles de directorio de la cadena [MultiStreamPath.location](/psd/python-net/aspose.gis/multistreampath/). |
## **Methods**
| **Name** | **Descripción** |
| :- | :- |
...
| [open(access)](#open_access_9) | Abstrae un conjunto de formatos multi‑archivo de transmisión abierta como una ruta para acceder a los datos. |
...
Inicializa una nueva instancia de la clase [MultiStreamPath](/psd/python-net/aspose.gis/multistreampath/).

**Parameters:**

| Parámetro | Tipo | Descripción |
| :- | :- | :- |
| entry_file_name | string | Nombre del archivo de entrada. |
| file_names | string | Los nombres de archivo. |
| streams | _io.BufferedRandom[] | Los flujos. |
...
Abstrae un conjunto de formatos multi‑archivo de transmisión abierta como una ruta para acceder a los datos.
...
| Tipo | Descripción |
| :- | :- |
| _io.BufferedRandom | Esto puede ser ya sea un   o el flujo pasado originalmente por el cliente. |
