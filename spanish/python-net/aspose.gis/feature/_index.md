...
type: docs
weight: 830
url: /es/python-net/aspose.gis/feature/
---
...
| [get_value(attribute_name)](#get_value_attribute_name_2) | Obtiene el valor de un atributo. |
| [get_value_or_default(attribute_name, default_value)](#get_value_or_default_attribute_name_default_value_3) | Obtiene el valor de un atributo, o [FeatureAttribute.default_value](/psd/python-net/aspose.gis/featureattribute/) si el valor no está establecido o <c>null</c>. |
| [get_values(values, default_value)](#get_values_values_default_value_4) | Devuelve los valores de todos los atributos en una matriz. |
| [get_values(values_count, default_value)](#get_values_values_count_default_value_5) | Devuelve los valores de todos los atributos en una matriz. |
| [get_values_dump(default_value)](#get_values_dump_default_value_6) | Devuelve los valores de todos los atributos en una matriz.<br/>            Considere usar el método Aspose.Gis.Feature.GetValues(int,System.Object) para evitar asignaciones de memoria adicionales. |
| [get_values_list(attribute_name, separator, count)](#get_values_list_attribute_name_separator_count_7) | Obtiene la lista de valores. Análogo no genérico de List T GetValuesList |
| [is_value_null(attribute_name)](#is_value_null_attribute_name_8) | Determina si el atributo especificado ha sido establecido explícitamente al valor <c>null</c>. |
| [is_value_set(attribute_name)](#is_value_set_attribute_name_9) | Comprueba si el valor del atributo está establecido en esta característica. |
| [set_value(attribute_name, value)](#set_value_attribute_name_value_10) | Establece el valor. Análogo no genérico de void SetValue (string attributeName, T value) |
| [set_value_null(attribute_name)](#set_value_null_attribute_name_11) | Establece el valor del atributo a <c>null</c>. |
| [set_values(values)](#set_values_values_12) | Establece nuevos valores para todos los atributos.<br/>            También considere usar el método [Feature.copy_values(input_feature)](/psd/python-net/aspose.gis/feature/) para simplificar el establecimiento de valores en una sola llamada. |
| [unset_value(attribute_name)](#unset_value_attribute_name_13) | Elimina el valor del atributo de esta característica. |
...
Devuelve los valores de todos los atributos en una matriz.<br/>            Considere usar el método Aspose.Gis.Feature.GetValues(int,System.Object) para evitar asignaciones de memoria adicionales.
...
Obtiene la lista de valores. Análogo no genérico de List T GetValuesList
...
Establece el valor. Análogo no genérico de void SetValue (string attributeName, T value)
...
Establece nuevos valores para todos los atributos.<br/>            También considere usar el método [Feature.copy_values(input_feature)](/psd/python-net/aspose.gis/feature/) para simplificar el establecimiento de valores en una sola llamada.
