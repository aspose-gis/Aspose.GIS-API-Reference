---
title: "GeoJsonOptions Clase"
type: docs
weight: 20
url: /es/python-net/aspose.gis.formats.geojson/geojsonoptions/
---
...
| **Name** | **Descripción** |
| :- | :- |
| [GeoJsonOptions()](#GeoJsonOptions__1) | Crear una nueva instancia. |
## **Properties**
...
| descripción | string | r/w | Descripción a nivel de colección de características (para creación de capa) |
...
| nombre | string | r/w | Nombre a nivel de colección de características (para creación de capa) |
...
| read_bounding_boxes | bool | r/w | Determina si los Bounding Boxes ('bbox') deben leerse como atributos con un nombre 'bbox_0', 'bbox_1', etc.<br/>            El valor predeterminado es <see langword="false" />.<br/>            La cadena [GeoJsonOptions.nested_properties_separator](/psd/python-net/aspose.gis.formats.geojson/geojsonoptions/) se usa en los nombres bbox_0, bbox_1,.. |
...
| write_bounding_boxes | bool | r/w | Determina si los objetos GeoJSON deben incluir información sobre el rango de coordenadas de sus Geometrías.<br/>            Si se establece en <see langword="true" />, se genera un miembro "bbox" para cada geometría (no nula) cuando se agrega a la capa.<br/>            El valor predeterminado es <see langword="false" />. |
