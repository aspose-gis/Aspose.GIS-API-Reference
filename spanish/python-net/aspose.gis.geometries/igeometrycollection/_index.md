---
title: "Clase IGeometryCollection"
type: docs
weight: 120
url: /es/python-net/aspose.gis.geometries/igeometrycollection/
---

**Summary:** A [IGeometryCollection](/psd/python-net/aspose.gis.geometries/igeometrycollection/) is a [IGeometry](/psd/python-net/aspose.gis.geometries/igeometry/) that is a collection of one or more geometries.

**Module:** [aspose.gis.geometries](/psd/python-net/aspose.gis.geometries/)

**Full Name:** aspose.gis.geometries.IGeometryCollection
...
| [get_length()](#get_length__21) | Calcula la longitud de esta geometría. |
| [get_point_on_surface()](#get_point_on_surface__22) | Encuentra un punto que se garantiza que está en una de las superficies de esta colección. |
| [intersection(other)](#intersection_other_23) | Construye una intersección entre esta geometría y una geometría especificada. |
| [intersects(extent)](#intersects_extent_24) | Determina si esta geometría intersecta una extensión especificada. |
| [intersects(other)](#intersects_other_25) | Determina si esta geometría y una geometría especificada intersectan. |
| [overlaps(other)](#overlaps_other_26) | Determina si esta geometría se superpone con una geometría especificada. |
| [relate(other, intersection_pattern_matrix)](#relate_other_intersection_pattern_matrix_27) | Determina si la matriz de intersección DE-9IM de esta geometría y una geometría especificada coincide con el patrón proporcionado. |
| [replace_polygons_by_lines()](#replace_polygons_by_lines__28) | Obtiene los polígonos representados como líneas de esta geometría. |
| [spatially_contains(other)](#spatially_contains_other_29) | Determina si esta geometría contiene espacialmente una geometría especificada. |
| [spatially_equals(other)](#spatially_equals_other_30) | Determina si esta geometría es espacialmente igual a una geometría especificada. |
| [sym_difference(other)](#sym_difference_other_31) | Construye una diferencia simétrica entre esta geometría y una geometría especificada. |
| [to_editable()](#to_editable__32) | Obtiene una copia editable de esta geometría. |
| [to_linear_geometry()](#to_linear_geometry__33) | Obtiene una versión aproximada o equivalente sin curvas de esta geometría usando la <c>tolerance</c> predeterminada. |
| [to_linear_geometry(tolerance)](#to_linear_geometry_tolerance_34) | Obtiene una versión aproximada o equivalente sin curvas de esta geometría usando la <c>tolerance</c> especificada. |
| [touches(other)](#touches_other_35) | Determina si esta geometría y una geometría especificada se tocan. |
| [union(other)](#union_other_36) | Une esta geometría y una geometría especificada. |
| [union(other)](#union_other_37) | Une esta geometría y una geometría especificada. |
| [within(extent)](#within_extent_38) | Determina si esta geometría está dentro de una extensión especificada. |
| [within(other)](#within_other_39) | Determina si esta geometría está dentro de una geometría especificada. |
...
| Tipo | Descripción |
| :- | :- |
| [GeometryCollection](/psd/python-net/aspose.gis.geometries/geometrycollection) | Una copia editable de esta geometría. |
...
| Tipo | Descripción |
| :- | :- |
| [IGeometryCollection](/psd/python-net/aspose.gis.geometries/igeometrycollection) | Una geometría que no tiene geometrías de curva. Esto es equivalente a <DOM Element: class at 0x2a1791cc040>.IGeometryCollection.to_linear_geometry()(float) con<br/>            <c>tolerance</c> predeterminada. El valor predeterminado de <c>tolerance</c> depende del [SpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem/) de esta geometría:<br/>            <ul><br/>            <li> Para SRS proyectado, la tolerancia es 0.001 metros (en unidades del SRS) </li><br/>            <li> Para SRS geográfico, la tolerancia es <c>1e-5</c> grados (en unidades del SRS) </li><br/>            <li> Para SRS desconocido, la tolerancia es <c>1e-5</c> </li><br/>            </ul><br/>            Para más detalles sobre qué transformaciones se aplican, consulte la especificación de <DOM Element: class at 0x2a1791cc040>.IGeometryCollection.to_linear_geometry()(float). |
