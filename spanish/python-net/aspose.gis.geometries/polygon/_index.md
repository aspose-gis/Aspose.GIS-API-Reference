...
type: docs
weight: 310
url: /es/python-net/aspose.gis.geometries/polygon/
---
...
| **Name** | **Descripción** |
| :- | :- |
| [Polygon()](#Polygon__1) | Inicializa una nueva instancia de la clase [Polygon](/psd/python-net/aspose.gis.geometries/polygon/). |
| [Polygon(exterior_ring)](#Polygon_exterior_ring_2) | Inicializa una nueva instancia de la clase [Polygon](/psd/python-net/aspose.gis.geometries/polygon/). |
| [Polygon(exterior_ring, interior_rings)](#Polygon_exterior_ring_interior_rings_3) | Inicializa una nueva instancia de la clase [Polygon](/psd/python-net/aspose.gis.geometries/polygon/). |
## **Properties**
...
| exterior_ring | [ILinearRing](/psd/python-net/aspose.gis.geometries/ilinearring) | r/w | Obtiene el anillo exterior. |
...
| [get_point_on_surface()](#get_point_on_surface__28) | Encuentra un punto que se garantiza que está en este polígono. |
...
Inicializa una nueva instancia de la clase [Polygon](/psd/python-net/aspose.gis.geometries/polygon/).
...
| :- | :- | :- |
| exterior_ring | [ILinearRing](/psd/python-net/aspose.gis.geometries/ilinearring) | El anillo exterior. |
...
| :- | :- | :- |
| exterior_ring | [ILinearRing](/psd/python-net/aspose.gis.geometries/ilinearring) | El anillo exterior. |
| interior_rings | System.Collections.Generic.IEnumerable<ILinearRing> | Los anillos interiores. |
...
| Parámetro | Tipo | Descripción |
| :- | :- | :- |
| ring | [ILinearRing](/psd/python-net/aspose.gis.geometries/ilinearring) | El anillo a agregar. |
...
| Tipo | Descripción |
| :- | :- |
| [ILinearRing](/psd/python-net/aspose.gis.geometries/ilinearring) | El anillo interior. |
...
Encuentra un punto que se garantiza que está en este polígono.

**Returns**

| Tipo | Descripción |
| :- | :- |
| [IPoint](/psd/python-net/aspose.gis.geometries/ipoint) | Un punto en este polígono. Un punto vacío si este polígono no tiene interior. |
...
| Tipo | Descripción |
| :- | :- |
| [Polygon](/psd/python-net/aspose.gis.geometries/polygon) | Una copia editable de esta geometría. |
