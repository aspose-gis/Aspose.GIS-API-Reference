---
title: "Clase CurvePolygon"
type: docs
weight: 40
url: /es/python-net/aspose.gis.geometries/curvepolygon/
---
...
| **Name** | **Descripción** |
| :- | :- |
| [CurvePolygon()](#CurvePolygon__1) | Inicializa una nueva instancia de la clase [CurvePolygon](/psd/python-net/aspose.gis.geometries/curvepolygon/). |
| [CurvePolygon(exterior_ring)](#CurvePolygon_exterior_ring_2) | Inicializa una nueva instancia de la clase [CurvePolygon](/psd/python-net/aspose.gis.geometries/curvepolygon/). |
| [CurvePolygon(exterior_ring, interior_rings)](#CurvePolygon_exterior_ring_interior_rings_3) | Inicializa una nueva instancia de la clase [CurvePolygon](/psd/python-net/aspose.gis.geometries/curvepolygon/). |
## **Properties**
...
| exterior_ring | [ICurve](/psd/python-net/aspose.gis.geometries/icurve) | r/w | Obtiene el anillo exterior. |
...
| interior_rings_count | int | r | Obtiene el número de anillos interiores. |
...
| **Name** | **Descripción** |
| :- | :- |
| [add_interior_ring(ring)](#add_interior_ring_ring_1) | Agrega un anillo interior. |
| [as_binary()](#as_binary__2) | Traduce esta geometría a su representación Well-Known Binary. |
| [as_binary(variant)](#as_binary_variant_3) | Traduce esta geometría a su representación Well-Known Binary. |
...
| [as_image(width, height, renderer, symbolizer)](#as_image_width_height_renderer_symbolizer_6) | Exporta esta geometría a una representación de imagen. |
| [as_text()](#as_text__7) | Traduce esta geometría a su representación Well-Known Text. |
| [as_text(variant)](#as_text_variant_8) | Traduce esta geometría a su representación Well-Known Text. |
| [as_text(variant, format)](#as_text_variant_format_9) | Traduce esta geometría a su representación Well-Known Text. |
| [clone()](#clone__10) | Clona esta instancia. |
| [covered_by(other)](#covered_by_other_11) | Determina si esta geometría está cubierta por una geometría especificada. |
| [covers(other)](#covers_other_12) | Determina si esta geometría cubre una geometría especificada. |
| [crosses(other)](#crosses_other_13) | Determina si esta geometría y una geometría especificada se cruzan. |
| [difference(other)](#difference_other_14) | Resta una geometría especificada de esta geometría. |
| [disjoint(other)](#disjoint_other_15) | Determina si esta geometría está disjunta de una geometría especificada. |
| [from_binary(wkb)](#from_binary_wkb_16) | Crea una geometría a partir de su representación Well-Known Binary. |
| [from_binary(wkb, spatial_reference_system)](#from_binary_wkb_spatial_reference_system_17) | Crea una geometría a partir de su representación Well-Known Binary. |
| [from_text(wkt)](#from_text_wkt_18) | Crea una geometría a partir de su representación Well-Known Text. |
| [from_text(wkt, spatial_reference_system)](#from_text_wkt_spatial_reference_system_19) | Crea una geometría a partir de su representación Well-Known Text. |
| [get_area()](#get_area__20) | Calcula el área de esta geometría. |
| [get_buffer(distance, quadrant_segments)](#get_buffer_distance_quadrant_segments_21) | Calcula una región de buffer alrededor de esta geometría. |
| [get_centroid()](#get_centroid__22) | Calcula el centroide de esta geometría. |
| [get_convex_hull()](#get_convex_hull__23) | Calcula la envolvente convexa de esta geometría. |
| [get_distance_to(other)](#get_distance_to_other_24) | Calcula la distancia mínima entre esta geometría y una geometría especificada. |
| [get_extent()](#get_extent__25) | Calcula y devuelve una extensión delimitadora de esta geometría. |
| [get_interior_ring(index)](#get_interior_ring_index_26) | Obtiene el anillo interior por su índice. |
| [get_length()](#get_length__27) | Calcula la longitud de esta geometría. |
| [get_point_on_surface()](#get_point_on_surface__28) | Encuentra un punto que está garantizado que se encuentre en este polígono curvo. |
...
| [replace_polygons_by_lines()](#replace_polygons_by_lines__34) | Obtiene los polígonos representados como líneas de esta geometría. |
| [round_m(digits)](#round_m_digits_35) | Redondea la coordenada M a un número especificado de dígitos fraccionarios. |
| [round_xy(digits)](#round_xy_digits_36) | Redondea las coordenadas X e Y a un número especificado de dígitos fraccionarios. |
| [round_z(digits)](#round_z_digits_37) | Redondea la coordenada Z a un número especificado de dígitos fraccionarios. |
| set_empty() | Hace que esta [Geometry](/psd/python-net/aspose.gis.geometries/geometry/) esté vacía. |
| [spatially_contains(other)](#spatially_contains_other_38) | Determina si esta geometría contiene espacialmente una geometría especificada. |
| [spatially_equals(other)](#spatially_equals_other_39) | Determina si esta geometría es espacialmente igual a una geometría especificada. |
| [sym_difference(other)](#sym_difference_other_40) | Construye una diferencia simétrica entre esta geometría y una geometría especificada. |
| [to_editable()](#to_editable__41) | Obtiene una copia editable de esta geometría. |
| [to_linear_geometry()](#to_linear_geometry__42) | Obtiene una versión aproximada o equivalente sin curvas de esta geometría usando la <c>tolerance</c> predeterminada. |
| [to_linear_geometry(tolerance)](#to_linear_geometry_tolerance_43) | Obtiene una versión aproximada o equivalente sin curvas de esta geometría usando la <c>tolerance</c> especificada. |
| [to_svg(extent)](#to_svg_extent_44) | Traduce esta geometría a la representación Svg. |
| [touches(other)](#touches_other_45) | Determina si esta geometría y una geometría especificada se tocan. |
| [union(other)](#union_other_46) | Une esta geometría y una geometría especificada. |
| [union(other)](#union_other_47) | Une esta geometría y una geometría especificada. |
| [within(extent)](#within_extent_48) | Determina si esta geometría está dentro de una extensión especificada. |
| [within(other)](#within_other_49) | Determina si esta geometría está dentro de una geometría especificada. |
...
Inicializa una nueva instancia de la clase [CurvePolygon](/psd/python-net/aspose.gis.geometries/curvepolygon/).
...
| :- | :- | :- |
| exterior_ring | [ICurve](/psd/python-net/aspose.gis.geometries/icurve) | El anillo exterior. |
...
| :- | :- | :- |
| exterior_ring | [ICurve](/psd/python-net/aspose.gis.geometries/icurve) | El anillo exterior. |
| interior_rings | System.Collections.Generic.IEnumerable<ICurve> | Los anillos interiores. |
...
| Parámetro | Tipo | Descripción |
| :- | :- | :- |
| ring | [ICurve](/psd/python-net/aspose.gis.geometries/icurve) | El anillo a agregar. |
...
| Tipo | Descripción |
| :- | :- |
| [ICurve](/psd/python-net/aspose.gis.geometries/icurve) | El anillo interior. |
...
Encuentra un punto que está garantizado que se encuentre en este polígono curvo.

**Returns**

| Tipo | Descripción |
| :- | :- |
| [IPoint](/psd/python-net/aspose.gis.geometries/ipoint) | Un punto en este polígono curvo. Un punto vacío si este polígono curvo no tiene interior. |
...
| Tipo | Descripción |
| :- | :- |
| [CurvePolygon](/psd/python-net/aspose.gis.geometries/curvepolygon) | Una copia editable de esta geometría. |
...
| Tipo | Descripción |
| :- | :- |
| [IPolygon](/psd/python-net/aspose.gis.geometries/ipolygon) | Un [IPolygon](/psd/python-net/aspose.gis.geometries/ipolygon/) que aproxima o es equivalente a este <c>ISurface</c>.<br/>            Equivalente a <DOM Element: class at 0x2a1793609d0>.ISurface.to_linear_geometry()(float) con<br/>            la <c>tolerance</c> predeterminada. El valor predeterminado de la <c>tolerance</c> depende del [SpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem/)<br/>            de esta geometría:<br/>            <ul><br/>            <li> Para SRS proyectado, la tolerancia es 0.001 metros (en unidades del SRS) </li><br/>            <li> Para SRS geográfico, la tolerancia es <c>1e-5</c> grados (en unidades del SRS) </li><br/>            <li> Para SRS desconocido, la tolerancia es <c>1e-5</c> </li><br/>            </ul><br/>            Para más detalles sobre qué transformaciones se aplican, consulte la especificación de <DOM Element: class at 0x2a1793609d0>.ISurface.to_linear_geometry()(float). |
...
| Tipo | Descripción |
| :- | :- |
| [IPolygon](/psd/python-net/aspose.gis.geometries/ipolygon) | Un [IPolygon](/psd/python-net/aspose.gis.geometries/ipolygon/) que aproxima o es equivalente a este <c>ISurface</c>:<br/>             <ul><br/>             Si este objeto es [IPolygon](/psd/python-net/aspose.gis.geometries/ipolygon/) en sí, el resultado es equivalente a este objeto<br/>             Si este objeto no es [IPolygon](/psd/python-net/aspose.gis.geometries/ipolygon/), se linealiza y se crea un [IPolygon](/psd/python-net/aspose.gis.geometries/ipolygon/)<br/>            </ul> |
