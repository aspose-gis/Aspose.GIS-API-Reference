---
title: "IGeometry Clase"
type: docs
weight: 110
url: /es/python-net/aspose.gis.geometries/igeometry/
---

**Summary:** The interface root class of Geometries hierarchy
...
| [to_linear_geometry()](#to_linear_geometry__31) | Obtiene una versión aproximada o equivalente sin curvas de esta geometría usando la <c>tolerance</c> predeterminada. |
| [to_linear_geometry(tolerance)](#to_linear_geometry_tolerance_32) | Obtiene una versión aproximada o equivalente sin curvas de esta geometría usando la <c>tolerance</c> especificada. |
| [touches(other)](#touches_other_33) | Determina si esta geometría y una geometría especificada se tocan. |
| [union(other)](#union_other_34) | Une esta geometría y una geometría especificada. |
| [union(other)](#union_other_35) | Une esta geometría y una geometría especificada. |
| [within(extent)](#within_extent_36) | Determina si esta geometría está dentro de una extensión especificada. |
| [within(other)](#within_other_37) | Determina si esta geometría está dentro de una geometría especificada. |
...
### Method: to_linear_geometry() {#to_linear_geometry__31}
...
### Method: touches(other) {#touches_other_33}
...
### Method: union(other) {#union_other_34}
