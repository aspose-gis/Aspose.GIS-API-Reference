---
title: "Clase ICompoundCurve"
type: docs
weight: 80
url: /es/python-net/aspose.gis.geometries/icompoundcurve/
---
...
| [overlaps(other)](#overlaps_other_25) | Determina si esta geometría se superpone con una geometría especificada. |
| [relate(other, intersection_pattern_matrix)](#relate_other_intersection_pattern_matrix_26) | Determina si la matriz de intersección DE-9IM de esta geometría y una geometría especificada coincide con el patrón proporcionado. |
| [replace_polygons_by_lines()](#replace_polygons_by_lines__27) | Obtiene los polígonos representados como líneas de esta geometría. |
| [spatially_contains(other)](#spatially_contains_other_28) | Determina si esta geometría contiene espacialmente una geometría especificada. |
| [spatially_equals(other)](#spatially_equals_other_29) | Determina si esta geometría es espacialmente igual a una geometría especificada. |
| [sym_difference(other)](#sym_difference_other_30) | Construye una diferencia simétrica entre esta geometría y una geometría especificada. |
| [to_editable()](#to_editable__31) | Obtiene una copia editable de esta geometría. |
| [to_linear_geometry()](#to_linear_geometry__32) | Obtiene una versión aproximada o equivalente sin curvas de esta geometría usando la <c>tolerance</c> predeterminada. |
| [to_linear_geometry(tolerance)](#to_linear_geometry_tolerance_33) | Obtiene una versión aproximada o equivalente sin curvas de esta geometría usando la <c>tolerance</c> especificada. |
| [touches(other)](#touches_other_34) | Determina si esta geometría y una geometría especificada se tocan. |
| [union(other)](#union_other_35) | Une esta geometría y una geometría especificada. |
| [union(other)](#union_other_36) | Une esta geometría y una geometría especificada. |
| [within(extent)](#within_extent_37) | Determina si esta geometría está dentro de una extensión especificada. |
| [within(other)](#within_other_38) | Determina si esta geometría está dentro de una geometría especificada. |
