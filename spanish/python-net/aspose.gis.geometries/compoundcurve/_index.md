---
title: "Clase CompoundCurve"
type: docs
weight: 20
url: /es/python-net/aspose.gis.geometries/compoundcurve/
---
...
| **Name** | **Descripción** |
| :- | :- |
| [CompoundCurve()](#CompoundCurve__1) | Inicializa una nueva instancia de la clase [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/). |
| [CompoundCurve(curves)](#CompoundCurve_curves_2) | Inicializa una nueva instancia de la clase [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/). |
| [CompoundCurve(other)](#CompoundCurve_other_3) | Inicializa una nueva instancia de la clase [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/). |
## **Properties**
...
| count | int | r | Obtiene el número de curvas en el [ICompoundCurve](/psd/python-net/aspose.gis.geometries/icompoundcurve/). |
...
| **Name** | **Descripción** |
| :- | :- |
| [add_curve(curve)](#add_curve_curve_1) | Agrega una curva al final de este [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/). |
...
| [get_length()](#get_length__26) | Calcula la longitud de esta geometría. |
| [intersection(other)](#intersection_other_27) | Construye una intersección entre esta geometría y una geometría especificada. |
| [intersects(extent)](#intersects_extent_28) | Determina si esta geometría intersecta una extensión especificada. |
| [intersects(other)](#intersects_other_29) | Determina si esta geometría y una geometría especificada intersectan. |
| [overlaps(other)](#overlaps_other_30) | Determina si esta geometría se superpone con una geometría especificada. |
| [relate(other, intersection_pattern_matrix)](#relate_other_intersection_pattern_matrix_31) | Determina si la matriz de intersección DE-9IM de esta geometría y una geometría especificada coincide con el patrón proporcionado. |
| [replace_polygons_by_lines()](#replace_polygons_by_lines__32) | Obtiene los polígonos representados como líneas de esta geometría. |
| reverse() | Invierte este [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/). Es decir, invierte el orden de las curvas y cada curva dentro de este compound curve. |
| [round_m(digits)](#round_m_digits_33) | Redondea la coordenada M a un número especificado de dígitos fraccionarios. |
| [round_xy(digits)](#round_xy_digits_34) | Redondea las coordenadas X e Y a un número especificado de dígitos fraccionarios. |
| [round_z(digits)](#round_z_digits_35) | Redondea la coordenada Z a un número especificado de dígitos fraccionarios. |
| set_empty() | Hace que esta [Geometry](/psd/python-net/aspose.gis.geometries/geometry/) esté vacía. |
| [spatially_contains(other)](#spatially_contains_other_36) | Determina si esta geometría contiene espacialmente una geometría especificada. |
| [spatially_equals(other)](#spatially_equals_other_37) | Determina si esta geometría es espacialmente igual a una geometría especificada. |
| [sym_difference(other)](#sym_difference_other_38) | Construye una diferencia simétrica entre esta geometría y una geometría especificada. |
| [to_editable()](#to_editable__39) | Obtiene una copia editable de esta geometría. |
| [to_linear_geometry()](#to_linear_geometry__40) | Obtiene una versión aproximada o equivalente sin curvas de esta geometría usando la <c>tolerance</c> predeterminada. |
| [to_linear_geometry(tolerance)](#to_linear_geometry_tolerance_41) | Obtiene una versión aproximada o equivalente sin curvas de esta geometría usando la <c>tolerance</c> especificada. |
| [to_svg(extent)](#to_svg_extent_42) | Traduce esta geometría a la representación Svg. |
| [touches(other)](#touches_other_43) | Determina si esta geometría y una geometría especificada se tocan. |
| [union(other)](#union_other_44) | Une esta geometría y una geometría especificada. |
| [union(other)](#union_other_45) | Une esta geometría y una geometría especificada. |
| [within(extent)](#within_extent_46) | Determina si esta geometría está dentro de una extensión especificada. |
| [within(other)](#within_other_47) | Determina si esta geometría está dentro de una geometría especificada. |
...
Inicializa una nueva instancia de la clase [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/).
...
| :- | :- | :- |
| curvas | System.Collections.Generic.IEnumerable<ICurve> | La colección de curvas. |
...
| Parámetro | Tipo | Descripción |
| :- | :- | :- |
| other | [ICompoundCurve](/psd/python-net/aspose.gis.geometries/icompoundcurve) | La otra línea de la cual copiar datos. |
...
Agrega una curva al final de este [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/).

**Parameters:**

| Parámetro | Tipo | Descripción |
| :- | :- | :- |
| curve | [ICurve](/psd/python-net/aspose.gis.geometries/icurve) | Curva a agregar. |
...
| Tipo | Descripción |
| :- | :- |
| [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve) | Una copia editable de esta geometría. |
