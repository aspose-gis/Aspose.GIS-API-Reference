---
title: "Clase CircularString"
type: docs
weight: 10
url: /es/python-net/aspose.gis.geometries/circularstring/
---
...
| **Name** | **Descripción** |
| :- | :- |
| [CircularString()](#CircularString__1) | Inicializa una nueva instancia de la clase [CircularString](/psd/python-net/aspose.gis.geometries/circularstring/). |
| [CircularString(collection)](#CircularString_collection_2) | Inicializa una nueva instancia de la clase [CircularString](/psd/python-net/aspose.gis.geometries/circularstring/). |
| [CircularString(other)](#CircularString_other_3) | Inicializa una nueva instancia de la clase [CircularString](/psd/python-net/aspose.gis.geometries/circularstring/). |
## **Properties**
...
| **Name** | **Descripción** |
| :- | :- |
| [add_point(point)](#add_point_point_1) | Añade un punto al final de la cadena circular. |
| [add_point(x, y)](#add_point_x_y_2) | Añade un punto al final de la cadena circular. |
| [add_point(x, y, z)](#add_point_x_y_z_3) | Añade un punto al final de la cadena circular. |
| [add_point(x, y, z, m)](#add_point_x_y_z_m_4) | Añade un punto al final de la cadena circular. |
...
| [overlaps(other)](#overlaps_other_33) | Determina si esta geometría se superpone con una geometría especificada. |
| [relate(other, intersection_pattern_matrix)](#relate_other_intersection_pattern_matrix_34) | Determina si la matriz de intersección DE-9IM de esta geometría y una geometría especificada coincide con el patrón proporcionado. |
...
| reverse() | Invierte el orden de los puntos en este [CircularString](/psd/python-net/aspose.gis.geometries/circularstring/). |
...
Inicializa una nueva instancia de la clase [CircularString](/psd/python-net/aspose.gis.geometries/circularstring/).
...
| Parámetro | Tipo | Descripción |
| :- | :- | :- |
| other | [ICircularString](/psd/python-net/aspose.gis.geometries/icircularstring) | La otra cadena de la cual copiar datos. |
...
Añade un punto al final de la cadena circular.
