---
title: "Clase IMultiCurve"
type: docs
weight: 150
url: /es/python-net/aspose.gis.geometries/imulticurve/
---
...
| Tipo | Descripción |
| :- | :- |
| [MultiCurve](/psd/python-net/aspose.gis.geometries/multicurve) | Una copia editable de esta geometría. |
...
| Tipo | Descripción |
| :- | :- |
| [IMultiLineString](/psd/python-net/aspose.gis.geometries/imultilinestring) | Un [IMultiLineString](/psd/python-net/aspose.gis.geometries/imultilinestring/) que aproxima o es equivalente a este [IMultiCurve](/psd/python-net/aspose.gis.geometries/imulticurve/).<br/>            Esto es el equivalente de <DOM Element: class at 0x2a179241f70>.IMultiCurve.to_linear_geometry()(float) con<br/>            tolerancia predeterminada <c>tolerance</c>. El valor predeterminado de <c>tolerance</c> depende de [SpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem/)<br/>            de esta geometría:<br/>            <ul><br/>            <li> Para SRS proyectado la tolerancia es 0.001 metros (en unidades del SRS) </li><br/>            <li> Para SRS geográfico la tolerancia es <c>1e-5</c> grados (en unidades del SRS) </li><br/>            <li> Para SRS desconocido la tolerancia es <c>1e-5</c> </li><br/>            </ul><br/>            Para más detalles sobre qué transformaciones se aplican, consulte la especificación de <DOM Element: class at 0x2a179241f70>.IMultiCurve.to_linear_geometry()(float). |
...
| Tipo | Descripción |
| :- | :- |
| [IMultiLineString](/psd/python-net/aspose.gis.geometries/imultilinestring) | Un [IMultiLineString](/psd/python-net/aspose.gis.geometries/imultilinestring/) que aproxima o es equivalente a este [IMultiCurve](/psd/python-net/aspose.gis.geometries/imulticurve/):<br/>             <ul><br/>             Si este objeto es [IMultiLineString](/psd/python-net/aspose.gis.geometries/imultilinestring/) en sí, el resultado es equivalente a este objeto<br/>             Si este objeto no es [IMultiLineString](/psd/python-net/aspose.gis.geometries/imultilinestring/) - todas las curvas se linealizan y se crea un nuevo <c>IMultiLineString</c><br/>            </ul> |
