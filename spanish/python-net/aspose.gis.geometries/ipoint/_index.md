...
type: docs
weight: 200
url: /es/python-net/aspose.gis.geometries/ipoint/
---
...
| m | double | r | Obtiene la coordenada m. |
...
| x | double | r | Obtiene la coordenada x. |
| y | double | r | Obtiene la coordenada y. |
| z | double | r | Obtiene la coordenada z. |
## **Methods**
| **Name** | **Descripción** |
| :- | :- |
...
| Tipo | Descripción |
| :- | :- |
| [Point](/psd/python-net/aspose.gis.geometries/point) | Una copia editable de esta geometría. |
