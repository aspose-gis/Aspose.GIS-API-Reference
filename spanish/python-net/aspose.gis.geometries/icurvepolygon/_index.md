---
title: "Clase ICurvePolygon"
type: docs
weight: 100
url: /es/python-net/aspose.gis.geometries/icurvepolygon/
---
...
| exterior_ring | [ICurve](/psd/python-net/aspose.gis.geometries/icurve) | r | Obtiene el anillo exterior. |
...
| has_m | bool | r | Obtiene un valor que indica si esta instancia tiene coordenada M. |
| has_z | bool | r | Obtiene un valor que indica si esta instancia tiene coordenada Z. |
...
| spatial_reference_system | [SpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem/) | r | Obtiene el SpatialReferenceSystem de esta instancia.<br/>            Esta propiedad puede ser <see langword="null" />, si el SpatialReferenceSystem es desconocido. |
## **Methods**
| **Name** | **Descripción** |
| :- | :- |
...
| [get_area()](#get_area__15) | Calcula el área de esta geometría. |
| [get_buffer(distance, quadrant_segments)](#get_buffer_distance_quadrant_segments_16) | Calcula una región de buffer alrededor de esta geometría. |
| [get_centroid()](#get_centroid__17) | Calcula el centroide de esta geometría. |
| [get_convex_hull()](#get_convex_hull__18) | Calcula la envolvente convexa de esta geometría. |
| [get_distance_to(other)](#get_distance_to_other_19) | Calcula la distancia mínima entre esta geometría y una geometría especificada. |
| [get_extent()](#get_extent__20) | Calcula y devuelve una extensión delimitadora de esta geometría. |
| [get_interior_ring(index)](#get_interior_ring_index_21) | Obtiene el anillo interior por su índice. |
| [get_length()](#get_length__22) | Calcula la longitud de esta geometría. |
| [get_point_on_surface()](#get_point_on_surface__23) | Encuentra un punto que se garantiza que está en esta superficie. |
| [intersection(other)](#intersection_other_24) | Construye una intersección entre esta geometría y una geometría especificada. |
| [intersects(extent)](#intersects_extent_25) | Determina si esta geometría intersecta una extensión especificada. |
| [intersects(other)](#intersects_other_26) | Determina si esta geometría y una geometría especificada intersectan. |
| [overlaps(other)](#overlaps_other_27) | Determina si esta geometría se superpone con una geometría especificada. |
| [relate(other, intersection_pattern_matrix)](#relate_other_intersection_pattern_matrix_28) | Determina si la matriz de intersección DE-9IM de esta geometría y una geometría especificada coincide con el patrón proporcionado. |
| [replace_polygons_by_lines()](#replace_polygons_by_lines__29) | Obtiene los polígonos representados como líneas de esta geometría. |
| [spatially_contains(other)](#spatially_contains_other_30) | Determina si esta geometría contiene espacialmente una geometría especificada. |
| [spatially_equals(other)](#spatially_equals_other_31) | Determina si esta geometría es espacialmente igual a una geometría especificada. |
| [sym_difference(other)](#sym_difference_other_32) | Construye una diferencia simétrica entre esta geometría y una geometría especificada. |
| [to_editable()](#to_editable__33) | Obtiene una copia editable de esta geometría. |
| [to_linear_geometry()](#to_linear_geometry__34) | Obtiene una versión aproximada o equivalente sin curvas de esta geometría usando la <c>tolerance</c> predeterminada. |
| [to_linear_geometry(tolerance)](#to_linear_geometry_tolerance_35) | Obtiene una versión aproximada o equivalente sin curvas de esta geometría usando la <c>tolerance</c> especificada. |
| [touches(other)](#touches_other_36) | Determina si esta geometría y una geometría especificada se tocan. |
| [union(other)](#union_other_37) | Une esta geometría y una geometría especificada. |
| [union(other)](#union_other_38) | Une esta geometría y una geometría especificada. |
| [within(extent)](#within_extent_39) | Determina si esta geometría está dentro de una extensión especificada. |
| [within(other)](#within_other_40) | Determina si esta geometría está dentro de una geometría especificada. |
...
| Tipo | Descripción |
| :- | :- |
| [ICurve](/psd/python-net/aspose.gis.geometries/icurve) | El valor del anillo interior |
...
| Tipo | Descripción |
| :- | :- |
| [IPoint](/psd/python-net/aspose.gis.geometries/ipoint) | Un punto en esta superficie. Un punto vacío si esta superficie no tiene interior. |
...
| Tipo | Descripción |
| :- | :- |
| [Surface](/psd/python-net/aspose.gis.geometries/surface) | Una copia editable de esta geometría. |
...
| Tipo | Descripción |
| :- | :- |
| [IPolygon](/psd/python-net/aspose.gis.geometries/ipolygon) | Una geometría que no tiene geometrías de curva. Esto equivale a <DOM Element: class at 0x2a1791a70d0>.IGeometry.to_linear_geometry()(float) con<br/>            <c>tolerance</c> predeterminado. El <c>tolerance</c> predeterminado se define mediante [IGeometry.spatial_reference_system](/psd/python-net/aspose.gis.geometries/igeometry/)<br/>            de esta geometría:<br/>            <ul><br/>            <li> Para SRS proyectado, la tolerancia es 0.001 metros (en unidades SRS) </li><br/>            <li> Para SRS geográfico, la tolerancia es <c>1e-5</c> grados (en unidades SRS) </li><br/>            <li> Para SRS desconocido, la tolerancia es <c>1e-5</c> </li><br/>            </ul><br/>            Para obtener más detalles sobre qué transformaciones se aplican, consulte la especificación de <DOM Element: class at 0x2a1791a70d0>.IGeometry.to_linear_geometry()(float). |
...
| Parámetro | Tipo | Descripción |
| :- | :- | :- |
| tolerancia | double | El <c>tolerance</c> a usar. Se garantiza que el resultado esté a menos de <c>tolerance</c> de la<br/>            geometría curvada, a menos que la cantidad de puntos necesaria para linearizar la geometría supere el máximo por cuadrante<br/>            que actualmente es igual a 10000 puntos. |

**Returns**

| Tipo | Descripción |
| :- | :- |
| [IPolygon](/psd/python-net/aspose.gis.geometries/ipolygon) | Una geometría que no tiene geometrías de curva. Se aplican las siguientes transformaciones:<br/>            <ul><br/>            <li> Los [GeometryType.CIRCULAR_STRING](/psd/python-net/aspose.gis.geometries/geometrytype/) se linearizan<br/>            (transformados en [GeometryType.LINE_STRING](/psd/python-net/aspose.gis.geometries/geometrytype/) con la <paramref name="tolerance" /> especificada) </li><br/>            <li> Los [GeometryType.COMPOUND_CURVE](/psd/python-net/aspose.gis.geometries/geometrytype/) se unen en <c>LineString</c>s </li><br/>            <li> Los [GeometryType.CURVE_POLYGON](/psd/python-net/aspose.gis.geometries/geometrytype/) se transforman en [GeometryType.POLYGON](/psd/python-net/aspose.gis.geometries/geometrytype/)s </li><br/>            <li> Los [GeometryType.MULTI_CURVE](/psd/python-net/aspose.gis.geometries/geometrytype/) se transforman en [GeometryType.MULTI_LINE_STRING](/psd/python-net/aspose.gis.geometries/geometrytype/)s </li><br/>            <li> Los [GeometryType.MULTI_SURFACE](/psd/python-net/aspose.gis.geometries/geometrytype/) se transforman en [GeometryType.MULTI_POLYGON](/psd/python-net/aspose.gis.geometries/geometrytype/)s </li><br/>            </ul><br/>            Como resultado, [IGeometry.has_curve_geometry](/psd/python-net/aspose.gis.geometries/igeometry/) de la geometría de salida es <see langword="false" />. |
