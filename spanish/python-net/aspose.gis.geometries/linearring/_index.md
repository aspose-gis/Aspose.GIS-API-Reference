---
title: "Clase LinearRing"
type: docs
weight: 240
url: /es/python-net/aspose.gis.geometries/linearring/
---
...
| **Name** | **Descripción** |
| :- | :- |
| [LinearRing()](#LinearRing__1) | Inicializa una nueva instancia de la clase [LinearRing](/psd/python-net/aspose.gis.geometries/linearring/). |
| [LinearRing(collection)](#LinearRing_collection_2) | Inicializa una nueva instancia de la clase [LinearRing](/psd/python-net/aspose.gis.geometries/linearring/). |
| [LinearRing(other)](#LinearRing_other_3) | Inicializa una nueva instancia de la clase [LinearRing](/psd/python-net/aspose.gis.geometries/linearring/). |
## **Properties**
...
| dimension | [GeometryDimension](/psd/python-net/aspose.gis.geometries/geometrydimension) | r | Obtiene la dimensión topológica de este [IGeometry](/psd/python-net/aspose.gis.geometries/igeometry/).<br/>            Si la dimensión es desconocida (p. ej. para una GEOMETRYCOLLECTION vacía) se devuelve [GeometryDimension.POINT](/psd/python-net/aspose.gis.geometries/geometrydimension/). |
...
| spatial_reference_system | [SpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem/) | r/w | Obtiene el SpatialReferenceSystem de esta instancia.<br/>            Esta propiedad puede ser <see langword="null" />, si el SpatialReferenceSystem no está establecido.<br/>            Asignar un nuevo SpatialReferenceSystem no realizará ninguna transformación de coordenadas, solo cambiará la referencia. |
| start_point | [IPoint](/psd/python-net/aspose.gis.geometries/ipoint) | r | Devuelve una copia del punto inicial de la curva. |
## **Methods**
| **Name** | **Descripción** |
| :- | :- |
| [add_point(point)](#add_point_point_1) | Añade un punto al final de la línea. |
| [add_point(x, y)](#add_point_x_y_2) | Añade un punto al final de la línea. |
| [add_point(x, y, z)](#add_point_x_y_z_3) | Añade un punto al final de la línea. |
| [add_point(x, y, z, m)](#add_point_x_y_z_m_4) | Añade un punto al final de la línea. |
| [as_binary()](#as_binary__5) | Traduce esta geometría a su representación Well-Known Binary. |
| [as_binary(variant)](#as_binary_variant_6) | Traduce esta geometría a su representación Well-Known Binary. |
| [as_image(output_path, width, height, renderer, symbolizer)](#as_image_output_path_width_height_renderer_symbolizer_7) | Exporta esta geometría a una representación de imagen. |
| [as_image(output_path, width, height, renderer, symbolizer)](#as_image_output_path_width_height_renderer_symbolizer_8) | Exporta esta geometría a una representación de imagen. |
| [as_image(width, height, renderer, symbolizer)](#as_image_width_height_renderer_symbolizer_9) | Exporta esta geometría a una representación de imagen. |
| [as_text()](#as_text__10) | Traduce esta geometría a su representación Well-Known Text. |
| [as_text(variant)](#as_text_variant_11) | Traduce esta geometría a su representación Well-Known Text. |
| [as_text(variant, format)](#as_text_variant_format_12) | Traduce esta geometría a su representación Well-Known Text. |
| [clone()](#clone__13) | Clona esta instancia. |
| [covered_by(other)](#covered_by_other_14) | Determina si esta geometría está cubierta por una geometría especificada. |
| [covers(other)](#covers_other_15) | Determina si esta geometría cubre una geometría especificada. |
| [crosses(other)](#crosses_other_16) | Determina si esta geometría y una geometría especificada se cruzan. |
| [difference(other)](#difference_other_17) | Resta una geometría especificada de esta geometría. |
| [disjoint(other)](#disjoint_other_18) | Determina si esta geometría está disjunta de una geometría especificada. |
| [from_binary(wkb)](#from_binary_wkb_19) | Crea una geometría a partir de su representación Well-Known Binary. |
| [from_binary(wkb, spatial_reference_system)](#from_binary_wkb_spatial_reference_system_20) | Crea una geometría a partir de su representación Well-Known Binary. |
| [from_text(wkt)](#from_text_wkt_21) | Crea una geometría a partir de su representación Well-Known Text. |
| [from_text(wkt, spatial_reference_system)](#from_text_wkt_spatial_reference_system_22) | Crea una geometría a partir de su representación Well-Known Text. |
| [get_area()](#get_area__23) | Calcula el área de esta geometría. |
| [get_buffer(distance, quadrant_segments)](#get_buffer_distance_quadrant_segments_24) | Calcula una región de buffer alrededor de esta geometría. |
| [get_centroid()](#get_centroid__25) | Calcula el centroide de esta geometría. |
| [get_convex_hull()](#get_convex_hull__26) | Calcula la envolvente convexa de esta geometría. |
| [get_distance_to(other)](#get_distance_to_other_27) | Calcula la distancia mínima entre esta geometría y una geometría especificada. |
| [get_extent()](#get_extent__28) | Calcula y devuelve una extensión delimitadora de esta geometría. |
| [get_length()](#get_length__29) | Calcula la longitud de esta geometría. |
| [intersection(other)](#intersection_other_30) | Construye una intersección entre esta geometría y una geometría especificada. |
| [intersects(extent)](#intersects_extent_31) | Determina si esta geometría intersecta una extensión especificada. |
| [intersects(other)](#intersects_other_32) | Determina si esta geometría y una geometría especificada intersectan. |
| [is_clockwise()](#is_clockwise__33) | Determina si el anillo tiene sentido horario. |
| [overlaps(other)](#overlaps_other_34) | Determina si esta geometría se superpone con una geometría especificada. |
| [relate(other, intersection_pattern_matrix)](#relate_other_intersection_pattern_matrix_35) | Determina si la matriz de intersección DE-9IM de esta geometría y una geometría especificada coincide con el patrón proporcionado. |
| [replace_polygons_by_lines()](#replace_polygons_by_lines__36) | Obtiene los polígonos representados como líneas de esta geometría. |
| reverse() | Invierte el orden de los puntos en este [LineString](/psd/python-net/aspose.gis.geometries/linestring/). |
| [round_m(digits)](#round_m_digits_37) | Redondea la coordenada M a un número especificado de dígitos fraccionarios. |
| [round_xy(digits)](#round_xy_digits_38) | Redondea las coordenadas X e Y a un número especificado de dígitos fraccionarios. |
| [round_z(digits)](#round_z_digits_39) | Redondea la coordenada Z a un número especificado de dígitos fraccionarios. |
| set_empty() | Hace que esta [Geometry](/psd/python-net/aspose.gis.geometries/geometry/) esté vacía. |
| [spatially_contains(other)](#spatially_contains_other_40) | Determina si esta geometría contiene espacialmente una geometría especificada. |
| [spatially_equals(other)](#spatially_equals_other_41) | Determina si esta geometría es espacialmente igual a una geometría especificada. |
| [sym_difference(other)](#sym_difference_other_42) | Construye una diferencia simétrica entre esta geometría y una geometría especificada. |
| [to_editable()](#to_editable__43) | Obtiene una copia editable de esta geometría. |
| [to_linear_geometry()](#to_linear_geometry__44) | Obtiene una versión aproximada o equivalente sin curvas de esta geometría usando la <c>tolerance</c> predeterminada. |
| [to_linear_geometry(tolerance)](#to_linear_geometry_tolerance_45) | Obtiene una versión aproximada o equivalente sin curvas de esta geometría usando la <c>tolerance</c> especificada. |
| [to_svg(extent)](#to_svg_extent_46) | Traduce esta geometría a la representación Svg. |
| [touches(other)](#touches_other_47) | Determina si esta geometría y una geometría especificada se tocan. |
| [union(other)](#union_other_48) | Une esta geometría y una geometría especificada. |
| [union(other)](#union_other_49) | Une esta geometría y una geometría especificada. |
| [within(extent)](#within_extent_50) | Determina si esta geometría está dentro de una extensión especificada. |
| [within(other)](#within_other_51) | Determina si esta geometría está dentro de una geometría especificada. |
...
Inicializa una nueva instancia de la clase [LinearRing](/psd/python-net/aspose.gis.geometries/linearring/).
...
| :- | :- | :- |
| colección | System.Collections.Generic.IEnumerable<IPoint> | La colección de puntos. |
...
| Parámetro | Tipo | Descripción |
| :- | :- | :- |
| other | [ILineString](/psd/python-net/aspose.gis.geometries/ilinestring) | La otra línea de la cual copiar datos. |
...
| Parámetro | Tipo | Descripción |
| :- | :- | :- |
| point | [IPoint](/psd/python-net/aspose.gis.geometries/ipoint) | El punto a añadir. |
...
| Parámetro | Tipo | Descripción |
| :- | :- | :- |
| x | double | El valor para la coordenada X. |
| y | double | El valor para la coordenada Y. |
...
| x | double | El valor para la coordenada X. |
| y | double | El valor para la coordenada Y. |
| z | double | El valor para la coordenada Z. |
...
| y | double | El valor para la coordenada Y. |
| z | double | El valor para la coordenada Z. |
| m | double | El valor para la coordenada M. |
...
Determina si el anillo tiene sentido horario.

**Returns**

| Tipo | Descripción |
| :- | :- |
| bool | <see langword=\"true\" /> si es horario; de lo contrario <see langword=\"false\" />. |
...
| Tipo | Descripción |
| :- | :- |
| [LinearRing](/psd/python-net/aspose.gis.geometries/linearring) | Una copia editable de esta geometría. |
