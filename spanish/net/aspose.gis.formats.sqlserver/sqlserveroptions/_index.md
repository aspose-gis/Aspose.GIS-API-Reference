...
description: Aspose.Gis.Formats.SqlServer.SqlServerOptions clase. Opciones específicas del controlador para formato SqlServer. Por el momento el controlador no ofrece opciones personalizables.
type: docs
weight: 690
url: /es/net/aspose.gis.formats.sqlserver/sqlserveroptions/
---
## SqlServerOptions class

Opciones específicas del controlador para formato SqlServer. Por el momento, el controlador no ofrece opciones personalizables.
...
| Nombre | Descripción |
| --- | --- |
| [SqlServerOptions](sqlserveroptions/)() | Crear nueva instancia. |
