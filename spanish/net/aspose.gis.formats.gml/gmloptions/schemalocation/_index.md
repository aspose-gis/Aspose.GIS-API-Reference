...
description: Lista separada por espacios de pares de URI. El primer URI de cada par es un URI del espacio de nombres el segundo URI es una ruta al esquema XML del espacio de nombres. Si se establece ennull GmlDriveraspose.gis.formats.gml/gmldriver intentará leer schemaLocation desde el elemento raíz del documento. El valor predeterminado esnull .
type: docs
weight: 50
