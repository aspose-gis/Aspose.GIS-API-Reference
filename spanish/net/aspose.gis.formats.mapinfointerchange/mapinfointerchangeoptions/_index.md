...
description: Aspose.Gis.Formats.MapInfoInterchange.MapInfoInterchangeOptions clase. Opciones específicas del controlador para el formato de intercambio de MapInfo.
type: docs
weight: 590
url: /es/net/aspose.gis.formats.mapinfointerchange/mapinfointerchangeoptions/
---
## MapInfoInterchangeOptions class

Opciones específicas del controlador para el formato de intercambio de MapInfo.
...
| Nombre | Descripción |
| --- | --- |
| [MapInfoInterchangeOptions](mapinfointerchangeoptions/)() | Crear nueva instancia. |
...
| [TextStringAttribute](../../aspose.gis.formats.mapinfointerchange/mapinfointerchangeoptions/textstringattribute/) { get; set; } | Especifica el nombre del atributo que representa el texto del objeto gráfico 'Texto'. |
