...
description: Aspose.Gis.Formats.Kml.KmlOptions clase. Opciones específicas del controlador para el formato KML.
type: docs
weight: 410
url: /es/net/aspose.gis.formats.kml/kmloptions/
---
## KmlOptions class

Opciones específicas del controlador para el formato KML.
...
| Nombre | Descripción |
| --- | --- |
| [KmlOptions](kmloptions/)() | Crear nueva instancia. |

## Propiedades

| Nombre | Descripción |
| --- | --- |
| [AltitudeMode](../../aspose.gis.formats.kml/kmloptions/altitudemode/) { get; set; } | Le permite especificar los AltitudeModes para usar con geometrías KML |
| [AutoId](../../aspose.gis.formats.kml/kmloptions/autoid/) { get; set; } | Generar automáticamente ids |
...
| [DocumentId](../../aspose.gis.formats.kml/kmloptions/documentid/) { get; set; } | Se usa para especificar la identificación del nodo raíz 'Documento' |
...
| [SymbolToReplaceInvalidChars](../../aspose.gis.formats.kml/kmloptions/symboltoreplaceinvalidchars/) { get; set; } | Determina qué símbolo se usará para reemplazar los caracteres no válidos en la lectura. Se omite el reemplazo si el valor es '\0'. Por defecto el valor es '\0' char. |
