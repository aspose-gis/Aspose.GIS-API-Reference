...
description: Crear SRS geográfico a partir de parámetros personalizados.
type: docs
weight: 360
url: /es/net/aspose.gis.spatialreferencing/spatialreferencesystem/creategeographic/
---
...
| --- | --- | --- |
| parameters | GeographicSpatialReferenceSystemParameters | Parámetros desde los que crear. |
