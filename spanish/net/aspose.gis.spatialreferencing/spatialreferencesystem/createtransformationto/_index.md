...
| excepción | condición |
| --- | --- |
| NotSupportedException | Transformación entre este`Sistema de referencia espacial` y el argumento no es compatible. Esto puede suceder porque una de las proyecciones no es compatible o uno de los sistemas no es compatible.[`VerticalSpatialReferenceSystem`](../../verticalspatialreferencesystem) or [`LocalSpatialReferenceSystem`](../../localspatialreferencesystem) . |
