...
description: El sistema de referencia espacial asigna coordenadas a lugares de la Tierra. Hay diferentes tipos de SRS consulteType./spatialreferencesystem/type . Además si el tipo de SRS esGeographic or Projected SRS puede ser compuesto o simple verIsCompound./spatialreferencesystem/iscompound .
type: docs
weight: 2150
...
El sistema de referencia espacial asigna coordenadas a lugares de la Tierra. Hay diferentes tipos de SRS, consulte[`Type`](./type) . Además, si el tipo de SRS esGeographic or Projected SRS puede ser compuesto o simple, ver[`IsCompound`](./iscompound) .
