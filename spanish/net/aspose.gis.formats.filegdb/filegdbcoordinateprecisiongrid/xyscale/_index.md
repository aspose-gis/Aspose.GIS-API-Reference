...
description: Obtiene o establece la escala de las coordenadas X e Y. Si se establece ennull se usa el predeterminado.
type: docs
weight: 60
...
El valor predeterminado es`1e9` por[`VectorLayer`](../../../aspose.gis/vectorlayer) con geográfica[`SpatialReferenceSystem`](../../../aspose.gis.spatialreferencing/spatialreferencesystem) y`Escala XY = 1 / Tolerancia XY * 10` por[`VectorLayer`](../../../aspose.gis/vectorlayer) with proyectado[`SpatialReferenceSystem`](../../../aspose.gis.spatialreferencing/spatialreferencesystem) .
