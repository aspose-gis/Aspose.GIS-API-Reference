...
description: Devuelve los valores de todos los atributos de una matriz. Considere usarGetValuesaspose.gis/feature/getvaluesmétodo para evitar la asignación de memoria adicional.
type: docs
weight: 60
...
Los atributos de valores de la entidad se copian en la matriz de valores que se pasa como parámetro. Para atributos con valor no establecido, se devuelve el parámetro 'unsetValue' especificado.
