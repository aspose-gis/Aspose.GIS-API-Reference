...
description: Devuelve un modelo de precisión de redondeo. De acuerdo con el modelo de precisión de redondeo solo un número limitado de dígitos son significativos.
type: docs
weight: 20
