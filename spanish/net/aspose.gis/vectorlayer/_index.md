...
description: Representa una capa vectorial. Una capa vectorial es una colección de características geográficas almacenadas en un archivo.
type: docs
weight: 2220
...
| Nombre | Descripción |
| --- | --- |
| override [Attributes](../../aspose.gis/vectorlayer/attributes) { get; } | Obtiene la colección de atributos personalizados para las funciones en este[`VectorLayer`](../vectorlayer) . |
...
| [Add](../../aspose.gis/vectorlayer/add#add)(Feature) | Agrega una nueva entidad a la capa, si es compatible con el[`VectorLayer`](../vectorlayer) s[`Driver`](./driver) . |
| virtual [Add](../../aspose.gis/vectorlayer/add#add_1)(Feature, IFeatureStyle) | Agrega una nueva entidad con el estilo especificado a la capa, si es compatible con el[`VectorLayer`](../vectorlayer) s[`Driver`](./driver) . |
...
| [CopyAttributes](../../aspose.gis/vectorlayer/copyattributes#copyattributes)(FeaturesSequence) | Copia atributos de otros[`VectorLayer`](../vectorlayer) a este. |
| [CopyAttributes](../../aspose.gis/vectorlayer/copyattributes#copyattributes_1)(FeaturesSequence, IAttributesConverter) | Copia atributos de otros[`VectorLayer`](../vectorlayer) a este. |
| [Dispose](../../aspose.gis/vectorlayer/dispose)() | Libera los recursos utilizados por el[`VectorLayer`](../vectorlayer) . |
