...
description: Especifica los límites del mapa para renderizar. Si se establece ennull  la extensión se calcula durante el renderizado para incluir todas las geometrías en todas las capas.
type: docs
weight: 40
