...
description: Aspose.Gis.Formats.Shapefile.ShapefileOptions clase. Opciones específicas del controlador para formato Shapefile. Por el momento el controlador no ofrece opciones personalizables.
type: docs
weight: 670
url: /es/net/aspose.gis.formats.shapefile/shapefileoptions/
---
## ShapefileOptions class

Opciones específicas del controlador para formato Shapefile. Por el momento, el controlador no ofrece opciones personalizables.
...
| Nombre | Descripción |
| --- | --- |
| [ShapefileOptions](shapefileoptions/)() | Crear nueva instancia. |
