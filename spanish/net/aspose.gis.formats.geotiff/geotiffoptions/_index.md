...
description: Aspose.Gis.Formats.GeoTiff.GeoTiffOptions clase. Opciones específicas del controlador para el formato GeoTiff.
type: docs
weight: 330
url: /es/net/aspose.gis.formats.geotiff/geotiffoptions/
---
## GeoTiffOptions class

Opciones específicas del controlador para el formato GeoTiff.
...
| Nombre | Descripción |
| --- | --- |
| [GeoTiffOptions](geotiffoptions/)() | Crear nueva instancia. |
