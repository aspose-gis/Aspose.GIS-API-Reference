...
description: AMultiCurve./multicurve es unidimensionalGeometryCollection./geometrycollection cuyos elementos sonCurve./curve s.
type: docs
weight: 1040
...
A[`MultiCurve`](../multicurve) es unidimensional[`GeometryCollection`](../geometrycollection) cuyos elementos son[`Curve`](../curve) s.
...
| Nombre | Descripción |
| --- | --- |
| [MultiCurve](multicurve)() | Inicializa una nueva instancia del[`MultiCurve`](../multicurve) clase. |
