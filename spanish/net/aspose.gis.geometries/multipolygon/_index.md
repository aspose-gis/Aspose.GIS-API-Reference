...
description: AMultiPolygon./multipolygon es un unidimensionalGeometryCollection./geometrycollection cuyos elementos sonPolygon./polygon s.
type: docs
weight: 1070
url: /es/net/aspose.gis.geometries/multipolygon/
---
## MultiPolygon class

A[`MultiPolygon`](../multipolygon) es un unidimensional[`GeometryCollection`](../geometrycollection) cuyos elementos son[`Polygon`](../polygon) s.
...
| Nombre | Descripción |
| --- | --- |
| [MultiPolygon](multipolygon)() | Inicializa una nueva instancia del[`MultiPolygon`](../multipolygon) clase. |
...
| override [GeometryType](../../aspose.gis.geometries/multipolygon/geometrytype) { get; } | Obtiene el tipo de la geometría. |
...
| override [Clone](../../aspose.gis.geometries/multipolygon/clone)() | Clona esta instancia. |
...
| [ToEditable](../../aspose.gis.geometries/multipolygon/toeditable#toeditable_2)() | Obtiene una copia editable de esta geometría. (4 methods) |
| [ToEditable&lt;T&gt;](../../aspose.gis.geometries/geometry/toeditable)() | Obtiene una copia editable de esta geometría. |
| [ToLinearGeometry](../../aspose.gis.geometries/multisurface/tolineargeometry)() | Obtiene una versión no curva aproximada o equivalente de esta geometría usando el valor predeterminado`tolerancia` . (3 methods) |
| [ToLinearGeometry](../../aspose.gis.geometries/multisurface/tolineargeometry)(double) | Obtiene una versión no curva aproximada o equivalente de esta geometría usando el`tolerancia` . (3 methods) |
