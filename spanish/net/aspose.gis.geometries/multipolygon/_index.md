...
description: Aspose.Gis.Geometries.MultiPolygon clase. AMultiPolygon es un unidimensionalGeometryCollection cuyos elementos sonPolygon s.
type: docs
weight: 1170
...
A`MultiPolygon` es un unidimensional[`GeometryCollection`](../geometrycollection/) cuyos elementos son[`Polygon`](../polygon/) s.
...
| Nombre | Descripción |
| --- | --- |
| [MultiPolygon](multipolygon/)() | Inicializa una nueva instancia del`MultiPolygon` clase. |
