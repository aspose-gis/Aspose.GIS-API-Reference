...
description: Aspose.Gis.Geometries.Geometry clase. La clase raíz abstracta de la jerarquía de geometrías.
type: docs
weight: 920
...
| Nombre | Descripción |
| --- | --- |
| [CoordinateDimension](../../aspose.gis.geometries/geometry/coordinatedimension/) { get; } | Obtiene el número de dimensiones de coordenadas para este`Geometry` . |
| abstract [Dimension](../../aspose.gis.geometries/geometry/dimension/) { get; } | Obtiene la dimensión topológica de este`Geometry` . Si se desconoce la dimensión (por ejemplo, para una GEOMETRYCOLLECTION vacía)Point se devuelve. |
...
| virtual [SetEmpty](../../aspose.gis.geometries/geometry/setempty/)() | hace esto`Geometry` vacío. |
