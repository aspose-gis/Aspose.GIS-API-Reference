...
description: Aspose.Gis.Geometries.CircularString clase. Una curva de varios vértices con interpolación circular entre puntos.
type: docs
weight: 880
...
| Nombre | Descripción |
| --- | --- |
| [CircularString](circularstring/#constructor)() | Inicializa una nueva instancia del`CircularString` clase. |
| [CircularString](circularstring/#constructor_1)(ICircularString) | Inicializa una nueva instancia del`CircularString` clase. |
| [CircularString](circularstring/#constructor_2)(IEnumerable&lt;IPoint&gt;) | Inicializa una nueva instancia del`CircularString` clase. |
...
| [Count](../../aspose.gis.geometries/circularstring/count/) { get; } | Obtiene el número de puntos en el`CircularString` . |
...
| override [Reverse](../../aspose.gis.geometries/circularstring/reverse/)() | Invierte el orden de los puntos en este`CircularString` . |
