...
description: APoint./point representa una única ubicación en el espacio de coordenadas.
type: docs
weight: 1090
url: /es/net/aspose.gis.geometries/point/
---
## Point class

A[`Point`](../point) representa una única ubicación en el espacio de coordenadas.
...
| Nombre | Descripción |
| --- | --- |
| [Point](point#constructor)() | Inicializa una nueva instancia del[`Point`](../point) clase. |
| [Point](point#constructor_1)(IPoint) | Inicializa una nueva instancia del[`Point`](../point) clase. |
| [Point](point#constructor_2)(double, double) | Inicializa una nueva instancia del[`Point`](../point) clase. |
| [Point](point#constructor_3)(double, double, double) | Inicializa una nueva instancia del[`Point`](../point) clase. |
| [Point](point#constructor_4)(double, double, double, double) | Inicializa una nueva instancia del[`Point`](../point) clase. |
...
| override [Dimension](../../aspose.gis.geometries/point/dimension) { get; } | Obtiene la dimensión topológica de este[`Geometry`](../geometry) . |
| override [GeometryType](../../aspose.gis.geometries/point/geometrytype) { get; } | Obtiene el tipo de la geometría. |
...
| override [HasM](../../aspose.gis.geometries/point/hasm) { get; set; } | Obtiene un valor que indica si esta instancia tiene una coordenada M. |
| override [HasZ](../../aspose.gis.geometries/point/hasz) { get; set; } | Obtiene un valor que indica si esta instancia tiene coordenada Z. |
...
| [M](../../aspose.gis.geometries/point/m) { get; set; } | Obtiene o establece un valor para la coordenada m. |
| override [SpatialReferenceSystem](../../aspose.gis.geometries/point/spatialreferencesystem) { get; set; } | Obtiene SpatialReferenceSystem de esta instancia. Esta propiedad se puede`null` , es SpatialReferenceSystem es desconocido. La asignación de un nuevo SpatialReferenceSystem no realizará ninguna transformación de coordenadas, solo cambiará la referencia. |
| [X](../../aspose.gis.geometries/point/x) { get; set; } | Obtiene o establece un valor para la coordenada x. |
| [Y](../../aspose.gis.geometries/point/y) { get; set; } | Obtiene o establece un valor para la coordenada y. |
| [Z](../../aspose.gis.geometries/point/z) { get; set; } | Obtiene o establece un valor para la coordenada z. |
...
| override [Clone](../../aspose.gis.geometries/point/clone)() | Clona esta instancia. |
...
| [Equals](../../aspose.gis.geometries/point/equals#equals)(IPoint) | Indica si el objeto actual es igual a otro objeto del mismo tipo. |
| override [Equals](../../aspose.gis.geometries/point/equals#equals_1)(object) | Determina si el objeto especificado es igual al objeto actual. |
...
| override [GetHashCode](../../aspose.gis.geometries/point/gethashcode)() | Sirve como la función hash predeterminada. |
...
| override [SetEmpty](../../aspose.gis.geometries/point/setempty)() | hace esto[`Geometry`](../geometry) vacío. |
...
| [ToEditable](../../aspose.gis.geometries/point/toeditable#toeditable_1)() | Obtiene una copia editable de esta geometría. (2 methods) |
| [ToEditable&lt;T&gt;](../../aspose.gis.geometries/geometry/toeditable)() | Obtiene una copia editable de esta geometría. |
| [ToLinearGeometry](../../aspose.gis.geometries/geometry/tolineargeometry)() | Obtiene una versión no curva aproximada o equivalente de esta geometría usando el valor predeterminado`tolerancia` . |
| [ToLinearGeometry](../../aspose.gis.geometries/geometry/tolineargeometry)(double) | Obtiene una versión no curva aproximada o equivalente de esta geometría usando el`tolerancia` . |
...
| [operator ==](../../aspose.gis.geometries/point/op_equality) | Implementa el operador ==. |
| [operator !=](../../aspose.gis.geometries/point/op_inequality) | Implementa el operador !=. |
