...
description: Aspose.Gis.Geometries.Point clase. APoint representa una única ubicación en el espacio de coordenadas.
type: docs
weight: 1190
...
A`Point` representa una única ubicación en el espacio de coordenadas.
...
| Nombre | Descripción |
| --- | --- |
| [Point](point/#constructor)() | Inicializa una nueva instancia del`Point` clase. |
| [Point](point/#constructor_1)(IPoint) | Inicializa una nueva instancia del`Point` clase. |
| [Point](point/#constructor_2)(double, double) | Inicializa una nueva instancia del`Point` clase. |
| [Point](point/#constructor_3)(double, double, double) | Inicializa una nueva instancia del`Point` clase. |
| [Point](point/#constructor_4)(double, double, double, double) | Inicializa una nueva instancia del`Point` clase. |
