...
description: Aspose.Gis.Geometries.LinearRing clase. ALinearRing es unLineString que es a la vez cerrado y simple.
type: docs
weight: 1130
...
A`LinearRing` es un[`LineString`](../linestring/) que es a la vez cerrado y simple.
...
| Nombre | Descripción |
| --- | --- |
| [LinearRing](linearring/#constructor)() | Inicializa una nueva instancia del`LinearRing` clase. |
| [LinearRing](linearring/#constructor_2)(IEnumerable&lt;IPoint&gt;) | Inicializa una nueva instancia del`LinearRing` clase. |
| [LinearRing](linearring/#constructor_1)(ILineString) | Inicializa una nueva instancia del`LinearRing` clase. |
