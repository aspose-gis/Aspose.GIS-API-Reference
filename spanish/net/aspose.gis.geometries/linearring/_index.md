...
description: ALinearRing./linearring es unLineString./linestring que es a la vez cerrado y simple.
type: docs
weight: 1030
url: /es/net/aspose.gis.geometries/linearring/
---
## LinearRing class

A[`LinearRing`](../linearring) es un[`LineString`](../linestring) que es a la vez cerrado y simple.
...
| Nombre | Descripción |
| --- | --- |
| [LinearRing](linearring#constructor)() | Inicializa una nueva instancia del[`LinearRing`](../linearring) clase. |
| [LinearRing](linearring#constructor_2)(IEnumerable&lt;IPoint&gt;) | Inicializa una nueva instancia del[`LinearRing`](../linearring) clase. |
| [LinearRing](linearring#constructor_1)(ILineString) | Inicializa una nueva instancia del[`LinearRing`](../linearring) clase. |
...
| [Count](../../aspose.gis.geometries/linestring/count) { get; } | Obtiene el número de puntos en el[`LineString`](../linestring) . |
...
| override [GeometryType](../../aspose.gis.geometries/linearring/geometrytype) { get; } | Obtiene el tipo de la geometría. |
...
| Nombre | Descripción |
| --- | --- |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint)(IPoint) | Añade un punto al final de la línea. |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint)(double, double) | Añade un punto al final de la línea. |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint)(double, double, double) | Añade un punto al final de la línea. |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint)(double, double, double, double) | Añade un punto al final de la línea. |
...
| override [Clone](../../aspose.gis.geometries/linearring/clone)() | Clona esta instancia. |
...
| [Equals](../../aspose.gis.geometries/linestring/equals)(ILineString) | Indica si el objeto actual es igual a otro objeto del mismo tipo. |
| override [Equals](../../aspose.gis.geometries/linestring/equals)(object) | Determina si el objeto especificado es igual al objeto actual. |
...
| [IsClockwise](../../aspose.gis.geometries/linearring/isclockwise)() | Determina si el anillo tiene cuerda en el sentido de las agujas del reloj. |
...
| override [Reverse](../../aspose.gis.geometries/linestring/reverse)() | Invierte el orden de los puntos en este[`LineString`](../linestring) . |
...
| [ToEditable](../../aspose.gis.geometries/linearring/toeditable#toeditable_2)() | Obtiene una copia editable de esta geometría. (4 methods) |
