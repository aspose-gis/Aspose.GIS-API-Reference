...
description: Aspose.Gis.Geometries.MultiSurface clase. AMultiSurface es unidimensionalGeometryCollection cuyos elementos sonISurface s.
type: docs
weight: 1180
...
A`MultiSurface` es unidimensional[`GeometryCollection`](../geometrycollection/) cuyos elementos son[`ISurface`](../isurface/) s.
...
| Nombre | Descripción |
| --- | --- |
| [MultiSurface](multisurface/)() | Inicializa una nueva instancia del`MultiSurface` clase. |
