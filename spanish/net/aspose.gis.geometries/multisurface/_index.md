...
description: AMultiSurface./multisurface es unidimensionalGeometryCollection./geometrycollection cuyos elementos sonISurface./isurface s.
type: docs
weight: 1080
url: /es/net/aspose.gis.geometries/multisurface/
---
## MultiSurface class

A[`MultiSurface`](../multisurface) es unidimensional[`GeometryCollection`](../geometrycollection) cuyos elementos son[`ISurface`](../isurface) s.
...
| Nombre | Descripción |
| --- | --- |
| [MultiSurface](multisurface)() | Inicializa una nueva instancia del[`MultiSurface`](../multisurface) clase. |
...
| [Dimension](../../aspose.gis.geometries/multisurface/dimension) { get; } | Obtiene la dimensión topológica de este[`Geometry`](../geometry) . |
| override [GeometryType](../../aspose.gis.geometries/multisurface/geometrytype) { get; } | Obtiene el tipo de la geometría. |
...
| override [Clone](../../aspose.gis.geometries/multisurface/clone)() | Clona esta instancia. |
...
| [ToEditable](../../aspose.gis.geometries/multisurface/toeditable#toeditable_2)() | Obtiene una copia editable de esta geometría. (3 methods) |
| [ToEditable&lt;T&gt;](../../aspose.gis.geometries/geometry/toeditable)() | Obtiene una copia editable de esta geometría. |
| [ToLinearGeometry](../../aspose.gis.geometries/multisurface/tolineargeometry#tolineargeometry_4)() | Obtiene una versión no curva aproximada o equivalente de esta geometría usando el valor predeterminado`tolerancia` . (3 methods) |
| [ToLinearGeometry](../../aspose.gis.geometries/multisurface/tolineargeometry#tolineargeometry_5)(double) | Obtiene una versión no curva aproximada o equivalente de esta geometría usando el`tolerancia` . (3 methods) |
