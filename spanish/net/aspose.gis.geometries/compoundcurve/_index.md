...
description: Aspose.Gis.Geometries.CompoundCurve clase. Una curva que representa una secuencia de curvas contiguas de manera que las curvas adyacentes se unen en sus puntos finales.
type: docs
weight: 890
...
| Nombre | Descripción |
| --- | --- |
| [CompoundCurve](compoundcurve/#constructor)() | Inicializa una nueva instancia del`CompoundCurve` clase. |
| [CompoundCurve](compoundcurve/#constructor_1)(ICompoundCurve) | Inicializa una nueva instancia del`CompoundCurve` clase. |
| [CompoundCurve](compoundcurve/#constructor_2)(IEnumerable&lt;ICurve&gt;) | Inicializa una nueva instancia del`CompoundCurve` clase. |
...
| Nombre | Descripción |
| --- | --- |
| [AddCurve](../../aspose.gis.geometries/compoundcurve/addcurve/)(ICurve) | Agrega una curva al final de este`CompoundCurve` . |
...
| override [Reverse](../../aspose.gis.geometries/compoundcurve/reverse/)() | Invierte esto`CompoundCurve` . Es decir, el orden inverso de las curvas y cada curva dentro de esta curva compuesta. |
