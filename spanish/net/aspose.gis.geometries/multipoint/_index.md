...
description: Aspose.Gis.Geometries.MultiPoint clase. AMultiPoint es unidimensionalGeometryCollection cuyos elementos sonPoint s.
type: docs
weight: 1160
...
A`MultiPoint` es unidimensional[`GeometryCollection`](../geometrycollection/) cuyos elementos son[`Point`](../point/) s.
...
| Nombre | Descripción |
| --- | --- |
| [MultiPoint](multipoint/)() | Inicializa una nueva instancia del`MultiPoint` clase. |
