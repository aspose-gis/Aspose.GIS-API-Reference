...
description: AMultiPoint./multipoint es unidimensionalGeometryCollection./geometrycollection cuyos elementos sonPoint./point s.
type: docs
weight: 1060
url: /es/net/aspose.gis.geometries/multipoint/
---
## MultiPoint class

A[`MultiPoint`](../multipoint) es unidimensional[`GeometryCollection`](../geometrycollection) cuyos elementos son[`Point`](../point) s.
...
| Nombre | Descripción |
| --- | --- |
| [MultiPoint](multipoint)() | Inicializa una nueva instancia del[`MultiPoint`](../multipoint) clase. |
...
| [Dimension](../../aspose.gis.geometries/multipoint/dimension) { get; } | Obtiene la dimensión topológica de este[`Geometry`](../geometry) . |
| override [GeometryType](../../aspose.gis.geometries/multipoint/geometrytype) { get; } | Obtiene el tipo de la geometría. |
...
| override [Clone](../../aspose.gis.geometries/multipoint/clone)() | Clona esta instancia. |
...
| [ToEditable](../../aspose.gis.geometries/multipoint/toeditable#toeditable_2)() | Obtiene una copia editable de esta geometría. (3 methods) |
| [ToEditable&lt;T&gt;](../../aspose.gis.geometries/geometry/toeditable)() | Obtiene una copia editable de esta geometría. |
| [ToLinearGeometry](../../aspose.gis.geometries/geometrycollection/tolineargeometry)() | Obtiene una versión no curva aproximada o equivalente de esta geometría usando el valor predeterminado`tolerancia` . (2 methods) |
| [ToLinearGeometry](../../aspose.gis.geometries/geometrycollection/tolineargeometry)(double) | Obtiene una versión no curva aproximada o equivalente de esta geometría usando el`tolerancia` . (2 methods) |
