...
description: IGeometry método. Determina si esta geometría y una geometría especificada se cruzan.
type: docs
weight: 160
...
Este método prueba si las geometrías son cruces en términos de la matriz de intersección DE-9IM. Dos geometrías se cruzan entre sí si tienen algunos puntos interiores en común, pero no todos, y la dimensión de la intersección es menor que la dimensión de al menos uno de los geometrías. Es decir: dos[`LineString`](../../linestring/) s cross, si forman una letra 'X', una LineString y una[`Polygon`](../../polygon/) cruce si LineString atraviesa el interior de un polígono. Consulte la Especificación de características simples de OpenGIS para obtener más detalles sobre DE-9IM y la relación de "cruces espaciales".
