...
description: La clase raíz de la interfaz de la jerarquía de geometrías
type: docs
weight: 900
...
| Nombre | Descripción |
| --- | --- |
| [Dimension](../../aspose.gis.geometries/igeometry/dimension) { get; } | Obtiene la dimensión topológica de este[`IGeometry`](../igeometry) . Si se desconoce la dimensión (por ejemplo, para una GEOMETRYCOLLECTION vacía)Point se devuelve. |
