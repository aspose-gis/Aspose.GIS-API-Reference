...
description: Aspose.Gis.Geometries.GeometryCollection clase. AGeometryCollection es unGeometry que es una colección de una o más geometrías.
type: docs
weight: 930
...
A`GeometryCollection` es un[`Geometry`](../geometry/) que es una colección de una o más geometrías.
...
| Nombre | Descripción |
| --- | --- |
| [GeometryCollection](geometrycollection/)() | Inicializa una nueva instancia del`GeometryCollection` clase. |
