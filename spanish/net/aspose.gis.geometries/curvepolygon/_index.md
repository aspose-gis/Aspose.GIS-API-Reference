...
description: Aspose.Gis.Geometries.CurvePolygon clase. Una superficie plana definida por 1 límite exterior y 0 o más límites interiores.
type: docs
weight: 910
...
| Nombre | Descripción |
| --- | --- |
| [CurvePolygon](curvepolygon/#constructor)() | Inicializa una nueva instancia del`CurvePolygon` clase. |
| [CurvePolygon](curvepolygon/#constructor_1)(ICurve) | Inicializa una nueva instancia del`CurvePolygon` clase. |
| [CurvePolygon](curvepolygon/#constructor_2)(ICurve, IEnumerable&lt;ICurve&gt;) | Inicializa una nueva instancia del`CurvePolygon` clase. |
