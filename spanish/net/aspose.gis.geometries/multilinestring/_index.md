...
description: Aspose.Gis.Geometries.MultiLineString clase. AMultiLineString es unidimensionalGeometryCollection cuyos elementos sonLineString s.
type: docs
weight: 1150
...
A`MultiLineString` es unidimensional[`GeometryCollection`](../geometrycollection/) cuyos elementos son[`LineString`](../linestring/) s.
...
| Nombre | Descripción |
| --- | --- |
| [MultiLineString](multilinestring/)() | Inicializa una nueva instancia del`MultiLineString` clase. |
