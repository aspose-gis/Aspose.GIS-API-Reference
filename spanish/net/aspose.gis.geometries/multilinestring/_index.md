...
type: docs
weight: 1050
url: /es/net/aspose.gis.geometries/multilinestring/
---
...
| Nombre | Descripción |
| --- | --- |
| [MultiLineString](multilinestring)() | Inicializa una nueva instancia del[`MultiLineString`](../multilinestring) clase. |
...
| override [GeometryType](../../aspose.gis.geometries/multilinestring/geometrytype) { get; } | Obtiene el tipo de la geometría. |
...
| override [Clone](../../aspose.gis.geometries/multilinestring/clone)() | Clona esta instancia. |
...
| [ToEditable](../../aspose.gis.geometries/multilinestring/toeditable#toeditable_3)() | Obtiene una copia editable de esta geometría. (4 methods) |
| [ToEditable&lt;T&gt;](../../aspose.gis.geometries/geometry/toeditable)() | Obtiene una copia editable de esta geometría. |
| [ToLinearGeometry](../../aspose.gis.geometries/multicurve/tolineargeometry)() | Obtiene una versión no curva aproximada o equivalente de esta geometría usando el valor predeterminado`tolerancia` . (3 methods) |
| [ToLinearGeometry](../../aspose.gis.geometries/multicurve/tolineargeometry)(double) | Obtiene una versión no curva aproximada o equivalente de esta geometría usando el`tolerancia` . (3 methods) |
