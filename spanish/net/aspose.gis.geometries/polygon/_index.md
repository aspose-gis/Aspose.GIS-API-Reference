...
description: Aspose.Gis.Geometries.Polygon clase. APolygon es una superficie plana definida por 1 límite exterior y 0 o más límites interiores.
type: docs
weight: 1200
...
A`Polygon` es una superficie plana, definida por 1 límite exterior y 0 o más límites interiores.
...
| Nombre | Descripción |
| --- | --- |
| [Polygon](polygon/#constructor)() | Inicializa una nueva instancia del`Polygon` clase. |
| [Polygon](polygon/#constructor_1)(ILinearRing) | Inicializa una nueva instancia del`Polygon` clase. |
| [Polygon](polygon/#constructor_2)(ILinearRing, IEnumerable&lt;ILinearRing&gt;) | Inicializa una nueva instancia del`Polygon` clase. |
