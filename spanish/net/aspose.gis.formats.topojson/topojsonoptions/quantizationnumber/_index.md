...
description: Especifica el número de cuantificación que se usará para cuantificar las coordenadas y los arcos de codificación delta en la salida TopoJSON.
type: docs
weight: 50
