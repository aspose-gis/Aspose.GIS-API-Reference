...
type: docs
weight: 880
url: /it/python-net/aspose.gis/filedriver/
---
...
| [open_layer(path, options)](#open_layer_path_options_21) | Apre il layer per la lettura. |
| [open_layer(path, options)](#open_layer_path_options_22) | Apre il layer per la lettura. |
| [supports_spatial_reference_system(spatial_reference_system)](#supports_spatial_reference_system_spatial_reference_system_23) | Determina se il sistema di riferimento spaziale specificato è supportato dal driver. |
