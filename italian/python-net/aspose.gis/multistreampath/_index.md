...
type: docs
weight: 2760
url: /it/python-net/aspose.gis/multistreampath/
---
...
| **Name** | **Descrizione** |
| :- | :- |
| [MultiStreamPath(entry_file_name, file_names, streams)](#MultiStreamPath_entry_file_name_file_names_streams_1) | Inizializza una nuova istanza della classe [MultiStreamPath](/psd/python-net/aspose.gis/multistreampath/). |
## **Properties**
| **Name** | **Type** | **Access** | **Descrizione** |
| :- | :- | :- | :- |
| posizione | string | r | Restituisce una rappresentazione stringa della posizione di questo <c>AbstractPath</c>. |
| separator | char | r | Restituisce un carattere separatore usato per separare i livelli di directory della stringa [MultiStreamPath.location](/psd/python-net/aspose.gis/multistreampath/). |
## **Methods**
| **Name** | **Descrizione** |
| :- | :- |
...
| [open(access)](#open_access_9) | Astrae un insieme di formati multi-file di streaming aperti come percorso per l'accesso ai dati. |
...
Inizializza una nuova istanza della classe [MultiStreamPath](/psd/python-net/aspose.gis/multistreampath/).

**Parameters:**

| Parametro | Tipo | Descrizione |
| :- | :- | :- |
| entry_file_name | string | Nome del file di ingresso. |
| file_names | string | I nomi dei file. |
| streams | _io.BufferedRandom[] | I flussi. |
...
Astrae un insieme di formati multi-file di streaming aperti come percorso per l'accesso ai dati.
...
| Tipo | Descrizione |
| :- | :- |
| _io.BufferedRandom | Questo può essere o un   o lo stream originariamente passato dal client. |
