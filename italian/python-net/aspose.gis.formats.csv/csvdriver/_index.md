...
type: docs
weight: 10
url: /it/python-net/aspose.gis.formats.csv/csvdriver/
---
...
| **Name** | **Descrizione** |
| :- | :- |
| [CsvDriver()](#CsvDriver__1) | Inizializza una nuova istanza della classe CsvDriver |
## **Properties**
...
Inizializza una nuova istanza della classe CsvDriver
...
| :- | :- | :- |
| path | string | Percorso del file. |
| options | [CsvOptions](/psd/python-net/aspose.gis.formats.csv/csvoptions) | Opzioni specifiche del driver. |
