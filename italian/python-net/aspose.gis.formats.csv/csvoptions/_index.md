---
title: "CsvOptions Classe"
type: docs
weight: 20
url: /it/python-net/aspose.gis.formats.csv/csvoptions/
---
...
| **Name** | **Descrizione** |
| :- | :- |
| [CsvOptions()](#CsvOptions__1) | Crea una nuova istanza. |
## **Properties**
...
| column_m | string | r/w | Ottiene o imposta il nome della colonna che contiene il valore della coordinata M.<br/>            Il valore predefinito è <see langword=\"null\" />. |
| column_wkt | string | r/w | Ottiene o imposta il nome della colonna che contiene il Well-Known Text per rappresentare la geometria.<br/>            Il valore predefinito è <see langword=\"null\" />. |
| column_x | string | r/w | Ottiene o imposta il nome della colonna che contiene il valore della coordinata X.<br/>            Il valore predefinito è <see langword=\"null\" />. |
| column_y | string | r/w | Ottiene o imposta il nome della colonna che contiene il valore della coordinata Y.<br/>            Il valore predefinito è <see langword=\"null\" />. |
| column_z | string | r/w | Ottiene o imposta il nome della colonna che contiene il valore della coordinata Z.<br/>            Il valore predefinito è <see langword=\"null\" />. |
...
| delimitatore | char | r/w | Ottiene o imposta un carattere usato come delimitatore per separare i valori.<br/>            Il valore predefinito è ','. |
| double_quote_escape | char | r/w | Ottiene o imposta un carattere usato come carattere di escape per le virgolette doppie.<br/>            Il valore predefinito è '\"'. |
| has_attribute_names | bool | r/w | Determina se esiste una riga di intestazione con i nomi degli attributi.<br/>            Il valore predefinito è <see langword=\"true\" />. |
...
| start_line_number | int | r/w | Ottiene o imposta un numero di riga basato su zero che sarà il primo quando si leggono i dati.<br/>            Il valore predefinito è 0. |
