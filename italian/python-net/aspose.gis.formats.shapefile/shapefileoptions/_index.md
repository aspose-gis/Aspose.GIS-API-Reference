...
type: docs
weight: 20
url: /it/python-net/aspose.gis.formats.shapefile/shapefileoptions/
---
...
| **Name** | **Descrizione** |
| :- | :- |
| [ShapefileOptions()](#ShapefileOptions__1) | Crea una nuova istanza. |
## **Properties**
...
| is_ignore_wrong_data | bool | r/w | Determina se lanciare un'eccezione durante l'analisi di dati errati o impostare valori predefiniti per essi |
