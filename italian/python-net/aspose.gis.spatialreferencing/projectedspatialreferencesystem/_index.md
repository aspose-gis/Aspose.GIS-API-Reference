---
title: "Classe ProjectedSpatialReferenceSystem"
type: docs
weight: 150
url: /it/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/
---
...
| :- | :- | :- | :- |
| angular_unit | [Unit](/psd/python-net/aspose.gis.spatialreferencing/unit) | r | Unità utilizzata per i valori angolari in questo SRS e per i parametri angolari di [ProjectedSpatialReferenceSystem.projection](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/).<br/>            Corrisponde all'unità angolare di [ProjectedSpatialReferenceSystem.base](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/). |
...
| as_projected | [ProjectedSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem) | r | Restituisci questo. |
...
| axises_order | [ProjectedAxisesOrder](/psd/python-net/aspose.gis.spatialreferencing/projectedaxisesorder) | r | Ordine degli assi in questo SRS.<br/>            Se questo SRS non è valido e ha direzioni degli assi errate, viene restituito [ProjectedAxisesOrder.INVALID](/psd/python-net/aspose.gis.spatialreferencing/projectedaxisesorder/). |
| base | [GeographicSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/geographicspatialreferencesystem) | r | SRS geografico al quale è stata applicata [ProjectedSpatialReferenceSystem.projection](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/) per ottenere questo SRS. |
| dimensions_count | int | r | Restituisce il conteggio delle dimensioni in questo SRS. Per gli SRS proiettati può essere:<br/>            due - se questo è un singolo SRS proiettato.<br/>            tre - se questo è un SRS composto, che consiste in un singolo SRS proiettato bidimensionale e un SRS verticale, che aggiunge la terza dimensione. |
...
| has_geographic_datum | bool | r | Restituisce true, poiché gli SRS proiettati hanno sempre il meridiano primario. |
| has_prime_meridian | bool | r | Restituisce true, poiché gli SRS proiettati hanno sempre il meridiano primario. |
...
| linear_unit | [Unit](/psd/python-net/aspose.gis.spatialreferencing/unit) | r | Unità, utilizzata per le dimensioni lineari in questo SRS e per i parametri lineari di [ProjectedSpatialReferenceSystem.projection](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/). |
...
| projection | [Projection](/psd/python-net/aspose.gis.spatialreferencing/projection) | r | Proiezione, applicata a [ProjectedSpatialReferenceSystem.base](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/) per ottenere questo SRS. |
| type | [SpatialReferenceSystemType](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype) | r | Restituisce [SpatialReferenceSystemType.PROJECTED](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/). |
