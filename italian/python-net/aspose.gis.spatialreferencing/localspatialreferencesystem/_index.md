---
title: "Classe LocalSpatialReferenceSystem"
type: docs
weight: 130
url: /it/python-net/aspose.gis.spatialreferencing/localspatialreferencesystem/
---
...
| as_geographic | [GeographicSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/geographicspatialreferencesystem) | r | Restituisce questo SRS convertito in [GeographicSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/geographicspatialreferencesystem/).<br/>            Usa [SpatialReferenceSystem.type](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem/) per scoprire se la conversione è possibile. |
| as_local | [LocalSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/localspatialreferencesystem) | r | Restituisci questo. |
...
| dimensions_count | int | r | Numero di dimensioni in questo SRS. |
...
| geographic_datum | [GeographicDatum](/psd/python-net/aspose.gis.spatialreferencing/geographicdatum) | r | Lancia InvalidOperationException, poiché il Local SRS non ha un datum geografico. |
| has_geographic_datum | bool | r | Restituisce <see langword="false" />, poiché il Local SRS non ha un datum geografico. |
| has_prime_meridian | bool | r | Restituisce <see langword="false" />, poiché il Local SRS non ha il meridiano primario. |
...
| local_datum | [LocalDatum](/psd/python-net/aspose.gis.spatialreferencing/localdatum) | r | Datum che descrive il metodo di misurazione. |
...
| prime_meridian | [PrimeMeridian](/psd/python-net/aspose.gis.spatialreferencing/primemeridian) | r | Lancia InvalidOperationException, poiché il Local SRS non ha il meridiano primario. |
| type | [SpatialReferenceSystemType](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype) | r | Restituisce [SpatialReferenceSystemType.LOCAL](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/). |
| unit | [Unit](/psd/python-net/aspose.gis.spatialreferencing/unit) | r | Unità di questo SRS. |
...
| [get_unit(dimension)](#get_unit_dimension_12) | Ottieni [LocalSpatialReferenceSystem.unit](/psd/python-net/aspose.gis.spatialreferencing/localspatialreferencesystem/) della dimensione. |
...
Ottieni [LocalSpatialReferenceSystem.unit](/psd/python-net/aspose.gis.spatialreferencing/localspatialreferencesystem/) della dimensione.
