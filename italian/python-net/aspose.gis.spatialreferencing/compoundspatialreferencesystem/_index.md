...
type: docs
weight: 30
url: /it/python-net/aspose.gis.spatialreferencing/compoundspatialreferencesystem/
---
...
| :- | :- | :- | :- |
| as_compound | [CompoundSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/compoundspatialreferencesystem) | r | Restituisci questo. |
...
| dimensions_count | int | r | Numero di dimensioni. Per un SRS composto questo è la somma del numero di dimensioni dei SRS sottostanti. |
...
| geographic_datum | [GeographicDatum](/psd/python-net/aspose.gis.spatialreferencing/geographicdatum) | r | Restituisce il datum geografico di questo SRS.<br/>            Se sia [CompoundSpatialReferenceSystem.head](/psd/python-net/aspose.gis.spatialreferencing/compoundspatialreferencesystem/) e [CompoundSpatialReferenceSystem.tail](/psd/python-net/aspose.gis.spatialreferencing/compoundspatialreferencesystem/) hanno un datum geografico - restituisce il datum geografico di head. |
| has_geographic_datum | bool | r | I SRS composti hanno un datum geografico se uno qualsiasi dei SRS sottostanti ha un datum geografico. |
| has_prime_meridian | bool | r | I SRS composti hanno il meridiano primario se uno qualsiasi dei SRS sottostanti ha il meridiano primario. |
| head | [SpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem) | r | Primo SRS sottostante. |
...
| is_compound | bool | r | Restituisce <see langword="true" />. |
...
| prime_meridian | [PrimeMeridian](/psd/python-net/aspose.gis.spatialreferencing/primemeridian) | r | Restituisce il meridiano primario di questo SRS.<br/>            Se sia [CompoundSpatialReferenceSystem.head](/psd/python-net/aspose.gis.spatialreferencing/compoundspatialreferencesystem/) e [CompoundSpatialReferenceSystem.tail](/psd/python-net/aspose.gis.spatialreferencing/compoundspatialreferencesystem/) hanno il meridiano primario - restituisce il meridiano primario di head. |
| tail | [SpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem) | r | Secondo SRS sottostante. |
| type | [SpatialReferenceSystemType](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype) | r | Tipo di questo SRS composto. Può essere [SpatialReferenceSystemType.GEOGRAPHIC](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/) se<br/>            questo SRS composto è una combinazione di SRS geografico e verticale, o [SpatialReferenceSystemType.PROJECTED](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/) se<br/>            questo SRS composto è una combinazione di SRS proiettato e verticale. |
...
| [validate(error_message)](#validate_error_message_18) | Determina se questo SRS è valido. Vedi <see cref=\"M:Aspose.Gis.SpatialReferencing.SpatialReferenceSystem.Validate(string@)\" /> per la descrizione della validità. |
...
Determina se questo SRS è valido. Vedi <see cref=\"M:Aspose.Gis.SpatialReferencing.SpatialReferenceSystem.Validate(string@)\" /> per la descrizione della validità.

**Parameters:**

| Parametro | Tipo | Descrizione |
| :- | :- | :- |
| messaggio_errore | Stringa | Descrizione dell'invalidità (se il risultato è <see langword="false" />) |

**Returns**

| Tipo | Descrizione |
| :- | :- |
| bool | Se questo SRS è valido - <see langword="true" />, altrimenti - <see langword="false" />. |
