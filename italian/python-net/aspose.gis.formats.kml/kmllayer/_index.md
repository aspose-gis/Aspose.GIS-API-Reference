...
type: docs
weight: 140
url: /it/python-net/aspose.gis.formats.kml/kmllayer/
---
...
| driver | [Driver](/psd/python-net/aspose.gis/driver) | r | Ottiene il [KmlLayer.driver](/psd/python-net/aspose.gis.formats.kml/kmllayer/) che ha istanziato questo livello. |
| features | [Feature[]](/psd/python-net/aspose.gis/feature) | r | Ottiene l'elenco delle feature. |
...
| ground_overlay_list | System.Collections.Generic.List<Aspose.Gis.Formats.Kml.SpecificFields.KmlGroundOverlayInfo> | r | Elenco di KmlGroundOverlayInfo dai nodi GroundOverlay |
| network_link_list | System.Collections.Generic.List<Aspose.Gis.Formats.Kml.SpecificFields.KmlNetworkLinkInfo> | r | Elenco di KmlNetworkLinkInfo dai nodi NetworkLink |
| region_list | System.Collections.Generic.List<Aspose.Gis.Formats.Kml.SpecificFields.KmlRegionInfo> | r | Elenco di KmlRegionInfo dai nodi Region |
| spatial_reference_system | [SpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem/) | r | Ottieni il sistema di riferimento spaziale di questo livello. Per KML è sempre WGS84. |
## **Methods**
| **Name** | **Descrizione** |
| :- | :- |
