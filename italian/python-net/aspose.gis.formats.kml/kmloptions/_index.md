...
type: docs
weight: 190
url: /it/python-net/aspose.gis.formats.kml/kmloptions/
---
...
| **Name** | **Descrizione** |
| :- | :- |
| [KmlOptions()](#KmlOptions__1) | Crea una nuova istanza. |
## **Properties**
| **Name** | **Type** | **Access** | **Descrizione** |
| :- | :- | :- | :- |
| altitude_mode | [AltitudeModes](/psd/python-net/aspose.gis.formats.kml/altitudemodes) | r/w | Consente di specificare gli AltitudeModes da utilizzare per le geometrie KML |
...
| document_id | string | r/w | Utilizzato per specificare l'ID del nodo radice 'Document' |
...
| symbol_to_replace_invalid_chars | char | r/w | Determina quale simbolo verrà usato per sostituire i caratteri non validi durante la lettura.<br/>            La sostituzione viene saltata se il valore è '\0'. Per impostazione predefinita il valore è il carattere '\0'. |
