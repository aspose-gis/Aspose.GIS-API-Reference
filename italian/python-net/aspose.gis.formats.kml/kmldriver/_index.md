---
title: "Classe KmlDriver"
type: docs
weight: 50
url: /it/python-net/aspose.gis.formats.kml/kmldriver/
---
...
| [open_as_kml_layer(path, options)](#open_as_kml_layer_path_options_18) | Apre un layer Kml per la lettura. |
...
| :- | :- | :- |
| path | string | Percorso del file. |
| options | [KmlOptions](/psd/python-net/aspose.gis.formats.kml/kmloptions) | Opzioni specifiche del driver. |
...
Apre un layer Kml per la lettura.
...
| Tipo | Descrizione |
| :- | :- |
| [KmlLayer](/psd/python-net/aspose.gis.formats.kml/kmllayer) | KmlLayer con campi specifici |
