---
title: "GmlDriver Classe"
type: docs
weight: 10
url: /it/python-net/aspose.gis.formats.gml/gmldriver/
---
...
| [create_layer(path, options, spatial_reference_system)](#create_layer_path_options_spatial_reference_system_14) | Crea un layer e lo apre per aggiungere nuove feature. |
...
| [open_layer(path)](#open_layer_path_24) | Apre il layer per la lettura. |
...
| [supports_spatial_reference_system(spatial_reference_system)](#supports_spatial_reference_system_spatial_reference_system_29) | Determina se il sistema di riferimento spaziale specificato è supportato dal driver. |
...
| :- | :- | :- |
| path | string | Percorso del file. |
| options | [GmlOptions](/psd/python-net/aspose.gis.formats.gml/gmloptions) | Opzioni specifiche del driver. |
