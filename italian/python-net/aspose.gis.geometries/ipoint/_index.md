...
type: docs
weight: 200
url: /it/python-net/aspose.gis.geometries/ipoint/
---
...
| m | double | r | Restituisce la coordinata m. |
...
| x | double | r | Restituisce la coordinata x. |
| y | double | r | Restituisce la coordinata y. |
| z | double | r | Restituisce la coordinata z. |
## **Methods**
| **Name** | **Descrizione** |
| :- | :- |
