---
title: "Classe MultiSurface"
type: docs
weight: 290
url: /it/python-net/aspose.gis.geometries/multisurface/
---
...
| **Name** | **Descrizione** |
| :- | :- |
| [MultiSurface()](#MultiSurface__1) | Inizializza una nuova istanza della classe [MultiSurface](/psd/python-net/aspose.gis.geometries/multisurface/) . |
## **Properties**
...
Inizializza una nuova istanza della classe [MultiSurface](/psd/python-net/aspose.gis.geometries/multisurface/) .
...
| Tipo | Descrizione |
| :- | :- |
| [MultiSurface](/psd/python-net/aspose.gis.geometries/multisurface) | Una copia modificabile di questa geometria. |
...
| Tipo | Descrizione |
| :- | :- |
| [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon) | Una [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon/) che approssima o è equivalente a questo [IMultiSurface](/psd/python-net/aspose.gis.geometries/imultisurface/).<br/>            Questa è l'equivalente di <DOM Element: class at 0x2a1792e8790>.IMultiSurface.to_linear_geometry()(float) con<br/>            <c>tolerance</c> predefinito. Il valore predefinito di <c>tolerance</c> dipende da [SpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem/)<br/>            di questa geometria:<br/>            <ul><br/>            <li> Per SRS proiettato la tolleranza è 0.001 metri (nelle unità SRS) </li><br/>            <li> Per SRS geografico la tolleranza è <c>1e-5</c> gradi (nelle unità SRS) </li><br/>            <li> Per SRS sconosciuto la tolleranza è <c>1e-5</c> </li><br/>            </ul><br/>            Per maggiori dettagli sulle trasformazioni applicate, fare riferimento alla specifica <DOM Element: class at 0x2a1792e8790>.IMultiSurface.to_linear_geometry()(float). |
...
| Tipo | Descrizione |
| :- | :- |
| [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon) | Una [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon/) che approssima o è equivalente a questo [IMultiSurface](/psd/python-net/aspose.gis.geometries/imultisurface/):<br/>             <ul><br/>             Se questo oggetto è [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon/) stesso, il risultato è equivalente a questo oggetto<br/>             Se questo oggetto non è [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon/) - tutte le superfici sono linearizzate e viene creato un nuovo <c>IMultiPolygon</c><br/>            </ul> |
