...
type: docs
weight: 10
url: /it/python-net/aspose.gis.geometries/circularstring/
---
...
| **Name** | **Descrizione** |
| :- | :- |
| [CircularString()](#CircularString__1) | Inizializza una nuova istanza della classe [CircularString](/psd/python-net/aspose.gis.geometries/circularstring/) . |
| [CircularString(collection)](#CircularString_collection_2) | Inizializza una nuova istanza della classe [CircularString](/psd/python-net/aspose.gis.geometries/circularstring/) . |
| [CircularString(other)](#CircularString_other_3) | Inizializza una nuova istanza della classe [CircularString](/psd/python-net/aspose.gis.geometries/circularstring/) . |
## **Properties**
...
| **Name** | **Descrizione** |
| :- | :- |
| [add_point(point)](#add_point_point_1) | Aggiunge un punto alla fine della stringa circolare. |
| [add_point(x, y)](#add_point_x_y_2) | Aggiunge un punto alla fine della stringa circolare. |
| [add_point(x, y, z)](#add_point_x_y_z_3) | Aggiunge un punto alla fine della stringa circolare. |
| [add_point(x, y, z, m)](#add_point_x_y_z_m_4) | Aggiunge un punto alla fine della stringa circolare. |
...
| reverse() | Inverte l'ordine dei punti in questa [CircularString](/psd/python-net/aspose.gis.geometries/circularstring/) . |
...
Inizializza una nuova istanza della classe [CircularString](/psd/python-net/aspose.gis.geometries/circularstring/) .
...
| Parametro | Tipo | Descrizione |
| :- | :- | :- |
| other | [ICircularString](/psd/python-net/aspose.gis.geometries/icircularstring) | L'altra stringa da cui copiare i dati. |
...
Aggiunge un punto alla fine della stringa circolare.
