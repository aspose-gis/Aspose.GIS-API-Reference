---
title: "Polygon Classe"
type: docs
weight: 310
url: /it/python-net/aspose.gis.geometries/polygon/
---
...
| **Name** | **Descrizione** |
| :- | :- |
| [Polygon()](#Polygon__1) | Inizializza una nuova istanza della classe [Polygon](/psd/python-net/aspose.gis.geometries/polygon/). |
| [Polygon(exterior_ring)](#Polygon_exterior_ring_2) | Inizializza una nuova istanza della classe [Polygon](/psd/python-net/aspose.gis.geometries/polygon/). |
| [Polygon(exterior_ring, interior_rings)](#Polygon_exterior_ring_interior_rings_3) | Inizializza una nuova istanza della classe [Polygon](/psd/python-net/aspose.gis.geometries/polygon/). |
## **Properties**
...
| exterior_ring | [ILinearRing](/psd/python-net/aspose.gis.geometries/ilinearring) | r/w | Ottiene l'anello esterno. |
...
| [get_point_on_surface()](#get_point_on_surface__28) | Trova un punto garantito che si trovi su questo poligono. |
...
Inizializza una nuova istanza della classe [Polygon](/psd/python-net/aspose.gis.geometries/polygon/).
...
| :- | :- | :- |
| exterior_ring | [ILinearRing](/psd/python-net/aspose.gis.geometries/ilinearring) | L'anello esterno. |
...
| :- | :- | :- |
| exterior_ring | [ILinearRing](/psd/python-net/aspose.gis.geometries/ilinearring) | L'anello esterno. |
| interior_rings | System.Collections.Generic.IEnumerable<ILinearRing> | Gli anelli interni. |
...
| Parametro | Tipo | Descrizione |
| :- | :- | :- |
| ring | [ILinearRing](/psd/python-net/aspose.gis.geometries/ilinearring) | L'anello da aggiungere. |
...
Trova un punto garantito che si trovi su questo poligono.

**Returns**

| Tipo | Descrizione |
| :- | :- |
| [IPoint](/psd/python-net/aspose.gis.geometries/ipoint) | Un punto su questo poligono. Un punto vuoto se questo poligono non ha interno. |
