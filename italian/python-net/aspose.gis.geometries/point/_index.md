...
type: docs
weight: 300
url: /it/python-net/aspose.gis.geometries/point/
---
...
| **Name** | **Descrizione** |
| :- | :- |
| [Point()](#Point__1) | Inizializza una nuova istanza della classe [Point](/psd/python-net/aspose.gis.geometries/point/). |
| [Point(other)](#Point_other_2) | Inizializza una nuova istanza della classe [Point](/psd/python-net/aspose.gis.geometries/point/). |
| [Point(x, y)](#Point_x_y_3) | Inizializza una nuova istanza della classe [Point](/psd/python-net/aspose.gis.geometries/point/). |
| [Point(x, y, z)](#Point_x_y_z_4) | Inizializza una nuova istanza della classe [Point](/psd/python-net/aspose.gis.geometries/point/). |
| [Point(x, y, z, m)](#Point_x_y_z_m_5) | Inizializza una nuova istanza della classe [Point](/psd/python-net/aspose.gis.geometries/point/). |
## **Properties**
...
| has_m | bool | r/w | Restituisce un valore che indica se questa istanza ha una coordinata M. |
...
| m | double | r/w | Ottiene o imposta un valore per la coordinata m. |
...
| x | double | r/w | Ottiene o imposta un valore per la coordinata x. |
| y | double | r/w | Ottiene o imposta un valore per la coordinata y. |
| z | double | r/w | Ottiene o imposta un valore per la coordinata z. |
## **Methods**
| **Name** | **Descrizione** |
| :- | :- |
...
| [from_binary(wkb)](#from_binary_wkb_15) | Crea una geometria dalla sua rappresentazione Well-Known Binary. |
| [from_binary(wkb, spatial_reference_system)](#from_binary_wkb_spatial_reference_system_16) | Crea una geometria dalla sua rappresentazione Well-Known Binary. |
| [from_text(wkt)](#from_text_wkt_17) | Crea una geometria dalla sua rappresentazione Well-Known Text. |
| [from_text(wkt, spatial_reference_system)](#from_text_wkt_spatial_reference_system_18) | Crea una geometria dalla sua rappresentazione Well-Known Text. |
| [get_area()](#get_area__19) | Calcola l'area di questa geometria. |
| [get_buffer(distance, quadrant_segments)](#get_buffer_distance_quadrant_segments_20) | Calcola una zona di buffer attorno a questa geometria. |
| [get_centroid()](#get_centroid__21) | Calcola il centroide di questa geometria. |
| [get_convex_hull()](#get_convex_hull__22) | Calcola l'involucro convesso di questa geometria. |
| [get_distance_to(other)](#get_distance_to_other_23) | Calcola la distanza minima tra questa geometria e una geometria specificata. |
| [get_extent()](#get_extent__24) | Calcola e restituisce l'estensione di delimitazione di questa geometria. |
| [get_length()](#get_length__25) | Calcola la lunghezza di questa geometria. |
| [intersection(other)](#intersection_other_26) | Costruisce un'intersezione tra questa geometria e una geometria specificata. |
| [intersects(extent)](#intersects_extent_27) | Determina se questa geometria interseca un'estensione specificata. |
| [intersects(other)](#intersects_other_28) | Determina se questa geometria e una geometria specificata si intersecano. |
| [overlaps(other)](#overlaps_other_29) | Determina se questa geometria si sovrappone a una geometria specificata. |
| [relate(other, intersection_pattern_matrix)](#relate_other_intersection_pattern_matrix_30) | Determina se la matrice di intersezione DE-9IM di questa geometria e una geometria specificata corrisponde al modello fornito. |
| [replace_polygons_by_lines()](#replace_polygons_by_lines__31) | Ottiene i poligoni rappresentati come linee di questa geometria. |
| [round_m(digits)](#round_m_digits_32) | Arrotonda la coordinata M a un numero specificato di cifre frazionarie. |
| [round_xy(digits)](#round_xy_digits_33) | Arrotonda le coordinate X e Y a un numero specificato di cifre frazionarie. |
| [round_z(digits)](#round_z_digits_34) | Arrotonda la coordinata Z a un numero specificato di cifre frazionarie. |
| set_empty() | Rende vuota questa [Geometry](/psd/python-net/aspose.gis.geometries/geometry/). |
| [spatially_contains(other)](#spatially_contains_other_35) | Determina se questa geometria contiene spazialmente una geometria specificata. |
| [spatially_equals(other)](#spatially_equals_other_36) | Determina se questa geometria è spazialmente uguale a una geometria specificata. |
| [sym_difference(other)](#sym_difference_other_37) | Costruisce una differenza simmetrica tra questa geometria e una geometria specificata. |
| [to_editable()](#to_editable__38) | Ottiene una copia modificabile di questa geometria. |
| [to_linear_geometry()](#to_linear_geometry__39) | Ottiene una versione approssimativa o equivalente non curva di questa geometria usando la <c>tolerance</c> predefinita. |
| [to_linear_geometry(tolerance)](#to_linear_geometry_tolerance_40) | Ottiene una versione approssimativa o equivalente non curva di questa geometria usando la <c>tolerance</c> specificata. |
| [to_svg(extent)](#to_svg_extent_41) | Traduce questa geometria nella rappresentazione Svg. |
| [touches(other)](#touches_other_42) | Determina se questa geometria e una geometria specificata si toccano. |
| [union(other)](#union_other_43) | Unisce questa geometria e una geometria specificata. |
| [union(other)](#union_other_44) | Unisce questa geometria e una geometria specificata. |
| [within(extent)](#within_extent_45) | Determina se questa geometria è all'interno di un'estensione specificata. |
| [within(other)](#within_other_46) | Determina se questa geometria è all'interno di una geometria specificata. |
...
Inizializza una nuova istanza della classe [Point](/psd/python-net/aspose.gis.geometries/point/).
...
| :- | :- | :- |
| other | [IPoint](/psd/python-net/aspose.gis.geometries/ipoint) | L'altro [IPoint](/psd/python-net/aspose.gis.geometries/ipoint/) da cui copiare i dati. |
...
| Parametro | Tipo | Descrizione |
| :- | :- | :- |
| distanza | double | La larghezza della zona buffer. |
...
| Tipo | Descrizione |
| :- | :- |
| double | Se entrambe le geometrie non sono [Geometry.is_empty](/psd/python-net/aspose.gis.geometries/geometry/) - una distanza tra i punti più vicini delle geometrie.<br/>            Se almeno una geometria è vuota viene restituito -1. |
...
| Tipo | Descrizione |
| :- | :- |
| [Point](/psd/python-net/aspose.gis.geometries/point) | Una copia modificabile di questa geometria. |
