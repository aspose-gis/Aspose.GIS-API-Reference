---
title: "Geometry Classe"
type: docs
weight: 50
url: /it/python-net/aspose.gis.geometries/geometry/
---
...
| dimension | [GeometryDimension](/psd/python-net/aspose.gis.geometries/geometrydimension) | r | Ottiene la dimensione topologica di questo [Geometry](/psd/python-net/aspose.gis.geometries/geometry/).<br/>            Se la dimensione è sconosciuta (ad es. per una GEOMETRYCOLLECTION vuota) [GeometryDimension.POINT](/psd/python-net/aspose.gis.geometries/geometrydimension/) viene restituita. |
...
| Tipo | Descrizione |
| :- | :- |
| [Geometry](/psd/python-net/aspose.gis.geometries/geometry) | Una copia modificabile di questa geometria. |
