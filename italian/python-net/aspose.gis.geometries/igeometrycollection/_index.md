...
type: docs
weight: 120
url: /it/python-net/aspose.gis.geometries/igeometrycollection/
---
...
| Parametro | Tipo | Descrizione |
| :- | :- | :- |
| tolleranza | double | La <c>tolerance</c> da usare. Il risultato è garantito essere inferiore a <c>tolerance</c> dalla<br/> geometria curva, a meno che il numero di punti necessario per linearizzare la geometria superi il massimo per quadrante,<br/> attualmente pari a 10000 punti. |
