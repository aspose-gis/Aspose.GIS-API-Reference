...
type: docs
weight: 260
url: /it/python-net/aspose.gis.geometries/multilinestring/
---
...
| **Name** | **Descrizione** |
| :- | :- |
| [MultiLineString()](#MultiLineString__1) | Inizializza una nuova istanza della classe [MultiLineString](/psd/python-net/aspose.gis.geometries/multilinestring/). |
## **Properties**
...
| is_closed | bool | r | Determina se questa curva è chiusa. |
...
Inizializza una nuova istanza della classe [MultiLineString](/psd/python-net/aspose.gis.geometries/multilinestring/).
...
| Tipo | Descrizione |
| :- | :- |
| [IMultiLineString](/psd/python-net/aspose.gis.geometries/imultilinestring) | Una [IMultiLineString](/psd/python-net/aspose.gis.geometries/imultilinestring/) che approssima o è equivalente a questo [IMultiCurve](/psd/python-net/aspose.gis.geometries/imulticurve/).<br/>            Questa è l'equivalente di <DOM Element: class at 0x2a179241f70>.IMultiCurve.to_linear_geometry()(float) con<br/>            <c>tolerance</c> predefinito. Il valore predefinito di <c>tolerance</c> dipende da [SpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem/)<br/>            di questa geometria:<br/>            <ul><br/>            <li> Per SRS proiettato la tolleranza è 0.001 metri (nelle unità SRS) </li><br/>            <li> Per SRS geografico la tolleranza è <c>1e-5</c> gradi (nelle unità SRS) </li><br/>            <li> Per SRS sconosciuto la tolleranza è <c>1e-5</c> </li><br/>            </ul><br/>            Per maggiori dettagli sulle trasformazioni applicate, fare riferimento alla specifica <DOM Element: class at 0x2a179241f70>.IMultiCurve.to_linear_geometry()(float). |
...
| Tipo | Descrizione |
| :- | :- |
| [IMultiLineString](/psd/python-net/aspose.gis.geometries/imultilinestring) | Una [IMultiLineString](/psd/python-net/aspose.gis.geometries/imultilinestring/) che approssima o è equivalente a questo [IMultiCurve](/psd/python-net/aspose.gis.geometries/imulticurve/):<br/>             <ul><br/>             Se questo oggetto è [IMultiLineString](/psd/python-net/aspose.gis.geometries/imultilinestring/) stesso, il risultato è equivalente a questo oggetto<br/>             Se questo oggetto non è [IMultiLineString](/psd/python-net/aspose.gis.geometries/imultilinestring/) - tutte le curve sono linearizzate e viene creato un nuovo <c>IMultiLineString</c><br/>            </ul> |
