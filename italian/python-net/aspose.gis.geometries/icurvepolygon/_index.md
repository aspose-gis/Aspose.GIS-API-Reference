...
type: docs
weight: 100
url: /it/python-net/aspose.gis.geometries/icurvepolygon/
---
...
| exterior_ring | [ICurve](/psd/python-net/aspose.gis.geometries/icurve) | r | Ottiene l'anello esterno. |
...
| [get_interior_ring(index)](#get_interior_ring_index_21) | Ottiene l'anello interno per indice. |
| [get_length()](#get_length__22) | Calcola la lunghezza di questa geometria. |
| [get_point_on_surface()](#get_point_on_surface__23) | Trova un punto garantito che si trovi su questa superficie. |
| [intersection(other)](#intersection_other_24) | Costruisce un'intersezione tra questa geometria e una geometria specificata. |
| [intersects(extent)](#intersects_extent_25) | Determina se questa geometria interseca un'estensione specificata. |
| [intersects(other)](#intersects_other_26) | Determina se questa geometria e una geometria specificata si intersecano. |
| [overlaps(other)](#overlaps_other_27) | Determina se questa geometria si sovrappone a una geometria specificata. |
| [relate(other, intersection_pattern_matrix)](#relate_other_intersection_pattern_matrix_28) | Determina se la matrice di intersezione DE-9IM di questa geometria e una geometria specificata corrisponde al modello fornito. |
| [replace_polygons_by_lines()](#replace_polygons_by_lines__29) | Ottiene i poligoni rappresentati come linee di questa geometria. |
| [spatially_contains(other)](#spatially_contains_other_30) | Determina se questa geometria contiene spazialmente una geometria specificata. |
| [spatially_equals(other)](#spatially_equals_other_31) | Determina se questa geometria è spazialmente uguale a una geometria specificata. |
| [sym_difference(other)](#sym_difference_other_32) | Costruisce una differenza simmetrica tra questa geometria e una geometria specificata. |
| [to_editable()](#to_editable__33) | Ottiene una copia modificabile di questa geometria. |
| [to_linear_geometry()](#to_linear_geometry__34) | Ottiene una versione approssimativa o equivalente non curva di questa geometria usando la <c>tolerance</c> predefinita. |
| [to_linear_geometry(tolerance)](#to_linear_geometry_tolerance_35) | Ottiene una versione approssimativa o equivalente non curva di questa geometria usando la <c>tolerance</c> specificata. |
| [touches(other)](#touches_other_36) | Determina se questa geometria e una geometria specificata si toccano. |
| [union(other)](#union_other_37) | Unisce questa geometria e una geometria specificata. |
| [union(other)](#union_other_38) | Unisce questa geometria e una geometria specificata. |
| [within(extent)](#within_extent_39) | Determina se questa geometria è all'interno di un'estensione specificata. |
| [within(other)](#within_other_40) | Determina se questa geometria è all'interno di una geometria specificata. |
...
| Tipo | Descrizione |
| :- | :- |
| [ICurve](/psd/python-net/aspose.gis.geometries/icurve) | Il valore dell'anello interno |
...
Trova un punto garantito che si trovi su questa superficie.

**Returns**

| Tipo | Descrizione |
| :- | :- |
| [IPoint](/psd/python-net/aspose.gis.geometries/ipoint) | Un punto su questa superficie. Un punto vuoto se questa superficie non ha interno. |
...
| Tipo | Descrizione |
| :- | :- |
| [Surface](/psd/python-net/aspose.gis.geometries/surface) | Una copia modificabile di questa geometria. |
