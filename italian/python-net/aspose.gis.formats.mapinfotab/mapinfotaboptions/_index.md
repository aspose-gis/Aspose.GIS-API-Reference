---
title: "MapInfoTabOptions Classe"
type: docs
weight: 20
url: /it/python-net/aspose.gis.formats.mapinfotab/mapinfotaboptions/
---
...
| **Name** | **Descrizione** |
| :- | :- |
| [MapInfoTabOptions()](#MapInfoTabOptions__1) | Crea una nuova istanza. |
## **Properties**
| **Name** | **Type** | **Access** | **Descrizione** |
| :- | :- | :- | :- |
| block_size | int | r/w | Dimensione del blocco per i file '*.map' (multipli di 512). Il valore predefinito è 16384. Valori validi: da 512 a 32256. |
...
| is_ignore_wrong_data | bool | r/w | Determina se lanciare un'eccezione durante il lavoro con dati errati o impostare i valori predefiniti. |
