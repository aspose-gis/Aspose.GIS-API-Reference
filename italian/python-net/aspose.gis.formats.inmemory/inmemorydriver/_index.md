---
title: "Classe InMemoryDriver"
type: docs
weight: 10
url: /it/python-net/aspose.gis.formats.inmemory/inmemorydriver/
---
...
| [create_layer()](#create_layer__5) | Crea un layer e lo apre per aggiungere nuove feature. |
| [create_layer(features_sequence)](#create_layer_features_sequence_6) | Crea un layer dalla sequenza di feature e lo apre per aggiungere nuove feature. |
...
| [create_layer(path, options)](#create_layer_path_options_9) | Crea il livello e lo apre per l'aggiunta. |
| [create_layer(path, options)](#create_layer_path_options_10) | Crea il livello e lo apre per l'aggiunta. |
...
| [create_layer(path, spatial_reference_system)](#create_layer_path_spatial_reference_system_13) | Crea il livello e lo apre per l'aggiunta. |
...
| [create_layer(spatial_reference_system)](#create_layer_spatial_reference_system_15) | Crea un layer e lo apre per aggiungere nuove feature. |
...
| [supports_spatial_reference_system(spatial_reference_system)](#supports_spatial_reference_system_spatial_reference_system_26) | Determina se il sistema di riferimento spaziale specificato è supportato dal driver. |
...
Crea un layer dalla sequenza di feature e lo apre per aggiungere nuove feature.
