...
type: docs
weight: 10
url: /it/python-net/aspose.gis.formats.gdal/gdaldriver/
---
...
| [create_layer(path, options, spatial_reference_system)](#create_layer_path_options_spatial_reference_system_9) | Crea un layer e lo apre per aggiungere nuove feature. |
| [create_layer(path, options, spatial_reference_system)](#create_layer_path_options_spatial_reference_system_10) | Crea un layer e lo apre per aggiungere nuove feature. |
...
| [open_layer(path)](#open_layer_path_19) | Apre il layer per la lettura. |
| [open_layer(path)](#open_layer_path_20) | Apre il layer per la lettura. |
| [open_layer(path, options)](#open_layer_path_options_21) | Apre un layer per la lettura. |
| [open_layer(path, options)](#open_layer_path_options_22) | Apre un layer per la lettura. |
| [open_layer(path, options)](#open_layer_path_options_23) | Apre un layer per la lettura. |
...
| :- | :- | :- |
| path | string | Percorso del file. |
| options | [GdalOptions](/psd/python-net/aspose.gis.formats.gdal/gdaloptions) | Opzioni specifiche del driver. |
