---
title: "FileGdbOptions Classe"
type: docs
weight: 30
url: /it/python-net/aspose.gis.formats.filegdb/filegdboptions/
---
...
| **Name** | **Descrizione** |
| :- | :- |
| [FileGdbOptions()](#FileGdbOptions__1) | Crea una nuova istanza. |
## **Properties**
...
| coordinate_precision_grid | [FileGdbCoordinatePrecisionGrid](/psd/python-net/aspose.gis.formats.filegdb/filegdbcoordinateprecisiongrid) | r/w | Una griglia di precisione delle coordinate da utilizzare nel nuovo layer. |
...
| ensure_valid_coordinates_range | bool | r/w | Indica se le coordinate devono trovarsi in un intervallo valido. |
| expected_geometry_type | Nullable<Aspose.Gis.Geometries.GeometryType> | r/w | Tipo di geometria previsto per il layer. Se questa opzione è impostata, consentiamo l'aggiunta solo di geometrie di questo tipo. |
| geometry_field_name | string | r/w | Nome del campo geometria. |
| has_m | bool | r/w | Le geometrie del layer possono avere la coordinata 'm'. Per impostazione predefinita è true. |
| has_z | bool | r/w | Le geometrie del layer possono avere la coordinata 'z'. Per impostazione predefinita è true. |
...
| m_tolerance | Nullable<double> | r/w | Tolleranza di snap M. |
| object_id_field_name | string | r/w | Nome del campo ID dell'oggetto. |
...
| xy_tolerance | Nullable<double> | r/w | Tolleranza di snap X e Y. |
...
| z_tolerance | Nullable<double> | r/w | Tolleranza di snap Z. |
