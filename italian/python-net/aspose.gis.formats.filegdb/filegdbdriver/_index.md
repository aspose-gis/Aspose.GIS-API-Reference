...
type: docs
weight: 20
url: /it/python-net/aspose.gis.formats.filegdb/filegdbdriver/
---
...
| [create_dataset(path, options)](#create_dataset_path_options_5) | Crea un set di dati. |
| [create_dataset(path, options)](#create_dataset_path_options_6) | Crea un set di dati. |
| [create_layer(path)](#create_layer_path_7) | Crea il livello e lo apre per l'aggiunta. |
| [create_layer(path)](#create_layer_path_8) | Crea il livello e lo apre per l'aggiunta. |
...
| [create_layer(path, options)](#create_layer_path_options_11) | Crea un layer e lo apre per aggiungere nuove feature. |
| [create_layer(path, options, spatial_reference_system)](#create_layer_path_options_spatial_reference_system_12) | Crea un layer e lo apre per l'aggiunta. |
| [create_layer(path, options, spatial_reference_system)](#create_layer_path_options_spatial_reference_system_13) | Crea un layer e lo apre per l'aggiunta. |
| [create_layer(path, options, spatial_reference_system)](#create_layer_path_options_spatial_reference_system_14) | Crea un layer e lo apre per l'aggiunta. |
| [create_layer(path, options, spatial_reference_system)](#create_layer_path_options_spatial_reference_system_15) | Crea un layer e lo apre per l'aggiunta. |
| [create_layer(path, spatial_reference_system)](#create_layer_path_spatial_reference_system_16) | Crea il livello e lo apre per l'aggiunta. |
| [create_layer(path, spatial_reference_system)](#create_layer_path_spatial_reference_system_17) | Crea il livello e lo apre per l'aggiunta. |
| [edit_layer(path, options)](#edit_layer_path_options_18) | Apre un layer per la modifica. |
| [edit_layer(path, options)](#edit_layer_path_options_19) | Apre un layer per la modifica. |
| [open_dataset(path)](#open_dataset_path_20) | Apre il dataset. |
| [open_dataset(path)](#open_dataset_path_21) | Apre il dataset. |
| [open_dataset(path, options)](#open_dataset_path_options_22) | Apre il dataset. |
| [open_dataset(path, options)](#open_dataset_path_options_23) | Apre il dataset. |
| [open_dataset(path, options)](#open_dataset_path_options_24) | Apre il dataset. |
| [open_dataset(path, options)](#open_dataset_path_options_25) | Apre il dataset. |
| [open_layer(path)](#open_layer_path_26) | Apre il layer per la lettura. |
| [open_layer(path)](#open_layer_path_27) | Apre il layer per la lettura. |
| [open_layer(path, options)](#open_layer_path_options_28) | Apre un layer per la lettura. |
| [open_layer(path, options)](#open_layer_path_options_29) | Apre un layer per la lettura. |
| [open_layer(path, options)](#open_layer_path_options_30) | Apre un layer per la lettura. |
| [open_layer(path, options)](#open_layer_path_options_31) | Apre un layer per la lettura. |
| [supports_spatial_reference_system(spatial_reference_system)](#supports_spatial_reference_system_spatial_reference_system_32) | Determina se il sistema di riferimento spaziale specificato è supportato dal driver. |
...
| :- | :- | :- |
| path | string | Percorso del dataset. |
| options | [FileGdbOptions](/psd/python-net/aspose.gis.formats.filegdb/filegdboptions) | Opzioni specifiche del driver. |
...
Crea un layer e lo apre per l'aggiunta.
