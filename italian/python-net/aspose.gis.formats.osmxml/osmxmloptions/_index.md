...
type: docs
weight: 20
url: /it/python-net/aspose.gis.formats.osmxml/osmxmloptions/
---
...
| **Name** | **Descrizione** |
| :- | :- |
| [OsmXmlOptions()](#OsmXmlOptions__1) | Crea una nuova istanza. |
## **Properties**
...
| report_all_nodes | bool | r/w | Riporta tutti i nodi come feature, anche se non hanno tag significativi. |
| report_all_ways | bool | r/w | Riporta tutti i percorsi come feature, anche se non hanno tag significativi o non hanno nodi. |
| report_common_attributes | bool | r/w | Riporta gli attributi OSM comuni: visible, version, changeset, timestamp, user e uid.<br/>            Gli attributi comuni saranno riportati come attributi della feature con prefisso "osm_", ad esempio osm_user, osm_timestamp, ecc. |
...
| write_common_attributes | bool | r/w | Scrivi gli attributi OSM comuni: visible, version, changeset, timestamp, user e uid. |
