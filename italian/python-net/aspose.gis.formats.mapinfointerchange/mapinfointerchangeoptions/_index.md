---
title: "Classe MapInfoInterchangeOptions"
type: docs
weight: 20
url: /it/python-net/aspose.gis.formats.mapinfointerchange/mapinfointerchangeoptions/
---
...
| **Name** | **Descrizione** |
| :- | :- |
| [MapInfoInterchangeOptions()](#MapInfoInterchangeOptions__1) | Crea una nuova istanza. |
## **Properties**
| **Name** | **Type** | **Access** | **Descrizione** |
| :- | :- | :- | :- |
| set di caratteri | string | r/w | Determina il set di caratteri, per impostazione predefinita è Neutral |
...
| delimitatore | string | r/w | Determina il delimitatore per gli attributi nel file mid, per impostazione predefinita è il carattere di tabulazione. |
...
| text_string_attribute | string | r/w | Specifica il nome dell'attributo che rappresenta il testo dell'oggetto grafico 'Text'. |
