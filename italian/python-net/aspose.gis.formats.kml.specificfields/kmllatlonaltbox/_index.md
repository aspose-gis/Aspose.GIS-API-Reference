---
title: "Classe KmlLatLonAltBox"
type: docs
weight: 30
url: /it/python-net/aspose.gis.formats.kml.specificfields/kmllatlonaltbox/
---
...
| est | double | r/w | Est del nodo 'LatLonBox'. |
...
| nord | double | r/w | Nord del nodo 'LatLonBox'. |
| prefisso | string | r | Restituisce il prefisso. |
| rotazione | Nullable<double> | r/w | Rotazione del nodo 'LatLonBox'. |
| sud | double | r/w | Sud del nodo 'LatLonBox'. |
| ovest | double | r/w | Ovest del nodo 'LatLonBox'. |
## **Methods**
| **Name** | **Descrizione** |
| :- | :- |
