---
title: "Classe KmlGroundOverlayInfo"
type: docs
weight: 20
url: /it/python-net/aspose.gis.formats.kml.specificfields/kmlgroundoverlayinfo/
---
...
| lat_lon_box | [KmlLatLonBox](/psd/python-net/aspose.gis.formats.kml.specificfields/kmllatlonbox) | r/w | Specifica l'oggetto dal nodo Kml 'LatLonAltBox'. |
| nome | string | r/w | Nome del Ground Overlay |
...
| visibility | bool | r/w | Visibilità del Ground Overlay |
## **Methods**
| **Name** | **Descrizione** |
| :- | :- |
