...
description: Aspose.Gis.Formats.Shapefile.ShapefileOptions classe. Opzioni specifiche del driver per il formato Shapefile. Al momento il driver non fornisce opzioni personalizzabili.
type: docs
weight: 670
url: /it/net/aspose.gis.formats.shapefile/shapefileoptions/
---
## ShapefileOptions class

Opzioni specifiche del driver per il formato Shapefile. Al momento, il driver non fornisce opzioni personalizzabili.
...
| Nome | Descrizione |
| --- | --- |
| [ShapefileOptions](shapefileoptions/)() | Crea nuova istanza. |
