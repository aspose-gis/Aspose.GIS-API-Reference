...
| Nome | Descrizione |
| --- | --- |
| [CurvePolygon](curvepolygon#constructor)() | Inizializza una nuova istanza di[`CurvePolygon`](../curvepolygon) classe. |
| [CurvePolygon](curvepolygon#constructor_1)(ICurve) | Inizializza una nuova istanza di[`CurvePolygon`](../curvepolygon) classe. |
| [CurvePolygon](curvepolygon#constructor_2)(ICurve, IEnumerable&lt;ICurve&gt;) | Inizializza una nuova istanza di[`CurvePolygon`](../curvepolygon) classe. |
...
| override [GeometryType](../../aspose.gis.geometries/curvepolygon/geometrytype) { get; } | Ottiene il tipo della geometria. |
| override [HasCurveGeometry](../../aspose.gis.geometries/curvepolygon/hascurvegeometry) { get; } | Ottiene un valore che indica se questa geometria è o contiene una geometria curva (non lineare). |
| [HasM](../../aspose.gis.geometries/curvepolygon/hasm) { get; set; } | Ottiene un valore che indica se questa istanza ha la coordinata M. |
| [HasZ](../../aspose.gis.geometries/curvepolygon/hasz) { get; set; } | Ottiene un valore che indica se questa istanza ha la coordinata Z. |
| [InteriorRingsCount](../../aspose.gis.geometries/curvepolygon/interiorringscount) { get; } | Ottiene il numero di anelli interni. |
...
| override [GetHashCode](../../aspose.gis.geometries/curvepolygon/gethashcode)() | Serve come funzione hash predefinita. |
...
| override [GetPointOnSurface](../../aspose.gis.geometries/curvepolygon/getpointonsurface)() | Trova un punto che si trova su questo poligono curvo. |
