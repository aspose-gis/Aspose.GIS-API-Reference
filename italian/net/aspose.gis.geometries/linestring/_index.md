...
description: Una linea multivertice.
type: docs
weight: 1020
url: /it/net/aspose.gis.geometries/linestring/
---
## LineString class

Una linea multi-vertice.
...
| Nome | Descrizione |
| --- | --- |
| [LineString](linestring#constructor)() | Inizializza una nuova istanza di[`LineString`](../linestring) classe. |
| [LineString](linestring#constructor_2)(IEnumerable&lt;IPoint&gt;) | Inizializza una nuova istanza di[`LineString`](../linestring) classe. |
| [LineString](linestring#constructor_1)(ILineString) | Inizializza una nuova istanza di[`LineString`](../linestring) classe. |
...
| [Count](../../aspose.gis.geometries/linestring/count) { get; } | Ottiene il numero di punti nel file[`LineString`](../linestring) . |
...
| override [GeometryType](../../aspose.gis.geometries/linestring/geometrytype) { get; } | Ottiene il tipo della geometria. |
...
| [HasM](../../aspose.gis.geometries/linestring/hasm) { get; set; } | Ottiene un valore che indica se questa istanza ha la coordinata M. |
...
| Nome | Descrizione |
| --- | --- |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint#addpoint)(IPoint) | Aggiunge un punto alla fine della linea. |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint#addpoint_1)(double, double) | Aggiunge un punto alla fine della linea. |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint#addpoint_2)(double, double, double) | Aggiunge un punto alla fine della linea. |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint#addpoint_3)(double, double, double, double) | Aggiunge un punto alla fine della linea. |
...
| override [Clone](../../aspose.gis.geometries/linestring/clone)() | Clona questa istanza. |
...
| [Equals](../../aspose.gis.geometries/linestring/equals#equals)(ILineString) | Indica se l'oggetto corrente è uguale a un altro oggetto dello stesso tipo. |
| override [Equals](../../aspose.gis.geometries/linestring/equals#equals_1)(object) | Determina se l'oggetto specificato è uguale all'oggetto corrente. |
...
| override [GetHashCode](../../aspose.gis.geometries/linestring/gethashcode)() | Serve come funzione hash predefinita. |
...
| [ToEditable](../../aspose.gis.geometries/linestring/toeditable#toeditable_2)() | Ottiene una copia modificabile di questa geometria. (3 methods) |
...
| [operator ==](../../aspose.gis.geometries/linestring/op_equality) | Implementa l'operatore ==. |
| [operator !=](../../aspose.gis.geometries/linestring/op_inequality) | Implementa l'operatore !=. |
