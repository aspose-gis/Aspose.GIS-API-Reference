...
description: Aspose.Gis.Geometries.LineString classe. Una linea multivertice.
type: docs
weight: 1120
...
| Nome | Descrizione |
| --- | --- |
| [LineString](linestring/#constructor)() | Inizializza una nuova istanza di`LineString` classe. |
| [LineString](linestring/#constructor_2)(IEnumerable&lt;IPoint&gt;) | Inizializza una nuova istanza di`LineString` classe. |
| [LineString](linestring/#constructor_1)(ILineString) | Inizializza una nuova istanza di`LineString` classe. |
...
| [Count](../../aspose.gis.geometries/linestring/count/) { get; } | Ottiene il numero di punti in`LineString` . |
...
| override [GeometryType](../../aspose.gis.geometries/linestring/geometrytype/) { get; } | Ottiene il tipo di geometria. |
...
| Nome | Descrizione |
| --- | --- |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint/#addpoint)(IPoint) | Aggiunge un punto alla fine della riga. |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint/#addpoint_1)(double, double) | Aggiunge un punto alla fine della riga. |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint/#addpoint_2)(double, double, double) | Aggiunge un punto alla fine della riga. |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint/#addpoint_3)(double, double, double, double) | Aggiunge un punto alla fine della riga. |
...
| override [Reverse](../../aspose.gis.geometries/linestring/reverse/)() | Inverte l'ordine dei punti in questo`LineString` . |
