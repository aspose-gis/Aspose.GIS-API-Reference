...
description: Aspose.Gis.Geometries.MultiPoint classe. AMultiPoint è unidimensionaleGeometryCollection i cui elementi sonoPoint s.
type: docs
weight: 1160
...
A`MultiPoint` è unidimensionale[`GeometryCollection`](../geometrycollection/) i cui elementi sono[`Point`](../point/) s.
...
| Nome | Descrizione |
| --- | --- |
| [MultiPoint](multipoint/)() | Inizializza una nuova istanza di`MultiPoint` classe. |
...
| [Dimension](../../aspose.gis.geometries/multipoint/dimension/) { get; } | Ottiene la dimensione topologica di this[`Geometry`](../geometry/) . |
| override [GeometryType](../../aspose.gis.geometries/multipoint/geometrytype/) { get; } | Ottiene il tipo di geometria. |
...
| [ToLinearGeometry](../../aspose.gis.geometries/geometrycollection/tolineargeometry/)(double) | Ottiene una versione non curva approssimativa o equivalente di questa geometria utilizzando l'oggetto specificato`tolleranza` . (2 methods) |
