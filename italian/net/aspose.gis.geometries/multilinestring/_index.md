...
description: Aspose.Gis.Geometries.MultiLineString classe. AMultiLineString è unidimensionaleGeometryCollection i cui elementi sonoLineString s.
type: docs
weight: 1150
...
A`MultiLineString` è unidimensionale[`GeometryCollection`](../geometrycollection/) i cui elementi sono[`LineString`](../linestring/) s.
...
| Nome | Descrizione |
| --- | --- |
| [MultiLineString](multilinestring/)() | Inizializza una nuova istanza di`MultiLineString` classe. |
...
| override [GeometryType](../../aspose.gis.geometries/multilinestring/geometrytype/) { get; } | Ottiene il tipo di geometria. |
...
| [ToLinearGeometry](../../aspose.gis.geometries/multicurve/tolineargeometry/)(double) | Ottiene una versione non curva approssimativa o equivalente di questa geometria utilizzando l'oggetto specificato`tolleranza` . (3 methods) |
