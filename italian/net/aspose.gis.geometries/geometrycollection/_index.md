...
description: AGeometryCollection./geometrycollection è unGeometry./geometry ovvero una raccolta di una o più geometrie.
type: docs
weight: 830
url: /it/net/aspose.gis.geometries/geometrycollection/
---
## GeometryCollection class

A[`GeometryCollection`](../geometrycollection) è un[`Geometry`](../geometry) ovvero una raccolta di una o più geometrie.
...
| Nome | Descrizione |
| --- | --- |
| [GeometryCollection](geometrycollection)() | Inizializza una nuova istanza di[`GeometryCollection`](../geometrycollection) classe. |
...
| override [Dimension](../../aspose.gis.geometries/geometrycollection/dimension) { get; } | Ottiene la dimensione topologica di questo[`Geometry`](../geometry) . Se la raccolta è vuota,Point viene restituito. |
| override [GeometryType](../../aspose.gis.geometries/geometrycollection/geometrytype) { get; } | Ottiene il tipo della geometria. |
...
| override [Clone](../../aspose.gis.geometries/geometrycollection/clone)() | Clona questa istanza. |
...
| [Equals](../../aspose.gis.geometries/geometrycollection/equals#equals)(IGeometryCollection) | Indica se l'oggetto corrente è uguale a un altro oggetto dello stesso tipo. |
| override [Equals](../../aspose.gis.geometries/geometrycollection/equals#equals_1)(object) | Determina se l'oggetto specificato è uguale all'oggetto corrente. |
...
| [ReplacePolygonsByLines](../../aspose.gis.geometries/geometrycollection/replacepolygonsbylines#replacepolygonsbylines_1)() | Ottiene i poligoni rappresentati come linee di questa geometria. (2 methods) |
...
| [ToEditable](../../aspose.gis.geometries/geometrycollection/toeditable#toeditable_1)() | Ottiene una copia modificabile di questa geometria. (2 methods) |
| [ToEditable&lt;T&gt;](../../aspose.gis.geometries/geometry/toeditable)() | Ottiene una copia modificabile di questa geometria. |
| [ToLinearGeometry](../../aspose.gis.geometries/geometrycollection/tolineargeometry#tolineargeometry_2)() | Ottiene una versione non curva approssimativa o equivalente di questa geometria utilizzando l'impostazione predefinita`tolleranza` . (2 methods) |
| [ToLinearGeometry](../../aspose.gis.geometries/geometrycollection/tolineargeometry#tolineargeometry_3)(double) | Ottiene una versione non curva approssimativa o equivalente di questa geometria utilizzando l'elemento specificato`tolleranza` . (2 methods) |
...
| [operator ==](../../aspose.gis.geometries/geometrycollection/op_equality) | Implementa l'operatore ==. |
| [operator !=](../../aspose.gis.geometries/geometrycollection/op_inequality) | Implementa l'operatore !=. |
