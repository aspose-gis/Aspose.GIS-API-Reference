...
description: ACurve./curve è una sequenza di punti.
type: docs
weight: 800
...
A[`Curve`](../curve) è una sequenza di punti.
...
| [ToLinearGeometry](../../aspose.gis.geometries/curve/tolineargeometry#tolineargeometry_3)(double) | Ottiene una versione non curva approssimativa o equivalente di questa geometria utilizzando l'elemento specificato`tolleranza` . (2 methods) |
