...
description: Aspose.Gis.Geometries.CompoundCurve classe. Una curva che rappresenta una sequenza di curve contigue in modo tale che le curve adiacenti siano unite ai loro punti finali.
type: docs
weight: 890
...
| Nome | Descrizione |
| --- | --- |
| [CompoundCurve](compoundcurve/#constructor)() | Inizializza una nuova istanza di`CompoundCurve` classe. |
| [CompoundCurve](compoundcurve/#constructor_1)(ICompoundCurve) | Inizializza una nuova istanza di`CompoundCurve` classe. |
| [CompoundCurve](compoundcurve/#constructor_2)(IEnumerable&lt;ICurve&gt;) | Inizializza una nuova istanza di`CompoundCurve` classe. |
...
| [Count](../../aspose.gis.geometries/compoundcurve/count/) { get; } | Ottiene il numero di curve nel file[`ICompoundCurve`](../icompoundcurve/) . |
...
| override [GeometryType](../../aspose.gis.geometries/compoundcurve/geometrytype/) { get; } | Ottiene il tipo di geometria. |
| override [HasCurveGeometry](../../aspose.gis.geometries/compoundcurve/hascurvegeometry/) { get; } | Ottiene un valore che indica se questa geometria è o contiene geometria curva (non lineare). |
| [HasM](../../aspose.gis.geometries/compoundcurve/hasm/) { get; set; } | Ottiene un valore che indica se questa istanza ha coordinate M. |
...
| Nome | Descrizione |
| --- | --- |
| [AddCurve](../../aspose.gis.geometries/compoundcurve/addcurve/)(ICurve) | Aggiunge una curva alla fine di questo`CompoundCurve` . |
...
| override [GetHashCode](../../aspose.gis.geometries/compoundcurve/gethashcode/)() | Funge da funzione hash predefinita. |
...
| override [Reverse](../../aspose.gis.geometries/compoundcurve/reverse/)() | Inverte questo`CompoundCurve` . Cioè - ordine inverso delle curve e ogni curva all'interno di questa curva composta. |
