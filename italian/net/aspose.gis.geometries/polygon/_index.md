...
description: Aspose.Gis.Geometries.Polygon classe. APolygon è una superficie planare definita da 1 confine esterno e 0 o più confini interni.
type: docs
weight: 1200
...
A`Polygon` è una superficie planare, definita da 1 confine esterno e 0 o più confini interni.
...
| Nome | Descrizione |
| --- | --- |
| [Polygon](polygon/#constructor)() | Inizializza una nuova istanza di`Polygon` classe. |
| [Polygon](polygon/#constructor_1)(ILinearRing) | Inizializza una nuova istanza di`Polygon` classe. |
| [Polygon](polygon/#constructor_2)(ILinearRing, IEnumerable&lt;ILinearRing&gt;) | Inizializza una nuova istanza di`Polygon` classe. |
...
| override [GeometryType](../../aspose.gis.geometries/polygon/geometrytype/) { get; } | Ottiene il tipo di geometria. |
...
| override [HasM](../../aspose.gis.geometries/polygon/hasm/) { get; set; } | Ottiene un valore che indica se questa istanza ha coordinate M. |
...
| [InteriorRingsCount](../../aspose.gis.geometries/polygon/interiorringscount/) { get; } | Ottiene il numero di squilli interni. |
...
| override [GetHashCode](../../aspose.gis.geometries/polygon/gethashcode/)() | Funge da funzione hash predefinita. |
...
| override [GetPointOnSurface](../../aspose.gis.geometries/polygon/getpointonsurface/)() | Trova un punto che è garantito essere su questo poligono. |
