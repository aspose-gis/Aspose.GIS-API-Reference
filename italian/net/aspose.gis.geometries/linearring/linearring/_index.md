...
description: LinearRing costruttore. Inizializza una nuova istanza diLinearRing classe.
type: docs
weight: 10
...
Inizializza una nuova istanza di[`LinearRing`](../) classe.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| collection | IEnumerable`1 | La raccolta punti. |
