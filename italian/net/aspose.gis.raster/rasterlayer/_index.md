...
description: Rappresenta un livello raster.
type: docs
weight: 1290
...
| abstract [CellSize](../../aspose.gis.raster/rasterlayer/cellsize) { get; } | Ottiene la dimensione della cella o del pixel del raster. |
...
| abstract [SpatialReferenceSystem](../../aspose.gis.raster/rasterlayer/spatialreferencesystem) { get; } | Ottiene un sistema di riferimento spaziale di raster. Può essere`null` se è sconosciuto. |
...
| Nome | Descrizione |
| --- | --- |
| [Crop](../../aspose.gis.raster/rasterlayer/crop)(IGeometry) | Ritaglia il livello raster usando una forma. |
| [Dispose](../../aspose.gis.raster/rasterlayer/dispose)() | Rilascia le risorse utilizzate dal[`RasterLayer`](../rasterlayer) . |
| abstract [GetBand](../../aspose.gis.raster/rasterlayer/getband)(int) | Ottiene una banda dall'indice specificato. |
| virtual [GetExtent](../../aspose.gis.raster/rasterlayer/getextent)() | Calcola un'estensione spaziale di questo livello. |
...
| [GetStatistics](../../aspose.gis.raster/rasterlayer/getstatistics)(int, bool) | Calcola statistiche riassuntive composte da conteggio, somma, media, min, max. |
...
| [Warp](../../aspose.gis.raster/rasterlayer/warp)(WarpOptions) | Trasforma il livello raster in un altro. |
