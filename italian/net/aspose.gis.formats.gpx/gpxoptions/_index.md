...
description: Aspose.Gis.Formats.Gpx.GpxOptions classe. Opzioni specifiche del driver per il formato GPX.
type: docs
weight: 370
...
| [MAttribute](../../aspose.gis.formats.gpx/gpxoptions/mattribute/) { get; set; } | Determina quale attributo GPX verrà esportato come coordinata 'M' di waypoint, punti di rotta e punti di traccia. Il comportamento è lo stesso con[`ZAttribute`](./zattribute/) , l'impostazione predefinita è`null` . |
...
| [NestedAttributeSeparator](../../aspose.gis.formats.gpx/gpxoptions/nestedattributeseparator/) { get; } | Una stringa per separare il nome dell'attributo nidificato e i relativi indici. L'impostazione predefinita è il doppio carattere di sottolineatura "__". |
