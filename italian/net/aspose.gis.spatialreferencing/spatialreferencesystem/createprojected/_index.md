...
description: SpatialReferenceSystem metodo. Crea SRS proiettato da parametri personalizzati.
type: docs
weight: 380
...
| --- | --- |
| InvalidOperationException | L'SRS di base nei parametri è`null` . Il metodo di proiezione nei parametri è`null` . |
