...
description: Il dato geografico mette in relazione longitudine e latitudine con un luogo particolare sulla terra.
type: docs
weight: 2020
...
Il dato geografico mette in relazione longitudine e latitudine con un luogo particolare sulla terra.
...
| static [Nad83](../../aspose.gis.spatialreferencing/geographicdatum/nad83) { get; } | Datum NAD 83. |
| static [Osgb36](../../aspose.gis.spatialreferencing/geographicdatum/osgb36) { get; } | Datum OSGB 1936. |
| static [Wgs72](../../aspose.gis.spatialreferencing/geographicdatum/wgs72) { get; } | Datum WGS 72. |
| static [Wgs84](../../aspose.gis.spatialreferencing/geographicdatum/wgs84) { get; } | Datum WGS 84. |
...
| [ToWgs84Parameters](../../aspose.gis.spatialreferencing/geographicdatum/towgs84parameters) { get; } | BursaWolfParamters che possono essere utilizzati per trasformare le coordinate in questo datum in coordinate nel datum WGS84. |
