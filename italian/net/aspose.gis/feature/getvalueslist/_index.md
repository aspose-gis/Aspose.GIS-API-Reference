...
description: Ottiene i valori di una sequenza di attributi sotto forma di elenco.
type: docs
weight: 70
...
Ottiene i valori di una sequenza di attributi sotto forma di elenco.
...
Elenco dei valori degli attributi i cui nomi sono diversi in base al valore dell'indice di sequenza.
...
Questo utilizza[`GetValue`](../getvalue) per ottenere un valore unico. Quindi, questo metodo converte automaticamente il valore nel tipo richiesto nel parametro di tipo generico.  Se l'attributo con indice 0 non viene trovato, verrà generatoArgumentException .
