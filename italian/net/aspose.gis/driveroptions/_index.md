...
description: Aspose.Gis.DriverOptions classe. Opzioni per aDriver .
type: docs
weight: 100
url: /it/net/aspose.gis/driveroptions/
---
## DriverOptions class

Opzioni per a[`Driver`](../driver/) .
...
| [DeleteNearPointsDistance](../../aspose.gis/driveroptions/deletenearpointsdistance/) { get; set; } | Determina la distanza per[`DeleteNearPoints`](./deletenearpoints/) . L'impostazione predefinita è`0` . |
...
| [SimplifySegmentsDistance](../../aspose.gis/driveroptions/simplifysegmentsdistance/) { get; set; } | Determina la distanza per[`SimplifySegments`](./simplifysegments/) . L'impostazione predefinita è`0` . |
