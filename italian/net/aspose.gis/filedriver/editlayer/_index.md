...
Il driver crea uno strato interno con tutte le funzionalità. Ma abbiamo la possibilità di utilizzare lo spazio su disco invece della RAM. Esistono driver per un uso più ottimale delle risorse (consultare la documentazione specifica del driver). Inoltre il driver può modificare un livello Se può creare e aprire i livelli.
