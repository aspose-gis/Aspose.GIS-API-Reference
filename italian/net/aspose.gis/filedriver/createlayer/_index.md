...
description: FileDriver metodo. Crea il livello e lo apre per laggiunta.
type: docs
weight: 60
...
| NotSupportedException | Il driver non può creare layer vettoriali (vedi[`CanCreateLayers`](../cancreatelayers/)). |
