...
description: Restituisce la posizione calcolata come stringa nel formato specificato.
type: docs
weight: 10
url: /it/net/aspose.gis/geoconvert/aspointtext/
---
...
| --- | --- | --- |
| latitude | Double | Posizione latitudine. |
| longitude | Double | Longitudine di posizione. |
| format | PointFormats | Formato del risultato. |

### Valore di ritorno

Posiziona come stringa.
