...
description: Aspose.Gis.Formats.Csv.CsvOptions classe. Opzioni specifiche del driver per il formato CSV.
type: docs
weight: 200
...
| [ColumnM](../../aspose.gis.formats.csv/csvoptions/columnm/) { get; set; } | Ottiene o imposta un nome di colonna che contiene il valore della coordinata M. Il valore predefinito è`null` . |
| [ColumnWkt](../../aspose.gis.formats.csv/csvoptions/columnwkt/) { get; set; } | Ottiene o imposta il nome di una colonna contenente testo noto per rappresentare la geometria. Il valore predefinito è`null` . |
| [ColumnX](../../aspose.gis.formats.csv/csvoptions/columnx/) { get; set; } | Ottiene o imposta un nome di colonna che contiene il valore della coordinata X. Il valore predefinito è`null` . |
| [ColumnY](../../aspose.gis.formats.csv/csvoptions/columny/) { get; set; } | Ottiene o imposta un nome di colonna che contiene il valore della coordinata Y. Il valore predefinito è`null` . |
| [ColumnZ](../../aspose.gis.formats.csv/csvoptions/columnz/) { get; set; } | Ottiene o imposta un nome di colonna che contiene il valore della coordinata Z. Il valore predefinito è`null` . |
...
| [Delimiter](../../aspose.gis.formats.csv/csvoptions/delimiter/) { get; set; } | Ottiene o imposta un carattere utilizzato come delimitatore per separare i valori. Il valore predefinito è ','. |
| [DoubleQuoteEscape](../../aspose.gis.formats.csv/csvoptions/doublequoteescape/) { get; set; } | Recupera o imposta un carattere utilizzato come lettera di escape per le virgolette. Il valore predefinito è '"'. |
| [HasAttributeNames](../../aspose.gis.formats.csv/csvoptions/hasattributenames/) { get; set; } | Determina se esiste una riga di intestazione con i nomi degli attributi. Il valore predefinito è`true` . |
...
| [StartLineNumber](../../aspose.gis.formats.csv/csvoptions/startlinenumber/) { get; set; } | Ottiene o imposta un numero di riga in base zero che sarà il primo quando vengono letti i dati. Il valore predefinito è 0. |
