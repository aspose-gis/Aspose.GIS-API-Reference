...
description: Opzioni specifiche del driver per il formato TopoJSON.
type: docs
weight: 640
...
| [DefaultObjectName](../../aspose.gis.formats.topojson/topojsonoptions/defaultobjectname) { get; set; } | Nome dell'oggetto in cui vengono inserite le caratteristiche per impostazione predefinita. |
...
| [QuantizationNumber](../../aspose.gis.formats.topojson/topojsonoptions/quantizationnumber) { get; set; } | Specifica il numero di quantizzazione da utilizzare per quantizzare le coordinate e codificare delta gli archi nell'output TopoJSON. |
...
| [Transform](../../aspose.gis.formats.topojson/topojsonoptions/transform) { get; set; } | Specifica l'oggetto di trasformazione da utilizzare per quantizzare le coordinate e codificare delta gli archi nell'output TopoJSON. |
