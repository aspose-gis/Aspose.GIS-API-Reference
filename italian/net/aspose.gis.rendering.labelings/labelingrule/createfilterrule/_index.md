...
description: Crea una nuova regola che applica unetichettatura alla funzione ogni volta che supera il filtro.
type: docs
weight: 20
...
Crea una nuova regola che applica un'etichettatura alla funzione ogni volta che supera il filtro.
