...
| [get_value_or_default(attribute_name, default_value)](#get_value_or_default_attribute_name_default_value_4) | 获取属性的值，若值未设置或为 <c>null</c>，则返回 [FeatureAttribute.default_value](/psd/python-net/aspose.gis/featureattribute/)。 |
| [get_values(values, default_value)](#get_values_values_default_value_5) | 以数组形式返回所有属性的值。 |
| [get_values(values_count, default_value)](#get_values_values_count_default_value_6) | 以数组形式返回所有属性的值。 |
...
| [get_values_list(attribute_name, separator, count)](#get_values_list_attribute_name_separator_count_8) | 获取属性序列的值列表。 |
| [is_value_null(attribute_name)](#is_value_null_attribute_name_9) | 确定指定属性是否已显式设置为 <c>null</c> 值。 |
| [is_value_set(attribute_name)](#is_value_set_attribute_name_10) | 检查此要素中是否已设置属性值。 |
...
| [set_values(values)](#set_values_values_13) | 为所有属性设置新值。<br/>            也可以考虑使用 [DynamicFeature.copy_values(input_feature)](/psd/python-net/aspose.gis/dynamicfeature/) 方法在一次调用中简化设置值。 |
| [unset_value(attribute_name)](#unset_value_attribute_name_14) | 从此要素中移除属性值。 |
...
为所有属性设置新值。<br/>            也可以考虑使用 [DynamicFeature.copy_values(input_feature)](/psd/python-net/aspose.gis/dynamicfeature/) 方法在一次调用中简化设置值。
