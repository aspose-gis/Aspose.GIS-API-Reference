...
type: docs
weight: 880
url: /zh/python-net/aspose.gis/filedriver/
---
...
| [open_layer(path, options)](#open_layer_path_options_21) | 打开该图层进行读取。 |
| [open_layer(path, options)](#open_layer_path_options_22) | 打开该图层进行读取。 |
| [supports_spatial_reference_system(spatial_reference_system)](#supports_spatial_reference_system_spatial_reference_system_23) | 确定指定的空间参考系统是否受驱动程序支持。 |
