---
title: "MapInfoInterchangeOptions 类"
type: docs
weight: 20
url: /zh/python-net/aspose.gis.formats.mapinfointerchange/mapinfointerchangeoptions/
---
...
| **Name** | **描述** |
| :- | :- |
| [MapInfoInterchangeOptions()](#MapInfoInterchangeOptions__1) | 创建新实例。 |
## **Properties**
| **Name** | **Type** | **Access** | **描述** |
| :- | :- | :- | :- |
| charset | string | r/w | 确定字符集，默认是 Neutral |
...
| delimiter | string | r/w | 确定 mid 文件中属性的分隔符，默认是制表符 |
