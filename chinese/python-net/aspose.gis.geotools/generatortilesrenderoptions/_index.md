---
title: "GeneratorTilesRenderOptions 类"
type: docs
weight: 20
url: /zh/python-net/aspose.gis.geotools/generatortilesrenderoptions/
---

**Summary:** Options to render tiles
...
| tile_name_template | string | r/w | 瓦片名称模板 |
| tile_size | double | r/w | 瓦片大小 |
...
初始化 GeneratorTilesRenderOptions 类的新实例
