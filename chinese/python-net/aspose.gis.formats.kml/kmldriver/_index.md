...
type: docs
weight: 50
url: /zh/python-net/aspose.gis.formats.kml/kmldriver/
---
...
| [open_as_kml_layer(path, options)](#open_as_kml_layer_path_options_18) | 打开一个 Kml 图层进行读取。 |
...
| [open_layer(path)](#open_layer_path_24) | 打开该图层进行读取。 |
...
| [supports_spatial_reference_system(spatial_reference_system)](#supports_spatial_reference_system_spatial_reference_system_29) | 确定指定的空间参考系统是否受驱动程序支持。 |
...
| :- | :- | :- |
| path | string | 文件的路径。 |
| options | [KmlOptions](/psd/python-net/aspose.gis.formats.kml/kmloptions) | 驱动程序特定的选项。 |
...
| 类型 | 描述 |
| :- | :- |
| [KmlLayer](/psd/python-net/aspose.gis.formats.kml/kmllayer) | 具有特定字段的 KmlLayer |
