---
title: "MapInfoTabOptions 类"
type: docs
weight: 20
url: /zh/python-net/aspose.gis.formats.mapinfotab/mapinfotaboptions/
---
...
| **Name** | **描述** |
| :- | :- |
| [MapInfoTabOptions()](#MapInfoTabOptions__1) | 创建新实例。 |
## **Properties**
| **Name** | **Type** | **Access** | **描述** |
| :- | :- | :- | :- |
| block_size | int | r/w | ‘*.map’ 文件的块大小（512 的倍数）。默认值为 16384。有效值范围：512 到 32256。 |
...
| is_ignore_wrong_data | bool | r/w | 确定在处理错误数据时是抛出异常还是为其设置默认值 |
...
| text_string_attribute | string | r/w | 指定表示 'Text' 图形对象文本的属性名称。 |
