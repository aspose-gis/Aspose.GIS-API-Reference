---
title: "CompoundLabelPosition 类"
type: docs
weight: 10
url: /zh/python-net/aspose.gis.labeling.line/compoundlabelposition/
---
...
| **Name** | **Description** |
| :- | :- |
| [CompoundLabelPosition(parts, cost)](#CompoundLabelPosition_parts_cost_1) | 初始化 CompoundLabelPosition 类的新实例 |
## **Properties**
| **Name** | **Type** | **Access** | **Description** |
| :- | :- | :- | :- |
| bounding_rectangle | [BoundingRectangle](/psd/python-net/aspose.gis.common/boundingrectangle/) | r |    |
| 成本 | double | r |  |
| 部件 | System.Collections.Generic.IReadOnlyList<SymbolTetragon> | r |  |
...
初始化 CompoundLabelPosition 类的新实例

**Parameters:**

| 参数 | 类型 | 描述 |
| :- | :- | :- |
| 部件 | System.Collections.Generic.IReadOnlyList<SymbolTetragon> |  |
| 成本 | double |  |
