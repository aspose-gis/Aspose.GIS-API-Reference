...
type: docs
weight: 10
url: /zh/python-net/aspose.gis.formats.kml.specificfields/iconinfo/
---
...
| **Name** | **描述** |
| :- | :- |
| [IconInfo(link)](#IconInfo_link_1) | 初始化一个新的 [IconInfo](/psd/python-net/aspose.gis.formats.kml.specificfields/iconinfo/) 类实例。 |
## **Properties**
| **Name** | **Type** | **Access** | **描述** |
| :- | :- | :- | :- |
| children | [NodeLink[]](/psd/python-net/aspose.gis/nodelink) | r | 获取子节点。 |
| href | string | r/w | 获取或设置 href。 |
...
初始化一个新的 [IconInfo](/psd/python-net/aspose.gis.formats.kml.specificfields/iconinfo/) 类实例。

**Parameters:**

| 参数 | 类型 | 描述 |
| :- | :- | :- |
| link | [NodeLink](/psd/python-net/aspose.gis/nodelink) | 将创建它的节点 |
