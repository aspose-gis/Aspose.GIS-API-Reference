...
| **Name** | **Description** |
| :- | :- |
| [IconInfo(link)](#IconInfo_link_1) | 初始化 [IconInfo](/psd/python-net/aspose.gis.formats.kml.specificfields/iconinfo/) 类的新实例。 |
## **Properties**
...
初始化 [IconInfo](/psd/python-net/aspose.gis.formats.kml.specificfields/iconinfo/) 类的新实例。
