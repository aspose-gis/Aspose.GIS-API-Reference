---
title: "KmlLatLonBox 类"
type: docs
weight: 40
url: /zh/python-net/aspose.gis.formats.kml.specificfields/kmllatlonbox/
---
...
| 北 | double | r/w | ‘LatLonBox’ 节点的北部。 |
| 前缀 | string | r | 获取前缀。 |
| 旋转 | Nullable<double> | r/w | ‘LatLonBox’ 节点的 Rotation。 |
| 南 | double | r/w | ‘LatLonBox’ 节点的南部。 |
| 西 | double | r/w | ‘LatLonBox’ 节点的西部。 |
## **Methods**
| **Name** | **描述** |
| :- | :- |
