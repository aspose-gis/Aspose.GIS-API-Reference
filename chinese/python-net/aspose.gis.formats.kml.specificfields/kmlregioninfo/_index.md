---
title: "KmlRegionInfo 类"
type: docs
weight: 70
url: /zh/python-net/aspose.gis.formats.kml.specificfields/kmlregioninfo/
---
...
| id | string | r/w | Id 的 'Region' 节点。 |
| lat_lon_alt_box | [KmlLatLonAltBox](/psd/python-net/aspose.gis.formats.kml.specificfields/kmllatlonaltbox) | r/w | 指定来自 Kml 'LatLonAltBox' 节点的对象。 |
| lod | [KmlLodSettings](/psd/python-net/aspose.gis.formats.kml.specificfields/kmllodsettings) | r/w | 指定来自 Kml 'Lod' 节点的对象。 |
