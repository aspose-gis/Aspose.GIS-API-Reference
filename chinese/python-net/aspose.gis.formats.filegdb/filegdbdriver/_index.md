---
title: "FileGdbDriver 类"
type: docs
weight: 20
url: /zh/python-net/aspose.gis.formats.filegdb/filegdbdriver/
---
...
| [create_dataset(path, options)](#create_dataset_path_options_5) | 创建一个数据集。 |
| [create_dataset(path, options)](#create_dataset_path_options_6) | 创建一个数据集。 |
| [create_layer(path)](#create_layer_path_7) | 创建图层并以追加方式打开它。 |
| [create_layer(path)](#create_layer_path_8) | 创建图层并以追加方式打开它。 |
| [create_layer(path, options)](#create_layer_path_options_9) | 创建一个图层并打开以添加新要素。 |
| [create_layer(path, options)](#create_layer_path_options_10) | 创建一个图层并打开以添加新要素。 |
| [create_layer(path, options)](#create_layer_path_options_11) | 创建一个图层并打开以添加新要素。 |
| [create_layer(path, options, spatial_reference_system)](#create_layer_path_options_spatial_reference_system_12) | 创建一个图层并以追加模式打开它。 |
| [create_layer(path, options, spatial_reference_system)](#create_layer_path_options_spatial_reference_system_13) | 创建一个图层并以追加模式打开它。 |
| [create_layer(path, options, spatial_reference_system)](#create_layer_path_options_spatial_reference_system_14) | 创建一个图层并以追加模式打开它。 |
...
| [open_dataset(path, options)](#open_dataset_path_options_23) | 打开数据集。 |
| [open_dataset(path, options)](#open_dataset_path_options_24) | 打开数据集。 |
| [open_dataset(path, options)](#open_dataset_path_options_25) | 打开数据集。 |
| [open_layer(path)](#open_layer_path_26) | 打开该图层进行读取。 |
| [open_layer(path)](#open_layer_path_27) | 打开该图层进行读取。 |
| [open_layer(path, options)](#open_layer_path_options_28) | 打开一个图层进行读取。 |
| [open_layer(path, options)](#open_layer_path_options_29) | 打开一个图层进行读取。 |
| [open_layer(path, options)](#open_layer_path_options_30) | 打开一个图层进行读取。 |
| [open_layer(path, options)](#open_layer_path_options_31) | 打开一个图层进行读取。 |
| [supports_spatial_reference_system(spatial_reference_system)](#supports_spatial_reference_system_spatial_reference_system_32) | 确定指定的空间参考系统是否受驱动程序支持。 |
...
| :- | :- | :- |
| path | string | 数据集的路径。 |
| options | [FileGdbOptions](/psd/python-net/aspose.gis.formats.filegdb/filegdboptions) | 驱动程序特定的选项。 |
