---
title: "ShapefileDriver 类"
type: docs
weight: 10
url: /zh/python-net/aspose.gis.formats.shapefile/shapefiledriver/
---
...
| :- | :- | :- |
| path | string | 文件的路径。 |
| options | [ShapefileOptions](/psd/python-net/aspose.gis.formats.shapefile/shapefileoptions) | 驱动程序特定的选项。 |
