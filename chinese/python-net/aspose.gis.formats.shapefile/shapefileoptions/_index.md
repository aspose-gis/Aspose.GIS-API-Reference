---
title: "ShapefileOptions 类"
type: docs
weight: 20
url: /zh/python-net/aspose.gis.formats.shapefile/shapefileoptions/
---
...
| **Name** | **描述** |
| :- | :- |
| [ShapefileOptions()](#ShapefileOptions__1) | 创建新实例。 |
## **Properties**
| **Name** | **Type** | **Access** | **描述** |
| :- | :- | :- | :- |
...
| is_ignore_wrong_data | bool | r/w | 确定在解析错误数据时是抛出异常还是为其设置默认值 |
