...
type: docs
weight: 10
url: /zh/python-net/aspose.gis.formats.csv/csvdriver/
---
...
| **Name** | **Description** |
| :- | :- |
| [CsvDriver()](#CsvDriver__1) | 初始化 CsvDriver 类的新实例 |
## **Properties**
...
| :- | :- | :- |
| path | string | 文件的路径。 |
| options | [CsvOptions](/psd/python-net/aspose.gis.formats.csv/csvoptions) | 驱动程序特定的选项。 |
