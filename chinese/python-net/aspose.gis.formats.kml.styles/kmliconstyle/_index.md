...
| hot_spot | [KmlCoordinate](/psd/python-net/aspose.gis.formats.kml.styles/kmlcoordinate) | r/w | 指定锚定到 Placemark 中指定点的图标上参考点的位置。<br/>默认值为 <see langword=\"null\" />，表示 HotSpot 缺失。 |
| resource | [KmlIconResource](/psd/python-net/aspose.gis.formats.kml.styles/kmliconresource) | r/w | 指定资源位置。默认值为 <see langword=\"null\" />，表示图标缺失。 |
