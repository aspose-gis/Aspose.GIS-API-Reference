...
type: docs
weight: 10
url: /zh/python-net/aspose.gis.formats.gdal/gdaldriver/
---
...
| [create_layer(path, options, spatial_reference_system)](#create_layer_path_options_spatial_reference_system_9) | 创建一个图层并打开以添加新要素。 |
...
| [edit_layer(path, options)](#edit_layer_path_options_13) | 打开一个图层进行编辑。 |
| [edit_layer(path, options)](#edit_layer_path_options_14) | 打开一个图层进行编辑。 |
...
| [open_layer(path)](#open_layer_path_19) | 打开该图层进行读取。 |
| [open_layer(path)](#open_layer_path_20) | 打开该图层进行读取。 |
| [open_layer(path, options)](#open_layer_path_options_21) | 打开一个图层进行读取。 |
| [open_layer(path, options)](#open_layer_path_options_22) | 打开一个图层进行读取。 |
| [open_layer(path, options)](#open_layer_path_options_23) | 打开一个图层进行读取。 |
...
| :- | :- | :- |
| path | string | 文件的路径。 |
| options | [GdalOptions](/psd/python-net/aspose.gis.formats.gdal/gdaloptions) | 驱动程序特定的选项。 |
