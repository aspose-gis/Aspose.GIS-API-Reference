...
| base | [GeographicSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/geographicspatialreferencesystem) | r | 用于获取此 SRS 的 [ProjectedSpatialReferenceSystem.projection](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/) 所应用的地理 SRS。 |
| dimensions_count | 整数 | r | 返回此 SRS 的维度计数。对于投影 SRS，这可能是：<br/>            two - 如果这是单投影 SRS。<br/>            three - 如果这是复合 SRS，由单一的二维投影 SRS 和垂直 SRS 组成，增加了第三维度。 |
...
| linear_unit | [Unit](/psd/python-net/aspose.gis.spatialreferencing/unit) | r | 在此 SRS 中用于线性维度以及 [ProjectedSpatialReferenceSystem.projection](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/) 的线性参数的单位。 |
...
| projection | [Projection](/psd/python-net/aspose.gis.spatialreferencing/projection) | r | 用于获取此 SRS 的 [ProjectedSpatialReferenceSystem.base](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/) 所应用的投影。 |
...
| 类型 | 描述 |
| :- | :- |
| bool | 如果 SRS 有效，则为 <see langword="true" />，否则为 <see langword="false" />。 |
