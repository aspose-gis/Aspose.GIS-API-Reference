---
title: "ProjectedSpatialReferenceSystem 类"
type: docs
weight: 150
url: /zh/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/
---
...
| **Name** | **Type** | **Access** | **描述** |
| :- | :- | :- | :- |
| angular_unit | [Unit](/psd/python-net/aspose.gis.spatialreferencing/unit) | r | 用于此 SRS 中角度值以及 [ProjectedSpatialReferenceSystem.projection](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/) 的角度参数的单位。<br/>            与 [ProjectedSpatialReferenceSystem.base](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/) 的角度单位相匹配。 |
| as_compound | [CompoundSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/compoundspatialreferencesystem) | r | 返回将此 SRS 转换为 [CompoundSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/compoundspatialreferencesystem/) 的结果。<br/>            使用 [SpatialReferenceSystem.is_compound](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem/) 来判断是否可以进行转换。 |
...
| as_projected | [ProjectedSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem) | r | 返回此。 |
...
| axises_order | [ProjectedAxisesOrder](/psd/python-net/aspose.gis.spatialreferencing/projectedaxisesorder) | r | 此 SRS 中轴的顺序。<br/>            如果此 SRS 无效且轴方向错误，将返回 [ProjectedAxisesOrder.INVALID](/psd/python-net/aspose.gis.spatialreferencing/projectedaxisesorder/)。 |
| base | [GeographicSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/geographicspatialreferencesystem) | r | 用于生成此 SRS 的 [ProjectedSpatialReferenceSystem.projection](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/) 所对应的地理 SRS。 |
| dimensions_count | int | r | 返回此 SRS 的维度计数。对于投影 SRS，可为：<br/>            two - 如果这是单一投影 SRS。<br/>            three - 如果这是复合 SRS，由单一的二维投影 SRS 和垂直 SRS 组成，增加了第三维度。 |
...
| geographic_datum | [GeographicDatum](/psd/python-net/aspose.gis.spatialreferencing/geographicdatum) | r | 返回此 SRS 的地理基准。 |
| has_geographic_datum | bool | r | 返回 true，因为投影 SRS 总是具有本初子午线。 |
| has_prime_meridian | bool | r | 返回 true，因为投影 SRS 总是具有本初子午线。 |
| identifier | [Identifier](/psd/python-net/aspose.gis.spatialreferencing/identifier) | r | 此可识别对象的标识符。 |
| is_compound | bool | r | 返回此 SRS 是否为复合（由两个 SRS 组成的联合）。<br/>            以下组合的复合 SRS 被视为有效：<br/>            Geographic SRS + Vertical SRS，在这种情况下复合 SRS 的类型为 [SpatialReferenceSystemType.GEOGRAPHIC](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/)。<br/>            Projected SRS + Vertical SRS，在这种情况下复合 SRS 的类型为 [SpatialReferenceSystemType.PROJECTED](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/)。<br/>            如果 SRS 组合不同，复合 SRS 的类型将为 [SpatialReferenceSystemType.UNKNOWN](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/)。 |
...
| linear_unit | [Unit](/psd/python-net/aspose.gis.spatialreferencing/unit) | r | 此 SRS 中用于线性维度的单位，以及用于 [ProjectedSpatialReferenceSystem.projection](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/) 的线性参数的单位。 |
...
| prime_meridian | [PrimeMeridian](/psd/python-net/aspose.gis.spatialreferencing/primemeridian) | r | 返回此 SRS 的本初子午线。 |
| projection | [Projection](/psd/python-net/aspose.gis.spatialreferencing/projection) | r | 用于生成此 SRS 的 [ProjectedSpatialReferenceSystem.base](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/) 所采用的投影。 |
| type | [SpatialReferenceSystemType](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype) | r | 返回 [SpatialReferenceSystemType.PROJECTED](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/)。 |
...
| [validate(error_message)](#validate_error_message_18) | 确定此 SRS 是否有效。 |
...
| 参数 | 类型 | 描述 |
| :- | :- | :- |
| error_message | 字符串 | 如果方法返回 <see langword="false" />，则这是无效性的描述。 |

**Returns**

| 类型 | 描述 |
| :- | :- |
| bool | <see langword="true" /> 如果 SRS 有效，<see langword="false" /> 否则。 |
