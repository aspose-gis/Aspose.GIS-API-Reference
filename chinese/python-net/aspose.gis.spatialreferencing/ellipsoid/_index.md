...
| inverse_flattening | double | r | 椭球体的逆扁率。如果这是球体，则为 0。 |
| is_sphere | bool | r | 检测此椭球体是否为球体。 |
| is_valid | bool | r | 检测椭球体是否有效：其半长轴大于 0，且逆扁率为正或等于 0。 |
| 名称 | string | r | 此对象的名称。 |
...
| **Name** | **Description** |
| :- | :- |
| [is_equivalent(ellipsoid1, ellipsoid2)](#is_equivalent_ellipsoid1_ellipsoid2_1) | 确定两个椭球体是否等价。<br/>            如果椭球体 A 等价于椭球体 B，则它们具有相同的半长轴和逆扁率。 |
| [is_equivalent(other)](#is_equivalent_other_2) | 确定两个椭球体是否等价。<br/>            如果椭球体 A 等价于椭球体 B，则它们具有相同的半长轴和逆扁率。 |
...
| inverse_flattening | double | 椭球体的逆扁率。应为 0 以创建球体。 |
...
确定两个椭球体是否等价。<br/>            如果椭球体 A 等价于椭球体 B，则它们具有相同的半长轴和逆扁率。
