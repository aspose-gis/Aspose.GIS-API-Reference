...
| dimensions_count | 整数 | r | 返回 3，因为地心 SRS 始终是三维的。 |
...
| has_geographic_datum | bool | r | 返回 <see langword="true" />，因为地心 SRS 总是具有地理基准。 |
| has_prime_meridian | bool | r | 返回 <see langword="true" />，因为地心 SRS 总是具有本初子午线。 |
