...
| **Name** | **描述** |
| :- | :- |
| [RasterImageMarker(image_path)](#RasterImageMarker_image_path_1) | 初始化一个新的 [RasterImageMarker](/psd/python-net/aspose.gis.rendering.symbolizers/rasterimagemarker/) 类的实例。 |
| [RasterImageMarker(image_path)](#RasterImageMarker_image_path_2) | 初始化一个新的 [RasterImageMarker](/psd/python-net/aspose.gis.rendering.symbolizers/rasterimagemarker/) 类的实例。 |
| [RasterImageMarker(other)](#RasterImageMarker_other_3) | 初始化一个新的 [RasterImageMarker](/psd/python-net/aspose.gis.rendering.symbolizers/rasterimagemarker/) 类的实例。 |
## **Properties**
| **Name** | **Type** | **Access** | **描述** |
| :- | :- | :- | :- |
...
| opacity | double | r/w | 图层的不透明度。默认值为 1.0。 |
...
初始化一个新的 [RasterImageMarker](/psd/python-net/aspose.gis.rendering.symbolizers/rasterimagemarker/) 类的实例。
...
| 参数 | 类型 | 描述 |
| :- | :- | :- |
| other | [RasterImageMarker](/psd/python-net/aspose.gis.rendering.symbolizers/rasterimagemarker) | 要从中复制数据的另一个 [RasterImageMarker](/psd/python-net/aspose.gis.rendering.symbolizers/rasterimagemarker/) 。 |
