...
| dash_offset | [Measurement](/psd/python-net/aspose.gis.rendering/measurement) | r/w | 指定从线条起点到虚线模式起始的距离。 |
| dash_pattern | System.Collections.Generic.IEnumerable<Measurement> | r/w | 指定一个距离数组，用于指定虚线中交替的短划线和空格的长度<br/>            用于虚线中。 |
...
| 参数 | 类型 | 描述 |
| :- | :- | :- |
| other | [SimpleLine](/psd/python-net/aspose.gis.rendering.symbolizers/simpleline) | 另一个用于复制数据的 [SimpleLine](/psd/python-net/aspose.gis.rendering.symbolizers/simpleline/)。 |
