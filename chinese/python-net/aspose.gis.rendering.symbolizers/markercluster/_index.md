---
title: "MarkerCluster 类"
type: docs
weight: 30
url: /zh/python-net/aspose.gis.rendering.symbolizers/markercluster/
---
...
| 参数 | 类型 | 描述 |
| :- | :- | :- |
| distance | [Measurement](/psd/python-net/aspose.gis.rendering/measurement) | 指定收集最近点的距离。 |
...
| 参数 | 类型 | 描述 |
| :- | :- | :- |
| other | [MarkerCluster](/psd/python-net/aspose.gis.rendering.symbolizers/markercluster) | 要从中复制数据的另一个 [MarkerCluster](/psd/python-net/aspose.gis.rendering.symbolizers/markercluster/)。 |
