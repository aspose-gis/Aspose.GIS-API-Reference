---
title: "GeometryGenerator 类"
type: docs
weight: 10
url: /zh/python-net/aspose.gis.rendering.symbolizers/geometrygenerator/
---
...
| **Name** | **描述** |
| :- | :- |
| [GeometryGenerator()](#GeometryGenerator__1) | 初始化 GeometryGenerator 类的新实例 |
## **Properties**
| **Name** | **Type** | **Access** | **描述** |
| :- | :- | :- | :- |
...
| symbolizer | [VectorSymbolizer](/psd/python-net/aspose.gis.rendering.symbolizers/vectorsymbolizer) | r/w | 指定要应用于修改后几何体的符号化器。<br/>            默认是 <see langword=\"NullVectorSymbolizer\" />. |
