...
| object_name_attribute | string | r/w | 属性的名称，反映包含要素的对象的名称。 |
| quantization_number | Nullable<int> | r/w | 指定用于在输出 TopoJSON 中量化坐标和对弧线进行增量编码的量化数字。 |
...
| transform | [TopoJsonTransform](/psd/python-net/aspose.gis.formats.topojson/topojsontransform) | r/w | 指定用于在输出 TopoJSON 中量化坐标和对弧线进行增量编码的变换对象。 |
