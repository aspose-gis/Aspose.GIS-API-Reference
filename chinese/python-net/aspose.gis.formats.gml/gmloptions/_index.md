...
| **Name** | **Type** | **Access** | **描述** |
| :- | :- | :- | :- |
| application_namespace | string | r/w | 此项指定用于生成 gml 文档的自定义命名空间，作为应用程序命名空间。 |
...
| load_schemas_from_internet | bool | r/w | 确定是否允许 Aspose.GIS 从互联网加载 XML 架构。<br/>            如果设置为 <see langword="false" />，具有非 'file://' 开头的绝对 URI 的架构将不会被加载。<br/>            默认值为 <see langword="false" />。 |
