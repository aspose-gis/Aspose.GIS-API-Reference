...
type: docs
weight: 10
url: /zh/python-net/aspose.gis.formats.gml/gmldriver/
---
...
| [create_layer(path, options, spatial_reference_system)](#create_layer_path_options_spatial_reference_system_14) | 创建一个图层并打开以添加新要素。 |
...
| :- | :- | :- |
| path | string | 文件的路径。 |
| options | [GmlOptions](/psd/python-net/aspose.gis.formats.gml/gmloptions) | 驱动程序特定的选项。 |
