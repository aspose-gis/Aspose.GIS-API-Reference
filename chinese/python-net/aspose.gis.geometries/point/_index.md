...
type: docs
weight: 300
url: /zh/python-net/aspose.gis.geometries/point/
---
...
| **Name** | **Description** |
| :- | :- |
| [Point()](#Point__1) | 初始化一个新的 [Point](/psd/python-net/aspose.gis.geometries/point/) 类实例。 |
| [Point(other)](#Point_other_2) | 初始化一个新的 [Point](/psd/python-net/aspose.gis.geometries/point/) 类实例。 |
| [Point(x, y)](#Point_x_y_3) | 初始化一个新的 [Point](/psd/python-net/aspose.gis.geometries/point/) 类实例。 |
| [Point(x, y, z)](#Point_x_y_z_4) | 初始化一个新的 [Point](/psd/python-net/aspose.gis.geometries/point/) 类实例。 |
| [Point(x, y, z, m)](#Point_x_y_z_m_5) | 初始化一个新的 [Point](/psd/python-net/aspose.gis.geometries/point/) 类实例。 |
## **Properties**
...
| x | double | r/w | 获取或设置 x 坐标的值。 |
| y | double | r/w | 获取或设置 y 坐标的值。 |
| z | double | r/w | 获取或设置 z 坐标的值。 |
## **Methods**
| **Name** | **Description** |
| :- | :- |
...
| [intersection(other)](#intersection_other_26) | 构建此几何体与指定几何体的交集。 |
...
| [sym_difference(other)](#sym_difference_other_37) | 在此几何体与指定几何体之间构建对称差。 |
...
| [touches(other)](#touches_other_42) | 确定此几何体与指定几何体是否相接。 |
...
初始化一个新的 [Point](/psd/python-net/aspose.gis.geometries/point/) 类实例。
...
| 参数 | 类型 | 描述 |
| :- | :- | :- |
| other | [IPoint](/psd/python-net/aspose.gis.geometries/ipoint) | 要从中复制数据的另一个 [IPoint](/psd/python-net/aspose.gis.geometries/ipoint/)。 |
...
| 类型 | 描述 |
| :- | :- |
| [Point](/psd/python-net/aspose.gis.geometries/point) | 此几何体的可编辑副本。 |
