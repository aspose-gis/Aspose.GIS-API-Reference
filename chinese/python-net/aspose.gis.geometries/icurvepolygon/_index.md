...
| exterior_ring | [ICurve](/psd/python-net/aspose.gis.geometries/icurve) | r | 获取外环。 |
...
| [get_point_on_surface()](#get_point_on_surface__23) | 查找一个保证位于此表面的点。 |
| [intersection(other)](#intersection_other_24) | 构建此几何体与指定几何体之间的交集。 |
...
| [sym_difference(other)](#sym_difference_other_32) | 在此几何体和指定几何体之间构建对称差。 |
...
| [touches(other)](#touches_other_36) | 确定此几何体与指定几何体是否相切。 |
