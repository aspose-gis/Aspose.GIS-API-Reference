---
title: "GeometryCollection 类"
type: docs
weight: 60
url: /zh/python-net/aspose.gis.geometries/geometrycollection/
---
...
| **Name** | **描述** |
| :- | :- |
| [GeometryCollection()](#GeometryCollection__1) | 初始化 [GeometryCollection](/psd/python-net/aspose.gis.geometries/geometrycollection/) 类的新实例。 |
## **Properties**
| **Name** | **Type** | **Access** | **描述** |
| :- | :- | :- | :- |
| coordinate_dimension | int | r | 获取此 [Geometry](/psd/python-net/aspose.gis.geometries/geometry/) 的坐标维度数量。 |
| 计数 | int | r | 获取此集合中几何对象的数量。 |
| dimension | [GeometryDimension](/psd/python-net/aspose.gis.geometries/geometrydimension) | r | 获取此 [Geometry](/psd/python-net/aspose.gis.geometries/geometry/) 的拓扑维度。<br/>            如果集合为空，则返回 [GeometryDimension.POINT](/psd/python-net/aspose.gis.geometries/geometrydimension/)。 |
...
初始化 [GeometryCollection](/psd/python-net/aspose.gis.geometries/geometrycollection/) 类的新实例。
...
| 类型 | 描述 |
| :- | :- |
| [GeometryCollection](/psd/python-net/aspose.gis.geometries/geometrycollection) | 此几何体的可编辑副本。 |
...
| 类型 | 描述 |
| :- | :- |
| [IGeometryCollection](/psd/python-net/aspose.gis.geometries/igeometrycollection) | 一种没有曲线几何的几何体。这相当于 <DOM Element: class at 0x2a1791cc040>.IGeometryCollection.to_linear_geometry()(float) 使用<br/>默认的 <c>tolerance</c>。默认的 <c>tolerance</c> 值取决于此几何体的 [SpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem/)：<br/>            <ul><br/>            <li> 对于投影坐标系，容差为 0.001 米（以 SRS 单位计） </li><br/>            <li> 对于地理坐标系，容差为 <c>1e-5</c> 度（以 SRS 单位计） </li><br/>            <li> 对于未知坐标系，容差为 <c>1e-5</c> </li><br/>            </ul><br/>            有关所应用的转换的更多细节，请参阅 <DOM Element: class at 0x2a1791cc040>.IGeometryCollection.to_linear_geometry()(float) 规范。 |
