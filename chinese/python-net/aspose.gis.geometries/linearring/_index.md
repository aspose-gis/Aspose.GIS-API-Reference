...
| [is_clockwise()](#is_clockwise__33) | 确定环是否为顺时针方向。 |
...
| [sym_difference(other)](#sym_difference_other_42) | 在此几何体和指定几何体之间构建对称差。 |
...
| [touches(other)](#touches_other_47) | 确定此几何体与指定几何体是否相切。 |
...
| 类型 | 描述 |
| :- | :- |
| bool | <see langword=\"true\" /> 如果为顺时针；否则 <see langword=\"false\" />. |
