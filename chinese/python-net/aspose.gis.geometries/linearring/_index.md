...
type: docs
weight: 240
url: /zh/python-net/aspose.gis.geometries/linearring/
---
...
| **Name** | **Description** |
| :- | :- |
| [LinearRing()](#LinearRing__1) | 初始化 [LinearRing](/psd/python-net/aspose.gis.geometries/linearring/) 类的新实例。 |
| [LinearRing(collection)](#LinearRing_collection_2) | 初始化 [LinearRing](/psd/python-net/aspose.gis.geometries/linearring/) 类的新实例。 |
| [LinearRing(other)](#LinearRing_other_3) | 初始化 [LinearRing](/psd/python-net/aspose.gis.geometries/linearring/) 类的新实例。 |
## **Properties**
...
| is_closed | bool | r | 获取指示曲线是否闭合的值。<br/>            当曲线的起点等于终点时，曲线为闭合。 |
...
| spatial_reference_system | [SpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem/) | r/w | 获取此实例的 SpatialReferenceSystem。<br/>            如果未设置 SpatialReferenceSystem，此属性可以为 <see langword=\"null\" />。<br/>            为 SpatialReferenceSystem 赋新值不会执行任何坐标转换，仅会更改参考。 |
...
| [as_binary()](#as_binary__5) | 将此几何体转换为其 Well-Known Binary 表示形式。 |
| [as_binary(variant)](#as_binary_variant_6) | 将此几何体转换为其 Well-Known Binary 表示形式。 |
| [as_image(output_path, width, height, renderer, symbolizer)](#as_image_output_path_width_height_renderer_symbolizer_7) | 将此几何体导出为图像表示形式。 |
| [as_image(output_path, width, height, renderer, symbolizer)](#as_image_output_path_width_height_renderer_symbolizer_8) | 将此几何体导出为图像表示形式。 |
| [as_image(width, height, renderer, symbolizer)](#as_image_width_height_renderer_symbolizer_9) | 将此几何体导出为图像表示形式。 |
| [as_text()](#as_text__10) | 将此几何体转换为其 Well-Known Text 表示形式。 |
| [as_text(variant)](#as_text_variant_11) | 将此几何体转换为其 Well-Known Text 表示形式。 |
| [as_text(variant, format)](#as_text_variant_format_12) | 将此几何体转换为其 Well-Known Text 表示形式。 |
...
| [from_binary(wkb)](#from_binary_wkb_19) | 从其 Well-Known Binary 表示创建几何体。 |
| [from_binary(wkb, spatial_reference_system)](#from_binary_wkb_spatial_reference_system_20) | 从其 Well-Known Binary 表示创建几何体。 |
| [from_text(wkt)](#from_text_wkt_21) | 从其 Well-Known Text 表示创建几何体。 |
| [from_text(wkt, spatial_reference_system)](#from_text_wkt_spatial_reference_system_22) | 从其 Well-Known Text 表示创建几何体。 |
...
| [intersection(other)](#intersection_other_30) | 构建此几何体与指定几何体的交集。 |
| [intersects(extent)](#intersects_extent_31) | 确定此几何体是否与指定范围相交。 |
| [intersects(other)](#intersects_other_32) | 确定此几何体与指定几何体是否相交。 |
| [is_clockwise()](#is_clockwise__33) | 确定环是否为顺时针绕向。 |
| [overlaps(other)](#overlaps_other_34) | 确定此几何体是否与指定几何体重叠。 |
| [relate(other, intersection_pattern_matrix)](#relate_other_intersection_pattern_matrix_35) | 确定此几何体与指定几何体的 DE-9IM 交叉矩阵是否匹配提供的模式。 |
| [replace_polygons_by_lines()](#replace_polygons_by_lines__36) | 获取此几何体中表示为线的多边形。 |
| reverse() | 反转此 [LineString](/psd/python-net/aspose.gis.geometries/linestring/) 中点的顺序。 |
| [round_m(digits)](#round_m_digits_37) | 将 M 坐标四舍五入到指定的小数位数。 |
| [round_xy(digits)](#round_xy_digits_38) | 将 X 和 Y 坐标四舍五入到指定的小数位数。 |
| [round_z(digits)](#round_z_digits_39) | 将 Z 坐标四舍五入到指定的小数位数。 |
| set_empty() | 使此 [Geometry](/psd/python-net/aspose.gis.geometries/geometry/) 为空。 |
| [spatially_contains(other)](#spatially_contains_other_40) | 确定此几何体在空间上是否包含指定几何体。 |
| [spatially_equals(other)](#spatially_equals_other_41) | 确定此几何体在空间上是否等于指定几何体。 |
| [sym_difference(other)](#sym_difference_other_42) | 在此几何体与指定几何体之间构建对称差。 |
| [to_editable()](#to_editable__43) | 获取此几何体的可编辑副本。 |
| [to_linear_geometry()](#to_linear_geometry__44) | 使用默认的 <c>tolerance</c> 获取此几何体的近似或等效的非曲线版本。 |
| [to_linear_geometry(tolerance)](#to_linear_geometry_tolerance_45) | 使用指定的 <c>tolerance</c> 获取此几何体的近似或等效的非曲线版本。 |
| [to_svg(extent)](#to_svg_extent_46) | 将此几何体转换为 Svg 表示。 |
| [touches(other)](#touches_other_47) | 确定此几何体与指定几何体是否相接。 |
| [union(other)](#union_other_48) | 合并此几何体和指定几何体。 |
| [union(other)](#union_other_49) | 合并此几何体和指定几何体。 |
| [within(extent)](#within_extent_50) | 确定此几何体是否位于指定范围内。 |
| [within(other)](#within_other_51) | 确定此几何体是否位于指定几何体内部。 |
...
初始化 [LinearRing](/psd/python-net/aspose.gis.geometries/linearring/) 类的新实例。
...
| 类型 | 描述 |
| :- | :- |
| bool | 如果顺时针，则为 <see langword="true" />；否则为 <see langword="false" />。 |
...
| 类型 | 描述 |
| :- | :- |
| [LinearRing](/psd/python-net/aspose.gis.geometries/linearring) | 此几何体的可编辑副本。 |
...
| 类型 | 描述 |
| :- | :- |
| [ILineString](/psd/python-net/aspose.gis.geometries/ilinestring) | 一个近似或等价于此曲线的 [ILineString](/psd/python-net/aspose.gis.geometries/ilinestring/)。<br/>            这相当于 <DOM Element: class at 0x2a1791540d0>.ICurve.to_linear_geometry()(float) 使用默认的 <c>tolerance</c>。默认的 <c>tolerance</c> 值取决于此几何体的 [SpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem/)<br/>            ：<ul><br/>            <li> 对于投影坐标系，容差为 0.001 米（以坐标系单位计） </li><br/>            <li> 对于地理坐标系，容差为 <c>1e-5</c> 度（以坐标系单位计） </li><br/>            <li> 对于未知坐标系，容差为 <c>1e-5</c> </li><br/>            </ul><br/>            有关应用的转换的更多细节，请参阅 <DOM Element: class at 0x2a1791540d0>.ICurve.to_linear_geometry()(float) 规范。 |
...
| 类型 | 描述 |
| :- | :- |
| [ILineString](/psd/python-net/aspose.gis.geometries/ilinestring) | 一个近似或等价于此曲线的 [ILineString](/psd/python-net/aspose.gis.geometries/ilinestring/):<br/>             <ul><br/>             如果此对象本身是 [ILineString](/psd/python-net/aspose.gis.geometries/ilinestring/)，则结果等价于此对象<br/>             如果此对象是 [ICircularString](/psd/python-net/aspose.gis.geometries/icircularstring/)，则结果为使用指定的 <paramref name=\"tolerance\" /> 线性化后的圆形字符串<br/>             如果此对象是 [ICompoundCurve](/psd/python-net/aspose.gis.geometries/icompoundcurve/)，则其所有曲线被线性化后再合并为 [ILineString](/psd/python-net/aspose.gis.geometries/ilinestring/)<br/>            </ul> |
