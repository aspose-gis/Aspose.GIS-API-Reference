...
type: docs
weight: 270
url: /zh/python-net/aspose.gis.geometries/multipoint/
---
...
| **Name** | **描述** |
| :- | :- |
| [MultiPoint()](#MultiPoint__1) | 初始化 [MultiPoint](/psd/python-net/aspose.gis.geometries/multipoint/) 类的新实例。 |
## **Properties**
| **Name** | **Type** | **Access** | **描述** |
| :- | :- | :- | :- |
...
初始化 [MultiPoint](/psd/python-net/aspose.gis.geometries/multipoint/) 类的新实例。
...
| 类型 | 描述 |
| :- | :- |
| [MultiPoint](/psd/python-net/aspose.gis.geometries/multipoint) | 此几何体的可编辑副本。 |
