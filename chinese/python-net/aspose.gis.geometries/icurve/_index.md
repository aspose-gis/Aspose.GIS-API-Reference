...
type: docs
weight: 90
url: /zh/python-net/aspose.gis.geometries/icurve/
---
...
| [relate(other, intersection_pattern_matrix)](#relate_other_intersection_pattern_matrix_26) | 确定此几何体与指定几何体的 DE-9IM 交叉矩阵是否匹配提供的模式。 |
...
| [within(other)](#within_other_38) | 确定此几何体是否位于指定几何体内部。 |
