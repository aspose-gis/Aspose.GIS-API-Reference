...
type: docs
weight: 320
url: /zh/python-net/aspose.gis.geometries/surface/
---
...
| [from_binary(wkb)](#from_binary_wkb_15) | 从其 Well-Known Binary 表示创建几何体。 |
| [from_binary(wkb, spatial_reference_system)](#from_binary_wkb_spatial_reference_system_16) | 从其 Well-Known Binary 表示创建几何体。 |
| [from_text(wkt)](#from_text_wkt_17) | 从其 Well-Known Text 表示创建几何体。 |
| [from_text(wkt, spatial_reference_system)](#from_text_wkt_spatial_reference_system_18) | 从其 Well-Known Text 表示创建几何体。 |
...
| [get_point_on_surface()](#get_point_on_surface__26) | 查找保证位于此表面的点。 |
...
| 类型 | 描述 |
| :- | :- |
| double | 如果两个几何体都不是 [Geometry.is_empty](/psd/python-net/aspose.gis.geometries/geometry/)，则返回两几何体最近点之间的距离。<br/>            如果至少有一个几何体为空，则返回 -1。 |
...
| 类型 | 描述 |
| :- | :- |
| [IPoint](/psd/python-net/aspose.gis.geometries/ipoint) | 此表面的一个点。如果该表面没有内部，则为空点。 |
...
| 类型 | 描述 |
| :- | :- |
| [Surface](/psd/python-net/aspose.gis.geometries/surface) | 此几何体的可编辑副本。 |
