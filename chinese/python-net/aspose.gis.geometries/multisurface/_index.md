---
title: "MultiSurface 类"
type: docs
weight: 290
url: /zh/python-net/aspose.gis.geometries/multisurface/
---
...
| **Name** | **描述** |
| :- | :- |
| [MultiSurface()](#MultiSurface__1) | 初始化 [MultiSurface](/psd/python-net/aspose.gis.geometries/multisurface/) 类的新实例。 |
## **Properties**
| **Name** | **Type** | **Access** | **描述** |
| :- | :- | :- | :- |
| coordinate_dimension | int | r | 获取此 [Geometry](/psd/python-net/aspose.gis.geometries/geometry/) 的坐标维度数量。 |
| 计数 | int | r | 获取此集合中几何对象的数量。 |
...
| [add_range(geometries)](#add_range_geometries_2) | 将指定的几何体添加到集合中。 |
| [as_binary()](#as_binary__3) | 将此几何体转换为其 Well-Known Binary 表示。 |
| [as_binary(variant)](#as_binary_variant_4) | 将此几何体转换为其 Well-Known Binary 表示。 |
...
| [as_image(output_path, width, height, renderer, symbolizer)](#as_image_output_path_width_height_renderer_symbolizer_6) | 将此几何体导出为图像表示。 |
| [as_image(width, height, renderer, symbolizer)](#as_image_width_height_renderer_symbolizer_7) | 将此几何体导出为图像表示。 |
| [as_text()](#as_text__8) | 将此几何体转换为其 Well-Known Text 表示。 |
| [as_text(variant)](#as_text_variant_9) | 将此几何体转换为其 Well-Known Text 表示。 |
| [as_text(variant, format)](#as_text_variant_format_10) | 将此几何体转换为其 Well-Known Text 表示。 |
...
| [from_binary(wkb)](#from_binary_wkb_17) | 从其已知二进制（Well-Known Binary）表示创建几何体。 |
| [from_binary(wkb, spatial_reference_system)](#from_binary_wkb_spatial_reference_system_18) | 从其已知二进制（Well-Known Binary）表示创建几何体。 |
| [from_text(wkt)](#from_text_wkt_19) | 从其已知文本（Well-Known Text）表示创建几何体。 |
| [from_text(wkt, spatial_reference_system)](#from_text_wkt_spatial_reference_system_20) | 从其已知文本（Well-Known Text）表示创建几何体。 |
...
| [get_point_on_surface()](#get_point_on_surface__28) | 查找一个保证位于此集合中某个表面上的点。 |
| [intersection(other)](#intersection_other_29) | 构建此几何体与指定几何体之间的交集。 |
...
初始化 [MultiSurface](/psd/python-net/aspose.gis.geometries/multisurface/) 类的新实例。
...
| 参数 | 类型 | 描述 |
| :- | :- | :- |
| geometries | System.Collections.Generic.IEnumerable<IGeometry> | 要添加的几何体。 |
...
| 类型 | 描述 |
| :- | :- |
| [MultiSurface](/psd/python-net/aspose.gis.geometries/multisurface) | 此几何体的可编辑副本。 |
...
| 类型 | 描述 |
| :- | :- |
| [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon) | 一个 [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon/) 近似或等价于此 [IMultiSurface](/psd/python-net/aspose.gis.geometries/imultisurface/)。<br/> 这相当于 <DOM Element: class at 0x2a1792e8790>.IMultiSurface.to_linear_geometry()(float) 并使用<br/> 默认的 <c>tolerance</c>。默认的 <c>tolerance</c> 值取决于 [SpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem/) 对此几何体的设置：<br/> <ul><br/> <li> 对于投影坐标系，容差为 0.001 米（以 SRS 单位计） </li><br/> <li> 对于地理坐标系，容差为 <c>1e-5</c> 度（以 SRS 单位计） </li><br/> <li> 对于未知坐标系，容差为 <c>1e-5</c> </li><br/> </ul><br/> 有关所应用的转换的更多细节，请参阅 <DOM Element: class at 0x2a1792e8790>.IMultiSurface.to_linear_geometry()(float) 规范。 |
...
| 类型 | 描述 |
| :- | :- |
| [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon) | 一个 [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon/) 近似或等价于此 [IMultiSurface](/psd/python-net/aspose.gis.geometries/imultisurface/)：<br/> <ul><br/> 如果此对象本身是 [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon/)，结果等价于此对象<br/> 如果此对象不是 [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon/) - 所有面被线性化并创建新的 <c>IMultiPolygon</c><br/> </ul> |
