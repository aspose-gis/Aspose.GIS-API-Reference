...
| 类型 | 描述 |
| :- | :- |
| [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon) | 一个近似或等价于此 [IMultiSurface](/psd/python-net/aspose.gis.geometries/imultisurface/) 的 [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon/)。<br/>            这相当于 <DOM Element: class at 0x2a1792e8790>.IMultiSurface.to_linear_geometry()(float) 使用默认的 <c>tolerance</c>。默认的 <c>tolerance</c> 值取决于此几何体的 [SpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem/)<br/>            ：<ul><br/>            <li> 对于投影坐标系，容差为 0.001 米（以坐标系单位计） </li><br/>            <li> 对于地理坐标系，容差为 <c>1e-5</c> 度（以坐标系单位计） </li><br/>            <li> 对于未知坐标系，容差为 <c>1e-5</c> </li><br/>            </ul><br/>            有关应用的转换的更多细节，请参阅 <DOM Element: class at 0x2a1792e8790>.IMultiSurface.to_linear_geometry()(float) 规范。 |
...
| 类型 | 描述 |
| :- | :- |
| [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon) | 一个近似或等价于此 [IMultiSurface](/psd/python-net/aspose.gis.geometries/imultisurface/) 的 [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon/)：<br/>             <ul><br/>             如果此对象本身是 [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon/)，结果等价于该对象<br/>             如果此对象不是 [IMultiPolygon]，则所有面被线性化并创建新的 <c>IMultiPolygon</c><br/>            </ul> |
