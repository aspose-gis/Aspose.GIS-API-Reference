---
title: "CircularString 类"
type: docs
weight: 10
url: /zh/python-net/aspose.gis.geometries/circularstring/
---
...
| **Name** | **Description** |
| :- | :- |
| [CircularString()](#CircularString__1) | 初始化 [CircularString](/psd/python-net/aspose.gis.geometries/circularstring/) 类的新实例。 |
| [CircularString(collection)](#CircularString_collection_2) | 初始化 [CircularString](/psd/python-net/aspose.gis.geometries/circularstring/) 类的新实例。 |
| [CircularString(other)](#CircularString_other_3) | 初始化 [CircularString](/psd/python-net/aspose.gis.geometries/circularstring/) 类的新实例。 |
## **Properties**
...
| **Name** | **Description** |
| :- | :- |
| [add_point(point)](#add_point_point_1) | 在圆形字符串的末尾添加一个点。 |
| [add_point(x, y)](#add_point_x_y_2) | 在圆形字符串的末尾添加一个点。 |
| [add_point(x, y, z)](#add_point_x_y_z_3) | 在圆形字符串的末尾添加一个点。 |
| [add_point(x, y, z, m)](#add_point_x_y_z_m_4) | 在圆形字符串的末尾添加一个点。 |
...
| reverse() | 反转此 [CircularString](/psd/python-net/aspose.gis.geometries/circularstring/) 中点的顺序。 |
...
初始化 [CircularString](/psd/python-net/aspose.gis.geometries/circularstring/) 类的新实例。
...
| 参数 | 类型 | 描述 |
| :- | :- | :- |
| other | [ICircularString](/psd/python-net/aspose.gis.geometries/icircularstring) | 要从中复制数据的另一个字符串。 |
...
| 类型 | 描述 |
| :- | :- |
| [CircularString](/psd/python-net/aspose.gis.geometries/circularstring) | 此几何体的可编辑副本。 |
