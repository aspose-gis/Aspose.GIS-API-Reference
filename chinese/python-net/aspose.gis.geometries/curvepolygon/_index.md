---
title: "CurvePolygon 类"
type: docs
weight: 40
url: /zh/python-net/aspose.gis.geometries/curvepolygon/
---
...
| **Name** | **描述** |
| :- | :- |
| [CurvePolygon()](#CurvePolygon__1) | 初始化一个新的 [CurvePolygon](/psd/python-net/aspose.gis.geometries/curvepolygon/) 类实例。 |
| [CurvePolygon(exterior_ring)](#CurvePolygon_exterior_ring_2) | 初始化一个新的 [CurvePolygon](/psd/python-net/aspose.gis.geometries/curvepolygon/) 类实例。 |
| [CurvePolygon(exterior_ring, interior_rings)](#CurvePolygon_exterior_ring_interior_rings_3) | 初始化一个新的 [CurvePolygon](/psd/python-net/aspose.gis.geometries/curvepolygon/) 类实例。 |
## **Properties**
| **Name** | **Type** | **Access** | **描述** |
| :- | :- | :- | :- |
...
| exterior_ring | [ICurve](/psd/python-net/aspose.gis.geometries/icurve) | r/w | 获取外环。 |
...
| interior_rings_count | int | r | 获取内部环的数量。 |
...
| [get_point_on_surface()](#get_point_on_surface__28) | 查找一个保证位于此曲面多边形上的点。 |
...
| [sym_difference(other)](#sym_difference_other_40) | 在此几何体和指定几何体之间构建对称差。 |
...
| [touches(other)](#touches_other_45) | 确定此几何体与指定几何体是否相切。 |
...
初始化一个新的 [CurvePolygon](/psd/python-net/aspose.gis.geometries/curvepolygon/) 类实例。
...
| 参数 | 类型 | 描述 |
| :- | :- | :- |
| exterior_ring | [ICurve](/psd/python-net/aspose.gis.geometries/icurve) | 外环。 |
...
| :- | :- | :- |
| exterior_ring | [ICurve](/psd/python-net/aspose.gis.geometries/icurve) | 外环。 |
| interior_rings | System.Collections.Generic.IEnumerable<ICurve> | 内部环。 |
...
| 参数 | 类型 | 描述 |
| :- | :- | :- |
| ring | [ICurve](/psd/python-net/aspose.gis.geometries/icurve) | 要添加的环。 |
...
| 类型 | 描述 |
| :- | :- |
| [ICurve](/psd/python-net/aspose.gis.geometries/icurve) | 内部环。 |
...
| 类型 | 描述 |
| :- | :- |
| [IPoint](/psd/python-net/aspose.gis.geometries/ipoint) | 此曲面多边形上的点。如果该曲面多边形没有内部，则为空点。 |
...
| 类型 | 描述 |
| :- | :- |
| [CurvePolygon](/psd/python-net/aspose.gis.geometries/curvepolygon) | 此几何体的可编辑副本。 |
...
| 类型 | 描述 |
| :- | :- |
| [IPolygon](/psd/python-net/aspose.gis.geometries/ipolygon) | 一个近似或等价于此 <c>ISurface</c> 的 [IPolygon](/psd/python-net/aspose.gis.geometries/ipolygon/)。<br/>            这相当于 <DOM Element: class at 0x2a1793609d0>.ISurface.to_linear_geometry()(float)，使用默认的 <c>tolerance</c>。默认的 <c>tolerance</c> 值取决于此几何体的 [SpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem/)：<br/>            <ul><br/>            <li> 对于投影坐标系，容差为 0.001 米（SRS 单位） </li><br/>            <li> 对于地理坐标系，容差为 <c>1e-5</c> 度（SRS 单位） </li><br/>            <li> 对于未知坐标系，容差为 <c>1e-5</c> </li><br/>            </ul><br/>            有关所应用的转换的更多细节，请参阅 <DOM Element: class at 0x2a1793609d0>.ISurface.to_linear_geometry()(float) 规范。 |
...
| 类型 | 描述 |
| :- | :- |
| [IPolygon](/psd/python-net/aspose.gis.geometries/ipolygon) | 一个近似或等价于此 <c>ISurface</c> 的 [IPolygon](/psd/python-net/aspose.gis.geometries/ipolygon/)：<br/>             <ul><br/>             如果此对象本身是 [IPolygon](/psd/python-net/aspose.gis.geometries/ipolygon/)，结果等价于此对象<br/>             如果此对象不是 [IPolygon](/psd/python-net/aspose.gis.geometries/ipolygon/)，则将其线性化并创建 [IPolygon](/psd/python-net/aspose.gis.geometries/ipolygon/)<br/>            </ul> |
