...
type: docs
weight: 250
url: /zh/python-net/aspose.gis.geometries/multicurve/
---
...
| **Name** | **描述** |
| :- | :- |
| [MultiCurve()](#MultiCurve__1) | 初始化 [MultiCurve](/psd/python-net/aspose.gis.geometries/multicurve/) 类的新实例。 |
## **Properties**
| **Name** | **Type** | **Access** | **描述** |
| :- | :- | :- | :- |
...
初始化 [MultiCurve](/psd/python-net/aspose.gis.geometries/multicurve/) 类的新实例。
...
| 类型 | 描述 |
| :- | :- |
| [MultiCurve](/psd/python-net/aspose.gis.geometries/multicurve) | 此几何体的可编辑副本。 |
...
| 类型 | 描述 |
| :- | :- |
| [IMultiLineString](/psd/python-net/aspose.gis.geometries/imultilinestring) | 一个 [IMultiLineString](/psd/python-net/aspose.gis.geometries/imultilinestring/) 近似或等价于此 [IMultiCurve](/psd/python-net/aspose.gis.geometries/imulticurve/)。<br/> 这相当于 <DOM Element: class at 0x2a179241f70>.IMultiCurve.to_linear_geometry()(float) 并使用<br/> 默认的 <c>tolerance</c>。默认的 <c>tolerance</c> 值取决于 [SpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem/) 对此几何体的设置：<br/> <ul><br/> <li> 对于投影坐标系，容差为 0.001 米（以 SRS 单位计） </li><br/> <li> 对于地理坐标系，容差为 <c>1e-5</c> 度（以 SRS 单位计） </li><br/> <li> 对于未知坐标系，容差为 <c>1e-5</c> </li><br/> </ul><br/> 有关所应用的转换的更多细节，请参阅 <DOM Element: class at 0x2a179241f70>.IMultiCurve.to_linear_geometry()(float) 规范。 |
...
| 类型 | 描述 |
| :- | :- |
| [IMultiLineString](/psd/python-net/aspose.gis.geometries/imultilinestring) | 一个 [IMultiLineString](/psd/python-net/aspose.gis.geometries/imultilinestring/) 近似或等价于此 [IMultiCurve](/psd/python-net/aspose.gis.geometries/imulticurve/)：<br/> <ul><br/> 如果此对象本身是 [IMultiLineString](/psd/python-net/aspose.gis.geometries/imultilinestring/)，结果等价于此对象<br/> 如果此对象不是 [IMultiLineString](/psd/python-net/aspose.gis.geometries/imultilinestring/) - 所有曲线被线性化并创建新的 <c>IMultiLineString</c><br/> </ul> |
