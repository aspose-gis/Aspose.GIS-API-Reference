...
type: docs
weight: 110
url: /zh/python-net/aspose.gis.geometries/igeometry/
---
...
| [to_linear_geometry()](#to_linear_geometry__31) | 使用默认的 <c>tolerance</c> 获取此几何体的近似或等效的非曲线版本。 |
| [to_linear_geometry(tolerance)](#to_linear_geometry_tolerance_32) | 使用指定的 <c>tolerance</c> 获取此几何体的近似或等效的非曲线版本。 |
| [touches(other)](#touches_other_33) | 确定此几何体与指定几何体是否相接。 |
| [union(other)](#union_other_34) | 合并此几何体和指定几何体。 |
| [union(other)](#union_other_35) | 合并此几何体和指定几何体。 |
| [within(extent)](#within_extent_36) | 确定此几何体是否位于指定范围内。 |
| [within(other)](#within_other_37) | 确定此几何体是否位于指定几何体内部。 |
