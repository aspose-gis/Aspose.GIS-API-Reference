...
| **Name** | **Description** |
| :- | :- |
| [add_curve(curve)](#add_curve_curve_1) | 向此 [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/) 的末尾添加一条曲线。 |
...
| [intersection(other)](#intersection_other_27) | 构建此几何体与指定几何体的交集。 |
...
| [sym_difference(other)](#sym_difference_other_38) | 在此几何体与指定几何体之间构建对称差。 |
...
| [touches(other)](#touches_other_43) | 确定此几何体与指定几何体是否相接。 |
...
向此 [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/) 的末尾添加一条曲线。
