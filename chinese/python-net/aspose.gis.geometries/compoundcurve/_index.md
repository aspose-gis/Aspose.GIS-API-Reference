---
title: "CompoundCurve 类"
type: docs
weight: 20
url: /zh/python-net/aspose.gis.geometries/compoundcurve/
---
...
| **Name** | **描述** |
| :- | :- |
| [CompoundCurve()](#CompoundCurve__1) | 初始化一个新的 [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/) 类实例。 |
| [CompoundCurve(curves)](#CompoundCurve_curves_2) | 初始化一个新的 [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/) 类实例。 |
| [CompoundCurve(other)](#CompoundCurve_other_3) | 初始化一个新的 [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/) 类实例。 |
## **Properties**
| **Name** | **Type** | **Access** | **描述** |
| :- | :- | :- | :- |
| coordinate_dimension | int | r | 获取此 [Geometry](/psd/python-net/aspose.gis.geometries/geometry/) 的坐标维度数量。 |
| count | int | r | 获取 [ICompoundCurve](/psd/python-net/aspose.gis.geometries/icompoundcurve/) 中曲线的数量。 |
...
| **Name** | **描述** |
| :- | :- |
| [add_curve(curve)](#add_curve_curve_1) | 在此 [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/) 的末尾添加一条曲线。 |
| [as_binary()](#as_binary__2) | 将此几何体转换为其 Well-Known Binary 表示。 |
| [as_binary(variant)](#as_binary_variant_3) | 将此几何体转换为其 Well-Known Binary 表示。 |
...
| [as_image(output_path, width, height, renderer, symbolizer)](#as_image_output_path_width_height_renderer_symbolizer_5) | 将此几何体导出为图像表示。 |
| [as_image(width, height, renderer, symbolizer)](#as_image_width_height_renderer_symbolizer_6) | 将此几何体导出为图像表示。 |
| [as_text()](#as_text__7) | 将此几何体转换为其 Well-Known Text 表示。 |
| [as_text(variant)](#as_text_variant_8) | 将此几何体转换为其 Well-Known Text 表示。 |
| [as_text(variant, format)](#as_text_variant_format_9) | 将此几何体转换为其 Well-Known Text 表示。 |
...
| [from_binary(wkb)](#from_binary_wkb_16) | 从其已知二进制（Well-Known Binary）表示创建几何体。 |
| [from_binary(wkb, spatial_reference_system)](#from_binary_wkb_spatial_reference_system_17) | 从其已知二进制（Well-Known Binary）表示创建几何体。 |
| [from_text(wkt)](#from_text_wkt_18) | 从其已知文本（Well-Known Text）表示创建几何体。 |
| [from_text(wkt, spatial_reference_system)](#from_text_wkt_spatial_reference_system_19) | 从其已知文本（Well-Known Text）表示创建几何体。 |
...
| [get_length()](#get_length__26) | 计算此几何体的长度。 |
| [intersection(other)](#intersection_other_27) | 构建此几何体与指定几何体之间的交集。 |
| [intersects(extent)](#intersects_extent_28) | 确定此几何体是否与指定范围相交。 |
| [intersects(other)](#intersects_other_29) | 确定此几何体与指定几何体是否相交。 |
| [overlaps(other)](#overlaps_other_30) | 确定此几何体是否与指定几何体重叠。 |
| [relate(other, intersection_pattern_matrix)](#relate_other_intersection_pattern_matrix_31) | 确定此几何体与指定几何体的 DE-9IM 交叉矩阵是否匹配提供的模式。 |
| [replace_polygons_by_lines()](#replace_polygons_by_lines__32) | 获取此几何体中表示为线的多边形。 |
| reverse() | 反转此 [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/)。即 - 颠倒曲线的顺序以及该复合曲线内部的每条曲线。 |
| [round_m(digits)](#round_m_digits_33) | 将 M 坐标四舍五入到指定的小数位数。 |
| [round_xy(digits)](#round_xy_digits_34) | 将 X 和 Y 坐标四舍五入到指定的小数位数。 |
| [round_z(digits)](#round_z_digits_35) | 将 Z 坐标四舍五入到指定的小数位数。 |
| set_empty() | 将此 [Geometry](/psd/python-net/aspose.gis.geometries/geometry/) 设为空。 |
| [spatially_contains(other)](#spatially_contains_other_36) | 确定此几何体在空间上是否包含指定几何体。 |
| [spatially_equals(other)](#spatially_equals_other_37) | 确定此几何体在空间上是否等于指定几何体。 |
| [sym_difference(other)](#sym_difference_other_38) | 在此几何体和指定几何体之间构建对称差。 |
| [to_editable()](#to_editable__39) | 获取此几何体的可编辑副本。 |
| [to_linear_geometry()](#to_linear_geometry__40) | 使用默认的 <c>tolerance</c> 获取此几何体的近似或等效的非曲线版本。 |
| [to_linear_geometry(tolerance)](#to_linear_geometry_tolerance_41) | 使用指定的 <c>tolerance</c> 获取此几何体的近似或等效的非曲线版本。 |
| [to_svg(extent)](#to_svg_extent_42) | 将此几何体转换为 Svg 表示。 |
| [touches(other)](#touches_other_43) | 确定此几何体与指定几何体是否相切。 |
| [union(other)](#union_other_44) | 合并此几何体和指定几何体。 |
| [union(other)](#union_other_45) | 合并此几何体和指定几何体。 |
| [within(extent)](#within_extent_46) | 确定此几何体是否位于指定范围内。 |
| [within(other)](#within_other_47) | 确定此几何体是否位于指定几何体内部。 |
...
初始化一个新的 [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/) 类实例。
...
| 参数 | 类型 | 描述 |
| :- | :- | :- |
| 曲线 | System.Collections.Generic.IEnumerable<ICurve> | 曲线的集合。 |
...
| 参数 | 类型 | 描述 |
| :- | :- | :- |
| other | [ICompoundCurve](/psd/python-net/aspose.gis.geometries/icompoundcurve) | 要从中复制数据的另一条线。 |
...
在此 [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/) 的末尾添加一条曲线。

**Parameters:**

| 参数 | 类型 | 描述 |
| :- | :- | :- |
| curve | [ICurve](/psd/python-net/aspose.gis.geometries/icurve) | 要添加的曲线。 |
...
| 类型 | 描述 |
| :- | :- |
| [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve) | 此几何体的可编辑副本。 |
