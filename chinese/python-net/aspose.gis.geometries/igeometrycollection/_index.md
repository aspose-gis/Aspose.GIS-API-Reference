---
title: "IGeometryCollection 类"
type: docs
weight: 120
url: /zh/python-net/aspose.gis.geometries/igeometrycollection/
---
...
| [get_point_on_surface()](#get_point_on_surface__22) | 查找一个保证位于此集合中某个表面上的点。 |
| [intersection(other)](#intersection_other_23) | 构建此几何体与指定几何体之间的交集。 |
...
| [sym_difference(other)](#sym_difference_other_31) | 在此几何体和指定几何体之间构建对称差。 |
...
| [touches(other)](#touches_other_35) | 确定此几何体与指定几何体是否相切。 |
...
| 参数 | 类型 | 描述 |
| :- | :- | :- |
| 容差 | double | 要使用的 <c>tolerance</c>。结果保证距离弯曲几何体小于 <c>tolerance</c>，除非线性化几何体所需的点数超过每象限的最大值，当前为 10000 点。 |
