---
title: "SqlServerOptions 类"
type: docs
weight: 20
url: /zh/python-net/aspose.gis.formats.sqlserver/sqlserveroptions/
---
...
| **Name** | **描述** |
| :- | :- |
| [SqlServerOptions()](#SqlServerOptions__1) | 创建新实例。 |
## **Properties**
| **Name** | **Type** | **Access** | **描述** |
| :- | :- | :- | :- |
...
| spatial_reference_system_mode | [SpatialReferenceSystemMode](/psd/python-net/aspose.gis/spatialreferencesystemmode) | r/w | 确定当未知几何体的数据库 SRS 被添加到图层时应如何处理。<br/>            默认值是 [SpatialReferenceSystemMode.THROW_EXCEPTION](/psd/python-net/aspose.gis/spatialreferencesystemmode/)。 |
