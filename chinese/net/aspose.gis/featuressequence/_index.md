...
description: FeaturesSequence./featuressequence表示一组向量特征
type: docs
weight: 160
...
[`FeaturesSequence`](../featuressequence)表示一组向量特征。
...
| 姓名 | 描述 |
| --- | --- |
| abstract [Attributes](../../aspose.gis/featuressequence/attributes) { get; } | 获取此[`VectorLayer`](../vectorlayer)中特征的自定义属性集合。 |
...
| [WhereIntersects](../../aspose.gis/featuressequence/whereintersects#whereintersects_1)(FeaturesSequence) | 根据其他特征序列中所有几何图形的联合过滤特征。 |
| virtual [WhereIntersects](../../aspose.gis/featuressequence/whereintersects#whereintersects_2)(IGeometry) | 根据提供的几何体过滤特征。 |
