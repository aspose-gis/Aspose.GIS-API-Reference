---
title: "类 DriverOptions"
second_title: "Aspose.GIS for .NET API 参考文档"
description: "Aspose.Gis.DriverOptions 类。驱动程序的选项"
type: docs
weight: 1450
...
| [DeleteNearPointsDistance](../../aspose.gis/driveroptions/deletenearpointsdistance/) { get; set; } | 确定 [`DeleteNearPoints`](./deletenearpoints/) 的距离。默认值为 `0`。 |
...
| [SimplifySegmentsDistance](../../aspose.gis/driveroptions/simplifysegmentsdistance/) { get; set; } | 确定 [`SimplifySegments`](./simplifysegments/) 的距离。默认值为 `0`。 |
