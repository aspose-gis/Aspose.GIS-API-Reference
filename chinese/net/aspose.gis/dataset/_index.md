...
description: Aspose.Gis.Dataset 班级. 数据集是VectorLayer实例.
type: docs
weight: 80
...
| 姓名 | 描述 |
| --- | --- |
| virtual [CanCreateLayers](../../aspose.gis/dataset/cancreatelayers/) { get; } | 获取该数据集是否可以创建矢量图层的值。 |
| virtual [CanRemoveLayers](../../aspose.gis/dataset/canremovelayers/) { get; } | 获取该数据集是否可以去除矢量图层的值。 |
...
| virtual [CreateLayer](../../aspose.gis/dataset/createlayer/#createlayer)() | 创建一个新的矢量图层并打开它进行追加。 |
| virtual [CreateLayer](../../aspose.gis/dataset/createlayer/#createlayer_2)(SpatialReferenceSystem) | 创建一个新的矢量图层并打开它进行追加。 |
| virtual [CreateLayer](../../aspose.gis/dataset/createlayer/#createlayer_1)(DriverOptions, SpatialReferenceSystem) | 创建一个新的矢量图层并打开它进行追加。 |
| virtual [CreateLayer](../../aspose.gis/dataset/createlayer/#createlayer_4)(string, SpatialReferenceSystem) | 创建一个具有指定名称的新矢量图层并打开它进行追加。 |
| virtual [CreateLayer](../../aspose.gis/dataset/createlayer/#createlayer_3)(string, DriverOptions, SpatialReferenceSystem) | 创建一个具有指定名称的新矢量图层并打开它进行追加。 |
| [Dispose](../../aspose.gis/dataset/dispose/)() | 释放所使用的资源`Dataset`. |
...
| abstract [OpenLayer](../../aspose.gis/dataset/openlayer/)(string, DriverOptions) | 打开指定名称的层进行读取。 |
| abstract [OpenLayerAt](../../aspose.gis/dataset/openlayerat/)(int, DriverOptions) | 打开指定索引处的层进行读取。 |
