...
description: "IAttributesConverter 方法。根据目标图层的需要调整 FeatureAttribute"
type: docs
weight: 10
...
根据目标图层的需要调整一个[`FeatureAttribute`](../../featureattribute/)。
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| 属性 | FeatureAttribute | 源图层属性的副本。 |
| 操作 | AttributesConverterActions | 指定目标图层属性的可选操作。例如，允许我们排除我们的属性。 |
