...
description: "Aspose.Gis.Formats.Kml.KmlOptions 类。针对 KML 格式的驱动特定选项"
type: docs
weight: 2050
...
| [SymbolToReplaceInvalidChars](../../aspose.gis.formats.kml/kmloptions/symboltoreplaceinvalidchars/) { get; set; } | 确定在读取时使用哪个符号替换无效字符。如果值为 '\0'，则跳过替换。默认值为 '\0' 字符。 |
