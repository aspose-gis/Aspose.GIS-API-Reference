...
description: Aspose.Gis.Formats.Kml.KmlOptions 班级. KML 格式的特定于驱动程序的选项
type: docs
weight: 410
...
| 姓名 | 描述 |
| --- | --- |
| [AltitudeMode](../../aspose.gis.formats.kml/kmloptions/altitudemode/) { get; set; } | 允许您指定用于 KML 几何图形的 AltitudeModes |
| [AutoId](../../aspose.gis.formats.kml/kmloptions/autoid/) { get; set; } | 自动生成 ids |
...
| [DocumentId](../../aspose.gis.formats.kml/kmloptions/documentid/) { get; set; } | 用于指定根 'Document' node 的 id |
...
| [SymbolToReplaceInvalidChars](../../aspose.gis.formats.kml/kmloptions/symboltoreplaceinvalidchars/) { get; set; } | 确定在读取时将使用哪个符号替换无效字符。 如果值为“\0”，则跳过替换。默认值为 '\0' char. |
