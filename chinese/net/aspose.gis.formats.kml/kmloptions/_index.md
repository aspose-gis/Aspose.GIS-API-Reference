...
| [SymbolToReplaceInvalidChars](../../aspose.gis.formats.kml/kmloptions/symboltoreplaceinvalidchars) { get; set; } | 确定读取时将使用哪个符号替换无效字符。 如果值为“\0”，则跳过替换。默认值为 '\0' char. |
