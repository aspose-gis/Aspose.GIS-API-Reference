...
针对 Shapefile 格式的驱动程序特定选项。目前，驱动程序没有可自定义的选项。
...
| [IsIgnoreWrongData](../../aspose.gis.formats.shapefile/shapefileoptions/isignorewrongdata/) { get; set; } | 确定在解析错误数据时是抛出异常还是为其设置默认值 |
