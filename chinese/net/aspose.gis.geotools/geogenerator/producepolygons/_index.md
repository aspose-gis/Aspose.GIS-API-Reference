...
description: 使用给定数量的随机项目创建一个新的 IPolygon 枚举器所有这些项目都在给定范围内
type: docs
weight: 30
...
使用给定数量的随机项目创建一个新的 IPolygon 枚举器，所有这些项目都在给定范围内。
...
多边形数组（见枚举[`多边形`](../../../aspose.gis.geometries/ipolygon))
