...
description: "Aspose.Gis.Formats.TopoJson.TopoJsonOptions 类。TopoJSON 格式的驱动程序特定选项。"
type: docs
weight: 2370
...
| [QuantizationNumber](../../aspose.gis.formats.topojson/topojsonoptions/quantizationnumber/) { get; set; } | 指定用于在输出 TopoJSON 中量化坐标并对弧线进行增量编码的量化数值。 |
...
| [Transform](../../aspose.gis.formats.topojson/topojsonoptions/transform/) { get; set; } | 指定用于在输出 TopoJSON 中量化坐标并对弧线进行增量编码的变换对象。 |
