...
description: "Aspose.Gis.SpatialReferencing.ProjectedSpatialReferenceSystem 类。Projected SRS 是对地理 SRS 应用投影的结果。投影 SRS 可以是二维的或三维的。如果投影 SRS 是三维的，则它实际上是由二维投影 SRS 和一维垂直 SRS 组成的复合 SRS。"
type: docs
weight: 4670
...
| 名称 | 描述 |
| --- | --- |
| abstract [AngularUnit](../../aspose.gis.spatialreferencing/projectedspatialreferencesystem/angularunit/) { get; } | 单位，用于此 SRS 中的角度值以及 [`Projection`](./projection/) 的角度参数。匹配 [`Base`](./base/) 的角度单位。 |
...
| abstract [DimensionsCount](../../aspose.gis.spatialreferencing/projectedspatialreferencesystem/dimensionscount/) { get; } | 返回此 SRS 的维度计数。对于投影 SRS，这可以是：two - 如果这是单一投影 SRS；three - 如果这是复合 SRS，由单一二维投影 SRS 和垂直 SRS 组成，后者增加第三维度。 |
...
| [HasGeographicDatum](../../aspose.gis.spatialreferencing/projectedspatialreferencesystem/hasgeographicdatum/) { get; } | 返回 true，因为投影 SRS 始终具有本初子午线。 |
| [HasPrimeMeridian](../../aspose.gis.spatialreferencing/projectedspatialreferencesystem/hasprimemeridian/) { get; } | 返回 true，因为投影 SRS 始终具有本初子午线。 |
...
| abstract [Projection](../../aspose.gis.spatialreferencing/projectedspatialreferencesystem/projection/) { get; } | 投影，已对 [`Base`](./base/) 应用以获取此 SRS。 |
