...
description: "ProjectedSpatialReferenceSystem 属性。用于此 SRS 中角度值以及 Projection 的角度参数的单位。与 Base 的角度单位相匹配"
type: docs
weight: 10
...
用于此 SRS 中角度值以及 [`Projection`](../projection/) 的角度参数的单位。与 [`Base`](../base/) 的角度单位相匹配。
