...
description: 返回此 SRS 中的维度计数对于投影 SRS这可以是 二  如果这是单个投影 SRS 三  如果这是复合 SRS它由单维二维投影 SRS 和垂直 SRS 组成添加第三维
type: docs
weight: 50
...
返回此 SRS 中的维度计数。对于投影 SRS，这可以是： 二 - 如果这是单个投影 SRS。 三 - 如果这是复合 SRS，它由单维、二维、投影 SRS 和垂直 SRS 组成，添加第三维。
