...
description: Aspose.Gis.SpatialReferencing.VerticalSpatialReferenceSystem 班级. Vertical SRS 是描述高度坐标的一维 SRS
type: docs
weight: 2310
...
| override [GeographicDatum](../../aspose.gis.spatialreferencing/verticalspatialreferencesystem/geographicdatum/) { get; } | 投掷InvalidOperationException , 因为 Vertical SRS 没有地理数据. |
| override [HasGeographicDatum](../../aspose.gis.spatialreferencing/verticalspatialreferencesystem/hasgeographicdatum/) { get; } | 返回`false` , 因为 Vertical SRS 没有地理数据. |
...
| override [PrimeMeridian](../../aspose.gis.spatialreferencing/verticalspatialreferencesystem/primemeridian/) { get; } | 投掷InvalidOperationException ，因为垂直 SRS 没有本初子午线。 |
| override [Type](../../aspose.gis.spatialreferencing/verticalspatialreferencesystem/type/) { get; } | 返回Vertical. |
| [VerticalDatum](../../aspose.gis.spatialreferencing/verticalspatialreferencesystem/verticaldatum/) { get; } | 此 SRS 中使用的数据。 |
| [VerticalUnit](../../aspose.gis.spatialreferencing/verticalspatialreferencesystem/verticalunit/) { get; } | 此 SRS 中使用的单位。 |
...
| override [GetAxis](../../aspose.gis.spatialreferencing/verticalspatialreferencesystem/getaxis/)(int) | 得到[`Axis`](../axis/)描述维度. |
| override [GetUnit](../../aspose.gis.spatialreferencing/verticalspatialreferencesystem/getunit/)(int) | 得到[`Unit`](../unit/)维度. |
...
| override [Validate](../../aspose.gis.spatialreferencing/verticalspatialreferencesystem/validate/)(out string) | 确定此 SRS 是否有效。看[`Validate`](../spatialreferencesystem/validate/)有效性描述. |
