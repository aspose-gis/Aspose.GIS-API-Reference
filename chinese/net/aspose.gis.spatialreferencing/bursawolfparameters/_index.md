...
| 名称 | 描述 |
| --- | --- |
| [BursaWolfParameters](bursawolfparameters/#constructor)(double, double, double) | 创建 `BursaWolfParameters` 的新实例。 |
| [BursaWolfParameters](bursawolfparameters/#constructor_1)(double, double, double, double, double, double, double) | 创建 `BursaWolfParameters` 的新实例。 |
...
| [Dx](../../aspose.gis.spatialreferencing/bursawolfparameters/dx/) { get; } | Dx（米）。 |
| [Dy](../../aspose.gis.spatialreferencing/bursawolfparameters/dy/) { get; } | Dy（米）。 |
| [Dz](../../aspose.gis.spatialreferencing/bursawolfparameters/dz/) { get; } | Dz（米）。 |
| [IsNull](../../aspose.gis.spatialreferencing/bursawolfparameters/isnull/) { get; } | 确定此实例是否为[`Null`](./null/)。 |
