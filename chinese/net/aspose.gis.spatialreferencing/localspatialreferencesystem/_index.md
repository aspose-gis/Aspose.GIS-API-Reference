...
description: "Aspose.Gis.SpatialReferencing.LocalSpatialReferenceSystem 类。本地 SRS 将坐标关联到非地球的某个对象。"
type: docs
weight: 4630
...
| override [DimensionsCount](../../aspose.gis.spatialreferencing/localspatialreferencesystem/dimensionscount/) { get; } | 此 SRS 的维度数量。 |
...
| override [Validate](../../aspose.gis.spatialreferencing/localspatialreferencesystem/validate/)(out string) | 确定此 SRS 是否有效。参见 [`Validate`](../spatialreferencesystem/validate/) 获取有效性描述。 |
