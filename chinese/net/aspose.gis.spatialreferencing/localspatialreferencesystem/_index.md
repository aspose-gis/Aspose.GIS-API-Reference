...
description: Aspose.Gis.SpatialReferencing.LocalSpatialReferenceSystem 班级. 局部 SRS 相关坐标到某个物体而不是地球
type: docs
weight: 2180
...
| override [GeographicDatum](../../aspose.gis.spatialreferencing/localspatialreferencesystem/geographicdatum/) { get; } | 投掷InvalidOperationException 因为 Local SRS 没有地理数据. |
| override [HasGeographicDatum](../../aspose.gis.spatialreferencing/localspatialreferencesystem/hasgeographicdatum/) { get; } | 返回`false` 因为 Local SRS 没有地理数据. |
...
| override [PrimeMeridian](../../aspose.gis.spatialreferencing/localspatialreferencesystem/primemeridian/) { get; } | 投掷InvalidOperationException ，因为本地 SRS 没有本初子午线。 |
| override [Type](../../aspose.gis.spatialreferencing/localspatialreferencesystem/type/) { get; } | 返回Local. |
| [Unit](../../aspose.gis.spatialreferencing/localspatialreferencesystem/unit/) { get; } | 这个 SRS 的单位。 |
...
| override [GetAxis](../../aspose.gis.spatialreferencing/localspatialreferencesystem/getaxis/)(int) | 得到[`Axis`](../axis/)描述维度. |
| override [GetUnit](../../aspose.gis.spatialreferencing/localspatialreferencesystem/getunit/)(int) | 得到[`Unit`](./unit/)维度. |
...
| override [Validate](../../aspose.gis.spatialreferencing/localspatialreferencesystem/validate/)(out string) | 确定此 SRS 是否有效。看[`Validate`](../spatialreferencesystem/validate/)有效性描述. |
