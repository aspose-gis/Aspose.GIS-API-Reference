...
description: "GeographicSpatialReferenceSystem 属性。返回此 SRS 中的维度计数。对于地理 SRS，如果这是单一地理 SRS，则可以是 two；如果这是复合 SRS，由单一二维地理 SRS 和添加第三维度的垂直 SRS 组成，则可以是 three。"
type: docs
weight: 40
...
返回此坐标系的维度数量。对于地理坐标系，可能为：二维 - 如果这是单一的地理坐标系。三维 - 如果这是复合坐标系，由单一的二维地理坐标系和垂直坐标系组成，从而增加第三维度。
