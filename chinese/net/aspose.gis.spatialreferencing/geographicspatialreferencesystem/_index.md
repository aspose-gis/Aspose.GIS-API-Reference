...
description: "Aspose.Gis.SpatialReferencing.GeographicSpatialReferenceSystem 类。地理坐标系是一种基于经度和纬度的坐标系。地理坐标系可以是二维的或三维的。如果地理坐标系是三维的，则它实际上是由二维地理坐标系和垂直坐标系组成的复合坐标系。"
type: docs
weight: 4580
...
| abstract [DimensionsCount](../../aspose.gis.spatialreferencing/geographicspatialreferencesystem/dimensionscount/) { get; } | 返回此坐标系的维度计数。对于地理坐标系，这可能是：二维 - 如果这是单一的地理坐标系。三维 - 如果这是复合坐标系，由单一的二维地理坐标系和垂直坐标系组成，从而增加第三维度。 |
