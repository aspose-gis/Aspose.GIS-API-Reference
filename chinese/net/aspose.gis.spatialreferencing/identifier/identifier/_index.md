...
description: "Identifier 构造函数。创建新实例"
type: docs
weight: 10
url: /zh/net/aspose.gis.spatialreferencing/identifier/identifier/
---
...
| 异常 | 条件 |
| --- | --- |
| ArgumentNullException | *authorityName* 或 *authorityUniqueIdentifier* 为 `null`。 |
