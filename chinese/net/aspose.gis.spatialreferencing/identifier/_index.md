...
description: "Aspose.Gis.SpatialReferencing.Identifier 类。表示标识符——对象外部描述的引用。如果您从 WKT 创建 SRS，Identifier 对应于 AUTHORITY 关键字"
type: docs
weight: 4610
...
| 名称 | 描述 |
| --- | --- |
| [AuthorityName](../../aspose.gis.spatialreferencing/identifier/authorityname/) { get; } | 一个授权机构的名称，它提供了[`AuthorityUniqueIdentifier`](./authorityuniqueidentifier/)。 |
| [AuthorityUniqueIdentifier](../../aspose.gis.spatialreferencing/identifier/authorityuniqueidentifier/) { get; } | 一种在[`AuthorityName`](./authorityname/) 中唯一表示对象的方式。 |
...
| override [GetHashCode](../../aspose.gis.spatialreferencing/identifier/gethashcode/)() | 作为默认的哈希函数。 |
