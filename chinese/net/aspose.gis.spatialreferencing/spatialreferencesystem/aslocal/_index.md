...
description: 返回此 SRS 转换为LocalSpatialReferenceSystemaspose.gis.spatialreferencing/localspatialreferencesystem. 使用Typeaspose.gis.spatialreferencing/spatialreferencesystem/type找出是否可以转换
type: docs
weight: 60
