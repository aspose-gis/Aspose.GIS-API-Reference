...
description: "SpatialReferenceSystem 属性。返回此 SRS 转换为 GeocentricSpatialReferenceSystem。使用 Type 以确定是否可以进行转换"
type: docs
weight: 40
...
返回此 SRS 转换为 [`GeocentricSpatialReferenceSystem`](../../geocentricspatialreferencesystem/)。使用 [`Type`](../type/) 以确定是否可以进行转换。
