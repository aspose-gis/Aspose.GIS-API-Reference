...
description: "SpatialReferenceSystem 属性。返回此 SRS 是否为复合的，即两个 SRS 的联合。以下复合 SRS 中的 SRS 组合被视为有效：Geographic SRS + Vertical SRS，在这种情况下复合 SRS 的类型为 Geographic。Projected SRS + Vertical SRS，在这种情况下复合 SRS 的类型为 Projected。如果 SRS 的组合类型不同，复合 SRS 的类型将为 Unknown。"
type: docs
weight: 130
