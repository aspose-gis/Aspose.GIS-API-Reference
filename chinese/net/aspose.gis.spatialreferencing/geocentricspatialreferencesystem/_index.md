...
description: Aspose.Gis.SpatialReferencing.GeocentricSpatialReferenceSystem 班级. Geocentric SRS 是原点在地球中心的 3 维笛卡尔 SRS
type: docs
weight: 2090
...
| override [AsGeocentric](../../aspose.gis.spatialreferencing/geocentricspatialreferencesystem/asgeocentric/) { get; } | 返回这个。 |
...
| [AxisesOrder](../../aspose.gis.spatialreferencing/geocentricspatialreferencesystem/axisesorder/) { get; } | 此 SRS 中的轴顺序。 如果此 SRS 无效且轴方向错误，Invalid返回. |
| override [DimensionsCount](../../aspose.gis.spatialreferencing/geocentricspatialreferencesystem/dimensionscount/) { get; } | 返回 3，因为地心 SRS 始终是三维的。 |
| [EpsgCode](../../aspose.gis.spatialreferencing/identifiableobject/epsgcode/) { get; } | 如果此对象标识符是 EPSG 标识符 - 返回其代码。否则 - 返回 -1. |
| override [GeographicDatum](../../aspose.gis.spatialreferencing/geocentricspatialreferencesystem/geographicdatum/) { get; } | 返回此 SRS 的地理数据。 |
| override [HasGeographicDatum](../../aspose.gis.spatialreferencing/geocentricspatialreferencesystem/hasgeographicdatum/) { get; } | 返回`true` , 因为地心 SRS 总是有地理数据. |
| override [HasPrimeMeridian](../../aspose.gis.spatialreferencing/geocentricspatialreferencesystem/hasprimemeridian/) { get; } | 返回`true` , 因为地心 SRS 总是有本初子午线. |
...
| override [Type](../../aspose.gis.spatialreferencing/geocentricspatialreferencesystem/type/) { get; } | 返回Geocentric. |
...
| override [GetAxis](../../aspose.gis.spatialreferencing/geocentricspatialreferencesystem/getaxis/)(int) | 得到[`Axis`](../axis/)描述维度. |
| override [GetUnit](../../aspose.gis.spatialreferencing/geocentricspatialreferencesystem/getunit/)(int) | 得到[`Unit`](../unit/)维度. |
...
| override [Validate](../../aspose.gis.spatialreferencing/geocentricspatialreferencesystem/validate/)(out string) | 确定此 SRS 是否有效。看[`Validate`](../spatialreferencesystem/validate/)有效性描述. |
