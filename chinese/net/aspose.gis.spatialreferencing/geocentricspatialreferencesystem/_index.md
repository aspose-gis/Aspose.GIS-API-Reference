...
| override [DimensionsCount](../../aspose.gis.spatialreferencing/geocentricspatialreferencesystem/dimensionscount/) { get; } | 返回 3，因为 geocentric SRS 始终是三维的。 |
...
| override [HasGeographicDatum](../../aspose.gis.spatialreferencing/geocentricspatialreferencesystem/hasgeographicdatum/) { get; } | 返回 `true`，因为 geocentric SRS 始终具有地理基准。 |
| override [HasPrimeMeridian](../../aspose.gis.spatialreferencing/geocentricspatialreferencesystem/hasprimemeridian/) { get; } | 返回 `true`，因为 geocentric SRS 始终具有本初子午线。 |
...
| override [Validate](../../aspose.gis.spatialreferencing/geocentricspatialreferencesystem/validate/)(out string) | 确定此 SRS 是否有效。参见 [`Validate`](../spatialreferencesystem/validate/) 获取有效性描述。 |
