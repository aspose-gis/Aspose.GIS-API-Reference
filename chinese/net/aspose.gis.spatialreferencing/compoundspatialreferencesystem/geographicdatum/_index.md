...
description: "CompoundSpatialReferenceSystem 属性。返回此 SRS 的地理基准。如果 Head 和 Tail 都具有地理基准，则返回 Head 的地理基准。"
type: docs
weight: 50
...
返回此 SRS 的地理基准。如果 [`Head`](../head/) 和 [`Tail`](../tail/) 都具有地理基准，则返回 head 的地理基准。
