...
description: "Aspose.Gis.SpatialReferencing.CompoundSpatialReferenceSystem 类。复合 SRS 将两个底层 SRS 合并，且这两个都不能是复合的"
type: docs
weight: 4510
...
复合 SRS 将两个基础 SRS 组合在一起，且它们均不能是复合的。
...
| override [AsGeographic](../../aspose.gis.spatialreferencing/compoundspatialreferencesystem/asgeographic/) { get; } | 返回此 SRS 的地理表示。如果此复合 SRS 确实表示地理 SRS，则结果将是三维地理 SRS（具有经度、纬度、高度维度）。否则将抛出异常。 |
...
| override [AsProjected](../../aspose.gis.spatialreferencing/compoundspatialreferencesystem/asprojected/) { get; } | 返回此 SRS 的投影表示。如果此复合 SRS 确实表示投影 SRS，则结果将是三维投影 SRS（具有 X、Y、高度维度）。否则将抛出异常。 |
...
| override [HasGeographicDatum](../../aspose.gis.spatialreferencing/compoundspatialreferencesystem/hasgeographicdatum/) { get; } | 如果任一底层 SRS 具有地理基准，则复合 SRS 具有地理基准。 |
| override [HasPrimeMeridian](../../aspose.gis.spatialreferencing/compoundspatialreferencesystem/hasprimemeridian/) { get; } | 如果任一底层 SRS 具有本初子午线，则复合 SRS 具有本初子午线。 |
...
| override [Type](../../aspose.gis.spatialreferencing/compoundspatialreferencesystem/type/) { get; } | 此复合 SRS 的类型。如果该复合 SRS 由地理和垂直 SRS 组合而成，则为 Geographic；如果由投影和垂直 SRS 组合而成，则为 Projected。 |
...
| override [Validate](../../aspose.gis.spatialreferencing/compoundspatialreferencesystem/validate/)(out string) | 确定此 SRS 是否有效。参见 [`Validate`](../spatialreferencesystem/validate/) 获取有效性描述。 |
