...
description: "ImageMetadataReader 方法。它尝试查找 EXIF 中的标签 ImageWidth 和 ImageHeight，如果这些标签不存在，则返回 null"
type: docs
weight: 130
url: /zh/net/aspose.gis.imagemetadata/imagemetadatareader/trygetimagesize/
---
## ImageMetadataReader.TryGetImageSize method

尝试查找 EXIF 标签集 ImageWidth 和 ImageHeight，如果这些标签不存在则返回 null
