---
title: "类 InFileOptions"
second_title: "Aspose.GIS for .NET API 参考"
description: "Aspose.Gis.Formats.InFile.InFileOptions 类。针对 InFile 图层的驱动程序特定选项"
type: docs
weight: 2000
url: /zh/net/aspose.gis.formats.infile/infileoptions/
---
## InFileOptions class

针对 InFile 图层的驱动程序特定选项。
...
| 名称 | 描述 |
| --- | --- |
| [InFileOptions](infileoptions/)() | 创建新实例。 |

## 属性

| 名称 | 描述 |
| --- | --- |
| [ArrayAsString](../../aspose.gis.formats.infile/infileoptions/arrayasstring/) { get; set; } | 是否将字符串、整数或实数的 JSon 数组暴露为字符串。 |
| [AttributesSkip](../../aspose.gis.formats.infile/infileoptions/attributesskip/) { get; set; } | 控制属性的翻译：yes - 跳过所有属性 |
| [AutoId](../../aspose.gis.formats.infile/infileoptions/autoid/) { get; set; } | 自动生成 ID |
| [CloseLinearRing](../../aspose.gis/driveroptions/closelinearring/) { get; set; } | 确定是否在每个几何体中关闭未闭合的 LinearRing。默认值为 `false`。 |
| [CountOfFeatureInPart](../../aspose.gis.formats.infile/infileoptions/countoffeatureinpart/) { get; set; } | 文件每个部分的要素最大数量 |
| [CreateMidpoints](../../aspose.gis/driveroptions/createmidpoints/) { get; set; } | 确定是否在几何体的每个线段中间添加新点。默认值为 `false`。 |
| [DateAsString](../../aspose.gis.formats.infile/infileoptions/dateasstring/) { get; set; } | 是否将 JSon 日期/时间/日期时间 以字符串形式公开。 |
...
| [GeometryAsCollection](../../aspose.gis.formats.infile/infileoptions/geometryascollection/) { get; set; } | 控制几何体的平移：是 - 使用 GeometryCollection 类型包装几何体 |
...
| [NestedPropertiesSeparator](../../aspose.gis.formats.infile/infileoptions/nestedpropertiesseparator/) { get; set; } | 获取或设置用于分隔嵌套属性组件的字符串。默认是 "_"。 |
...
| [WriteUnsetAttribute](../../aspose.gis.formats.infile/infileoptions/writeunsetattribute/) { get; set; } | 是否通过添加 'null' 值来写入未设置的属性 |
