...
| 姓名 | 描述 |
| --- | --- |
| [VectorMapLayer](vectormaplayer#constructor)(FeaturesSequence) | 使用默认符号创建新实例。 |
| [VectorMapLayer](vectormaplayer#constructor_1)(FeaturesSequence, VectorSymbolizer) | 使用默认符号创建新实例。 |
| [VectorMapLayer](vectormaplayer#constructor_5)(VectorLayer, bool) | 使用默认符号创建新实例。 |
| [VectorMapLayer](vectormaplayer#constructor_2)(FeaturesSequence, VectorSymbolizer, Labeling) | 使用默认符号创建新实例。 |
