...
description: 地图是图层的集合可以通过Renderer./renderer.
type: docs
weight: 1620
...
地图是图层的集合，可以通过[`Renderer`](../renderer).
...
| [Resolution](../../aspose.gis.rendering/map/resolution) { get; set; } | 用于渲染此地图并在两者之间转换的分辨率[`Measurement`](../measurement).默认为 96。 |
...
| 姓名 | 描述 |
| --- | --- |
| [Add](../../aspose.gis.rendering/map/add#add)(FeaturesSequence) | 创建并添加一个[`VectorMapLayer`](../vectormaplayer)到地图。图层按附加顺序渲染。 |
| [Add](../../aspose.gis.rendering/map/add#add_4)(MapLayer) | 向地图添加图层。图层按附加顺序渲染。 |
| [Add](../../aspose.gis.rendering/map/add#add_1)(FeaturesSequence, VectorSymbolizer) | 创建并添加一个[`VectorMapLayer`](../vectormaplayer)到地图。图层按附加顺序渲染。 |
| [Add](../../aspose.gis.rendering/map/add#add_7)(VectorLayer, bool) | 创建一个[`VectorMapLayer`](../vectormaplayer)使用默认符号并将其添加到地图中。图层按附加顺序渲染。 |
| [Add](../../aspose.gis.rendering/map/add#add_2)(FeaturesSequence, VectorSymbolizer, Labeling) | 创建并添加一个[`VectorMapLayer`](../vectormaplayer)到地图。图层按附加顺序渲染。 |
...
| [Add](../../aspose.gis.rendering/map/add#add_6)(VectorLayer, VectorSymbolizer, bool) | 创建并添加一个[`VectorMapLayer`](../vectormaplayer)到地图。图层按附加顺序渲染。 |
| [Add](../../aspose.gis.rendering/map/add#add_5)(VectorLayer, VectorSymbolizer, Labeling, bool) | 创建并添加一个[`VectorMapLayer`](../vectormaplayer)到地图。图层按附加顺序渲染。 |
| [Dispose](../../aspose.gis.rendering/map/dispose)() | 处置资源。 |
| [GetEnumerator](../../aspose.gis.rendering/map/getenumerator)() | 返回一个遍历地图中图层的枚举器。 |
