...
| 名称 | 描述 |
| --- | --- |
| [BackgroundColor](../../aspose.gis.rendering/map/backgroundcolor/) { get; set; } | 地图的背景颜色。默认透明。 |
| [Count](../../aspose.gis.rendering/map/count/) { get; } | 获取地图中图层的数量。 |
| [Extent](../../aspose.gis.rendering/map/extent/) { get; set; } | 指定要渲染的地图边界。如果设置为 `null`，则在渲染期间计算范围，以包含所有图层中的所有几何体。 |
...
| [Resolution](../../aspose.gis.rendering/map/resolution/) { get; set; } | 用于渲染此地图并在 [`Measurement`](../measurement/) 之间转换的分辨率。默认值为 96。 |
...
| [Add](../../aspose.gis.rendering/map/add/#add_8)(VectorLayer, bool) | 创建一个带默认符号化器的 [`VectorMapLayer`](../vectormaplayer/)，并将其添加到地图。图层按添加顺序渲染。 |
...
| [Add](../../aspose.gis.rendering/map/add/#add_3)(RasterLayer, RasterColorizer, bool) | 创建一个带默认颜色化器的 [`RasterMapLayer`](../rastermaplayer/)，并将其添加到地图。 |
