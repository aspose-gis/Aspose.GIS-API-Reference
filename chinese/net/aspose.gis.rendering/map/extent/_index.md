...
description: "Map 属性。指定要渲染的地图边界。如果设置为 null，则在渲染期间计算范围，以包含所有图层中的所有几何体。"
type: docs
weight: 40
...
指定要渲染的地图边界。如果设置为 `null`，则在渲染期间计算范围，以包含所有图层中的所有几何体。
...
如果范围的空间参考系统不等于地图的空间参考系统，则在渲染期间范围会被转换到目标空间参考系统。
