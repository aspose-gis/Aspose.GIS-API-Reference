---
title: "类 PostGisOptions"
second_title: "Aspose.GIS for .NET API 参考"
description: "Aspose.Gis.Formats.PostGis.PostGisOptions 类。PostGis 格式的驱动特定选项。目前该驱动程序不提供可自定义的选项"
type: docs
weight: 2300
url: /zh/net/aspose.gis.formats.postgis/postgisoptions/
---
## PostGisOptions class

PostGis 格式的驱动程序特定选项。目前，驱动程序没有可自定义的选项。
...
| 名称 | 描述 |
| --- | --- |
| [PostGisOptions](postgisoptions/)() | 创建新实例。 |
...
| [SpatialReferenceSystemMode](../../aspose.gis/databasedriveroptions/spatialreferencesystemmode/) { get; set; } | 确定在将未知几何体的 SRS 添加到图层时，数据库应如何处理。默认值为 ThrowException。 |
