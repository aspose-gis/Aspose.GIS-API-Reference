...
| 名称 | 描述 |
| --- | --- |
| [MapOptions](mapoptions/)() | 默认构造函数。 |

## 属性

| 名称 | 描述 |
| --- | --- |
| [BackgroundColor](../../aspose.gis.geotools.layersmap/mapoptions/backgroundcolor/) { get; set; } | 地图的背景颜色。默认值为 System.Drawing.Color.Transparent。 |
...
| 名称 | 描述 |
| --- | --- |
| [SpatialReference](../../aspose.gis.geotools.layersmap/mapoptions/spatialreference/) | 空间参考。默认值为 Aspose.Gis.SpatialReferencing.SpatialReferenceSystem.WebMercator。 |
