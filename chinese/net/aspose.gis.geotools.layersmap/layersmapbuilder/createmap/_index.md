...
description: "LayersMapBuilder 方法。使用提供的选项创建地图，并将其渲染保存于 System.IO.MemoryStream 中"
type: docs
weight: 20
url: /zh/net/aspose.gis.geotools.layersmap/layersmapbuilder/createmap/
---
## LayersMapBuilder.CreateMap method

使用提供的选项创建地图，并将其渲染存储在 System.IO.MemoryStream 中。
