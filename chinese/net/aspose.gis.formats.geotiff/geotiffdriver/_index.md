...
| 姓名 | 描述 |
| --- | --- |
| override [CanOpenLayers](../../aspose.gis.formats.geotiff/geotiffdriver/canopenlayers) { get; } | 获取一个值，该值指示此驱动程序是否可以打开栅格图层。 |
...
| [OpenLayer](../../aspose.gis.formats.geotiff/geotiffdriver/openlayer#openlayer_1)(AbstractPath, GeoTiffOptions) | 打开一个层进行读取。 |
...
| [OpenLayer](../../aspose.gis.formats.geotiff/geotiffdriver/openlayer#openlayer_4)(string, GeoTiffOptions) | 打开一个层进行读取。 |
