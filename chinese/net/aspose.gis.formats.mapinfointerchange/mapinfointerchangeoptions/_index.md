...
description: Aspose.Gis.Formats.MapInfoInterchange.MapInfoInterchangeOptions 班级. MapInfo 交换格式的驱动程序特定选项
type: docs
weight: 590
...
| [TextStringAttribute](../../aspose.gis.formats.mapinfointerchange/mapinfointerchangeoptions/textstringattribute/) { get; set; } | 指定表示“文本”图形对象文本的属性名称。 |
