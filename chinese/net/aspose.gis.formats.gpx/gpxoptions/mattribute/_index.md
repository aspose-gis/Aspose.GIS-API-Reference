...
description: "GpxOptions 属性。确定哪个 GPX 属性将导出为航点、路线点和轨迹点的 M 坐标。行为与 ZAttribute 相同，默认值为 null。"
type: docs
weight: 20
...
确定哪个 GPX 属性将导出为航点、路线点和轨迹点的 “M” 坐标。行为与 [`ZAttribute`](../zattribute/) 相同，默认值为 `null`。
