...
description: Aspose.Gis.Rendering.Labelings命名空间提供用于配置矢量特征标注的类
type: docs
weight: 300
...
| [NullLabeling](./nulllabeling) | 的[`NullLabeling`](../aspose.gis.rendering.labelings/nulllabeling)跳过对其应用的几何图形的标记。 |
| [PointLabelPlacement](./pointlabelplacement) | 点标签放置将标签放置在几何中心附近。 |
| [RuleBasedLabeling](./rulebasedlabeling) | 根据用户定义的规则对要素应用标签。 |
| [SimpleLabeling](./simplelabeling) | 一个简单的标签会在每个特征上放置标签。 |
## 枚举
