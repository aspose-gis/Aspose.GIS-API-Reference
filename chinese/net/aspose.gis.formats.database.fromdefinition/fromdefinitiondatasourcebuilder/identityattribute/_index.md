...
description: "FromDefinitionDataSourceBuilder 方法。允许跟踪更改的必需设置"
type: docs
weight: 40
url: /zh/net/aspose.gis.formats.database.fromdefinition/fromdefinitiondatasourcebuilder/identityattribute/
---
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| 名称 | 字符串 | 特征的属性，将被视为唯一标识该特征。 |
| overwriteSameKey | Boolean | 如果此标志设置为 true，则新添加的具有与图层中已存在的唯一标识符相同的特征将覆盖当前特征，并且如果发现差异，数据将被读取为已更新。否则，将抛出异常。 |
