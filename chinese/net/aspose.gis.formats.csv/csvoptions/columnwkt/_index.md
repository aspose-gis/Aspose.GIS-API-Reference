...
description: "CsvOptions 属性。获取或设置包含用于表示几何的 WellKnown Text 的列名。默认值为 null"
type: docs
weight: 30
...
获取或设置用于表示几何体的 Well-Known Text 所在列的名称。默认值为 `null`。
...
如果列值为 `null` 或 `empty string`，则不会基于 Well-Known Text 创建几何对象。
