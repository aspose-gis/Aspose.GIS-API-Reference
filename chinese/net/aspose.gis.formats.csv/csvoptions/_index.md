...
description: Aspose.Gis.Formats.Csv.CsvOptions 班级. CSV 格式的驱动程序特定选项
type: docs
weight: 200
...
| [ColumnM](../../aspose.gis.formats.csv/csvoptions/columnm/) { get; set; } | 获取或设置包含 M 坐标值的列的名称。 默认为`null`. |
| [ColumnWkt](../../aspose.gis.formats.csv/csvoptions/columnwkt/) { get; set; } | 获取或设置包含 Well-Known Text 的列的名称，用于表示几何。 默认值为`null`. |
| [ColumnX](../../aspose.gis.formats.csv/csvoptions/columnx/) { get; set; } | 获取或设置包含 X 坐标值的列的名称。 默认为`null`. |
| [ColumnY](../../aspose.gis.formats.csv/csvoptions/columny/) { get; set; } | 获取或设置包含 Y 坐标值的列的名称。 默认为`null`. |
| [ColumnZ](../../aspose.gis.formats.csv/csvoptions/columnz/) { get; set; } | 获取或设置包含 Z 坐标值的列的名称。 默认为`null`. |
...
| [Delimiter](../../aspose.gis.formats.csv/csvoptions/delimiter/) { get; set; } | 获取或设置用作分隔值的分隔符的字符。 默认值为 ','。 |
| [DoubleQuoteEscape](../../aspose.gis.formats.csv/csvoptions/doublequoteescape/) { get; set; } | 获取或设置用作双引号转义符的字符。 默认值为 '"'。 |
...
| [StartLineNumber](../../aspose.gis.formats.csv/csvoptions/startlinenumber/) { get; set; } | 获取或设置一个从零开始的行数，在读取数据时将首先行。 默认值为 0. |
