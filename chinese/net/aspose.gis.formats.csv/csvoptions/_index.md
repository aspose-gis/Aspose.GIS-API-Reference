...
description: "Aspose.Gis.Formats.Csv.CsvOptions 类。CSV 格式的驱动特定选项"
type: docs
weight: 1700
...
| [ColumnWkt](../../aspose.gis.formats.csv/csvoptions/columnwkt/) { get; set; } | 获取或设置包含 Well-Known Text 用于表示几何体的列名。默认值为 `null`。 |
