...
| 姓名 | 描述 |
| --- | --- |
| [CircularString](circularstring#constructor)() | 初始化[`CircularString`](../circularstring)类的新实例。 |
| [CircularString](circularstring#constructor_1)(ICircularString) | 初始化[`CircularString`](../circularstring)类的新实例。 |
| [CircularString](circularstring#constructor_2)(IEnumerable&lt;IPoint&gt;) | 初始化[`CircularString`](../circularstring)类的新实例。 |
...
| [Count](../../aspose.gis.geometries/circularstring/count) { get; } | 获取[`CircularString`](../circularstring)中的点数。 |
...
| override [HasCurveGeometry](../../aspose.gis.geometries/circularstring/hascurvegeometry) { get; } | 获取一个值，该值指示此几何图形是还是包含曲线（非线性）几何图形。 |
| [HasM](../../aspose.gis.geometries/circularstring/hasm) { get; set; } | 获取该实例是否有M坐标的值。 |
...
| override [IsEmpty](../../aspose.gis.geometries/circularstring/isempty) { get; } | 获取一个值，该值指示此实例是否为空。 |
...
| [SpatialReferenceSystem](../../aspose.gis.geometries/circularstring/spatialreferencesystem) { get; set; } | 获取此实例的 SpatialReferenceSystem。 如果未设置 SpatialReferenceSystem，则此属性可以是`null`。 分配新的 SpatialReferenceSystem 不会执行任何坐标转换，只会更改参考。 |
...
| [Equals](../../aspose.gis.geometries/circularstring/equals#equals)(ICircularString) | 表示当前对象是否等于另一个同类型的对象。 |
| override [Equals](../../aspose.gis.geometries/circularstring/equals#equals_1)(object) | 判断指定对象是否等于当前对象。 |
...
| override [Reverse](../../aspose.gis.geometries/circularstring/reverse)() | 反转此[`CircularString`](../circularstring)中的点顺序。 |
...
| override [SetEmpty](../../aspose.gis.geometries/circularstring/setempty)() | 使[`Geometry`](../geometry)为空。 |
