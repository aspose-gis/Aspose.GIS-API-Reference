...
description: "Aspose.Gis.Geometries.Polygon 类。Polygon 是一个由 1 条外部边界和 0 条或多条内部边界定义的平面表面"
type: docs
weight: 2980
...
`Polygon` 是一个平面表面，由 1 条外部边界和 0 条或多条内部边界定义。
...
| 名称 | 描述 |
| --- | --- |
| [Polygon](polygon/#constructor)() | 初始化 `Polygon` 类的新实例。 |
| [Polygon](polygon/#constructor_1)(ILinearRing) | 初始化 `Polygon` 类的新实例。 |
| [Polygon](polygon/#constructor_2)(ILinearRing, IEnumerable&lt;ILinearRing&gt;) | 初始化 `Polygon` 类的新实例。 |
...
| override [GeometryType](../../aspose.gis.geometries/polygon/geometrytype/) { get; } | 获取几何体的类型。 |
| virtual [HasCurveGeometry](../../aspose.gis.geometries/geometry/hascurvegeometry/) { get; } | 获取一个值，指示此几何体是否为或包含曲线（非线性）几何体。 |
| override [HasM](../../aspose.gis.geometries/polygon/hasm/) { get; set; } | 获取一个值，指示此实例是否具有 M 坐标。 |
| override [HasZ](../../aspose.gis.geometries/polygon/hasz/) { get; set; } | 获取一个值，指示此实例是否具有 Z 坐标。 |
| [InteriorRingsCount](../../aspose.gis.geometries/polygon/interiorringscount/) { get; } | 获取内部环的数量。 |
...
| override [SpatialReferenceSystem](../../aspose.gis.geometries/polygon/spatialreferencesystem/) { get; set; } | 获取此实例的 SpatialReferenceSystem。此属性可以为 `null`，表示 SpatialReferenceSystem 未知。分配新的 SpatialReferenceSystem 不会执行任何坐标转换，只会更改引用。 |

## 方法

| 名称 | 描述 |
| --- | --- |
| [AddInteriorRing](../../aspose.gis.geometries/polygon/addinteriorring/)(ILinearRing) | 添加内部环。 |
...
| [Equals](../../aspose.gis.geometries/polygon/equals/#equals)(ICurvePolygon) | 确定指定的对象是否等于当前对象。 |
| [Equals](../../aspose.gis.geometries/polygon/equals/#equals_1)(IPolygon) | 确定指定的对象是否等于当前对象。 |
| override [Equals](../../aspose.gis.geometries/polygon/equals/#equals_2)(object) | 确定指定的对象是否等于当前对象。 |
...
| override [GetHashCode](../../aspose.gis.geometries/polygon/gethashcode/)() | 用作默认的哈希函数。 |
| [GetInteriorRing](../../aspose.gis.geometries/polygon/getinteriorring/)(int) | 按索引获取内部环。 |
| [GetLength](../../aspose.gis.geometries/geometry/getlength/)() | 计算此几何体的长度。 |
| override [GetPointOnSurface](../../aspose.gis.geometries/polygon/getpointonsurface/)() | 查找保证位于此多边形上的点。 |
...
| override [SetEmpty](../../aspose.gis.geometries/polygon/setempty/)() | 将此 [`Geometry`](../geometry/) 设为空。 |
...
| [ToEditable](../../aspose.gis.geometries/polygon/toeditable/#toeditable_1)() | 获取此几何对象的可编辑副本。（3 种方法） |
