...
description: APolygon./polygon是一个平面 由 1 个外部边界定义和 0 个或多个内部边界
type: docs
weight: 1090
...
A[`Polygon`](../polygon)是一个平面， 由 1 个外部边界定义和 0 个或多个内部边界。
...
| 姓名 | 描述 |
| --- | --- |
| [Polygon](polygon#constructor)() | 初始化[`Polygon`](../polygon)类的新实例。 |
| [Polygon](polygon#constructor_1)(ILinearRing) | 初始化[`Polygon`](../polygon)类的新实例。 |
| [Polygon](polygon#constructor_2)(ILinearRing, IEnumerable&lt;ILinearRing&gt;) | 初始化[`Polygon`](../polygon)类的新实例。 |
...
| override [HasM](../../aspose.gis.geometries/polygon/hasm) { get; set; } | 获取该实例是否有M坐标的值。 |
...
| override [IsEmpty](../../aspose.gis.geometries/polygon/isempty) { get; } | 获取一个值，该值指示此实例是否为空。 |
...
| override [SpatialReferenceSystem](../../aspose.gis.geometries/polygon/spatialreferencesystem) { get; set; } | 获取此实例的 SpatialReferenceSystem。 这个属性可以是`null`，是 SpatialReferenceSystem 是未知的。 分配新的 SpatialReferenceSystem 不会执行任何坐标转换，只会更改参考。 |

## 方法

| 姓名 | 描述 |
| --- | --- |
| [AddInteriorRing](../../aspose.gis.geometries/polygon/addinteriorring)(ILinearRing) | 添加内环。 |
...
| [Equals](../../aspose.gis.geometries/polygon/equals#equals)(ICurvePolygon) | 判断指定对象是否等于当前对象。 |
| [Equals](../../aspose.gis.geometries/polygon/equals#equals_1)(IPolygon) | 判断指定对象是否等于当前对象。 |
| override [Equals](../../aspose.gis.geometries/polygon/equals#equals_2)(object) | 判断指定对象是否等于当前对象。 |
...
| override [SetEmpty](../../aspose.gis.geometries/polygon/setempty)() | 使[`Geometry`](../geometry)为空。 |
