...
description: "Aspose.Gis.Geometries.Polygon 类。一个 Polygon 是由 1 条外部边界和 0 条或多条内部边界定义的平面表面"
type: docs
weight: 2980
...
一个 `Polygon` 是平面表面，由 1 条外部边界和 0 条或多条内部边界定义。
...
| [ExteriorRing](../../aspose.gis.geometries/polygon/exteriorring/) { get; set; } | 获取外部环。 |
...
| override [SpatialReferenceSystem](../../aspose.gis.geometries/polygon/spatialreferencesystem/) { get; set; } | 获取此实例的 SpatialReferenceSystem。此属性可以为 `null`，表示 SpatialReferenceSystem 未知。为 SpatialReferenceSystem 分配新值不会执行任何坐标转换，只会更改引用。 |
...
| override [GetHashCode](../../aspose.gis.geometries/polygon/gethashcode/)() | 作为默认的哈希函数。 |
| [GetInteriorRing](../../aspose.gis.geometries/polygon/getinteriorring/)(int) | 通过索引获取内部环。 |
| [GetLength](../../aspose.gis.geometries/geometry/getlength/)() | 计算此几何体的长度。 |
| override [GetPointOnSurface](../../aspose.gis.geometries/polygon/getpointonsurface/)() | 查找保证位于该多边形上的点。 |
