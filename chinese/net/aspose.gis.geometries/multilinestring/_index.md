...
description: "Aspose.Gis.Geometries.MultiLineString 类。MultiLineString 是一个一维的 GeometryCollection，其元素是 LineString。"
type: docs
weight: 2930
...
`MultiLineString` 是一个一维的 [`GeometryCollection`](../geometrycollection/)，其元素是 [`LineString`](../linestring/)。
