...
| 姓名 | 描述 |
| --- | --- |
| [MultiLineString](multilinestring)() | 初始化[`MultiLineString`](../multilinestring)类. |
...
| [Dimension](../../aspose.gis.geometries/multicurve/dimension) { get; } | 获取这个的拓扑维度[`Geometry`](../geometry). |
...
| [ToLinearGeometry](../../aspose.gis.geometries/multicurve/tolineargeometry)() | 使用默认值获取此几何图形的近似或等效非曲线版本`宽容`. (3 methods) |
| [ToLinearGeometry](../../aspose.gis.geometries/multicurve/tolineargeometry)(double) | 使用指定的获取此几何图形的近似或等效非曲线版本`宽容`. (3 methods) |
