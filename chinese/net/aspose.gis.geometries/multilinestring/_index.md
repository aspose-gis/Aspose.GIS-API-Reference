...
| 姓名 | 描述 |
| --- | --- |
| [MultiLineString](multilinestring)() | 初始化[`MultiLineString`](../multilinestring)类的新实例。 |
...
| [Dimension](../../aspose.gis.geometries/multicurve/dimension) { get; } | 获取此Geometry的拓扑维度。 |
| override [GeometryType](../../aspose.gis.geometries/multilinestring/geometrytype) { get; } | 获取几何的类型。 |
...
| virtual [IsClosed](../../aspose.gis.geometries/multicurve/isclosed) { get; } | 确定这条曲线是否闭合。 |
...
| [Equals](../../aspose.gis.geometries/geometrycollection/equals)(IGeometryCollection) | 表示当前对象是否等于另一个同类型的对象。 |
| override [Equals](../../aspose.gis.geometries/geometrycollection/equals)(object) | 判断指定对象是否等于当前对象。 |
...
| [ReplacePolygonsByLines](../../aspose.gis.geometries/geometrycollection/replacepolygonsbylines)() | 获取表示为此几何图形的线的多边形。 (2 methods) |
...
| [ToEditable](../../aspose.gis.geometries/multilinestring/toeditable#toeditable_3)() | 获取此几何图形的可编辑副本。 (4 methods) |
| [ToEditable&lt;T&gt;](../../aspose.gis.geometries/geometry/toeditable)() | 获取此几何图形的可编辑副本。 |
| [ToLinearGeometry](../../aspose.gis.geometries/multicurve/tolineargeometry)() | 使用默认` 公差` 获取此几何图形的近似或等效非曲线版本。 (3 methods) |
| [ToLinearGeometry](../../aspose.gis.geometries/multicurve/tolineargeometry)(double) | 使用指定的` 容差` 获取此几何图形的近似或等效非曲线版本。 (3 methods) |
