---
title: "类 MultiLineString"
second_title: "Aspose.GIS for .NET API 参考"
description: "Aspose.Gis.Geometries.MultiLineString 类。MultiLineString 是一种一维的 GeometryCollection，其元素为 LineString。"
type: docs
weight: 2930
...
A `MultiLineString` 是一个一维的 [`GeometryCollection`](../geometrycollection/)，其元素为 [`LineString`](../linestring/)。
...
| 名称 | 描述 |
| --- | --- |
| [MultiLineString](multilinestring/)() | 初始化 `MultiLineString` 类的新实例。 |
...
| [Dimension](../../aspose.gis.geometries/multicurve/dimension/) { get; } | 获取此 [`Geometry`](../geometry/) 的拓扑维度。 |
| override [GeometryType](../../aspose.gis.geometries/multilinestring/geometrytype/) { get; } | 获取几何体的类型。 |
...
| virtual [IsClosed](../../aspose.gis.geometries/multicurve/isclosed/) { get; } | 确定此曲线是否闭合。 |
...
| [ToEditable](../../aspose.gis.geometries/multilinestring/toeditable/#toeditable_3)() | 获取此几何对象的可编辑副本。（4 种方法） |
| [ToEditable&lt;T&gt;](../../aspose.gis.geometries/geometry/toeditable/)() | 获取此几何体的可编辑副本。 |
| [ToLinearGeometry](../../aspose.gis.geometries/multicurve/tolineargeometry/)() | 使用默认的 `tolerance` 获取此几何对象的近似或等效的非曲线版本。（3 种方法） |
| [ToLinearGeometry](../../aspose.gis.geometries/multicurve/tolineargeometry/)(double) | 使用指定的 `tolerance` 获取此几何对象的近似或等效的非曲线版本。（3 种方法） |
