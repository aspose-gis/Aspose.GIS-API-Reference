---
title: "类 MultiSurface"
second_title: "Aspose.GIS for .NET API 参考"
description: "Aspose.Gis.Geometries.MultiSurface 类。一个 MultiSurface 是一维 GeometryCollection，其元素为 ISurfaces"
type: docs
weight: 2960
...
一个 `MultiSurface` 是一维 [`GeometryCollection`](../geometrycollection/)，其元素为 [`ISurface`](../isurface/)。
...
| 名称 | 描述 |
| --- | --- |
| [MultiSurface](multisurface/)() | 初始化 `MultiSurface` 类的新实例。 |
...
| override [GeometryType](../../aspose.gis.geometries/multisurface/geometrytype/) { get; } | 获取几何体的类型。 |
...
| [ToEditable](../../aspose.gis.geometries/multisurface/toeditable/#toeditable_2)() | 获取此几何对象的可编辑副本。（3 种方法） |
| [ToEditable&lt;T&gt;](../../aspose.gis.geometries/geometry/toeditable/)() | 获取此几何体的可编辑副本。 |
| [ToLinearGeometry](../../aspose.gis.geometries/multisurface/tolineargeometry/#tolineargeometry_4)() | 使用默认的 `tolerance` 获取此几何对象的近似或等效的非曲线版本。（3 种方法） |
| [ToLinearGeometry](../../aspose.gis.geometries/multisurface/tolineargeometry/#tolineargeometry_5)(double) | 使用指定的 `tolerance` 获取此几何对象的近似或等效的非曲线版本。（3 种方法） |
