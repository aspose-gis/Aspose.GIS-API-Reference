...
description: AMultiSurface./multisurface是一维GeometryCollection./geometrycollection其元素是ISurface./isurfaces
type: docs
weight: 1070
...
A[`MultiSurface`](../multisurface)是一维[`GeometryCollection`](../geometrycollection)其元素是[`ISurface`](../isurface)s。
...
| 姓名 | 描述 |
| --- | --- |
| [MultiSurface](multisurface)() | 初始化[`MultiSurface`](../multisurface)类的新实例。 |
...
| [ToLinearGeometry](../../aspose.gis.geometries/multisurface/tolineargeometry#tolineargeometry_4)() | 使用默认` 公差` 获取此几何图形的近似或等效非曲线版本。 (3 methods) |
| [ToLinearGeometry](../../aspose.gis.geometries/multisurface/tolineargeometry#tolineargeometry_5)(double) | 使用指定的` 容差` 获取此几何图形的近似或等效非曲线版本。 (3 methods) |
