...
description: "Aspose.Gis.Geometries.MultiSurface 类。MultiSurface 是一个一维 GeometryCollection，其元素为 ISurfaces"
type: docs
weight: 2960
...
`MultiSurface` 是一个一维 [`GeometryCollection`](../geometrycollection/)，其元素为 [`ISurface`](../isurface/)。
