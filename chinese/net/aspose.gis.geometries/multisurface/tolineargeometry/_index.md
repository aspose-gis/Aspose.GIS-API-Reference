...
description: "MultiSurface 方法。使用默认容差获取此几何体的近似或等价的非曲线版本"
type: docs
weight: 60
...
A [`IMultiPolygon`](../../imultipolygon/)，其近似或等价于此 [`IMultiSurface`](../../imultisurface/)：  如果此对象本身是 [`IMultiPolygon`](../../imultipolygon/)，结果等价于此对象；如果此对象不是 [`IMultiPolygon`](../../imultipolygon/)，则所有表面都会线性化并创建新的 `IMultiPolygon`。
