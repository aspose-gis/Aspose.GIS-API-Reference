...
| [ToLinearGeometry](../../aspose.gis.geometries/surface/tolineargeometry/#tolineargeometry_2)() | 获取此几何体的近似或等效的非曲线版本，使用默认的 `tolerance`。（2 个方法） |
| [ToLinearGeometry](../../aspose.gis.geometries/surface/tolineargeometry/#tolineargeometry_3)(double) | 获取此几何体的近似或等效的非曲线版本，使用指定的 `tolerance`。（2 个方法） |
