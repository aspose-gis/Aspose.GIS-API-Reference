...
description: "Aspose.Gis.Geometries.Surface 类。Surface 是一种二维几何对象"
type: docs
weight: 2990
...
| abstract [SpatialReferenceSystem](../../aspose.gis.geometries/geometry/spatialreferencesystem/) { get; set; } | 获取此实例的 SpatialReferenceSystem。此属性可以为 `null`，表示 SpatialReferenceSystem 未知。分配新的 SpatialReferenceSystem 不会执行任何坐标转换，只会更改引用。 |
...
| abstract [GetPointOnSurface](../../aspose.gis.geometries/surface/getpointonsurface/)() | 查找一个保证位于此表面的点。 |
...
| virtual [SetEmpty](../../aspose.gis.geometries/geometry/setempty/)() | 将此 [`Geometry`](../geometry/) 设为空。 |
...
| [ToEditable](../../aspose.gis.geometries/surface/toeditable/#toeditable_1)() | 获取此几何体的可编辑副本。（2 种方法） |
| [ToEditable&lt;T&gt;](../../aspose.gis.geometries/geometry/toeditable/)() | 获取此几何体的可编辑副本。 |
| [ToLinearGeometry](../../aspose.gis.geometries/surface/tolineargeometry/#tolineargeometry_2)() | 使用默认的 `tolerance` 获取此几何体的近似或等效的非曲线版本。（2 个方法） |
| [ToLinearGeometry](../../aspose.gis.geometries/surface/tolineargeometry/#tolineargeometry_3)(double) | 使用指定的 `tolerance` 获取此几何体的近似或等效的非曲线版本。（2 个方法） |
