...
description: "Aspose.Gis.Geometries.Curve 类。Curve 是一系列点的序列"
type: docs
weight: 2680
...
| abstract [Reverse](../../aspose.gis.geometries/curve/reverse/)() | 反转此曲线。 |
...
| [ToEditable](../../aspose.gis.geometries/curve/toeditable/#toeditable)() | 获取此几何体的可编辑副本。（2 种方法） |
| [ToEditable&lt;T&gt;](../../aspose.gis.geometries/geometry/toeditable/)() | 获取此几何体的可编辑副本。 |
| [ToLinearGeometry](../../aspose.gis.geometries/curve/tolineargeometry/#tolineargeometry_2)() | 使用默认的 `tolerance` 获取此几何体的近似或等效的非曲线版本。（2 个方法） |
| [ToLinearGeometry](../../aspose.gis.geometries/curve/tolineargeometry/#tolineargeometry_3)(double) | 使用指定的 `tolerance` 获取此几何体的近似或等效的非曲线版本。（2 个方法） |
