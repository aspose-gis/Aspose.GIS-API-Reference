...
description: ACurve./curve是一个点序列
type: docs
weight: 790
...
| [ToLinearGeometry](../../aspose.gis.geometries/curve/tolineargeometry#tolineargeometry_2)() | 使用默认` 公差` 获取此几何图形的近似或等效非曲线版本。 (2 methods) |
| [ToLinearGeometry](../../aspose.gis.geometries/curve/tolineargeometry#tolineargeometry_3)(double) | 使用指定的` 容差` 获取此几何图形的近似或等效非曲线版本。 (2 methods) |
