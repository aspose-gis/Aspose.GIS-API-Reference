...
一个 [`IMultiLineString`](../../imultilinestring/)，其近似或等价于此 [`IMultiCurve`](../../imulticurve/)：如果此对象本身就是 [`IMultiLineString`](../../imultilinestring/)，结果等同于此对象；如果此对象不是 [`IMultiLineString`](../../imultilinestring/)，则所有曲线被线性化并创建新的 `IMultiLineString`
