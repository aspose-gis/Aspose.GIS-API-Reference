...
description: "Aspose.Gis.Geometries.MultiCurve 类。MultiCurve 是一种一维 GeometryCollection，其元素为 Curve。"
type: docs
weight: 2920
...
`MultiCurve` 是一个一维的 [`GeometryCollection`](../geometrycollection/)，其元素为 [`Curve`](../curve/)。
...
| 名称 | 描述 |
| --- | --- |
| [MultiCurve](multicurve/)() | 初始化 `MultiCurve` 类的新实例。 |
...
| override [GeometryType](../../aspose.gis.geometries/multicurve/geometrytype/) { get; } | 获取几何体的类型。 |
...
| [ToEditable](../../aspose.gis.geometries/multicurve/toeditable/#toeditable_2)() | 获取此几何对象的可编辑副本。（3 种方法） |
| [ToEditable&lt;T&gt;](../../aspose.gis.geometries/geometry/toeditable/)() | 获取此几何体的可编辑副本。 |
| [ToLinearGeometry](../../aspose.gis.geometries/multicurve/tolineargeometry/#tolineargeometry_4)() | 使用默认的 `tolerance` 获取此几何对象的近似或等效的非曲线版本。（3 种方法） |
| [ToLinearGeometry](../../aspose.gis.geometries/multicurve/tolineargeometry/#tolineargeometry_5)(double) | 使用指定的 `tolerance` 获取此几何对象的近似或等效的非曲线版本。（3 种方法） |
