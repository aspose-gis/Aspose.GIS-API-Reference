...
| 姓名 | 描述 |
| --- | --- |
| [MultiCurve](multicurve)() | 初始化[`MultiCurve`](../multicurve)类的新实例。 |
...
| override [GeometryType](../../aspose.gis.geometries/multicurve/geometrytype) { get; } | 获取几何的类型。 |
...
| [ToEditable](../../aspose.gis.geometries/multicurve/toeditable#toeditable_2)() | 获取此几何图形的可编辑副本。 (3 methods) |
| [ToEditable&lt;T&gt;](../../aspose.gis.geometries/geometry/toeditable)() | 获取此几何图形的可编辑副本。 |
| [ToLinearGeometry](../../aspose.gis.geometries/multicurve/tolineargeometry#tolineargeometry_4)() | 使用默认` 公差` 获取此几何图形的近似或等效非曲线版本。 (3 methods) |
| [ToLinearGeometry](../../aspose.gis.geometries/multicurve/tolineargeometry#tolineargeometry_5)(double) | 使用指定的` 容差` 获取此几何图形的近似或等效非曲线版本。 (3 methods) |
