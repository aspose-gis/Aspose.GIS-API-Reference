...
| 姓名 | 描述 |
| --- | --- |
| [MultiCurve](multicurve)() | 初始化[`MultiCurve`](../multicurve)类. |
...
| [ToLinearGeometry](../../aspose.gis.geometries/multicurve/tolineargeometry#tolineargeometry_4)() | 使用默认值获取此几何图形的近似或等效非曲线版本`宽容`. (3 methods) |
| [ToLinearGeometry](../../aspose.gis.geometries/multicurve/tolineargeometry#tolineargeometry_5)(double) | 使用指定的获取此几何图形的近似或等效非曲线版本`宽容`. (3 methods) |
