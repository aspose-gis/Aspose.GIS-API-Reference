...
一个[`IMultiLineString`](../../imultilinestring/)，其近似或等价于此[`IMultiCurve`](../)：  如果此对象本身是[`IMultiLineString`](../../imultilinestring/)，结果等同于此对象；如果此对象不是[`IMultiLineString`](../../imultilinestring/)，则所有曲线被线性化并创建新的 `IMultiLineString`。
