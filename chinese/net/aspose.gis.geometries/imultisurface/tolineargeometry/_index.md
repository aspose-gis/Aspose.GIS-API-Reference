...
一个[`IMultiPolygon`](../../imultipolygon/)，其近似或等价于此[`IMultiSurface`](../)：如果此对象本身是[`IMultiPolygon`](../../imultipolygon/)，结果等同于此对象；如果此对象不是[`IMultiPolygon`](../../imultipolygon/)，则所有表面被线性化并创建新的 `IMultiPolygon`。
