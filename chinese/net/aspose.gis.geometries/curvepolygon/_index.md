...
| 姓名 | 描述 |
| --- | --- |
| [CurvePolygon](curvepolygon#constructor)() | 初始化[`CurvePolygon`](../curvepolygon)类. |
| [CurvePolygon](curvepolygon#constructor_1)(ICurve) | 初始化[`CurvePolygon`](../curvepolygon)类. |
| [CurvePolygon](curvepolygon#constructor_2)(ICurve, IEnumerable&lt;ICurve&gt;) | 初始化[`CurvePolygon`](../curvepolygon)类. |
...
| override [HasCurveGeometry](../../aspose.gis.geometries/curvepolygon/hascurvegeometry) { get; } | 获取一个值，该值指示此几何图形是否是或包含曲线（非线性）几何图形。 |
| [HasM](../../aspose.gis.geometries/curvepolygon/hasm) { get; set; } | 获取一个值，表示这个实例是否有M坐标。 |
| [HasZ](../../aspose.gis.geometries/curvepolygon/hasz) { get; set; } | 获取一个值，该值指示此实例是否具有 Z 坐标。 |
| [InteriorRingsCount](../../aspose.gis.geometries/curvepolygon/interiorringscount) { get; } | 获取内环数。 |
| override [IsEmpty](../../aspose.gis.geometries/curvepolygon/isempty) { get; } | 获取一个指示此实例是否为空的值。 |
...
| [SpatialReferenceSystem](../../aspose.gis.geometries/curvepolygon/spatialreferencesystem) { get; set; } | 获取该实例的SpatialReferenceSystem。 该属性可以是`null` , 是 SpatialReferenceSystem 是未知的。 分配新的 SpatialReferenceSystem 不会进行任何坐标变换，只会改变参考。 |

## 方法

| 姓名 | 描述 |
| --- | --- |
| [AddInteriorRing](../../aspose.gis.geometries/curvepolygon/addinteriorring)(ICurve) | 添加一个内环。 |
...
| [Equals](../../aspose.gis.geometries/curvepolygon/equals#equals)(ICurvePolygon) | 指示当前对象是否等于另一个相同类型的对象。 |
...
| override [SetEmpty](../../aspose.gis.geometries/curvepolygon/setempty)() | 做这个[`Geometry`](../geometry)空的. |
