---
title: "类 CurvePolygon"
second_title: "Aspose.GIS for .NET API 参考"
description: "Aspose.Gis.Geometries.CurvePolygon 类。由 1 条外部边界和 0 条或多条内部边界定义的平面表面。"
type: docs
weight: 2690
url: /zh/net/aspose.gis.geometries/curvepolygon/
---
## CurvePolygon class
...
| 名称 | 描述 |
| --- | --- |
| [CurvePolygon](curvepolygon/#constructor)() | 初始化 `CurvePolygon` 类的新实例。 |
| [CurvePolygon](curvepolygon/#constructor_1)(ICurve) | 初始化 `CurvePolygon` 类的新实例。 |
| [CurvePolygon](curvepolygon/#constructor_2)(ICurve, IEnumerable&lt;ICurve&gt;) | 初始化 `CurvePolygon` 类的新实例。 |
...
| [Dimension](../../aspose.gis.geometries/surface/dimension/) { get; } | 获取此 [`Geometry`](../geometry/) 的拓扑维度。 |
| [ExteriorRing](../../aspose.gis.geometries/curvepolygon/exteriorring/) { get; set; } | 获取外部环。 |
| override [GeometryType](../../aspose.gis.geometries/curvepolygon/geometrytype/) { get; } | 获取几何体的类型。 |
| override [HasCurveGeometry](../../aspose.gis.geometries/curvepolygon/hascurvegeometry/) { get; } | 获取一个值，指示此几何体是否为或包含曲线（非线性）几何体。 |
| [HasM](../../aspose.gis.geometries/curvepolygon/hasm/) { get; set; } | 获取一个值，指示此实例是否具有 M 坐标。 |
| [HasZ](../../aspose.gis.geometries/curvepolygon/hasz/) { get; set; } | 获取一个值，指示此实例是否具有 Z 坐标。 |
| [InteriorRingsCount](../../aspose.gis.geometries/curvepolygon/interiorringscount/) { get; } | 获取内部环的数量。 |
| override [IsEmpty](../../aspose.gis.geometries/curvepolygon/isempty/) { get; } | 获取一个值，指示此实例是否为空。 |
...
| [SpatialReferenceSystem](../../aspose.gis.geometries/curvepolygon/spatialreferencesystem/) { get; set; } | 获取此实例的 SpatialReferenceSystem。此属性可以为 `null`，表示 SpatialReferenceSystem 未知。为 SpatialReferenceSystem 分配新值不会执行任何坐标转换，只会更改引用。 |

## 方法

| 名称 | 描述 |
| --- | --- |
| [AddInteriorRing](../../aspose.gis.geometries/curvepolygon/addinteriorring/)(ICurve) | 添加内部环。 |
...
| override [Clone](../../aspose.gis.geometries/curvepolygon/clone/)() | 克隆此实例。 |
...
| [Equals](../../aspose.gis.geometries/curvepolygon/equals/#equals)(ICurvePolygon) | 指示当前对象是否等于同类型的另一个对象。 |
| override [Equals](../../aspose.gis.geometries/curvepolygon/equals/#equals_1)(object) | 确定指定对象是否等于当前对象。 |
...
| override [GetHashCode](../../aspose.gis.geometries/curvepolygon/gethashcode/)() | 作为默认的哈希函数。 |
| [GetInteriorRing](../../aspose.gis.geometries/curvepolygon/getinteriorring/)(int) | 通过索引获取内部环。 |
| [GetLength](../../aspose.gis.geometries/geometry/getlength/)() | 计算此几何体的长度。 |
| override [GetPointOnSurface](../../aspose.gis.geometries/curvepolygon/getpointonsurface/)() | 查找一个保证位于此曲面多边形上的点。 |
...
| override [SetEmpty](../../aspose.gis.geometries/curvepolygon/setempty/)() | 将此 [`Geometry`](../geometry/) 设为空。 |
...
| [ToEditable](../../aspose.gis.geometries/curvepolygon/toeditable/#toeditable)() | 获取此几何对象的可编辑副本。（3 种方法） |
| [ToEditable&lt;T&gt;](../../aspose.gis.geometries/geometry/toeditable/)() | 获取此几何体的可编辑副本。 |
| [ToLinearGeometry](../../aspose.gis.geometries/surface/tolineargeometry/)() | 获取此几何体的近似或等效的非曲线版本，使用默认的 `tolerance`。（2 个方法） |
| [ToLinearGeometry](../../aspose.gis.geometries/surface/tolineargeometry/)(double) | 获取此几何体的近似或等效的非曲线版本，使用指定的 `tolerance`。（2 个方法） |
...
| [operator ==](../../aspose.gis.geometries/curvepolygon/op_equality/) | 实现运算符 ==。 |
| [operator !=](../../aspose.gis.geometries/curvepolygon/op_inequality/) | 实现运算符 !=。 |
