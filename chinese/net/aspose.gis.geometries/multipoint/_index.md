...
description: AMultiPoint./multipoint是一维GeometryCollection./geometrycollection 其元素是Point./points
type: docs
weight: 1050
...
A[`MultiPoint`](../multipoint)是一维[`GeometryCollection`](../geometrycollection) 其元素是[`Point`](../point)s。
...
| 姓名 | 描述 |
| --- | --- |
| [MultiPoint](multipoint)() | 初始化[`MultiPoint`](../multipoint)类的新实例。 |
...
| [Dimension](../../aspose.gis.geometries/multipoint/dimension) { get; } | 获取此Geometry的拓扑维度。 |
| override [GeometryType](../../aspose.gis.geometries/multipoint/geometrytype) { get; } | 获取几何的类型。 |
...
| [ToEditable](../../aspose.gis.geometries/multipoint/toeditable#toeditable_2)() | 获取此几何图形的可编辑副本。 (3 methods) |
| [ToEditable&lt;T&gt;](../../aspose.gis.geometries/geometry/toeditable)() | 获取此几何图形的可编辑副本。 |
| [ToLinearGeometry](../../aspose.gis.geometries/geometrycollection/tolineargeometry)() | 使用默认` 公差` 获取此几何图形的近似或等效非曲线版本。 (2 methods) |
| [ToLinearGeometry](../../aspose.gis.geometries/geometrycollection/tolineargeometry)(double) | 使用指定的` 容差` 获取此几何图形的近似或等效非曲线版本。 (2 methods) |
