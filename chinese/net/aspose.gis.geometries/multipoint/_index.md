...
description: "Aspose.Gis.Geometries.MultiPoint 类。一个 MultiPoint 是一维 GeometryCollection，其元素为 Points"
type: docs
weight: 2940
url: /zh/net/aspose.gis.geometries/multipoint/
---
## MultiPoint class

一个 `MultiPoint` 是一维 [`GeometryCollection`](../geometrycollection/)，其元素为 [`Point`](../point/)。
...
| 名称 | 描述 |
| --- | --- |
| [MultiPoint](multipoint/)() | 初始化 `MultiPoint` 类的新实例。 |
...
| [Dimension](../../aspose.gis.geometries/multipoint/dimension/) { get; } | 获取此 [`Geometry`](../geometry/) 的拓扑维度。 |
| override [GeometryType](../../aspose.gis.geometries/multipoint/geometrytype/) { get; } | 获取几何体的类型。 |
...
| override [Clone](../../aspose.gis.geometries/multipoint/clone/)() | 克隆此实例。 |
...
| [ToEditable](../../aspose.gis.geometries/multipoint/toeditable/#toeditable_2)() | 获取此几何对象的可编辑副本。（3 种方法） |
| [ToEditable&lt;T&gt;](../../aspose.gis.geometries/geometry/toeditable/)() | 获取此几何体的可编辑副本。 |
| [ToLinearGeometry](../../aspose.gis.geometries/geometrycollection/tolineargeometry/)() | 获取此几何体的近似或等效的非曲线版本，使用默认的 `tolerance`。（2 个方法） |
| [ToLinearGeometry](../../aspose.gis.geometries/geometrycollection/tolineargeometry/)(double) | 获取此几何体的近似或等效的非曲线版本，使用指定的 `tolerance`。（2 个方法） |
