...
description: 一个MultiPoint./multipoint是一维的GeometryCollection./geometrycollection 的元素是Point./points.
type: docs
weight: 1060
...
一个[`MultiPoint`](../multipoint)是一维的[`GeometryCollection`](../geometrycollection) 的元素是[`Point`](../point)s.
...
| 姓名 | 描述 |
| --- | --- |
| [MultiPoint](multipoint)() | 初始化[`MultiPoint`](../multipoint)类. |
...
| [Dimension](../../aspose.gis.geometries/multipoint/dimension) { get; } | 获取这个的拓扑维度[`Geometry`](../geometry). |
...
| [ToLinearGeometry](../../aspose.gis.geometries/geometrycollection/tolineargeometry)() | 使用默认值获取此几何图形的近似或等效非曲线版本`宽容`. (2 methods) |
| [ToLinearGeometry](../../aspose.gis.geometries/geometrycollection/tolineargeometry)(double) | 使用指定的获取此几何图形的近似或等效非曲线版本`宽容`. (2 methods) |
