...
description: "Aspose.Gis.Geometries.MultiPoint 类。MultiPoint 是一个一维 GeometryCollection，其元素为 Points"
type: docs
weight: 2940
...
`MultiPoint` 是一个一维 [`GeometryCollection`](../geometrycollection/)，其元素为 [`Point`](../point/)。
...
| [ToLinearGeometry](../../aspose.gis.geometries/geometrycollection/tolineargeometry/)() | 使用默认的 `tolerance` 获取此几何体的近似或等效的非曲线版本。（2 个方法） |
| [ToLinearGeometry](../../aspose.gis.geometries/geometrycollection/tolineargeometry/)(double) | 使用指定的 `tolerance` 获取此几何体的近似或等效的非曲线版本。（2 个方法） |
