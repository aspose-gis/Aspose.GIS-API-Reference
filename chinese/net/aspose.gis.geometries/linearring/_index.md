...
description: 一个LinearRing./linearring是一个LineString./linestring既封闭又简单
type: docs
weight: 1030
...
一个[`LinearRing`](../linearring)是一个[`LineString`](../linestring)既封闭又简单。
...
| 姓名 | 描述 |
| --- | --- |
| [LinearRing](linearring#constructor)() | 初始化[`LinearRing`](../linearring)类. |
| [LinearRing](linearring#constructor_2)(IEnumerable&lt;IPoint&gt;) | 初始化[`LinearRing`](../linearring)类. |
| [LinearRing](linearring#constructor_1)(ILineString) | 初始化[`LinearRing`](../linearring)类. |
...
| [Equals](../../aspose.gis.geometries/linestring/equals)(ILineString) | 指示当前对象是否等于另一个相同类型的对象。 |
