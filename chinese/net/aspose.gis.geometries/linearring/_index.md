...
description: ALinearRing./linearring是LineString./linestring既封闭又简单
type: docs
weight: 1020
...
A[`LinearRing`](../linearring)是[`LineString`](../linestring)既封闭又简单。
...
| 姓名 | 描述 |
| --- | --- |
| [LinearRing](linearring#constructor)() | 初始化[`LinearRing`](../linearring)类的新实例。 |
| [LinearRing](linearring#constructor_2)(IEnumerable&lt;IPoint&gt;) | 初始化[`LinearRing`](../linearring)类的新实例。 |
| [LinearRing](linearring#constructor_1)(ILineString) | 初始化[`LinearRing`](../linearring)类的新实例。 |
...
| override [GeometryType](../../aspose.gis.geometries/linearring/geometrytype) { get; } | 获取几何的类型。 |
...
| [Equals](../../aspose.gis.geometries/linestring/equals)(ILineString) | 表示当前对象是否等于另一个同类型的对象。 |
| override [Equals](../../aspose.gis.geometries/linestring/equals)(object) | 判断指定对象是否等于当前对象。 |
...
| [ToEditable](../../aspose.gis.geometries/linearring/toeditable#toeditable_2)() | 获取此几何图形的可编辑副本。 (4 methods) |
