...
| [SpatialReferenceSystem](../../aspose.gis.geometries/linestring/spatialreferencesystem/) { get; set; } | 获取此实例的 SpatialReferenceSystem。如果未设置 SpatialReferenceSystem，则此属性可以为 `null`。分配新的 SpatialReferenceSystem 不会执行任何坐标转换，仅会更改参考系。 |
...
| 名称 | 描述 |
| --- | --- |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint/)(IPoint) | 在直线的末端添加一个点。 |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint/)(double, double) | 在直线的末端添加一个点。 |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint/)(double, double, double) | 在直线的末端添加一个点。 |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint/)(double, double, double, double) | 在直线的末端添加一个点。 |
...
| override [Equals](../../aspose.gis.geometries/linestring/equals/)(object) | 确定指定的对象是否等于当前对象。 |
...
| override [GetHashCode](../../aspose.gis.geometries/linestring/gethashcode/)() | 用作默认的哈希函数。 |
...
| [IsClockwise](../../aspose.gis.geometries/linearring/isclockwise/)() | 确定环是否具有顺时针方向。 |
