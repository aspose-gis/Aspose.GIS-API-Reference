...
description: Aspose.Gis.Geometries.LinearRing 班级. 一个LinearRing是一个LineString那既封闭又简单.
type: docs
weight: 1130
...
一个`LinearRing`是一个[`LineString`](../linestring/)那既封闭又简单.
...
| 姓名 | 描述 |
| --- | --- |
| [LinearRing](linearring/#constructor)() | 初始化一个新的实例`LinearRing`类. |
| [LinearRing](linearring/#constructor_2)(IEnumerable&lt;IPoint&gt;) | 初始化一个新的实例`LinearRing`类. |
| [LinearRing](linearring/#constructor_1)(ILineString) | 初始化一个新的实例`LinearRing`类. |
...
| override [GeometryType](../../aspose.gis.geometries/linearring/geometrytype/) { get; } | 获取几何类型。 |
...
| 姓名 | 描述 |
| --- | --- |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint/)(IPoint) | 在行尾添加一个点。 |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint/)(double, double) | 在行尾添加一个点。 |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint/)(double, double, double) | 在行尾添加一个点。 |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint/)(double, double, double, double) | 在行尾添加一个点。 |
...
| [Equals](../../aspose.gis.geometries/linestring/equals/)(ILineString) | 指示当前对象是否等于同一类型的另一个对象。 |
...
| [IsClockwise](../../aspose.gis.geometries/linearring/isclockwise/)() | 确定环是否顺时针缠绕。 |
...
| override [Reverse](../../aspose.gis.geometries/linestring/reverse/)() | 反转点的顺序[`LineString`](../linestring/). |
...
| [ToEditable](../../aspose.gis.geometries/linearring/toeditable/#toeditable_2)() | 获取此几何体的可编辑副本。 (4 methods) |
