...
description: "Aspose.Gis.Geometries.LinearRing 类。LinearRing 是一个既闭合又简单的 LineString"
type: docs
weight: 2910
url: /zh/net/aspose.gis.geometries/linearring/
---
## LinearRing class

`LinearRing` 是一个既闭合又简单的[`LineString`](../linestring/)。
...
| 名称 | 描述 |
| --- | --- |
| [LinearRing](linearring/#constructor)() | 初始化 `LinearRing` 类的新实例。 |
| [LinearRing](linearring/#constructor_2)(IEnumerable&lt;IPoint&gt;) | 初始化 `LinearRing` 类的新实例。 |
| [LinearRing](linearring/#constructor_1)(ILineString) | 初始化 `LinearRing` 类的新实例。 |
...
| [Count](../../aspose.gis.geometries/linestring/count/) { get; } | 获取 [`LineString`](../linestring/) 中点的数量。 |
...
| override [GeometryType](../../aspose.gis.geometries/linearring/geometrytype/) { get; } | 获取几何体的类型。 |
| virtual [HasCurveGeometry](../../aspose.gis.geometries/geometry/hascurvegeometry/) { get; } | 获取一个值，指示此几何体是否为或包含曲线（非线性）几何体。 |
| [HasM](../../aspose.gis.geometries/linestring/hasm/) { get; set; } | 获取一个值，指示此实例是否具有 M 坐标。 |
...
| [SpatialReferenceSystem](../../aspose.gis.geometries/linestring/spatialreferencesystem/) { get; set; } | 获取此实例的 SpatialReferenceSystem。如果未设置 SpatialReferenceSystem，则此属性可以为 `null`。分配新的 SpatialReferenceSystem 不会执行任何坐标转换，只会更改参考。 |
...
| 名称 | 描述 |
| --- | --- |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint/)(IPoint) | 在直线的末尾添加一个点。 |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint/)(double, double) | 在直线的末尾添加一个点。 |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint/)(double, double, double) | 在直线的末尾添加一个点。 |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint/)(double, double, double, double) | 在直线的末尾添加一个点。 |
...
| override [Clone](../../aspose.gis.geometries/linearring/clone/)() | 克隆此实例。 |
...
| [Equals](../../aspose.gis.geometries/linestring/equals/)(ILineString) | 指示当前对象是否等于同类型的另一个对象。 |
| override [Equals](../../aspose.gis.geometries/linestring/equals/)(object) | 确定指定对象是否等于当前对象。 |
...
| [GetEnumerator](../../aspose.gis.geometries/linestring/getenumerator/)() | 返回遍历集合的枚举器。 |
| [GetExtent](../../aspose.gis.geometries/geometry/getextent/)() | 计算并返回此几何体的边界范围。 |
| override [GetHashCode](../../aspose.gis.geometries/linestring/gethashcode/)() | 作为默认的哈希函数。 |
...
| [IsClockwise](../../aspose.gis.geometries/linearring/isclockwise/)() | 确定环是否为顺时针方向。 |
...
| override [Reverse](../../aspose.gis.geometries/linestring/reverse/)() | 反转此 [`LineString`](../linestring/) 中点的顺序。 |
...
| override [SetEmpty](../../aspose.gis.geometries/linestring/setempty/)() | 将此 [`Geometry`](../geometry/) 设为空。 |
...
| [ToEditable](../../aspose.gis.geometries/linearring/toeditable/#toeditable_2)() | 获取此几何对象的可编辑副本。（4 种方法） |
