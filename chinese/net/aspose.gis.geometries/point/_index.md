...
description: APoint./point表示坐标空间中的单个位置
type: docs
weight: 1080
...
| 姓名 | 描述 |
| --- | --- |
| [Point](point#constructor)() | 初始化[`Point`](../point)类的新实例。 |
| [Point](point#constructor_1)(IPoint) | 初始化[`Point`](../point)类的新实例。 |
| [Point](point#constructor_2)(double, double) | 初始化[`Point`](../point)类的新实例。 |
| [Point](point#constructor_3)(double, double, double) | 初始化[`Point`](../point)类的新实例。 |
| [Point](point#constructor_4)(double, double, double, double) | 初始化[`Point`](../point)类的新实例。 |
...
| override [Dimension](../../aspose.gis.geometries/point/dimension) { get; } | 获取此Geometry的拓扑维度。 |
| override [GeometryType](../../aspose.gis.geometries/point/geometrytype) { get; } | 获取几何的类型。 |
| virtual [HasCurveGeometry](../../aspose.gis.geometries/geometry/hascurvegeometry) { get; } | 获取一个值，该值指示此几何图形是还是包含曲线（非线性）几何图形。 |
| override [HasM](../../aspose.gis.geometries/point/hasm) { get; set; } | 获取一个值，该值指示此实例是否具有 M 坐标。 |
| override [HasZ](../../aspose.gis.geometries/point/hasz) { get; set; } | 获取一个值，该值指示此实例是否具有 Z 坐标。 |
...
| override [SpatialReferenceSystem](../../aspose.gis.geometries/point/spatialreferencesystem) { get; set; } | 获取此实例的 SpatialReferenceSystem。 这个属性可以是`null`，是 SpatialReferenceSystem 是未知的。 分配新的 SpatialReferenceSystem 不会执行任何坐标转换，只会更改参考。 |
...
| [Equals](../../aspose.gis.geometries/point/equals#equals)(IPoint) | 表示当前对象是否等于另一个同类型的对象。 |
| override [Equals](../../aspose.gis.geometries/point/equals#equals_1)(object) | 判断指定对象是否等于当前对象。 |
...
| override [GetHashCode](../../aspose.gis.geometries/point/gethashcode)() | 用作默认哈希函数。 |
...
| override [SetEmpty](../../aspose.gis.geometries/point/setempty)() | 使[`Geometry`](../geometry)为空。 |
...
| [ToEditable](../../aspose.gis.geometries/point/toeditable#toeditable_1)() | 获取此几何图形的可编辑副本。 (2 methods) |
| [ToEditable&lt;T&gt;](../../aspose.gis.geometries/geometry/toeditable)() | 获取此几何图形的可编辑副本。 |
| [ToLinearGeometry](../../aspose.gis.geometries/geometry/tolineargeometry)() | 使用默认` 公差` 获取此几何图形的近似或等效非曲线版本。 |
| [ToLinearGeometry](../../aspose.gis.geometries/geometry/tolineargeometry)(double) | 使用指定的` 容差` 获取此几何图形的近似或等效非曲线版本。 |
