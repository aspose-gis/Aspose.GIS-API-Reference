...
description: Aspose.Gis.Geometries.Point 班级. 一个Point表示坐标空间中的单个位置
type: docs
weight: 1190
...
| 姓名 | 描述 |
| --- | --- |
| [Point](point/#constructor)() | 初始化一个新的实例`Point`类. |
| [Point](point/#constructor_1)(IPoint) | 初始化一个新的实例`Point`类. |
| [Point](point/#constructor_2)(double, double) | 初始化一个新的实例`Point`类. |
| [Point](point/#constructor_3)(double, double, double) | 初始化一个新的实例`Point`类. |
| [Point](point/#constructor_4)(double, double, double, double) | 初始化一个新的实例`Point`类. |
...
| override [Dimension](../../aspose.gis.geometries/point/dimension/) { get; } | 得到这个的拓扑维度[`Geometry`](../geometry/). |
| override [GeometryType](../../aspose.gis.geometries/point/geometrytype/) { get; } | 获取几何类型。 |
| virtual [HasCurveGeometry](../../aspose.gis.geometries/geometry/hascurvegeometry/) { get; } | 获取一个值，该值指示此几何图形是否为或包含曲线（非线性）几何图形。 |
| override [HasM](../../aspose.gis.geometries/point/hasm/) { get; set; } | 获取一个值，指示该实例是否具有 M 坐标。 |
...
| [M](../../aspose.gis.geometries/point/m/) { get; set; } | 获取或设置 m 坐标值。 |
| override [SpatialReferenceSystem](../../aspose.gis.geometries/point/spatialreferencesystem/) { get; set; } | 获取此实例的 SpatialReferenceSystem。 此属性可以是`null` , 是 SpatialReferenceSystem 是未知的。 分配新的 SpatialReferenceSystem 不会执行任何坐标转换，只有参考会改变。 |
| [X](../../aspose.gis.geometries/point/x/) { get; set; } | 获取或设置 x 坐标的值。 |
| [Y](../../aspose.gis.geometries/point/y/) { get; set; } | 获取或设置 y 坐标值。 |
...
| [Equals](../../aspose.gis.geometries/point/equals/#equals)(IPoint) | 指示当前对象是否等于同一类型的另一个对象。 |
...
| override [SetEmpty](../../aspose.gis.geometries/point/setempty/)() | 做这个[`Geometry`](../geometry/)空. |
...
| [ToEditable](../../aspose.gis.geometries/point/toeditable/#toeditable_1)() | 获取此几何体的可编辑副本。 (2 methods) |
| [ToEditable&lt;T&gt;](../../aspose.gis.geometries/geometry/toeditable/)() | 获取此几何体的可编辑副本。 |
| [ToLinearGeometry](../../aspose.gis.geometries/geometry/tolineargeometry/)() | 使用默认值获取此几何的近似或等效非曲线版本`宽容`. |
| [ToLinearGeometry](../../aspose.gis.geometries/geometry/tolineargeometry/)(double) | 使用指定的几何图形获取近似或等效的非曲线版本`宽容`. |
