...
description: 一个Point./point表示坐标空间中的单个位置
type: docs
weight: 1090
...
| 姓名 | 描述 |
| --- | --- |
| [Point](point#constructor)() | 初始化[`Point`](../point)类. |
| [Point](point#constructor_1)(IPoint) | 初始化[`Point`](../point)类. |
| [Point](point#constructor_2)(double, double) | 初始化[`Point`](../point)类. |
| [Point](point#constructor_3)(double, double, double) | 初始化[`Point`](../point)类. |
| [Point](point#constructor_4)(double, double, double, double) | 初始化[`Point`](../point)类. |
...
| override [Dimension](../../aspose.gis.geometries/point/dimension) { get; } | 获取这个的拓扑维度[`Geometry`](../geometry). |
...
| override [SpatialReferenceSystem](../../aspose.gis.geometries/point/spatialreferencesystem) { get; set; } | 获取该实例的SpatialReferenceSystem。 该属性可以是`null` , 是 SpatialReferenceSystem 是未知的。 分配新的 SpatialReferenceSystem 不会进行任何坐标变换，只会改变参考。 |
...
| [Equals](../../aspose.gis.geometries/point/equals#equals)(IPoint) | 指示当前对象是否等于另一个相同类型的对象。 |
...
| override [SetEmpty](../../aspose.gis.geometries/point/setempty)() | 做这个[`Geometry`](../geometry)空的. |
...
| [ToLinearGeometry](../../aspose.gis.geometries/geometry/tolineargeometry)() | 使用默认值获取此几何图形的近似或等效非曲线版本`宽容`. |
| [ToLinearGeometry](../../aspose.gis.geometries/geometry/tolineargeometry)(double) | 使用指定的获取此几何图形的近似或等效非曲线版本`宽容`. |
