...
description: "Aspose.Gis.Geometries.Point 类。点表示坐标空间中的单个位置"
type: docs
weight: 2970
...
| override [SpatialReferenceSystem](../../aspose.gis.geometries/point/spatialreferencesystem/) { get; set; } | 获取此实例的 SpatialReferenceSystem。此属性可以为 `null`，表示 SpatialReferenceSystem 未知。分配新的 SpatialReferenceSystem 不会执行任何坐标转换，只会更改引用。 |
...
| override [Equals](../../aspose.gis.geometries/point/equals/#equals_1)(object) | 确定指定的对象是否等于当前对象。 |
...
| override [GetHashCode](../../aspose.gis.geometries/point/gethashcode/)() | 用作默认的哈希函数。 |
