...
description: AMultiPolygon./multipolygon是一维 GeometryCollection./geometrycollection其元素是Polygon./polygons
type: docs
weight: 1060
...
A[`MultiPolygon`](../multipolygon)是一维 [`GeometryCollection`](../geometrycollection)其元素是[`Polygon`](../polygon)s。
...
| 姓名 | 描述 |
| --- | --- |
| [MultiPolygon](multipolygon)() | 初始化[`MultiPolygon`](../multipolygon)类的新实例。 |
...
| [Dimension](../../aspose.gis.geometries/multisurface/dimension) { get; } | 获取此Geometry的拓扑维度。 |
| override [GeometryType](../../aspose.gis.geometries/multipolygon/geometrytype) { get; } | 获取几何的类型。 |
...
| [ToEditable](../../aspose.gis.geometries/multipolygon/toeditable#toeditable_2)() | 获取此几何图形的可编辑副本。 (4 methods) |
| [ToEditable&lt;T&gt;](../../aspose.gis.geometries/geometry/toeditable)() | 获取此几何图形的可编辑副本。 |
| [ToLinearGeometry](../../aspose.gis.geometries/multisurface/tolineargeometry)() | 使用默认` 公差` 获取此几何图形的近似或等效非曲线版本。 (3 methods) |
| [ToLinearGeometry](../../aspose.gis.geometries/multisurface/tolineargeometry)(double) | 使用指定的` 容差` 获取此几何图形的近似或等效非曲线版本。 (3 methods) |
