---
title: "类 MultiPolygon"
second_title: "Aspose.GIS for .NET API 参考"
description: "Aspose.Gis.Geometries.MultiPolygon 类。一个 MultiPolygon 是一维 GeometryCollection，其元素为 Polygons"
type: docs
weight: 2950
url: /zh/net/aspose.gis.geometries/multipolygon/
---
## MultiPolygon class

一个 `MultiPolygon` 是一维 [`GeometryCollection`](../geometrycollection/)，其元素为 [`Polygon`](../polygon/)。
...
| 名称 | 描述 |
| --- | --- |
| [MultiPolygon](multipolygon/)() | 初始化 `MultiPolygon` 类的新实例。 |
...
| [Dimension](../../aspose.gis.geometries/multisurface/dimension/) { get; } | 获取此 [`Geometry`](../geometry/) 的拓扑维度。 |
| override [GeometryType](../../aspose.gis.geometries/multipolygon/geometrytype/) { get; } | 获取几何体的类型。 |
...
| override [SpatialReferenceSystem](../../aspose.gis.geometries/geometrycollection/spatialreferencesystem/) { get; set; } | 获取此实例的 SpatialReferenceSystem。此属性可以为 `null`，表示 SpatialReferenceSystem 未知。为 SpatialReferenceSystem 分配新值不会执行任何坐标转换，只会更改引用。 |

## 方法

| 名称 | 描述 |
| --- | --- |
| [Add](../../aspose.gis.geometries/geometrycollection/add/)(IGeometry) | 将指定几何体添加到集合中。 |
| [AddRange](../../aspose.gis.geometries/geometrycollection/addrange/)(IEnumerable&lt;IGeometry&gt;) | 将指定的几何体添加到集合中。 |
...
| override [Clone](../../aspose.gis.geometries/multipolygon/clone/)() | 克隆此实例。 |
...
| [Equals](../../aspose.gis.geometries/geometrycollection/equals/)(IGeometryCollection) | 指示当前对象是否等于同类型的另一个对象。 |
...
| [GetEnumerator](../../aspose.gis.geometries/geometrycollection/getenumerator/)() | 返回遍历集合的枚举器。 |
| [GetExtent](../../aspose.gis.geometries/geometry/getextent/)() | 计算并返回此几何体的边界范围。 |
| override [GetHashCode](../../aspose.gis.geometries/geometrycollection/gethashcode/)() | 作为默认的哈希函数。 |
...
| [ReplacePolygonsByLines](../../aspose.gis.geometries/geometrycollection/replacepolygonsbylines/)() | 获取此几何对象表示为线的多边形。（2 种方法） |
...
| [ToEditable](../../aspose.gis.geometries/multipolygon/toeditable/#toeditable_2)() | 获取此几何对象的可编辑副本。（4 种方法） |
| [ToEditable&lt;T&gt;](../../aspose.gis.geometries/geometry/toeditable/)() | 获取此几何体的可编辑副本。 |
| [ToLinearGeometry](../../aspose.gis.geometries/multisurface/tolineargeometry/)() | 使用默认的 `tolerance` 获取此几何对象的近似或等效的非曲线版本。（3 种方法） |
| [ToLinearGeometry](../../aspose.gis.geometries/multisurface/tolineargeometry/)(double) | 使用指定的 `tolerance` 获取此几何对象的近似或等效的非曲线版本。（3 种方法） |
