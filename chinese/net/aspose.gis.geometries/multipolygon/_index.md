...
description: 一个MultiPolygon./multipolygon是一维的 GeometryCollection./geometrycollection其元素是Polygon./polygons.
type: docs
weight: 1070
...
一个[`MultiPolygon`](../multipolygon)是一维的 [`GeometryCollection`](../geometrycollection)其元素是[`Polygon`](../polygon)s.
...
| 姓名 | 描述 |
| --- | --- |
| [MultiPolygon](multipolygon)() | 初始化[`MultiPolygon`](../multipolygon)类. |
...
| [ToLinearGeometry](../../aspose.gis.geometries/multisurface/tolineargeometry)() | 使用默认值获取此几何图形的近似或等效非曲线版本`宽容`. (3 methods) |
| [ToLinearGeometry](../../aspose.gis.geometries/multisurface/tolineargeometry)(double) | 使用指定的获取此几何图形的近似或等效非曲线版本`宽容`. (3 methods) |
