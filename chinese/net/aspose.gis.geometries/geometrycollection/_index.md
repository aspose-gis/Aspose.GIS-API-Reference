...
description: Aspose.Gis.Geometries.GeometryCollection 班级. 一个GeometryCollection是一个Geometry这是一个或多个几何图形的集合
type: docs
weight: 930
...
一个`GeometryCollection`是一个[`Geometry`](../geometry/)这是一个或多个几何图形的集合。
...
| 姓名 | 描述 |
| --- | --- |
| [GeometryCollection](geometrycollection/)() | 初始化一个新的实例`GeometryCollection`类. |
...
| override [Dimension](../../aspose.gis.geometries/geometrycollection/dimension/) { get; } | 得到这个的拓扑维度[`Geometry`](../geometry/). 如果集合为空，Point返回. |
| override [GeometryType](../../aspose.gis.geometries/geometrycollection/geometrytype/) { get; } | 获取几何类型。 |
...
| [Equals](../../aspose.gis.geometries/geometrycollection/equals/#equals)(IGeometryCollection) | 指示当前对象是否等于同一类型的另一个对象。 |
| override [Equals](../../aspose.gis.geometries/geometrycollection/equals/#equals_1)(object) | 确定指定对象是否等于当前对象。 |
...
| [ReplacePolygonsByLines](../../aspose.gis.geometries/geometrycollection/replacepolygonsbylines/#replacepolygonsbylines_1)() | 获取表示为该几何体的线的多边形。 (2 methods) |
...
| [ToEditable](../../aspose.gis.geometries/geometrycollection/toeditable/#toeditable_1)() | 获取此几何体的可编辑副本。 (2 methods) |
| [ToEditable&lt;T&gt;](../../aspose.gis.geometries/geometry/toeditable/)() | 获取此几何体的可编辑副本。 |
| [ToLinearGeometry](../../aspose.gis.geometries/geometrycollection/tolineargeometry/#tolineargeometry_2)() | 使用默认值获取此几何的近似或等效非曲线版本`宽容`. (2 methods) |
| [ToLinearGeometry](../../aspose.gis.geometries/geometrycollection/tolineargeometry/#tolineargeometry_3)(double) | 使用指定的几何图形获取近似或等效的非曲线版本`宽容`. (2 methods) |
