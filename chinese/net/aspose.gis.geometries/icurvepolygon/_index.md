...
description: "Aspose.Gis.Geometries.ICurvePolygon 接口。一个由 1 条外部边界和 0 条或多条内部边界定义的平面表面"
type: docs
weight: 2770
...
| 名称 | 描述 |
| --- | --- |
| [GetInteriorRing](../../aspose.gis.geometries/icurvepolygon/getinteriorring/)(int) | 按索引获取内部环。 |
