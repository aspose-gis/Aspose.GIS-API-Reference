...
| abstract [Dimension](../../aspose.gis.geometries/geometry/dimension) { get; } | 获取此Geometry的拓扑维度。 如果维度未知（例如对于空的 GEOMETRYCOLLECTION）Point返回。 |
...
| [ToLinearGeometry](../../aspose.gis.geometries/geometry/tolineargeometry#tolineargeometry)() | 使用默认` 公差` 获取此几何图形的近似或等效非曲线版本。 |
| [ToLinearGeometry](../../aspose.gis.geometries/geometry/tolineargeometry#tolineargeometry_1)(double) | 使用指定的` 容差` 获取此几何图形的近似或等效非曲线版本。 |
...
| [Within](../../aspose.gis.geometries/geometry/within#within_1)(IGeometry) | 确定此几何是否在指定几何内。 |
| static [FromBinary](../../aspose.gis.geometries/geometry/frombinary#frombinary)(byte[]) | 从其众所周知的二进制表示创建几何。 |
| static [FromBinary](../../aspose.gis.geometries/geometry/frombinary#frombinary_1)(byte[], SpatialReferenceSystem) | 从其众所周知的二进制表示创建几何。 |
| static [FromText](../../aspose.gis.geometries/geometry/fromtext#fromtext)(string) | 从其众所周知的文本表示创建几何。 |
| static [FromText](../../aspose.gis.geometries/geometry/fromtext#fromtext_1)(string, SpatialReferenceSystem) | 从其众所周知的文本表示创建几何。 |
