...
| 姓名 | 描述 |
| --- | --- |
| [Dimension](../../aspose.gis.geometries/igeometry/dimension) { get; } | 获取此Geometry的拓扑维度。 如果维度未知（例如对于空的 GEOMETRYCOLLECTION）Point返回。 |
| [GeometryType](../../aspose.gis.geometries/igeometry/geometrytype) { get; } | 获取几何的类型。 |
| [HasCurveGeometry](../../aspose.gis.geometries/igeometry/hascurvegeometry) { get; } | 获取一个值，该值指示此几何图形是还是包含曲线（非线性）几何图形。 |
| [HasM](../../aspose.gis.geometries/igeometry/hasm) { get; } | 获取该实例是否有M坐标的值。 |
| [HasZ](../../aspose.gis.geometries/igeometry/hasz) { get; } | 获取一个值，该值指示此实例是否具有 Z 坐标。 |
| [IsEmpty](../../aspose.gis.geometries/igeometry/isempty) { get; } | 获取表示此实例是否为空的值（表示空点集）。 |
| [IsSimple](../../aspose.gis.geometries/igeometry/issimple) { get; } | 获取一个值，该值指示此实例从 SFA 的角度来看是否简单。 |
| [IsValid](../../aspose.gis.geometries/igeometry/isvalid) { get; } | 获取指示此实例是否有效的值。 |
| [SpatialReferenceSystem](../../aspose.gis.geometries/igeometry/spatialreferencesystem) { get; } | 获取此实例的 SpatialReferenceSystem。 如果 SpatialReferenceSystem 未知，此属性可以是`null`。 |
...
| [Covers](../../aspose.gis.geometries/igeometry/covers)(IGeometry) | 确定此几何是否覆盖指定几何。 |
...
| [GetArea](../../aspose.gis.geometries/igeometry/getarea)() | 计算此几何的面积。 |
| [GetBuffer](../../aspose.gis.geometries/igeometry/getbuffer)(double, int) | 计算此几何图形周围的缓冲区。 |
| [GetCentroid](../../aspose.gis.geometries/igeometry/getcentroid)() | 计算该几何的质心。 |
| [GetConvexHull](../../aspose.gis.geometries/igeometry/getconvexhull)() | 计算此几何的凸包。 |
| [GetDistanceTo](../../aspose.gis.geometries/igeometry/getdistanceto)(IGeometry) | 计算此几何图形与指定几何图形之间的最小距离。 |
...
| [Intersection](../../aspose.gis.geometries/igeometry/intersection)(IGeometry) | 在此几何图形和指定几何图形之间建立交集。 |
...
| [ReplacePolygonsByLines](../../aspose.gis.geometries/igeometry/replacepolygonsbylines)() | 获取表示为此几何图形的线的多边形。 |
...
| [ToLinearGeometry](../../aspose.gis.geometries/igeometry/tolineargeometry#tolineargeometry)() | 使用默认` 公差` 获取此几何图形的近似或等效非曲线版本。 |
| [ToLinearGeometry](../../aspose.gis.geometries/igeometry/tolineargeometry#tolineargeometry_1)(double) | 使用指定的` 容差` 获取此几何图形的近似或等效非曲线版本。 |
| [Touches](../../aspose.gis.geometries/igeometry/touches)(IGeometry) | 确定此几何体是否与指定的几何体接触。 |
| [Union](../../aspose.gis.geometries/igeometry/union)(IGeometry) | 将此几何图形与指定几何图形结合。 |
| [Within](../../aspose.gis.geometries/igeometry/within#within)(Extent) | 确定此几何图形是否在指定范围内。 |
| [Within](../../aspose.gis.geometries/igeometry/within#within_1)(IGeometry) | 确定此几何是否在指定几何内。 |
