...
description: IGeometry 方法. 计算此几何图形周围的缓冲区
type: docs
weight: 200
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| distance | Double | 缓冲区宽度（以空间参考单位为单位）。 |
| quadrantSegments | Int32 | 用于近似 90 度曲率的段数。 此数字越大，产生的曲线近似越好。 默认值为 30. |

### 返回值

表示距离 此几何指定距离内的所有点的几何。 结果的类型是[`Null`](../../geometry/null/),[`IPolygon`](../../ipolygon/)或者[`IMultiPolygon`](../../imultipolygon/).
