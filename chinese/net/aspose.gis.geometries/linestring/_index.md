...
description: "Aspose.Gis.Geometries.LineString 类。多顶点线。"
type: docs
weight: 2900
...
| 名称 | 描述 |
| --- | --- |
| [LineString](linestring/#constructor)() | 初始化 `LineString` 类的新实例。 |
| [LineString](linestring/#constructor_2)(IEnumerable&lt;IPoint&gt;) | 初始化 `LineString` 类的新实例。 |
| [LineString](linestring/#constructor_1)(ILineString) | 初始化 `LineString` 类的新实例。 |
...
| [Count](../../aspose.gis.geometries/linestring/count/) { get; } | 获取 `LineString` 中点的数量。 |
...
| override [GeometryType](../../aspose.gis.geometries/linestring/geometrytype/) { get; } | 获取几何体的类型。 |
...
| 名称 | 描述 |
| --- | --- |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint/#addpoint)(IPoint) | 在直线的末端添加一个点。 |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint/#addpoint_1)(double, double) | 在直线的末端添加一个点。 |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint/#addpoint_2)(double, double, double) | 在直线的末端添加一个点。 |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint/#addpoint_3)(double, double, double, double) | 在直线的末端添加一个点。 |
...
| [Equals](../../aspose.gis.geometries/linestring/equals/#equals)(ILineString) | 指示当前对象是否等于同类型的另一个对象。 |
| override [Equals](../../aspose.gis.geometries/linestring/equals/#equals_1)(object) | 确定指定的对象是否等于当前对象。 |
...
| override [Reverse](../../aspose.gis.geometries/linestring/reverse/)() | 反转此 `LineString` 中点的顺序。 |
...
| [ToEditable](../../aspose.gis.geometries/linestring/toeditable/#toeditable_2)() | 获取此几何对象的可编辑副本。（3 种方法） |
