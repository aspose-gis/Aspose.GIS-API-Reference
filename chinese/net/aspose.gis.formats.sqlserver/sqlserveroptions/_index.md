...
description: Aspose.Gis.Formats.SqlServer.SqlServerOptions 班级. SqlServer 格式的驱动程序特定选项 目前驱动程序不提供可自定义的选项
type: docs
weight: 690
url: /zh/net/aspose.gis.formats.sqlserver/sqlserveroptions/
---
## SqlServerOptions class

SqlServer 格式的驱动程序特定选项。 目前，驱动程序不提供可自定义的选项。
...
| 姓名 | 描述 |
| --- | --- |
| [SqlServerOptions](sqlserveroptions/)() | 创建新实例. |
