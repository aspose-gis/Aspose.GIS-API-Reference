...
| 名称 | 描述 |
| --- | --- |
| override [CanOpenLayers](../../aspose.gis.formats.tiffw/tiffwdriver/canopenlayers/) { get; } | 获取一个值，指示此驱动程序是否可以打开栅格图层。 |
...
| override [OpenLayer](../../aspose.gis.formats.tiffw/tiffwdriver/openlayer/#openlayer_2)(AbstractPath, RasterDriverOptions) | 打开该图层进行读取。 |
