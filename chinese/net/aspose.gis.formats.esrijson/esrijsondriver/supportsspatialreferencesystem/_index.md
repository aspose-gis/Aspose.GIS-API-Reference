...
description: "EsriJsonDriver 方法。确定指定的空间参考系统是否受此驱动程序支持"
type: docs
weight: 60
url: /zh/net/aspose.gis.formats.esrijson/esrijsondriver/supportsspatialreferencesystem/
---
...
对于 EsriJson，唯一受支持的空间参考系统是 WGS84。
