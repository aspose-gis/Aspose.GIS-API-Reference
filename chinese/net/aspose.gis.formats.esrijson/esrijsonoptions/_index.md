---
title: "类 EsriJsonOptions"
second_title: "Aspose.GIS for .NET API 参考文档"
description: "Aspose.Gis.Formats.EsriJson.EsriJsonOptions 类。针对 EsriJson 格式的驱动特定选项"
type: docs
weight: 1830
...
| [NestedPropertiesSeparator](../../aspose.gis.formats.esrijson/esrijsonoptions/nestedpropertiesseparator/) { get; set; } | 获取或设置用于分隔嵌套属性组件的字符串。默认是 "_"。 |
