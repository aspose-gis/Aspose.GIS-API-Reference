...
| 名称 | 描述 |
| --- | --- |
| [ArrayAsString](../../aspose.gis.formats.geojsonseq/geojsonseqoptions/arrayasstring/) { get; set; } | 是否将字符串、整数或实数的 JSon 数组暴露为字符串。 |
| [AttributesSkip](../../aspose.gis.formats.geojsonseq/geojsonseqoptions/attributesskip/) { get; set; } | 控制属性的翻译：yes - 跳过所有属性 |
...
| [GeometryAsCollection](../../aspose.gis.formats.geojsonseq/geojsonseqoptions/geometryascollection/) { get; set; } | 控制几何体的平移：是 - 使用 GeometryCollection 类型包装几何体 |
