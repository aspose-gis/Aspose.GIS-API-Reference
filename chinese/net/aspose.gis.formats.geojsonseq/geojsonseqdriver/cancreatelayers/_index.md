...
description: "GeoJsonSeqDriver 属性。获取一个值，指示此驱动程序是否可以创建矢量图层"
type: docs
weight: 20
url: /zh/net/aspose.gis.formats.geojsonseq/geojsonseqdriver/cancreatelayers/
---
...
`true`，如果此驱动程序可以创建矢量图层；否则为 `false`。
