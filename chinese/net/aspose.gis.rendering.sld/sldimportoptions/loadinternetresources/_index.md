...
description: "SldImportOptions 属性。确定是否允许 Aspose.GIS 从互联网加载资源。如果设置为 false，则不会加载以 file// 开头的绝对 URI 的模式。默认是 false"
type: docs
weight: 20
...
确定是否允许 Aspose.GIS 从互联网加载资源。如果设置为 `false`，则不会加载以非 'file://' 开头的绝对 URI 的模式。默认是 `false`。
