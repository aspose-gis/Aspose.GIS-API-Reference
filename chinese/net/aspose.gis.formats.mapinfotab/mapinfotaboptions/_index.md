...
description: Aspose.Gis.Formats.MapInfoTab.MapInfoTabOptions 班级. MapInfo 选项卡格式的驱动程序特定选项
type: docs
weight: 610
...
| 姓名 | 描述 |
| --- | --- |
| [BlockSize](../../aspose.gis.formats.mapinfotab/mapinfotaboptions/blocksize/) { get; set; } | “*.map”文件的块大小（512 的倍数）。默认为 16384。有效值：512 到 32256. |
...
| [TextStringAttribute](../../aspose.gis.formats.mapinfotab/mapinfotaboptions/textstringattribute/) { get; set; } | 指定表示“文本”图形对象文本的属性名称。 |
