...
description: "MapInfoTabOptions 属性。确定在处理错误数据时是抛出异常还是设置默认值"
type: docs
weight: 30
url: /zh/net/aspose.gis.formats.mapinfotab/mapinfotaboptions/isignorewrongdata/
---
## MapInfoTabOptions.IsIgnoreWrongData property

确定在处理错误数据时是抛出异常还是设置默认值。
