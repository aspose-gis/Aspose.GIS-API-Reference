...
| 名称 | 描述 |
| --- | --- |
| [Filter](../../aspose.gis.rendering.symbolizers/rule/filter/) { get; } | 确定是否应将 "filter-rule" 应用于要素的符号器。如果返回 `true` 则使用该符号器；否则，跳过该要素。 |
...
| 名称 | 描述 |
| --- | --- |
| static [CreateElseRule](../../aspose.gis.rendering.symbolizers/rule/createelserule/)(VectorSymbolizer) | 创建一个新规则，当要素不匹配任何过滤规则时，对其应用符号器。 |
| static [CreateFilterRule](../../aspose.gis.rendering.symbolizers/rule/createfilterrule/)(Func&lt;Feature, bool&gt;, VectorSymbolizer) | 创建一个新规则，当要素通过过滤时，对其应用符号器。 |
