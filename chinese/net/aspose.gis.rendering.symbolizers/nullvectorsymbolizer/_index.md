...
description: "Aspose.Gis.Rendering.Symbolizers.NullVectorSymbolizer 类。NullSymbolizer 不绘制任何内容，并有效地跳过其所应用的几何体的渲染"
type: docs
weight: 4340
...
该 `NullSymbolizer` 什么也不绘制，并有效地跳过对其所应用的几何体的渲染。
