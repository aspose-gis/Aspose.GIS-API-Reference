...
description: "Aspose.Gis.Formats.FileGdb.FileGdbOptions 类。FileGDB 格式的驱动程序特定选项"
type: docs
weight: 1860
...
| [ExpectedGeometryType](../../aspose.gis.formats.filegdb/filegdboptions/expectedgeometrytype/) { get; set; } | 图层的预期几何类型。如果设置此选项，则只允许添加具有此类型的几何对象 |
| [GeometryFieldName](../../aspose.gis.formats.filegdb/filegdboptions/geometryfieldname/) { get; set; } | 几何字段的名称。 |
| [HasM](../../aspose.gis.formats.filegdb/filegdboptions/hasm/) { get; set; } | 图层的几何对象是否可以具有 'm' 坐标。默认值为 true |
| [HasZ](../../aspose.gis.formats.filegdb/filegdboptions/hasz/) { get; set; } | 图层的几何对象是否可以具有 'z' 坐标。默认值为 true |
