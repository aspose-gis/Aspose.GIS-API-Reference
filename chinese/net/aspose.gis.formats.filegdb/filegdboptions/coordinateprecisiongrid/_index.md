...
这是一个创建选项，不影响读取。 坐标精度网格定义了 FileGDB 中坐标的有效域和分辨率。 当此属性设置为`null`时，使用默认值。 有关坐标 精度网格的更多详细信息，请参阅[`FileGdbCoordinatePrecisionGrid`](../../filegdbcoordinateprecisiongrid)文档。
