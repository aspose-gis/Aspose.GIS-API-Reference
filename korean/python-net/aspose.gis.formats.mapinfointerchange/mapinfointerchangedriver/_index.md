---
title: "MapInfoInterchangeDriver 클래스"
type: docs
weight: 10
url: /ko/python-net/aspose.gis.formats.mapinfointerchange/mapinfointerchangedriver/
---
...
| [create_layer(path, options, spatial_reference_system)](#create_layer_path_options_spatial_reference_system_10) | 새 레이어를 만들고 새 피처를 추가하기 위해 엽니다. |
...
| [supports_spatial_reference_system(spatial_reference_system)](#supports_spatial_reference_system_spatial_reference_system_28) | 지정된 공간 참조 시스템이 드라이버에서 지원되는지 여부를 결정합니다. |
...
| :- | :- | :- |
| path | string | 파일 경로. |
| options | [MapInfoInterchangeOptions](/psd/python-net/aspose.gis.formats.mapinfointerchange/mapinfointerchangeoptions) | 드라이버별 옵션. |
