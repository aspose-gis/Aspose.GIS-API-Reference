---
title: "MapInfoInterchangeOptions 클래스"
type: docs
weight: 20
url: /ko/python-net/aspose.gis.formats.mapinfointerchange/mapinfointerchangeoptions/
---
...
| **Name** | **Description** |
| :- | :- |
| [MapInfoInterchangeOptions()](#MapInfoInterchangeOptions__1) | 새 인스턴스를 생성합니다. |
## **Properties**
| **Name** | **Type** | **Access** | **Description** |
| :- | :- | :- | :- |
| charset | string | r/w | charset을 결정합니다. 기본값은 Neutral입니다. |
...
| delimiter | string | r/w | mid 파일에서 속성 구분자를 결정합니다. 기본값은 탭 문자입니다. |
