---
title: "AbstractPath 클래스"
type: docs
weight: 10
url: /ko/python-net/aspose.gis/abstractpath/
---
...
| separator | char | r | [AbstractPath.location](/psd/python-net/aspose.gis/abstractpath/) 문자열의 디렉터리 수준을 구분하는 구분 문자를 가져옵니다. |
## **Methods**
| **Name** | **Description** |
| :- | :- |
...
| [open(access)](#open_access_9) | 이 <c>AbstractPath</c>를 파일로 엽니다. |
...
| 형식 | 설명 |
| :- | :- |
| _io.BufferedRandom | 지정된 FileAccess로 열린 스트림입니다. |
