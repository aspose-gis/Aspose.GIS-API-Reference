...
type: docs
weight: 10
url: /ko/python-net/aspose.gis.formats.kml.specificfields/iconinfo/
---
...
| **Name** | **Description** |
| :- | :- |
| [IconInfo(link)](#IconInfo_link_1) | 새 인스턴스를 초기화합니다 [IconInfo](/psd/python-net/aspose.gis.formats.kml.specificfields/iconinfo/) 클래스. |
## **Properties**
| **Name** | **Type** | **Access** | **Description** |
| :- | :- | :- | :- |
| children | [NodeLink[]](/psd/python-net/aspose.gis/nodelink) | r | 자식들을 가져옵니다. |
| href | string | r/w | href를 가져오거나 설정합니다. |
...
새 인스턴스를 초기화합니다 [IconInfo](/psd/python-net/aspose.gis.formats.kml.specificfields/iconinfo/) 클래스.

**Parameters:**

| 매개변수 | 형식 | 설명 |
| :- | :- | :- |
| link | [NodeLink](/psd/python-net/aspose.gis/nodelink) | 생성될 노드 |
