---
title: "KmlLodSettings 클래스"
type: docs
weight: 50
url: /ko/python-net/aspose.gis.formats.kml.specificfields/kmllodsettings/
---
...
| max_fade_extent | int | r/w | 'Lod' 노드의 MaxFadeExtent. |
| max_lod_pixels | int | r/w | 'Lod' 노드의 MaxLodPixels. |
| min_fade_extent | int | r/w | 'Lod' 노드의 MinFadeExtent. |
| min_lod_pixels | int | r/w | MinLodPixels의 'Lod' 노드. |
