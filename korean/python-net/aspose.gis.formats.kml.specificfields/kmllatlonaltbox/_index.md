---
title: "KmlLatLonAltBox 클래스"
type: docs
weight: 30
url: /ko/python-net/aspose.gis.formats.kml.specificfields/kmllatlonaltbox/
---
...
| 동쪽 | double | r/w | 'LatLonBox' 노드의 동쪽. |
| max_altitude | Nullable<double> | r/w | 'LatLonBox' 노드의 MaxAltitude. |
| min_altitude | Nullable<double> | r/w | 'LatLonBox' 노드의 MinAltitude. |
| name_without_prefix | string | r | 접두사 없이 이름을 가져옵니다. |
| node_name | string | r/w | 이름을 가져오거나 설정합니다. |
| node_value | string | r/w | 값을 가져오거나 설정합니다. |
| 북쪽 | double | r/w | 'LatLonBox' 노드의 북쪽. |
| 접두사 | string | r | 접두사를 가져옵니다. |
| 회전 | Nullable<double> | r/w | 'LatLonBox' 노드의 회전. |
| 남쪽 | double | r/w | 'LatLonBox' 노드의 남쪽. |
| 서쪽 | double | r/w | 'LatLonBox' 노드의 서쪽. |
## **Methods**
| **Name** | **Description** |
| :- | :- |
