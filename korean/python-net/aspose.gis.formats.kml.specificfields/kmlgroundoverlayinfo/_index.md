---
title: "KmlGroundOverlayInfo 클래스"
type: docs
weight: 20
url: /ko/python-net/aspose.gis.formats.kml.specificfields/kmlgroundoverlayinfo/
---
...
| draw_order | double | r/w | DrawOrder의 'GroundOverlay' 노드. |
| icon | [IconInfo](/psd/python-net/aspose.gis.formats.kml.specificfields/iconinfo) | r/w | IconPath의 'GroundOverlay' 노드. |
| lat_lon_box | [KmlLatLonBox](/psd/python-net/aspose.gis.formats.kml.specificfields/kmllatlonbox) | r/w | Kml 'LatLonAltBox' 노드에서 객체를 지정합니다. |
| 이름 | string | r/w | Ground Overlay의 이름 |
...
| visibility | bool | r/w | Ground Overlay의 Visibility |
## **Methods**
| **Name** | **Description** |
| :- | :- |
