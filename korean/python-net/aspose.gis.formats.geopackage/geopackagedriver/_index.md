---
title: "GeoPackageDriver 클래스"
type: docs
weight: 20
url: /ko/python-net/aspose.gis.formats.geopackage/geopackagedriver/
---
...
| **Name** | **Description** |
| :- | :- |
| [GeoPackageDriver()](#GeoPackageDriver__1) | GeoPackageDriver 클래스의 새 인스턴스를 초기화합니다. |
## **Properties**
...
| [open_dataset(path, options)](#open_dataset_path_options_19) | 데이터세트를 엽니다. |
| [open_layer(path)](#open_layer_path_20) | 읽기를 위해 레이어를 엽니다. |
| [open_layer(path)](#open_layer_path_21) | 읽기를 위해 레이어를 엽니다. |
| [open_layer(path, options)](#open_layer_path_options_22) | 읽기를 위해 레이어를 엽니다. |
| [open_layer(path, options)](#open_layer_path_options_23) | 읽기를 위해 레이어를 엽니다. |
| [supports_spatial_reference_system(spatial_reference_system)](#supports_spatial_reference_system_spatial_reference_system_24) | 지정된 공간 참조 시스템이 드라이버에서 지원되는지 여부를 결정합니다. |
...
GeoPackageDriver 클래스의 새 인스턴스를 초기화합니다.
...
| :- | :- | :- |
| path | [AbstractPath](/psd/python-net/aspose.gis/abstractpath) | 데이터세트 경로. |
| options | [GeoPackageOptions](/psd/python-net/aspose.gis.formats.geopackage/geopackageoptions) | 드라이버별 옵션. |

**Returns**

| 형식 | 설명 |
| :- | :- |
| [GeoPackageDataset](/psd/python-net/aspose.gis.formats.geopackage/geopackagedataset) | 다음의 인스턴스: [Dataset](/psd/python-net/aspose.gis/dataset/). |
