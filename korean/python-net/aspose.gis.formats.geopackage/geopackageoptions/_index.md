---
title: "GeoPackageOptions 클래스"
type: docs
weight: 30
url: /ko/python-net/aspose.gis.formats.geopackage/geopackageoptions/
---
...
| **Name** | **Description** |
| :- | :- |
| [GeoPackageOptions()](#GeoPackageOptions__1) | GeoPackageOptions 클래스의 새 인스턴스를 초기화합니다. |
## **Properties**
...
GeoPackageOptions 클래스의 새 인스턴스를 초기화합니다.
