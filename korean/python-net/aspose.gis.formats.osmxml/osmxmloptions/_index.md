---
title: "OsmXmlOptions 클래스"
type: docs
weight: 20
url: /ko/python-net/aspose.gis.formats.osmxml/osmxmloptions/
---
...
| **Name** | **Description** |
| :- | :- |
| [OsmXmlOptions()](#OsmXmlOptions__1) | 새 인스턴스를 생성합니다. |
## **Properties**
...
| report_all_nodes | bool | r/w | 중요한 태그가 없더라도 모든 노드를 피처로 보고합니다. |
| report_all_ways | bool | r/w | 중요한 태그가 없거나 노드가 없더라도 모든 웨이를 피처로 보고합니다. |
| report_common_attributes | bool | r/w | 공통 OSM 속성을 보고합니다: visible, version, changeset, timestamp, user 및 uid.<br/>            공통 속성은 "osm_" 접두사가 붙은 피처 속성으로 보고됩니다. 예: osm_user, osm_timestamp 등. |
...
| write_common_attributes | bool | r/w | 공통 OSM 속성을 씁니다: visible, version, changeset, timestamp, user 및 uid. |
