---
title: "FileGdbDriver 클래스"
type: docs
weight: 20
url: /ko/python-net/aspose.gis.formats.filegdb/filegdbdriver/
---
...
| [create_dataset(path, options)](#create_dataset_path_options_5) | 데이터 세트를 생성합니다. |
| [create_dataset(path, options)](#create_dataset_path_options_6) | 데이터 세트를 생성합니다. |
...
| [create_layer(path, options)](#create_layer_path_options_11) | 새 레이어를 만들고 새 피처를 추가하기 위해 엽니다. |
| [create_layer(path, options, spatial_reference_system)](#create_layer_path_options_spatial_reference_system_12) | 레이어를 생성하고 추가를 위해 엽니다. |
| [create_layer(path, options, spatial_reference_system)](#create_layer_path_options_spatial_reference_system_13) | 레이어를 생성하고 추가를 위해 엽니다. |
| [create_layer(path, options, spatial_reference_system)](#create_layer_path_options_spatial_reference_system_14) | 레이어를 생성하고 추가를 위해 엽니다. |
| [create_layer(path, options, spatial_reference_system)](#create_layer_path_options_spatial_reference_system_15) | 레이어를 생성하고 추가를 위해 엽니다. |
| [create_layer(path, spatial_reference_system)](#create_layer_path_spatial_reference_system_16) | 레이어를 생성하고 추가를 위해 엽니다. |
| [create_layer(path, spatial_reference_system)](#create_layer_path_spatial_reference_system_17) | 레이어를 생성하고 추가를 위해 엽니다. |
| [edit_layer(path, options)](#edit_layer_path_options_18) | 편집을 위해 레이어를 엽니다. |
| [edit_layer(path, options)](#edit_layer_path_options_19) | 편집을 위해 레이어를 엽니다. |
| [open_dataset(path)](#open_dataset_path_20) | 데이터세트를 엽니다. |
| [open_dataset(path)](#open_dataset_path_21) | 데이터세트를 엽니다. |
| [open_dataset(path, options)](#open_dataset_path_options_22) | 데이터세트를 엽니다. |
| [open_dataset(path, options)](#open_dataset_path_options_23) | 데이터세트를 엽니다. |
| [open_dataset(path, options)](#open_dataset_path_options_24) | 데이터세트를 엽니다. |
| [open_dataset(path, options)](#open_dataset_path_options_25) | 데이터세트를 엽니다. |
| [open_layer(path)](#open_layer_path_26) | 읽기를 위해 레이어를 엽니다. |
| [open_layer(path)](#open_layer_path_27) | 읽기를 위해 레이어를 엽니다. |
| [open_layer(path, options)](#open_layer_path_options_28) | 읽기를 위해 레이어를 엽니다. |
| [open_layer(path, options)](#open_layer_path_options_29) | 읽기를 위해 레이어를 엽니다. |
| [open_layer(path, options)](#open_layer_path_options_30) | 읽기를 위해 레이어를 엽니다. |
| [open_layer(path, options)](#open_layer_path_options_31) | 읽기를 위해 레이어를 엽니다. |
| [supports_spatial_reference_system(spatial_reference_system)](#supports_spatial_reference_system_spatial_reference_system_32) | 지정된 공간 참조 시스템이 드라이버에서 지원되는지 여부를 결정합니다. |
...
| :- | :- | :- |
| path | string | 데이터세트 경로. |
| options | [FileGdbOptions](/psd/python-net/aspose.gis.formats.filegdb/filegdboptions) | 드라이버별 옵션. |
