---
title: "GdalOptions 클래스"
type: docs
weight: 20
url: /ko/python-net/aspose.gis.formats.gdal/gdaloptions/
---
...
| **Name** | **Description** |
| :- | :- |
| [GdalOptions(temp_directory)](#GdalOptions_temp_directory_1) | 새 인스턴스를 생성합니다. |
## **Properties**
...
| file_name | string | r/w | 시작할 애플리케이션의 이름 |
...
| path_to_temp_file | string | r | 임시 파일의 경로. |
...
| 매개변수 | 형식 | 설명 |
| :- | :- | :- |
| temp_directory | string | 임시 파일의 경로. 기본적으로 사용자의 임시 폴더입니다. |
