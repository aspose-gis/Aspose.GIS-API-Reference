---
title: "MultiSurface 클래스"
type: docs
weight: 290
url: /ko/python-net/aspose.gis.geometries/multisurface/
---
...
| **Name** | **Description** |
| :- | :- |
| [MultiSurface()](#MultiSurface__1) | 새 인스턴스를 초기화합니다 [MultiSurface](/psd/python-net/aspose.gis.geometries/multisurface/) 클래스. |
## **Properties**
...
새 인스턴스를 초기화합니다 [MultiSurface](/psd/python-net/aspose.gis.geometries/multisurface/) 클래스.
...
| 형식 | 설명 |
| :- | :- |
| [MultiSurface](/psd/python-net/aspose.gis.geometries/multisurface) | 이 기하의 편집 가능한 복사본. |
...
| 형식 | 설명 |
| :- | :- |
| [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon) | 이 [IMultiSurface](/psd/python-net/aspose.gis.geometries/imultisurface/)에 근사하거나 동등한 [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon/)입니다.<br/>            이는 <DOM Element: class at 0x2a1792e8790>.IMultiSurface.to_linear_geometry()(float)와 기본 <c>tolerance</c>를 사용한 경우와 동일합니다.<br/>            기본 <c>tolerance</c> 값은 이 기하학의 [SpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem/)에 따라 달라집니다:<br/>            <ul><br/>            <li> 투영된 SRS의 경우 허용오차는 0.001 미터(SRS 단위)입니다 </li><br/>            <li> 지리적 SRS의 경우 허용오차는 <c>1e-5</c>도(SRS 단위)입니다 </li><br/>            <li> 알 수 없는 SRS의 경우 허용오차는 <c>1e-5</c>입니다 </li><br/>            </ul><br/>            적용된 변환에 대한 자세한 내용은 <DOM Element: class at 0x2a1792e8790>.IMultiSurface.to_linear_geometry()(float) 사양을 참조하십시오. |
...
| 형식 | 설명 |
| :- | :- |
| [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon) | 이 [IMultiSurface](/psd/python-net/aspose.gis.geometries/imultisurface/)에 근사하거나 동등한 [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon/)입니다:<br/>             <ul><br/>             이 객체가 자체적으로 [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon/)인 경우 결과는 이 객체와 동일합니다<br/>             이 객체가 [IMultiPolygon]이 아닌 경우 - 모든 표면이 선형화되어 새로운 <c>IMultiPolygon</c>이 생성됩니다<br/>            </ul> |
