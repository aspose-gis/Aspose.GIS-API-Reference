---
title: "LinearRing 클래스"
type: docs
weight: 240
url: /ko/python-net/aspose.gis.geometries/linearring/
---
...
| **Name** | **Description** |
| :- | :- |
| [LinearRing()](#LinearRing__1) | [LinearRing](/psd/python-net/aspose.gis.geometries/linearring/) 클래스의 새 인스턴스를 초기화합니다. |
| [LinearRing(collection)](#LinearRing_collection_2) | [LinearRing](/psd/python-net/aspose.gis.geometries/linearring/) 클래스의 새 인스턴스를 초기화합니다. |
| [LinearRing(other)](#LinearRing_other_3) | [LinearRing](/psd/python-net/aspose.gis.geometries/linearring/) 클래스의 새 인스턴스를 초기화합니다. |
## **Properties**
...
| [is_clockwise()](#is_clockwise__33) | 링이 시계 방향으로 감겼는지 확인합니다. |
| [overlaps(other)](#overlaps_other_34) | 이 기하가 지정된 기하와 겹치는지 확인합니다. |
| [relate(other, intersection_pattern_matrix)](#relate_other_intersection_pattern_matrix_35) | 이 기하와 지정된 기하의 DE-9IM 교차 매트릭스가 제공된 패턴과 일치하는지 확인합니다. |
| [replace_polygons_by_lines()](#replace_polygons_by_lines__36) | 이 기하를 선으로 표현한 다각형을 가져옵니다. |
| reverse() | 이 [LineString](/psd/python-net/aspose.gis.geometries/linestring/)의 점 순서를 반전시킵니다. |
| [round_m(digits)](#round_m_digits_37) | M 좌표를 지정된 소수 자릿수로 반올림합니다. |
| [round_xy(digits)](#round_xy_digits_38) | X 및 Y 좌표를 지정된 소수 자릿수로 반올림합니다. |
| [round_z(digits)](#round_z_digits_39) | Z 좌표를 지정된 소수 자릿수로 반올림합니다. |
| set_empty() | 이 [Geometry](/psd/python-net/aspose.gis.geometries/geometry/)를 비웁니다. |
| [spatially_contains(other)](#spatially_contains_other_40) | 이 기하가 지정된 기하를 공간적으로 포함하는지 확인합니다. |
| [spatially_equals(other)](#spatially_equals_other_41) | 이 기하가 지정된 기하와 공간적으로 같은지 확인합니다. |
| [sym_difference(other)](#sym_difference_other_42) | 이 기하와 지정된 기하 사이의 대칭 차집합을 만듭니다. |
| [to_editable()](#to_editable__43) | 이 기하의 편집 가능한 복사본을 가져옵니다. |
| [to_linear_geometry()](#to_linear_geometry__44) | 기본 <c>tolerance</c>를 사용하여 이 기하의 근사 또는 동등한 비곡선 버전을 가져옵니다. |
| [to_linear_geometry(tolerance)](#to_linear_geometry_tolerance_45) | 지정된 <c>tolerance</c>를 사용하여 이 기하의 근사 또는 동등한 비곡선 버전을 가져옵니다. |
| [to_svg(extent)](#to_svg_extent_46) | 이 기하를 Svg 표현으로 변환합니다. |
| [touches(other)](#touches_other_47) | 이 기하와 지정된 기하가 접하는지 판단합니다. |
| [union(other)](#union_other_48) | 이 기하와 지정된 기하를 합칩니다. |
| [union(other)](#union_other_49) | 이 기하와 지정된 기하를 합칩니다. |
| [within(extent)](#within_extent_50) | 이 기하가 지정된 범위 내에 있는지 판단합니다. |
| [within(other)](#within_other_51) | 이 기하가 지정된 기하 내에 있는지 판단합니다. |
...
[LinearRing](/psd/python-net/aspose.gis.geometries/linearring/) 클래스의 새 인스턴스를 초기화합니다.
...
링이 시계 방향으로 감겼는지 확인합니다.

**Returns**

| 형식 | 설명 |
| :- | :- |
| bool | 시계 방향이면 <see langword=\"true\" />; 그렇지 않으면 <see langword=\"false\" />. |
...
| 형식 | 설명 |
| :- | :- |
| [LinearRing](/psd/python-net/aspose.gis.geometries/linearring) | 이 기하의 편집 가능한 복사본. |
