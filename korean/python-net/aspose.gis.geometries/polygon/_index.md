...
type: docs
weight: 310
url: /ko/python-net/aspose.gis.geometries/polygon/
---
...
| **Name** | **Description** |
| :- | :- |
| [Polygon()](#Polygon__1) | [Polygon](/psd/python-net/aspose.gis.geometries/polygon/) 클래스의 새 인스턴스를 초기화합니다. |
| [Polygon(exterior_ring)](#Polygon_exterior_ring_2) | [Polygon](/psd/python-net/aspose.gis.geometries/polygon/) 클래스의 새 인스턴스를 초기화합니다. |
| [Polygon(exterior_ring, interior_rings)](#Polygon_exterior_ring_interior_rings_3) | [Polygon](/psd/python-net/aspose.gis.geometries/polygon/) 클래스의 새 인스턴스를 초기화합니다. |
## **Properties**
...
| exterior_ring | [ILinearRing](/psd/python-net/aspose.gis.geometries/ilinearring) | r/w | 외부 링을 가져옵니다. |
...
| [get_point_on_surface()](#get_point_on_surface__28) | 이 폴리곤 위에 반드시 존재하는 점을 찾습니다. |
...
[Polygon](/psd/python-net/aspose.gis.geometries/polygon/) 클래스의 새 인스턴스를 초기화합니다.
...
| 매개변수 | 형식 | 설명 |
| :- | :- | :- |
| exterior_ring | [ILinearRing](/psd/python-net/aspose.gis.geometries/ilinearring) | 외부 링. |
...
| :- | :- | :- |
| exterior_ring | [ILinearRing](/psd/python-net/aspose.gis.geometries/ilinearring) | 외부 링. |
| interior_rings | System.Collections.Generic.IEnumerable<ILinearRing> | 내부 링들. |
...
| 매개변수 | 형식 | 설명 |
| :- | :- | :- |
| ring | [ILinearRing](/psd/python-net/aspose.gis.geometries/ilinearring) | 추가할 링. |
...
| 형식 | 설명 |
| :- | :- |
| [ILinearRing](/psd/python-net/aspose.gis.geometries/ilinearring) | 내부 링. |
...
이 폴리곤 위에 반드시 존재하는 점을 찾습니다.

**Returns**

| 형식 | 설명 |
| :- | :- |
| [IPoint](/psd/python-net/aspose.gis.geometries/ipoint) | 이 폴리곤 위의 점입니다. 폴리곤에 내부가 없으면 빈 점을 반환합니다. |
...
| 형식 | 설명 |
| :- | :- |
| [Polygon](/psd/python-net/aspose.gis.geometries/polygon) | 이 기하의 편집 가능한 복사본. |
