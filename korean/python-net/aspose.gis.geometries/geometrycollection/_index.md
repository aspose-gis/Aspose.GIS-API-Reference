---
title: "GeometryCollection 클래스"
type: docs
weight: 60
url: /ko/python-net/aspose.gis.geometries/geometrycollection/
---
...
| **Name** | **Description** |
| :- | :- |
| [GeometryCollection()](#GeometryCollection__1) | 새 인스턴스를 초기화합니다 [GeometryCollection](/psd/python-net/aspose.gis.geometries/geometrycollection/) 클래스. |
## **Properties**
| **Name** | **Type** | **Access** | **Description** |
| :- | :- | :- | :- |
| coordinate_dimension | int | r | 이 [Geometry](/psd/python-net/aspose.gis.geometries/geometry/)에 대한 좌표 차원의 수를 가져옵니다. |
| 카운트 | int | r | 이 컬렉션에 포함된 지오메트리 수를 가져옵니다. |
| dimension | [GeometryDimension](/psd/python-net/aspose.gis.geometries/geometrydimension) | r | 이 [Geometry](/psd/python-net/aspose.gis.geometries/geometry/)의 위상 차원을 가져옵니다.<br/>            컬렉션이 비어 있으면 [GeometryDimension.POINT](/psd/python-net/aspose.gis.geometries/geometrydimension/)이 반환됩니다. |
...
| **Name** | **Description** |
| :- | :- |
| [add(geometry)](#add_geometry_1) | 지정된 지오메트리를 컬렉션에 추가합니다. |
| [add_range(geometries)](#add_range_geometries_2) | 지정된 지오메트리들을 컬렉션에 추가합니다. |
| [as_binary()](#as_binary__3) | 이 지오메트리를 Well-Known Binary 표현으로 변환합니다. |
| [as_binary(variant)](#as_binary_variant_4) | 이 지오메트리를 Well-Known Binary 표현으로 변환합니다. |
...
| [as_image(output_path, width, height, renderer, symbolizer)](#as_image_output_path_width_height_renderer_symbolizer_6) | 이 지오메트리를 이미지 표현으로 내보냅니다. |
| [as_image(width, height, renderer, symbolizer)](#as_image_width_height_renderer_symbolizer_7) | 이 지오메트리를 이미지 표현으로 내보냅니다. |
| [as_text()](#as_text__8) | 이 지오메트리를 Well-Known Text 표현으로 변환합니다. |
| [as_text(variant)](#as_text_variant_9) | 이 지오메트리를 Well-Known Text 표현으로 변환합니다. |
| [as_text(variant, format)](#as_text_variant_format_10) | 이 지오메트리를 Well-Known Text 표현으로 변환합니다. |
| [clone()](#clone__11) | 이 인스턴스를 복제합니다. |
| [covered_by(other)](#covered_by_other_12) | 지정된 지오메트리에 의해 이 지오메트리가 포함되는지 여부를 판단합니다. |
| [covers(other)](#covers_other_13) | 이 지오메트리가 지정된 지오메트리를 포함하는지 여부를 판단합니다. |
| [crosses(other)](#crosses_other_14) | 이 기하와 지정된 기하가 교차하는지 확인합니다. |
| [difference(other)](#difference_other_15) | 이 기하에서 지정된 기하를 빼냅니다. |
| [disjoint(other)](#disjoint_other_16) | 이 기하가 지정된 기하와 분리되어 있는지 확인합니다. |
| [from_binary(wkb)](#from_binary_wkb_17) | Well-Known Binary 표현에서 기하를 생성합니다. |
| [from_binary(wkb, spatial_reference_system)](#from_binary_wkb_spatial_reference_system_18) | Well-Known Binary 표현에서 기하를 생성합니다. |
| [from_text(wkt)](#from_text_wkt_19) | Well-Known Text 표현에서 기하를 생성합니다. |
| [from_text(wkt, spatial_reference_system)](#from_text_wkt_spatial_reference_system_20) | Well-Known Text 표현에서 기하를 생성합니다. |
| [get_area()](#get_area__21) | 이 기하의 면적을 계산합니다. |
| [get_buffer(distance, quadrant_segments)](#get_buffer_distance_quadrant_segments_22) | 이 기하 주변에 버퍼 영역을 계산합니다. |
| [get_centroid()](#get_centroid__23) | 이 기하의 중심점을 계산합니다. |
| [get_convex_hull()](#get_convex_hull__24) | 이 기하의 볼록 껍질을 계산합니다. |
| [get_distance_to(other)](#get_distance_to_other_25) | 이 기하와 지정된 기하 사이의 최소 거리를 계산합니다. |
| [get_extent()](#get_extent__26) | 이 기하의 경계 범위를 계산하고 반환합니다. |
| [get_length()](#get_length__27) | 이 기하의 길이를 계산합니다. |
| [get_point_on_surface()](#get_point_on_surface__28) | 이 컬렉션의 표면 중 하나에 반드시 위치하는 점을 찾습니다. |
...
| [remove_at(index)](#remove_at_index_34) | 지정된 지오메트리를 컬렉션에서 제거합니다. |
...
새 인스턴스를 초기화합니다 [GeometryCollection](/psd/python-net/aspose.gis.geometries/geometrycollection/) 클래스.
...
지정된 지오메트리를 컬렉션에 추가합니다.

**Parameters:**

| 매개변수 | 형식 | 설명 |
| :- | :- | :- |
| geometry | [IGeometry](/psd/python-net/aspose.gis.geometries/igeometry) | 추가할 지오메트리. |
...
지정된 지오메트리들을 컬렉션에 추가합니다.

**Parameters:**

| 매개변수 | 형식 | 설명 |
| :- | :- | :- |
| 기하 도형 | System.Collections.Generic.IEnumerable<IGeometry> | 추가할 지오메트리들. |
...
| 형식 | 설명 |
| :- | :- |
| double | 두 기하학이 모두 [Geometry.is_empty](/psd/python-net/aspose.gis.geometries/geometry/)가 아닌 경우 - 기하학들 사이 가장 가까운 점들 간의 거리.<br/>            하나라도 비어 있으면 -1이 반환됩니다. |
...
이 컬렉션의 표면 중 하나에 반드시 위치하는 점을 찾습니다.

**Returns**

| 형식 | 설명 |
| :- | :- |
| [IPoint](/psd/python-net/aspose.gis.geometries/ipoint) | 표면 중 하나에 위치한 점입니다. 이 컬렉션에 표면이 없거나 모든 표면이 비어 있는 경우 빈 점이 반환됩니다. |
...
지정된 지오메트리를 컬렉션에서 제거합니다.

**Parameters:**

| 매개변수 | 형식 | 설명 |
| :- | :- | :- |
| index | int | 제거할 지오메트리의 인덱스. |
...
| 형식 | 설명 |
| :- | :- |
| [GeometryCollection](/psd/python-net/aspose.gis.geometries/geometrycollection) | 이 기하의 편집 가능한 복사본. |
...
| 형식 | 설명 |
| :- | :- |
| [IGeometryCollection](/psd/python-net/aspose.gis.geometries/igeometrycollection) | 곡선 기하가 없는 기하입니다. 이는 <DOM Element: class at 0x2a1791cc040>.IGeometryCollection.to_linear_geometry()(float) 를 기본 <c>tolerance</c>와 함께 사용한 것과 동일합니다.<br/>            기본 <c>tolerance</c> 값은 이 기하의 [SpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem/)에 따라 달라집니다:<br/>            <ul><br/>            <li> 투영된 SRS의 경우 허용오차는 0.001 미터(SRS 단위)입니다 </li><br/>            <li> 지리적 SRS의 경우 허용오차는 <c>1e-5</c>도(SRS 단위)입니다 </li><br/>            <li> 알 수 없는 SRS의 경우 허용오차는 <c>1e-5</c>입니다 </li><br/>            </ul><br/>            적용되는 변환에 대한 자세한 내용은 <DOM Element: class at 0x2a1791cc040>.IGeometryCollection.to_linear_geometry()(float) 사양을 참조하십시오. |
...
| 매개변수 | 형식 | 설명 |
| :- | :- | :- |
| tolerance | double | 사용할 <c>tolerance</c>. 결과는 곡선 기하에서 <c>tolerance</c>보다 작은 거리임이 보장됩니다. |

**Returns**

| 형식 | 설명 |
| :- | :- |
| [IGeometryCollection](/psd/python-net/aspose.gis.geometries/igeometrycollection) | 곡선 기하가 없는 기하입니다. 다음 변환이 적용됩니다:<br/>            <ul><br/>            <li> [GeometryType.CIRCULAR_STRING](/psd/python-net/aspose.gis.geometries/geometrytype/)은 선형화됩니다<br/>            (지정된 <paramref name="tolerance" /> 로 [GeometryType.LINE_STRING](/psd/python-net/aspose.gis.geometries/geometrytype/)으로 변환) </li><br/>            <li> [GeometryType.COMPOUND_CURVE](/psd/python-net/aspose.gis.geometries/geometrytype/)은 <c>LineString</c>으로 결합됩니다 </li><br/>            <li> [GeometryType.CURVE_POLYGON](/psd/python-net/aspose.gis.geometries/geometrytype/)은 [GeometryType.POLYGON](/psd/python-net/aspose.gis.geometries/geometrytype/)으로 변환됩니다 </li><br/>            <li> [GeometryType.MULTI_CURVE](/psd/python-net/aspose.gis.geometries/geometrytype/)은 [GeometryType.MULTI_CURVE](/psd/python-net/aspose.gis.geometries/geometrytype/)으로 변환됩니다 </li><br/>            <li> [GeometryType.MULTI_SURFACE](/psd/python-net/aspose.gis.geometries/geometrytype/)은 [GeometryType.MULTI_POLYGON](/psd/python-net/aspose.gis.geometries/geometrytype/)으로 변환됩니다 </li><br/>            </ul><br/>            결과적으로 출력 기하의 [IGeometry.has_curve_geometry](/psd/python-net/aspose.gis.geometries/igeometry/) 은 <see langword="false" /> 입니다. |
