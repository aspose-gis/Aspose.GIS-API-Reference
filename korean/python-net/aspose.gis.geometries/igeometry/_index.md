...
type: docs
weight: 110
url: /ko/python-net/aspose.gis.geometries/igeometry/
---
...
| [to_linear_geometry()](#to_linear_geometry__31) | 기본 <c>tolerance</c>를 사용하여 이 기하의 근사 또는 동등한 비곡선 버전을 가져옵니다. |
| [to_linear_geometry(tolerance)](#to_linear_geometry_tolerance_32) | 지정된 <c>tolerance</c>를 사용하여 이 기하의 근사 또는 동등한 비곡선 버전을 가져옵니다. |
| [touches(other)](#touches_other_33) | 이 기하와 지정된 기하가 접하는지 판단합니다. |
| [union(other)](#union_other_34) | 이 기하와 지정된 기하를 합칩니다. |
| [union(other)](#union_other_35) | 이 기하와 지정된 기하를 합칩니다. |
| [within(extent)](#within_extent_36) | 이 기하가 지정된 범위 내에 있는지 판단합니다. |
| [within(other)](#within_other_37) | 이 기하가 지정된 기하 내에 있는지 판단합니다. |
