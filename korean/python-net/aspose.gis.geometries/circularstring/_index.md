---
title: "CircularString 클래스"
type: docs
weight: 10
url: /ko/python-net/aspose.gis.geometries/circularstring/
---
...
| **Name** | **Description** |
| :- | :- |
| [CircularString()](#CircularString__1) | 새 인스턴스를 초기화합니다 [CircularString](/psd/python-net/aspose.gis.geometries/circularstring/) 클래스. |
| [CircularString(collection)](#CircularString_collection_2) | 새 인스턴스를 초기화합니다 [CircularString](/psd/python-net/aspose.gis.geometries/circularstring/) 클래스. |
| [CircularString(other)](#CircularString_other_3) | 새 인스턴스를 초기화합니다 [CircularString](/psd/python-net/aspose.gis.geometries/circularstring/) 클래스. |
## **Properties**
...
| **Name** | **Description** |
| :- | :- |
| [add_point(point)](#add_point_point_1) | 원형 문자열의 끝에 점을 추가합니다. |
| [add_point(x, y)](#add_point_x_y_2) | 원형 문자열의 끝에 점을 추가합니다. |
| [add_point(x, y, z)](#add_point_x_y_z_3) | 원형 문자열의 끝에 점을 추가합니다. |
| [add_point(x, y, z, m)](#add_point_x_y_z_m_4) | 원형 문자열의 끝에 점을 추가합니다. |
...
| reverse() | 이 [CircularString](/psd/python-net/aspose.gis.geometries/circularstring/)의 점 순서를 반전시킵니다. |
...
새 인스턴스를 초기화합니다 [CircularString](/psd/python-net/aspose.gis.geometries/circularstring/) 클래스.
...
| 매개변수 | 형식 | 설명 |
| :- | :- | :- |
| other | [ICircularString](/psd/python-net/aspose.gis.geometries/icircularstring) | 데이터를 복사할 다른 문자열. |
...
| 형식 | 설명 |
| :- | :- |
| [CircularString](/psd/python-net/aspose.gis.geometries/circularstring) | 이 기하의 편집 가능한 복사본. |
