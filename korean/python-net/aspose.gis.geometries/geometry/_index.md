...
type: docs
weight: 50
url: /ko/python-net/aspose.gis.geometries/geometry/
---
...
| dimension | [GeometryDimension](/psd/python-net/aspose.gis.geometries/geometrydimension) | r | 이 [Geometry](/psd/python-net/aspose.gis.geometries/geometry/)의 위상 차원을 가져옵니다.<br/>            차원이 알려지지 않은 경우(예: 빈 GEOMETRYCOLLECTION) [GeometryDimension.POINT](/psd/python-net/aspose.gis.geometries/geometrydimension/)가 반환됩니다. |
...
| 형식 | 설명 |
| :- | :- |
| [Geometry](/psd/python-net/aspose.gis.geometries/geometry) | 이 기하의 편집 가능한 복사본. |
