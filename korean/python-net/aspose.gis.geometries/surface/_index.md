...
type: docs
weight: 320
url: /ko/python-net/aspose.gis.geometries/surface/
---
...
| [get_point_on_surface()](#get_point_on_surface__26) | 이 표면 위에 반드시 존재하는 점을 찾습니다. |
...
이 표면 위에 반드시 존재하는 점을 찾습니다.

**Returns**

| 형식 | 설명 |
| :- | :- |
| [IPoint](/psd/python-net/aspose.gis.geometries/ipoint) | 이 표면 위의 점. 표면에 내부가 없으면 빈 점. |
...
| 형식 | 설명 |
| :- | :- |
| [Surface](/psd/python-net/aspose.gis.geometries/surface) | 이 기하의 편집 가능한 복사본. |
