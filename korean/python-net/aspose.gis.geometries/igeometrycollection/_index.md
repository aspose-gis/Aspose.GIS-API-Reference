---
title: "IGeometryCollection 클래스"
type: docs
weight: 120
url: /ko/python-net/aspose.gis.geometries/igeometrycollection/
---
...
| [get_point_on_surface()](#get_point_on_surface__22) | 이 컬렉션의 표면 중 하나에 반드시 위치하는 점을 찾습니다. |
| [intersection(other)](#intersection_other_23) | 이 기하와 지정된 기하 사이의 교차점을 구축합니다. |
| [intersects(extent)](#intersects_extent_24) | 이 기하가 지정된 범위와 교차하는지 확인합니다. |
| [intersects(other)](#intersects_other_25) | 이 기하와 지정된 기하가 교차하는지 확인합니다. |
| [overlaps(other)](#overlaps_other_26) | 이 기하가 지정된 기하와 겹치는지 확인합니다. |
| [relate(other, intersection_pattern_matrix)](#relate_other_intersection_pattern_matrix_27) | 이 기하와 지정된 기하의 DE-9IM 교차 매트릭스가 제공된 패턴과 일치하는지 확인합니다. |
| [replace_polygons_by_lines()](#replace_polygons_by_lines__28) | 이 기하를 선으로 표현한 다각형을 가져옵니다. |
| [spatially_contains(other)](#spatially_contains_other_29) | 이 기하가 지정된 기하를 공간적으로 포함하는지 확인합니다. |
| [spatially_equals(other)](#spatially_equals_other_30) | 이 기하가 지정된 기하와 공간적으로 같은지 확인합니다. |
| [sym_difference(other)](#sym_difference_other_31) | 이 기하와 지정된 기하 사이의 대칭 차집합을 만듭니다. |
| [to_editable()](#to_editable__32) | 이 기하의 편집 가능한 복사본을 가져옵니다. |
| [to_linear_geometry()](#to_linear_geometry__33) | 기본 <c>tolerance</c>를 사용하여 이 기하의 근사 또는 동등한 비곡선 버전을 가져옵니다. |
| [to_linear_geometry(tolerance)](#to_linear_geometry_tolerance_34) | 지정된 <c>tolerance</c>를 사용하여 이 기하의 근사 또는 동등한 비곡선 버전을 가져옵니다. |
| [touches(other)](#touches_other_35) | 이 기하와 지정된 기하가 접하는지 판단합니다. |
| [union(other)](#union_other_36) | 이 기하와 지정된 기하를 합칩니다. |
| [union(other)](#union_other_37) | 이 기하와 지정된 기하를 합칩니다. |
| [within(extent)](#within_extent_38) | 이 기하가 지정된 범위 내에 있는지 판단합니다. |
| [within(other)](#within_other_39) | 이 기하가 지정된 기하 내에 있는지 판단합니다. |
...
| 매개변수 | 형식 | 설명 |
| :- | :- | :- |
| tolerance | double | 사용할 <c>tolerance</c>. 결과는 곡선 기하에서 <c>tolerance</c>보다 작은 거리임이 보장됩니다.<br/>            단, 기하를 선형화하는 데 필요한 점 수가 사분면당 최대값을 초과하는 경우는 제외하며,<br/>            현재 최대값은 10000점입니다. |
