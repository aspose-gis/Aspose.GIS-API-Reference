---
title: "CompoundCurve 클래스"
type: docs
weight: 20
url: /ko/python-net/aspose.gis.geometries/compoundcurve/
---
...
| **Name** | **Description** |
| :- | :- |
| [CompoundCurve()](#CompoundCurve__1) | 새로운 [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/) 클래스 인스턴스를 초기화합니다. |
| [CompoundCurve(curves)](#CompoundCurve_curves_2) | 새로운 [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/) 클래스 인스턴스를 초기화합니다. |
| [CompoundCurve(other)](#CompoundCurve_other_3) | 새로운 [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/) 클래스 인스턴스를 초기화합니다. |
## **Properties**
| **Name** | **Type** | **Access** | **Description** |
| :- | :- | :- | :- |
| coordinate_dimension | int | r | 이 [Geometry](/psd/python-net/aspose.gis.geometries/geometry/)에 대한 좌표 차원의 수를 가져옵니다. |
| count | int | r | [ICompoundCurve](/psd/python-net/aspose.gis.geometries/icompoundcurve/)에 포함된 곡선 수를 가져옵니다. |
...
| **Name** | **Description** |
| :- | :- |
| [add_curve(curve)](#add_curve_curve_1) | 이 [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/)의 끝에 곡선을 추가합니다. |
...
| [get_length()](#get_length__26) | 이 기하의 길이를 계산합니다. |
| [intersection(other)](#intersection_other_27) | 이 기하와 지정된 기하 사이의 교차점을 구축합니다. |
| [intersects(extent)](#intersects_extent_28) | 이 기하가 지정된 범위와 교차하는지 확인합니다. |
| [intersects(other)](#intersects_other_29) | 이 기하와 지정된 기하가 교차하는지 확인합니다. |
| [overlaps(other)](#overlaps_other_30) | 이 기하가 지정된 기하와 겹치는지 확인합니다. |
| [relate(other, intersection_pattern_matrix)](#relate_other_intersection_pattern_matrix_31) | 이 기하와 지정된 기하의 DE-9IM 교차 매트릭스가 제공된 패턴과 일치하는지 확인합니다. |
| [replace_polygons_by_lines()](#replace_polygons_by_lines__32) | 이 기하를 선으로 표현한 다각형을 가져옵니다. |
| reverse() | 이 [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/)를 역순으로 바꿉니다. 즉, 곡선들의 순서와 이 복합 곡선 내부의 모든 곡선을 역순으로 합니다. |
| [round_m(digits)](#round_m_digits_33) | M 좌표를 지정된 소수 자릿수로 반올림합니다. |
| [round_xy(digits)](#round_xy_digits_34) | X 및 Y 좌표를 지정된 소수 자릿수로 반올림합니다. |
| [round_z(digits)](#round_z_digits_35) | Z 좌표를 지정된 소수 자릿수로 반올림합니다. |
| set_empty() | 이 [Geometry](/psd/python-net/aspose.gis.geometries/geometry/)를 비웁니다. |
| [spatially_contains(other)](#spatially_contains_other_36) | 이 기하가 지정된 기하를 공간적으로 포함하는지 확인합니다. |
| [spatially_equals(other)](#spatially_equals_other_37) | 이 기하가 지정된 기하와 공간적으로 같은지 확인합니다. |
| [sym_difference(other)](#sym_difference_other_38) | 이 기하와 지정된 기하 사이의 대칭 차집합을 만듭니다. |
| [to_editable()](#to_editable__39) | 이 기하의 편집 가능한 복사본을 가져옵니다. |
| [to_linear_geometry()](#to_linear_geometry__40) | 기본 <c>tolerance</c>를 사용하여 이 기하의 근사 또는 동등한 비곡선 버전을 가져옵니다. |
| [to_linear_geometry(tolerance)](#to_linear_geometry_tolerance_41) | 지정된 <c>tolerance</c>를 사용하여 이 기하의 근사 또는 동등한 비곡선 버전을 가져옵니다. |
| [to_svg(extent)](#to_svg_extent_42) | 이 기하를 Svg 표현으로 변환합니다. |
| [touches(other)](#touches_other_43) | 이 기하와 지정된 기하가 접하는지 판단합니다. |
| [union(other)](#union_other_44) | 이 기하와 지정된 기하를 합칩니다. |
| [union(other)](#union_other_45) | 이 기하와 지정된 기하를 합칩니다. |
| [within(extent)](#within_extent_46) | 이 기하가 지정된 범위 내에 있는지 판단합니다. |
| [within(other)](#within_other_47) | 이 기하가 지정된 기하 내에 있는지 판단합니다. |
...
새로운 [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/) 클래스 인스턴스를 초기화합니다.
...
| 매개변수 | 형식 | 설명 |
| :- | :- | :- |
| 곡선들 | System.Collections.Generic.IEnumerable<ICurve> | 곡선들의 컬렉션입니다. |
...
| 매개변수 | 형식 | 설명 |
| :- | :- | :- |
| other | [ICompoundCurve](/psd/python-net/aspose.gis.geometries/icompoundcurve) | 데이터를 복사할 다른 선입니다. |
...
이 [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/)의 끝에 곡선을 추가합니다.

**Parameters:**

| 매개변수 | 형식 | 설명 |
| :- | :- | :- |
| curve | [ICurve](/psd/python-net/aspose.gis.geometries/icurve) | 추가할 곡선. |
...
| 형식 | 설명 |
| :- | :- |
| [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve) | 이 기하의 편집 가능한 복사본. |
