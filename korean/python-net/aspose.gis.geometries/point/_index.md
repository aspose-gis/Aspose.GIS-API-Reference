...
type: docs
weight: 300
url: /ko/python-net/aspose.gis.geometries/point/
---
...
| **Name** | **Description** |
| :- | :- |
| [Point()](#Point__1) | 새로운 [Point](/psd/python-net/aspose.gis.geometries/point/) 클래스 인스턴스를 초기화합니다. |
| [Point(other)](#Point_other_2) | 새로운 [Point](/psd/python-net/aspose.gis.geometries/point/) 클래스 인스턴스를 초기화합니다. |
| [Point(x, y)](#Point_x_y_3) | 새로운 [Point](/psd/python-net/aspose.gis.geometries/point/) 클래스 인스턴스를 초기화합니다. |
| [Point(x, y, z)](#Point_x_y_z_4) | 새로운 [Point](/psd/python-net/aspose.gis.geometries/point/) 클래스 인스턴스를 초기화합니다. |
| [Point(x, y, z, m)](#Point_x_y_z_m_5) | 새로운 [Point](/psd/python-net/aspose.gis.geometries/point/) 클래스 인스턴스를 초기화합니다. |
## **Properties**
...
| m | double | r/w | m-좌표의 값을 가져오거나 설정합니다. |
...
| x | double | r/w | x-좌표의 값을 가져오거나 설정합니다. |
| y | double | r/w | y-좌표의 값을 가져오거나 설정합니다. |
| z | double | r/w | z-좌표의 값을 가져오거나 설정합니다. |
## **Methods**
| **Name** | **Description** |
| :- | :- |
...
| [from_binary(wkb)](#from_binary_wkb_15) | Well-Known Binary 표현에서 기하를 생성합니다. |
| [from_binary(wkb, spatial_reference_system)](#from_binary_wkb_spatial_reference_system_16) | Well-Known Binary 표현에서 기하를 생성합니다. |
| [from_text(wkt)](#from_text_wkt_17) | Well-Known Text 표현에서 기하를 생성합니다. |
| [from_text(wkt, spatial_reference_system)](#from_text_wkt_spatial_reference_system_18) | Well-Known Text 표현에서 기하를 생성합니다. |
| [get_area()](#get_area__19) | 이 기하의 면적을 계산합니다. |
| [get_buffer(distance, quadrant_segments)](#get_buffer_distance_quadrant_segments_20) | 이 기하 주변에 버퍼 영역을 계산합니다. |
| [get_centroid()](#get_centroid__21) | 이 기하의 중심점을 계산합니다. |
| [get_convex_hull()](#get_convex_hull__22) | 이 기하의 볼록 껍질을 계산합니다. |
| [get_distance_to(other)](#get_distance_to_other_23) | 이 기하와 지정된 기하 사이의 최소 거리를 계산합니다. |
| [get_extent()](#get_extent__24) | 이 기하의 경계 범위를 계산하고 반환합니다. |
| [get_length()](#get_length__25) | 이 기하의 길이를 계산합니다. |
| [intersection(other)](#intersection_other_26) | 이 기하와 지정된 기하 사이의 교차점을 구축합니다. |
| [intersects(extent)](#intersects_extent_27) | 이 기하가 지정된 범위와 교차하는지 확인합니다. |
| [intersects(other)](#intersects_other_28) | 이 기하와 지정된 기하가 교차하는지 확인합니다. |
| [overlaps(other)](#overlaps_other_29) | 이 기하가 지정된 기하와 겹치는지 확인합니다. |
| [relate(other, intersection_pattern_matrix)](#relate_other_intersection_pattern_matrix_30) | 이 기하와 지정된 기하의 DE-9IM 교차 매트릭스가 제공된 패턴과 일치하는지 확인합니다. |
| [replace_polygons_by_lines()](#replace_polygons_by_lines__31) | 이 기하를 선으로 표현한 다각형을 가져옵니다. |
| [round_m(digits)](#round_m_digits_32) | M 좌표를 지정된 소수 자릿수로 반올림합니다. |
| [round_xy(digits)](#round_xy_digits_33) | X 및 Y 좌표를 지정된 소수 자릿수로 반올림합니다. |
| [round_z(digits)](#round_z_digits_34) | Z 좌표를 지정된 소수 자릿수로 반올림합니다. |
| set_empty() | 이 [Geometry](/psd/python-net/aspose.gis.geometries/geometry/)를 비웁니다. |
| [spatially_contains(other)](#spatially_contains_other_35) | 이 기하가 지정된 기하를 공간적으로 포함하는지 확인합니다. |
| [spatially_equals(other)](#spatially_equals_other_36) | 이 기하가 지정된 기하와 공간적으로 같은지 확인합니다. |
| [sym_difference(other)](#sym_difference_other_37) | 이 기하와 지정된 기하 사이의 대칭 차집합을 만듭니다. |
| [to_editable()](#to_editable__38) | 이 기하의 편집 가능한 복사본을 가져옵니다. |
| [to_linear_geometry()](#to_linear_geometry__39) | 기본 <c>tolerance</c>를 사용하여 이 기하의 근사 또는 동등한 비곡선 버전을 가져옵니다. |
| [to_linear_geometry(tolerance)](#to_linear_geometry_tolerance_40) | 지정된 <c>tolerance</c>를 사용하여 이 기하의 근사 또는 동등한 비곡선 버전을 가져옵니다. |
| [to_svg(extent)](#to_svg_extent_41) | 이 기하를 Svg 표현으로 변환합니다. |
| [touches(other)](#touches_other_42) | 이 기하와 지정된 기하가 접하는지 판단합니다. |
| [union(other)](#union_other_43) | 이 기하와 지정된 기하를 합칩니다. |
| [union(other)](#union_other_44) | 이 기하와 지정된 기하를 합칩니다. |
| [within(extent)](#within_extent_45) | 이 기하가 지정된 범위 내에 있는지 판단합니다. |
| [within(other)](#within_other_46) | 이 기하가 지정된 기하 내에 있는지 판단합니다. |
...
새로운 [Point](/psd/python-net/aspose.gis.geometries/point/) 클래스 인스턴스를 초기화합니다.
...
| 매개변수 | 형식 | 설명 |
| :- | :- | :- |
| other | [IPoint](/psd/python-net/aspose.gis.geometries/ipoint) | 데이터를 복사할 다른 [IPoint](/psd/python-net/aspose.gis.geometries/ipoint/)입니다. |
...
| 형식 | 설명 |
| :- | :- |
| [Point](/psd/python-net/aspose.gis.geometries/point) | 이 기하의 편집 가능한 복사본. |
