---
title: "CompoundSpatialReferenceSystem 클래스"
type: docs
weight: 30
url: /ko/python-net/aspose.gis.spatialreferencing/compoundspatialreferencesystem/
---
...
| :- | :- | :- | :- |
| as_compound | [CompoundSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/compoundspatialreferencesystem) | r | 이를 반환합니다. |
...
| as_geographic | [GeographicSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/geographicspatialreferencesystem) | r | 이 SRS의 지리적 표현을 반환합니다. 이 복합 SRS가 실제로 지리 SRS를 나타내면 결과는<br/>            3차원 지리 SRS(경도, 위도, 높이 차원)입니다. 그렇지 않으면 예외가 발생합니다. |
...
| as_projected | [ProjectedSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem) | r | 이 SRS의 투영된 표현을 반환합니다. 이 복합 SRS가 실제로 투영 SRS를 나타내면 결과는<br/>            3차원 투영 SRS(X, Y, 높이 차원)입니다. 그렇지 않으면 예외가 발생합니다. |
...
| dimensions_count | int | r | 차원 수. 복합 SRS의 경우 이는 기본 SRS의 차원 수의 합계입니다. |
...
| geographic_datum | [GeographicDatum](/psd/python-net/aspose.gis.spatialreferencing/geographicdatum) | r | 이 SRS의 지리적 기준을 반환합니다.<br/> 두 [CompoundSpatialReferenceSystem.head](/psd/python-net/aspose.gis.spatialreferencing/compoundspatialreferencesystem/) 및 [CompoundSpatialReferenceSystem.tail](/psd/python-net/aspose.gis.spatialreferencing/compoundspatialreferencesystem/)가 모두 지리적 기준을 가지고 있는 경우 - head의 지리적 기준을 반환합니다. |
| has_geographic_datum | bool | r | 복합 SRS는 기본 SRS 중 하나라도 지리적 기준을 가지고 있으면 지리적 기준을 가집니다. |
| has_prime_meridian | bool | r | 복합 SRS는 기본 SRS 중 하나라도 본초 자오선을 가지고 있으면 본초 자오선을 가집니다. |
| head | [SpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem) | r | 첫 번째 기본 SRS. |
| identifier | [Identifier](/psd/python-net/aspose.gis.spatialreferencing/identifier) | r | 이 식별 가능한 객체의 식별자입니다. |
| is_compound | bool | r | 반환합니다 <see langword="true" />. |
...
| prime_meridian | [PrimeMeridian](/psd/python-net/aspose.gis.spatialreferencing/primemeridian) | r | 이 SRS의 본초 자오선을 반환합니다.<br/> 두 [CompoundSpatialReferenceSystem.head](/psd/python-net/aspose.gis.spatialreferencing/compoundspatialreferencesystem/) 및 [CompoundSpatialReferenceSystem.tail](/psd/python-net/aspose.gis.spatialreferencing/compoundspatialreferencesystem/)가 모두 본초 자오선을 가지고 있는 경우 - head의 본초 자오선을 반환합니다. |
| tail | [SpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem) | r | 두 번째 기본 SRS. |
| type | [SpatialReferenceSystemType](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype) | r | 이 복합 SRS의 유형. 이 복합 SRS가 지리적 및 수직 SRS의 조합인 경우 [SpatialReferenceSystemType.GEOGRAPHIC](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/)가 될 수 있으며, <br/> 이 복합 SRS가 투영 및 수직 SRS의 조합인 경우 [SpatialReferenceSystemType.PROJECTED](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/)가 될 수 있습니다. |
...
| [validate(error_message)](#validate_error_message_18) | 이 SRS가 유효한지 판단합니다. 유효성 설명은 <see cref=\"M:Aspose.Gis.SpatialReferencing.SpatialReferenceSystem.Validate(string@)\" /> 를 참조하십시오. |
...
이 SRS가 유효한지 판단합니다. 유효성 설명은 <see cref=\"M:Aspose.Gis.SpatialReferencing.SpatialReferenceSystem.Validate(string@)\" /> 를 참조하십시오.

**Parameters:**

| 매개변수 | 형식 | 설명 |
| :- | :- | :- |
| error_message | 문자열 | 무효성 설명 (결과가 <see langword="false" />인 경우) |

**Returns**

| 형식 | 설명 |
| :- | :- |
| bool | 이 SRS가 유효하면 - <see langword="true" />, 그렇지 않으면 - <see langword="false" />. |
