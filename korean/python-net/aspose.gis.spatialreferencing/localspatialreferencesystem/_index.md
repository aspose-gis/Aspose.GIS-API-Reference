---
title: "LocalSpatialReferenceSystem 클래스"
type: docs
weight: 130
url: /ko/python-net/aspose.gis.spatialreferencing/localspatialreferencesystem/
---
...
| as_local | [LocalSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/localspatialreferencesystem) | r | 이를 반환합니다. |
...
| dimensions_count | int | r | 이 SRS의 차원 수. |
...
| geographic_datum | [GeographicDatum](/psd/python-net/aspose.gis.spatialreferencing/geographicdatum) | r | Local SRS에는 지리적 기준점이 없으므로 InvalidOperationException을 발생시킵니다. |
| has_geographic_datum | bool | r | Local SRS에는 지리적 기준점이 없으므로 <see langword="false" />를 반환합니다. |
| has_prime_meridian | bool | r | Local SRS에는 기본 자오선이 없으므로 <see langword="false" />를 반환합니다. |
...
| local_datum | [LocalDatum](/psd/python-net/aspose.gis.spatialreferencing/localdatum) | r | 측정 방법을 설명하는 기준점. |
...
| prime_meridian | [PrimeMeridian](/psd/python-net/aspose.gis.spatialreferencing/primemeridian) | r | Local SRS에는 기본 자오선이 없으므로 InvalidOperationException을 발생시킵니다. |
| type | [SpatialReferenceSystemType](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype) | r | 반환합니다 [SpatialReferenceSystemType.LOCAL](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/). |
| unit | [Unit](/psd/python-net/aspose.gis.spatialreferencing/unit) | r | 이 SRS의 단위. |
...
| [get_unit(dimension)](#get_unit_dimension_12) | 차원의 [LocalSpatialReferenceSystem.unit](/psd/python-net/aspose.gis.spatialreferencing/localspatialreferencesystem/)를 가져옵니다. |
...
차원의 [LocalSpatialReferenceSystem.unit](/psd/python-net/aspose.gis.spatialreferencing/localspatialreferencesystem/)를 가져옵니다.
