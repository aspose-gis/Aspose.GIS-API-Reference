---
title: "GeocentricSpatialReferenceSystem 클래스"
type: docs
weight: 50
url: /ko/python-net/aspose.gis.spatialreferencing/geocentricspatialreferencesystem/
---
...
| as_geocentric | [GeocentricSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/geocentricspatialreferencesystem) | r | 이를 반환합니다. |
...
| axises_order | [GeocentricAxisesOrder](/psd/python-net/aspose.gis.spatialreferencing/geocentricaxisesorder) | r | 이 SRS의 축 순서.<br/>            이 SRS가 유효하지 않고 축 방향이 잘못된 경우, [GeocentricAxisesOrder.INVALID](/psd/python-net/aspose.gis.spatialreferencing/geocentricaxisesorder/) 가 반환됩니다. |
| dimensions_count | int | r | 지오센트릭 SRS는 항상 3차원이므로 3을 반환합니다. |
...
| geographic_datum | [GeographicDatum](/psd/python-net/aspose.gis.spatialreferencing/geographicdatum) | r | 이 SRS의 지리적 기준을 반환합니다. |
| has_geographic_datum | bool | r | <see langword=\"true\" /> 를 반환합니다, 지오센트릭 SRS는 항상 지리적 기준을 가지고 있기 때문입니다. |
| has_prime_meridian | bool | r | <see langword=\"true\" /> 를 반환합니다, 지오센트릭 SRS는 항상 기본 자오선을 가지고 있기 때문입니다. |
...
| linear_unit | [Unit](/psd/python-net/aspose.gis.spatialreferencing/unit) | r | 이 SRS에서 사용되는 단위. |
...
| type | [SpatialReferenceSystemType](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype) | r | 다음 값을 반환합니다: [SpatialReferenceSystemType.GEOCENTRIC](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/). |
