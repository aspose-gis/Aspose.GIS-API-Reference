---
title: "ProjectedSpatialReferenceSystem 클래스"
type: docs
weight: 150
url: /ko/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/
---
...
| as_geographic | [GeographicSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/geographicspatialreferencesystem) | r | 이 SRS를 [GeographicSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/geographicspatialreferencesystem/) 로 변환한 결과를 반환합니다.<br/>            변환이 가능한지 확인하려면 [SpatialReferenceSystem.type](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem/) 를 사용하십시오. |
...
| as_projected | [ProjectedSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem) | r | 이를 반환합니다. |
...
| axises_order | [ProjectedAxisesOrder](/psd/python-net/aspose.gis.spatialreferencing/projectedaxisesorder) | r | 이 SRS의 축 순서입니다.<br/>            이 SRS가 유효하지 않으며 축 방향이 잘못된 경우 [ProjectedAxisesOrder.INVALID](/psd/python-net/aspose.gis.spatialreferencing/projectedaxisesorder/) 가 반환됩니다. |
| base | [GeographicSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/geographicspatialreferencesystem) | r | 이 SRS를 얻기 위해 [ProjectedSpatialReferenceSystem.projection](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/) 이 적용된 지리적 SRS입니다. |
| dimensions_count | int | r | 이 SRS의 차원 수를 반환합니다. 투영된 SRS의 경우 다음과 같습니다:<br/>            two - 이 경우 단일 투영 SRS입니다.<br/>            three - 이 경우 복합 SRS이며, 단일 2차원 투영 SRS와 수직 SRS로 구성되어 세 번째 차원을 추가합니다. |
...
| has_geographic_datum | bool | r | 투영된 SRS는 항상 기본 자오선을 가지므로 true를 반환합니다. |
| has_prime_meridian | bool | r | 투영된 SRS는 항상 기본 자오선을 가지므로 true를 반환합니다. |
...
| linear_unit | [Unit](/psd/python-net/aspose.gis.spatialreferencing/unit) | r | 이 SRS에서 선형 차원 및 [ProjectedSpatialReferenceSystem.projection](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/) 의 선형 매개변수에 사용되는 단위입니다. |
...
| projection | [Projection](/psd/python-net/aspose.gis.spatialreferencing/projection) | r | 이 SRS를 얻기 위해 [ProjectedSpatialReferenceSystem.base](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/) 에 적용된 투영입니다. |
| type | [SpatialReferenceSystemType](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype) | r | 반환합니다 [SpatialReferenceSystemType.PROJECTED](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/). |
