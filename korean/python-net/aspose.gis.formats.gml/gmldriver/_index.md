...
type: docs
weight: 10
url: /ko/python-net/aspose.gis.formats.gml/gmldriver/
---
...
| [create_layer(path, options, spatial_reference_system)](#create_layer_path_options_spatial_reference_system_14) | 새 레이어를 만들고 새 피처를 추가하기 위해 엽니다. |
...
| :- | :- | :- |
| path | string | 파일 경로. |
| options | [GmlOptions](/psd/python-net/aspose.gis.formats.gml/gmloptions) | 드라이버별 옵션. |
