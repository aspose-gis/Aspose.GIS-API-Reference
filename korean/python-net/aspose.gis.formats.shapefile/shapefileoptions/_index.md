---
title: "ShapefileOptions 클래스"
type: docs
weight: 20
url: /ko/python-net/aspose.gis.formats.shapefile/shapefileoptions/
---
...
| **Name** | **Description** |
| :- | :- |
| [ShapefileOptions()](#ShapefileOptions__1) | 새 인스턴스를 생성합니다. |
## **Properties**
...
| is_ignore_wrong_data | bool | r/w | 잘못된 데이터를 파싱할 때 예외를 발생시킬지 아니면 기본값을 설정할지 결정합니다. |
