...
type: docs
weight: 10
url: /ko/python-net/aspose.gis.formats.csv/csvdriver/
---
...
| **Name** | **Description** |
| :- | :- |
| [CsvDriver()](#CsvDriver__1) | CsvDriver 클래스의 새 인스턴스를 초기화합니다. |
## **Properties**
...
| :- | :- | :- |
| path | string | 파일 경로. |
| options | [CsvOptions](/psd/python-net/aspose.gis.formats.csv/csvoptions) | 드라이버별 옵션. |
