...
type: docs
weight: 140
url: /ko/python-net/aspose.gis.formats.kml/kmllayer/
---
...
| driver | [Driver](/psd/python-net/aspose.gis/driver) | r | 이 레이어를 인스턴스화한 [KmlLayer.driver](/psd/python-net/aspose.gis.formats.kml/kmllayer/)를 가져옵니다. |
| features | [Feature[]](/psd/python-net/aspose.gis/feature) | r | 특성 목록을 가져옵니다. |
| geometry_type | [GeometryType](/psd/python-net/aspose.gis.geometries/geometrytype/) | r | 레이어의 기하학 유형을 가져옵니다. |
| ground_overlay_list | System.Collections.Generic.List<Aspose.Gis.Formats.Kml.SpecificFields.KmlGroundOverlayInfo> | r | GroundOverlay 노드에서 가져온 KmlGroundOverlayInfo 목록 |
| network_link_list | System.Collections.Generic.List<Aspose.Gis.Formats.Kml.SpecificFields.KmlNetworkLinkInfo> | r | NetworkLink 노드에서 가져온 KmlNetworkLinkInfo 목록 |
| region_list | System.Collections.Generic.List<Aspose.Gis.Formats.Kml.SpecificFields.KmlRegionInfo> | r | Region 노드에서 가져온 KmlRegionInfo 목록 |
| spatial_reference_system | [SpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem/) | r | 이 레이어의 공간 참조 시스템을 가져옵니다. KML의 경우 항상 WGS84입니다. |
## **Methods**
| **Name** | **Description** |
| :- | :- |
