...
description: Aspose.Gis.Formats.SqlServer.SqlServerOptions 수업. SqlServer 형식에 대한 드라이버별 옵션입니다. 현재 드라이버는 사용자 지정 가능한 옵션을 제공하지 않습니다.
type: docs
weight: 690
url: /ko/net/aspose.gis.formats.sqlserver/sqlserveroptions/
---
## SqlServerOptions class

SqlServer 형식에 대한 드라이버별 옵션입니다. 현재 드라이버는 사용자 지정 가능한 옵션을 제공하지 않습니다.
...
| 이름 | 설명 |
| --- | --- |
| [SqlServerOptions](sqlserveroptions/)() | 새 인스턴스를 만듭니다. |
...
* 네임스페이스 [Aspose.Gis.Formats.SqlServer](../../aspose.gis.formats.sqlserver/)
* 집회 [Aspose.GIS](../../)
