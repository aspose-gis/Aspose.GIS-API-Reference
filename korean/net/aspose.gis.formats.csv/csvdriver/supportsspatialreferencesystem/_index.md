...
description: CsvDriver 방법. 지정된 공간 참조 시스템이 드라이버에서 지원되는지 여부를 결정합니다.
type: docs
weight: 70
url: /ko/net/aspose.gis.formats.csv/csvdriver/supportsspatialreferencesystem/
---
...
CSV의 경우 유일하게 지원되는 공간 참조 시스템은 WGS84입니다.

### 또한보십시오

* class [SpatialReferenceSystem](../../../aspose.gis.spatialreferencing/spatialreferencesystem/)
* class [CsvDriver](../)
* 네임스페이스 [Aspose.Gis.Formats.Csv](../../csvdriver/)
* 집회 [Aspose.GIS](../../../)
