...
description: Aspose.Gis.Formats.Kml.KmlOptions 수업. KML 형식에 대한 드라이버별 옵션입니다.
type: docs
weight: 410
url: /ko/net/aspose.gis.formats.kml/kmloptions/
---
## KmlOptions class

KML 형식에 대한 드라이버별 옵션입니다.
...
| 이름 | 설명 |
| --- | --- |
| [KmlOptions](kmloptions/)() | 새 인스턴스를 만듭니다. |

## 속성

| 이름 | 설명 |
| --- | --- |
| [AltitudeMode](../../aspose.gis.formats.kml/kmloptions/altitudemode/) { get; set; } | KML 기하학에 사용할 AltitudeModes를 지정할 수 있습니다 |
| [AutoId](../../aspose.gis.formats.kml/kmloptions/autoid/) { get; set; } | 자동 생성 ids |
...
| [DocumentId](../../aspose.gis.formats.kml/kmloptions/documentid/) { get; set; } | 루트 '문서' node 의 ID를 지정하는 데 사용됩니다. |
...
| [SymbolToReplaceInvalidChars](../../aspose.gis.formats.kml/kmloptions/symboltoreplaceinvalidchars/) { get; set; } | 읽을 때 유효하지 않은 문자를 대체하는 데 사용할 기호를 결정합니다. 값이 '\0'이면 대체를 건너뜁니다. 기본 값은 '\0' char. 입니다. |
