...
description: EsriJsonDriver 방법. 읽기용 레이어를 엽니다.
type: docs
weight: 50
url: /ko/net/aspose.gis.formats.esrijson/esrijsondriver/openlayer/
---
...
| --- | --- | --- |
| path | String | 파일 경로. |
| options | EsriJsonOptions | 드라이버별 옵션. |
...
* 네임스페이스 [Aspose.Gis.Formats.EsriJson](../../esrijsondriver/)
* 집회 [Aspose.GIS](../../../)
