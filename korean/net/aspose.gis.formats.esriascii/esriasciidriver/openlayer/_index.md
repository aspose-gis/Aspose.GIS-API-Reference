...
description: EsriAsciiDriver 방법. 읽기용 레이어를 엽니다.
type: docs
weight: 20
url: /ko/net/aspose.gis.formats.esriascii/esriasciidriver/openlayer/
---
...
* 네임스페이스 [Aspose.Gis.Formats.EsriAscii](../../esriasciidriver/)
* 집회 [Aspose.GIS](../../../)
...
| --- | --- | --- |
| path | String | 파일 경로. |
| options | EsriAsciiOptions | 드라이버별 옵션. |
