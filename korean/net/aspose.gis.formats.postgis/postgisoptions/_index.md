...
description: Aspose.Gis.Formats.PostGis.PostGisOptions 수업. PostGis 형식에 대한 드라이버별 옵션입니다. 현재 드라이버는 사용자 지정 가능한 옵션을 제공하지 않습니다.
type: docs
weight: 650
url: /ko/net/aspose.gis.formats.postgis/postgisoptions/
---
## PostGisOptions class

PostGis 형식에 대한 드라이버별 옵션입니다. 현재 드라이버는 사용자 지정 가능한 옵션을 제공하지 않습니다.
...
| 이름 | 설명 |
| --- | --- |
| [PostGisOptions](postgisoptions/)() | 새 인스턴스를 만듭니다. |
...
* 네임스페이스 [Aspose.Gis.Formats.PostGis](../../aspose.gis.formats.postgis/)
* 집회 [Aspose.GIS](../../)
