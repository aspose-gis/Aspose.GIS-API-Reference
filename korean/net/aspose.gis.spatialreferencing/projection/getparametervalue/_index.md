...
description: Projection 방법. 이 프로젝션의 지정된 이름을 가진 매개변수를 가져옵니다.
type: docs
weight: 40
url: /ko/net/aspose.gis.spatialreferencing/projection/getparametervalue/
---
## Projection.GetParameterValue method

이 프로젝션의 지정된 이름을 가진 매개변수를 가져옵니다.
...
| InvalidOperationException | 이 이름을 가진 매개변수가 없습니다. |
