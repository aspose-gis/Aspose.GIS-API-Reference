...
description: Aspose.Gis.Formats.GeoTiff.GeoTiffOptions 수업. GeoTiff 형식에 대한 드라이버별 옵션.
type: docs
weight: 330
url: /ko/net/aspose.gis.formats.geotiff/geotiffoptions/
---
## GeoTiffOptions class

GeoTiff 형식에 대한 드라이버별 옵션.
...
| 이름 | 설명 |
| --- | --- |
| [GeoTiffOptions](geotiffoptions/)() | 새 인스턴스를 만듭니다. |
...
* 네임스페이스 [Aspose.Gis.Formats.GeoTiff](../../aspose.gis.formats.geotiff/)
* 집회 [Aspose.GIS](../../)
