...
description: Aspose.Gis.Geometries.GeometryCollection 수업. AGeometryCollection 이다Geometry 이는 하나 이상의 기하학 모음입니다.
type: docs
weight: 930
url: /ko/net/aspose.gis.geometries/geometrycollection/
---
## GeometryCollection class

A`GeometryCollection` 이다[`Geometry`](../geometry/) 이는 하나 이상의 기하학 모음입니다.
...
| 이름 | 설명 |
| --- | --- |
| [GeometryCollection](geometrycollection/)() | 의 새 인스턴스를 초기화합니다.`GeometryCollection` 클래스. |
...
| override [Dimension](../../aspose.gis.geometries/geometrycollection/dimension/) { get; } | 이것의 토폴로지 차원을 가져옵니다.[`Geometry`](../geometry/) . 컬렉션이 비어 있는 경우,Point 반환됩니다. |
| override [GeometryType](../../aspose.gis.geometries/geometrycollection/geometrytype/) { get; } | 지오메트리 유형을 가져옵니다. |
...
| override [Clone](../../aspose.gis.geometries/geometrycollection/clone/)() | 이 인스턴스를 복제합니다. |
...
| [Equals](../../aspose.gis.geometries/geometrycollection/equals/#equals)(IGeometryCollection) | 현재 개체가 같은 유형의 다른 개체와 같은지 여부를 나타냅니다. |
| override [Equals](../../aspose.gis.geometries/geometrycollection/equals/#equals_1)(object) | 지정된 개체가 현재 개체와 같은지 여부를 확인합니다. |
...
| [ReplacePolygonsByLines](../../aspose.gis.geometries/geometrycollection/replacepolygonsbylines/#replacepolygonsbylines_1)() | 이 도형의 선으로 표현되는 다각형을 가져옵니다. (2 methods) |
...
| [ToEditable](../../aspose.gis.geometries/geometrycollection/toeditable/#toeditable_1)() | 이 지오메트리의 편집 가능한 복사본을 가져옵니다. (2 methods) |
| [ToEditable&lt;T&gt;](../../aspose.gis.geometries/geometry/toeditable/)() | 이 지오메트리의 편집 가능한 복사본을 가져옵니다. |
| [ToLinearGeometry](../../aspose.gis.geometries/geometrycollection/tolineargeometry/#tolineargeometry_2)() | 기본값을 사용하여 이 지오메트리의 대략적이거나 동등한 비곡선 버전을 가져옵니다.`용인` . (2 methods) |
| [ToLinearGeometry](../../aspose.gis.geometries/geometrycollection/tolineargeometry/#tolineargeometry_3)(double) | 지정된 값을 사용하여 이 지오메트리의 대략적이거나 동등한 비곡선 버전을 가져옵니다.`용인` . (2 methods) |
...
| [operator ==](../../aspose.gis.geometries/geometrycollection/op_equality/) | ==. 연산자 구현 |
| [operator !=](../../aspose.gis.geometries/geometrycollection/op_inequality/) | 연산자 구현 !=. |
