...
description: Aspose.Gis.Geometries.LineString 수업. 다중 정점 라인.
type: docs
weight: 1120
url: /ko/net/aspose.gis.geometries/linestring/
---
## LineString class
...
| 이름 | 설명 |
| --- | --- |
| [LineString](linestring/#constructor)() | 의 새 인스턴스를 초기화합니다.`LineString` 클래스. |
| [LineString](linestring/#constructor_2)(IEnumerable&lt;IPoint&gt;) | 의 새 인스턴스를 초기화합니다.`LineString` 클래스. |
| [LineString](linestring/#constructor_1)(ILineString) | 의 새 인스턴스를 초기화합니다.`LineString` 클래스. |
...
| [Count](../../aspose.gis.geometries/linestring/count/) { get; } | 에 있는 포인트 수를 가져옵니다.`LineString` . |
...
| override [GeometryType](../../aspose.gis.geometries/linestring/geometrytype/) { get; } | 지오메트리 유형을 가져옵니다. |
...
| 이름 | 설명 |
| --- | --- |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint/#addpoint)(IPoint) | 선의 끝에 점을 추가합니다. |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint/#addpoint_1)(double, double) | 선의 끝에 점을 추가합니다. |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint/#addpoint_2)(double, double, double) | 선의 끝에 점을 추가합니다. |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint/#addpoint_3)(double, double, double, double) | 선의 끝에 점을 추가합니다. |
...
| override [Clone](../../aspose.gis.geometries/linestring/clone/)() | 이 인스턴스를 복제합니다. |
...
| [Equals](../../aspose.gis.geometries/linestring/equals/#equals)(ILineString) | 현재 개체가 같은 유형의 다른 개체와 같은지 여부를 나타냅니다. |
| override [Equals](../../aspose.gis.geometries/linestring/equals/#equals_1)(object) | 지정된 개체가 현재 개체와 같은지 여부를 확인합니다. |
...
| override [Reverse](../../aspose.gis.geometries/linestring/reverse/)() | 이 점의 순서를 반대로 합니다.`LineString` . |
...
| [ToEditable](../../aspose.gis.geometries/linestring/toeditable/#toeditable_2)() | 이 지오메트리의 편집 가능한 복사본을 가져옵니다. (3 methods) |
...
| [operator ==](../../aspose.gis.geometries/linestring/op_equality/) | ==. 연산자 구현 |
| [operator !=](../../aspose.gis.geometries/linestring/op_inequality/) | 연산자 구현 !=. |
