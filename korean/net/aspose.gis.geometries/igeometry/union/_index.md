...
description: IGeometry 방법. 이 기하학과 지정된 기하학을 통합합니다.
type: docs
weight: 370
url: /ko/net/aspose.gis.geometries/igeometry/union/
---
## IGeometry.Union method

이 기하학과 지정된 기하학을 통합합니다.
...
| 모수 | 유형 | 설명 |
| --- | --- | --- |
| other | IGeometry | 결합할 형상입니다. |

### 반환 값

이 기하학과 인수의 합집합을 나타내는 기하학입니다. 결과 지오메트리는 이 지오메트리 또는 인수에 있는 포인트 세트를 포함합니다.
