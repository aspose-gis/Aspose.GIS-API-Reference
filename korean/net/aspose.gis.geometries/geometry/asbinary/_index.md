...
description: Geometry 방법. 이 기하학을 WellKnown Binary 표현으로 변환합니다.
type: docs
weight: 110
url: /ko/net/aspose.gis.geometries/geometry/asbinary/
---
## AsBinary() {#asbinary}
...
| 예외 | 상태 |
| --- | --- |
| NotSupportedException | 요청한 WKB 변형에서 형상을 나타낼 수 없습니다. 현재 이것은 when 에 발생합니다.[`HasCurveGeometry`](../hascurvegeometry/) 기하학의`true` 및 WKB 변형 is SimpleFeatureAccessOutdated . |
