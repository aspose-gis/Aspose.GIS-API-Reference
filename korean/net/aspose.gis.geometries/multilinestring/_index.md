...
description: Aspose.Gis.Geometries.MultiLineString 수업. AMultiLineString 일차원적이다GeometryCollection 그의 요소는LineString s.
type: docs
weight: 1150
url: /ko/net/aspose.gis.geometries/multilinestring/
---
## MultiLineString class

A`MultiLineString` 일차원적이다[`GeometryCollection`](../geometrycollection/) 그의 요소는[`LineString`](../linestring/) s.
...
| 이름 | 설명 |
| --- | --- |
| [MultiLineString](multilinestring/)() | 의 새 인스턴스를 초기화합니다.`MultiLineString` 클래스. |
...
| [Dimension](../../aspose.gis.geometries/multicurve/dimension/) { get; } | 이것의 토폴로지 차원을 가져옵니다.[`Geometry`](../geometry/) . |
| override [GeometryType](../../aspose.gis.geometries/multilinestring/geometrytype/) { get; } | 지오메트리 유형을 가져옵니다. |
...
| virtual [IsClosed](../../aspose.gis.geometries/multicurve/isclosed/) { get; } | 이 커브가 닫혀 있는지 여부를 결정합니다. |
...
| override [Clone](../../aspose.gis.geometries/multilinestring/clone/)() | 이 인스턴스를 복제합니다. |
...
| [ToEditable](../../aspose.gis.geometries/multilinestring/toeditable/#toeditable_3)() | 이 지오메트리의 편집 가능한 복사본을 가져옵니다. (4 methods) |
| [ToEditable&lt;T&gt;](../../aspose.gis.geometries/geometry/toeditable/)() | 이 지오메트리의 편집 가능한 복사본을 가져옵니다. |
| [ToLinearGeometry](../../aspose.gis.geometries/multicurve/tolineargeometry/)() | 기본값을 사용하여 이 지오메트리의 대략적이거나 동등한 비곡선 버전을 가져옵니다.`용인` . (3 methods) |
| [ToLinearGeometry](../../aspose.gis.geometries/multicurve/tolineargeometry/)(double) | 지정된 값을 사용하여 이 지오메트리의 대략적이거나 동등한 비곡선 버전을 가져옵니다.`용인` . (3 methods) |
