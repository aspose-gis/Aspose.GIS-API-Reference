...
description: Aspose.Gis.Geometries.CurvePolygon 수업. 외부 경계 1개와 내부 경계 0개 이상으로 정의된 평면 표면.
type: docs
weight: 910
url: /ko/net/aspose.gis.geometries/curvepolygon/
---
## CurvePolygon class
...
| 이름 | 설명 |
| --- | --- |
| [CurvePolygon](curvepolygon/#constructor)() | 의 새 인스턴스를 초기화합니다.`CurvePolygon` 클래스. |
| [CurvePolygon](curvepolygon/#constructor_1)(ICurve) | 의 새 인스턴스를 초기화합니다.`CurvePolygon` 클래스. |
| [CurvePolygon](curvepolygon/#constructor_2)(ICurve, IEnumerable&lt;ICurve&gt;) | 의 새 인스턴스를 초기화합니다.`CurvePolygon` 클래스. |
...
| [ExteriorRing](../../aspose.gis.geometries/curvepolygon/exteriorring/) { get; set; } | 외부 링을 가져옵니다. |
| override [GeometryType](../../aspose.gis.geometries/curvepolygon/geometrytype/) { get; } | 지오메트리 유형을 가져옵니다. |
| override [HasCurveGeometry](../../aspose.gis.geometries/curvepolygon/hascurvegeometry/) { get; } | 이 도형이 곡선(선형 아님) 도형인지 또는 포함하는지 나타내는 값을 가져옵니다. |
| [HasM](../../aspose.gis.geometries/curvepolygon/hasm/) { get; set; } | 이 인스턴스에 M 좌표가 있는지 여부를 나타내는 값을 가져옵니다. |
| [HasZ](../../aspose.gis.geometries/curvepolygon/hasz/) { get; set; } | 이 인스턴스에 Z 좌표가 있는지 여부를 나타내는 값을 가져옵니다. |
| [InteriorRingsCount](../../aspose.gis.geometries/curvepolygon/interiorringscount/) { get; } | 내부 링의 수를 가져옵니다. |
| override [IsEmpty](../../aspose.gis.geometries/curvepolygon/isempty/) { get; } | 이 인스턴스가 비어 있는지 여부를 나타내는 값을 가져옵니다. |
...
| [SpatialReferenceSystem](../../aspose.gis.geometries/curvepolygon/spatialreferencesystem/) { get; set; } | 이 인스턴스의 SpatialReferenceSystem을 가져옵니다. 이 속성은 다음과 같을 수 있습니다.`null` , SpatialReferenceSystem is unknown. 새 SpatialReferenceSystem을 할당하면 좌표 변환이 수행되지 않고 참조만 변경됩니다. |

## 행동 양식

| 이름 | 설명 |
| --- | --- |
| [AddInteriorRing](../../aspose.gis.geometries/curvepolygon/addinteriorring/)(ICurve) | 내부 링을 추가합니다. |
...
| override [Clone](../../aspose.gis.geometries/curvepolygon/clone/)() | 이 인스턴스를 복제합니다. |
...
| [Equals](../../aspose.gis.geometries/curvepolygon/equals/#equals)(ICurvePolygon) | 현재 개체가 같은 유형의 다른 개체와 같은지 여부를 나타냅니다. |
| override [Equals](../../aspose.gis.geometries/curvepolygon/equals/#equals_1)(object) | 지정된 개체가 현재 개체와 같은지 여부를 확인합니다. |
...
| override [GetHashCode](../../aspose.gis.geometries/curvepolygon/gethashcode/)() | 기본 해시 함수 역할을 합니다. |
| [GetInteriorRing](../../aspose.gis.geometries/curvepolygon/getinteriorring/)(int) | 인덱스로 내부 링을 가져옵니다. |
| [GetLength](../../aspose.gis.geometries/geometry/getlength/)() | 이 기하학의 길이를 계산합니다. |
| override [GetPointOnSurface](../../aspose.gis.geometries/curvepolygon/getpointonsurface/)() | 이 곡선 폴리곤에 있다고 보장되는 점을 찾습니다. |
...
| override [SetEmpty](../../aspose.gis.geometries/curvepolygon/setempty/)() | 이렇게 만듭니다[`Geometry`](../geometry/) 비어 있습니다. |
...
| [ToEditable](../../aspose.gis.geometries/curvepolygon/toeditable/#toeditable)() | 이 지오메트리의 편집 가능한 복사본을 가져옵니다. (3 methods) |
...
| [operator ==](../../aspose.gis.geometries/curvepolygon/op_equality/) | ==. 연산자 구현 |
| [operator !=](../../aspose.gis.geometries/curvepolygon/op_inequality/) | 연산자 구현 !=. |
