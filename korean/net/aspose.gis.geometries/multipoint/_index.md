...
description: Aspose.Gis.Geometries.MultiPoint 수업. AMultiPoint 일차원적이다GeometryCollection 그의 요소는Point s.
type: docs
weight: 1160
url: /ko/net/aspose.gis.geometries/multipoint/
---
## MultiPoint class

A`MultiPoint` 일차원적이다[`GeometryCollection`](../geometrycollection/) 그의 요소는[`Point`](../point/) s.
...
| 이름 | 설명 |
| --- | --- |
| [MultiPoint](multipoint/)() | 의 새 인스턴스를 초기화합니다.`MultiPoint` 클래스. |
...
| [Dimension](../../aspose.gis.geometries/multipoint/dimension/) { get; } | 이것의 토폴로지 차원을 가져옵니다.[`Geometry`](../geometry/) . |
| override [GeometryType](../../aspose.gis.geometries/multipoint/geometrytype/) { get; } | 지오메트리 유형을 가져옵니다. |
...
| override [Clone](../../aspose.gis.geometries/multipoint/clone/)() | 이 인스턴스를 복제합니다. |
...
| [ToEditable](../../aspose.gis.geometries/multipoint/toeditable/#toeditable_2)() | 이 지오메트리의 편집 가능한 복사본을 가져옵니다. (3 methods) |
| [ToEditable&lt;T&gt;](../../aspose.gis.geometries/geometry/toeditable/)() | 이 지오메트리의 편집 가능한 복사본을 가져옵니다. |
| [ToLinearGeometry](../../aspose.gis.geometries/geometrycollection/tolineargeometry/)() | 기본값을 사용하여 이 지오메트리의 대략적이거나 동등한 비곡선 버전을 가져옵니다.`용인` . (2 methods) |
| [ToLinearGeometry](../../aspose.gis.geometries/geometrycollection/tolineargeometry/)(double) | 지정된 값을 사용하여 이 지오메트리의 대략적이거나 동등한 비곡선 버전을 가져옵니다.`용인` . (2 methods) |
