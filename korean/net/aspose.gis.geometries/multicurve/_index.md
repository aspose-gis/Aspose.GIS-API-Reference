...
description: Aspose.Gis.Geometries.MultiCurve 수업. AMultiCurve 일차원적이다GeometryCollection 그의 요소는Curve s.
type: docs
weight: 1140
url: /ko/net/aspose.gis.geometries/multicurve/
---
## MultiCurve class

A`MultiCurve` 일차원적이다[`GeometryCollection`](../geometrycollection/) 그의 요소는[`Curve`](../curve/) s.
...
| 이름 | 설명 |
| --- | --- |
| [MultiCurve](multicurve/)() | 의 새 인스턴스를 초기화합니다.`MultiCurve` 클래스. |
...
| override [GeometryType](../../aspose.gis.geometries/multicurve/geometrytype/) { get; } | 지오메트리 유형을 가져옵니다. |
...
| override [Clone](../../aspose.gis.geometries/multicurve/clone/)() | 이 인스턴스를 복제합니다. |
...
| [ToEditable](../../aspose.gis.geometries/multicurve/toeditable/#toeditable_2)() | 이 지오메트리의 편집 가능한 복사본을 가져옵니다. (3 methods) |
| [ToEditable&lt;T&gt;](../../aspose.gis.geometries/geometry/toeditable/)() | 이 지오메트리의 편집 가능한 복사본을 가져옵니다. |
| [ToLinearGeometry](../../aspose.gis.geometries/multicurve/tolineargeometry/#tolineargeometry_4)() | 기본값을 사용하여 이 지오메트리의 대략적이거나 동등한 비곡선 버전을 가져옵니다.`용인` . (3 methods) |
| [ToLinearGeometry](../../aspose.gis.geometries/multicurve/tolineargeometry/#tolineargeometry_5)(double) | 지정된 값을 사용하여 이 지오메트리의 대략적이거나 동등한 비곡선 버전을 가져옵니다.`용인` . (3 methods) |
