...
description: Aspose.Gis.Geometries.Point 수업. APoint 좌표 공간에서 단일 위치를 나타냅니다.
type: docs
weight: 1190
url: /ko/net/aspose.gis.geometries/point/
---
## Point class

A`Point` 좌표 공간에서 단일 위치를 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [Point](point/#constructor)() | 의 새 인스턴스를 초기화합니다.`Point` 클래스. |
| [Point](point/#constructor_1)(IPoint) | 의 새 인스턴스를 초기화합니다.`Point` 클래스. |
| [Point](point/#constructor_2)(double, double) | 의 새 인스턴스를 초기화합니다.`Point` 클래스. |
| [Point](point/#constructor_3)(double, double, double) | 의 새 인스턴스를 초기화합니다.`Point` 클래스. |
| [Point](point/#constructor_4)(double, double, double, double) | 의 새 인스턴스를 초기화합니다.`Point` 클래스. |
...
| override [Dimension](../../aspose.gis.geometries/point/dimension/) { get; } | 이것의 토폴로지 차원을 가져옵니다.[`Geometry`](../geometry/) . |
| override [GeometryType](../../aspose.gis.geometries/point/geometrytype/) { get; } | 지오메트리 유형을 가져옵니다. |
| virtual [HasCurveGeometry](../../aspose.gis.geometries/geometry/hascurvegeometry/) { get; } | 이 도형이 곡선(선형 아님) 도형인지 또는 포함하는지 나타내는 값을 가져옵니다. |
| override [HasM](../../aspose.gis.geometries/point/hasm/) { get; set; } | 이 인스턴스에 M 좌표가 있는지 여부를 나타내는 값을 가져옵니다. |
| override [HasZ](../../aspose.gis.geometries/point/hasz/) { get; set; } | 이 인스턴스에 Z 좌표가 있는지 여부를 나타내는 값을 가져옵니다. |
...
| [M](../../aspose.gis.geometries/point/m/) { get; set; } | m 좌표 값을 가져오거나 설정합니다. |
| override [SpatialReferenceSystem](../../aspose.gis.geometries/point/spatialreferencesystem/) { get; set; } | 이 인스턴스의 SpatialReferenceSystem을 가져옵니다. 이 속성은 다음과 같을 수 있습니다.`null` , SpatialReferenceSystem is unknown. 새 SpatialReferenceSystem을 할당하면 좌표 변환이 수행되지 않고 참조만 변경됩니다. |
| [X](../../aspose.gis.geometries/point/x/) { get; set; } | x 좌표 값을 가져오거나 설정합니다. |
| [Y](../../aspose.gis.geometries/point/y/) { get; set; } | y 좌표 값을 가져오거나 설정합니다. |
| [Z](../../aspose.gis.geometries/point/z/) { get; set; } | z 좌표 값을 가져오거나 설정합니다. |
...
| override [Clone](../../aspose.gis.geometries/point/clone/)() | 이 인스턴스를 복제합니다. |
...
| [Equals](../../aspose.gis.geometries/point/equals/#equals)(IPoint) | 현재 개체가 같은 유형의 다른 개체와 같은지 여부를 나타냅니다. |
| override [Equals](../../aspose.gis.geometries/point/equals/#equals_1)(object) | 지정된 개체가 현재 개체와 같은지 여부를 확인합니다. |
...
| override [GetHashCode](../../aspose.gis.geometries/point/gethashcode/)() | 기본 해시 함수 역할을 합니다. |
...
| override [SetEmpty](../../aspose.gis.geometries/point/setempty/)() | 이렇게 만듭니다[`Geometry`](../geometry/) 비어 있습니다. |
...
| [ToEditable](../../aspose.gis.geometries/point/toeditable/#toeditable_1)() | 이 지오메트리의 편집 가능한 복사본을 가져옵니다. (2 methods) |
| [ToEditable&lt;T&gt;](../../aspose.gis.geometries/geometry/toeditable/)() | 이 지오메트리의 편집 가능한 복사본을 가져옵니다. |
| [ToLinearGeometry](../../aspose.gis.geometries/geometry/tolineargeometry/)() | 기본값을 사용하여 이 지오메트리의 대략적이거나 동등한 비곡선 버전을 가져옵니다.`용인` . |
| [ToLinearGeometry](../../aspose.gis.geometries/geometry/tolineargeometry/)(double) | 지정된 값을 사용하여 이 지오메트리의 대략적이거나 동등한 비곡선 버전을 가져옵니다.`용인` . |
...
| [operator ==](../../aspose.gis.geometries/point/op_equality/) | ==. 연산자 구현 |
| [operator !=](../../aspose.gis.geometries/point/op_inequality/) | 연산자 구현 !=. |
