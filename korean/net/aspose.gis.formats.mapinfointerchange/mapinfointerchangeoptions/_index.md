...
description: Aspose.Gis.Formats.MapInfoInterchange.MapInfoInterchangeOptions 수업. MapInfo 교환 형식에 대한 드라이버별 옵션입니다.
type: docs
weight: 590
url: /ko/net/aspose.gis.formats.mapinfointerchange/mapinfointerchangeoptions/
---
## MapInfoInterchangeOptions class

MapInfo 교환 형식에 대한 드라이버별 옵션입니다.
...
| 이름 | 설명 |
| --- | --- |
| [MapInfoInterchangeOptions](mapinfointerchangeoptions/)() | 새 인스턴스를 만듭니다. |
...
| [TextStringAttribute](../../aspose.gis.formats.mapinfointerchange/mapinfointerchangeoptions/textstringattribute/) { get; set; } | '텍스트' 그래픽 객체의 텍스트를 나타내는 속성의 이름을 지정합니다. |
