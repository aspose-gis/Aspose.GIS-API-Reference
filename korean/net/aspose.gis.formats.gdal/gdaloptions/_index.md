...
description: Aspose.Gis.Formats.GDAL.GdalOptions 수업. GDAL 형식에 대한 드라이버별 옵션입니다.
type: docs
weight: 290
url: /ko/net/aspose.gis.formats.gdal/gdaloptions/
---
## GdalOptions class

GDAL 형식에 대한 드라이버별 옵션입니다.
...
| 이름 | 설명 |
| --- | --- |
| [GdalOptions](gdaloptions/)(string) | 새 인스턴스를 만듭니다. |
...
| [FileName](../../aspose.gis.formats.gdal/gdaloptions/filename/) { get; set; } | start 에 대한 응용 프로그램의 이름 |
...
| [PathToTempFile](../../aspose.gis.formats.gdal/gdaloptions/pathtotempfile/) { get; } | 임시 파일 경로. |
