...
description: GdalDriver 방법. 지정된 공간 참조 시스템이 드라이버에서 지원되는지 여부를 결정합니다.
type: docs
weight: 60
url: /ko/net/aspose.gis.formats.gdal/gdaldriver/supportsspatialreferencesystem/
---
...
GDAL의 경우 유일하게 지원되는 공간 참조 시스템은 WGS84입니다.
