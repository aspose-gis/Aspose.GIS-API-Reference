...
description: Aspose.Gis.DriverOptions klas. Opties voor eenDriver .
type: docs
weight: 100
url: /nl/net/aspose.gis/driveroptions/
---
## DriverOptions class

Opties voor een[`Driver`](../driver/) .
...
| [DeleteNearPointsDistance](../../aspose.gis/driveroptions/deletenearpointsdistance/) { get; set; } | Bepaalt de afstand voor[`DeleteNearPoints`](./deletenearpoints/) . Standaard naar`0` . |
...
| [SimplifySegmentsDistance](../../aspose.gis/driveroptions/simplifysegmentsdistance/) { get; set; } | Bepaalt de afstand voor[`SimplifySegments`](./simplifysegments/) . Standaard naar`0` . |
