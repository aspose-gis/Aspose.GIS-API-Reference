...
description: Aspose.Gis.Formats.MapInfoTab.MapInfoTabOptions klas. Driverspecifieke opties voor MapInfo Tabformaat.
type: docs
weight: 610
url: /nl/net/aspose.gis.formats.mapinfotab/mapinfotaboptions/
---
## MapInfoTabOptions class

Driverspecifieke opties voor MapInfo Tab-formaat.
...
| Naam | Beschrijving |
| --- | --- |
| [MapInfoTabOptions](mapinfotaboptions/)() | Nieuwe instantie maken. |

## Eigenschappen

| Naam | Beschrijving |
| --- | --- |
| [BlockSize](../../aspose.gis.formats.mapinfotab/mapinfotaboptions/blocksize/) { get; set; } | Blokgrootte voor '*.map'-bestanden (veelvouden van 512). Standaard ingesteld op 16384. Geldige waarden: 512 tot 32256. |
...
| [TextStringAttribute](../../aspose.gis.formats.mapinfotab/mapinfotaboptions/textstringattribute/) { get; set; } | Specificeert de naam van het attribuut dat de tekst van het grafische object 'Tekst' vertegenwoordigt. |
