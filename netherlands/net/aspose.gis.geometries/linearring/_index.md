...
description: Aspose.Gis.Geometries.LinearRing klas. EENLinearRing is eenLineString dat is zowel gesloten als eenvoudig.
type: docs
weight: 1130
url: /nl/net/aspose.gis.geometries/linearring/
---
## LinearRing class

EEN`LinearRing` is een[`LineString`](../linestring/) dat is zowel gesloten als eenvoudig.
...
| Naam | Beschrijving |
| --- | --- |
| [LinearRing](linearring/#constructor)() | Initialiseert een nieuw exemplaar van het`LinearRing` klasse. |
| [LinearRing](linearring/#constructor_2)(IEnumerable&lt;IPoint&gt;) | Initialiseert een nieuw exemplaar van het`LinearRing` klasse. |
| [LinearRing](linearring/#constructor_1)(ILineString) | Initialiseert een nieuw exemplaar van het`LinearRing` klasse. |
...
| [Count](../../aspose.gis.geometries/linestring/count/) { get; } | Krijgt het aantal punten in de[`LineString`](../linestring/) . |
...
| override [GeometryType](../../aspose.gis.geometries/linearring/geometrytype/) { get; } | Haalt het type geometrie op. |
...
| Naam | Beschrijving |
| --- | --- |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint/)(IPoint) | Voegt een punt toe aan het einde van de lijn. |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint/)(double, double) | Voegt een punt toe aan het einde van de lijn. |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint/)(double, double, double) | Voegt een punt toe aan het einde van de lijn. |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint/)(double, double, double, double) | Voegt een punt toe aan het einde van de lijn. |
...
| override [Clone](../../aspose.gis.geometries/linearring/clone/)() | Kloont deze instantie. |
...
| [Equals](../../aspose.gis.geometries/linestring/equals/)(ILineString) | Geeft aan of het huidige object gelijk is aan een ander object van hetzelfde type. |
| override [Equals](../../aspose.gis.geometries/linestring/equals/)(object) | Bepaalt of het opgegeven object gelijk is aan het huidige object. |
...
| [IsClockwise](../../aspose.gis.geometries/linearring/isclockwise/)() | Bepaalt of de ring rechtsom is opgewonden. |
...
| override [Reverse](../../aspose.gis.geometries/linestring/reverse/)() | Keert hierin de volgorde van de punten om[`LineString`](../linestring/) . |
...
| [ToEditable](../../aspose.gis.geometries/linearring/toeditable/#toeditable_2)() | Krijgt een bewerkbare kopie van deze geometrie. (4 methods) |
