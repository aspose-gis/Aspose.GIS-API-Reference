...
description: Aspose.Gis.Geometries.GeometryCollection klas. EENGeometryCollection is eenGeometry dat is een verzameling van een of meer geometrieën.
type: docs
weight: 930
url: /nl/net/aspose.gis.geometries/geometrycollection/
---
## GeometryCollection class

EEN`GeometryCollection` is een[`Geometry`](../geometry/) dat is een verzameling van een of meer geometrieën.
...
| Naam | Beschrijving |
| --- | --- |
| [GeometryCollection](geometrycollection/)() | Initialiseert een nieuw exemplaar van het`GeometryCollection` klasse. |
...
| override [Dimension](../../aspose.gis.geometries/geometrycollection/dimension/) { get; } | Krijgt de topologische dimensie hiervan[`Geometry`](../geometry/) . Als verzameling leeg is,Point wordt geretourneerd. |
| override [GeometryType](../../aspose.gis.geometries/geometrycollection/geometrytype/) { get; } | Haalt het type geometrie op. |
...
| override [Clone](../../aspose.gis.geometries/geometrycollection/clone/)() | Kloont deze instantie. |
...
| [Equals](../../aspose.gis.geometries/geometrycollection/equals/#equals)(IGeometryCollection) | Geeft aan of het huidige object gelijk is aan een ander object van hetzelfde type. |
| override [Equals](../../aspose.gis.geometries/geometrycollection/equals/#equals_1)(object) | Bepaalt of het opgegeven object gelijk is aan het huidige object. |
...
| [ReplacePolygonsByLines](../../aspose.gis.geometries/geometrycollection/replacepolygonsbylines/#replacepolygonsbylines_1)() | Krijgt polygonen weergegeven als lijnen van deze geometrie. (2 methods) |
...
| [ToEditable](../../aspose.gis.geometries/geometrycollection/toeditable/#toeditable_1)() | Krijgt een bewerkbare kopie van deze geometrie. (2 methods) |
| [ToEditable&lt;T&gt;](../../aspose.gis.geometries/geometry/toeditable/)() | Krijgt een bewerkbare kopie van deze geometrie. |
| [ToLinearGeometry](../../aspose.gis.geometries/geometrycollection/tolineargeometry/#tolineargeometry_2)() | Krijgt een geschatte of gelijkwaardige niet-kromme versie van deze geometrie met de standaardwaarde`tolerantie` . (2 methods) |
| [ToLinearGeometry](../../aspose.gis.geometries/geometrycollection/tolineargeometry/#tolineargeometry_3)(double) | Krijgt geschatte of equivalente niet-kromme versie van deze geometrie met behulp van de gespecificeerde`tolerantie` . (2 methods) |
...
| [operator ==](../../aspose.gis.geometries/geometrycollection/op_equality/) | Implementeert de operator ==. |
| [operator !=](../../aspose.gis.geometries/geometrycollection/op_inequality/) | Implementeert de operator !=. |
