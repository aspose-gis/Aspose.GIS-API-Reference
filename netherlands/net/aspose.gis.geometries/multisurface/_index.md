...
description: Aspose.Gis.Geometries.MultiSurface klas. EENMultiSurface is een eendimensionaalGeometryCollection waarvan de elementen zijnISurface s.
type: docs
weight: 1180
url: /nl/net/aspose.gis.geometries/multisurface/
---
## MultiSurface class

EEN`MultiSurface` is een eendimensionaal[`GeometryCollection`](../geometrycollection/) waarvan de elementen zijn[`ISurface`](../isurface/) s.
...
| Naam | Beschrijving |
| --- | --- |
| [MultiSurface](multisurface/)() | Initialiseert een nieuw exemplaar van het`MultiSurface` klasse. |
...
| [Dimension](../../aspose.gis.geometries/multisurface/dimension/) { get; } | Krijgt de topologische dimensie hiervan[`Geometry`](../geometry/) . |
| override [GeometryType](../../aspose.gis.geometries/multisurface/geometrytype/) { get; } | Haalt het type geometrie op. |
...
| override [Clone](../../aspose.gis.geometries/multisurface/clone/)() | Kloont deze instantie. |
...
| [ToEditable](../../aspose.gis.geometries/multisurface/toeditable/#toeditable_2)() | Krijgt een bewerkbare kopie van deze geometrie. (3 methods) |
| [ToEditable&lt;T&gt;](../../aspose.gis.geometries/geometry/toeditable/)() | Krijgt een bewerkbare kopie van deze geometrie. |
| [ToLinearGeometry](../../aspose.gis.geometries/multisurface/tolineargeometry/#tolineargeometry_4)() | Krijgt een geschatte of gelijkwaardige niet-kromme versie van deze geometrie met de standaardwaarde`tolerantie` . (3 methods) |
| [ToLinearGeometry](../../aspose.gis.geometries/multisurface/tolineargeometry/#tolineargeometry_5)(double) | Krijgt geschatte of equivalente niet-kromme versie van deze geometrie met behulp van de gespecificeerde`tolerantie` . (3 methods) |
