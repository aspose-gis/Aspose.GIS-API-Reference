...
description: Aspose.Gis.Geometries.MultiPolygon klas. EENMultiPolygon is een eendimensionale GeometryCollection waarvan de elementen zijnPolygon s.
type: docs
weight: 1170
url: /nl/net/aspose.gis.geometries/multipolygon/
---
## MultiPolygon class

EEN`MultiPolygon` is een eendimensionale [`GeometryCollection`](../geometrycollection/) waarvan de elementen zijn[`Polygon`](../polygon/) s.
...
| Naam | Beschrijving |
| --- | --- |
| [MultiPolygon](multipolygon/)() | Initialiseert een nieuw exemplaar van het`MultiPolygon` klasse. |
...
| override [GeometryType](../../aspose.gis.geometries/multipolygon/geometrytype/) { get; } | Haalt het type geometrie op. |
...
| override [Clone](../../aspose.gis.geometries/multipolygon/clone/)() | Kloont deze instantie. |
...
| [ToEditable](../../aspose.gis.geometries/multipolygon/toeditable/#toeditable_2)() | Krijgt een bewerkbare kopie van deze geometrie. (4 methods) |
| [ToEditable&lt;T&gt;](../../aspose.gis.geometries/geometry/toeditable/)() | Krijgt een bewerkbare kopie van deze geometrie. |
| [ToLinearGeometry](../../aspose.gis.geometries/multisurface/tolineargeometry/)() | Krijgt een geschatte of gelijkwaardige niet-kromme versie van deze geometrie met de standaardwaarde`tolerantie` . (3 methods) |
| [ToLinearGeometry](../../aspose.gis.geometries/multisurface/tolineargeometry/)(double) | Krijgt geschatte of equivalente niet-kromme versie van deze geometrie met behulp van de gespecificeerde`tolerantie` . (3 methods) |
