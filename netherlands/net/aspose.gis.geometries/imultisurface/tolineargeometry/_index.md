...
description: IMultiSurface methode. Krijgt een geschatte of gelijkwaardige nietkromme versie van deze geometrie met de standaardwaardetolerantie .
type: docs
weight: 20
url: /nl/net/aspose.gis.geometries/imultisurface/tolineargeometry/
---
...
* naamruimte [Aspose.Gis.Geometries](../../imultisurface/)
* montage [Aspose.GIS](../../../)
...
EEN[`IMultiPolygon`](../../imultipolygon/) die dit benadert of gelijkwaardig is[`IMultiSurface`](../) :  Als dit object is[`IMultiPolygon`](../../imultipolygon/) zelf is het resultaat gelijk aan dit object Als dit object dat niet is[`IMultiPolygon`](../../imultipolygon/) - alle oppervlakken zijn gelineariseerd en nieuw`IMultiPolygon` is gemaakt
