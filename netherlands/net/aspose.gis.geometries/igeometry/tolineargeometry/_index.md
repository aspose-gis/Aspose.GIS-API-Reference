...
description: IGeometry methode. Krijgt een geschatte of gelijkwaardige nietkromme versie van deze geometrie met de standaardwaardetolerantie .
type: docs
weight: 350
url: /nl/net/aspose.gis.geometries/igeometry/tolineargeometry/
---
...
Een geometrie die geen gebogen geometrieën heeft. De volgende transformaties worden toegepast: CircularString s zijn linearized (getransformeerd inLineString s met opgegeven*tolerance* )CompoundCurve s worden samengevoegd`LijnString` SCurvePolygon s worden omgezet inPolygon SMultiCurve s worden omgezet inMultiLineString SMultiSurface s worden omgezet inMultiPolygon S Als resultaat,[`HasCurveGeometry`](../hascurvegeometry/) van uitvoergeometrie is`false` .
