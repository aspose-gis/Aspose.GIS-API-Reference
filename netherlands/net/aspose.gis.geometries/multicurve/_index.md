...
description: Aspose.Gis.Geometries.MultiCurve klas. EENMultiCurve is een eendimensionaalGeometryCollection waarvan de elementen zijnCurve s.
type: docs
weight: 1140
url: /nl/net/aspose.gis.geometries/multicurve/
---
## MultiCurve class

EEN`MultiCurve` is een eendimensionaal[`GeometryCollection`](../geometrycollection/) waarvan de elementen zijn[`Curve`](../curve/) s.
...
| Naam | Beschrijving |
| --- | --- |
| [MultiCurve](multicurve/)() | Initialiseert een nieuw exemplaar van het`MultiCurve` klasse. |
...
| override [GeometryType](../../aspose.gis.geometries/multicurve/geometrytype/) { get; } | Haalt het type geometrie op. |
...
| override [Clone](../../aspose.gis.geometries/multicurve/clone/)() | Kloont deze instantie. |
...
| [ToEditable](../../aspose.gis.geometries/multicurve/toeditable/#toeditable_2)() | Krijgt een bewerkbare kopie van deze geometrie. (3 methods) |
| [ToEditable&lt;T&gt;](../../aspose.gis.geometries/geometry/toeditable/)() | Krijgt een bewerkbare kopie van deze geometrie. |
| [ToLinearGeometry](../../aspose.gis.geometries/multicurve/tolineargeometry/#tolineargeometry_4)() | Krijgt een geschatte of gelijkwaardige niet-kromme versie van deze geometrie met de standaardwaarde`tolerantie` . (3 methods) |
| [ToLinearGeometry](../../aspose.gis.geometries/multicurve/tolineargeometry/#tolineargeometry_5)(double) | Krijgt geschatte of equivalente niet-kromme versie van deze geometrie met behulp van de gespecificeerde`tolerantie` . (3 methods) |
