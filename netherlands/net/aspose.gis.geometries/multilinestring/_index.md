...
description: Aspose.Gis.Geometries.MultiLineString klas. EENMultiLineString is een eendimensionaalGeometryCollection waarvan de elementen zijnLineString s.
type: docs
weight: 1150
url: /nl/net/aspose.gis.geometries/multilinestring/
---
## MultiLineString class

EEN`MultiLineString` is een eendimensionaal[`GeometryCollection`](../geometrycollection/) waarvan de elementen zijn[`LineString`](../linestring/) s.
...
| Naam | Beschrijving |
| --- | --- |
| [MultiLineString](multilinestring/)() | Initialiseert een nieuw exemplaar van het`MultiLineString` klasse. |
...
| [Dimension](../../aspose.gis.geometries/multicurve/dimension/) { get; } | Krijgt de topologische dimensie hiervan[`Geometry`](../geometry/) . |
| override [GeometryType](../../aspose.gis.geometries/multilinestring/geometrytype/) { get; } | Haalt het type geometrie op. |
...
| virtual [IsClosed](../../aspose.gis.geometries/multicurve/isclosed/) { get; } | Bepaalt of deze curve gesloten is. |
...
| override [Clone](../../aspose.gis.geometries/multilinestring/clone/)() | Kloont deze instantie. |
...
| [ToEditable](../../aspose.gis.geometries/multilinestring/toeditable/#toeditable_3)() | Krijgt een bewerkbare kopie van deze geometrie. (4 methods) |
| [ToEditable&lt;T&gt;](../../aspose.gis.geometries/geometry/toeditable/)() | Krijgt een bewerkbare kopie van deze geometrie. |
| [ToLinearGeometry](../../aspose.gis.geometries/multicurve/tolineargeometry/)() | Krijgt een geschatte of gelijkwaardige niet-kromme versie van deze geometrie met de standaardwaarde`tolerantie` . (3 methods) |
| [ToLinearGeometry](../../aspose.gis.geometries/multicurve/tolineargeometry/)(double) | Krijgt geschatte of equivalente niet-kromme versie van deze geometrie met behulp van de gespecificeerde`tolerantie` . (3 methods) |
