...
description: Aspose.Gis.Formats.OsmXml.OsmXmlOptions klas. Stuurprogrammaspecifieke opties voor OSM XMLindeling.
type: docs
weight: 630
url: /nl/net/aspose.gis.formats.osmxml/osmxmloptions/
---
## OsmXmlOptions class

Stuurprogrammaspecifieke opties voor OSM XML-indeling.
...
| Naam | Beschrijving |
| --- | --- |
| [OsmXmlOptions](osmxmloptions/)() | Nieuwe instantie maken. |
...
| [ReportAllNodes](../../aspose.gis.formats.osmxml/osmxmloptions/reportallnodes/) { get; set; } | Rapporteer alle knooppunten als objecten, zelfs als ze geen significante tags hebben. |
| [ReportAllWays](../../aspose.gis.formats.osmxml/osmxmloptions/reportallways/) { get; set; } | Rapporteer alle wegen als objecten, zelfs als ze geen significante tags hebben of geen knooppunten hebben. |
| [ReportCommonAttributes](../../aspose.gis.formats.osmxml/osmxmloptions/reportcommonattributes/) { get; set; } | Rapporteer algemene OSM-attributen: zichtbaar, versie, wijzigingenset, tijdstempel, gebruiker en uid. Algemene attributen worden gerapporteerd als feature-attributen met "osm_" prefix, bijv. osm_user, osm_timestamp, etc. |
...
* naamruimte [Aspose.Gis.Formats.OsmXml](../../aspose.gis.formats.osmxml/)
* montage [Aspose.GIS](../../)
