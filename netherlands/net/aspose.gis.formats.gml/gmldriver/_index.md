...
description: Aspose.Gis.Formats.Gml.GmlDriver klas. Een stuurprogramma voor het GMLformaat.
type: docs
weight: 340
url: /nl/net/aspose.gis.formats.gml/gmldriver/
---
## GmlDriver class

Een stuurprogramma voor het GML-formaat.
...
| Naam | Beschrijving |
| --- | --- |
| override [CanCreateDatasets](../../aspose.gis.formats.gml/gmldriver/cancreatedatasets/) { get; } | Krijgt een waarde die aangeeft of dit stuurprogramma gegevenssets kan maken. |
| override [CanCreateLayers](../../aspose.gis.formats.gml/gmldriver/cancreatelayers/) { get; } | Krijgt een waarde die aangeeft of dit stuurprogramma vectorlagen kan maken. |
...
| override [CanOpenLayers](../../aspose.gis.formats.gml/gmldriver/canopenlayers/) { get; } | Krijgt een waarde die aangeeft of dit stuurprogramma vectorlagen kan openen. |
...
| [CreateLayer](../../aspose.gis.formats.gml/gmldriver/createlayer/#createlayer_7)(string, GmlOptions) | Maakt een laag en opent deze om nieuwe objecten toe te voegen. |
| [CreateLayer](../../aspose.gis/filedriver/createlayer/)(string, SpatialReferenceSystem) | Maakt de laag en opent deze om toe te voegen. |
| override [CreateLayer](../../aspose.gis.formats.gml/gmldriver/createlayer/#createlayer_2)(AbstractPath, DriverOptions, SpatialReferenceSystem) | Maakt een laag en opent deze om nieuwe objecten toe te voegen. |
...
| [CreateLayer](../../aspose.gis.formats.gml/gmldriver/createlayer/#createlayer_8)(string, GmlOptions, SpatialReferenceSystem) | Maakt een laag en opent deze om nieuwe objecten toe te voegen. |
...
| override [OpenLayer](../../aspose.gis.formats.gml/gmldriver/openlayer/#openlayer_1)(AbstractPath, DriverOptions) | Opent een laag om te lezen. |
| [OpenLayer](../../aspose.gis.formats.gml/gmldriver/openlayer/#openlayer_2)(AbstractPath, GmlOptions) | Opent een laag om te lezen. |
| [OpenLayer](../../aspose.gis/filedriver/openlayer/)(string, DriverOptions) | Opent de laag om te lezen. |
| [OpenLayer](../../aspose.gis.formats.gml/gmldriver/openlayer/#openlayer_5)(string, GmlOptions) | Opent een laag om te lezen. |
| override [SupportsSpatialReferenceSystem](../../aspose.gis.formats.gml/gmldriver/supportsspatialreferencesystem/)(SpatialReferenceSystem) | Bepaalt of gespecificeerd ruimtelijk referentiesysteem wordt ondersteund door de driver. |
