...
type: docs
weight: 10
url: /nl/python-net/aspose.gis.formats.gml/gmldriver/
---
...
| [create_layer(path, options, spatial_reference_system)](#create_layer_path_options_spatial_reference_system_14) | Maakt een laag aan en opent deze om nieuwe objecten toe te voegen. |
...
| :- | :- | :- |
| pad | string | Pad naar het bestand. |
| options | [GmlOptions](/psd/python-net/aspose.gis.formats.gml/gmloptions) | Driver-specifieke opties. |
