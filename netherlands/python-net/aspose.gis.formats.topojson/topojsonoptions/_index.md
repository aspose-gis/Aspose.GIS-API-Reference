...
type: docs
weight: 20
url: /nl/python-net/aspose.gis.formats.topojson/topojsonoptions/
---
...
| **Name** | **Beschrijving** |
| :- | :- |
| [TopoJsonOptions()](#TopoJsonOptions__1) | Maak een nieuw exemplaar. |
## **Properties**
...
| default_object_name | string | r/w | Naam van het object waarin kenmerken standaard worden geplaatst. |
...
| object_name_attribute | string | r/w | Naam van het attribuut dat de naam van het object dat een kenmerk bevat weergeeft. |
| quantization_number | Nullable<int> | r/w | Specificeert het kwantisatienummer dat gebruikt wordt om coördinaten te kwantiseren en arcs delta‑gecodeerd te verwerken in de uitvoer‑TopoJSON. |
...
| transform | [TopoJsonTransform](/psd/python-net/aspose.gis.formats.topojson/topojsontransform) | r/w | Specificeert het transformatie‑object dat gebruikt wordt om coördinaten te kwantiseren en arcs delta‑gecodeerd te verwerken in de uitvoer‑TopoJSON. |
