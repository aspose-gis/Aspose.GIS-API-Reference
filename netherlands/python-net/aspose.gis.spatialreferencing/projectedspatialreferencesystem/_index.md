---
title: "ProjectedSpatialReferenceSystem Klasse"
type: docs
weight: 150
url: /nl/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/
---
...
| :- | :- | :- | :- |
| angular_unit | [Unit](/psd/python-net/aspose.gis.spatialreferencing/unit) | r | Eenheid die wordt gebruikt voor hoekwaarden in dit SRS en voor hoekparameters van [ProjectedSpatialReferenceSystem.projection](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/).<br/>            Komt overeen met de hoekeenheid van [ProjectedSpatialReferenceSystem.base](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/). |
| as_compound | [CompoundSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/compoundspatialreferencesystem) | r | Retourneert dit SRS geconverteerd naar [CompoundSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/compoundspatialreferencesystem/).<br/>            Gebruik [SpatialReferenceSystem.is_compound](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem/) om te achterhalen of conversie mogelijk is. |
...
| as_geographic | [GeographicSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/geographicspatialreferencesystem) | r | Retourneert dit SRS geconverteerd naar [GeographicSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/geographicspatialreferencesystem/).<br/> Gebruik [SpatialReferenceSystem.type](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem/) om te achterhalen of conversie mogelijk is. |
...
| as_projected | [ProjectedSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem) | r | Retourneer dit. |
...
| axises_order | [ProjectedAxisesOrder](/psd/python-net/aspose.gis.spatialreferencing/projectedaxisesorder) | r | Volgorde van assen in dit SRS.<br/> Als dit SRS niet geldig is en verkeerde asrichtingen heeft, wordt [ProjectedAxisesOrder.INVALID](/psd/python-net/aspose.gis.spatialreferencing/projectedaxisesorder/) geretourneerd. |
| base | [GeographicSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/geographicspatialreferencesystem) | r | Geografisch SRS waaraan [ProjectedSpatialReferenceSystem.projection](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/) is toegepast om dit SRS te verkrijgen. |
| dimensions_count | int | r | Retourneert het aantal dimensies in dit SRS. Voor een projected SRS kan dit zijn:<br/> twee - als dit een enkel projected SRS is.<br/> drie - als dit een samengesteld SRS is, dat bestaat uit een enkel, tweedimensionaal, projected SRS en een verticaal SRS, dat een derde dimensie toevoegt. |
...
| geographic_datum | [GeographicDatum](/psd/python-net/aspose.gis.spatialreferencing/geographicdatum) | r | Retourneert de geografische datum van dit SRS. |
| has_geographic_datum | bool | r | Retourneert true, aangezien een projected SRS altijd een nulmeridiaan heeft. |
| has_prime_meridian | bool | r | Retourneert true, aangezien een projected SRS altijd een nulmeridiaan heeft. |
...
| is_compound | bool | r | Retourneert of dit SRS samengesteld is (een vereniging van twee SRS).<br/> De volgende combinaties van SRS in een samengesteld SRS worden als geldig beschouwd:<br/> Geographic SRS + Vertical SRS, in dit geval zal het type van het samengestelde SRS [SpatialReferenceSystemType.GEOGRAPHIC](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/) zijn.<br/> Projected SRS + Vertical SRS, in dit geval zal het type van het samengestelde SRS [SpatialReferenceSystemType.PROJECTED](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/) zijn.<br/> Als de combinatie van SRS's verschilt, zal het type van het samengestelde SRS [SpatialReferenceSystemType.UNKNOWN](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/) zijn. |
...
| linear_unit | [Unit](/psd/python-net/aspose.gis.spatialreferencing/unit) | r | Eenheid die wordt gebruikt voor lineaire dimensies in dit SRS en voor lineaire parameters van [ProjectedSpatialReferenceSystem.projection](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/). |
...
| prime_meridian | [PrimeMeridian](/psd/python-net/aspose.gis.spatialreferencing/primemeridian) | r | Retourneert de nulmeridiaan van dit SRS. |
| projection | [Projection](/psd/python-net/aspose.gis.spatialreferencing/projection) | r | Projectie die werd toegepast op [ProjectedSpatialReferenceSystem.base](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/) om dit SRS te verkrijgen. |
| type | [SpatialReferenceSystemType](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype) | r | Retourneert [SpatialReferenceSystemType.PROJECTED](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/). |
...
| [validate(error_message)](#validate_error_message_18) | Bepaal of deze SRS geldig is. |
...
| Parameter | Type | Beschrijving |
| :- | :- | :- |
| error_message | String | Als de methode <see langword="false" /> retourneert, is dit de beschrijving van de ongeldigheid. |

**Returns**

| Type | Beschrijving |
| :- | :- |
| bool | <see langword="true" /> als de SRS geldig is, <see langword="false" /> anders. |
