...
type: docs
weight: 80
url: /nl/python-net/aspose.gis.spatialreferencing/geographicspatialreferencesystem/
---
...
| :- | :- | :- | :- |
| angular_unit | [Unit](/psd/python-net/aspose.gis.spatialreferencing/unit) | r | Eenheid, gebruikt voor hoeksdimensies, in dit SRS. |
...
| as_geographic | [GeographicSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/geographicspatialreferencesystem) | r | Retourneert dit. |
...
| axises_order | [GeographicAxisesOrder](/psd/python-net/aspose.gis.spatialreferencing/geographicaxisesorder) | r | Volgorde van assen in dit SRS.<br/>            Als dit SRS niet geldig is en verkeerde asrichtingen heeft, wordt [GeographicAxisesOrder.INVALID](/psd/python-net/aspose.gis.spatialreferencing/geographicaxisesorder/) geretourneerd. |
| dimensions_count | int | r | Retourneert het aantal dimensies in dit SRS. Voor geografisch SRS kan dit zijn:<br/>            twee - als dit een enkel geografisch SRS is.<br/>            drie - als dit een samengesteld SRS is, dat bestaat uit een enkel, tweedimensionaal, geografisch SRS en een verticaal SRS, dat een derde dimensie toevoegt. |
...
| has_geographic_datum | bool | r | Retourneert <see langword="true" />, aangezien geografisch SRS altijd een nulmeridiaan heeft. |
| has_prime_meridian | bool | r | Retourneert <see langword="true" />, aangezien geografisch SRS altijd een nulmeridiaan heeft. |
...
| type | [SpatialReferenceSystemType](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype) | r | Retourneert [SpatialReferenceSystemType.GEOGRAPHIC](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/). |
