...
type: docs
weight: 130
url: /nl/python-net/aspose.gis.spatialreferencing/localspatialreferencesystem/
---
...
| as_local | [LocalSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/localspatialreferencesystem) | r | Retourneer dit. |
...
| dimensions_count | int | r | Aantal dimensies in dit SRS. |
...
| geographic_datum | [GeographicDatum](/psd/python-net/aspose.gis.spatialreferencing/geographicdatum) | r | Gooit InvalidOperationException, aangezien Local SRS geen geografisch datum heeft. |
| has_geographic_datum | bool | r | Retourneert <see langword="false" />, aangezien Local SRS geen geografisch datum heeft. |
| has_prime_meridian | bool | r | Retourneert <see langword="false" />, aangezien Local SRS geen nulmeridiaan heeft. |
...
| local_datum | [LocalDatum](/psd/python-net/aspose.gis.spatialreferencing/localdatum) | r | Datum, dat de meetmethode beschrijft. |
...
| prime_meridian | [PrimeMeridian](/psd/python-net/aspose.gis.spatialreferencing/primemeridian) | r | Gooit InvalidOperationException, aangezien Local SRS geen nulmeridiaan heeft. |
| type | [SpatialReferenceSystemType](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype) | r | Retour [SpatialReferenceSystemType.LOCAL](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/). |
| unit | [Unit](/psd/python-net/aspose.gis.spatialreferencing/unit) | r | Eenheid van dit SRS. |
...
| [get_unit(dimension)](#get_unit_dimension_12) | Haal [LocalSpatialReferenceSystem.unit](/psd/python-net/aspose.gis.spatialreferencing/localspatialreferencesystem/) van dimensie. |
...
Haal [LocalSpatialReferenceSystem.unit](/psd/python-net/aspose.gis.spatialreferencing/localspatialreferencesystem/) van dimensie.
