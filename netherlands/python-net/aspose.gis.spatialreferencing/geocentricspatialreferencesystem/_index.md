---
title: "GeocentricSpatialReferenceSystem klasse"
type: docs
weight: 50
url: /nl/python-net/aspose.gis.spatialreferencing/geocentricspatialreferencesystem/
---
...
| as_geocentric | [GeocentricSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/geocentricspatialreferencesystem) | r | Retourneer dit. |
...
| axises_order | [GeocentricAxisesOrder](/psd/python-net/aspose.gis.spatialreferencing/geocentricaxisesorder) | r | Volgorde van assen in deze SRS.<br/>            Als deze SRS niet geldig is en verkeerde asrichtingen heeft, wordt [GeocentricAxisesOrder.INVALID](/psd/python-net/aspose.gis.spatialreferencing/geocentricaxisesorder/) geretourneerd. |
| dimensions_count | int | r | Retourneer 3, aangezien een geocentrische SRS altijd drie-dimensionaal is. |
...
| geographic_datum | [GeographicDatum](/psd/python-net/aspose.gis.spatialreferencing/geographicdatum) | r | Retourneer het geografische datum van deze SRS. |
| has_geographic_datum | bool | r | Retourneer <see langword="true" />, aangezien een geocentrische SRS altijd een geografisch datum heeft. |
| has_prime_meridian | bool | r | Retourneer <see langword="true" />, aangezien een geocentrische SRS altijd een nulmeridiaan heeft. |
...
| linear_unit | [Unit](/psd/python-net/aspose.gis.spatialreferencing/unit) | r | Eenheid, gebruikt in deze SRS. |
...
| prime_meridian | [PrimeMeridian](/psd/python-net/aspose.gis.spatialreferencing/primemeridian) | r | Retourneer de nulmeridiaan van deze SRS. |
| type | [SpatialReferenceSystemType](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype) | r | Retourneer [SpatialReferenceSystemType.GEOCENTRIC](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/). |
