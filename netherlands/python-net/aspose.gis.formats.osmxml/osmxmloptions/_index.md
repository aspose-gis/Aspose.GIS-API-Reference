...
type: docs
weight: 20
url: /nl/python-net/aspose.gis.formats.osmxml/osmxmloptions/
---
...
| **Name** | **Beschrijving** |
| :- | :- |
| [OsmXmlOptions()](#OsmXmlOptions__1) | Maak een nieuw exemplaar. |
## **Properties**
...
| report_all_nodes | bool | r/w | Rapporteer alle knooppunten als features, zelfs als ze geen significante tags hebben. |
| report_all_ways | bool | r/w | Rapporteer alle wegen als features, zelfs als ze geen significante tags hebben of geen knooppunten hebben. |
| report_common_attributes | bool | r/w | Rapporteer gemeenschappelijke OSM-attributen: visible, version, changeset, timestamp, user en uid.<br/>            Gemeenschappelijke attributen worden gerapporteerd als feature-attributen met het prefix "osm_", bijv. osm_user, osm_timestamp, enz. |
...
| write_common_attributes | bool | r/w | Schrijf gemeenschappelijke OSM-attributen: visible, version, changeset, timestamp, user en uid. |
