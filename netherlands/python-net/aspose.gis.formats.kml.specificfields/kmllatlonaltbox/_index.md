...
type: docs
weight: 30
url: /nl/python-net/aspose.gis.formats.kml.specificfields/kmllatlonaltbox/
---
...
| oost | double | r/w | Oost van 'LatLonBox' node. |
| max_altitude | Nullable<double> | r/w | MaxAltitude van 'LatLonBox' node. |
| min_altitude | Nullable<double> | r/w | MinAltitude van 'LatLonBox' node. |
...
| noord | double | r/w | Noord van 'LatLonBox' node. |
| prefix | string | r | Haalt de prefix op. |
| rotatie | Nullable<double> | r/w | Rotatie van 'LatLonBox' node. |
| zuid | double | r/w | Zuid van 'LatLonBox' node. |
| west | double | r/w | West van 'LatLonBox' node. |
## **Methods**
| **Name** | **Beschrijving** |
| :- | :- |
