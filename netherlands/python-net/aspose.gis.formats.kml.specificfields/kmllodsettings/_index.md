...
type: docs
weight: 50
url: /nl/python-net/aspose.gis.formats.kml.specificfields/kmllodsettings/
---
...
| max_fade_extent | int | r/w | MaxFadeExtent van 'Lod' node. |
| max_lod_pixels | int | r/w | MaxLodPixels van 'Lod' node. |
| min_fade_extent | int | r/w | MinFadeExtent van 'Lod' node. |
| min_lod_pixels | int | r/w | MinLodPixels van 'Lod' knooppunt. |
