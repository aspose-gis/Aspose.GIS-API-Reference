---
title: "KmlGroundOverlayInfo Klasse"
type: docs
weight: 20
url: /nl/python-net/aspose.gis.formats.kml.specificfields/kmlgroundoverlayinfo/
---
...
| draw_order | double | r/w | DrawOrder van 'GroundOverlay' knooppunt. |
| icon | [IconInfo](/psd/python-net/aspose.gis.formats.kml.specificfields/iconinfo) | r/w | IconPath van 'GroundOverlay' knooppunt. |
| lat_lon_box | [KmlLatLonBox](/psd/python-net/aspose.gis.formats.kml.specificfields/kmllatlonbox) | r/w | Specificeert object van Kml 'LatLonAltBox' knooppunt. |
| naam | string | r/w | Naam van Ground Overlay |
...
| visibility | bool | r/w | Zichtbaarheid van Ground Overlay |
## **Methods**
| **Name** | **Beschrijving** |
| :- | :- |
