---
title: "GeoPackageDriver Klasse"
type: docs
weight: 20
url: /nl/python-net/aspose.gis.formats.geopackage/geopackagedriver/
---
...
| **Name** | **Beschrijving** |
| :- | :- |
| [GeoPackageDriver()](#GeoPackageDriver__1) | Initialiseert een nieuw exemplaar van de GeoPackageDriver klasse |
## **Properties**
...
| [create_layer(path, options, spatial_reference_system)](#create_layer_path_options_spatial_reference_system_9) | Maakt de laag aan en opent deze voor toevoegen. |
| [create_layer(path, options, spatial_reference_system)](#create_layer_path_options_spatial_reference_system_10) | Maakt de laag aan en opent deze voor toevoegen. |
...
| [open_dataset(path, options)](#open_dataset_path_options_19) | Opent de dataset. |
| [open_layer(path)](#open_layer_path_20) | Opent de laag voor lezen. |
| [open_layer(path)](#open_layer_path_21) | Opent de laag voor lezen. |
| [open_layer(path, options)](#open_layer_path_options_22) | Opent de laag voor lezen. |
| [open_layer(path, options)](#open_layer_path_options_23) | Opent de laag voor lezen. |
...
Initialiseert een nieuw exemplaar van de GeoPackageDriver klasse
...
| :- | :- | :- |
| path | [AbstractPath](/psd/python-net/aspose.gis/abstractpath) | Pad naar de dataset. |
| options | [GeoPackageOptions](/psd/python-net/aspose.gis.formats.geopackage/geopackageoptions) | Driver-specifieke opties. |

**Returns**

| Type | Beschrijving |
| :- | :- |
| [GeoPackageDataset](/psd/python-net/aspose.gis.formats.geopackage/geopackagedataset) | Een exemplaar van [Dataset](/psd/python-net/aspose.gis/dataset/). |
...
| Type | Beschrijving |
| :- | :- |
| bool | Booleaanse waarde, die aangeeft of het opgegeven ruimtelijk referentiesysteem wordt ondersteund door de driver.<br/>            <see langword="null" /> wordt beschouwd als ondersteund door elke driver. |
