...
type: docs
weight: 70
url: /nl/python-net/aspose.gis.common.formats.mapinfo.tabformat.map/maptransform/
---
...
| **Name** | **Beschrijving** |
| :- | :- |
| [MapTransform(x_displacement, y_displacement, x_scale, y_scale, coordinates_origin_quadrant)](#MapTransform_x_displacement_y_displacement_x_scale_y_scale_coordinates_origin_quadrant_1) | Initialiseert een nieuw exemplaar van de MapTransform-klasse |
## **Properties**
| **Name** | **Type** | **Access** | **Beschrijving** |
| :- | :- | :- | :- |
| coordinates_origin_quadrant | [Quadrant](/psd/python-net/aspose.gis.common/quadrant) | r |    |
| coördinaten_oorsprong_kwadrant_byte | byte | r |  |
| x_verplaatsing | double | r |  |
| x_scale | double | r |  |
| y_verplaatsing | double | r |  |
| y_scale | double | r |  |
## **Methods**
| **Name** | **Beschrijving** |
| :- | :- |
...
Initialiseert een nieuw exemplaar van de MapTransform-klasse

**Parameters:**

| Parameter | Type | Beschrijving |
| :- | :- | :- |
| x_verplaatsing | double |  |
| y_verplaatsing | double |  |
| x_scale | double |  |
| y_scale | double |  |
