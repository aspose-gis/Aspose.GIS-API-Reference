---
title: "IGeometryCollection Klasse"
type: docs
weight: 120
url: /nl/python-net/aspose.gis.geometries/igeometrycollection/
---
...
| [get_point_on_surface()](#get_point_on_surface__22) | Vindt een punt dat gegarandeerd op een van de oppervlakken in deze collectie ligt. |
| [intersection(other)](#intersection_other_23) | Bouwt een intersectie tussen deze geometrie en een opgegeven geometrie. |
| [intersects(extent)](#intersects_extent_24) | Bepaalt of deze geometrie een opgegeven extent intersecteert. |
| [intersects(other)](#intersects_other_25) | Bepaalt of deze geometrie en een opgegeven geometrie elkaar intersecteren. |
| [overlaps(other)](#overlaps_other_26) | Bepaalt of deze geometrie overlapt met een opgegeven geometrie. |
| [relate(other, intersection_pattern_matrix)](#relate_other_intersection_pattern_matrix_27) | Bepaalt of de DE-9IM-intersectiematrix van deze geometrie en een opgegeven geometrie overeenkomt met het opgegeven patroon. |
| [replace_polygons_by_lines()](#replace_polygons_by_lines__28) | Haalt polygonen op die als lijnen van deze geometrie worden weergegeven. |
| [spatially_contains(other)](#spatially_contains_other_29) | Bepaalt of deze geometrie ruimtelijk een opgegeven geometrie bevat. |
| [spatially_equals(other)](#spatially_equals_other_30) | Bepaalt of deze geometrie ruimtelijk gelijk is aan een opgegeven geometrie. |
| [sym_difference(other)](#sym_difference_other_31) | Bouwt een symmetrisch verschil tussen deze geometrie en een gespecificeerde geometrie. |
| [to_editable()](#to_editable__32) | Haalt een bewerkbare kopie van deze geometrie op. |
| [to_linear_geometry()](#to_linear_geometry__33) | Haalt een benaderende of equivalente niet-curve versie van deze geometrie op met de standaard <c>tolerance</c>. |
| [to_linear_geometry(tolerance)](#to_linear_geometry_tolerance_34) | Haalt een benaderende of equivalente niet-curve versie van deze geometrie op met de opgegeven <c>tolerance</c>. |
| [touches(other)](#touches_other_35) | Bepaalt of deze geometrie en een gespecificeerde geometrie elkaar raken. |
| [union(other)](#union_other_36) | Voegt deze geometrie en een gespecificeerde geometrie samen. |
| [union(other)](#union_other_37) | Voegt deze geometrie en een gespecificeerde geometrie samen. |
| [within(extent)](#within_extent_38) | Bepaalt of deze geometrie zich binnen een gespecificeerde omvang bevindt. |
| [within(other)](#within_other_39) | Bepaalt of deze geometrie zich binnen een gespecificeerde geometrie bevindt. |
