---
title: "MultiLineString Klasse"
type: docs
weight: 260
url: /nl/python-net/aspose.gis.geometries/multilinestring/
---
...
| **Name** | **Beschrijving** |
| :- | :- |
| [MultiLineString()](#MultiLineString__1) | Initialiseert een nieuwe instantie van de [MultiLineString](/psd/python-net/aspose.gis.geometries/multilinestring/) klasse. |
## **Properties**
...
| is_closed | bool | r | Bepaalt of deze curve gesloten is. |
...
| spatial_reference_system | [SpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem/) | r/w | Haalt SpatialReferenceSystem van deze instantie op.<br/>            Deze eigenschap kan <see langword="null" /> zijn, als SpatialReferenceSystem onbekend is. |
## **Methods**
| **Name** | **Beschrijving** |
| :- | :- |
...
Initialiseert een nieuwe instantie van de [MultiLineString](/psd/python-net/aspose.gis.geometries/multilinestring/) klasse.
...
| Type | Beschrijving |
| :- | :- |
| [MultiLineString](/psd/python-net/aspose.gis.geometries/multilinestring) | Een bewerkbare kopie van deze geometrie. |
...
| Type | Beschrijving |
| :- | :- |
| [IMultiLineString](/psd/python-net/aspose.gis.geometries/imultilinestring) | Een [IMultiLineString](/psd/python-net/aspose.gis.geometries/imultilinestring/) die benadert of gelijkwaardig is aan deze [IMultiCurve](/psd/python-net/aspose.gis.geometries/imulticurve/).<br/>            Dit is het equivalent van <DOM Element: class at 0x2a179241f70>.IMultiCurve.to_linear_geometry()(float) met<br/>            standaard <c>tolerance</c>. De standaardwaarde van <c>tolerance</c> is afhankelijk van [SpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem/)<br/>            van deze geometrie:<br/>            <ul><br/>            <li> Voor een geprojecteerd SRS is de tolerantie 0,001 meter (in SRS-eenheden) </li><br/>            <li> Voor een geografisch SRS is de tolerantie <c>1e-5</c> graden (in SRS-eenheden) </li><br/>            <li> Voor een onbekend SRS is de tolerantie <c>1e-5</c> </li><br/>            </ul><br/>            Voor meer details over welke transformaties worden toegepast, raadpleeg de specificatie van <DOM Element: class at 0x2a179241f70>.IMultiCurve.to_linear_geometry()(float). |
...
| Type | Beschrijving |
| :- | :- |
| [IMultiLineString](/psd/python-net/aspose.gis.geometries/imultilinestring) | Een [IMultiLineString](/psd/python-net/aspose.gis.geometries/imultilinestring/) die benadert of gelijkwaardig is aan deze [IMultiCurve](/psd/python-net/aspose.gis.geometries/imulticurve/):<br/>             <ul><br/>             Als dit object zelf een [IMultiLineString](/psd/python-net/aspose.gis.geometries/imultilinestring/) is, is het resultaat gelijk aan dit object<br/>             Als dit object geen [IMultiLineString](/psd/python-net/aspose.gis.geometries/imultilinestring/) is, worden alle curven lineair gemaakt en wordt een nieuwe <c>IMultiLineString</c> aangemaakt<br/>            </ul> |
