...
type: docs
weight: 110
url: /nl/python-net/aspose.gis.geometries/igeometry/
---
...
| [to_linear_geometry()](#to_linear_geometry__31) | Haalt een benaderende of equivalente niet-curve versie van deze geometrie op met de standaard <c>tolerance</c>. |
| [to_linear_geometry(tolerance)](#to_linear_geometry_tolerance_32) | Haalt een benaderende of equivalente niet-curve versie van deze geometrie op met de opgegeven <c>tolerance</c>. |
| [touches(other)](#touches_other_33) | Bepaalt of deze geometrie en een gespecificeerde geometrie elkaar raken. |
| [union(other)](#union_other_34) | Voegt deze geometrie en een gespecificeerde geometrie samen. |
| [union(other)](#union_other_35) | Voegt deze geometrie en een gespecificeerde geometrie samen. |
| [within(extent)](#within_extent_36) | Bepaalt of deze geometrie zich binnen een gespecificeerde omvang bevindt. |
| [within(other)](#within_other_37) | Bepaalt of deze geometrie zich binnen een gespecificeerde geometrie bevindt. |
