...
type: docs
weight: 60
url: /nl/python-net/aspose.gis.geometries/geometrycollection/
---
...
| **Name** | **Beschrijving** |
| :- | :- |
| [GeometryCollection()](#GeometryCollection__1) | Initialiseert een nieuw exemplaar van de [GeometryCollection](/psd/python-net/aspose.gis.geometries/geometrycollection/) klasse. |
## **Properties**
...
| aantal | int | r | Haalt het aantal geometrieën in deze collectie op. |
| dimension | [GeometryDimension](/psd/python-net/aspose.gis.geometries/geometrydimension) | r | Haalt de topologische dimensie op van deze [Geometry](/psd/python-net/aspose.gis.geometries/geometry/).<br/>            Als de collectie leeg is, wordt [GeometryDimension.POINT](/psd/python-net/aspose.gis.geometries/geometrydimension/) geretourneerd. |
...
| **Name** | **Beschrijving** |
| :- | :- |
| [add(geometry)](#add_geometry_1) | Voegt de opgegeven geometrie toe aan de collectie. |
| [add_range(geometries)](#add_range_geometries_2) | Voegt de opgegeven geometrieën toe aan de collectie. |
| [as_binary()](#as_binary__3) | Vertaal deze geometrie naar zijn Well-Known Binary-representatie. |
| [as_binary(variant)](#as_binary_variant_4) | Vertaal deze geometrie naar zijn Well-Known Binary-representatie. |
| [as_image(output_path, width, height, renderer, symbolizer)](#as_image_output_path_width_height_renderer_symbolizer_5) | Exporteer deze geometrie naar een afbeeldingsrepresentatie. |
| [as_image(output_path, width, height, renderer, symbolizer)](#as_image_output_path_width_height_renderer_symbolizer_6) | Exporteer deze geometrie naar een afbeeldingsrepresentatie. |
| [as_image(width, height, renderer, symbolizer)](#as_image_width_height_renderer_symbolizer_7) | Exporteer deze geometrie naar een afbeeldingsrepresentatie. |
| [as_text()](#as_text__8) | Vertaal deze geometrie naar zijn Well-Known Text-representatie. |
| [as_text(variant)](#as_text_variant_9) | Vertaal deze geometrie naar zijn Well-Known Text-representatie. |
| [as_text(variant, format)](#as_text_variant_format_10) | Vertaal deze geometrie naar zijn Well-Known Text-representatie. |
| [clone()](#clone__11) | Kloont deze instantie. |
| [covered_by(other)](#covered_by_other_12) | Bepaalt of deze geometrie wordt gedekt door een opgegeven geometrie. |
| [covers(other)](#covers_other_13) | Bepaalt of deze geometrie een opgegeven geometrie dekt. |
| [crosses(other)](#crosses_other_14) | Bepaalt of deze geometrie en een opgegeven geometrie elkaar kruisen. |
| [difference(other)](#difference_other_15) | Trek een opgegeven geometrie af van deze geometrie. |
| [disjoint(other)](#disjoint_other_16) | Bepaalt of deze geometrie losstaat van een opgegeven geometrie. |
| [from_binary(wkb)](#from_binary_wkb_17) | Maakt een geometrie aan vanuit de Well-Known Binary-representatie. |
| [from_binary(wkb, spatial_reference_system)](#from_binary_wkb_spatial_reference_system_18) | Maakt een geometrie aan vanuit de Well-Known Binary-representatie. |
| [from_text(wkt)](#from_text_wkt_19) | Maakt een geometrie aan vanuit de Well-Known Text-representatie. |
| [from_text(wkt, spatial_reference_system)](#from_text_wkt_spatial_reference_system_20) | Maakt een geometrie aan vanuit de Well-Known Text-representatie. |
| [get_area()](#get_area__21) | Berekent de oppervlakte van deze geometrie. |
| [get_buffer(distance, quadrant_segments)](#get_buffer_distance_quadrant_segments_22) | Berekent een buffergebied rond deze geometrie. |
| [get_centroid()](#get_centroid__23) | Berekent het zwaartepunt van deze geometrie. |
| [get_convex_hull()](#get_convex_hull__24) | Berekent de convexe omhulling van deze geometrie. |
| [get_distance_to(other)](#get_distance_to_other_25) | Berekent de minimale afstand tussen deze geometrie en een opgegeven geometrie. |
| [get_extent()](#get_extent__26) | Berekent en retourneert een begrenzende extent van deze geometrie. |
| [get_length()](#get_length__27) | Berekent de lengte van deze geometrie. |
| [get_point_on_surface()](#get_point_on_surface__28) | Vindt een punt dat gegarandeerd op een van de oppervlakken in deze collectie ligt. |
| [intersection(other)](#intersection_other_29) | Bouwt een intersectie tussen deze geometrie en een opgegeven geometrie. |
| [intersects(extent)](#intersects_extent_30) | Bepaalt of deze geometrie een opgegeven extent intersecteert. |
| [intersects(other)](#intersects_other_31) | Bepaalt of deze geometrie en een opgegeven geometrie elkaar intersecteren. |
| [overlaps(other)](#overlaps_other_32) | Bepaalt of deze geometrie overlapt met een opgegeven geometrie. |
| [relate(other, intersection_pattern_matrix)](#relate_other_intersection_pattern_matrix_33) | Bepaalt of de DE-9IM-intersectiematrix van deze geometrie en een opgegeven geometrie overeenkomt met het opgegeven patroon. |
| [remove_at(index)](#remove_at_index_34) | Verwijdert de opgegeven geometrie uit de collectie. |
...
Initialiseert een nieuw exemplaar van de [GeometryCollection](/psd/python-net/aspose.gis.geometries/geometrycollection/) klasse.
...
| :- | :- | :- |
| geometry | [IGeometry](/psd/python-net/aspose.gis.geometries/igeometry) | De toe te voegen geometrie. |
...
Voegt de opgegeven geometrieën toe aan de collectie.

**Parameters:**

| Parameter | Type | Beschrijving |
| :- | :- | :- |
| geometrieën | System.Collections.Generic.IEnumerable<IGeometry> | De toe te voegen geometrieën. |
...
Vindt een punt dat gegarandeerd op een van de oppervlakken in deze collectie ligt.

**Returns**

| Type | Beschrijving |
| :- | :- |
| [IPoint](/psd/python-net/aspose.gis.geometries/ipoint) | Een punt op een van de oppervlakken. Een leeg punt als deze collectie geen oppervlakken bevat of alle oppervlakken leeg zijn. |
...
Verwijdert de opgegeven geometrie uit de collectie.

**Parameters:**

| Parameter | Type | Beschrijving |
| :- | :- | :- |
| index | int | Index van de te verwijderen geometrie. |
...
| Type | Beschrijving |
| :- | :- |
| [GeometryCollection](/psd/python-net/aspose.gis.geometries/geometrycollection) | Een bewerkbare kopie van deze geometrie. |
...
| Type | Beschrijving |
| :- | :- |
| [IGeometryCollection](/psd/python-net/aspose.gis.geometries/igeometrycollection) | Een geometrie die geen curve-geometrieën bevat. Dit is het equivalent van <DOM Element: class at 0x2a1791cc040>.IGeometryCollection.to_linear_geometry()(float) met<br/>            standaard <c>tolerance</c>. De standaardwaarde van <c>tolerance</c> is afhankelijk van [SpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem/) van deze geometrie:<br/>            <ul><br/>            <li> Voor een geprojecteerd SRS is de tolerantie 0,001 meter (in SRS-eenheden) </li><br/>            <li> Voor een geografisch SRS is de tolerantie <c>1e-5</c> graden (in SRS-eenheden) </li><br/>            <li> Voor een onbekend SRS is de tolerantie <c>1e-5</c> </li><br/>            </ul><br/>            Voor meer details over welke transformaties worden toegepast, raadpleeg de specificatie van <DOM Element: class at 0x2a1791cc040>.IGeometryCollection.to_linear_geometry()(float). |
...
| Parameter | Type | Beschrijving |
| :- | :- | :- |
| tolerantie | double | De <c>tolerance</c> die gebruikt moet worden. Het resultaat is gegarandeerd minder dan <c>tolerance</c> verwijderd van de<br/>            gebogen geometrie. |

**Returns**

| Type | Beschrijving |
| :- | :- |
| [IGeometryCollection](/psd/python-net/aspose.gis.geometries/igeometrycollection) | Een geometrie die geen curve-geometrieën bevat. De volgende transformaties worden toegepast:<br/>            <ul><br/>            <li> [GeometryType.CIRCULAR_STRING](/psd/python-net/aspose.gis.geometries/geometrytype/)s worden gelinieariseerd<br/> (omgezet naar [GeometryType.LINE_STRING](/psd/python-net/aspose.gis.geometries/geometrytype/)s met de opgegeven <paramref name="tolerance" />) </li><br/>            <li> [GeometryType.COMPOUND_CURVE](/psd/python-net/aspose.gis.geometries/geometrytype/)s worden samengevoegd tot <c>LineString</c>s </li><br/>            <li> [GeometryType.CURVE_POLYGON](/psd/python-net/aspose.gis.geometries/geometrytype/)s worden omgezet naar [GeometryType.POLYGON](/psd/python-net/aspose.gis.geometries/geometrytype/)s </li><br/>            <li> [GeometryType.MULTI_CURVE](/psd/python-net/aspose.gis.geometries/geometrytype/)s worden omgezet naar [GeometryType.MULTI_CURVE](/psd/python-net/aspose.gis.geometries/geometrytype/)s </li><br/>            <li> [GeometryType.MULTI_SURFACE](/psd/python-net/aspose.gis.geometries/geometrytype/)s worden omgezet naar [GeometryType.MULTI_POLYGON](/psd/python-net/aspose.gis.geometries/geometrytype/)s </li><br/>            </ul><br/>            Als gevolg hiervan is [IGeometry.has_curve_geometry](/psd/python-net/aspose.gis.geometries/igeometry/) van de uitvoer geometrie <see langword="false" />. |
