...
type: docs
weight: 20
url: /nl/python-net/aspose.gis.geometries/compoundcurve/
---
...
| **Name** | **Beschrijving** |
| :- | :- |
| [CompoundCurve()](#CompoundCurve__1) | Initialiseert een nieuw exemplaar van de [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/) klasse. |
| [CompoundCurve(curves)](#CompoundCurve_curves_2) | Initialiseert een nieuw exemplaar van de [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/) klasse. |
| [CompoundCurve(other)](#CompoundCurve_other_3) | Initialiseert een nieuw exemplaar van de [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/) klasse. |
## **Properties**
...
| count | int | r | Haalt het aantal curven op in de [ICompoundCurve](/psd/python-net/aspose.gis.geometries/icompoundcurve/). |
...
| **Name** | **Beschrijving** |
| :- | :- |
| [add_curve(curve)](#add_curve_curve_1) | Voegt een curve toe aan het einde van deze [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/). |
...
| [get_length()](#get_length__26) | Berekent de lengte van deze geometrie. |
...
| reverse() | Keert deze [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/) om. Dat betekent - de volgorde van curven en elke curve binnen deze samengestelde curve omkeren. |
...
Initialiseert een nieuw exemplaar van de [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/) klasse.
...
| :- | :- | :- |
| curven | System.Collections.Generic.IEnumerable<ICurve> | De verzameling curven. |
...
| Parameter | Type | Beschrijving |
| :- | :- | :- |
| other | [ICompoundCurve](/psd/python-net/aspose.gis.geometries/icompoundcurve) | De andere lijn waaruit gegevens gekopieerd moeten worden. |
...
Voegt een curve toe aan het einde van deze [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/).

**Parameters:**

| Parameter | Type | Beschrijving |
| :- | :- | :- |
| curve | [ICurve](/psd/python-net/aspose.gis.geometries/icurve) | Curve om toe te voegen. |
...
| Type | Beschrijving |
| :- | :- |
| [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve) | Een bewerkbare kopie van deze geometrie. |
