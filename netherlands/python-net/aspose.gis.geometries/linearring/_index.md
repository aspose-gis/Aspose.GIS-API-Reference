...
type: docs
weight: 240
url: /nl/python-net/aspose.gis.geometries/linearring/
---
...
| **Name** | **Beschrijving** |
| :- | :- |
| [LinearRing()](#LinearRing__1) | Initialiseert een nieuw exemplaar van de [LinearRing](/psd/python-net/aspose.gis.geometries/linearring/) klasse. |
| [LinearRing(collection)](#LinearRing_collection_2) | Initialiseert een nieuw exemplaar van de [LinearRing](/psd/python-net/aspose.gis.geometries/linearring/) klasse. |
| [LinearRing(other)](#LinearRing_other_3) | Initialiseert een nieuw exemplaar van de [LinearRing](/psd/python-net/aspose.gis.geometries/linearring/) klasse. |
## **Properties**
...
| **Name** | **Beschrijving** |
| :- | :- |
| [add_point(point)](#add_point_point_1) | Voegt een punt toe aan het einde van de lijn. |
| [add_point(x, y)](#add_point_x_y_2) | Voegt een punt toe aan het einde van de lijn. |
| [add_point(x, y, z)](#add_point_x_y_z_3) | Voegt een punt toe aan het einde van de lijn. |
| [add_point(x, y, z, m)](#add_point_x_y_z_m_4) | Voegt een punt toe aan het einde van de lijn. |
...
| [is_clockwise()](#is_clockwise__33) | Bepaalt of de ring een klokwijzer winding heeft. |
| [overlaps(other)](#overlaps_other_34) | Bepaalt of deze geometrie overlapt met een opgegeven geometrie. |
| [relate(other, intersection_pattern_matrix)](#relate_other_intersection_pattern_matrix_35) | Bepaalt of de DE-9IM-intersectiematrix van deze geometrie en een opgegeven geometrie overeenkomt met het opgegeven patroon. |
| [replace_polygons_by_lines()](#replace_polygons_by_lines__36) | Haalt polygonen op die als lijnen van deze geometrie worden weergegeven. |
| reverse() | Keert de volgorde van punten in deze [LineString](/psd/python-net/aspose.gis.geometries/linestring/) om. |
| [round_m(digits)](#round_m_digits_37) | Rondt de M-coördinaat af naar een opgegeven aantal decimale cijfers. |
| [round_xy(digits)](#round_xy_digits_38) | Rondt de X- en Y-coördinaten af naar een opgegeven aantal decimale cijfers. |
| [round_z(digits)](#round_z_digits_39) | Rondt de Z-coördinaat af naar een opgegeven aantal decimale cijfers. |
| set_empty() | Maakt deze [Geometry](/psd/python-net/aspose.gis.geometries/geometry/) leeg. |
| [spatially_contains(other)](#spatially_contains_other_40) | Bepaalt of deze geometrie ruimtelijk een opgegeven geometrie bevat. |
| [spatially_equals(other)](#spatially_equals_other_41) | Bepaalt of deze geometrie ruimtelijk gelijk is aan een opgegeven geometrie. |
| [sym_difference(other)](#sym_difference_other_42) | Bouwt een symmetrisch verschil tussen deze geometrie en een gespecificeerde geometrie. |
| [to_editable()](#to_editable__43) | Haalt een bewerkbare kopie van deze geometrie op. |
| [to_linear_geometry()](#to_linear_geometry__44) | Haalt een benaderende of equivalente niet-curve versie van deze geometrie op met de standaard <c>tolerance</c>. |
| [to_linear_geometry(tolerance)](#to_linear_geometry_tolerance_45) | Haalt een benaderende of equivalente niet-curve versie van deze geometrie op met de opgegeven <c>tolerance</c>. |
| [to_svg(extent)](#to_svg_extent_46) | Zet deze geometrie om naar een Svg-representatie. |
| [touches(other)](#touches_other_47) | Bepaalt of deze geometrie en een gespecificeerde geometrie elkaar raken. |
| [union(other)](#union_other_48) | Voegt deze geometrie en een gespecificeerde geometrie samen. |
| [union(other)](#union_other_49) | Voegt deze geometrie en een gespecificeerde geometrie samen. |
| [within(extent)](#within_extent_50) | Bepaalt of deze geometrie zich binnen een gespecificeerde omvang bevindt. |
| [within(other)](#within_other_51) | Bepaalt of deze geometrie zich binnen een gespecificeerde geometrie bevindt. |
...
Initialiseert een nieuw exemplaar van de [LinearRing](/psd/python-net/aspose.gis.geometries/linearring/) klasse.
...
| Parameter | Type | Beschrijving |
| :- | :- | :- |
| other | [ILineString](/psd/python-net/aspose.gis.geometries/ilinestring) | De andere lijn waaruit gegevens gekopieerd moeten worden. |
...
Bepaalt of de ring een klokwijzer winding heeft.

**Returns**

| Type | Beschrijving |
| :- | :- |
| bool | <see langword="true" /> als klokwijzer; anders <see langword="false" />. |
...
| Type | Beschrijving |
| :- | :- |
| [LinearRing](/psd/python-net/aspose.gis.geometries/linearring) | Een bewerkbare kopie van deze geometrie. |
