...
type: docs
weight: 200
url: /nl/python-net/aspose.gis.geometries/ipoint/
---
...
| m | double | r | Haalt de m-coördinaat op. |
...
| x | double | r | Haalt de x-coördinaat op. |
| y | double | r | Haalt de y-coördinaat op. |
| z | double | r | Haalt de z-coördinaat op. |
## **Methods**
| **Name** | **Beschrijving** |
| :- | :- |
