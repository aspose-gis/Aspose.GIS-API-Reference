---
title: "CurvePolygon Klasse"
type: docs
weight: 40
url: /nl/python-net/aspose.gis.geometries/curvepolygon/
---
...
| **Name** | **Beschrijving** |
| :- | :- |
| [CurvePolygon()](#CurvePolygon__1) | Initialiseert een nieuw exemplaar van de [CurvePolygon](/psd/python-net/aspose.gis.geometries/curvepolygon/) klasse. |
| [CurvePolygon(exterior_ring)](#CurvePolygon_exterior_ring_2) | Initialiseert een nieuw exemplaar van de [CurvePolygon](/psd/python-net/aspose.gis.geometries/curvepolygon/) klasse. |
| [CurvePolygon(exterior_ring, interior_rings)](#CurvePolygon_exterior_ring_interior_rings_3) | Initialiseert een nieuw exemplaar van de [CurvePolygon](/psd/python-net/aspose.gis.geometries/curvepolygon/) klasse. |
## **Properties**
...
| exterior_ring | [ICurve](/psd/python-net/aspose.gis.geometries/icurve) | r/w | Haalt de buitenring op. |
...
| interior_rings_count | int | r | Haalt het aantal binnenringen op. |
...
| **Name** | **Beschrijving** |
| :- | :- |
| [add_interior_ring(ring)](#add_interior_ring_ring_1) | Voegt een binnenring toe. |
| [as_binary()](#as_binary__2) | Vertaal deze geometrie naar zijn Well-Known Binary-representatie. |
| [as_binary(variant)](#as_binary_variant_3) | Vertaal deze geometrie naar zijn Well-Known Binary-representatie. |
...
| [as_image(width, height, renderer, symbolizer)](#as_image_width_height_renderer_symbolizer_6) | Exporteer deze geometrie naar een afbeeldingsrepresentatie. |
| [as_text()](#as_text__7) | Vertaal deze geometrie naar zijn Well-Known Text-representatie. |
| [as_text(variant)](#as_text_variant_8) | Vertaal deze geometrie naar zijn Well-Known Text-representatie. |
| [as_text(variant, format)](#as_text_variant_format_9) | Vertaal deze geometrie naar zijn Well-Known Text-representatie. |
| [clone()](#clone__10) | Kloont deze instantie. |
| [covered_by(other)](#covered_by_other_11) | Bepaalt of deze geometrie wordt gedekt door een opgegeven geometrie. |
| [covers(other)](#covers_other_12) | Bepaalt of deze geometrie een opgegeven geometrie dekt. |
| [crosses(other)](#crosses_other_13) | Bepaalt of deze geometrie en een opgegeven geometrie elkaar kruisen. |
| [difference(other)](#difference_other_14) | Trek een opgegeven geometrie af van deze geometrie. |
| [disjoint(other)](#disjoint_other_15) | Bepaalt of deze geometrie losstaat van een opgegeven geometrie. |
| [from_binary(wkb)](#from_binary_wkb_16) | Maakt een geometrie aan vanuit de Well-Known Binary-representatie. |
| [from_binary(wkb, spatial_reference_system)](#from_binary_wkb_spatial_reference_system_17) | Maakt een geometrie aan vanuit de Well-Known Binary-representatie. |
| [from_text(wkt)](#from_text_wkt_18) | Maakt een geometrie aan vanuit de Well-Known Text-representatie. |
| [from_text(wkt, spatial_reference_system)](#from_text_wkt_spatial_reference_system_19) | Maakt een geometrie aan vanuit de Well-Known Text-representatie. |
| [get_area()](#get_area__20) | Berekent de oppervlakte van deze geometrie. |
| [get_buffer(distance, quadrant_segments)](#get_buffer_distance_quadrant_segments_21) | Berekent een buffergebied rond deze geometrie. |
| [get_centroid()](#get_centroid__22) | Berekent het zwaartepunt van deze geometrie. |
| [get_convex_hull()](#get_convex_hull__23) | Berekent de convexe omhulling van deze geometrie. |
| [get_distance_to(other)](#get_distance_to_other_24) | Berekent de minimale afstand tussen deze geometrie en een opgegeven geometrie. |
| [get_extent()](#get_extent__25) | Berekent en retourneert een begrenzende extent van deze geometrie. |
| [get_interior_ring(index)](#get_interior_ring_index_26) | Haalt de binnenring op via de index. |
| [get_length()](#get_length__27) | Berekent de lengte van deze geometrie. |
| [get_point_on_surface()](#get_point_on_surface__28) | Vindt een punt dat gegarandeerd op dit gebogen polygoon ligt. |
...
| [replace_polygons_by_lines()](#replace_polygons_by_lines__34) | Haalt polygonen op die als lijnen van deze geometrie worden weergegeven. |
| [round_m(digits)](#round_m_digits_35) | Rondt de M-coördinaat af naar een opgegeven aantal decimale cijfers. |
| [round_xy(digits)](#round_xy_digits_36) | Rondt de X- en Y-coördinaten af naar een opgegeven aantal decimale cijfers. |
| [round_z(digits)](#round_z_digits_37) | Rondt de Z-coördinaat af naar een opgegeven aantal decimale cijfers. |
| set_empty() | Maakt deze [Geometry](/psd/python-net/aspose.gis.geometries/geometry/) leeg. |
| [spatially_contains(other)](#spatially_contains_other_38) | Bepaalt of deze geometrie ruimtelijk een opgegeven geometrie bevat. |
| [spatially_equals(other)](#spatially_equals_other_39) | Bepaalt of deze geometrie ruimtelijk gelijk is aan een opgegeven geometrie. |
| [sym_difference(other)](#sym_difference_other_40) | Bouwt een symmetrisch verschil tussen deze geometrie en een gespecificeerde geometrie. |
| [to_editable()](#to_editable__41) | Haalt een bewerkbare kopie van deze geometrie op. |
| [to_linear_geometry()](#to_linear_geometry__42) | Haalt een benaderende of equivalente niet-curve versie van deze geometrie op met de standaard <c>tolerance</c>. |
| [to_linear_geometry(tolerance)](#to_linear_geometry_tolerance_43) | Haalt een benaderende of equivalente niet-curve versie van deze geometrie op met de opgegeven <c>tolerance</c>. |
| [to_svg(extent)](#to_svg_extent_44) | Zet deze geometrie om naar een Svg-representatie. |
| [touches(other)](#touches_other_45) | Bepaalt of deze geometrie en een gespecificeerde geometrie elkaar raken. |
| [union(other)](#union_other_46) | Voegt deze geometrie en een gespecificeerde geometrie samen. |
| [union(other)](#union_other_47) | Voegt deze geometrie en een gespecificeerde geometrie samen. |
| [within(extent)](#within_extent_48) | Bepaalt of deze geometrie zich binnen een gespecificeerde omvang bevindt. |
| [within(other)](#within_other_49) | Bepaalt of deze geometrie zich binnen een gespecificeerde geometrie bevindt. |
...
Initialiseert een nieuw exemplaar van de [CurvePolygon](/psd/python-net/aspose.gis.geometries/curvepolygon/) klasse.
...
| :- | :- | :- |
| exterior_ring | [ICurve](/psd/python-net/aspose.gis.geometries/icurve) | De buitenring. |
...
| :- | :- | :- |
| exterior_ring | [ICurve](/psd/python-net/aspose.gis.geometries/icurve) | De buitenring. |
| interior_rings | System.Collections.Generic.IEnumerable<ICurve> | De binnenringen. |
...
Voegt een binnenring toe.

**Parameters:**

| Parameter | Type | Beschrijving |
| :- | :- | :- |
| ring | [ICurve](/psd/python-net/aspose.gis.geometries/icurve) | De ring om toe te voegen. |
...
Haalt de binnenring op via de index.
...
| Type | Beschrijving |
| :- | :- |
| [ICurve](/psd/python-net/aspose.gis.geometries/icurve) | De binnenring. |
...
Vindt een punt dat gegarandeerd op dit gebogen polygoon ligt.

**Returns**

| Type | Beschrijving |
| :- | :- |
| [IPoint](/psd/python-net/aspose.gis.geometries/ipoint) | Een punt op dit gebogen polygoon. Een leeg punt als dit gebogen polygoon geen binnenkant heeft. |
...
| Type | Beschrijving |
| :- | :- |
| [CurvePolygon](/psd/python-net/aspose.gis.geometries/curvepolygon) | Een bewerkbare kopie van deze geometrie. |
