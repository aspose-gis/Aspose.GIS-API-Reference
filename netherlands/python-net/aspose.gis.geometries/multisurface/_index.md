---
title: "MultiSurface Klasse"
type: docs
weight: 290
url: /nl/python-net/aspose.gis.geometries/multisurface/
---

**Summary:** A [MultiSurface](/psd/python-net/aspose.gis.geometries/multisurface/) is a one-dimensional [GeometryCollection](/psd/python-net/aspose.gis.geometries/geometrycollection/) whose elements are [ISurface](/psd/python-net/aspose.gis.geometries/isurface/)s.

**Module:** [aspose.gis.geometries](/psd/python-net/aspose.gis.geometries/)

**Full Name:** aspose.gis.geometries.MultiSurface

**Inheritance:** IGeometry, IGeometryCollection, IMultiSurface, GeometryCollection
...
| **Name** | **Beschrijving** |
| :- | :- |
| [MultiSurface()](#MultiSurface__1) | Initialiseert een nieuw exemplaar van de [MultiSurface](/psd/python-net/aspose.gis.geometries/multisurface/) klasse. |
## **Properties**
...
### Constructor: MultiSurface() {#MultiSurface__1}
...
Initialiseert een nieuw exemplaar van de [MultiSurface](/psd/python-net/aspose.gis.geometries/multisurface/) klasse.
...
| Type | Beschrijving |
| :- | :- |
| [MultiSurface](/psd/python-net/aspose.gis.geometries/multisurface) | Een bewerkbare kopie van deze geometrie. |
...
| Type | Beschrijving |
| :- | :- |
| [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon) | Een [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon/) die benadert of gelijkwaardig is aan deze [IMultiSurface](/psd/python-net/aspose.gis.geometries/imultisurface/).<br/>            Dit is het equivalent van <DOM Element: class at 0x2a1792e8790>.IMultiSurface.to_linear_geometry()(float) met<br/>            standaard <c>tolerance</c>. De standaardwaarde van <c>tolerance</c> is afhankelijk van [SpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem/)<br/>            van deze geometrie:<br/>            <ul><br/>            <li> Voor een geprojecteerd SRS is de tolerantie 0,001 meter (in SRS-eenheden) </li><br/>            <li> Voor een geografisch SRS is de tolerantie <c>1e-5</c> graden (in SRS-eenheden) </li><br/>            <li> Voor een onbekend SRS is de tolerantie <c>1e-5</c> </li><br/>            </ul><br/>            Voor meer details over welke transformaties worden toegepast, raadpleeg de specificatie van <DOM Element: class at 0x2a1792e8790>.IMultiSurface.to_linear_geometry()(float). |
...
| Type | Beschrijving |
| :- | :- |
| [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon) | Een [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon/) die benadert of gelijkwaardig is aan deze [IMultiSurface](/psd/python-net/aspose.gis.geometries/imultisurface/):<br/>             <ul><br/>             Als dit object zelf een [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon/) is, is het resultaat gelijk aan dit object<br/>             Als dit object geen [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon/) is, worden alle oppervlakken lineair gemaakt en wordt een nieuwe <c>IMultiPolygon</c> aangemaakt<br/>            </ul> |
