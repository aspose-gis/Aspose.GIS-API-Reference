...
type: docs
weight: 50
url: /nl/python-net/aspose.gis.geometries/geometry/
---
...
| dimension | [GeometryDimension](/psd/python-net/aspose.gis.geometries/geometrydimension) | r | Haalt de topologische dimensie van deze [Geometry](/psd/python-net/aspose.gis.geometries/geometry/).<br/>            Als de dimensie onbekend is (bijv. voor een lege GEOMETRYCOLLECTION) wordt [GeometryDimension.POINT](/psd/python-net/aspose.gis.geometries/geometrydimension/) geretourneerd. |
...
| Type | Beschrijving |
| :- | :- |
| [Geometry](/psd/python-net/aspose.gis.geometries/geometry) | Een bewerkbare kopie van deze geometrie. |
