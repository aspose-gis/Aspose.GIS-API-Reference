...
type: docs
weight: 310
url: /nl/python-net/aspose.gis.geometries/polygon/
---
...
| **Name** | **Beschrijving** |
| :- | :- |
| [Polygon()](#Polygon__1) | Initialiseert een nieuw exemplaar van de klasse [Polygon](/psd/python-net/aspose.gis.geometries/polygon/). |
| [Polygon(exterior_ring)](#Polygon_exterior_ring_2) | Initialiseert een nieuw exemplaar van de klasse [Polygon](/psd/python-net/aspose.gis.geometries/polygon/). |
| [Polygon(exterior_ring, interior_rings)](#Polygon_exterior_ring_interior_rings_3) | Initialiseert een nieuw exemplaar van de klasse [Polygon](/psd/python-net/aspose.gis.geometries/polygon/). |
## **Properties**
...
| exterior_ring | [ILinearRing](/psd/python-net/aspose.gis.geometries/ilinearring) | r/w | Haalt de buitenring op. |
...
| [get_point_on_surface()](#get_point_on_surface__28) | Vindt een punt dat gegarandeerd op deze veelhoek ligt. |
...
Initialiseert een nieuw exemplaar van de klasse [Polygon](/psd/python-net/aspose.gis.geometries/polygon/).
...
| :- | :- | :- |
| exterior_ring | [ILinearRing](/psd/python-net/aspose.gis.geometries/ilinearring) | De buitenring. |
...
| :- | :- | :- |
| exterior_ring | [ILinearRing](/psd/python-net/aspose.gis.geometries/ilinearring) | De buitenring. |
| interior_rings | System.Collections.Generic.IEnumerable<ILinearRing> | De binnenringen. |
...
| Parameter | Type | Beschrijving |
| :- | :- | :- |
| ring | [ILinearRing](/psd/python-net/aspose.gis.geometries/ilinearring) | De ring om toe te voegen. |
...
| Type | Beschrijving |
| :- | :- |
| [ILinearRing](/psd/python-net/aspose.gis.geometries/ilinearring) | De binnenring. |
...
Vindt een punt dat gegarandeerd op deze veelhoek ligt.

**Returns**

| Type | Beschrijving |
| :- | :- |
| [IPoint](/psd/python-net/aspose.gis.geometries/ipoint) | Een punt op deze veelhoek. Een leeg punt als deze veelhoek geen binnenring heeft. |
...
| Type | Beschrijving |
| :- | :- |
| [Polygon](/psd/python-net/aspose.gis.geometries/polygon) | Een bewerkbare kopie van deze geometrie. |
