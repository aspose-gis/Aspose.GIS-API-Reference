...
type: docs
weight: 210
url: /nl/python-net/aspose.gis.geometries/ipolygon/
---
...
| exterior_ring | [ILinearRing](/psd/python-net/aspose.gis.geometries/ilinearring) | r | Haalt de buitenring op. |
...
| [get_interior_ring(index)](#get_interior_ring_index_21) | Haalt de binnenring op via de index. |
| [get_length()](#get_length__22) | Berekent de lengte van deze geometrie. |
| [get_point_on_surface()](#get_point_on_surface__23) | Vindt een punt dat gegarandeerd op dit oppervlak ligt. |
| [intersection(other)](#intersection_other_24) | Bouwt een intersectie tussen deze geometrie en een opgegeven geometrie. |
| [intersects(extent)](#intersects_extent_25) | Bepaalt of deze geometrie een opgegeven extent intersecteert. |
| [intersects(other)](#intersects_other_26) | Bepaalt of deze geometrie en een opgegeven geometrie elkaar intersecteren. |
| [overlaps(other)](#overlaps_other_27) | Bepaalt of deze geometrie overlapt met een opgegeven geometrie. |
| [relate(other, intersection_pattern_matrix)](#relate_other_intersection_pattern_matrix_28) | Bepaalt of de DE-9IM-intersectiematrix van deze geometrie en een opgegeven geometrie overeenkomt met het opgegeven patroon. |
| [replace_polygons_by_lines()](#replace_polygons_by_lines__29) | Haalt polygonen op die als lijnen van deze geometrie worden weergegeven. |
| [spatially_contains(other)](#spatially_contains_other_30) | Bepaalt of deze geometrie ruimtelijk een opgegeven geometrie bevat. |
| [spatially_equals(other)](#spatially_equals_other_31) | Bepaalt of deze geometrie ruimtelijk gelijk is aan een opgegeven geometrie. |
| [sym_difference(other)](#sym_difference_other_32) | Bouwt een symmetrisch verschil tussen deze geometrie en een gespecificeerde geometrie. |
| [to_editable()](#to_editable__33) | Haalt een bewerkbare kopie van deze geometrie op. |
| [to_linear_geometry()](#to_linear_geometry__34) | Haalt een benaderende of equivalente niet-curve versie van deze geometrie op met de standaard <c>tolerance</c>. |
| [to_linear_geometry(tolerance)](#to_linear_geometry_tolerance_35) | Haalt een benaderende of equivalente niet-curve versie van deze geometrie op met de opgegeven <c>tolerance</c>. |
| [touches(other)](#touches_other_36) | Bepaalt of deze geometrie en een gespecificeerde geometrie elkaar raken. |
| [union(other)](#union_other_37) | Voegt deze geometrie en een gespecificeerde geometrie samen. |
| [union(other)](#union_other_38) | Voegt deze geometrie en een gespecificeerde geometrie samen. |
| [within(extent)](#within_extent_39) | Bepaalt of deze geometrie zich binnen een gespecificeerde omvang bevindt. |
| [within(other)](#within_other_40) | Bepaalt of deze geometrie zich binnen een gespecificeerde geometrie bevindt. |
