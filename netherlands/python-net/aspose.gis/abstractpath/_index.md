...
type: docs
weight: 10
url: /nl/python-net/aspose.gis/abstractpath/
---
...
| separator | char | r | Haalt een scheidingsteken op dat wordt gebruikt om directory-niveaus van de [AbstractPath.location](/psd/python-net/aspose.gis/abstractpath/) tekenreeks te scheiden. |
## **Methods**
| **Name** | **Beschrijving** |
| :- | :- |
...
| [open(access)](#open_access_9) | Opent dit <c>AbstractPath</c> als een bestand. |
...
Opent dit <c>AbstractPath</c> als een bestand.
...
| Type | Beschrijving |
| :- | :- |
| _io.BufferedRandom | Een stream geopend met de opgegeven FileAccess. |
