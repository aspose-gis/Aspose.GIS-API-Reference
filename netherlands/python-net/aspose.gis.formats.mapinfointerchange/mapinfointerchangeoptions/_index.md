---
title: "MapInfoInterchangeOptions Klasse"
type: docs
weight: 20
url: /nl/python-net/aspose.gis.formats.mapinfointerchange/mapinfointerchangeoptions/
---
...
| **Name** | **Beschrijving** |
| :- | :- |
| [MapInfoInterchangeOptions()](#MapInfoInterchangeOptions__1) | Maak een nieuw exemplaar. |
## **Properties**
| **Name** | **Type** | **Access** | **Beschrijving** |
| :- | :- | :- | :- |
| tekenset | string | r/w | Bepaalt de tekenset, standaard is Neutral |
...
| scheidingsteken | string | r/w | Bepaalt het scheidingsteken voor attributen in een mid-bestand, standaard is een tabteken |
...
| tekst_string_attribuut | string | r/w | Specificeert de naam van het attribuut dat de tekst van het grafische object 'Text' vertegenwoordigt. |
