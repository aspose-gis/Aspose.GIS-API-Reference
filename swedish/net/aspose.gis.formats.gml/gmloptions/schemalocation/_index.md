...
description: Mellanslagsseparerad lista med URIpar. Första URI i varje par är en URI för namnutrymmet andra URI är ett sökväg till XMLschema för namnutrymmet. Om satt tillnull GmlDriveraspose.gis.formats.gml/gmldriver kommer att försöka läsa schemaLocation från rotelementet i dokumentet. Standard ärnull .
type: docs
weight: 50
