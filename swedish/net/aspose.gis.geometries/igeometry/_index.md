...
description: Gränssnittsrotklassen för Geometries hierarchy
type: docs
weight: 900
...
| namn | Beskrivning |
| --- | --- |
| [Dimension](../../aspose.gis.geometries/igeometry/dimension) { get; } | Får den topologiska dimensionen av detta[`IGeometry`](../igeometry) . Om dimensionen är okänd (t.ex. för en tom GEOMETRYCOLLECTION)Point returneras. |
