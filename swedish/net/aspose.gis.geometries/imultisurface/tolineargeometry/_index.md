...
description: IMultiSurface metod. Får ungefärlig eller likvärdig ickekurv version av denna geometri med standardtolerans .
type: docs
weight: 20
url: /sv/net/aspose.gis.geometries/imultisurface/tolineargeometry/
---
...
A[`IMultiPolygon`](../../imultipolygon/) som är ungefärlig eller likvärdig med detta[`IMultiSurface`](../) :  Om detta objekt är[`IMultiPolygon`](../../imultipolygon/) i sig är resultatet ekvivalent med detta objekt Om detta objekt inte är det[`IMultiPolygon`](../../imultipolygon/) - alla ytor är linjäriserade och nya`IMultiPolygon` är skapad
