...
description: Aspose.Gis.Geometries.CompoundCurve klass. En kurva som representerar en sekvens av sammanhängande kurvor så att intilliggande kurvor sammanfogas vid deras ändpunkter.
type: docs
weight: 890
...
| namn | Beskrivning |
| --- | --- |
| [CompoundCurve](compoundcurve/#constructor)() | Initierar en ny instans av`CompoundCurve` class. |
| [CompoundCurve](compoundcurve/#constructor_1)(ICompoundCurve) | Initierar en ny instans av`CompoundCurve` class. |
| [CompoundCurve](compoundcurve/#constructor_2)(IEnumerable&lt;ICurve&gt;) | Initierar en ny instans av`CompoundCurve` class. |
...
| namn | Beskrivning |
| --- | --- |
| [AddCurve](../../aspose.gis.geometries/compoundcurve/addcurve/)(ICurve) | Lägger till en kurva i slutet av detta`CompoundCurve` . |
...
| override [Reverse](../../aspose.gis.geometries/compoundcurve/reverse/)() | Vänder om detta`CompoundCurve` . Det vill säga - omvänd ordning av kurvorna och varje kurva inuti denna sammansatta kurva. |
