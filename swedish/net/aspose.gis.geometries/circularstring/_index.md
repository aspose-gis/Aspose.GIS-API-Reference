...
description: Aspose.Gis.Geometries.CircularString klass. En kurva med flera vertex med cirkulär interpolation mellan punkter.
type: docs
weight: 880
...
| namn | Beskrivning |
| --- | --- |
| [CircularString](circularstring/#constructor)() | Initierar en ny instans av`CircularString` class. |
| [CircularString](circularstring/#constructor_1)(ICircularString) | Initierar en ny instans av`CircularString` class. |
| [CircularString](circularstring/#constructor_2)(IEnumerable&lt;IPoint&gt;) | Initierar en ny instans av`CircularString` class. |
...
| [Count](../../aspose.gis.geometries/circularstring/count/) { get; } | Får antalet poäng i`CircularString` . |
...
| override [Reverse](../../aspose.gis.geometries/circularstring/reverse/)() | Omvänd ordning på punkterna i detta`CircularString` . |
