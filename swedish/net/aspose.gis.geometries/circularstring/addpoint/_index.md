...
description: Lägger till en punkt i slutet av den cirkulära strängen.
type: docs
weight: 120
url: /sv/net/aspose.gis.geometries/circularstring/addpoint/
---
...
| --- | --- | --- |
| point | IPoint | Poängen att tillägga. |
...
| ArgumentException | Argumentet är tomt (dess[`IsEmpty`](../../igeometry/isempty) är`true` ). |
