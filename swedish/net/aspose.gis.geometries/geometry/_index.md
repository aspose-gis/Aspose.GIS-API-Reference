...
description: Aspose.Gis.Geometries.Geometry klass. Den abstrakta rotklassen för geometrihierarkin.
type: docs
weight: 920
...
| namn | Beskrivning |
| --- | --- |
| [CoordinateDimension](../../aspose.gis.geometries/geometry/coordinatedimension/) { get; } | Hämtar antalet koordinatdimensioner för detta`Geometry` . |
| abstract [Dimension](../../aspose.gis.geometries/geometry/dimension/) { get; } | Får den topologiska dimensionen av detta`Geometry` . Om dimensionen är okänd (t.ex. för en tom GEOMETRYCOLLECTION)Point returneras. |
...
| virtual [SetEmpty](../../aspose.gis.geometries/geometry/setempty/)() | gör detta`Geometry` tomt. |
