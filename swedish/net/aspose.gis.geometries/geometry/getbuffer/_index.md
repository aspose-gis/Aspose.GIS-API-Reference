...
description: Geometry metod. Beräknar ett buffertområde runt denna geometri.
type: docs
weight: 210
url: /sv/net/aspose.gis.geometries/geometry/getbuffer/
---
...
En geometri som representerar alla punkter som ligger inom ett specificerat avstånd från denna geometri. Typen av resultat är antingen[`Null`](../null/) ,[`IPolygon`](../../ipolygon/) eller[`IMultiPolygon`](../../imultipolygon/) .
