...
description: Geometry metod. Bestämmer om denna geometri täcker en specificerad geometri.
type: docs
weight: 160
url: /sv/net/aspose.gis.geometries/geometry/covers/
---
...
Denna metod testar om en geometri täcker en annan i termer av DE-9IM skärningsmatris. En geometri täcker en annan, om geometrin innehåller varje punkt i en annan geometri. Denna metod liknar[`SpatiallyContains`](../../igeometry/spatiallycontains/) , men återvänder`true` oftare, eftersom den inte skiljer mellan inre och gränspunkter. Så, om geometri A ligger på gränsen för geometri B,[`SpatiallyContains`](../../igeometry/spatiallycontains/) returnerar`false` , medan denna metod returnerar`true`. Denna metod motsvarar:
