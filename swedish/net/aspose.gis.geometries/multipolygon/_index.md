...
description: Aspose.Gis.Geometries.MultiPolygon klass. AMultiPolygon är en endimensionell GeometryCollection vars element ärPolygon s.
type: docs
weight: 1170
...
A`MultiPolygon` är en endimensionell [`GeometryCollection`](../geometrycollection/) vars element är[`Polygon`](../polygon/) s.
...
| namn | Beskrivning |
| --- | --- |
| [MultiPolygon](multipolygon/)() | Initierar en ny instans av`MultiPolygon` class. |
