...
description: AMultiPolygon./multipolygon är en endimensionell GeometryCollection./geometrycollection vars element ärPolygon./polygon s.
type: docs
weight: 1070
url: /sv/net/aspose.gis.geometries/multipolygon/
---
## MultiPolygon class

A[`MultiPolygon`](../multipolygon) är en endimensionell [`GeometryCollection`](../geometrycollection) vars element är[`Polygon`](../polygon) s.
...
| namn | Beskrivning |
| --- | --- |
| [MultiPolygon](multipolygon)() | Initierar en ny instans av[`MultiPolygon`](../multipolygon) class. |
...
| override [GeometryType](../../aspose.gis.geometries/multipolygon/geometrytype) { get; } | Hämtar typen av geometri. |
...
| override [Clone](../../aspose.gis.geometries/multipolygon/clone)() | Klonar den här instansen. |
...
| [ToEditable](../../aspose.gis.geometries/multipolygon/toeditable#toeditable_2)() | Får en redigerbar kopia av denna geometri. (4 methods) |
| [ToEditable&lt;T&gt;](../../aspose.gis.geometries/geometry/toeditable)() | Får en redigerbar kopia av denna geometri. |
| [ToLinearGeometry](../../aspose.gis.geometries/multisurface/tolineargeometry)() | Får ungefärlig eller likvärdig icke-kurv version av denna geometri med standard`tolerans` . (3 methods) |
| [ToLinearGeometry](../../aspose.gis.geometries/multisurface/tolineargeometry)(double) | Får ungefärlig eller likvärdig icke-kurv version av denna geometri med den angivna`tolerans` . (3 methods) |
