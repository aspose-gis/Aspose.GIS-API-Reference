...
description: Aspose.Gis.Geometries.MultiCurve klass. AMultiCurve är en endimensionellGeometryCollection vars element ärCurve s.
type: docs
weight: 1140
...
A`MultiCurve` är en endimensionell[`GeometryCollection`](../geometrycollection/) vars element är[`Curve`](../curve/) s.
...
| namn | Beskrivning |
| --- | --- |
| [MultiCurve](multicurve/)() | Initierar en ny instans av`MultiCurve` class. |
