...
description: Aspose.Gis.Geometries.CurvePolygon klass. En plan yta definierad av 1 yttre gräns och 0 eller fler inre gränser.
type: docs
weight: 910
url: /sv/net/aspose.gis.geometries/curvepolygon/
---
## CurvePolygon class

En plan yta, definierad av 1 yttre gräns och 0 eller fler inre gränser.
...
| namn | Beskrivning |
| --- | --- |
| [CurvePolygon](curvepolygon/#constructor)() | Initierar en ny instans av`CurvePolygon` class. |
| [CurvePolygon](curvepolygon/#constructor_1)(ICurve) | Initierar en ny instans av`CurvePolygon` class. |
| [CurvePolygon](curvepolygon/#constructor_2)(ICurve, IEnumerable&lt;ICurve&gt;) | Initierar en ny instans av`CurvePolygon` class. |
...
| [ExteriorRing](../../aspose.gis.geometries/curvepolygon/exteriorring/) { get; set; } | Får den yttre ringen. |
| override [GeometryType](../../aspose.gis.geometries/curvepolygon/geometrytype/) { get; } | Hämtar typen av geometri. |
| override [HasCurveGeometry](../../aspose.gis.geometries/curvepolygon/hascurvegeometry/) { get; } | Får ett värde som indikerar om denna geometri är eller innehåller kurvgeometri (ej linjär). |
| [HasM](../../aspose.gis.geometries/curvepolygon/hasm/) { get; set; } | Får ett värde som indikerar om denna instans har M-koordinat. |
| [HasZ](../../aspose.gis.geometries/curvepolygon/hasz/) { get; set; } | Får ett värde som indikerar om denna instans har Z-koordinat. |
| [InteriorRingsCount](../../aspose.gis.geometries/curvepolygon/interiorringscount/) { get; } | Får antalet invändiga ringar. |
| override [IsEmpty](../../aspose.gis.geometries/curvepolygon/isempty/) { get; } | Får ett värde som anger om denna instans är tom. |
...
| override [Clone](../../aspose.gis.geometries/curvepolygon/clone/)() | Klonar den här instansen. |
...
| [Equals](../../aspose.gis.geometries/curvepolygon/equals/#equals)(ICurvePolygon) | Anger om det aktuella objektet är lika med ett annat objekt av samma typ. |
| override [Equals](../../aspose.gis.geometries/curvepolygon/equals/#equals_1)(object) | Bestämmer om det angivna objektet är lika med det aktuella objektet. |
...
| override [GetHashCode](../../aspose.gis.geometries/curvepolygon/gethashcode/)() | Fungerar som standard hash-funktion. |
| [GetInteriorRing](../../aspose.gis.geometries/curvepolygon/getinteriorring/)(int) | Får den inre ringen genom dess index. |
| [GetLength](../../aspose.gis.geometries/geometry/getlength/)() | Beräknar längden på denna geometri. |
| override [GetPointOnSurface](../../aspose.gis.geometries/curvepolygon/getpointonsurface/)() | Hittar en punkt som garanterat finns på denna krökta polygon. |
...
| override [SetEmpty](../../aspose.gis.geometries/curvepolygon/setempty/)() | gör detta[`Geometry`](../geometry/) tomt. |
...
| [ToEditable](../../aspose.gis.geometries/curvepolygon/toeditable/#toeditable)() | Får en redigerbar kopia av denna geometri. (3 methods) |
...
| [operator ==](../../aspose.gis.geometries/curvepolygon/op_equality/) | Implementerar operatorn ==. |
| [operator !=](../../aspose.gis.geometries/curvepolygon/op_inequality/) | Implementerar operatorn !=. |
