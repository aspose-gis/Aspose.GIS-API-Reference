...
description: Aspose.Gis.Geometries.LinearRing klass. ALinearRing är enLineString det är både stängt och enkelt.
type: docs
weight: 1130
...
A`LinearRing` är en[`LineString`](../linestring/) det är både stängt och enkelt.
...
| namn | Beskrivning |
| --- | --- |
| [LinearRing](linearring/#constructor)() | Initierar en ny instans av`LinearRing` class. |
| [LinearRing](linearring/#constructor_2)(IEnumerable&lt;IPoint&gt;) | Initierar en ny instans av`LinearRing` class. |
| [LinearRing](linearring/#constructor_1)(ILineString) | Initierar en ny instans av`LinearRing` class. |
