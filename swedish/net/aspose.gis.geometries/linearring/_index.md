...
description: ALinearRing./linearring är enLineString./linestring det är både stängt och enkelt.
type: docs
weight: 1030
url: /sv/net/aspose.gis.geometries/linearring/
---
## LinearRing class

A[`LinearRing`](../linearring) är en[`LineString`](../linestring) det är både stängt och enkelt.
...
| namn | Beskrivning |
| --- | --- |
| [LinearRing](linearring#constructor)() | Initierar en ny instans av[`LinearRing`](../linearring) class. |
| [LinearRing](linearring#constructor_2)(IEnumerable&lt;IPoint&gt;) | Initierar en ny instans av[`LinearRing`](../linearring) class. |
| [LinearRing](linearring#constructor_1)(ILineString) | Initierar en ny instans av[`LinearRing`](../linearring) class. |
...
| [Count](../../aspose.gis.geometries/linestring/count) { get; } | Får antalet poäng i[`LineString`](../linestring) . |
...
| override [GeometryType](../../aspose.gis.geometries/linearring/geometrytype) { get; } | Hämtar typen av geometri. |
...
| namn | Beskrivning |
| --- | --- |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint)(IPoint) | Lägger till en punkt i slutet av raden. |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint)(double, double) | Lägger till en punkt i slutet av raden. |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint)(double, double, double) | Lägger till en punkt i slutet av raden. |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint)(double, double, double, double) | Lägger till en punkt i slutet av raden. |
...
| override [Clone](../../aspose.gis.geometries/linearring/clone)() | Klonar den här instansen. |
...
| [Equals](../../aspose.gis.geometries/linestring/equals)(ILineString) | Anger om det aktuella objektet är lika med ett annat objekt av samma typ. |
| override [Equals](../../aspose.gis.geometries/linestring/equals)(object) | Bestämmer om det angivna objektet är lika med det aktuella objektet. |
...
| [IsClockwise](../../aspose.gis.geometries/linearring/isclockwise)() | Bestämmer om ringen har medurslindning. |
...
| override [Reverse](../../aspose.gis.geometries/linestring/reverse)() | Omvänd ordning på punkterna i detta[`LineString`](../linestring) . |
...
| [ToEditable](../../aspose.gis.geometries/linearring/toeditable#toeditable_2)() | Får en redigerbar kopia av denna geometri. (4 methods) |
