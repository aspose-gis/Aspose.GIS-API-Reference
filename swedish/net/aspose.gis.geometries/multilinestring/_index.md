...
type: docs
weight: 1050
url: /sv/net/aspose.gis.geometries/multilinestring/
---
...
| namn | Beskrivning |
| --- | --- |
| [MultiLineString](multilinestring)() | Initierar en ny instans av[`MultiLineString`](../multilinestring) class. |
...
| override [GeometryType](../../aspose.gis.geometries/multilinestring/geometrytype) { get; } | Hämtar typen av geometri. |
...
| override [Clone](../../aspose.gis.geometries/multilinestring/clone)() | Klonar den här instansen. |
...
| [ToEditable](../../aspose.gis.geometries/multilinestring/toeditable#toeditable_3)() | Får en redigerbar kopia av denna geometri. (4 methods) |
| [ToEditable&lt;T&gt;](../../aspose.gis.geometries/geometry/toeditable)() | Får en redigerbar kopia av denna geometri. |
| [ToLinearGeometry](../../aspose.gis.geometries/multicurve/tolineargeometry)() | Får ungefärlig eller likvärdig icke-kurv version av denna geometri med standard`tolerans` . (3 methods) |
| [ToLinearGeometry](../../aspose.gis.geometries/multicurve/tolineargeometry)(double) | Får ungefärlig eller likvärdig icke-kurv version av denna geometri med den angivna`tolerans` . (3 methods) |
