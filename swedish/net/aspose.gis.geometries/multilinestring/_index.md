...
description: Aspose.Gis.Geometries.MultiLineString klass. AMultiLineString är en endimensionellGeometryCollection vars element ärLineString s.
type: docs
weight: 1150
...
A`MultiLineString` är en endimensionell[`GeometryCollection`](../geometrycollection/) vars element är[`LineString`](../linestring/) s.
...
| namn | Beskrivning |
| --- | --- |
| [MultiLineString](multilinestring/)() | Initierar en ny instans av`MultiLineString` class. |
