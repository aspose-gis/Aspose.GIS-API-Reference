...
description: Aspose.Gis.Geometries.Point klass. APoint representerar en enda plats i koordinatutrymmet.
type: docs
weight: 1190
...
A`Point` representerar en enda plats i koordinatutrymmet.
...
| namn | Beskrivning |
| --- | --- |
| [Point](point/#constructor)() | Initierar en ny instans av`Point` class. |
| [Point](point/#constructor_1)(IPoint) | Initierar en ny instans av`Point` class. |
| [Point](point/#constructor_2)(double, double) | Initierar en ny instans av`Point` class. |
| [Point](point/#constructor_3)(double, double, double) | Initierar en ny instans av`Point` class. |
| [Point](point/#constructor_4)(double, double, double, double) | Initierar en ny instans av`Point` class. |
