...
description: AGeometryCollection./geometrycollection är enGeometry./geometry som är en samling av en eller flera geometrier.
type: docs
weight: 830
...
A[`GeometryCollection`](../geometrycollection) är en[`Geometry`](../geometry) som är en samling av en eller flera geometrier.
...
| namn | Beskrivning |
| --- | --- |
| [GeometryCollection](geometrycollection)() | Initierar en ny instans av[`GeometryCollection`](../geometrycollection) class. |
