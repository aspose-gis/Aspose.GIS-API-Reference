...
description: AMultiSurface./multisurface är en endimensionellGeometryCollection./geometrycollection vars element ärISurface./isurface s.
type: docs
weight: 1080
url: /sv/net/aspose.gis.geometries/multisurface/
---
## MultiSurface class

A[`MultiSurface`](../multisurface) är en endimensionell[`GeometryCollection`](../geometrycollection) vars element är[`ISurface`](../isurface) s.
...
| namn | Beskrivning |
| --- | --- |
| [MultiSurface](multisurface)() | Initierar en ny instans av[`MultiSurface`](../multisurface) class. |
...
| [Dimension](../../aspose.gis.geometries/multisurface/dimension) { get; } | Får den topologiska dimensionen av detta[`Geometry`](../geometry) . |
| override [GeometryType](../../aspose.gis.geometries/multisurface/geometrytype) { get; } | Hämtar typen av geometri. |
...
| override [Clone](../../aspose.gis.geometries/multisurface/clone)() | Klonar den här instansen. |
...
| [ToEditable](../../aspose.gis.geometries/multisurface/toeditable#toeditable_2)() | Får en redigerbar kopia av denna geometri. (3 methods) |
| [ToEditable&lt;T&gt;](../../aspose.gis.geometries/geometry/toeditable)() | Får en redigerbar kopia av denna geometri. |
| [ToLinearGeometry](../../aspose.gis.geometries/multisurface/tolineargeometry#tolineargeometry_4)() | Får ungefärlig eller likvärdig icke-kurv version av denna geometri med standard`tolerans` . (3 methods) |
| [ToLinearGeometry](../../aspose.gis.geometries/multisurface/tolineargeometry#tolineargeometry_5)(double) | Får ungefärlig eller likvärdig icke-kurv version av denna geometri med den angivna`tolerans` . (3 methods) |
