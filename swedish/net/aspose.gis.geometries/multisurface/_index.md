...
description: Aspose.Gis.Geometries.MultiSurface klass. AMultiSurface är en endimensionellGeometryCollection vars element ärISurface s.
type: docs
weight: 1180
...
A`MultiSurface` är en endimensionell[`GeometryCollection`](../geometrycollection/) vars element är[`ISurface`](../isurface/) s.
...
| namn | Beskrivning |
| --- | --- |
| [MultiSurface](multisurface/)() | Initierar en ny instans av`MultiSurface` class. |
