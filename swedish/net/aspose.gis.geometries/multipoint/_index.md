...
description: Aspose.Gis.Geometries.MultiPoint klass. AMultiPoint är en endimensionellGeometryCollection vars element ärPoint s.
type: docs
weight: 1160
...
A`MultiPoint` är en endimensionell[`GeometryCollection`](../geometrycollection/) vars element är[`Point`](../point/) s.
...
| namn | Beskrivning |
| --- | --- |
| [MultiPoint](multipoint/)() | Initierar en ny instans av`MultiPoint` class. |
