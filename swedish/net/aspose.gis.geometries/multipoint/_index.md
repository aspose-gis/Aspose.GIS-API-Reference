...
description: AMultiPoint./multipoint är en endimensionellGeometryCollection./geometrycollection vars element ärPoint./point s.
type: docs
weight: 1060
url: /sv/net/aspose.gis.geometries/multipoint/
---
## MultiPoint class

A[`MultiPoint`](../multipoint) är en endimensionell[`GeometryCollection`](../geometrycollection) vars element är[`Point`](../point) s.
...
| namn | Beskrivning |
| --- | --- |
| [MultiPoint](multipoint)() | Initierar en ny instans av[`MultiPoint`](../multipoint) class. |
...
| [Dimension](../../aspose.gis.geometries/multipoint/dimension) { get; } | Får den topologiska dimensionen av detta[`Geometry`](../geometry) . |
| override [GeometryType](../../aspose.gis.geometries/multipoint/geometrytype) { get; } | Hämtar typen av geometri. |
...
| override [Clone](../../aspose.gis.geometries/multipoint/clone)() | Klonar den här instansen. |
...
| [ToEditable](../../aspose.gis.geometries/multipoint/toeditable#toeditable_2)() | Får en redigerbar kopia av denna geometri. (3 methods) |
| [ToEditable&lt;T&gt;](../../aspose.gis.geometries/geometry/toeditable)() | Får en redigerbar kopia av denna geometri. |
| [ToLinearGeometry](../../aspose.gis.geometries/geometrycollection/tolineargeometry)() | Får ungefärlig eller likvärdig icke-kurv version av denna geometri med standard`tolerans` . (2 methods) |
| [ToLinearGeometry](../../aspose.gis.geometries/geometrycollection/tolineargeometry)(double) | Får ungefärlig eller likvärdig icke-kurv version av denna geometri med den angivna`tolerans` . (2 methods) |
