...
description: Aspose.Gis.SpatialReferencing.VerticalSpatialReferenceSystem klass. Vertical SRS är en endimensionell SRS som beskriver höjdkoordinater.
type: docs
weight: 2310
url: /sv/net/aspose.gis.spatialreferencing/verticalspatialreferencesystem/
---
## VerticalSpatialReferenceSystem class

Vertical SRS är en endimensionell SRS som beskriver höjdkoordinater.
...
| override [AsVertical](../../aspose.gis.spatialreferencing/verticalspatialreferencesystem/asvertical/) { get; } | Returnerar denna SRS. |
| override [DimensionsCount](../../aspose.gis.spatialreferencing/verticalspatialreferencesystem/dimensionscount/) { get; } | Ger 1, eftersom vertikal SRS alltid är endimensionell. |
...
| override [GeographicDatum](../../aspose.gis.spatialreferencing/verticalspatialreferencesystem/geographicdatum/) { get; } | KastarInvalidOperationException , eftersom Vertical SRS inte har geografiskt datum. |
| override [HasGeographicDatum](../../aspose.gis.spatialreferencing/verticalspatialreferencesystem/hasgeographicdatum/) { get; } | Returnerar`false` , eftersom Vertical SRS inte har geografiskt datum. |
| override [HasPrimeMeridian](../../aspose.gis.spatialreferencing/verticalspatialreferencesystem/hasprimemeridian/) { get; } | Returnerar`false` , eftersom Vertical SRS inte har nollmeridian. |
...
| override [PrimeMeridian](../../aspose.gis.spatialreferencing/verticalspatialreferencesystem/primemeridian/) { get; } | KastarInvalidOperationException , eftersom Vertical SRS inte har nollmeridian. |
| override [Type](../../aspose.gis.spatialreferencing/verticalspatialreferencesystem/type/) { get; } | ReturVertical . |
| [VerticalDatum](../../aspose.gis.spatialreferencing/verticalspatialreferencesystem/verticaldatum/) { get; } | Datum som används i denna SRS. |
| [VerticalUnit](../../aspose.gis.spatialreferencing/verticalspatialreferencesystem/verticalunit/) { get; } | Enhet som används i denna SRS. |
...
| override [GetAxis](../../aspose.gis.spatialreferencing/verticalspatialreferencesystem/getaxis/)(int) | Hämta[`Axis`](../axis/) som beskriver dimension. |
| override [GetUnit](../../aspose.gis.spatialreferencing/verticalspatialreferencesystem/getunit/)(int) | Hämta[`Unit`](../unit/)av dimension. |
| override [IsEquivalent](../../aspose.gis.spatialreferencing/verticalspatialreferencesystem/isequivalent/)(SpatialReferenceSystem) | Detekterar om denna SRS är likvärdig med annan SRS. . |
...
| override [Validate](../../aspose.gis.spatialreferencing/verticalspatialreferencesystem/validate/)(out string) | Bestäm om denna SRS är giltig. Ser[`Validate`](../spatialreferencesystem/validate/) för giltighetsbeskrivning. |
