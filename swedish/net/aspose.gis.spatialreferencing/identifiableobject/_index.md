...
description: Representerar ett objekt som kan ha EPSGkod och namn.
type: docs
weight: 2050
url: /sv/net/aspose.gis.spatialreferencing/identifiableobject/
---
## IdentifiableObject class

Representerar ett objekt som kan ha EPSG-kod och namn.
