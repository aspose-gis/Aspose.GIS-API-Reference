...
description: Parametrar för att skapa projicerad SRS. Vissa parametrar har standardvärden. Vissa parametrar har rimliga standardvärden så du behöver inte bara tilldela dem. Om du tilldelarnull för dessa parametrar kommer ett standardvärde att användas. ProjectionMethodName./projectedspatialreferencesystemparameters/projectionmethodname ochBase./projectedspatialreferencesystemparameters/base har inga standardvärden  du måste tilldela några ickenull värde till dessa egenskaper.
type: docs
weight: 2130
