...
description: Aspose.Gis.Formats.TopoJson.TopoJsonOptions klass. Drivrutinsspecifika alternativ för TopoJSONformat.
type: docs
weight: 710
url: /sv/net/aspose.gis.formats.topojson/topojsonoptions/
---
...
| namn | Beskrivning |
| --- | --- |
| [TopoJsonOptions](topojsonoptions/)() | Skapa ny instans. |
...
| [DefaultObjectName](../../aspose.gis.formats.topojson/topojsonoptions/defaultobjectname/) { get; set; } | Namn på objektet där funktioner placeras som standard. |
...
| [NestedPropertiesSeparator](../../aspose.gis.formats.topojson/topojsonoptions/nestedpropertiesseparator/) { get; set; } | Hämtar eller ställer in en sträng som används för att separera komponenter av kapslade attribut. Standard är "_". |
| [ObjectNameAttribute](../../aspose.gis.formats.topojson/topojsonoptions/objectnameattribute/) { get; set; } | Namn på attributet, som återspeglar namnet på objektet som innehåller en egenskap. |
| [QuantizationNumber](../../aspose.gis.formats.topojson/topojsonoptions/quantizationnumber/) { get; set; } | Anger kvantiseringsnummer som ska användas för att kvantisera koordinater och delta-koda bågar i utdata TopoJSON. |
...
| [Transform](../../aspose.gis.formats.topojson/topojsonoptions/transform/) { get; set; } | Anger transformobjekt som ska användas för att kvantisera koordinater och delta-koda bågar i utdata TopoJSON. |
