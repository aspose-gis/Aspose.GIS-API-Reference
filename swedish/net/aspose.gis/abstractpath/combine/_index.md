...
description: Kombinerar dettaAbstractPathaspose.gis/abstractpath med specificerade sökvägskomponenter.
type: docs
weight: 50
...
Kombinerar detta[`AbstractPath`](../../abstractpath) med specificerade sökvägskomponenter.
...
| --- | --- | --- |
| location | String | En sökvägskomponent att lägga till detta[`AbstractPath`](../../abstractpath). |

### Returvärde

En ny[`AbstractPath`](../../abstractpath) pekar på en[`Location`](../location) det är en kombination av platser av detta[`AbstractPath`](../../abstractpath)and argumentet.
