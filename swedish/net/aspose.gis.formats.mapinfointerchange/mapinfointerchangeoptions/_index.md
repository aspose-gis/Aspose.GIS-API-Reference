...
description: Aspose.Gis.Formats.MapInfoInterchange.MapInfoInterchangeOptions klass. Drivrutinsspecifika alternativ för MapInfo Interchangeformat.
type: docs
weight: 590
url: /sv/net/aspose.gis.formats.mapinfointerchange/mapinfointerchangeoptions/
---
## MapInfoInterchangeOptions class

Drivrutinsspecifika alternativ för MapInfo Interchange-format.
...
| namn | Beskrivning |
| --- | --- |
| [MapInfoInterchangeOptions](mapinfointerchangeoptions/)() | Skapa ny instans. |
...
| [TextStringAttribute](../../aspose.gis.formats.mapinfointerchange/mapinfointerchangeoptions/textstringattribute/) { get; set; } | Anger namnet på attributet som representerar texten i det grafiska objektet "Text". |
