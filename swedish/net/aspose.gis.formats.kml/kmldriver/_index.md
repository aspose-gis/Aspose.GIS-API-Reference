...
type: docs
weight: 330
url: /sv/net/aspose.gis.formats.kml/kmldriver/
---
## KmlDriver class
...
| namn | Beskrivning |
| --- | --- |
| override [CanCreateDatasets](../../aspose.gis.formats.kml/kmldriver/cancreatedatasets) { get; } | Får ett värde som indikerar om den här drivrutinen kan skapa datauppsättningar. |
| override [CanCreateLayers](../../aspose.gis.formats.kml/kmldriver/cancreatelayers) { get; } | Får ett värde som indikerar om den här drivrutinen kan skapa vektorlager. |
...
| override [CanOpenLayers](../../aspose.gis.formats.kml/kmldriver/canopenlayers) { get; } | Får ett värde som indikerar om den här drivrutinen kan öppna vektorlager. |
...
| [CreateLayer](../../aspose.gis.formats.kml/kmldriver/createlayer#createlayer_3)(AbstractPath, KmlOptions) | Skapar ett lager och öppnar det för att lägga till nya funktioner. |
...
| [CreateLayer](../../aspose.gis.formats.kml/kmldriver/createlayer#createlayer_9)(string, KmlOptions) | Skapar ett lager och öppnar det för att lägga till nya funktioner. |
...
| override [CreateLayer](../../aspose.gis.formats.kml/kmldriver/createlayer#createlayer_2)(AbstractPath, DriverOptions, SpatialReferenceSystem) | Skapar ett lager och öppnar det för att lägga till nya funktioner. |
| [CreateLayer](../../aspose.gis.formats.kml/kmldriver/createlayer#createlayer_4)(AbstractPath, KmlOptions, SpatialReferenceSystem) | Skapar ett lager och öppnar det för att lägga till nya funktioner. |
...
| override [OpenLayer](../../aspose.gis.formats.kml/kmldriver/openlayer#openlayer_1)(AbstractPath, DriverOptions) | Öppnar ett lager för läsning. |
| [OpenLayer](../../aspose.gis.formats.kml/kmldriver/openlayer#openlayer_2)(AbstractPath, KmlOptions) | Öppnar ett lager för läsning. |
| [OpenLayer](../../aspose.gis/filedriver/openlayer)(string, DriverOptions) | Öppnar lagret för läsning. |
| [OpenLayer](../../aspose.gis.formats.kml/kmldriver/openlayer#openlayer_5)(string, KmlOptions) | Öppnar ett lager för läsning. |
| override [SupportsSpatialReferenceSystem](../../aspose.gis.formats.kml/kmldriver/supportsspatialreferencesystem)(SpatialReferenceSystem) | Bestämmer om specificerat rumsligt referenssystem stöds av drivrutinen. |
