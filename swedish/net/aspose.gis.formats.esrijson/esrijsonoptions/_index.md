...
description: Aspose.Gis.Formats.EsriJson.EsriJsonOptions klass. Drivrutinsspecifika alternativ för EsriJsonformat.
type: docs
weight: 240
url: /sv/net/aspose.gis.formats.esrijson/esrijsonoptions/
---
## EsriJsonOptions class

Drivrutinsspecifika alternativ för EsriJson-format.
...
| namn | Beskrivning |
| --- | --- |
| [EsriJsonOptions](esrijsonoptions/)() | Skapa ny instans. |
...
| [NestedPropertiesSeparator](../../aspose.gis.formats.esrijson/esrijsonoptions/nestedpropertiesseparator/) { get; set; } | Hämtar eller ställer in en sträng som används för att separera komponenter av kapslade attribut. Standard är "_". |
