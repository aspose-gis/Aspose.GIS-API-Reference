---
title: "GeoJsonOptions klass"
type: docs
weight: 20
url: /sv/python-net/aspose.gis.formats.geojson/geojsonoptions/
---
...
| **Name** | **Beskrivning** |
| :- | :- |
| [GeoJsonOptions()](#GeoJsonOptions__1) | Skapa ny instans. |
## **Properties**
...
| beskrivning | string | läs/skriv | Beskrivning på feature collection-nivå (för lager skapande) |
...
| namn | string | läs/skriv | Namn på feature collection-nivå (för lager skapande) |
...
| read_bounding_boxes | bool | r/w | Bestämmer om Bounding Boxes ('bbox') ska läsas som attribut med namn 'bbox_0', 'bbox_1' osv.<br/>            Standardvärdet är <see langword="false" />.<br/>            Strängen [GeoJsonOptions.nested_properties_separator](/psd/python-net/aspose.gis.formats.geojson/geojsonoptions/) används i namn som bbox_0, bbox_1,.. |
...
| write_bounding_boxes | bool | läs/skriv | Bestämmer om GeoJSON-objekt ska inkludera information om koordinatområdet för sina Geometries.<br/>            Om den är satt till <see langword="true" />, genereras ett medlem "bbox" för varje geometri (inte null) när den läggs till lagret.<br/>            Standardvärdet är <see langword="false" />. |
