---
title: "ShapefileOptions-klass"
type: docs
weight: 20
url: /sv/python-net/aspose.gis.formats.shapefile/shapefileoptions/
---
...
| **Name** | **Beskrivning** |
| :- | :- |
| [ShapefileOptions()](#ShapefileOptions__1) | Skapa ny instans. |
## **Properties**
...
| is_ignore_wrong_data | bool | läs/skriv | Bestämmer om vi ska kasta ett undantag vid parsning av felaktiga data eller sätta standardvärden för dem |
