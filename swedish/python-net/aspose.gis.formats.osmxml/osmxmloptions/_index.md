---
title: "OsmXmlOptions-klass"
type: docs
weight: 20
url: /sv/python-net/aspose.gis.formats.osmxml/osmxmloptions/
---
...
| **Name** | **Beskrivning** |
| :- | :- |
| [OsmXmlOptions()](#OsmXmlOptions__1) | Skapa ny instans. |
## **Properties**
...
| report_all_nodes | bool | läs/skriv | Rapportera alla noder som funktioner, även om de inte har några betydande taggar. |
| report_all_ways | bool | läs/skriv | Rapportera alla vägar som funktioner, även om de inte har några betydande taggar eller några noder. |
| report_common_attributes | bool | läs/skriv | Rapportera vanliga OSM-attribut: visible, version, changeset, timestamp, user och uid.<br/>            Vanliga attribut kommer att rapporteras som funktionsattribut med prefixet "osm_", t.ex. osm_user, osm_timestamp, osv. |
...
| write_common_attributes | bool | läs/skriv | Skriv vanliga OSM-attribut: visible, version, changeset, timestamp, user och uid. |
