---
title: "KmlLatLonAltBox klass"
type: docs
weight: 30
url: /sv/python-net/aspose.gis.formats.kml.specificfields/kmllatlonaltbox/
---
...
| öst | double | läs/skriv | Öst om 'LatLonBox'-noden. |
| max_altitude | Nullable<double> | läs/skriv | MaxAltitude för 'LatLonBox'-noden. |
| min_altitude | Nullable<double> | läs/skriv | MinAltitude för 'LatLonBox'-noden. |
...
| norr | double | läs/skriv | Norr om 'LatLonBox'-noden. |
| prefix | string | r | Hämtar prefixet. |
| rotation | Nullable<double> | läs/skriv | Rotation för 'LatLonBox'-noden. |
| söder | double | läs/skriv | Söder om 'LatLonBox'-noden. |
| väst | double | läs/skriv | Väst om 'LatLonBox'-noden. |
## **Methods**
| **Name** | **Beskrivning** |
| :- | :- |
