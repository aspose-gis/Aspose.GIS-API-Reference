---
title: "KmlLodSettings klass"
type: docs
weight: 50
url: /sv/python-net/aspose.gis.formats.kml.specificfields/kmllodsettings/
---
...
| max_fade_extent | int | läs/skriv | MaxFadeExtent för 'Lod'-noden. |
| max_lod_pixels | int | läs/skriv | MaxLodPixels för 'Lod'-noden. |
| min_fade_extent | int | läs/skriv | MinFadeExtent för 'Lod'-noden. |
| min_lod_pixels | int | läs/skriv | MinLodPixels för 'Lod'-noden. |
