---
title: "KmlRegionInfo klass"
type: docs
weight: 70
url: /sv/python-net/aspose.gis.formats.kml.specificfields/kmlregioninfo/
---
...
| id | string | läs/skriv | Id för 'Region'-noden. |
| lat_lon_alt_box | [KmlLatLonAltBox](/psd/python-net/aspose.gis.formats.kml.specificfields/kmllatlonaltbox) | r/w | Specificerar objekt från Kml 'LatLonAltBox'-noden. |
| lod | [KmlLodSettings](/psd/python-net/aspose.gis.formats.kml.specificfields/kmllodsettings) | r/w | Specificerar objekt från Kml 'Lod'-noden. |
