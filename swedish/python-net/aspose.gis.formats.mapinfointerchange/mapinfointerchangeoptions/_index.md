---
title: "MapInfoInterchangeOptions klass"
type: docs
weight: 20
url: /sv/python-net/aspose.gis.formats.mapinfointerchange/mapinfointerchangeoptions/
---
...
| **Name** | **Beskrivning** |
| :- | :- |
| [MapInfoInterchangeOptions()](#MapInfoInterchangeOptions__1) | Skapa ny instans. |
## **Properties**
| **Name** | **Type** | **Access** | **Beskrivning** |
| :- | :- | :- | :- |
| teckenuppsättning | string | läs/skriv | Bestämmer teckenuppsättning, som standard är Neutral |
...
| avgränsare | string | läs/skriv | Bestämmer avgränsare för attribut i mid-fil, som standard är tabbtecken |
