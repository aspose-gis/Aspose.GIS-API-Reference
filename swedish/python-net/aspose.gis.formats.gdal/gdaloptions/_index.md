---
title: "GdalOptions-klass"
type: docs
weight: 20
url: /sv/python-net/aspose.gis.formats.gdal/gdaloptions/
---
...
| **Name** | **Beskrivning** |
| :- | :- |
| [GdalOptions(temp_directory)](#GdalOptions_temp_directory_1) | Skapa en ny instans. |
## **Properties**
...
| file_name | string | läs/skriv | Namn på applikationen att starta |
...
| path_to_temp_file | string | r | Sökväg till temporära filer. |
...
| :- | :- | :- |
| temp_directory | string | Sökväg till temporära filer. Användarens temporära mapp som standard. |
