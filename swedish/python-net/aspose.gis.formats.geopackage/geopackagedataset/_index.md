---
title: "GeoPackageDataset-klass"
type: docs
weight: 10
url: /sv/python-net/aspose.gis.formats.geopackage/geopackagedataset/
---
...
| **Name** | **Beskrivning** |
| :- | :- |
| [GeoPackageDataset(path, options)](#GeoPackageDataset_path_options_1) | Skapar ny instans. |
## **Properties**
...
| driver | [Driver](/psd/python-net/aspose.gis/driver) | r | Hämtar [GeoPackageDataset.driver](/psd/python-net/aspose.gis.formats.geopackage/geopackagedataset/) som skapade detta dataset. |
| layers_count | int | r | Hämtar antalet lager i detta dataset. |
| tile_layers_count | int | r | Hämtar antalet tile-lager i detta dataset. |
## **Methods**
| **Name** | **Beskrivning** |
| :- | :- |
...
| [edit_layer(name, options, spatial_reference_system)](#edit_layer_name_options_spatial_reference_system_10) | Denna metod är fortfarande under utveckling. |
| [edit_layer_at(index, options, spatial_reference_system)](#edit_layer_at_index_options_spatial_reference_system_11) | Denna metod är fortfarande under utveckling. |
| [get_layer_name(index)](#get_layer_name_index_12) | Hämtar namnet på lagret vid angivet index. |
| [get_tile_layer_name(index)](#get_tile_layer_name_index_13) | Hämtar namnet på tile-lagret på angivet index. |
| [has_layer_with_name(name)](#has_layer_with_name_name_14) | Kontrollera om det aktuella datasetet har ett lager med specifikt namn |
| [open(path, driver)](#open_path_driver_15) | Öppnar datasetet. |
| [open(path, driver)](#open_path_driver_16) | Öppnar datasetet. |
| [open(path, driver, options)](#open_path_driver_options_17) | Öppnar datasetet. |
| [open(path, driver, options)](#open_path_driver_options_18) | Öppnar datasetet. |
| [open(path, options)](#open_path_options_19) | Fabrikmetod för att skapa ett dataset från en gpkg-fil. |
| [open_layer(name, options)](#open_layer_name_options_20) | Öppnar lagret med angivet namn för läsning. |
| [open_layer_at(index, options)](#open_layer_at_index_options_21) | Öppnar lagret vid angivet index för läsning. |
| [open_layer_at(index, options)](#open_layer_at_index_options_22) | Öppnar lagret vid angivet index för läsning. |
| [open_tile_layer(name, options)](#open_tile_layer_name_options_23) | Öppnar tile-lagret med angivet namn för läsning. |
| [open_tile_layer_at(index, options)](#open_tile_layer_at_index_options_24) | Öppnar tile-lagret på angivet index för läsning. |
| [remove_layer(name)](#remove_layer_name_25) | Tar bort vektorlager med angivet namn. |
| [remove_layer_at(index)](#remove_layer_at_index_26) | Tar bort vektorlager vid angivet index. |
| [rename_layer(current_name, new_name)](#rename_layer_current_name_new_name_27) | Byt namn på lager i datasetet |
...
| :- | :- | :- |
| path | [AbstractPath](/psd/python-net/aspose.gis/abstractpath) | Sökväg till gpkg-filen. |
| options | [GeoPackageOptions](/psd/python-net/aspose.gis.formats.geopackage/geopackageoptions) | Inställningar angående särdragen för att läsa gpkg-filen. |
...
Denna metod är fortfarande under utveckling.
...
Hämtar namnet på tile-lagret på angivet index.
...
Fabrikmetod för att skapa ett dataset från en gpkg-fil.
...
| :- | :- | :- |
| index | int | Index för lagret att öppna. |
| options | [GeoPackageOptions](/psd/python-net/aspose.gis.formats.geopackage/geopackageoptions) | Öppningsalternativ. |
...
Öppnar tile-lagret med angivet namn för läsning.
...
| Typ | Beskrivning |
| :- | :- |
| [XyzTiles](/psd/python-net/aspose.gis.formats.xyztile/xyztiles/) | Tile-lagret öppnades för läsning. |
...
Öppnar tile-lagret på angivet index för läsning.
