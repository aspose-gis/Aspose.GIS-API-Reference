---
title: "MultiStreamPath-klass"
type: docs
weight: 2760
url: /sv/python-net/aspose.gis/multistreampath/
---
...
| **Name** | **Beskrivning** |
| :- | :- |
| [MultiStreamPath(entry_file_name, file_names, streams)](#MultiStreamPath_entry_file_name_file_names_streams_1) | Initierar en ny instans av klassen [MultiStreamPath](/psd/python-net/aspose.gis/multistreampath/). |
## **Properties**
| **Name** | **Type** | **Access** | **Beskrivning** |
| :- | :- | :- | :- |
| plats | string | r | Hämtar en strängrepresentation av platsen för detta <c>AbstractPath</c>. |
| separator | char | r | Hämtar ett avgränsartecken som används för att separera katalognivåer i strängen [MultiStreamPath.location](/psd/python-net/aspose.gis/multistreampath/). |
## **Methods**
| **Name** | **Beskrivning** |
| :- | :- |
...
| [open(access)](#open_access_9) | Abstraherar en uppsättning öppna strömmande multi‑filformat som en sökväg för åtkomst till data. |
...
Initierar en ny instans av klassen [MultiStreamPath](/psd/python-net/aspose.gis/multistreampath/).

**Parameters:**

| Parameter | Typ | Beskrivning |
| :- | :- | :- |
| entry_file_name | string | Namnet på inmatningsfilen. |
| file_names | string | Filnamnen. |
| streams | _io.BufferedRandom[] | Strömmarna. |
...
Abstraherar en uppsättning öppna strömmande multi‑filformat som en sökväg för åtkomst till data.
...
| Typ | Beskrivning |
| :- | :- |
| _io.BufferedRandom | Detta kan antingen vara en   eller den ström som ursprungligen skickades av klienten. |
