---
title: "CircularString-klass"
type: docs
weight: 10
url: /sv/python-net/aspose.gis.geometries/circularstring/
---
...
| **Name** | **Beskrivning** |
| :- | :- |
| [CircularString()](#CircularString__1) | Initierar en ny instans av klassen [CircularString](/psd/python-net/aspose.gis.geometries/circularstring/) |
| [CircularString(collection)](#CircularString_collection_2) | Initierar en ny instans av klassen [CircularString](/psd/python-net/aspose.gis.geometries/circularstring/) |
| [CircularString(other)](#CircularString_other_3) | Initierar en ny instans av klassen [CircularString](/psd/python-net/aspose.gis.geometries/circularstring/) |
## **Properties**
...
| **Name** | **Beskrivning** |
| :- | :- |
| [add_point(point)](#add_point_point_1) | Lägger till en punkt i slutet av den cirkulära strängen. |
| [add_point(x, y)](#add_point_x_y_2) | Lägger till en punkt i slutet av den cirkulära strängen. |
| [add_point(x, y, z)](#add_point_x_y_z_3) | Lägger till en punkt i slutet av den cirkulära strängen. |
| [add_point(x, y, z, m)](#add_point_x_y_z_m_4) | Lägger till en punkt i slutet av den cirkulära strängen. |
...
| [overlaps(other)](#overlaps_other_33) | Bestämmer om denna geometri överlappar med en specificerad geometri. |
| [relate(other, intersection_pattern_matrix)](#relate_other_intersection_pattern_matrix_34) | Bestämmer om DE-9IM-skärningsmatrisen för denna geometri och en specificerad geometri matchar det angivna mönstret. |
| [replace_polygons_by_lines()](#replace_polygons_by_lines__35) | Hämtar polygoner som representeras som linjer i denna geometri. |
| reverse() | Vänder ordningen på punkterna i denna [CircularString](/psd/python-net/aspose.gis.geometries/circularstring/). |
...
Initierar en ny instans av klassen [CircularString](/psd/python-net/aspose.gis.geometries/circularstring/)
...
| Parameter | Typ | Beskrivning |
| :- | :- | :- |
| other | [ICircularString](/psd/python-net/aspose.gis.geometries/icircularstring) | Den andra strängen att kopiera data från. |
...
Lägger till en punkt i slutet av den cirkulära strängen.
...
| Typ | Beskrivning |
| :- | :- |
| [CircularString](/psd/python-net/aspose.gis.geometries/circularstring) | En redigerbar kopia av denna geometri. |
