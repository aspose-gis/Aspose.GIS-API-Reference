...
type: docs
weight: 90
url: /sv/python-net/aspose.gis.geometries/icurve/
---
...
| [overlaps(other)](#overlaps_other_25) | Bestämmer om denna geometri överlappar med en specificerad geometri. |
| [relate(other, intersection_pattern_matrix)](#relate_other_intersection_pattern_matrix_26) | Bestämmer om DE-9IM-skärningsmatrisen för denna geometri och en specificerad geometri matchar det angivna mönstret. |
| [replace_polygons_by_lines()](#replace_polygons_by_lines__27) | Hämtar polygoner som representeras som linjer i denna geometri. |
| [spatially_contains(other)](#spatially_contains_other_28) | Bestämmer om denna geometri rumsligt innehåller en specificerad geometri. |
| [spatially_equals(other)](#spatially_equals_other_29) | Bestämmer om denna geometri är rumsligt lika med en specificerad geometri. |
| [sym_difference(other)](#sym_difference_other_30) | Skapar en symmetrisk differens mellan denna geometri och en specificerad geometri. |
| [to_editable()](#to_editable__31) | Hämtar en redigerbar kopia av denna geometri. |
| [to_linear_geometry()](#to_linear_geometry__32) | Hämtar en ungefärlig eller motsvarande icke-kurv version av denna geometri med standard <c>tolerance</c>. |
| [to_linear_geometry(tolerance)](#to_linear_geometry_tolerance_33) | Hämtar en ungefärlig eller motsvarande icke-kurv version av denna geometri med den angivna <c>tolerance</c>. |
| [touches(other)](#touches_other_34) | Bestämmer om denna geometri och en specificerad geometri rör varandra. |
| [union(other)](#union_other_35) | Förenar denna geometri och en specificerad geometri. |
| [union(other)](#union_other_36) | Förenar denna geometri och en specificerad geometri. |
| [within(extent)](#within_extent_37) | Bestämmer om denna geometri ligger inom ett specificerat omfång. |
| [within(other)](#within_other_38) | Bestämmer om denna geometri ligger inom en specificerad geometri. |
...
| Typ | Beskrivning |
| :- | :- |
| [Curve](/psd/python-net/aspose.gis.geometries/curve) | En redigerbar kopia av denna geometri. |
