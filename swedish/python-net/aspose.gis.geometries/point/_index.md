...
type: docs
weight: 300
url: /sv/python-net/aspose.gis.geometries/point/
---
...
| **Name** | **Beskrivning** |
| :- | :- |
| [Point()](#Point__1) | Initierar en ny instans av klassen [Point](/psd/python-net/aspose.gis.geometries/point/). |
| [Point(other)](#Point_other_2) | Initierar en ny instans av klassen [Point](/psd/python-net/aspose.gis.geometries/point/). |
| [Point(x, y)](#Point_x_y_3) | Initierar en ny instans av klassen [Point](/psd/python-net/aspose.gis.geometries/point/). |
| [Point(x, y, z)](#Point_x_y_z_4) | Initierar en ny instans av klassen [Point](/psd/python-net/aspose.gis.geometries/point/). |
| [Point(x, y, z, m)](#Point_x_y_z_m_5) | Initierar en ny instans av klassen [Point](/psd/python-net/aspose.gis.geometries/point/). |
## **Properties**
...
| has_m | bool | läs/skriv | Hämtar ett värde som indikerar om denna instans har en M-koordinat. |
...
| m | double | läs/skriv | Hämtar eller anger ett värde för m-koordinaten. |
...
| x | double | läs/skriv | Hämtar eller anger ett värde för x-koordinaten. |
| y | double | läs/skriv | Hämtar eller anger ett värde för y-koordinaten. |
| z | double | läs/skriv | Hämtar eller anger ett värde för z-koordinaten. |
## **Methods**
| **Name** | **Beskrivning** |
| :- | :- |
...
Initierar en ny instans av klassen [Point](/psd/python-net/aspose.gis.geometries/point/).
...
| :- | :- | :- |
| other | [IPoint](/psd/python-net/aspose.gis.geometries/ipoint) | Den andra [IPoint](/psd/python-net/aspose.gis.geometries/ipoint/) att kopiera data från. |
