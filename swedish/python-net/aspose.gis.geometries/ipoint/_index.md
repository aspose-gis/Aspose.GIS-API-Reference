...
type: docs
weight: 200
url: /sv/python-net/aspose.gis.geometries/ipoint/
---
...
| m | double | r | Hämtar m-koordinaten. |
...
| x | double | r | Hämtar x-koordinaten. |
| y | double | r | Hämtar y-koordinaten. |
| z | double | r | Hämtar z-koordinaten. |
## **Methods**
| **Name** | **Beskrivning** |
| :- | :- |
...
| Typ | Beskrivning |
| :- | :- |
| [Point](/psd/python-net/aspose.gis.geometries/point) | En redigerbar kopia av denna geometri. |
