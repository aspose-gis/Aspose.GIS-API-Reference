---
title: "IPolygon-klass"
type: docs
weight: 210
url: /sv/python-net/aspose.gis.geometries/ipolygon/
---
...
| exterior_ring | [ILinearRing](/psd/python-net/aspose.gis.geometries/ilinearring) | r | Hämtar den yttre ringen. |
...
| [get_interior_ring(index)](#get_interior_ring_index_21) | Hämtar den inre ringen efter dess index. |
| [get_length()](#get_length__22) | Beräknar längden på denna geometri. |
| [get_point_on_surface()](#get_point_on_surface__23) | Hittar en punkt som garanterat ligger på denna yta. |
| [intersection(other)](#intersection_other_24) | Bygger en skärning mellan denna geometri och en specificerad geometri. |
| [intersects(extent)](#intersects_extent_25) | Bestämmer om denna geometri skär ett specificerat område. |
| [intersects(other)](#intersects_other_26) | Bestämmer om denna geometri och en specificerad geometri skär varandra. |
| [overlaps(other)](#overlaps_other_27) | Bestämmer om denna geometri överlappar med en specificerad geometri. |
| [relate(other, intersection_pattern_matrix)](#relate_other_intersection_pattern_matrix_28) | Bestämmer om DE-9IM-skärningsmatrisen för denna geometri och en specificerad geometri matchar det angivna mönstret. |
| [replace_polygons_by_lines()](#replace_polygons_by_lines__29) | Hämtar polygoner som representeras som linjer i denna geometri. |
| [spatially_contains(other)](#spatially_contains_other_30) | Bestämmer om denna geometri rumsligt innehåller en specificerad geometri. |
| [spatially_equals(other)](#spatially_equals_other_31) | Bestämmer om denna geometri är rumsligt lika med en specificerad geometri. |
| [sym_difference(other)](#sym_difference_other_32) | Skapar en symmetrisk differens mellan denna geometri och en specificerad geometri. |
| [to_editable()](#to_editable__33) | Hämtar en redigerbar kopia av denna geometri. |
| [to_linear_geometry()](#to_linear_geometry__34) | Hämtar en ungefärlig eller motsvarande icke-kurv version av denna geometri med standard <c>tolerance</c>. |
| [to_linear_geometry(tolerance)](#to_linear_geometry_tolerance_35) | Hämtar en ungefärlig eller motsvarande icke-kurv version av denna geometri med den angivna <c>tolerance</c>. |
| [touches(other)](#touches_other_36) | Bestämmer om denna geometri och en specificerad geometri rör varandra. |
| [union(other)](#union_other_37) | Förenar denna geometri och en specificerad geometri. |
| [union(other)](#union_other_38) | Förenar denna geometri och en specificerad geometri. |
| [within(extent)](#within_extent_39) | Bestämmer om denna geometri ligger inom ett specificerat omfång. |
| [within(other)](#within_other_40) | Bestämmer om denna geometri ligger inom en specificerad geometri. |
