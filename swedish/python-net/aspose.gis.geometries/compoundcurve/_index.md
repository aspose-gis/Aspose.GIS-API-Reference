---
title: "CompoundCurve klass"
type: docs
weight: 20
url: /sv/python-net/aspose.gis.geometries/compoundcurve/
---
...
| **Name** | **Beskrivning** |
| :- | :- |
| [CompoundCurve()](#CompoundCurve__1) | Initierar en ny instans av klassen [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/). |
| [CompoundCurve(curves)](#CompoundCurve_curves_2) | Initierar en ny instans av klassen [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/). |
| [CompoundCurve(other)](#CompoundCurve_other_3) | Initierar en ny instans av klassen [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/). |
## **Properties**
...
| count | int | r | Hämtar antalet kurvor i [ICompoundCurve](/psd/python-net/aspose.gis.geometries/icompoundcurve/). |
...
| **Name** | **Beskrivning** |
| :- | :- |
| [add_curve(curve)](#add_curve_curve_1) | Lägger till en kurva i slutet av denna [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/). |
| [as_binary()](#as_binary__2) | Översätter denna geometri till dess Well-Known Binary-representation. |
| [as_binary(variant)](#as_binary_variant_3) | Översätter denna geometri till dess Well-Known Binary-representation. |
...
| [as_image(width, height, renderer, symbolizer)](#as_image_width_height_renderer_symbolizer_6) | Exporterar denna geometri till en bildrepresentation. |
| [as_text()](#as_text__7) | Översätter denna geometri till dess Well-Known Text-representation. |
| [as_text(variant)](#as_text_variant_8) | Översätter denna geometri till dess Well-Known Text-representation. |
| [as_text(variant, format)](#as_text_variant_format_9) | Översätter denna geometri till dess Well-Known Text-representation. |
| [clone()](#clone__10) | Klonar detta objekt. |
| [covered_by(other)](#covered_by_other_11) | Bestämmer om denna geometri täcks av en specificerad geometri. |
| [covers(other)](#covers_other_12) | Bestämmer om denna geometri täcker en specificerad geometri. |
| [crosses(other)](#crosses_other_13) | Bestämmer om denna geometri och en specificerad geometri korsar. |
| [difference(other)](#difference_other_14) | Subtraherar en specificerad geometri från denna geometri. |
| [disjoint(other)](#disjoint_other_15) | Bestämmer om denna geometri är disjunkt från en specificerad geometri. |
| [from_binary(wkb)](#from_binary_wkb_16) | Skapar en geometri från dess Well-Known Binary-representation. |
| [from_binary(wkb, spatial_reference_system)](#from_binary_wkb_spatial_reference_system_17) | Skapar en geometri från dess Well-Known Binary-representation. |
| [from_text(wkt)](#from_text_wkt_18) | Skapar en geometri från dess Well-Known Text-representation. |
| [from_text(wkt, spatial_reference_system)](#from_text_wkt_spatial_reference_system_19) | Skapar en geometri från dess Well-Known Text-representation. |
| [get_area()](#get_area__20) | Beräknar arean av denna geometri. |
| [get_buffer(distance, quadrant_segments)](#get_buffer_distance_quadrant_segments_21) | Beräknar ett buffertområde runt denna geometri. |
| [get_centroid()](#get_centroid__22) | Beräknar centroiden för denna geometri. |
| [get_convex_hull()](#get_convex_hull__23) | Beräknar den konvexa höljet för denna geometri. |
| [get_distance_to(other)](#get_distance_to_other_24) | Beräknar det minsta avståndet mellan denna geometri och en specificerad geometri. |
| [get_extent()](#get_extent__25) | Beräknar och returnerar en omgivande utbredning av denna geometri. |
| [get_length()](#get_length__26) | Beräknar längden på denna geometri. |
| [intersection(other)](#intersection_other_27) | Bygger en skärning mellan denna geometri och en specificerad geometri. |
| [intersects(extent)](#intersects_extent_28) | Bestämmer om denna geometri skär ett specificerat område. |
| [intersects(other)](#intersects_other_29) | Bestämmer om denna geometri och en specificerad geometri skär varandra. |
| [overlaps(other)](#overlaps_other_30) | Bestämmer om denna geometri överlappar med en specificerad geometri. |
| [relate(other, intersection_pattern_matrix)](#relate_other_intersection_pattern_matrix_31) | Bestämmer om DE-9IM-skärningsmatrisen för denna geometri och en specificerad geometri matchar det angivna mönstret. |
| [replace_polygons_by_lines()](#replace_polygons_by_lines__32) | Hämtar polygoner som representeras som linjer i denna geometri. |
| reverse() | Vänder på denna [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/). Det vill säga - vänd ordningen på kurvorna och varje kurva i denna sammansatta kurva. |
| [round_m(digits)](#round_m_digits_33) | Avrundar M-koordinaten till ett specificerat antal decimaler. |
| [round_xy(digits)](#round_xy_digits_34) | Avrundar X- och Y-koordinaterna till ett specificerat antal decimaler. |
| [round_z(digits)](#round_z_digits_35) | Avrundar Z-koordinaten till ett specificerat antal decimaler. |
| set_empty() | Gör denna [Geometry](/psd/python-net/aspose.gis.geometries/geometry/) tom. |
| [spatially_contains(other)](#spatially_contains_other_36) | Bestämmer om denna geometri rumsligt innehåller en specificerad geometri. |
| [spatially_equals(other)](#spatially_equals_other_37) | Bestämmer om denna geometri är rumsligt lika med en specificerad geometri. |
| [sym_difference(other)](#sym_difference_other_38) | Skapar en symmetrisk differens mellan denna geometri och en specificerad geometri. |
| [to_editable()](#to_editable__39) | Hämtar en redigerbar kopia av denna geometri. |
| [to_linear_geometry()](#to_linear_geometry__40) | Hämtar en ungefärlig eller motsvarande icke-kurv version av denna geometri med standard <c>tolerance</c>. |
| [to_linear_geometry(tolerance)](#to_linear_geometry_tolerance_41) | Hämtar en ungefärlig eller motsvarande icke-kurv version av denna geometri med den angivna <c>tolerance</c>. |
| [to_svg(extent)](#to_svg_extent_42) | Översätter denna geometri till Svg-representation. |
| [touches(other)](#touches_other_43) | Bestämmer om denna geometri och en specificerad geometri rör varandra. |
| [union(other)](#union_other_44) | Förenar denna geometri och en specificerad geometri. |
| [union(other)](#union_other_45) | Förenar denna geometri och en specificerad geometri. |
| [within(extent)](#within_extent_46) | Bestämmer om denna geometri ligger inom ett specificerat omfång. |
| [within(other)](#within_other_47) | Bestämmer om denna geometri ligger inom en specificerad geometri. |
...
Initierar en ny instans av klassen [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/).
...
| :- | :- | :- |
| kurvor | System.Collections.Generic.IEnumerable<ICurve> | Samlingen av kurvor. |
...
| Parameter | Typ | Beskrivning |
| :- | :- | :- |
| other | [ICompoundCurve](/psd/python-net/aspose.gis.geometries/icompoundcurve) | Den andra linjen att kopiera data från. |
...
Lägger till en kurva i slutet av denna [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/).

**Parameters:**

| Parameter | Typ | Beskrivning |
| :- | :- | :- |
| curve | [ICurve](/psd/python-net/aspose.gis.geometries/icurve) | Kurva att lägga till. |
...
| Typ | Beskrivning |
| :- | :- |
| [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve) | En redigerbar kopia av denna geometri. |
