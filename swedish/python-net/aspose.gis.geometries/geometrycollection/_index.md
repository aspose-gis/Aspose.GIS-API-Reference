---
title: "GeometryCollection-klass"
type: docs
weight: 60
url: /sv/python-net/aspose.gis.geometries/geometrycollection/
---
...
| **Name** | **Beskrivning** |
| :- | :- |
| [GeometryCollection()](#GeometryCollection__1) | Initierar en ny instans av klassen [GeometryCollection](/psd/python-net/aspose.gis.geometries/geometrycollection/) |
## **Properties**
...
| dimension | [GeometryDimension](/psd/python-net/aspose.gis.geometries/geometrydimension) | r | Hämtar den topologiska dimensionen för detta [Geometry](/psd/python-net/aspose.gis.geometries/geometry/).<br/>            Om samlingen är tom, returneras [GeometryDimension.POINT](/psd/python-net/aspose.gis.geometries/geometrydimension/) |
...
Initierar en ny instans av klassen [GeometryCollection](/psd/python-net/aspose.gis.geometries/geometrycollection/)
...
| Parameter | Typ | Beskrivning |
| :- | :- | :- |
| tolerans | double | Den <c>tolerance</c> som ska användas. Resultatet garanteras vara mindre än <c>tolerance</c> från den<br/>            kurviga geometrin. |
