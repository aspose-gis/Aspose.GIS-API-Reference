---
title: "IGeometryCollection-klass"
type: docs
weight: 120
url: /sv/python-net/aspose.gis.geometries/igeometrycollection/
---
...
| [get_point_on_surface()](#get_point_on_surface__22) | Hittar en punkt som garanterat ligger på en av ytorna i denna samling. |
| [intersection(other)](#intersection_other_23) | Bygger en skärning mellan denna geometri och en specificerad geometri. |
| [intersects(extent)](#intersects_extent_24) | Bestämmer om denna geometri skär ett specificerat område. |
| [intersects(other)](#intersects_other_25) | Bestämmer om denna geometri och en specificerad geometri skär varandra. |
...
| Typ | Beskrivning |
| :- | :- |
| [GeometryCollection](/psd/python-net/aspose.gis.geometries/geometrycollection) | En redigerbar kopia av denna geometri. |
...
| Typ | Beskrivning |
| :- | :- |
| [IGeometryCollection](/psd/python-net/aspose.gis.geometries/igeometrycollection) | En geometri som inte har några kurvgeometrier. Detta är motsvarigheten till <DOM Element: class at 0x2a1791cc040>.IGeometryCollection.to_linear_geometry()(float) med<br/>            standard <c>tolerance</c>. Standardvärdet för <c>tolerance</c> beror på [SpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem/)<br/>            för denna geometri:<br/>            <ul><br/>            <li> För projicerade SRS är toleransen 0,001 meter (i SRS-enheter) </li><br/>            <li> För geografiska SRS är toleransen <c>1e-5</c> grader (i SRS-enheter) </li><br/>            <li> För okända SRS är toleransen <c>1e-5</c> </li><br/>            </ul><br/>            För mer detaljer om vilka transformationer som tillämpas, se specifikationen för <DOM Element: class at 0x2a1791cc040>.IGeometryCollection.to_linear_geometry()(float). |
...
| Parameter | Typ | Beskrivning |
| :- | :- | :- |
| tolerans | double | Den <c>tolerance</c> som ska användas. Resultatet garanteras vara mindre än <c>tolerance</c> från den<br/>            kurviga geometrin, såvida inte antalet punkter som behövs för att linjärisera geometrin överstiger det per kvadrant‑maximala antalet,<br/>            som för närvarande är 10000 punkter. |

**Returns**

| Typ | Beskrivning |
| :- | :- |
| [IGeometryCollection](/psd/python-net/aspose.gis.geometries/igeometrycollection) | En geometri som inte har några kurvgeometrier. Följande transformationer tillämpas:<br/>            <ul><br/>            <li> [GeometryType.CIRCULAR_STRING](/psd/python-net/aspose.gis.geometries/geometrytype/)s linjäriseras<br/> (omvandlas till [GeometryType.LINE_STRING](/psd/python-net/aspose.gis.geometries/geometrytype/)s med angiven <paramref name="tolerance" />) </li><br/>            <li> [GeometryType.COMPOUND_CURVE](/psd/python-net/aspose.gis.geometries/geometrytype/)s sammanfogas till <c>LineString</c>s </li><br/>            <li> [GeometryType.CURVE_POLYGON](/psd/python-net/aspose.gis.geometries/geometrytype/)s omvandlas till [GeometryType.POLYGON](/psd/python-net/aspose.gis.geometries/geometrytype/)s </li><br/>            <li> [GeometryType.MULTI_CURVE](/psd/python-net/aspose.gis.geometries/geometrytype/)s omvandlas till [GeometryType.MULTI_CURVE](/psd/python-net/aspose.gis.geometries/geometrytype/)s </li><br/>            <li> [GeometryType.MULTI_SURFACE](/psd/python-net/aspose.gis.geometries/geometrytype/)s omvandlas till [GeometryType.MULTI_POLYGON](/psd/python-net/aspose.gis.geometries/geometrytype/)s </li><br/>            </ul><br/>            Som ett resultat är [IGeometry.has_curve_geometry](/psd/python-net/aspose.gis.geometries/igeometry/) för den resulterande geometrin <see langword="false" />. |
