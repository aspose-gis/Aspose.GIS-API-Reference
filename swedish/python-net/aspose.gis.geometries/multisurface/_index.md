---
title: "MultiSurface-klass"
type: docs
weight: 290
url: /sv/python-net/aspose.gis.geometries/multisurface/
---
...
| **Name** | **Beskrivning** |
| :- | :- |
| [MultiSurface()](#MultiSurface__1) | Initierar en ny instans av klassen [MultiSurface](/psd/python-net/aspose.gis.geometries/multisurface/) |
## **Properties**
...
Initierar en ny instans av klassen [MultiSurface](/psd/python-net/aspose.gis.geometries/multisurface/)
...
| Typ | Beskrivning |
| :- | :- |
| [MultiSurface](/psd/python-net/aspose.gis.geometries/multisurface) | En redigerbar kopia av denna geometri. |
...
| Typ | Beskrivning |
| :- | :- |
| [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon) | En [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon/) som approximerar eller är motsvarande detta [IMultiSurface](/psd/python-net/aspose.gis.geometries/imultisurface/).<br/>            Detta är motsvarigheten till <DOM Element: class at 0x2a1792e8790>.IMultiSurface.to_linear_geometry()(float) med<br/>            standard <c>tolerance</c>. Standardvärdet för <c>tolerance</c> beror på [SpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem/)<br/>            av denna geometri:<br/>            <ul><br/>            <li> För projicerade SRS är toleransen 0.001 meter (i SRS-enheter) </li><br/>            <li> För geografiska SRS är toleransen <c>1e-5</c> grader (i SRS-enheter) </li><br/>            <li> För okända SRS är toleransen <c>1e-5</c> </li><br/>            </ul><br/>            För mer detaljer om vilka transformationer som tillämpas, se <DOM Element: class at 0x2a1792e8790>.IMultiSurface.to_linear_geometry()(float) specifikation. |
...
| Typ | Beskrivning |
| :- | :- |
| [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon) | En [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon/) som approximerar eller är motsvarande detta [IMultiSurface](/psd/python-net/aspose.gis.geometries/imultisurface/):<br/>             <ul><br/>             Om detta objekt är [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon/) själv är resultatet motsvarande detta objekt<br/>             Om detta objekt inte är [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon/) - alla ytor linjäriseras och en ny <c>IMultiPolygon</c> skapas<br/>            </ul> |
