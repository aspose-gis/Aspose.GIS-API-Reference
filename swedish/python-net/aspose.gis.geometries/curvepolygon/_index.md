---
title: "CurvePolygon klass"
type: docs
weight: 40
url: /sv/python-net/aspose.gis.geometries/curvepolygon/
---
...
| **Name** | **Beskrivning** |
| :- | :- |
| [CurvePolygon()](#CurvePolygon__1) | Initierar en ny instans av klassen [CurvePolygon](/psd/python-net/aspose.gis.geometries/curvepolygon/). |
| [CurvePolygon(exterior_ring)](#CurvePolygon_exterior_ring_2) | Initierar en ny instans av klassen [CurvePolygon](/psd/python-net/aspose.gis.geometries/curvepolygon/). |
| [CurvePolygon(exterior_ring, interior_rings)](#CurvePolygon_exterior_ring_interior_rings_3) | Initierar en ny instans av klassen [CurvePolygon](/psd/python-net/aspose.gis.geometries/curvepolygon/). |
## **Properties**
...
| exterior_ring | [ICurve](/psd/python-net/aspose.gis.geometries/icurve) | r/w | Hämtar den yttre ringen. |
...
| interior_rings_count | int | r | Hämtar antalet inre ringar. |
...
| **Name** | **Beskrivning** |
| :- | :- |
| [add_interior_ring(ring)](#add_interior_ring_ring_1) | Lägger till en inre ring. |
...
| [get_interior_ring(index)](#get_interior_ring_index_26) | Hämtar den inre ringen efter dess index. |
| [get_length()](#get_length__27) | Beräknar längden på denna geometri. |
| [get_point_on_surface()](#get_point_on_surface__28) | Hittar en punkt som garanterat ligger på denna krökta polygon. |
...
| [replace_polygons_by_lines()](#replace_polygons_by_lines__34) | Hämtar polygoner som representeras som linjer i denna geometri. |
| [round_m(digits)](#round_m_digits_35) | Avrundar M-koordinaten till ett specificerat antal decimaler. |
| [round_xy(digits)](#round_xy_digits_36) | Avrundar X- och Y-koordinaterna till ett specificerat antal decimaler. |
| [round_z(digits)](#round_z_digits_37) | Avrundar Z-koordinaten till ett specificerat antal decimaler. |
| set_empty() | Gör denna [Geometry](/psd/python-net/aspose.gis.geometries/geometry/) tom. |
| [spatially_contains(other)](#spatially_contains_other_38) | Bestämmer om denna geometri rumsligt innehåller en specificerad geometri. |
| [spatially_equals(other)](#spatially_equals_other_39) | Bestämmer om denna geometri är rumsligt lika med en specificerad geometri. |
| [sym_difference(other)](#sym_difference_other_40) | Skapar en symmetrisk differens mellan denna geometri och en specificerad geometri. |
| [to_editable()](#to_editable__41) | Hämtar en redigerbar kopia av denna geometri. |
| [to_linear_geometry()](#to_linear_geometry__42) | Hämtar en ungefärlig eller motsvarande icke-kurv version av denna geometri med standard <c>tolerance</c>. |
| [to_linear_geometry(tolerance)](#to_linear_geometry_tolerance_43) | Hämtar en ungefärlig eller motsvarande icke-kurv version av denna geometri med den angivna <c>tolerance</c>. |
| [to_svg(extent)](#to_svg_extent_44) | Översätter denna geometri till Svg-representation. |
| [touches(other)](#touches_other_45) | Bestämmer om denna geometri och en specificerad geometri rör varandra. |
| [union(other)](#union_other_46) | Förenar denna geometri och en specificerad geometri. |
| [union(other)](#union_other_47) | Förenar denna geometri och en specificerad geometri. |
| [within(extent)](#within_extent_48) | Bestämmer om denna geometri ligger inom ett specificerat omfång. |
| [within(other)](#within_other_49) | Bestämmer om denna geometri ligger inom en specificerad geometri. |
...
Initierar en ny instans av klassen [CurvePolygon](/psd/python-net/aspose.gis.geometries/curvepolygon/).
...
| :- | :- | :- |
| exterior_ring | [ICurve](/psd/python-net/aspose.gis.geometries/icurve) | Den yttre ringen. |
...
| :- | :- | :- |
| exterior_ring | [ICurve](/psd/python-net/aspose.gis.geometries/icurve) | Den yttre ringen. |
| interior_rings | System.Collections.Generic.IEnumerable<ICurve> | De inre ringarna. |
...
| Parameter | Typ | Beskrivning |
| :- | :- | :- |
| ring | [ICurve](/psd/python-net/aspose.gis.geometries/icurve) | Ringen att lägga till. |
...
Hämtar den inre ringen efter dess index.
...
| Typ | Beskrivning |
| :- | :- |
| [ICurve](/psd/python-net/aspose.gis.geometries/icurve) | Den inre ringen. |
...
Hittar en punkt som garanterat ligger på denna krökta polygon.

**Returns**

| Typ | Beskrivning |
| :- | :- |
| [IPoint](/psd/python-net/aspose.gis.geometries/ipoint) | En punkt på denna krökta polygon. En tom punkt om denna krökta polygon saknar inre. |
...
| Typ | Beskrivning |
| :- | :- |
| [CurvePolygon](/psd/python-net/aspose.gis.geometries/curvepolygon) | En redigerbar kopia av denna geometri. |
...
| Typ | Beskrivning |
| :- | :- |
| [IPolygon](/psd/python-net/aspose.gis.geometries/ipolygon) | En [IPolygon](/psd/python-net/aspose.gis.geometries/ipolygon/) som approximera eller är ekvivalent med detta <c>ISurface</c>.<br/> Detta är motsvarigheten till <DOM Element: class at 0x2a1793609d0>.ISurface.to_linear_geometry()(float) med<br/> standard <c>tolerance</c>. Standardvärdet för <c>tolerance</c> beror på [SpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem/) för denna geometri:<ul><br/><li>För projicerat SRS är toleransen 0.001 meter (i SRS-enheter)</li><br/><li>För geografiskt SRS är toleransen <c>1e-5</c> grader (i SRS-enheter)</li><br/><li>För okänt SRS är toleransen <c>1e-5</c></li><br/></ul> För mer detaljer om vilka transformationer som tillämpas, se specifikationen för <DOM Element: class at 0x2a1793609d0>.ISurface.to_linear_geometry()(float). |
...
| Typ | Beskrivning |
| :- | :- |
| [IPolygon](/psd/python-net/aspose.gis.geometries/ipolygon) | En [IPolygon](/psd/python-net/aspose.gis.geometries/ipolygon/) som approximera eller är ekvivalent med detta <c>ISurface</c>:<br/> <ul><br/> Om detta objekt är [IPolygon](/psd/python-net/aspose.gis.geometries/ipolygon/) själv är resultatet ekvivalent med detta objekt<br/> Om detta objekt inte är [IPolygon](/psd/python-net/aspose.gis.geometries/ipolygon/) linjäriseras det och ett [IPolygon](/psd/python-net/aspose.gis.geometries/ipolygon/) skapas<br/> </ul> |
