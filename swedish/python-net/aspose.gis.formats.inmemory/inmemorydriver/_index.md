---
title: "InMemoryDriver-klass"
type: docs
weight: 10
url: /sv/python-net/aspose.gis.formats.inmemory/inmemorydriver/
---
...
| [create_layer()](#create_layer__5) | Skapar ett lager och öppnar det för att lägga till nya funktioner. |
| [create_layer(features_sequence)](#create_layer_features_sequence_6) | Skapar ett lager från en sekvens av features och öppnar det för att lägga till nya features. |
...
| [create_layer(path, options)](#create_layer_path_options_9) | Skapar lagret och öppnar det för tillägg. |
| [create_layer(path, options)](#create_layer_path_options_10) | Skapar lagret och öppnar det för tillägg. |
...
| [create_layer(path, spatial_reference_system)](#create_layer_path_spatial_reference_system_13) | Skapar lagret och öppnar det för tillägg. |
...
| [create_layer(spatial_reference_system)](#create_layer_spatial_reference_system_15) | Skapar ett lager och öppnar det för att lägga till nya funktioner. |
...
| [supports_spatial_reference_system(spatial_reference_system)](#supports_spatial_reference_system_spatial_reference_system_26) | Avgör, om det angivna rumsliga referenssystemet stöds av drivrutinen. |
...
Skapar ett lager från en sekvens av features och öppnar det för att lägga till nya features.
