---
title: "GeocentricSpatialReferenceSystem‑klass"
type: docs
weight: 50
url: /sv/python-net/aspose.gis.spatialreferencing/geocentricspatialreferencesystem/
---
...
| as_geocentric | [GeocentricSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/geocentricspatialreferencesystem) | r | Returnera detta. |
...
| axises_order | [GeocentricAxisesOrder](/psd/python-net/aspose.gis.spatialreferencing/geocentricaxisesorder) | r | Ordning på axlar i denna SRS.<br/>            Om denna SRS inte är giltig och har felaktiga axelriktningar, returneras [GeocentricAxisesOrder.INVALID](/psd/python-net/aspose.gis.spatialreferencing/geocentricaxisesorder/). |
| dimensions_count | int | r | Returnera 3, eftersom geocentrisk SRS alltid är tredimensionell. |
...
| geographic_datum | [GeographicDatum](/psd/python-net/aspose.gis.spatialreferencing/geographicdatum) | r | Returnera geografiskt datum för denna SRS. |
| has_geographic_datum | bool | r | Returnera <see langword=\"true\" />, eftersom geocentrisk SRS alltid har geografiskt datum. |
| has_prime_meridian | bool | r | Returnera <see langword=\"true\" />, eftersom geocentrisk SRS alltid har primärmeridian. |
...
| linear_unit | [Unit](/psd/python-net/aspose.gis.spatialreferencing/unit) | r | Enhet som används i denna SRS. |
...
| prime_meridian | [PrimeMeridian](/psd/python-net/aspose.gis.spatialreferencing/primemeridian) | r | Returnera primärmeridianen för denna SRS. |
| type | [SpatialReferenceSystemType](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype) | r | Returnera [SpatialReferenceSystemType.GEOCENTRIC](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/). |
