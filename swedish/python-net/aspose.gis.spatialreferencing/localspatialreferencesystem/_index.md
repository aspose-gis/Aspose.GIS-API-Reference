---
title: "LocalSpatialReferenceSystem-klass"
type: docs
weight: 130
url: /sv/python-net/aspose.gis.spatialreferencing/localspatialreferencesystem/
---
...
| as_local | [LocalSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/localspatialreferencesystem) | r | Returnera detta. |
...
| dimensions_count | int | r | Antal dimensioner i detta SRS. |
...
| geographic_datum | [GeographicDatum](/psd/python-net/aspose.gis.spatialreferencing/geographicdatum) | r | Kastar InvalidOperationException, eftersom lokala SRS inte har geografiskt datum. |
| has_geographic_datum | bool | r | Returnerar <see langword="false" />, eftersom lokala SRS inte har geografiskt datum. |
| has_prime_meridian | bool | r | Returnerar <see langword="false" />, eftersom lokala SRS inte har primärmeridian. |
...
| local_datum | [LocalDatum](/psd/python-net/aspose.gis.spatialreferencing/localdatum) | r | Datum som beskriver mätningsmetod. |
...
| prime_meridian | [PrimeMeridian](/psd/python-net/aspose.gis.spatialreferencing/primemeridian) | r | Kastar InvalidOperationException, eftersom lokala SRS inte har primärmeridian. |
| type | [SpatialReferenceSystemType](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype) | r | Returnerar [SpatialReferenceSystemType.LOCAL](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/). |
| unit | [Unit](/psd/python-net/aspose.gis.spatialreferencing/unit) | r | Enhet för detta SRS. |
...
| [get_unit(dimension)](#get_unit_dimension_12) | Hämta [LocalSpatialReferenceSystem.unit](/psd/python-net/aspose.gis.spatialreferencing/localspatialreferencesystem/) för dimension. |
...
Hämta [LocalSpatialReferenceSystem.unit](/psd/python-net/aspose.gis.spatialreferencing/localspatialreferencesystem/) för dimension.
