---
title: "ProjectedSpatialReferenceSystem-klass"
type: docs
weight: 150
url: /sv/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/
---
...
| as_geographic | [GeographicSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/geographicspatialreferencesystem) | r | Returnerar detta SRS konverterat till [GeographicSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/geographicspatialreferencesystem/).<br/>            Använd [SpatialReferenceSystem.type](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem/) för att ta reda på om konvertering är möjlig. |
...
| as_projected | [ProjectedSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem) | r | Returnera detta. |
...
| axises_order | [ProjectedAxisesOrder](/psd/python-net/aspose.gis.spatialreferencing/projectedaxisesorder) | r | Ordning av axlar i detta SRS.<br/>            Om detta SRS inte är giltigt och har felaktiga axelriktningar, returneras [ProjectedAxisesOrder.INVALID](/psd/python-net/aspose.gis.spatialreferencing/projectedaxisesorder/). |
| base | [GeographicSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/geographicspatialreferencesystem) | r | Geografiskt SRS till vilket [ProjectedSpatialReferenceSystem.projection](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/) tillämpades för att få detta SRS. |
| dimensions_count | int | r | Returnerar antalet dimensioner i detta SRS. För projicerat SRS kan detta vara:<br/>            två - om detta är ett enkelt projicerat SRS.<br/>            tre - om detta är ett sammansatt SRS, som består av ett enkelt, tvådimensionellt, projicerat SRS och ett vertikalt SRS, som lägger till en tredje dimension. |
...
| has_geographic_datum | bool | r | Returnerar true, eftersom projicerade SRS alltid har en primär meridian. |
| has_prime_meridian | bool | r | Returnerar true, eftersom projicerade SRS alltid har en primär meridian. |
...
| linear_unit | [Unit](/psd/python-net/aspose.gis.spatialreferencing/unit) | r | Enhet som används för linjära dimensioner i detta SRS och för linjära parametrar för [ProjectedSpatialReferenceSystem.projection](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/). |
...
| projection | [Projection](/psd/python-net/aspose.gis.spatialreferencing/projection) | r | Projektion som tillämpades på [ProjectedSpatialReferenceSystem.base](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/) för att få detta SRS. |
| type | [SpatialReferenceSystemType](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype) | r | Returnerar [SpatialReferenceSystemType.PROJECTED](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/). |
