---
title: "CompoundSpatialReferenceSystem-klass"
type: docs
weight: 30
url: /sv/python-net/aspose.gis.spatialreferencing/compoundspatialreferencesystem/
---
...
| :- | :- | :- | :- |
| as_compound | [CompoundSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/compoundspatialreferencesystem) | r | Returnera detta. |
...
| as_geographic | [GeographicSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/geographicspatialreferencesystem) | r | Returnera geografisk representation av detta SRS. Om detta sammansatta SRS faktiskt representerar ett geografiskt SRS, kommer resultatet att<br/>            vara ett tredimensionellt geografiskt SRS (med longitud, latitud, höjddimensioner). Annars kommer ett undantag att kastas. |
...
| as_projected | [ProjectedSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem) | r | Returnera projicerad representation av detta SRS. Om detta sammansatta SRS faktiskt representerar ett projicerat SRS, kommer resultatet att<br/>            vara ett tredimensionellt projicerat SRS (med X, Y, höjddimensioner). Annars kommer ett undantag att kastas. |
...
| dimensions_count | int | r | Antal dimensioner. För sammansatt SRS är detta summan av antalet dimensioner för underliggande SRS. |
...
| geographic_datum | [GeographicDatum](/psd/python-net/aspose.gis.spatialreferencing/geographicdatum) | r | Returnera geografisk datum för detta SRS.<br/>            Om både [CompoundSpatialReferenceSystem.head](/psd/python-net/aspose.gis.spatialreferencing/compoundspatialreferencesystem/) och [CompoundSpatialReferenceSystem.tail](/psd/python-net/aspose.gis.spatialreferencing/compoundspatialreferencesystem/) har geografisk datum - returnera geografisk datum för huvudet. |
| has_geographic_datum | bool | r | Sammansatt SRS har geografisk datum om någon av de underliggande SRS har geografisk datum. |
| has_prime_meridian | bool | r | Sammansatt SRS har primärmeridian om någon av de underliggande SRS har primärmeridian. |
| head | [SpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem) | r | Första underliggande SRS. |
...
| is_compound | bool | r | Returnerar <see langword="true" />. |
...
| prime_meridian | [PrimeMeridian](/psd/python-net/aspose.gis.spatialreferencing/primemeridian) | r | Returnera primärmeridian för detta SRS.<br/>            Om både [CompoundSpatialReferenceSystem.head](/psd/python-net/aspose.gis.spatialreferencing/compoundspatialreferencesystem/) och [CompoundSpatialReferenceSystem.tail](/psd/python-net/aspose.gis.spatialreferencing/compoundspatialreferencesystem/) har primärmeridian - returnera primärmeridian för huvudet. |
| tail | [SpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem) | r | Andra underliggande SRS. |
| type | [SpatialReferenceSystemType](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype) | r | Typ av detta sammansatta SRS. Kan vara [SpatialReferenceSystemType.GEOGRAPHIC](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/) om<br/>            detta sammansatta SRS är en kombination av geografisk och vertikal SRS, eller [SpatialReferenceSystemType.PROJECTED](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/) om<br/>            detta sammansatta SRS är en kombination av projicerad och vertikal SRS. |
...
| [validate(error_message)](#validate_error_message_18) | Bestäm om denna SRS är giltig. Se <see cref=\"M:Aspose.Gis.SpatialReferencing.SpatialReferenceSystem.Validate(string@)\" /> för beskrivning av giltigheten. |
...
Bestäm om denna SRS är giltig. Se <see cref=\"M:Aspose.Gis.SpatialReferencing.SpatialReferenceSystem.Validate(string@)\" /> för beskrivning av giltigheten.

**Parameters:**

| Parameter | Typ | Beskrivning |
| :- | :- | :- |
| error_message | Sträng | Beskrivning av ogiltighet (om resultatet är <see langword="false" />) |

**Returns**

| Typ | Beskrivning |
| :- | :- |
| bool | Om detta SRS är giltigt - <see langword="true" />, annars - <see langword="false" />. |
