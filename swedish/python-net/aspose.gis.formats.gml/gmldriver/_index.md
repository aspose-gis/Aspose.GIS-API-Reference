---
title: "GmlDriver klass"
type: docs
weight: 10
url: /sv/python-net/aspose.gis.formats.gml/gmldriver/
---
...
| [create_layer(path, options, spatial_reference_system)](#create_layer_path_options_spatial_reference_system_14) | Skapar ett lager och öppnar det för att lägga till nya funktioner. |
...
| :- | :- | :- |
| path | string | Sökväg till filen. |
| options | [GmlOptions](/psd/python-net/aspose.gis.formats.gml/gmloptions) | Drivrutinsspecifika alternativ. |
