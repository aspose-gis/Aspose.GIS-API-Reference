---
title: "KmlDriver-klass"
type: docs
weight: 50
url: /sv/python-net/aspose.gis.formats.kml/kmldriver/
---
...
| [open_as_kml_layer(path, options)](#open_as_kml_layer_path_options_18) | Öppnar ett Kml-lager för läsning. |
...
| [open_layer(path)](#open_layer_path_24) | Öppnar lagret för läsning. |
...
| [supports_spatial_reference_system(spatial_reference_system)](#supports_spatial_reference_system_spatial_reference_system_29) | Avgör, om det angivna rumsliga referenssystemet stöds av drivrutinen. |
...
| :- | :- | :- |
| path | string | Sökväg till filen. |
| options | [KmlOptions](/psd/python-net/aspose.gis.formats.kml/kmloptions) | Drivrutinsspecifika alternativ. |
...
Öppnar ett Kml-lager för läsning.
...
| Typ | Beskrivning |
| :- | :- |
| [KmlLayer](/psd/python-net/aspose.gis.formats.kml/kmllayer) | KmlLayer med specifika fält |
