---
title: "KmlOptions-klass"
type: docs
weight: 190
url: /sv/python-net/aspose.gis.formats.kml/kmloptions/
---
...
| **Name** | **Beskrivning** |
| :- | :- |
| [KmlOptions()](#KmlOptions__1) | Skapa ny instans. |
## **Properties**
| **Name** | **Type** | **Access** | **Beskrivning** |
| :- | :- | :- | :- |
| altitude_mode | [AltitudeModes](/psd/python-net/aspose.gis.formats.kml/altitudemodes) | r/w | Tillåter dig att ange de AltitudeModes som ska användas för KML-geometrier |
...
| document_id | string | läs/skriv | Används för att ange id:t för rot‑'Document'-noden |
...
| symbol_to_replace_invalid_chars | char | läs/skriv | Bestämmer vilket tecken som ska användas för att ersätta ogiltiga tecken vid läsning.<br/>            Ersättning hoppas över om värdet är '\0'. Som standard är värdet '\0'-tecken. |
