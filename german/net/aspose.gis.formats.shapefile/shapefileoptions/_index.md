...
description: Aspose.Gis.Formats.Shapefile.ShapefileOptions klas. Treiberspezifische Optionen für das ShapefileFormat. Im Moment bietet der Treiber keine anpassbaren Optionen.
type: docs
weight: 670
url: /de/net/aspose.gis.formats.shapefile/shapefileoptions/
---
## ShapefileOptions class

Treiberspezifische Optionen für das Shapefile-Format. Im Moment bietet der Treiber keine anpassbaren Optionen.
...
| Name | Beschreibung |
| --- | --- |
| [ShapefileOptions](shapefileoptions/)() | Neue Instanz erstellen. |
