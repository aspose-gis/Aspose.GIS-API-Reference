...
description: Parameter zum Erstellen geozentrischer SRS. Parameter haben vernünftige Standardwerte daher müssen Sie nur einige davon zuweisen. Wenn Sie zuweisennull Für jeden Parameter wird ein Standardwert verwendet.
type: docs
weight: 2000
...
| [YAxis](../../aspose.gis.spatialreferencing/geocentricspatialreferencesystemparameters/yaxis) { get; set; } | Achse der geozentrischen SRS, die die 'Y'-Dimension beschreibt (Achse, die auf der Äquatorebene nach links oder rechts von der X-Achse zeigt). Standardmäßig Achse mitEast Richtung. |
| [ZAxis](../../aspose.gis.spatialreferencing/geocentricspatialreferencesystemparameters/zaxis) { get; set; } | Achse der geozentrischen SRS, die die 'Z'-Dimension beschreibt (Achse, die auf den Nord- oder Südpol zeigt). Standardmäßig Achse mitNorth Richtung. |
