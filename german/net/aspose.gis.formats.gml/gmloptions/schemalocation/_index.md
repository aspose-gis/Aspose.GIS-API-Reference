...
description: Durch Leerzeichen getrennte Liste von URIPaaren. Der erste URI in jedem Paar ist ein URI des Namensraums der zweite URI ist ein Pfad zum XMLSchema des Namensraums. Wenn festgelegt aufnull GmlDriveraspose.gis.formats.gml/gmldriver wird versuchen schemaLocation aus dem Stammelement des Dokuments zu lesen. Standard istnull .
type: docs
weight: 50
