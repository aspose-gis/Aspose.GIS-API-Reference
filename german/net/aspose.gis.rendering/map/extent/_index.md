...
description: Gibt die Grenzen der zu rendernden Karte an. Wenn eingestellt aufnull  wird die Ausdehnung während des Renderns berechnet um alle Geometrien in allen Layern einzuschließen.
type: docs
weight: 40
