...
description: TopoJsonOptions eigendom. Gibt das Transformationsobjekt an das verwendet werden soll um Koordinaten zu quantisieren und Bögen in der Ausgabe TopoJSON zu deltakodieren.
type: docs
weight: 60
