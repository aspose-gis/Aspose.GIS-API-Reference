...
description: AMultiSurface./multisurface ist eindimensionalGeometryCollection./geometrycollection deren Elemente sindISurface./isurface s.
type: docs
weight: 1080
url: /de/net/aspose.gis.geometries/multisurface/
---
## MultiSurface class

A[`MultiSurface`](../multisurface) ist eindimensional[`GeometryCollection`](../geometrycollection) deren Elemente sind[`ISurface`](../isurface) s.
...
| Name | Beschreibung |
| --- | --- |
| [MultiSurface](multisurface)() | Initialisiert eine neue Instanz von[`MultiSurface`](../multisurface) Klasse. |
...
| [Dimension](../../aspose.gis.geometries/multisurface/dimension) { get; } | Ruft die topologische Dimension davon ab[`Geometry`](../geometry) . |
| override [GeometryType](../../aspose.gis.geometries/multisurface/geometrytype) { get; } | Ruft den Typ der Geometrie ab. |
...
| override [Clone](../../aspose.gis.geometries/multisurface/clone)() | Klont diese Instanz. |
...
| [ToEditable](../../aspose.gis.geometries/multisurface/toeditable#toeditable_2)() | Ruft eine bearbeitbare Kopie dieser Geometrie ab. (3 methods) |
| [ToEditable&lt;T&gt;](../../aspose.gis.geometries/geometry/toeditable)() | Ruft eine bearbeitbare Kopie dieser Geometrie ab. |
| [ToLinearGeometry](../../aspose.gis.geometries/multisurface/tolineargeometry#tolineargeometry_4)() | Ruft eine ungefähre oder äquivalente Nicht-Kurven-Version dieser Geometrie unter Verwendung der Vorgabe ab`Toleranz` . (3 methods) |
| [ToLinearGeometry](../../aspose.gis.geometries/multisurface/tolineargeometry#tolineargeometry_5)(double) | Ruft eine ungefähre oder äquivalente Nicht-Kurven-Version dieser Geometrie unter Verwendung der angegebenen ab`Toleranz` . (3 methods) |
