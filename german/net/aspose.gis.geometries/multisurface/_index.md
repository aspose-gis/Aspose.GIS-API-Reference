...
description: Aspose.Gis.Geometries.MultiSurface klas. AMultiSurface ist eindimensionalGeometryCollection deren Elemente sindISurface s.
type: docs
weight: 1180
...
A`MultiSurface` ist eindimensional[`GeometryCollection`](../geometrycollection/) deren Elemente sind[`ISurface`](../isurface/) s.
...
| Name | Beschreibung |
| --- | --- |
| [MultiSurface](multisurface/)() | Initialisiert eine neue Instanz von`MultiSurface` Klasse. |
