...
description: Aspose.Gis.Geometries.LinearRing klas. ALinearRing ist einLineString das ist sowohl geschlossen als auch einfach.
type: docs
weight: 1130
...
A`LinearRing` ist ein[`LineString`](../linestring/) das ist sowohl geschlossen als auch einfach.
...
| Name | Beschreibung |
| --- | --- |
| [LinearRing](linearring/#constructor)() | Initialisiert eine neue Instanz von`LinearRing` Klasse. |
| [LinearRing](linearring/#constructor_2)(IEnumerable&lt;IPoint&gt;) | Initialisiert eine neue Instanz von`LinearRing` Klasse. |
| [LinearRing](linearring/#constructor_1)(ILineString) | Initialisiert eine neue Instanz von`LinearRing` Klasse. |
