...
description: AIGeometryCollection./igeometrycollection ist einIGeometry./igeometry das ist eine Sammlung von einer oder mehreren Geometrien.
type: docs
weight: 910
...
A[`IGeometryCollection`](../igeometrycollection) ist ein[`IGeometry`](../igeometry) das ist eine Sammlung von einer oder mehreren Geometrien.
