...
description: Eine Kurve die eine Folge zusammenhängender Kurven darstellt sodass benachbarte Kurven an ihren Endpunkten verbunden sind.
type: docs
weight: 790
...
| Name | Beschreibung |
| --- | --- |
| [CompoundCurve](compoundcurve#constructor)() | Initialisiert eine neue Instanz von[`CompoundCurve`](../compoundcurve) Klasse. |
| [CompoundCurve](compoundcurve#constructor_1)(ICompoundCurve) | Initialisiert eine neue Instanz von[`CompoundCurve`](../compoundcurve) Klasse. |
| [CompoundCurve](compoundcurve#constructor_2)(IEnumerable&lt;ICurve&gt;) | Initialisiert eine neue Instanz von[`CompoundCurve`](../compoundcurve) Klasse. |
...
| Name | Beschreibung |
| --- | --- |
| [AddCurve](../../aspose.gis.geometries/compoundcurve/addcurve)(ICurve) | Fügt am Ende eine Kurve hinzu[`CompoundCurve`](../compoundcurve) . |
...
| override [Reverse](../../aspose.gis.geometries/compoundcurve/reverse)() | Kehrt dies um[`CompoundCurve`](../compoundcurve) . Das heißt - umgekehrte Reihenfolge der Kurven und jede Kurve innerhalb dieser zusammengesetzten Kurve. |
