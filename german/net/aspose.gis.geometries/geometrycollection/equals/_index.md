...
description: GeometryCollection methode. Bestimmt ob das angegebene Objekt gleich dem aktuellen Objekt ist.
type: docs
weight: 140
url: /de/net/aspose.gis.geometries/geometrycollection/equals/
---
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| other | IGeometryCollection | Ein Objekt, das mit diesem Objekt verglichen werden soll. |
