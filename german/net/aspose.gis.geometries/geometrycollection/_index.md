...
description: AGeometryCollection./geometrycollection ist einGeometry./geometry das ist eine Sammlung von einer oder mehreren Geometrien.
type: docs
weight: 830
...
A[`GeometryCollection`](../geometrycollection) ist ein[`Geometry`](../geometry) das ist eine Sammlung von einer oder mehreren Geometrien.
...
| Name | Beschreibung |
| --- | --- |
| [GeometryCollection](geometrycollection)() | Initialisiert eine neue Instanz von[`GeometryCollection`](../geometrycollection) Klasse. |
...
| [ReplacePolygonsByLines](../../aspose.gis.geometries/geometrycollection/replacepolygonsbylines#replacepolygonsbylines_1)() | Ruft Polygone ab, die als Linien dieser Geometrie dargestellt werden. (2 methods) |
