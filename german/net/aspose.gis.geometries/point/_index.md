...
description: APoint./point stellt einen einzelnen Ort im Koordinatenraum dar.
type: docs
weight: 1090
...
A[`Point`](../point) stellt einen einzelnen Ort im Koordinatenraum dar.
...
| Name | Beschreibung |
| --- | --- |
| [Point](point#constructor)() | Initialisiert eine neue Instanz von[`Point`](../point) Klasse. |
| [Point](point#constructor_1)(IPoint) | Initialisiert eine neue Instanz von[`Point`](../point) Klasse. |
| [Point](point#constructor_2)(double, double) | Initialisiert eine neue Instanz von[`Point`](../point) Klasse. |
| [Point](point#constructor_3)(double, double, double) | Initialisiert eine neue Instanz von[`Point`](../point) Klasse. |
| [Point](point#constructor_4)(double, double, double, double) | Initialisiert eine neue Instanz von[`Point`](../point) Klasse. |
