...
description: MultiCurve methode. Ruft eine ungefähre oder äquivalente NichtKurvenVersion dieser Geometrie unter Verwendung der angegebenen abToleranz .
type: docs
weight: 70
url: /de/net/aspose.gis.geometries/multicurve/tolineargeometry/
---
...
A[`IMultiLineString`](../../imultilinestring/) die ungefähr oder gleichwertig ist[`IMultiCurve`](../../imulticurve/) :  Wenn dieses Objekt ist[`IMultiLineString`](../../imultilinestring/) selbst ist das Ergebnis äquivalent zu diesem Objekt Wenn dieses Objekt es nicht ist[`IMultiLineString`](../../imultilinestring/) - alle Kurven sind linearisiert und neu`IMultiLineString` wird erstellt
...
A[`IMultiLineString`](../../imultilinestring/) die ungefähr oder gleichwertig ist[`IMultiCurve`](../../imulticurve/). Dies ist das Äquivalent zu[`ToLinearGeometry`](../../imulticurve/tolineargeometry/) with default`Toleranz` . Standard`Toleranz` s Wert ist abhängig von[`SpatialReferenceSystem`](../../../aspose.gis.spatialreferencing/spatialreferencesystem/) dieser Geometrie:  Für prognostizierte SRS beträgt die Toleranz 0,001 Meter (in SRS-Einheiten) Für die geografische SRS-Toleranz gilt`1e-5` Grad (in SRS-Einheiten) Für unbekannte SRS-Toleranz ist`1e-5` Weitere Einzelheiten darüber, welche Transformationen angewendet werden, finden Sie unter[`ToLinearGeometry`](../../imulticurve/tolineargeometry/) Spezifikation.
