...
description: Aspose.Gis.Geometries.Polygon klas. APolygon ist eine ebene Fläche definiert durch 1 äußere Begrenzung und 0 oder mehr innere Begrenzungen.
type: docs
weight: 1200
...
A`Polygon` ist eine ebene Fläche, definiert durch 1 äußere Begrenzung und 0 oder mehr innere Begrenzungen.
...
| Name | Beschreibung |
| --- | --- |
| [Polygon](polygon/#constructor)() | Initialisiert eine neue Instanz von`Polygon` Klasse. |
| [Polygon](polygon/#constructor_1)(ILinearRing) | Initialisiert eine neue Instanz von`Polygon` Klasse. |
| [Polygon](polygon/#constructor_2)(ILinearRing, IEnumerable&lt;ILinearRing&gt;) | Initialisiert eine neue Instanz von`Polygon` Klasse. |
...
| Name | Beschreibung |
| --- | --- |
| [AddInteriorRing](../../aspose.gis.geometries/polygon/addinteriorring/)(ILinearRing) | Fügt einen Innenring hinzu. |
