...
type: docs
weight: 780
url: /de/net/aspose.gis.geometries/circularstring/
---
...
| Name | Beschreibung |
| --- | --- |
| [CircularString](circularstring#constructor)() | Initialisiert eine neue Instanz von[`CircularString`](../circularstring) Klasse. |
| [CircularString](circularstring#constructor_1)(ICircularString) | Initialisiert eine neue Instanz von[`CircularString`](../circularstring) Klasse. |
| [CircularString](circularstring#constructor_2)(IEnumerable&lt;IPoint&gt;) | Initialisiert eine neue Instanz von[`CircularString`](../circularstring) Klasse. |
...
| [Count](../../aspose.gis.geometries/circularstring/count) { get; } | Ruft die Anzahl der Punkte in der ab[`CircularString`](../circularstring) . |
| [Dimension](../../aspose.gis.geometries/curve/dimension) { get; } | Ruft die topologische Dimension davon ab[`Geometry`](../geometry) . |
| override [EndPoint](../../aspose.gis.geometries/circularstring/endpoint) { get; } | Gibt eine Kopie des Endpunkts der Kurve zurück. |
| override [GeometryType](../../aspose.gis.geometries/circularstring/geometrytype) { get; } | Ruft den Typ der Geometrie ab. |
| override [HasCurveGeometry](../../aspose.gis.geometries/circularstring/hascurvegeometry) { get; } | Ruft einen Wert ab, der angibt, ob diese Geometrie Kurvengeometrie (nicht linear) ist oder enthält. |
| [HasM](../../aspose.gis.geometries/circularstring/hasm) { get; set; } | Ruft einen Wert ab, der angibt, ob diese Instanz eine M-Koordinate hat. |
| [HasZ](../../aspose.gis.geometries/circularstring/hasz) { get; set; } | Ruft einen Wert ab, der angibt, ob diese Instanz eine Z-Koordinate hat. |
...
| override [IsEmpty](../../aspose.gis.geometries/circularstring/isempty) { get; } | Ruft einen Wert ab, der angibt, ob diese Instanz leer ist. |
...
| [Item](../../aspose.gis.geometries/circularstring/item) { get; set; } | Ruft ab oder setzt die[`IPoint`](../ipoint) am angegebenen Index. |
| [SpatialReferenceSystem](../../aspose.gis.geometries/circularstring/spatialreferencesystem) { get; set; } | Ruft SpatialReferenceSystem dieser Instanz ab. Diese Eigenschaft kann sein`null` , wenn SpatialReferenceSystem nicht gesetzt ist. Bei der Zuweisung eines neuen SpatialReferenceSystem wird keine Koordinatentransformation durchgeführt, nur die Referenz ändert sich. |
| override [StartPoint](../../aspose.gis.geometries/circularstring/startpoint) { get; } | Gibt eine Kopie des Startpunkts der Kurve zurück. |

## Methoden

| Name | Beschreibung |
| --- | --- |
| [AddPoint](../../aspose.gis.geometries/circularstring/addpoint#addpoint)(IPoint) | Fügt am Ende der kreisförmigen Zeichenfolge einen Punkt hinzu. |
| [AddPoint](../../aspose.gis.geometries/circularstring/addpoint#addpoint_1)(double, double) | Fügt am Ende der kreisförmigen Zeichenfolge einen Punkt hinzu. |
| [AddPoint](../../aspose.gis.geometries/circularstring/addpoint#addpoint_2)(double, double, double) | Fügt am Ende der kreisförmigen Zeichenfolge einen Punkt hinzu. |
| [AddPoint](../../aspose.gis.geometries/circularstring/addpoint#addpoint_3)(double, double, double, double) | Fügt am Ende der kreisförmigen Zeichenfolge einen Punkt hinzu. |
...
| override [Clone](../../aspose.gis.geometries/circularstring/clone)() | Klont diese Instanz. |
...
| [Equals](../../aspose.gis.geometries/circularstring/equals#equals)(ICircularString) | Gibt an, ob das aktuelle Objekt gleich einem anderen Objekt desselben Typs ist. |
| override [Equals](../../aspose.gis.geometries/circularstring/equals#equals_1)(object) | Bestimmt, ob das angegebene Objekt gleich dem aktuellen Objekt ist. |
...
| [GetEnumerator](../../aspose.gis.geometries/circularstring/getenumerator)() | Gibt einen Enumerator zurück, der die Auflistung durchläuft. |
| [GetExtent](../../aspose.gis.geometries/geometry/getextent)() | Berechnet und gibt eine Begrenzungsausdehnung dieser Geometrie zurück. |
| override [GetHashCode](../../aspose.gis.geometries/circularstring/gethashcode)() | Dient als Standard-Hash-Funktion. |
...
| override [Reverse](../../aspose.gis.geometries/circularstring/reverse)() | Kehrt die Reihenfolge der Punkte um[`CircularString`](../circularstring) . |
...
| override [SetEmpty](../../aspose.gis.geometries/circularstring/setempty)() | Macht das[`Geometry`](../geometry) leer. |
...
| [ToEditable](../../aspose.gis.geometries/circularstring/toeditable#toeditable)() | Ruft eine bearbeitbare Kopie dieser Geometrie ab. (3 methods) |
...
| [operator ==](../../aspose.gis.geometries/circularstring/op_equality) | Implementiert den Operator ==. |
| [operator !=](../../aspose.gis.geometries/circularstring/op_inequality) | Implementiert den Operator !=. |
