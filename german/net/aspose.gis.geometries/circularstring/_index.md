...
description: Aspose.Gis.Geometries.CircularString klas. Eine Kurve mit mehreren Scheitelpunkten mit kreisförmiger Interpolation zwischen den Punkten.
type: docs
weight: 880
...
| Name | Beschreibung |
| --- | --- |
| [CircularString](circularstring/#constructor)() | Initialisiert eine neue Instanz von`CircularString` Klasse. |
| [CircularString](circularstring/#constructor_1)(ICircularString) | Initialisiert eine neue Instanz von`CircularString` Klasse. |
| [CircularString](circularstring/#constructor_2)(IEnumerable&lt;IPoint&gt;) | Initialisiert eine neue Instanz von`CircularString` Klasse. |
...
| [Count](../../aspose.gis.geometries/circularstring/count/) { get; } | Ruft die Anzahl der Punkte in der ab`CircularString` . |
...
| override [Reverse](../../aspose.gis.geometries/circularstring/reverse/)() | Kehrt die Reihenfolge der Punkte um`CircularString` . |
