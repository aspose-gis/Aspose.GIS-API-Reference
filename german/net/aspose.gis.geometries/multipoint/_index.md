...
description: Aspose.Gis.Geometries.MultiPoint klas. AMultiPoint ist eindimensionalGeometryCollection dessen Elemente sindPoint s.
type: docs
weight: 1160
...
A`MultiPoint` ist eindimensional[`GeometryCollection`](../geometrycollection/) dessen Elemente sind[`Point`](../point/) s.
...
| Name | Beschreibung |
| --- | --- |
| [MultiPoint](multipoint/)() | Initialisiert eine neue Instanz von`MultiPoint` Klasse. |
