...
description: AMultiPolygon./multipolygon ist ein eindimensionales GeometryCollection./geometrycollection deren Elemente sindPolygon./polygon s.
type: docs
weight: 1070
url: /de/net/aspose.gis.geometries/multipolygon/
---
## MultiPolygon class

A[`MultiPolygon`](../multipolygon) ist ein eindimensionales [`GeometryCollection`](../geometrycollection) deren Elemente sind[`Polygon`](../polygon) s.
...
| Name | Beschreibung |
| --- | --- |
| [MultiPolygon](multipolygon)() | Initialisiert eine neue Instanz von[`MultiPolygon`](../multipolygon) Klasse. |
...
| override [GeometryType](../../aspose.gis.geometries/multipolygon/geometrytype) { get; } | Ruft den Typ der Geometrie ab. |
...
| override [Clone](../../aspose.gis.geometries/multipolygon/clone)() | Klont diese Instanz. |
...
| [ToEditable](../../aspose.gis.geometries/multipolygon/toeditable#toeditable_2)() | Ruft eine bearbeitbare Kopie dieser Geometrie ab. (4 methods) |
| [ToEditable&lt;T&gt;](../../aspose.gis.geometries/geometry/toeditable)() | Ruft eine bearbeitbare Kopie dieser Geometrie ab. |
| [ToLinearGeometry](../../aspose.gis.geometries/multisurface/tolineargeometry)() | Ruft eine ungefähre oder äquivalente Nicht-Kurven-Version dieser Geometrie unter Verwendung der Vorgabe ab`Toleranz` . (3 methods) |
| [ToLinearGeometry](../../aspose.gis.geometries/multisurface/tolineargeometry)(double) | Ruft eine ungefähre oder äquivalente Nicht-Kurven-Version dieser Geometrie unter Verwendung der angegebenen ab`Toleranz` . (3 methods) |
