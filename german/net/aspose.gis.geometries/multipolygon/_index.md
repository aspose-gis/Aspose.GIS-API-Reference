...
description: Aspose.Gis.Geometries.MultiPolygon klas. AMultiPolygon ist ein eindimensionales GeometryCollection deren Elemente sindPolygon s.
type: docs
weight: 1170
...
A`MultiPolygon` ist ein eindimensionales [`GeometryCollection`](../geometrycollection/) deren Elemente sind[`Polygon`](../polygon/) s.
...
| Name | Beschreibung |
| --- | --- |
| [MultiPolygon](multipolygon/)() | Initialisiert eine neue Instanz von`MultiPolygon` Klasse. |
