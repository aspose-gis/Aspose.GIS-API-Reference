...
description: Aspose.Gis.Formats.Gpx.GpxOptions klas. Treiberspezifische Optionen für das GPXFormat.
type: docs
weight: 370
url: /de/net/aspose.gis.formats.gpx/gpxoptions/
---
## GpxOptions class

Treiberspezifische Optionen für das GPX-Format.
...
| Name | Beschreibung |
| --- | --- |
| [GpxOptions](gpxoptions/)() | Neue Instanz erstellen. |
...
| [MAttribute](../../aspose.gis.formats.gpx/gpxoptions/mattribute/) { get; set; } | Legt fest, welches GPX-Attribut als 'M'-Koordinate von Wegpunkten, Routenpunkten und Trackpunkten exportiert wird. Das Verhalten ist gleich mit[`ZAttribute`](./zattribute/) , standardmäßig auf`null` . |
...
| [NestedAttributeSeparator](../../aspose.gis.formats.gpx/gpxoptions/nestedattributeseparator/) { get; } | Eine Zeichenfolge zum Trennen des verschachtelten Attributnamens und seiner Indizes. Standardmäßig doppelter Unterstrich "__". |
| [ReadNestedAttributes](../../aspose.gis.formats.gpx/gpxoptions/readnestedattributes/) { get; set; } | Legt fest, ob GPX-Punkte wie „trkpt“ und „rtept“ innere Attribute enthalten und gelesen werden sollen. Standardmäßig auf`false` . |
