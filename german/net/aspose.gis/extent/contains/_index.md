...
description: Bestimmt ob diese Ausdehnung eine durch die Argumente definierte Koordinate enthält.
type: docs
weight: 120
...
Koordinaten, die sich an den Grenzen davon befinden[`Extent`](../../extent) are davon als eingeschlossen angesehen[`Extent`](../../extent) .
...
Koordinaten, die sich an den Grenzen davon befinden[`Extent`](../../extent) are davon als eingeschlossen angesehen[`Extent`](../../extent) . Aus diesem Grund wird davon ausgegangen, dass gleiche Extents einander enthalten.
