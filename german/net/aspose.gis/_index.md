...
| Klasse | Beschreibung |
| --- | --- |
| [AbstractPath](./abstractpath) | Ein`AbstrakterPfad` ist eine Basisklasse für Klassen, die einen eindeutigen Ort in einer Umgebung angeben, die einem Dateisystem ähnlich ist, wie unter anderem ein lokales Dateisystem, ein entfernter Dateispeicher oder ein ZIP-Archiv. |
