...
description: PrecisionModel./precisionmodel gibt eine Anzahl signifikanter Stellen in einer Koordinate an.
type: docs
weight: 1210
...
Es gibt zwei Arten von PrecisionModel:  Genau[`PrecisionModel`](../precisionmodel) (alle Ziffern sind signifikant); Gerundet[`PrecisionModel`](../precisionmodel) (Einige Anzahl von Ziffern sind signifikant). A[`PrecisionModel`](../precisionmodel) eingestellt werden kann[`VectorLayer`](../vectorlayer) über[`DriverOptions`](../driveroptions) um Koordinaten beim Schreiben oder Lesen von Geometrien zu runden.
