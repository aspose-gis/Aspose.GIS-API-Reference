...
description: Aspose.Gis.DriverOptions klas. Optionen für aDriver .
type: docs
weight: 100
url: /de/net/aspose.gis/driveroptions/
---
## DriverOptions class

Optionen für a[`Driver`](../driver/) .
...
| [DeleteNearPointsDistance](../../aspose.gis/driveroptions/deletenearpointsdistance/) { get; set; } | Bestimmt Entfernung für[`DeleteNearPoints`](./deletenearpoints/) . Standardmäßig auf`0` . |
...
| [SimplifySegmentsDistance](../../aspose.gis/driveroptions/simplifysegmentsdistance/) { get; set; } | Bestimmt Entfernung für[`SimplifySegments`](./simplifysegments/) . Standardmäßig auf`0` . |
