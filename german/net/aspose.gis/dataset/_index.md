...
description: Ein Datensatz ist die Sammlung vonVectorLayer./vectorlayer Instanzen.
type: docs
weight: 70
...
| [Dispose](../../aspose.gis/dataset/dispose)() | Gibt die Ressourcen frei, die von verwendet werden[`Dataset`](../dataset) . |
