...
description: Aspose.Gis.VectorLayer klas. Stellt eine Vektorebene dar. Eine Vektorebene ist eine Sammlung geografischer Merkmale die in einer Datei gespeichert sind.
type: docs
weight: 2320
...
| Name | Beschreibung |
| --- | --- |
| override [Attributes](../../aspose.gis/vectorlayer/attributes/) { get; } | Ruft die Sammlung von benutzerdefinierten Attributen für Features in this ab`VectorLayer` . |
...
| [Add](../../aspose.gis/vectorlayer/add/#add)(Feature) | Fügt dem Layer ein neues Feature hinzu, falls vom unterstützt`VectorLayer` S[`Driver`](./driver/) . |
| virtual [Add](../../aspose.gis/vectorlayer/add/#add_1)(Feature, IFeatureStyle) | Fügt dem Layer ein neues Feature mit dem angegebenen Stil hinzu, sofern vom unterstützt`VectorLayer` S[`Driver`](./driver/) . |
| [AsInMemory](../../aspose.gis/vectorlayer/asinmemory/)() | Erstellen Sie einen Ebenenklon im InMemory-Format. |
...
| [CopyAttributes](../../aspose.gis/vectorlayer/copyattributes/#copyattributes)(FeaturesSequence) | Kopiert Attribute von other`VectorLayer` zu diesem. |
| [CopyAttributes](../../aspose.gis/vectorlayer/copyattributes/#copyattributes_1)(FeaturesSequence, IAttributesConverter) | Kopiert Attribute von other`VectorLayer` zu diesem. |
| [Dispose](../../aspose.gis/vectorlayer/dispose/)() | Gibt die Ressourcen frei, die von verwendet werden`VectorLayer` . |
| override [Equals](../../aspose.gis/vectorlayer/equals/)(object) | Bestimmt, ob das angegebene Objekt gleich dem aktuellen Objekt ist. |
