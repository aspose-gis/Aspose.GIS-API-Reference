...
description: Ruft den Wert eines Attributs ab.
type: docs
weight: 30
...
Wenn der Layer nicht erfordert, dass seine Features Werte für alle Attribute aufweisen, die für den Layer definiert sind, kann diese Methode fehlschlagenInvalidOperationExceptionwenn ein fehlender Wert angefordert wird. Wenn Sie mit solchen Ebenen arbeiten, ziehen Sie die Verwendung von in Betracht[`GetValueOrDefault`](../getvalueordefault) .
