...
description: Überprüft ob der Attributwert in dieser Funktion festgelegt ist.
type: docs
weight: 90
...
`true` wenn der Wert für das angegebene Attribut gesetzt ist; Andernfalls,`false` .
