...
description: Aspose.Gis.Formats.MapInfoInterchange.MapInfoInterchangeOptions klas. Treiberspezifische Optionen für das MapInfo InterchangeFormat.
type: docs
weight: 590
url: /de/net/aspose.gis.formats.mapinfointerchange/mapinfointerchangeoptions/
---
## MapInfoInterchangeOptions class

Treiberspezifische Optionen für das MapInfo Interchange-Format.
...
| Name | Beschreibung |
| --- | --- |
| [MapInfoInterchangeOptions](mapinfointerchangeoptions/)() | Neue Instanz erstellen. |
...
| [TextStringAttribute](../../aspose.gis.formats.mapinfointerchange/mapinfointerchangeoptions/textstringattribute/) { get; set; } | Gibt den Namen des Attributs an, das den Text des grafischen Objekts „Text“ darstellt. |
