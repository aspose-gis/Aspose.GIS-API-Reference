...
description: Aspose.Gis.Formats.OsmXml.OsmXmlOptions klas. Treiberspezifische Optionen für das OSMXMLFormat.
type: docs
weight: 630
url: /de/net/aspose.gis.formats.osmxml/osmxmloptions/
---
## OsmXmlOptions class
...
| Name | Beschreibung |
| --- | --- |
| [OsmXmlOptions](osmxmloptions/)() | Neue Instanz erstellen. |
...
| [ReportAllNodes](../../aspose.gis.formats.osmxml/osmxmloptions/reportallnodes/) { get; set; } | Alle Knoten als Features melden, auch wenn sie keine signifikanten Tags haben. |
| [ReportAllWays](../../aspose.gis.formats.osmxml/osmxmloptions/reportallways/) { get; set; } | Melden Sie alle Wege als Features, auch wenn sie keine signifikanten Tags oder keine Knoten haben. |
| [ReportCommonAttributes](../../aspose.gis.formats.osmxml/osmxmloptions/reportcommonattributes/) { get; set; } | Gemeinsame OSM-Attribute melden: sichtbar, Version, Änderungssatz, Zeitstempel, Benutzer und UID. Gemeinsame Attribute werden als Funktionsattribute mit dem Präfix "osm_" gemeldet, z. B. osm_user, osm_timestamp usw. |
