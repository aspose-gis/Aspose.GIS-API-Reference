...
description: Name des ObjektIDFelds.
type: docs
weight: 60
...
Dies ist eine Erstellungsoption und wirkt sich nicht auf das Lesen aus. Definiert den Namen des Objekt-ID-Felds (Spalte). Standardmäßig „OBJECTID“. Wenn ein Attribut vorhanden ist[`Attributes`](../../../aspose.gis/vectorlayer/attributes) hat name gleich dem Wert dieser Eigenschaft, dann wird dieses Attribut umbenannt.
