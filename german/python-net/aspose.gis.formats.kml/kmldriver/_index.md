...
type: docs
weight: 50
url: /de/python-net/aspose.gis.formats.kml/kmldriver/
---
...
| [open_as_kml_layer(path, options)](#open_as_kml_layer_path_options_18) | Öffnet eine Kml‑Ebene zum Lesen. |
...
| :- | :- | :- |
| path | string | Pfad zur Datei. |
| options | [KmlOptions](/psd/python-net/aspose.gis.formats.kml/kmloptions) | Treiber-spezifische Optionen. |
...
Öffnet eine Kml‑Ebene zum Lesen.
...
| Typ | Beschreibung |
| :- | :- |
| [KmlLayer](/psd/python-net/aspose.gis.formats.kml/kmllayer) | KmlLayer mit spezifischen Feldern |
