...
type: docs
weight: 140
url: /de/python-net/aspose.gis.formats.kml/kmllayer/
---
...
| driver | [Driver](/psd/python-net/aspose.gis/driver) | r | Ermittelt den [KmlLayer.driver](/psd/python-net/aspose.gis.formats.kml/kmllayer/), der diese Ebene erstellt hat. |
| features | [Feature[]](/psd/python-net/aspose.gis/feature) | r | Ermittelt die Liste der Features. |
...
| ground_overlay_list | System.Collections.Generic.List<Aspose.Gis.Formats.Kml.SpecificFields.KmlGroundOverlayInfo> | r | Liste von KmlGroundOverlayInfo aus GroundOverlay-Knoten |
| network_link_list | System.Collections.Generic.List<Aspose.Gis.Formats.Kml.SpecificFields.KmlNetworkLinkInfo> | r | Liste von KmlNetworkLinkInfo aus NetworkLink-Knoten |
| region_list | System.Collections.Generic.List<Aspose.Gis.Formats.Kml.SpecificFields.KmlRegionInfo> | r | Liste von KmlRegionInfo aus Region-Knoten |
| spatial_reference_system | [SpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem/) | r | Ermittelt das räumliche Referenzsystem dieser Ebene. Für KML ist dies immer WGS84. |
## **Methods**
| **Name** | **Beschreibung** |
| :- | :- |
