...
type: docs
weight: 20
url: /de/python-net/aspose.gis.formats.filegdb/filegdbdriver/
---
...
| [create_dataset(path, options)](#create_dataset_path_options_5) | Erstellt einen Datensatz. |
| [create_dataset(path, options)](#create_dataset_path_options_6) | Erstellt einen Datensatz. |
| [create_layer(path)](#create_layer_path_7) | Erstellt das Layer und öffnet es zum Anhängen. |
| [create_layer(path)](#create_layer_path_8) | Erstellt das Layer und öffnet es zum Anhängen. |
...
| [create_layer(path, options)](#create_layer_path_options_11) | Erstellt eine Ebene und öffnet sie zum Hinzufügen neuer Features. |
| [create_layer(path, options, spatial_reference_system)](#create_layer_path_options_spatial_reference_system_12) | Erstellt eine Ebene und öffnet sie zum Anhängen. |
| [create_layer(path, options, spatial_reference_system)](#create_layer_path_options_spatial_reference_system_13) | Erstellt eine Ebene und öffnet sie zum Anhängen. |
| [create_layer(path, options, spatial_reference_system)](#create_layer_path_options_spatial_reference_system_14) | Erstellt eine Ebene und öffnet sie zum Anhängen. |
| [create_layer(path, options, spatial_reference_system)](#create_layer_path_options_spatial_reference_system_15) | Erstellt eine Ebene und öffnet sie zum Anhängen. |
| [create_layer(path, spatial_reference_system)](#create_layer_path_spatial_reference_system_16) | Erstellt das Layer und öffnet es zum Anhängen. |
| [create_layer(path, spatial_reference_system)](#create_layer_path_spatial_reference_system_17) | Erstellt das Layer und öffnet es zum Anhängen. |
| [edit_layer(path, options)](#edit_layer_path_options_18) | Öffnet eine Ebene zum Bearbeiten. |
| [edit_layer(path, options)](#edit_layer_path_options_19) | Öffnet eine Ebene zum Bearbeiten. |
| [open_dataset(path)](#open_dataset_path_20) | Öffnet den Datensatz. |
| [open_dataset(path)](#open_dataset_path_21) | Öffnet den Datensatz. |
| [open_dataset(path, options)](#open_dataset_path_options_22) | Öffnet den Datensatz. |
| [open_dataset(path, options)](#open_dataset_path_options_23) | Öffnet den Datensatz. |
| [open_dataset(path, options)](#open_dataset_path_options_24) | Öffnet den Datensatz. |
| [open_dataset(path, options)](#open_dataset_path_options_25) | Öffnet den Datensatz. |
| [open_layer(path)](#open_layer_path_26) | Öffnet die Ebene zum Lesen. |
| [open_layer(path)](#open_layer_path_27) | Öffnet die Ebene zum Lesen. |
| [open_layer(path, options)](#open_layer_path_options_28) | Öffnet eine Ebene zum Lesen. |
| [open_layer(path, options)](#open_layer_path_options_29) | Öffnet eine Ebene zum Lesen. |
| [open_layer(path, options)](#open_layer_path_options_30) | Öffnet eine Ebene zum Lesen. |
| [open_layer(path, options)](#open_layer_path_options_31) | Öffnet eine Ebene zum Lesen. |
| [supports_spatial_reference_system(spatial_reference_system)](#supports_spatial_reference_system_spatial_reference_system_32) | Bestimmt, ob das angegebene räumliche Referenzsystem vom Treiber unterstützt wird. |
...
| :- | :- | :- |
| path | string | Pfad zum Datensatz. |
| options | [FileGdbOptions](/psd/python-net/aspose.gis.formats.filegdb/filegdboptions) | Treiber-spezifische Optionen. |
