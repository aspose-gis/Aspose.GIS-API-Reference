...
type: docs
weight: 20
url: /de/python-net/aspose.gis.formats.geopackage/geopackagedriver/
---
...
| **Name** | **Beschreibung** |
| :- | :- |
| [GeoPackageDriver()](#GeoPackageDriver__1) | Initialisiert eine neue Instanz der GeoPackageDriver Klasse |
## **Properties**
...
| [create_layer(path, options, spatial_reference_system)](#create_layer_path_options_spatial_reference_system_9) | Erstellt das Layer und öffnet es zum Anhängen. |
| [create_layer(path, options, spatial_reference_system)](#create_layer_path_options_spatial_reference_system_10) | Erstellt das Layer und öffnet es zum Anhängen. |
...
| [open_dataset(path, options)](#open_dataset_path_options_19) | Öffnet den Datensatz. |
| [open_layer(path)](#open_layer_path_20) | Öffnet die Ebene zum Lesen. |
| [open_layer(path)](#open_layer_path_21) | Öffnet die Ebene zum Lesen. |
| [open_layer(path, options)](#open_layer_path_options_22) | Öffnet die Ebene zum Lesen. |
| [open_layer(path, options)](#open_layer_path_options_23) | Öffnet die Ebene zum Lesen. |
...
Initialisiert eine neue Instanz der GeoPackageDriver Klasse
...
| :- | :- | :- |
| path | [AbstractPath](/psd/python-net/aspose.gis/abstractpath) | Pfad zum Datensatz. |
| options | [GeoPackageOptions](/psd/python-net/aspose.gis.formats.geopackage/geopackageoptions) | Treiber-spezifische Optionen. |

**Returns**

| Typ | Beschreibung |
| :- | :- |
| [GeoPackageDataset](/psd/python-net/aspose.gis.formats.geopackage/geopackagedataset) | Eine Instanz von [Dataset](/psd/python-net/aspose.gis/dataset/). |
...
| Typ | Beschreibung |
| :- | :- |
| bool | Boolescher Wert, der angibt, ob das angegebene räumliche Referenzsystem vom Treiber unterstützt wird.<br/>            <see langword=\"null\" /> wird von jedem Treiber als unterstützt betrachtet. |
