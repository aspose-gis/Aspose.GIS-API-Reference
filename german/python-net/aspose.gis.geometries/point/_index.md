...
type: docs
weight: 300
url: /de/python-net/aspose.gis.geometries/point/
---
...
| **Name** | **Beschreibung** |
| :- | :- |
| [Point()](#Point__1) | Initialisiert eine neue Instanz der [Point](/psd/python-net/aspose.gis.geometries/point/) Klasse. |
| [Point(other)](#Point_other_2) | Initialisiert eine neue Instanz der [Point](/psd/python-net/aspose.gis.geometries/point/) Klasse. |
| [Point(x, y)](#Point_x_y_3) | Initialisiert eine neue Instanz der [Point](/psd/python-net/aspose.gis.geometries/point/) Klasse. |
| [Point(x, y, z)](#Point_x_y_z_4) | Initialisiert eine neue Instanz der [Point](/psd/python-net/aspose.gis.geometries/point/) Klasse. |
| [Point(x, y, z, m)](#Point_x_y_z_m_5) | Initialisiert eine neue Instanz der [Point](/psd/python-net/aspose.gis.geometries/point/) Klasse. |
## **Properties**
...
| m | double | r/w | Liest oder setzt einen Wert für die m-Koordinate. |
...
| x | double | r/w | Liest oder setzt einen Wert für die x-Koordinate. |
| y | double | r/w | Liest oder setzt einen Wert für die y-Koordinate. |
| z | double | r/w | Liest oder setzt einen Wert für die z-Koordinate. |
## **Methods**
| **Name** | **Beschreibung** |
| :- | :- |
...
| [from_binary(wkb)](#from_binary_wkb_15) | Erstellt eine Geometrie aus ihrer Well-Known-Binary-Darstellung. |
| [from_binary(wkb, spatial_reference_system)](#from_binary_wkb_spatial_reference_system_16) | Erstellt eine Geometrie aus ihrer Well-Known-Binary-Darstellung. |
| [from_text(wkt)](#from_text_wkt_17) | Erstellt eine Geometrie aus ihrer Well-Known-Text-Darstellung. |
| [from_text(wkt, spatial_reference_system)](#from_text_wkt_spatial_reference_system_18) | Erstellt eine Geometrie aus ihrer Well-Known-Text-Darstellung. |
| [get_area()](#get_area__19) | Berechnet die Fläche dieser Geometrie. |
| [get_buffer(distance, quadrant_segments)](#get_buffer_distance_quadrant_segments_20) | Berechnet einen Pufferbereich um diese Geometrie. |
| [get_centroid()](#get_centroid__21) | Berechnet den Schwerpunkt dieser Geometrie. |
| [get_convex_hull()](#get_convex_hull__22) | Berechnet die konvexe Hülle dieser Geometrie. |
| [get_distance_to(other)](#get_distance_to_other_23) | Berechnet den minimalen Abstand zwischen dieser Geometrie und einer angegebenen Geometrie. |
| [get_extent()](#get_extent__24) | Berechnet und gibt den begrenzenden Umfang dieser Geometrie zurück. |
| [get_length()](#get_length__25) | Berechnet die Länge dieser Geometrie. |
| [intersection(other)](#intersection_other_26) | Erstellt eine Schnittmenge zwischen dieser Geometrie und einer angegebenen Geometrie. |
| [intersects(extent)](#intersects_extent_27) | Bestimmt, ob diese Geometrie einen angegebenen Umfang schneidet. |
| [intersects(other)](#intersects_other_28) | Bestimmt, ob diese Geometrie und eine angegebene Geometrie sich schneiden. |
| [overlaps(other)](#overlaps_other_29) | Bestimmt, ob diese Geometrie mit einer angegebenen Geometrie überlappt. |
| [relate(other, intersection_pattern_matrix)](#relate_other_intersection_pattern_matrix_30) | Bestimmt, ob die DE-9IM-Schnittmatrix dieser Geometrie und einer angegebenen Geometrie dem bereitgestellten Muster entspricht. |
| [replace_polygons_by_lines()](#replace_polygons_by_lines__31) | Erhält Polygone, die als Linien dieser Geometrie dargestellt werden. |
| [round_m(digits)](#round_m_digits_32) | Rundet die M-Koordinate auf eine angegebene Anzahl von Nachkommastellen. |
| [round_xy(digits)](#round_xy_digits_33) | Rundet die X- und Y-Koordinaten auf eine angegebene Anzahl von Nachkommastellen. |
| [round_z(digits)](#round_z_digits_34) | Rundet die Z-Koordinate auf eine angegebene Anzahl von Nachkommastellen. |
| set_empty() | Macht diese [Geometry](/psd/python-net/aspose.gis.geometries/geometry/) leer. |
| [spatially_contains(other)](#spatially_contains_other_35) | Bestimmt, ob diese Geometrie räumlich eine angegebene Geometrie enthält. |
| [spatially_equals(other)](#spatially_equals_other_36) | Bestimmt, ob diese Geometrie räumlich einer angegebenen Geometrie gleich ist. |
| [sym_difference(other)](#sym_difference_other_37) | Erstellt die symmetrische Differenz zwischen dieser Geometrie und einer angegebenen Geometrie. |
| [to_editable()](#to_editable__38) | Erhält eine editierbare Kopie dieser Geometrie. |
| [to_linear_geometry()](#to_linear_geometry__39) | Erhält eine approximative oder äquivalente nicht gekrümmte Version dieser Geometrie unter Verwendung der Standard-<c>tolerance</c>. |
| [to_linear_geometry(tolerance)](#to_linear_geometry_tolerance_40) | Erhält eine approximative oder äquivalente nicht gekrümmte Version dieser Geometrie unter Verwendung der angegebenen <c>tolerance</c>. |
| [to_svg(extent)](#to_svg_extent_41) | Übersetzt diese Geometrie in eine Svg-Darstellung. |
| [touches(other)](#touches_other_42) | Bestimmt, ob diese Geometrie und eine angegebene Geometrie sich berühren. |
| [union(other)](#union_other_43) | Vereint diese Geometrie mit einer angegebenen Geometrie. |
| [union(other)](#union_other_44) | Vereint diese Geometrie mit einer angegebenen Geometrie. |
| [within(extent)](#within_extent_45) | Bestimmt, ob diese Geometrie innerhalb eines angegebenen Ausdehnungsbereichs liegt. |
| [within(other)](#within_other_46) | Bestimmt, ob diese Geometrie innerhalb einer angegebenen Geometrie liegt. |
...
Initialisiert eine neue Instanz der [Point](/psd/python-net/aspose.gis.geometries/point/) Klasse.
...
| :- | :- | :- |
| other | [IPoint](/psd/python-net/aspose.gis.geometries/ipoint) | Das andere [IPoint](/psd/python-net/aspose.gis.geometries/ipoint/) zum Kopieren von Daten. |
...
| Typ | Beschreibung |
| :- | :- |
| [Point](/psd/python-net/aspose.gis.geometries/point) | Eine editierbare Kopie dieser Geometrie. |
...
| Typ | Beschreibung |
| :- | :- |
| [IGeometry](/psd/python-net/aspose.gis.geometries/igeometry) | Eine Geometrie, die keine Kurvengeometrien enthält. Dies entspricht <DOM Element: class at 0x2a1791a70d0>.IGeometry.to_linear_geometry()(float) mit<br/>            dem Standard-<c>tolerance</c>. Der Standard-<c>tolerance</c> wird durch [IGeometry.spatial_reference_system](/psd/python-net/aspose.gis.geometries/igeometry/) dieser Geometrie definiert:<br/>            <ul><br/>            <li> Für projizierte SRS beträgt die Toleranz 0,001 Meter (in SRS-Einheiten) </li><br/>            <li> Für geografische SRS beträgt die Toleranz <c>1e-5</c> Grad (in SRS-Einheiten) </li><br/>            <li> Für unbekannte SRS beträgt die Toleranz <c>1e-5</c> </li><br/>            </ul><br/>            Weitere Details zu den angewandten Transformationen finden Sie in der Spezifikation von <DOM Element: class at 0x2a1791a70d0>.IGeometry.to_linear_geometry()(float). |
...
| Parameter | Typ | Beschreibung |
| :- | :- | :- |
| Toleranz | double | Das zu verwendende <c>tolerance</c>. Das Ergebnis ist garantiert weniger als <c>tolerance</c> vom gekrümmten Geometrieobjekt entfernt,<br/>            es sei denn, die Anzahl der Punkte, die zur Lineariserung der Geometrie benötigt werden, überschreitet das pro Quadrant maximal zulässige<br/>            von derzeit 10000 Punkten. |

**Returns**

| Typ | Beschreibung |
| :- | :- |
| [IGeometry](/psd/python-net/aspose.gis.geometries/igeometry) | Eine Geometrie, die keine Kurvengeometrien enthält. Die folgenden Transformationen werden angewendet:<br/>            <ul><br/>            <li> [GeometryType.CIRCULAR_STRING](/psd/python-net/aspose.gis.geometries/geometrytype/)s werden linearisiert<br/>            (umgewandelt in [GeometryType.LINE_STRING](/psd/python-net/aspose.gis.geometries/geometrytype/)s mit angegebenem <paramref name=\"tolerance\" />) </li><br/>            <li> [GeometryType.COMPOUND_CURVE](/psd/python-net/aspose.gis.geometries/geometrytype/)s werden zu <c>LineString</c>s zusammengeführt </li><br/>            <li> [GeometryType.CURVE_POLYGON](/psd/python-net/aspose.gis.geometries/geometrytype/)s werden in [GeometryType.POLYGON](/psd/python-net/aspose.gis.geometries/geometrytype/)s umgewandelt </li><br/>            <li> [GeometryType.MULTI_CURVE](/psd/python-net/aspose.gis.geometries/geometrytype/)s werden in [GeometryType.MULTI_LINE_STRING](/psd/python-net/aspose.gis.geometries/geometrytype/)s umgewandelt </li><br/>            <li> [GeometryType.MULTI_SURFACE](/psd/python-net/aspose.gis.geometries/geometrytype/)s werden in [GeometryType.MULTI_POLYGON](/psd/python-net/aspose.gis.geometries/geometrytype/)s umgewandelt </li><br/>            </ul><br/>            Infolgedessen ist [IGeometry.has_curve_geometry](/psd/python-net/aspose.gis.geometries/igeometry/) der Ausgabegometrie <see langword=\"false\" />. |
