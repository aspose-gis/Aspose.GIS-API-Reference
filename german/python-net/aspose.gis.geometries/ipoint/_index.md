...
type: docs
weight: 200
url: /de/python-net/aspose.gis.geometries/ipoint/
---
...
| m | double | r | Gibt die m-Koordinate zurück. |
...
| x | double | r | Gibt die x-Koordinate zurück. |
| y | double | r | Gibt die y-Koordinate zurück. |
| z | double | r | Gibt die z-Koordinate zurück. |
## **Methods**
| **Name** | **Beschreibung** |
| :- | :- |
