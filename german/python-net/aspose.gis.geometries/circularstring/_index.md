...
type: docs
weight: 10
url: /de/python-net/aspose.gis.geometries/circularstring/
---
...
| **Name** | **Beschreibung** |
| :- | :- |
| [CircularString()](#CircularString__1) | Initialisiert eine neue Instanz der Klasse [CircularString](/psd/python-net/aspose.gis.geometries/circularstring/). |
| [CircularString(collection)](#CircularString_collection_2) | Initialisiert eine neue Instanz der Klasse [CircularString](/psd/python-net/aspose.gis.geometries/circularstring/). |
| [CircularString(other)](#CircularString_other_3) | Initialisiert eine neue Instanz der Klasse [CircularString](/psd/python-net/aspose.gis.geometries/circularstring/). |
## **Properties**
...
| **Name** | **Beschreibung** |
| :- | :- |
| [add_point(point)](#add_point_point_1) | Fügt einen Punkt am Ende der Kreislinie hinzu. |
| [add_point(x, y)](#add_point_x_y_2) | Fügt einen Punkt am Ende der Kreislinie hinzu. |
| [add_point(x, y, z)](#add_point_x_y_z_3) | Fügt einen Punkt am Ende der Kreislinie hinzu. |
| [add_point(x, y, z, m)](#add_point_x_y_z_m_4) | Fügt einen Punkt am Ende der Kreislinie hinzu. |
...
| [overlaps(other)](#overlaps_other_33) | Bestimmt, ob diese Geometrie mit einer angegebenen Geometrie überlappt. |
| [relate(other, intersection_pattern_matrix)](#relate_other_intersection_pattern_matrix_34) | Bestimmt, ob die DE-9IM-Schnittmatrix dieser Geometrie und einer angegebenen Geometrie dem bereitgestellten Muster entspricht. |
...
| reverse() | Kehrt die Reihenfolge der Punkte in dieser [CircularString](/psd/python-net/aspose.gis.geometries/circularstring/) um. |
...
Initialisiert eine neue Instanz der Klasse [CircularString](/psd/python-net/aspose.gis.geometries/circularstring/).
...
| Parameter | Typ | Beschreibung |
| :- | :- | :- |
| other | [ICircularString](/psd/python-net/aspose.gis.geometries/icircularstring) | Der andere String, aus dem Daten kopiert werden sollen. |
...
Fügt einen Punkt am Ende der Kreislinie hinzu.
...
| Typ | Beschreibung |
| :- | :- |
| [CircularString](/psd/python-net/aspose.gis.geometries/circularstring) | Eine editierbare Kopie dieser Geometrie. |
