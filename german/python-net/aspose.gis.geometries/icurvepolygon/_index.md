---
title: "ICurvePolygon Klasse"
type: docs
weight: 100
url: /de/python-net/aspose.gis.geometries/icurvepolygon/
---
...
| exterior_ring | [ICurve](/psd/python-net/aspose.gis.geometries/icurve) | r | Liefert den äußeren Ring. |
...
| [get_interior_ring(index)](#get_interior_ring_index_21) | Liefert den inneren Ring anhand seines Index. |
| [get_length()](#get_length__22) | Berechnet die Länge dieser Geometrie. |
| [get_point_on_surface()](#get_point_on_surface__23) | Findet einen Punkt, der garantiert auf dieser Oberfläche liegt. |
| [intersection(other)](#intersection_other_24) | Erstellt eine Schnittmenge zwischen dieser Geometrie und einer angegebenen Geometrie. |
| [intersects(extent)](#intersects_extent_25) | Bestimmt, ob diese Geometrie einen angegebenen Umfang schneidet. |
| [intersects(other)](#intersects_other_26) | Bestimmt, ob diese Geometrie und eine angegebene Geometrie sich schneiden. |
| [overlaps(other)](#overlaps_other_27) | Bestimmt, ob diese Geometrie mit einer angegebenen Geometrie überlappt. |
| [relate(other, intersection_pattern_matrix)](#relate_other_intersection_pattern_matrix_28) | Bestimmt, ob die DE-9IM-Schnittmatrix dieser Geometrie und einer angegebenen Geometrie dem bereitgestellten Muster entspricht. |
| [replace_polygons_by_lines()](#replace_polygons_by_lines__29) | Erhält Polygone, die als Linien dieser Geometrie dargestellt werden. |
| [spatially_contains(other)](#spatially_contains_other_30) | Bestimmt, ob diese Geometrie räumlich eine angegebene Geometrie enthält. |
| [spatially_equals(other)](#spatially_equals_other_31) | Bestimmt, ob diese Geometrie räumlich einer angegebenen Geometrie gleich ist. |
| [sym_difference(other)](#sym_difference_other_32) | Erstellt die symmetrische Differenz zwischen dieser Geometrie und einer angegebenen Geometrie. |
| [to_editable()](#to_editable__33) | Erhält eine editierbare Kopie dieser Geometrie. |
| [to_linear_geometry()](#to_linear_geometry__34) | Erhält eine approximative oder äquivalente nicht gekrümmte Version dieser Geometrie unter Verwendung der Standard-<c>tolerance</c>. |
| [to_linear_geometry(tolerance)](#to_linear_geometry_tolerance_35) | Erhält eine approximative oder äquivalente nicht gekrümmte Version dieser Geometrie unter Verwendung der angegebenen <c>tolerance</c>. |
| [touches(other)](#touches_other_36) | Bestimmt, ob diese Geometrie und eine angegebene Geometrie sich berühren. |
| [union(other)](#union_other_37) | Vereint diese Geometrie mit einer angegebenen Geometrie. |
| [union(other)](#union_other_38) | Vereint diese Geometrie mit einer angegebenen Geometrie. |
| [within(extent)](#within_extent_39) | Bestimmt, ob diese Geometrie innerhalb eines angegebenen Ausdehnungsbereichs liegt. |
| [within(other)](#within_other_40) | Bestimmt, ob diese Geometrie innerhalb einer angegebenen Geometrie liegt. |
...
| Typ | Beschreibung |
| :- | :- |
| [ICurve](/psd/python-net/aspose.gis.geometries/icurve) | Der Innenringwert |
...
Findet einen Punkt, der garantiert auf dieser Oberfläche liegt.

**Returns**

| Typ | Beschreibung |
| :- | :- |
| [IPoint](/psd/python-net/aspose.gis.geometries/ipoint) | Ein Punkt auf dieser Oberfläche. Ein leerer Punkt, wenn diese Oberfläche kein Inneres hat. |
...
| Typ | Beschreibung |
| :- | :- |
| [Surface](/psd/python-net/aspose.gis.geometries/surface) | Eine editierbare Kopie dieser Geometrie. |
