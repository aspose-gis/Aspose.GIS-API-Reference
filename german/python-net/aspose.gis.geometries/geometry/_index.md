---
title: "Geometry Klasse"
type: docs
weight: 50
url: /de/python-net/aspose.gis.geometries/geometry/
---
...
| dimension | [GeometryDimension](/psd/python-net/aspose.gis.geometries/geometrydimension) | r | Liefert die topologische Dimension dieser [Geometry](/psd/python-net/aspose.gis.geometries/geometry/).<br/>            Wenn die Dimension unbekannt ist (z. B. für eine leere GEOMETRYCOLLECTION) wird [GeometryDimension.POINT](/psd/python-net/aspose.gis.geometries/geometrydimension/) zurückgegeben. |
...
| Typ | Beschreibung |
| :- | :- |
| [Geometry](/psd/python-net/aspose.gis.geometries/geometry) | Eine editierbare Kopie dieser Geometrie. |
