...
type: docs
weight: 190
url: /de/python-net/aspose.gis.geometries/imultisurface/
---
...
| Typ | Beschreibung |
| :- | :- |
| [MultiSurface](/psd/python-net/aspose.gis.geometries/multisurface) | Eine editierbare Kopie dieser Geometrie. |
...
| Typ | Beschreibung |
| :- | :- |
| [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon) | Ein [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon/) das approximiert oder gleichwertig zu diesem [IMultiSurface](/psd/python-net/aspose.gis.geometries/imultisurface/) ist.<br/>            Dies ist das Äquivalent zu <DOM Element: class at 0x2a1792e8790>.IMultiSurface.to_linear_geometry()(float) mit<br/>            standardmäßig <c>tolerance</c>. Der Standardwert von <c>tolerance</c> ist abhängig von [SpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem/)<br/>            dieser Geometrie:<br/>            <ul><br/>            <li> Für projizierte SRS beträgt die Toleranz 0,001 Meter (in SRS-Einheiten) </li><br/>            <li> Für geografische SRS beträgt die Toleranz <c>1e-5</c> Grad (in SRS-Einheiten) </li><br/>            <li> Für unbekannte SRS beträgt die Toleranz <c>1e-5</c> </li><br/>            </ul><br/>            Weitere Details zu den angewendeten Transformationen finden Sie in der Spezifikation von <DOM Element: class at 0x2a1792e8790>.IMultiSurface.to_linear_geometry()(float). |
...
| Typ | Beschreibung |
| :- | :- |
| [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon) | Ein [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon/) das approximiert oder gleichwertig zu diesem [IMultiSurface](/psd/python-net/aspose.gis.geometries/imultisurface/) ist:<br/>             <ul><br/>             Wenn dieses Objekt selbst ein [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon/) ist, ist das Ergebnis diesem Objekt gleichwertig<br/>             Wenn dieses Objekt kein [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon/) ist – werden alle Flächen linearisiert und ein neues <c>IMultiPolygon</c> wird erstellt<br/>            </ul> |
