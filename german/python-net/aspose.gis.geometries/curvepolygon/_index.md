...
type: docs
weight: 40
url: /de/python-net/aspose.gis.geometries/curvepolygon/
---
...
| **Name** | **Beschreibung** |
| :- | :- |
| [CurvePolygon()](#CurvePolygon__1) | Initialisiert eine neue Instanz der [CurvePolygon](/psd/python-net/aspose.gis.geometries/curvepolygon/) Klasse. |
| [CurvePolygon(exterior_ring)](#CurvePolygon_exterior_ring_2) | Initialisiert eine neue Instanz der [CurvePolygon](/psd/python-net/aspose.gis.geometries/curvepolygon/) Klasse. |
| [CurvePolygon(exterior_ring, interior_rings)](#CurvePolygon_exterior_ring_interior_rings_3) | Initialisiert eine neue Instanz der [CurvePolygon](/psd/python-net/aspose.gis.geometries/curvepolygon/) Klasse. |
## **Properties**
...
| exterior_ring | [ICurve](/psd/python-net/aspose.gis.geometries/icurve) | r/w | Liefert den äußeren Ring. |
...
| [get_point_on_surface()](#get_point_on_surface__28) | Findet einen Punkt, der garantiert auf diesem gekrümmten Polygon liegt. |
...
Initialisiert eine neue Instanz der [CurvePolygon](/psd/python-net/aspose.gis.geometries/curvepolygon/) Klasse.
...
| :- | :- | :- |
| exterior_ring | [ICurve](/psd/python-net/aspose.gis.geometries/icurve) | Der äußere Ring. |
...
| :- | :- | :- |
| exterior_ring | [ICurve](/psd/python-net/aspose.gis.geometries/icurve) | Der äußere Ring. |
| interior_rings | System.Collections.Generic.IEnumerable<ICurve> | Die inneren Ringe. |
...
| Parameter | Typ | Beschreibung |
| :- | :- | :- |
| ring | [ICurve](/psd/python-net/aspose.gis.geometries/icurve) | Der hinzuzufügende Ring. |
...
| Typ | Beschreibung |
| :- | :- |
| [ICurve](/psd/python-net/aspose.gis.geometries/icurve) | Der innere Ring. |
...
Findet einen Punkt, der garantiert auf diesem gekrümmten Polygon liegt.

**Returns**

| Typ | Beschreibung |
| :- | :- |
| [IPoint](/psd/python-net/aspose.gis.geometries/ipoint) | Ein Punkt auf diesem gekrümmten Polygon. Ein leerer Punkt, wenn dieses gekrümmte Polygon kein Inneres hat. |
...
| Typ | Beschreibung |
| :- | :- |
| [CurvePolygon](/psd/python-net/aspose.gis.geometries/curvepolygon) | Eine editierbare Kopie dieser Geometrie. |
