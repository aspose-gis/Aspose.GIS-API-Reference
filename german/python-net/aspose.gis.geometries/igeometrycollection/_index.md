...
type: docs
weight: 120
url: /de/python-net/aspose.gis.geometries/igeometrycollection/
---
...
| Parameter | Typ | Beschreibung |
| :- | :- | :- |
| Toleranz | double | Das zu verwendende <c>tolerance</c>. Das Ergebnis ist garantiert weniger als <c>tolerance</c> von der<br/>            gekrümmten Geometrie entfernt, es sei denn, die für die Linearisierung der Geometrie erforderliche Punktzahl überschreitet das pro Quadranten maximale Limit,<br/>            das derzeit bei 10.000 Punkten liegt. |
