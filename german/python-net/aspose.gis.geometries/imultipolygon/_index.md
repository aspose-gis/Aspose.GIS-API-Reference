---
title: "IMultiPolygon-Klasse"
type: docs
weight: 180
url: /de/python-net/aspose.gis.geometries/imultipolygon/
---
...
| [get_point_on_surface()](#get_point_on_surface__22) | Findet einen Punkt, der garantiert auf einer der Oberflächen in dieser Sammlung liegt. |
| [intersection(other)](#intersection_other_23) | Erstellt eine Schnittmenge zwischen dieser Geometrie und einer angegebenen Geometrie. |
| [intersects(extent)](#intersects_extent_24) | Bestimmt, ob diese Geometrie einen angegebenen Umfang schneidet. |
| [intersects(other)](#intersects_other_25) | Bestimmt, ob diese Geometrie und eine angegebene Geometrie sich schneiden. |
| [overlaps(other)](#overlaps_other_26) | Bestimmt, ob diese Geometrie mit einer angegebenen Geometrie überlappt. |
| [relate(other, intersection_pattern_matrix)](#relate_other_intersection_pattern_matrix_27) | Bestimmt, ob die DE-9IM-Schnittmatrix dieser Geometrie und einer angegebenen Geometrie dem bereitgestellten Muster entspricht. |
| [replace_polygons_by_lines()](#replace_polygons_by_lines__28) | Erhält Polygone, die als Linien dieser Geometrie dargestellt werden. |
| [spatially_contains(other)](#spatially_contains_other_29) | Bestimmt, ob diese Geometrie räumlich eine angegebene Geometrie enthält. |
| [spatially_equals(other)](#spatially_equals_other_30) | Bestimmt, ob diese Geometrie räumlich einer angegebenen Geometrie gleich ist. |
| [sym_difference(other)](#sym_difference_other_31) | Erstellt die symmetrische Differenz zwischen dieser Geometrie und einer angegebenen Geometrie. |
| [to_editable()](#to_editable__32) | Erhält eine editierbare Kopie dieser Geometrie. |
| [to_linear_geometry()](#to_linear_geometry__33) | Erhält eine approximative oder äquivalente nicht gekrümmte Version dieser Geometrie unter Verwendung der Standard-<c>tolerance</c>. |
| [to_linear_geometry(tolerance)](#to_linear_geometry_tolerance_34) | Erhält eine approximative oder äquivalente nicht gekrümmte Version dieser Geometrie unter Verwendung der angegebenen <c>tolerance</c>. |
| [touches(other)](#touches_other_35) | Bestimmt, ob diese Geometrie und eine angegebene Geometrie sich berühren. |
...
| [within(extent)](#within_extent_38) | Bestimmt, ob diese Geometrie innerhalb eines angegebenen Ausdehnungsbereichs liegt. |
| [within(other)](#within_other_39) | Bestimmt, ob diese Geometrie innerhalb einer angegebenen Geometrie liegt. |
...
| Typ | Beschreibung |
| :- | :- |
| [MultiPolygon](/psd/python-net/aspose.gis.geometries/multipolygon) | Eine editierbare Kopie dieser Geometrie. |
