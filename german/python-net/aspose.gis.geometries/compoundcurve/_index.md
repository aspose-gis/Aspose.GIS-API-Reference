---
title: "CompoundCurve Klasse"
type: docs
weight: 20
url: /de/python-net/aspose.gis.geometries/compoundcurve/
---
...
| **Name** | **Beschreibung** |
| :- | :- |
| [CompoundCurve()](#CompoundCurve__1) | Initialisiert eine neue Instanz der [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/) Klasse. |
| [CompoundCurve(curves)](#CompoundCurve_curves_2) | Initialisiert eine neue Instanz der [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/) Klasse. |
| [CompoundCurve(other)](#CompoundCurve_other_3) | Initialisiert eine neue Instanz der [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/) Klasse. |
## **Properties**
...
| count | int | r | Gibt die Anzahl der Kurven im [ICompoundCurve](/psd/python-net/aspose.gis.geometries/icompoundcurve/) zurück. |
...
| is_closed | bool | r | Ermittelt einen Wert, der angibt, ob eine Kurve geschlossen ist. <br/>            Eine Kurve ist geschlossen, wenn ihr Startpunkt dem Endpunkt entspricht. |
...
| **Name** | **Beschreibung** |
| :- | :- |
| [add_curve(curve)](#add_curve_curve_1) | Fügt eine Kurve am Ende dieses [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/) hinzu. |
...
| [get_length()](#get_length__26) | Berechnet die Länge dieser Geometrie. |
| [intersection(other)](#intersection_other_27) | Erstellt eine Schnittmenge zwischen dieser Geometrie und einer angegebenen Geometrie. |
| [intersects(extent)](#intersects_extent_28) | Bestimmt, ob diese Geometrie einen angegebenen Umfang schneidet. |
| [intersects(other)](#intersects_other_29) | Bestimmt, ob diese Geometrie und eine angegebene Geometrie sich schneiden. |
| [overlaps(other)](#overlaps_other_30) | Bestimmt, ob diese Geometrie mit einer angegebenen Geometrie überlappt. |
| [relate(other, intersection_pattern_matrix)](#relate_other_intersection_pattern_matrix_31) | Bestimmt, ob die DE-9IM-Schnittmatrix dieser Geometrie und einer angegebenen Geometrie dem bereitgestellten Muster entspricht. |
| [replace_polygons_by_lines()](#replace_polygons_by_lines__32) | Erhält Polygone, die als Linien dieser Geometrie dargestellt werden. |
| reverse() | Kehrt dieses [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/) um. Das bedeutet – die Reihenfolge der Kurven und jede Kurve innerhalb dieses zusammengesetzten Kurvenobjekts umkehren. |
| [round_m(digits)](#round_m_digits_33) | Rundet die M-Koordinate auf eine angegebene Anzahl von Nachkommastellen. |
| [round_xy(digits)](#round_xy_digits_34) | Rundet die X- und Y-Koordinaten auf eine angegebene Anzahl von Nachkommastellen. |
| [round_z(digits)](#round_z_digits_35) | Rundet die Z-Koordinate auf eine angegebene Anzahl von Nachkommastellen. |
| set_empty() | Macht diese [Geometry](/psd/python-net/aspose.gis.geometries/geometry/) leer. |
| [spatially_contains(other)](#spatially_contains_other_36) | Bestimmt, ob diese Geometrie räumlich eine angegebene Geometrie enthält. |
| [spatially_equals(other)](#spatially_equals_other_37) | Bestimmt, ob diese Geometrie räumlich einer angegebenen Geometrie gleich ist. |
| [sym_difference(other)](#sym_difference_other_38) | Erstellt die symmetrische Differenz zwischen dieser Geometrie und einer angegebenen Geometrie. |
| [to_editable()](#to_editable__39) | Erhält eine editierbare Kopie dieser Geometrie. |
| [to_linear_geometry()](#to_linear_geometry__40) | Erhält eine approximative oder äquivalente nicht gekrümmte Version dieser Geometrie unter Verwendung der Standard-<c>tolerance</c>. |
| [to_linear_geometry(tolerance)](#to_linear_geometry_tolerance_41) | Erhält eine approximative oder äquivalente nicht gekrümmte Version dieser Geometrie unter Verwendung der angegebenen <c>tolerance</c>. |
| [to_svg(extent)](#to_svg_extent_42) | Übersetzt diese Geometrie in eine Svg-Darstellung. |
| [touches(other)](#touches_other_43) | Bestimmt, ob diese Geometrie und eine angegebene Geometrie sich berühren. |
| [union(other)](#union_other_44) | Vereint diese Geometrie mit einer angegebenen Geometrie. |
| [union(other)](#union_other_45) | Vereint diese Geometrie mit einer angegebenen Geometrie. |
| [within(extent)](#within_extent_46) | Bestimmt, ob diese Geometrie innerhalb eines angegebenen Ausdehnungsbereichs liegt. |
| [within(other)](#within_other_47) | Bestimmt, ob diese Geometrie innerhalb einer angegebenen Geometrie liegt. |
...
Initialisiert eine neue Instanz der [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/) Klasse.
...
| :- | :- | :- |
| Kurven | System.Collections.Generic.IEnumerable<ICurve> | Die Sammlung der Kurven. |
...
| Parameter | Typ | Beschreibung |
| :- | :- | :- |
| other | [ICompoundCurve](/psd/python-net/aspose.gis.geometries/icompoundcurve) | Die andere Linie, von der Daten kopiert werden. |
...
Fügt eine Kurve am Ende dieses [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/) hinzu.

**Parameters:**

| Parameter | Typ | Beschreibung |
| :- | :- | :- |
| curve | [ICurve](/psd/python-net/aspose.gis.geometries/icurve) | Kurve zum Hinzufügen. |
...
| Typ | Beschreibung |
| :- | :- |
| [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve) | Eine editierbare Kopie dieser Geometrie. |
