---
title: "PostGisOptions Klasse"
type: docs
weight: 20
url: /de/python-net/aspose.gis.formats.postgis/postgisoptions/
---
...
| **Name** | **Beschreibung** |
| :- | :- |
| [PostGisOptions()](#PostGisOptions__1) | Neue Instanz erstellen. |
## **Properties**
...
| spatial_reference_system_mode | [SpatialReferenceSystemMode](/psd/python-net/aspose.gis/spatialreferencesystemmode) | r/w | Bestimmt, wie das SRS unbekannter Geometrien für die Datenbank behandelt werden soll, wenn sie zur Ebene hinzugefügt werden.<br/>            Der Standardwert ist [SpatialReferenceSystemMode.THROW_EXCEPTION](/psd/python-net/aspose.gis/spatialreferencesystemmode/). |
