...
type: docs
weight: 10
url: /de/python-net/aspose.gis.formats.esrijson/esrijsondriver/
---
...
| :- | :- | :- |
| path | string | Pfad zur Datei. |
| options | [EsriJsonOptions](/psd/python-net/aspose.gis.formats.esrijson/esrijsonoptions) | Treiber-spezifische Optionen. |
