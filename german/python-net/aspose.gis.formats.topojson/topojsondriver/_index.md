...
type: docs
weight: 10
url: /de/python-net/aspose.gis.formats.topojson/topojsondriver/
---
...
| :- | :- | :- |
| path | string | Pfad zur Datei. |
| options | [TopoJsonOptions](/psd/python-net/aspose.gis.formats.topojson/topojsonoptions) | Treiber-spezifische Optionen. |
