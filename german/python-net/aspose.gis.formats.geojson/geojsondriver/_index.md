...
type: docs
weight: 10
url: /de/python-net/aspose.gis.formats.geojson/geojsondriver/
---
...
| :- | :- | :- |
| path | string | Pfad zur Datei. |
| options | [GeoJsonOptions](/psd/python-net/aspose.gis.formats.geojson/geojsonoptions) | Treiber-spezifische Optionen. |
