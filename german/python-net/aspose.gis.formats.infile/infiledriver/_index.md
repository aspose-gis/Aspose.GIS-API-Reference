...
type: docs
weight: 10
url: /de/python-net/aspose.gis.formats.infile/infiledriver/
---
...
| :- | :- | :- |
| path | string | Pfad zur Datei. |
| options | [InFileOptions](/psd/python-net/aspose.gis.formats.infile/infileoptions) | Treiber-spezifische Optionen. |
