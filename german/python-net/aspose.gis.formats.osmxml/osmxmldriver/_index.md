...
type: docs
weight: 10
url: /de/python-net/aspose.gis.formats.osmxml/osmxmldriver/
---
...
| :- | :- | :- |
| path | string | Pfad zur Datei. |
| options | [OsmXmlOptions](/psd/python-net/aspose.gis.formats.osmxml/osmxmloptions) | Treiber-spezifische Optionen. |
