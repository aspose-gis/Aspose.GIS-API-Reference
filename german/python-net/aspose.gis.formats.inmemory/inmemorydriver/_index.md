...
type: docs
weight: 10
url: /de/python-net/aspose.gis.formats.inmemory/inmemorydriver/
---
...
| [create_layer()](#create_layer__5) | Erstellt eine Ebene und öffnet sie zum Hinzufügen neuer Features. |
| [create_layer(features_sequence)](#create_layer_features_sequence_6) | Erstellt eine Ebene aus einer Feature‑Sequenz und öffnet sie zum Hinzufügen neuer Features. |
...
| [create_layer(path, options)](#create_layer_path_options_9) | Erstellt das Layer und öffnet es zum Anhängen. |
| [create_layer(path, options)](#create_layer_path_options_10) | Erstellt das Layer und öffnet es zum Anhängen. |
...
| [create_layer(path, spatial_reference_system)](#create_layer_path_spatial_reference_system_13) | Erstellt das Layer und öffnet es zum Anhängen. |
...
| [create_layer(spatial_reference_system)](#create_layer_spatial_reference_system_15) | Erstellt eine Ebene und öffnet sie zum Hinzufügen neuer Features. |
...
| [supports_spatial_reference_system(spatial_reference_system)](#supports_spatial_reference_system_spatial_reference_system_26) | Bestimmt, ob das angegebene räumliche Referenzsystem vom Treiber unterstützt wird. |
...
Erstellt eine Ebene aus einer Feature‑Sequenz und öffnet sie zum Hinzufügen neuer Features.
