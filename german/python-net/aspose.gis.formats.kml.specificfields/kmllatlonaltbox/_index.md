---
title: "KmlLatLonAltBox Klasse"
type: docs
weight: 30
url: /de/python-net/aspose.gis.formats.kml.specificfields/kmllatlonaltbox/
---
...
| Osten | double | r/w | Osten des 'LatLonBox'-Knotens. |
| max_altitude | Nullable<double> | r/w | MaxAltitude des 'LatLonBox'-Knotens. |
| min_altitude | Nullable<double> | r/w | MinAltitude des 'LatLonBox'-Knotens. |
...
| Norden | double | r/w | Norden des 'LatLonBox'-Knotens. |
| Präfix | string | r | Gibt das Präfix zurück. |
| Drehung | Nullable<double> | r/w | Rotation des 'LatLonBox'-Knotens. |
| Süden | double | r/w | Süden des 'LatLonBox'-Knotens. |
| Westen | double | r/w | Westen des 'LatLonBox'-Knotens. |
## **Methods**
| **Name** | **Beschreibung** |
| :- | :- |
