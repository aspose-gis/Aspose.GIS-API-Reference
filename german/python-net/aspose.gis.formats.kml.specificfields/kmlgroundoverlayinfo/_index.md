...
type: docs
weight: 20
url: /de/python-net/aspose.gis.formats.kml.specificfields/kmlgroundoverlayinfo/
---
...
| draw_order | double | r/w | DrawOrder des 'GroundOverlay'-Knotens. |
| icon | [IconInfo](/psd/python-net/aspose.gis.formats.kml.specificfields/iconinfo) | r/w | IconPath des 'GroundOverlay'-Knotens. |
| lat_lon_box | [KmlLatLonBox](/psd/python-net/aspose.gis.formats.kml.specificfields/kmllatlonbox) | r/w | Gibt das Objekt aus dem Kml 'LatLonAltBox'-Knoten an. |
| Name | string | r/w | Name des Ground Overlay |
...
| visibility | bool | r/w | Sichtbarkeit des Ground Overlay |
## **Methods**
| **Name** | **Beschreibung** |
| :- | :- |
