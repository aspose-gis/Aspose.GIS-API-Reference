...
type: docs
weight: 10
url: /de/python-net/aspose.gis.formats.kml.specificfields/iconinfo/
---
...
| **Name** | **Beschreibung** |
| :- | :- |
| [IconInfo(link)](#IconInfo_link_1) | Initialisiert eine neue Instanz der [IconInfo](/psd/python-net/aspose.gis.formats.kml.specificfields/iconinfo/) Klasse. |
## **Properties**
| **Name** | **Type** | **Access** | **Beschreibung** |
| :- | :- | :- | :- |
| children | [NodeLink[]](/psd/python-net/aspose.gis/nodelink) | r | Liefert die Kind‑Elemente. |
| href | string | r/w | Liest oder setzt den href. |
...
Initialisiert eine neue Instanz der [IconInfo](/psd/python-net/aspose.gis.formats.kml.specificfields/iconinfo/) Klasse.

**Parameters:**

| Parameter | Typ | Beschreibung |
| :- | :- | :- |
| link | [NodeLink](/psd/python-net/aspose.gis/nodelink) | Der Knoten, aus dem es erstellt wird |
