...
type: docs
weight: 70
url: /de/python-net/aspose.gis.formats.kml.specificfields/kmlregioninfo/
---
...
| id | string | r/w | Id des 'Region'-Knotens. |
| lat_lon_alt_box | [KmlLatLonAltBox](/psd/python-net/aspose.gis.formats.kml.specificfields/kmllatlonaltbox) | r/w | Gibt das Objekt aus dem Kml 'LatLonAltBox'-Knoten an. |
| lod | [KmlLodSettings](/psd/python-net/aspose.gis.formats.kml.specificfields/kmllodsettings) | r/w | Gibt das Objekt aus dem Kml 'Lod'-Knoten an. |
