...
type: docs
weight: 50
url: /de/python-net/aspose.gis.spatialreferencing/geocentricspatialreferencesystem/
---
...
| as_geocentric | [GeocentricSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/geocentricspatialreferencesystem) | r | Gibt dies zurück. |
...
| axises_order | [GeocentricAxisesOrder](/psd/python-net/aspose.gis.spatialreferencing/geocentricaxisesorder) | r | Reihenfolge der Achsen in diesem SRS.<br/>            Wenn dieses SRS nicht gültig ist und falsche Achsenrichtungen hat, wird [GeocentricAxisesOrder.INVALID](/psd/python-net/aspose.gis.spatialreferencing/geocentricaxisesorder/) zurückgegeben. |
| dimensions_count | int | r | Gibt 3 zurück, da geozentrisches SRS immer dreidimensional ist. |
...
| geographic_datum | [GeographicDatum](/psd/python-net/aspose.gis.spatialreferencing/geographicdatum) | r | Gibt das geographische Datum dieses SRS zurück. |
| has_geographic_datum | bool | r | Gibt <see langword=\"true\" /> zurück, da geozentrisches SRS immer ein geographisches Datum hat. |
| has_prime_meridian | bool | r | Gibt <see langword=\"true\" /> zurück, da geozentrisches SRS immer den Nullmeridian hat. |
...
| linear_unit | [Unit](/psd/python-net/aspose.gis.spatialreferencing/unit) | r | Einheit, die in diesem SRS verwendet wird. |
...
| type | [SpatialReferenceSystemType](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype) | r | Gibt [SpatialReferenceSystemType.GEOCENTRIC](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/) zurück. |
