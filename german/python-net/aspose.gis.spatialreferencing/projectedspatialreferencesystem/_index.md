...
type: docs
weight: 150
url: /de/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/
---
...
| :- | :- | :- | :- |
| angular_unit | [Unit](/psd/python-net/aspose.gis.spatialreferencing/unit) | r | Einheit, die für Winkelwerte in diesem SRS und für Winkelparameter von [ProjectedSpatialReferenceSystem.projection](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/) verwendet wird.<br/>            Entspricht der Winkeleinheit von [ProjectedSpatialReferenceSystem.base](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/). |
| as_compound | [CompoundSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/compoundspatialreferencesystem) | r | Gibt dieses SRS zurück, konvertiert zu [CompoundSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/compoundspatialreferencesystem/).<br/>            Verwenden Sie [SpatialReferenceSystem.is_compound](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem/), um herauszufinden, ob eine Konvertierung möglich ist. |
...
| as_projected | [ProjectedSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem) | r | Gibt dies zurück. |
...
| axises_order | [ProjectedAxisesOrder](/psd/python-net/aspose.gis.spatialreferencing/projectedaxisesorder) | r | Reihenfolge der Achsen in diesem SRS.<br/>            Wenn dieses SRS nicht gültig ist und falsche Achsenrichtungen hat, wird [ProjectedAxisesOrder.INVALID](/psd/python-net/aspose.gis.spatialreferencing/projectedaxisesorder/) zurückgegeben. |
| base | [GeographicSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/geographicspatialreferencesystem) | r | Geografisches SRS, auf das [ProjectedSpatialReferenceSystem.projection](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/) angewendet wurde, um dieses SRS zu erhalten. |
| dimensions_count | int | r | Gibt die Anzahl der Dimensionen in diesem SRS zurück. Für projizierte SRS kann dies sein:<br/>            zwei - wenn dies ein einzelnes projiziertes SRS ist.<br/>            drei - wenn dies ein zusammengesetztes SRS ist, das aus einem einzelnen, zweidimensionalen, projizierten SRS und einem vertikalen SRS besteht, das die dritte Dimension hinzufügt. |
...
| geographic_datum | [GeographicDatum](/psd/python-net/aspose.gis.spatialreferencing/geographicdatum) | r | Gibt das geografische Datum dieses SRS zurück. |
| has_geographic_datum | bool | r | Gibt true zurück, da projizierte SRS immer einen Nullmeridian haben. |
| has_prime_meridian | bool | r | Gibt true zurück, da projizierte SRS immer einen Nullmeridian haben. |
...
| is_compound | bool | r | Gibt zurück, ob dieses SRS zusammengesetzt ist (eine Vereinigung von zwei SRS).<br/>            Die folgenden Kombinationen von SRS in einem zusammengesetzten SRS gelten als gültig:<br/>            Geografisches SRS + Vertikales SRS, in diesem Fall ist der Typ des zusammengesetzten SRS [SpatialReferenceSystemType.GEOGRAPHIC](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/).<br/>            Projektiertes SRS + Vertikales SRS, in diesem Fall ist der Typ des zusammengesetzten SRS [SpatialReferenceSystemType.PROJECTED](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/).<br/>            Wenn die Kombination der SRS unterschiedlich ist, ist der Typ des zusammengesetzten SRS [SpatialReferenceSystemType.UNKNOWN](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/). |
...
| linear_unit | [Unit](/psd/python-net/aspose.gis.spatialreferencing/unit) | r | Einheit, die für lineare Dimensionen in diesem SRS und für lineare Parameter von [ProjectedSpatialReferenceSystem.projection](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/) verwendet wird. |
...
| prime_meridian | [PrimeMeridian](/psd/python-net/aspose.gis.spatialreferencing/primemeridian) | r | Gibt den Nullmeridian dieses SRS zurück. |
| projection | [Projection](/psd/python-net/aspose.gis.spatialreferencing/projection) | r | Projektion, die auf [ProjectedSpatialReferenceSystem.base](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/) angewendet wurde, um dieses SRS zu erhalten. |
| type | [SpatialReferenceSystemType](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype) | r | Gibt [SpatialReferenceSystemType.PROJECTED](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/) zurück. |
...
| [validate(error_message)](#validate_error_message_18) | Bestimme, ob dieses SRS gültig ist. |
...
Bestimme, ob dieses SRS gültig ist.

**Parameters:**

| Parameter | Typ | Beschreibung |
| :- | :- | :- |
| Fehlermeldung | String | Wenn die Methode <see langword=\"false\" /> zurückgibt, ist dies die Beschreibung der Ungültigkeit. |

**Returns**

| Typ | Beschreibung |
| :- | :- |
| bool | <see langword=\"true\" /> wenn das SRS gültig ist, <see langword=\"false\" /> andernfalls. |
