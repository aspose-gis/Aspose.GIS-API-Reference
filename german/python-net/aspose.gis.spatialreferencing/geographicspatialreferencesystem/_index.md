---
title: "GeographicSpatialReferenceSystem Klasse"
type: docs
weight: 80
url: /de/python-net/aspose.gis.spatialreferencing/geographicspatialreferencesystem/
---
...
| :- | :- | :- | :- |
| angular_unit | [Unit](/psd/python-net/aspose.gis.spatialreferencing/unit) | r | Einheit, die für Winkelmaße in diesem SRS verwendet wird. |
...
| as_geographic | [GeographicSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/geographicspatialreferencesystem) | r | Gibt dies zurück. |
...
| axises_order | [GeographicAxisesOrder](/psd/python-net/aspose.gis.spatialreferencing/geographicaxisesorder) | r | Reihenfolge der Achsen in diesem SRS.<br/>            Wenn dieses SRS nicht gültig ist und falsche Achsenrichtungen hat, wird [GeographicAxisesOrder.INVALID](/psd/python-net/aspose.gis.spatialreferencing/geographicaxisesorder/) zurückgegeben. |
| dimensions_count | int | r | Gibt die Anzahl der Dimensionen in diesem SRS zurück. Für geografische SRS kann dies sein:<br/>            zwei – wenn dies ein einzelnes geografisches SRS ist.<br/>            drei – wenn dies ein zusammengesetztes SRS ist, das aus einem einzelnen, zweidimensionalen geografischen SRS und einem vertikalen SRS besteht, das die dritte Dimension hinzufügt. |
...
| has_geographic_datum | bool | r | Gibt <see langword="true" /> zurück, da geografische SRS immer den Nullmeridian haben. |
| has_prime_meridian | bool | r | Gibt <see langword="true" /> zurück, da geografische SRS immer den Nullmeridian haben. |
...
| type | [SpatialReferenceSystemType](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype) | r | Gibt [SpatialReferenceSystemType.GEOGRAPHIC](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/) zurück. |
