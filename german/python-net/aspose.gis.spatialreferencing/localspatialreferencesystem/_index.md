---
title: "LocalSpatialReferenceSystem Klasse"
type: docs
weight: 130
url: /de/python-net/aspose.gis.spatialreferencing/localspatialreferencesystem/
---
...
| as_local | [LocalSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/localspatialreferencesystem) | r | Gibt dies zurück. |
...
| dimensions_count | int | r | Anzahl der Dimensionen in diesem SRS. |
...
| geographic_datum | [GeographicDatum](/psd/python-net/aspose.gis.spatialreferencing/geographicdatum) | r | Wirft InvalidOperationException, da das lokale SRS keinen geografischen Datums hat. |
| has_geographic_datum | bool | r | Gibt <see langword="false" /> zurück, da das lokale SRS keinen geografischen Datums hat. |
| has_prime_meridian | bool | r | Gibt <see langword="false" /> zurück, da das lokale SRS keinen Nullmeridian hat. |
...
| local_datum | [LocalDatum](/psd/python-net/aspose.gis.spatialreferencing/localdatum) | r | Datum, das die Messmethode beschreibt. |
...
| prime_meridian | [PrimeMeridian](/psd/python-net/aspose.gis.spatialreferencing/primemeridian) | r | Wirft InvalidOperationException, da das lokale SRS keinen Nullmeridian hat. |
| type | [SpatialReferenceSystemType](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype) | r | Gibt [SpatialReferenceSystemType.LOCAL](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/) zurück. |
| unit | [Unit](/psd/python-net/aspose.gis.spatialreferencing/unit) | r | Einheit dieses SRS. |
...
| [get_unit(dimension)](#get_unit_dimension_12) | Abrufen [LocalSpatialReferenceSystem.unit](/psd/python-net/aspose.gis.spatialreferencing/localspatialreferencesystem/) der Dimension. |
...
Abrufen [LocalSpatialReferenceSystem.unit](/psd/python-net/aspose.gis.spatialreferencing/localspatialreferencesystem/) der Dimension.
