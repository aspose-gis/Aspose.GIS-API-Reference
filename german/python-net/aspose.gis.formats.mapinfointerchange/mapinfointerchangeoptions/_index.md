...
type: docs
weight: 20
url: /de/python-net/aspose.gis.formats.mapinfointerchange/mapinfointerchangeoptions/
---
...
| **Name** | **Beschreibung** |
| :- | :- |
| [MapInfoInterchangeOptions()](#MapInfoInterchangeOptions__1) | Neue Instanz erstellen. |
## **Properties**
| **Name** | **Type** | **Access** | **Beschreibung** |
| :- | :- | :- | :- |
| Zeichensatz | string | r/w | Bestimmt den Zeichensatz, standardmäßig ist Neutral |
...
| Trennzeichen | string | r/w | Bestimmt das Trennzeichen für Attribute in der MID-Datei, standardmäßig ist das Tabulatorzeichen |
