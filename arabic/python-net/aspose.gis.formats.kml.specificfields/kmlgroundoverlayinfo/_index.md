---
title: "KmlGroundOverlayInfo فئة"
type: docs
weight: 20
...
| draw_order | double | r/w | DrawOrder من عقدة 'GroundOverlay'. |
...
| الاسم | string | r/w | اسم Ground Overlay |
...
| visibility | bool | r/w | الرؤية Ground Overlay |
## **Methods**
| **Name** | **الوصف** |
| :- | :- |
