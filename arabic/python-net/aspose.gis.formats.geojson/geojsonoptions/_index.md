---
title: "فئة GeoJsonOptions"
type: docs
weight: 20
url: /ar/python-net/aspose.gis.formats.geojson/geojsonoptions/
---
...
| **Name** | **Description** |
| :- | :- |
| [GeoJsonOptions()](#GeoJsonOptions__1) | إنشاء مثال جديد. |
## **Properties**
...
| الوصف | string | قراءة/كتابة | الوصف على مستوى مجموعة الميزات (لإنشاء الطبقة) |
...
| الاسم | string | قراءة/كتابة | الاسم على مستوى مجموعة الميزات (لإنشاء الطبقة) |
...
| read_bounding_boxes | bool | r/w | يحدد ما إذا كان يجب قراءة صناديق الحدود ('bbox') كسمات باسم 'bbox_0'، 'bbox_1'، إلخ.<br/>            القيمة الافتراضية هي <see langword=\"false\" />.<br/>            تُستخدم السلسلة [GeoJsonOptions.nested_properties_separator](/psd/python-net/aspose.gis.formats.geojson/geojsonoptions/) في أسماء bbox_0، bbox_1،.. |
...
| write_bounding_boxes | bool | قراءة/كتابة | يحدد ما إذا كان يجب تضمين معلومات عن نطاق الإحداثيات لأشكاله في كائنات GeoJSON.<br/>            إذا تم تعيينه إلى <see langword=\"true\" />، يتم إنشاء خاصية \"bbox\" لكل شكل (غير فارغ) عند إضافته إلى الطبقة.<br/>            القيمة الافتراضية هي <see langword=\"false\" />. |
