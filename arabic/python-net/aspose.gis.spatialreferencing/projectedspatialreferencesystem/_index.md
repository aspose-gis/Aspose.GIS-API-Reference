---
title: "فئة ProjectedSpatialReferenceSystem"
type: docs
weight: 150
...
| dimensions_count | int | r | يعيد عدد الأبعاد في هذا الـ SRS. بالنسبة للـ SRS المُسقَط يمكن أن يكون:<br/>            اثنان - إذا كان هذا الـ SRS مسقطًا واحدًا.<br/>            ثلاثة - إذا كان هذا الـ SRS مركبًا، يتكون من SRS مسقط واحد ثنائي الأبعاد وSRS عمودي، مما يضيف البُعد الثالث. |
...
| has_geographic_datum | bool | r | يعيد true، لأن الـ SRS المسقط دائمًا ما يحتوي على خط الزوال الرئيسي. |
| has_prime_meridian | bool | r | يعيد true، لأن الـ SRS المسقط دائمًا ما يحتوي على خط الزوال الرئيسي. |
...
| type | [SpatialReferenceSystemType](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype) | r | يعيد [SpatialReferenceSystemType.PROJECTED](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/). |
