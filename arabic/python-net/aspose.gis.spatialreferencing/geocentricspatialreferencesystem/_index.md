...
| axises_order | [GeocentricAxisesOrder](/psd/python-net/aspose.gis.spatialreferencing/geocentricaxisesorder) | r | ترتيب المحاور في هذا SRS.<br/>            إذا كان هذا SRS غير صالح وله اتجاهات محاور خاطئة، يتم إرجاع [GeocentricAxisesOrder.INVALID](/psd/python-net/aspose.gis.spatialreferencing/geocentricaxisesorder/). |
| dimensions_count | int | r | أرجع 3، لأن SRS الجيوسنترية دائمًا ثلاثية الأبعاد. |
...
| geographic_datum | [GeographicDatum](/psd/python-net/aspose.gis.spatialreferencing/geographicdatum) | r | أرجع المرجع الجغرافي لهذا SRS. |
| has_geographic_datum | bool | r | أرجع <see langword=\"true\" />، لأن SRS الجيوسنترية دائمًا لديها مرجع جغرافي. |
| has_prime_meridian | bool | r | أرجع <see langword=\"true\" />، لأن SRS الجيوسنترية دائمًا لديها خط طول أساسي. |
...
| linear_unit | [Unit](/psd/python-net/aspose.gis.spatialreferencing/unit) | r | الوحدة المستخدمة في هذا SRS. |
...
| prime_meridian | [PrimeMeridian](/psd/python-net/aspose.gis.spatialreferencing/primemeridian) | r | أرجع خط الطول الأساسي لهذا SRS. |
