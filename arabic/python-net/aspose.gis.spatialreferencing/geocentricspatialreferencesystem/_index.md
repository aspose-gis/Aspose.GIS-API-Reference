...
type: docs
weight: 50
url: /ar/python-net/aspose.gis.spatialreferencing/geocentricspatialreferencesystem/
---
...
| as_geocentric | [GeocentricSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/geocentricspatialreferencesystem) | r | أعد هذا. |
...
| axises_order | [GeocentricAxisesOrder](/psd/python-net/aspose.gis.spatialreferencing/geocentricaxisesorder) | r | ترتيب المحاور في هذا الـSRS.<br/>            إذا كان هذا الـSRS غير صالح ويحتوي على اتجاهات محاور خاطئة، يتم إرجاع [GeocentricAxisesOrder.INVALID](/psd/python-net/aspose.gis.spatialreferencing/geocentricaxisesorder/). |
| dimensions_count | int | r | أرجع 3، لأن الـSRS الجيوسنترية دائمًا ثلاثية الأبعاد. |
...
| geographic_datum | [GeographicDatum](/psd/python-net/aspose.gis.spatialreferencing/geographicdatum) | r | أرجع المرجع الجغرافي لهذا الـSRS. |
| has_geographic_datum | bool | r | أرجع <see langword=\"true\" />، لأن الـSRS الجيوسنترية دائمًا لديها مرجع جغرافي. |
| has_prime_meridian | bool | r | أرجع <see langword=\"true\" />، لأن الـSRS الجيوسنترية دائمًا لديها خط الزوال الأساسي. |
...
| linear_unit | [Unit](/psd/python-net/aspose.gis.spatialreferencing/unit) | r | الوحدة المستخدمة في هذا الـSRS. |
...
| prime_meridian | [PrimeMeridian](/psd/python-net/aspose.gis.spatialreferencing/primemeridian) | r | أرجع خط الزوال الأساسي لهذا الـSRS. |
| type | [SpatialReferenceSystemType](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype) | r | أرجع [SpatialReferenceSystemType.GEOCENTRIC](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/). |
