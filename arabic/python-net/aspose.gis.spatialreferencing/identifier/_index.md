...
| :- | :- | :- | :- |
| authority_name | string | r | اسم السلطة التي قدمت [Identifier.authority_unique_identifier](/psd/python-net/aspose.gis.spatialreferencing/identifier/). |
...
| **Name** | **الوصف** |
| :- | :- |
| [epsg(epsg_code)](#epsg_epsg_code_1) | ينشئ Identifier جديد يمثل معرف EPSG بالرمز <paramref name="epsgCode" />. |
| [get_epsg_code()](#get_epsg_code__2) | إذا كان هذا الكائن يمثل معرف EPSG صالح (مثال: - اسم السلطة هو "EPSG" والمعرف الفريد للسلطة هو عدد صحيح) -<br/>            إرجاعه. وإلا - إرجاع -1. |
...
ينشئ Identifier جديد يمثل معرف EPSG بالرمز <paramref name="epsgCode" />.
...
إذا كان هذا الكائن يمثل معرف EPSG صالح (مثال: - اسم السلطة هو "EPSG" والمعرف الفريد للسلطة هو عدد صحيح) -<br/>            إرجاعه. وإلا - إرجاع -1.

**Returns**

| نوع | الوصف |
| :- | :- |
| int | معرف EPSG ممثل بهذا الكائن. إذا لم يمثل هذا الكائن معرف EPSG - إرجاع -1. |
