---
title: "فئة LocalSpatialReferenceSystem"
type: docs
weight: 130
url: /ar/python-net/aspose.gis.spatialreferencing/localspatialreferencesystem/
---
...
| as_local | [LocalSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/localspatialreferencesystem) | r | أعد هذا. |
| as_projected | [ProjectedSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem) | r | يرجع هذا الـSRS محولًا إلى [ProjectedSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/).<br/>            استخدم [SpatialReferenceSystem.type](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem/) لمعرفة ما إذا كان التحويل ممكنًا. |
...
| dimensions_count | int | r | عدد الأبعاد في هذا SRS. |
...
| geographic_datum | [GeographicDatum](/psd/python-net/aspose.gis.spatialreferencing/geographicdatum) | r | يرمي InvalidOperationException، لأن SRS المحلي لا يحتوي على مرجع جغرافي. |
| has_geographic_datum | bool | r | يعيد <see langword=\"false\" />, لأن SRS المحلي لا يحتوي على مرجع جغرافي. |
| has_prime_meridian | bool | r | يعيد <see langword=\"false\" />, لأن SRS المحلي لا يحتوي على خط الزوال الرئيسي. |
...
| local_datum | [LocalDatum](/psd/python-net/aspose.gis.spatialreferencing/localdatum) | r | المرجع الذي يصف طريقة القياسات. |
...
| prime_meridian | [PrimeMeridian](/psd/python-net/aspose.gis.spatialreferencing/primemeridian) | r | يرمي InvalidOperationException، لأن SRS المحلي لا يحتوي على خط الزوال الرئيسي. |
| type | [SpatialReferenceSystemType](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype) | r | إرجاع [SpatialReferenceSystemType.LOCAL](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/). |
| unit | [Unit](/psd/python-net/aspose.gis.spatialreferencing/unit) | r | وحدة هذا SRS. |
...
| [get_unit(dimension)](#get_unit_dimension_12) | احصل على [LocalSpatialReferenceSystem.unit](/psd/python-net/aspose.gis.spatialreferencing/localspatialreferencesystem/) للبعد. |
...
احصل على [LocalSpatialReferenceSystem.unit](/psd/python-net/aspose.gis.spatialreferencing/localspatialreferencesystem/) للبعد.
