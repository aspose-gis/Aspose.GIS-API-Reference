...
| has_geographic_datum | bool | r | يرجع <see langword="false" />، لأن SRS المحلي لا يحتوي على مرجع جغرافي. |
| has_prime_meridian | bool | r | يرجع <see langword="false" />، لأن SRS المحلي لا يحتوي على خط الزوال الرئيسي. |
