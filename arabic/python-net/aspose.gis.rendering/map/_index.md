...
| **Name** | **Description** |
| :- | :- |
| [Map()](#Map__1) | ينشئ مثيلاً جديداً لفئة <c>Map</c>. |
| [Map(width, height)](#Map_width_height_2) | ينشئ مثيلاً جديداً لفئة <c>Map</c>. |
## **Properties**
| **Name** | **Type** | **Access** | **Description** |
| :- | :- | :- | :- |
| background_color | System.Drawing.Color | قراءة/كتابة | لون خلفية الخريطة. القيمة الافتراضية هي . |
| extent | [Extent](/psd/python-net/aspose.gis/extent) | r/w | يحدد حدود الخريطة للعرض.<br/>            إذا تم تعيينه إلى <see langword=\"null\" />، يتم حساب الامتداد أثناء العرض لتضمين جميع الأشكال الهندسية في جميع الطبقات. |
...
| **Name** | **Description** |
| :- | :- |
| [add(features_sequence)](#add_features_sequence_1) | ينشئ ويضيف [VectorMapLayer](/psd/python-net/aspose.gis.rendering/vectormaplayer/) إلى الخريطة. يتم عرض الطبقات بترتيب الإضافة. |
| [add(features_sequence, symbolizer)](#add_features_sequence_symbolizer_2) | ينشئ ويضيف [VectorMapLayer](/psd/python-net/aspose.gis.rendering/vectormaplayer/) إلى الخريطة. يتم عرض الطبقات بترتيب الإضافة. |
| [add(features_sequence, symbolizer, labeling)](#add_features_sequence_symbolizer_labeling_3) | ينشئ ويضيف [VectorMapLayer](/psd/python-net/aspose.gis.rendering/vectormaplayer/) إلى الخريطة. يتم عرض الطبقات بترتيب الإضافة. |
| [add(layer, colorizer, keep_open)](#add_layer_colorizer_keep_open_4) | ينشئ [RasterMapLayer](/psd/python-net/aspose.gis.rendering/rastermaplayer/) مع المُلوّن الافتراضي ويضيفه إلى الخريطة. |
| [add(layer, keep_open)](#add_layer_keep_open_5) | ينشئ [VectorMapLayer](/psd/python-net/aspose.gis.rendering/vectormaplayer/) مع المُرمّز الافتراضي ويضيفه إلى الخريطة. يتم عرض الطبقات بترتيب الإضافة. |
| [add(layer, symbolizer, keep_open)](#add_layer_symbolizer_keep_open_6) | ينشئ ويضيف [VectorMapLayer](/psd/python-net/aspose.gis.rendering/vectormaplayer/) إلى الخريطة. يتم عرض الطبقات بترتيب الإضافة. |
| [add(layer, symbolizer, labeling, default_reference_system, keep_open)](#add_layer_symbolizer_labeling_default_reference_system_keep_open_7) | ينشئ ويضيف [VectorMapLayer](/psd/python-net/aspose.gis.rendering/vectormaplayer/) إلى الخريطة. يتم عرض الطبقات بترتيب الإضافة. |
| [add(layer, symbolizer, labeling, keep_open)](#add_layer_symbolizer_labeling_keep_open_8) | ينشئ ويضيف [VectorMapLayer](/psd/python-net/aspose.gis.rendering/vectormaplayer/) إلى الخريطة. يتم عرض الطبقات بترتيب الإضافة. |
| [add(map_layer)](#add_map_layer_9) | يضيف طبقة إلى الخريطة. يتم عرض الطبقات بترتيب الإضافة. |
| [render(output_path, renderer)](#render_output_path_renderer_10) | يقوم بتصوير الخريطة في ملف. |
| [render(output_path, renderer)](#render_output_path_renderer_11) | يقوم بتصوير الخريطة في ملف. |
...
ينشئ مثيلاً جديداً لفئة <c>Map</c>.
...
ينشئ ويضيف [VectorMapLayer](/psd/python-net/aspose.gis.rendering/vectormaplayer/) إلى الخريطة. يتم عرض الطبقات بترتيب الإضافة.
...
| :- | :- | :- |
| features_sequence | [FeaturesSequence](/psd/python-net/aspose.gis/featuressequence) | تسلسل الميزات لتمثيله بواسطة [VectorMapLayer](/psd/python-net/aspose.gis.rendering/vectormaplayer/). |
| symbolizer | [VectorSymbolizer](/psd/python-net/aspose.gis.rendering.symbolizers/vectorsymbolizer/) | مُرمّز لاستخدامه في التصيير. |
...
ينشئ [RasterMapLayer](/psd/python-net/aspose.gis.rendering/rastermaplayer/) مع المُلوّن الافتراضي ويضيفه إلى الخريطة.
...
| colorizer | [RasterColorizer](/psd/python-net/aspose.gis.rendering.colorizers/rastercolorizer/) | مُلوّن لاستخدامه في التصيير. إذا كان <see langword=\"null\" />, يتم استخدام المُلوّن الافتراضي. |
...
ينشئ [VectorMapLayer](/psd/python-net/aspose.gis.rendering/vectormaplayer/) مع المُرمّز الافتراضي ويضيفه إلى الخريطة. يتم عرض الطبقات بترتيب الإضافة.
...
| keep_open | bool | <see langword=\"true\" /> لترك طبقة المتجه مفتوحة بعد التخلص من كائن [Map](/psd/python-net/aspose.gis.rendering/map/);<br/>            <see langword=\"false\" /> للتخلص من الطبقة. |
