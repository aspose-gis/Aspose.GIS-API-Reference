---
title: "فئة GdalOptions"
type: docs
weight: 20
url: /ar/python-net/aspose.gis.formats.gdal/gdaloptions/
---
...
| **Name** | **Description** |
| :- | :- |
| [GdalOptions(temp_directory)](#GdalOptions_temp_directory_1) | إنشاء نسخة جديدة. |
## **Properties**
...
| file_name | string | قراءة/كتابة | اسم التطبيق للبدء |
...
| path_to_temp_file | string | r | مسار الملفات المؤقتة. |
...
| معامل | نوع | وصف |
| :- | :- | :- |
| temp_directory | string | مسار الملفات المؤقتة. مجلد المستخدم المؤقت بشكل افتراضي. |
