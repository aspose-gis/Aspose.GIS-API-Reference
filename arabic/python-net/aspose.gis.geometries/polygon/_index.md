...
| **Name** | **الوصف** |
| :- | :- |
| [Polygon()](#Polygon__1) | يُنشئ مثلاً جديداً من الفئة [Polygon](/psd/python-net/aspose.gis.geometries/polygon/). |
| [Polygon(exterior_ring)](#Polygon_exterior_ring_2) | يُنشئ مثلاً جديداً من الفئة [Polygon](/psd/python-net/aspose.gis.geometries/polygon/). |
| [Polygon(exterior_ring, interior_rings)](#Polygon_exterior_ring_interior_rings_3) | يُنشئ مثلاً جديداً من الفئة [Polygon](/psd/python-net/aspose.gis.geometries/polygon/). |
## **Properties**
...
يُنشئ مثلاً جديداً من الفئة [Polygon](/psd/python-net/aspose.gis.geometries/polygon/).
...
| :- | :- | :- |
| exterior_ring | [ILinearRing](/psd/python-net/aspose.gis.geometries/ilinearring) | الحلقة الخارجية. |
| الحلقات_الداخلية | System.Collections.Generic.IEnumerable<ILinearRing> | الحلقات الداخلية. |
...
| نوع | الوصف |
| :- | :- |
| [IPoint](/psd/python-net/aspose.gis.geometries/ipoint) | نقطة على هذا المضلع. نقطة فارغة إذا لم يكن لهذا المضلع داخلية. |
