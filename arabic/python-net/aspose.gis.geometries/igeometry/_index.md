...
type: docs
weight: 110
url: /ar/python-net/aspose.gis.geometries/igeometry/
---
...
| [to_linear_geometry()](#to_linear_geometry__31) | يحصل على نسخة تقريبية أو مكافئة غير منحنية من هذه الهندسة باستخدام <c>tolerance</c> الافتراضي. |
| [to_linear_geometry(tolerance)](#to_linear_geometry_tolerance_32) | يحصل على نسخة تقريبية أو مكافئة غير منحنية من هذه الهندسة باستخدام <c>tolerance</c> المحدد. |
| [touches(other)](#touches_other_33) | يحدد ما إذا كانت هذه الهندسة وهندسة محددة تلامسان. |
| [union(other)](#union_other_34) | يوحد هذه الهندسة وهندسة محددة. |
| [union(other)](#union_other_35) | يوحد هذه الهندسة وهندسة محددة. |
| [within(extent)](#within_extent_36) | يحدد ما إذا كانت هذه الهندسة داخل نطاق محدد. |
| [within(other)](#within_other_37) | يحدد ما إذا كانت هذه الهندسة داخل هندسة محددة. |
