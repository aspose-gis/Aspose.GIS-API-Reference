...
| **Name** | **Description** |
| :- | :- |
| [MultiPoint()](#MultiPoint__1) | يُنشئ نسخة جديدة من الفئة [MultiPoint](/psd/python-net/aspose.gis.geometries/multipoint/). |
## **Properties**
...
يُنشئ نسخة جديدة من الفئة [MultiPoint](/psd/python-net/aspose.gis.geometries/multipoint/).
