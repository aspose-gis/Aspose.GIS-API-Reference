...
| **Name** | **الوصف** |
| :- | :- |
| [CircularString()](#CircularString__1) | ينشئ مثيلًا جديدًا من الفئة [CircularString](/psd/python-net/aspose.gis.geometries/circularstring/) |
| [CircularString(collection)](#CircularString_collection_2) | ينشئ مثيلًا جديدًا من الفئة [CircularString](/psd/python-net/aspose.gis.geometries/circularstring/) |
| [CircularString(other)](#CircularString_other_3) | ينشئ مثيلًا جديدًا من الفئة [CircularString](/psd/python-net/aspose.gis.geometries/circularstring/) |
## **Properties**
...
ينشئ مثيلًا جديدًا من الفئة [CircularString](/psd/python-net/aspose.gis.geometries/circularstring/)
