...
| معامل | نوع | وصف |
| :- | :- | :- |
| التحمل | double | ‏‏ <c>tolerance</c> المراد استخدامها. النتيجة مضمونة أن تكون أقل من <c>tolerance</c> بعيداً عن<br/> الهندسة المنحنية، ما لم يتجاوز عدد النقاط المطلوبة لتخطيط الهندسة الحد الأقصى لكل ربع،<br/> وهو حالياً يساوي 10000 نقطة. |
