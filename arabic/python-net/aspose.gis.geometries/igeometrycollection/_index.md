---
title: "فئة IGeometryCollection"
type: docs
weight: 120
url: /ar/python-net/aspose.gis.geometries/igeometrycollection/
---
...
| [intersection(other)](#intersection_other_23) | يبني تقاطعًا بين هذه الهندسة وهندسة محددة. |
| [intersects(extent)](#intersects_extent_24) | يحدد ما إذا كانت هذه الهندسة تتقاطع مع نطاق محدد. |
| [intersects(other)](#intersects_other_25) | يحدد ما إذا كانت هذه الهندسة وهندسة محددة تتقاطع. |
| [overlaps(other)](#overlaps_other_26) | يحدد ما إذا كانت هذه الهندسة تتداخل مع هندسة محددة. |
| [relate(other, intersection_pattern_matrix)](#relate_other_intersection_pattern_matrix_27) | يحدد ما إذا كانت مصفوفة تقاطع DE-9IM لهذه الهندسة وهندسة محددة تطابق النمط المقدم. |
| [replace_polygons_by_lines()](#replace_polygons_by_lines__28) | يحصل على المضلعات الممثلة كخطوط لهذه الهندسة. |
| [spatially_contains(other)](#spatially_contains_other_29) | يحدد ما إذا كانت هذه الهندسة تحتوي مكانيًا على هندسة محددة. |
...
| [within(extent)](#within_extent_38) | يحدد ما إذا كانت هذه الهندسة داخل نطاق محدد. |
| [within(other)](#within_other_39) | يحدد ما إذا كانت هذه الهندسة داخل هندسة محددة. |
...
| نوع | الوصف |
| :- | :- |
| [IGeometryCollection](/psd/python-net/aspose.gis.geometries/igeometrycollection) | هندسة لا تحتوي على هندسات منحنى. هذا يعادل <DOM Element: class at 0x2a1791cc040>.IGeometryCollection.to_linear_geometry()(float) مع<br/>            <c>tolerance</c> الافتراضية. قيمة <c>tolerance</c> الافتراضية تعتمد على [SpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem/) لهذه الهندسة:<br/>            <ul><br/>            <li> بالنسبة لأنظمة الإحداثيات المُسقطة يكون التسامح 0.001 متر (بوحدات SRS) </li><br/>            <li> بالنسبة لأنظمة الإحداثيات الجغرافية يكون التسامح <c>1e-5</c> درجة (بوحدات SRS) </li><br/>            <li> بالنسبة لأنظمة الإحداثيات غير المعروفة يكون التسامح <c>1e-5</c> </li><br/>            </ul><br/>            لمزيد من التفاصيل حول التحويلات المطبقة راجع مواصفة <DOM Element: class at 0x2a1791cc040>.IGeometryCollection.to_linear_geometry()(float). |
...
| معامل | نوع | الوصف |
| :- | :- | :- |
| التسامح | double | ‏‏<c>tolerance</c> المراد استخدامها. النتيجة مضمونة أن تكون أقل من <c>tolerance</c> بعيدًا عن<br/>            الهندسة المنحنية، إلا إذا تجاوز عدد النقاط المطلوبة لتحويل الهندسة إلى خطية الحد الأقصى لكل ربع،<br/>            وهو حاليًا يساوي 10000 نقطة. |

**Returns**

| نوع | الوصف |
| :- | :- |
| [IGeometryCollection](/psd/python-net/aspose.gis.geometries/igeometrycollection) | هندسة لا تحتوي على هندسات منحنى. يتم تطبيق التحويلات التالية:<br/>            <ul><br/>            <li> يتم تحويل [GeometryType.CIRCULAR_STRING](/psd/python-net/aspose.gis.geometries/geometrytype/)s إلى خطية (تحويل إلى [GeometryType.LINE_STRING](/psd/python-net/aspose.gis.geometries/geometrytype/)s باستخدام <paramref name="tolerance" /> المحدد) </li><br/>            <li> يتم دمج [GeometryType.COMPOUND_CURVE](/psd/python-net/aspose.gis.geometries/geometrytype/)s في <c>LineString</c>s </li><br/>            <li> يتم تحويل [GeometryType.CURVE_POLYGON](/psd/python-net/aspose.gis.geometries/geometrytype/)s إلى [GeometryType.POLYGON](/psd/python-net/aspose.gis.geometries/geometrytype/)s </li><br/>            <li> يتم تحويل [GeometryType.MULTI_CURVE](/psd/python-net/aspose.gis.geometries/geometrytype/)s إلى [GeometryType.MULTI_CURVE](/psd/python-net/aspose.gis.geometries/geometrytype/)s </li><br/>            <li> يتم تحويل [GeometryType.MULTI_SURFACE](/psd/python-net/aspose.gis.geometries/geometrytype/)s إلى [GeometryType.MULTI_POLYGON](/psd/python-net/aspose.gis.geometries/geometrytype/)s </li><br/>            </ul><br/>            نتيجةً لذلك، تكون الخاصية [IGeometry.has_curve_geometry](/psd/python-net/aspose.gis.geometries/igeometry/) للهيكل الناتج <see langword="false" />. |
