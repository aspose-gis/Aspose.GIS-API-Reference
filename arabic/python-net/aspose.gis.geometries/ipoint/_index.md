...
type: docs
weight: 200
url: /ar/python-net/aspose.gis.geometries/ipoint/
---
...
| x | double | r | يسترجع إحداثي x. |
| y | double | r | يسترجع إحداثي y. |
| z | double | r | يسترجع إحداثي z. |
## **Methods**
| **Name** | **الوصف** |
| :- | :- |
...
| [to_linear_geometry()](#to_linear_geometry__32) | يحصل على نسخة تقريبية أو مكافئة غير منحنية من هذه الهندسة باستخدام <c>tolerance</c> الافتراضي. |
| [to_linear_geometry(tolerance)](#to_linear_geometry_tolerance_33) | يحصل على نسخة تقريبية أو مكافئة غير منحنية من هذه الهندسة باستخدام <c>tolerance</c> المحدد. |
