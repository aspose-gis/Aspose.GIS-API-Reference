...
| **Name** | **الوصف** |
| :- | :- |
| [LineString()](#LineString__1) | يُنشئ مثلاً جديداً من فئة [LineString](/psd/python-net/aspose.gis.geometries/linestring/). |
| [LineString(collection)](#LineString_collection_2) | يُنشئ مثلاً جديداً من فئة [LineString](/psd/python-net/aspose.gis.geometries/linestring/). |
| [LineString(other)](#LineString_other_3) | يُنشئ مثلاً جديداً من فئة [LineString](/psd/python-net/aspose.gis.geometries/linestring/). |
## **Properties**
...
يُنشئ مثلاً جديداً من فئة [LineString](/psd/python-net/aspose.gis.geometries/linestring/).
