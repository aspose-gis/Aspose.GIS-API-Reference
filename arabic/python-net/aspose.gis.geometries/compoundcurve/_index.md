...
| **Name** | **Description** |
| :- | :- |
| [CompoundCurve()](#CompoundCurve__1) | ينشئ مثيلاً جديدًا من الفئة [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/). |
| [CompoundCurve(curves)](#CompoundCurve_curves_2) | ينشئ مثيلاً جديدًا من الفئة [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/). |
| [CompoundCurve(other)](#CompoundCurve_other_3) | ينشئ مثيلاً جديدًا من الفئة [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/). |
## **Properties**
...
| [to_linear_geometry()](#to_linear_geometry__40) | يحصل على نسخة تقريبية أو مكافئة غير منحنية من هذه الهندسة باستخدام <c>tolerance</c> الافتراضية. |
| [to_linear_geometry(tolerance)](#to_linear_geometry_tolerance_41) | يحصل على نسخة تقريبية أو مكافئة غير منحنية من هذه الهندسة باستخدام <c>tolerance</c> المحددة. |
| [to_svg(extent)](#to_svg_extent_42) | يترجم هذه الهندسة إلى تمثيل Svg. |
...
ينشئ مثيلاً جديدًا من الفئة [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/).
