...
| **Name** | **Description** |
| :- | :- |
| [CurvePolygon()](#CurvePolygon__1) | ينشئ مثيلاً جديدًا من الفئة [CurvePolygon](/psd/python-net/aspose.gis.geometries/curvepolygon/). |
| [CurvePolygon(exterior_ring)](#CurvePolygon_exterior_ring_2) | ينشئ مثيلاً جديدًا من الفئة [CurvePolygon](/psd/python-net/aspose.gis.geometries/curvepolygon/). |
| [CurvePolygon(exterior_ring, interior_rings)](#CurvePolygon_exterior_ring_interior_rings_3) | ينشئ مثيلاً جديدًا من الفئة [CurvePolygon](/psd/python-net/aspose.gis.geometries/curvepolygon/). |
## **Properties**
...
ينشئ مثيلاً جديدًا من الفئة [CurvePolygon](/psd/python-net/aspose.gis.geometries/curvepolygon/).
...
| :- | :- | :- |
| exterior_ring | [ICurve](/psd/python-net/aspose.gis.geometries/icurve) | الحلقة الخارجية. |
| interior_rings | System.Collections.Generic.IEnumerable<ICurve> | الحلقات الداخلية. |
