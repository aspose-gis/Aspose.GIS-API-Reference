---
title: "GpxOptions فئة"
type: docs
weight: 20
url: /ar/python-net/aspose.gis.formats.gpx/gpxoptions/
---
...
| **Name** | **الوصف** |
| :- | :- |
| [GpxOptions()](#GpxOptions__1) | إنشاء مثال جديد. |
## **Properties**
...
| m_attribute | string | r/w | يحدد أي سمة GPX سيتم تصديرها كإحداثي 'M' لنقاط الطريق، ونقاط المسار، ونقاط المسار.<br/>            السلوك هو نفسه مع [GpxOptions.z_attribute](/psd/python-net/aspose.gis.formats.gpx/gpxoptions/)، الافتراضي هو <see langword=\"null\" />. |
...
| nested_attribute_separator | string | r | سلسلة لفصل اسم السمة المتداخلة ومؤشراتها. الافتراضي هو الشرطتين السفلية \"__\". |
| read_nested_attributes | bool | r/w | يحدد ما إذا كانت نقاط GPX، مثل 'trkpt' و 'rtept'، تحتوي على سمات داخلية وما إذا كان يجب قراءتها. الافتراضي هو <see langword=\"false\" />. |
...
| z_attribute | string | r/w | يحدد أي سمة GPX سيتم تصديرها كإحداثي 'Z' لنقاط الطريق، ونقاط المسار، ونقاط المسار.<br/>            إذا كان <see langword=\"null\" /> - لن يتم تصدير أي سمة كإحداثي 'Z'.<br/>            الافتراضي هو \"ele\".<br/>            القيم الممكنة هي أسماء جميع سمات XML الخاصة بـ GPX التي يمكن تمثيلها كقيمة مزدوجة (مثل \"speed\"، \"magvar\"، \"geoidheight\" وغيرها). |
