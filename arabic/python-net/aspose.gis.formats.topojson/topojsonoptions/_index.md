...
| default_object_name | string | r/w | اسم الكائن حيث يتم وضع الميزات افتراضيًا. |
...
| object_name_attribute | string | r/w | اسم الخاصية التي تعكس اسم الكائن الذي يحتوي على ميزة. |
| quantization_number | Nullable<int> | r/w | يحدد رقم التكميم لاستخدامه في تقليل الدقة للإحداثيات وترميز الفروق للأقواس في TopoJSON الناتج. |
...
| transform | [TopoJsonTransform](/psd/python-net/aspose.gis.formats.topojson/topojsontransform) | r/w | يحدد كائن التحويل لاستخدامه في تقليل الدقة للإحداثيات وترميز الفروق للأقواس في TopoJSON الناتج. |
