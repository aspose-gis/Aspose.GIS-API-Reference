...
| report_all_nodes | bool | r/w | الإبلاغ عن جميع العقد كميزات، حتى إذا لم تكن لديها أي وسوم ذات أهمية. |
| report_all_ways | bool | r/w | الإبلاغ عن جميع الطرق كميزات، حتى إذا لم يكن لديها أي وسوم ذات أهمية أو لم يكن لديها أي عقد. |
| report_common_attributes | bool | r/w | الإبلاغ عن سمات OSM الشائعة: visible, version, changeset, timestamp, user و uid.<br/>            سيتم الإبلاغ عن السمات الشائعة كسمات للميزة مع البادئة "osm_"، مثل osm_user، osm_timestamp، إلخ. |
...
| write_common_attributes | bool | r/w | اكتب سمات OSM الشائعة: visible, version, changeset, timestamp, user و uid. |
