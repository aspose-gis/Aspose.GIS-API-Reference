---
title: "فئة OsmXmlOptions"
type: docs
weight: 20
url: /ar/python-net/aspose.gis.formats.osmxml/osmxmloptions/
---
...
| **Name** | **Description** |
| :- | :- |
| [OsmXmlOptions()](#OsmXmlOptions__1) | إنشاء مثال جديد. |
## **Properties**
...
| report_all_nodes | bool | قراءة/كتابة | الإبلاغ عن جميع العقد كميزات، حتى إذا لم يكن لديها أي وسوم ذات أهمية. |
| report_all_ways | bool | قراءة/كتابة | الإبلاغ عن جميع الطرق كميزات، حتى إذا لم يكن لديها أي وسوم ذات أهمية أو لم يكن لديها أي عقد. |
| report_common_attributes | bool | قراءة/كتابة | الإبلاغ عن سمات OSM المشتركة: visible, version, changeset, timestamp, user و uid.<br/>            سيتم الإبلاغ عن السمات المشتركة كسمات للميزات مع بادئة "osm_"، على سبيل المثال osm_user، osm_timestamp، إلخ. |
...
| write_common_attributes | bool | قراءة/كتابة | اكتب سمات OSM المشتركة: visible, version, changeset, timestamp, user و uid. |
