---
title: "فئة MapInfoInterchangeOptions"
type: docs
weight: 20
url: /ar/python-net/aspose.gis.formats.mapinfointerchange/mapinfointerchangeoptions/
---
...
| **Name** | **Description** |
| :- | :- |
| [MapInfoInterchangeOptions()](#MapInfoInterchangeOptions__1) | إنشاء مثال جديد. |
## **Properties**
| **Name** | **Type** | **Access** | **Description** |
| :- | :- | :- | :- |
| مجموعة الأحرف | string | قراءة/كتابة | يحدد مجموعة الأحرف، بشكل افتراضي هي Neutral |
...
| الفاصل | string | قراءة/كتابة | يحدد الفاصل للسمات في ملف mid، بشكل افتراضي هو حرف الجدولة |
