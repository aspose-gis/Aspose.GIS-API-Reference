---
title: "فئة SqlServerOptions"
type: docs
weight: 20
url: /ar/python-net/aspose.gis.formats.sqlserver/sqlserveroptions/
---
...
| **Name** | **Description** |
| :- | :- |
| [SqlServerOptions()](#SqlServerOptions__1) | إنشاء مثال جديد. |
## **Properties**
...
| spatial_reference_system_mode | [SpatialReferenceSystemMode](/psd/python-net/aspose.gis/spatialreferencesystemmode) | r/w | يحدد كيفية معالجة نظام الإحداثيات المرجعي (SRS) للأشكال الهندسية غير المعروفة في قاعدة البيانات عند إضافتها إلى الطبقة.<br/>            القيمة الافتراضية هي [SpatialReferenceSystemMode.THROW_EXCEPTION](/psd/python-net/aspose.gis/spatialreferencesystemmode/). |
