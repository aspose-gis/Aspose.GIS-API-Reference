---
title: "فئة MapInfoTabOptions"
type: docs
weight: 20
url: /ar/python-net/aspose.gis.formats.mapinfotab/mapinfotaboptions/
---
...
| **Name** | **Description** |
| :- | :- |
| [MapInfoTabOptions()](#MapInfoTabOptions__1) | إنشاء مثال جديد. |
## **Properties**
| **Name** | **Type** | **Access** | **Description** |
| :- | :- | :- | :- |
| block_size | int | قراءة/كتابة | حجم الكتلة لملفات '*.map' (مضاعفات 512). القيمة الافتراضية هي 16384. القيم الصالحة: من 512 إلى 32256. |
...
| is_ignore_wrong_data | bool | قراءة/كتابة | يحدد ما إذا كنا يجب أن نرمي استثناءً أثناء العمل ببيانات غير صحيحة أو نعيّن القيم الافتراضية لها. |
...
| text_string_attribute | string | قراءة/كتابة | يحدد اسم السمة التي تمثل نص الكائن الرسومي 'Text'. |
