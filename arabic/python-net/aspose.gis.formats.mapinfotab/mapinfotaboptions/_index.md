...
| :- | :- | :- | :- |
| block_size | int | r/w | حجم الكتلة لملفات '*.map' (مضاعفات 512). القيمة الافتراضية هي 16384. القيم الصالحة: من 512 إلى 32256. |
...
| is_ignore_wrong_data | bool | r/w | يحدد ما إذا كنا يجب أن نرمي استثناءً أثناء العمل ببيانات غير صحيحة أم نعيّن القيم الافتراضية لها. |
...
| text_string_attribute | string | r/w | يحدد اسم السمة التي تمثل نص الكائن الرسومي 'Text'. |
