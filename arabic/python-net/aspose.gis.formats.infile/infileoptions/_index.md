---
title: "فئة InFileOptions"
type: docs
weight: 20
url: /ar/python-net/aspose.gis.formats.infile/infileoptions/
---
...
| **Name** | **الوصف** |
| :- | :- |
| [InFileOptions()](#InFileOptions__1) | إنشاء مثال جديد. |
## **Properties**
...
| count_of_feature_in_part | int | r/w | الحد الأقصى لعدد الميزات في كل جزء من الملف |
