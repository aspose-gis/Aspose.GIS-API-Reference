...
| coordinate_precision_grid | [FileGdbCoordinatePrecisionGrid](/psd/python-net/aspose.gis.formats.filegdb/filegdbcoordinateprecisiongrid) | r/w | شبكة دقة إحداثية لاستخدامها في الطبقة الجديدة. |
...
| ensure_valid_coordinates_range | bool | قراءة/كتابة | ما إذا كان يجب أن تكون الإحداثيات ضمن النطاق الصحيح. |
| expected_geometry_type | Nullable<Aspose.Gis.Geometries.GeometryType> | قراءة/كتابة | نوع الهندسة المتوقع للطبقة. إذا تم تعيين هذا الخيار فسنسمح بإضافة فقط الهندسات من هذا النوع. |
| geometry_field_name | string | قراءة/كتابة | اسم حقل الهندسة. |
| has_m | bool | قراءة/كتابة | هل يمكن للهندسات في الطبقة أن تحتوي على إحداثي 'm'. القيمة الافتراضية هي true |
| has_z | bool | قراءة/كتابة | هل يمكن للهندسات في الطبقة أن تحتوي على إحداثي 'z'. القيمة الافتراضية هي true |
...
| m_tolerance | Nullable<double> | قراءة/كتابة | تحمل الالتقاط M. |
| object_id_field_name | string | قراءة/كتابة | اسم حقل معرف الكائن. |
...
| xy_tolerance | Nullable<double> | قراءة/كتابة | تحمل الالتقاط X و Y. |
...
| z_tolerance | Nullable<double> | قراءة/كتابة | تحمل الالتقاط Z. |
