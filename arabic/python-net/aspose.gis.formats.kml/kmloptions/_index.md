...
| :- | :- | :- | :- |
| altitude_mode | [AltitudeModes](/psd/python-net/aspose.gis.formats.kml/altitudemodes) | r/w | يسمح لك بتحديد AltitudeModes لاستخدامها مع أشكال KML |
...
| document_id | string | r/w | يُستخدم لتحديد معرف عقدة الجذر 'Document' |
...
| symbol_to_replace_invalid_chars | char | r/w | يحدد أي رمز سيتم استخدامه لاستبدال الأحرف غير الصالحة عند القراءة.<br/>            يتم تخطي الاستبدال إذا كانت القيمة '\\0'. القيمة الافتراضية هي الحرف '\\0'. |
