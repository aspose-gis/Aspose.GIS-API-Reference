---
title: "فئة KmlOptions"
type: docs
weight: 190
url: /ar/python-net/aspose.gis.formats.kml/kmloptions/
---
...
| **Name** | **Description** |
| :- | :- |
| [KmlOptions()](#KmlOptions__1) | إنشاء مثال جديد. |
## **Properties**
| **Name** | **Type** | **Access** | **Description** |
| :- | :- | :- | :- |
| altitude_mode | [AltitudeModes](/psd/python-net/aspose.gis.formats.kml/altitudemodes) | r/w | يسمح لك بتحديد أوضاع الارتفاع (AltitudeModes) لاستخدامها مع أشكال KML |
...
| document_id | string | قراءة/كتابة | يُستخدم لتحديد معرف عقدة 'Document' الجذرية |
...
| symbol_to_replace_invalid_chars | حرف | قراءة/كتابة | يحدد أي رمز سيتم استخدامه لاستبدال الأحرف غير الصالحة عند القراءة.<br/>            يتم تخطي الاستبدال إذا كانت القيمة '\0'. القيمة الافتراضية هي حرف '\0'. |
