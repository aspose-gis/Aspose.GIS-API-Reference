---
title: "فئة GeoTiffDriver"
type: docs
weight: 10
url: /ar/python-net/aspose.gis.formats.geotiff/geotiffdriver/
---
...
| [open_layer(path, options)](#open_layer_path_options_3) | يفتح الطبقة للقراءة. |
| [open_layer(path, options)](#open_layer_path_options_4) | يفتح الطبقة للقراءة. |
| [open_layer(path, options)](#open_layer_path_options_5) | يفتح الطبقة للقراءة. |
| [open_layer(path, options)](#open_layer_path_options_6) | يفتح الطبقة للقراءة. |
...
| :- | :- | :- |
| path | string | المسار إلى الملف. |
| options | [GeoTiffOptions](/psd/python-net/aspose.gis.formats.geotiff/geotiffoptions) | خيارات خاصة بالمشغل. |
