...
| ClampToGround | `2` | بالنسبة للكاميرا، يضع هذا الإعداد الكاميرا relativeToGround أيضًا، لأن وضع الكاميرا بالضبط على ارتفاع الأرض يعني أن العين ستتقاطع مع التضاريس (وسيتم حجب الرؤية). |
