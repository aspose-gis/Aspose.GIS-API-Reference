...
description: Aspose.Gis.Formats.Kml.KmlOptions فصل. خيارات خاصة ببرنامج التشغيل لتنسيق KML .
type: docs
weight: 410
...
| اسم | وصف |
| --- | --- |
| [AltitudeMode](../../aspose.gis.formats.kml/kmloptions/altitudemode/) { get; set; } | يسمح لك بتحديد AltitudeModes لاستخدامها مع الأشكال الهندسية لـ KML |
| [AutoId](../../aspose.gis.formats.kml/kmloptions/autoid/) { get; set; } | إنشاء المعرفات تلقائيًا |
...
| [DocumentId](../../aspose.gis.formats.kml/kmloptions/documentid/) { get; set; } | يُستخدم لتحديد معرف "المستند" الجذر node |
