...
خيارات خاصة بالسائق لتنسيق KML.
...
| [DocumentId](../../aspose.gis.formats.kml/kmloptions/documentid/) { get; set; } | يُستخدم لتحديد معرف العقدة الجذرية 'Document' |
...
| [SymbolToReplaceInvalidChars](../../aspose.gis.formats.kml/kmloptions/symboltoreplaceinvalidchars/) { get; set; } | يحدد الرمز الذي سيُستَبدَل به الأحرف غير الصالحة عند القراءة. يتم تخطي الاستبدال إذا كانت القيمة '\\0'. القيمة الافتراضية هي الحرف '\\0'. |
