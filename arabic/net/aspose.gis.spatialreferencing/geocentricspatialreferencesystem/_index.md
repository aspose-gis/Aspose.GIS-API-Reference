...
description: نظام SRS لمركز الأرض هو SRS ديكارتي ثلاثي الأبعاد أصله في مركز الأرض.
type: docs
weight: 1990
...
نظام SRS لمركز الأرض هو SRS ديكارتي ثلاثي الأبعاد أصله في مركز الأرض.
...
| override [DimensionsCount](../../aspose.gis.spatialreferencing/geocentricspatialreferencesystem/dimensionscount) { get; } | إرجاع 3 ، نظرًا لأن SRS تكون دائمًا ثلاثية الأبعاد. |
...
| override [PrimeMeridian](../../aspose.gis.spatialreferencing/geocentricspatialreferencesystem/primemeridian) { get; } | إرجاع خط الطول الأولي لهذا SRS. |
...
| override [Validate](../../aspose.gis.spatialreferencing/geocentricspatialreferencesystem/validate)(out string) | تحديد ما إذا كان SRS هذا صالحًا. نرى[`Validate`](../spatialreferencesystem/validate) لوصف الصلاحية. |
