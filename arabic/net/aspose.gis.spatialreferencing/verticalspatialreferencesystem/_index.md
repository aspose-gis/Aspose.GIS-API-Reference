...
description: SRS العمودي عبارة عن SRS أحادي البعد يصف إحداثيات الارتفاع.
type: docs
weight: 2210
...
| override [HasPrimeMeridian](../../aspose.gis.spatialreferencing/verticalspatialreferencesystem/hasprimemeridian) { get; } | عوائد`false` ، نظرًا لأن Vertical SRS لا يحتوي على خط الطول الأولي. |
...
| override [PrimeMeridian](../../aspose.gis.spatialreferencing/verticalspatialreferencesystem/primemeridian) { get; } | رمياتInvalidOperationException ، نظرًا لأن Vertical SRS لا يحتوي على خط الطول الأولي. |
...
| override [Validate](../../aspose.gis.spatialreferencing/verticalspatialreferencesystem/validate)(out string) | تحديد ما إذا كان SRS هذا صالحًا. نرى[`Validate`](../spatialreferencesystem/validate) لوصف الصلاحية. |
