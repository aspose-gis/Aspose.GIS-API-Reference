...
description: Aspose.Gis.SpatialReferencing.LocalSpatialReferenceSystem فصل. إحداثيات SRS المحلية ذات الصلة ببعض الأشياء  وليس الأرض.
type: docs
weight: 2180
...
إحداثيات SRS المحلية ذات الصلة ببعض الأشياء ، وليس الأرض.
...
| override [Validate](../../aspose.gis.spatialreferencing/localspatialreferencesystem/validate/)(out string) | تحديد ما إذا كان SRS هذا صالحًا. يرى[`Validate`](../spatialreferencesystem/validate/) لوصف الصلاحية. |
