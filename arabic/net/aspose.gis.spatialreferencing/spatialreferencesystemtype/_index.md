...
| الاسم | القيمة | الوصف |
| --- | --- | --- |
| Unknown | `0` | القيمة الافتراضية. يمكن إرجاعها من [`Type`](../spatialreferencesystem/type/) إذا كان هذا نظام إحداثيات مركب مع تركيبة غير صالحة من أنظمة الإحداثيات الأساسية. راجع [`IsCompound`](../spatialreferencesystem/iscompound/). |
...
| Geocentric | `2` | نظام الإحداثيات الجيومتري هو نظام إحداثيات ديكارتي ثلاثي الأبعاد مع الأصل في مركز الأرض. يمكن تحويل نظام الإحداثيات الجيومتري إلى [`GeocentricSpatialReferenceSystem`](../geocentricspatialreferencesystem/) عبر طريقة [`AsGeocentric`](../spatialreferencesystem/asgeocentric/). |
...
| Vertical | `4` | نظام الإحداثيات العمودي يصف إحداثي الارتفاع الخطي. يمكن تحويل نظام الإحداثيات العمودي إلى [`VerticalSpatialReferenceSystem`](../verticalspatialreferencesystem/) عبر طريقة [`AsVertical`](../spatialreferencesystem/asvertical/). |
