...
description: يوحد مركب SRS اثنين من SRS الأساسيين  ولا يمكن أن يكون أي منهما مركبًا.
type: docs
weight: 1960
...
| override [DimensionsCount](../../aspose.gis.spatialreferencing/compoundspatialreferencesystem/dimensionscount) { get; } | عدد الأبعاد. بالنسبة إلى SRS المركب ، هذا مجموع عدد أبعاد SRS الأساسية. |
...
| override [HasPrimeMeridian](../../aspose.gis.spatialreferencing/compoundspatialreferencesystem/hasprimemeridian) { get; } | يحتوي SRS المركب على خط الزوال الرئيسي إذا كان أي من SRS الأساسي يحتوي على خط الزوال الرئيسي. |
...
| override [Type](../../aspose.gis.spatialreferencing/compoundspatialreferencesystem/type) { get; } | نوع هذا المركب SRS. يمكن ان يكونGeographicif هذا المركب SRS هو مزيج من SRS الجغرافي والعمودي ، أوProjected if هذا المركب SRS هو مزيج من SRS الرأسي والمتوقع. |
...
| override [Validate](../../aspose.gis.spatialreferencing/compoundspatialreferencesystem/validate)(out string) | تحديد ما إذا كان SRS هذا صالحًا. نرى[`Validate`](../spatialreferencesystem/validate) لوصف الصلاحية. |
