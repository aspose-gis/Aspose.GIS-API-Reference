...
description: "الفئة Aspose.Gis.SpatialReferencing.CompoundSpatialReferenceSystem. يجمع نظام الإحداثيات المركب بين نظامين أساسيين لا يمكن أن يكون أي منهما مركبًا."
type: docs
weight: 4510
...
| override [AsGeographic](../../aspose.gis.spatialreferencing/compoundspatialreferencesystem/asgeographic/) { get; } | إرجاع تمثيل جغرافي لهذا النظام. إذا كان هذا النظام المركب يمثل فعلاً نظامًا جغرافيًا، فستكون النتيجة نظام إحداثيات جغرافي ثلاثي الأبعاد (مع أبعاد الطول والعرض والارتفاع). وإلا سيتم إلقاء استثناء. |
...
| override [AsProjected](../../aspose.gis.spatialreferencing/compoundspatialreferencesystem/asprojected/) { get; } | إرجاع تمثيل إسقاطي لهذا النظام. إذا كان هذا النظام المركب يمثل فعلاً نظامًا إسقاطيًا، فستكون النتيجة نظام إحداثيات إسقاطي ثلاثي الأبعاد (مع أبعاد X وY والارتفاع). وإلا سيتم إلقاء استثناء. |
...
| override [DimensionsCount](../../aspose.gis.spatialreferencing/compoundspatialreferencesystem/dimensionscount/) { get; } | عدد الأبعاد. بالنسبة للنظام المركب، هذا هو مجموع عدد أبعاد الأنظمة الأساسية. |
...
| override [GeographicDatum](../../aspose.gis.spatialreferencing/compoundspatialreferencesystem/geographicdatum/) { get; } | إرجاع datum الجغرافي لهذا SRS. إذا كان كل من [`Head`](./head/) و[`Tail`](./tail/) يحتويان على datum جغرافي - إرجاع datum الجغرافي للـ head. |
| override [HasGeographicDatum](../../aspose.gis.spatialreferencing/compoundspatialreferencesystem/hasgeographicdatum/) { get; } | يحتوي الـ Compound SRS على datum جغرافي إذا كان أي من الـ SRS الأساسي يحتوي على datum جغرافي. |
| override [HasPrimeMeridian](../../aspose.gis.spatialreferencing/compoundspatialreferencesystem/hasprimemeridian/) { get; } | يحتوي الـ Compound SRS على خط الزوال الرئيسي إذا كان أي من الـ SRS الأساسي يحتوي على خط الزوال الرئيسي. |
| [Head](../../aspose.gis.spatialreferencing/compoundspatialreferencesystem/head/) { get; } | الـ SRS الأساسي الأول. |
| [Identifier](../../aspose.gis.spatialreferencing/identifiableobject/identifier/) { get; } | معرف هذا الكائن القابل للتعريف. |
| override [IsCompound](../../aspose.gis.spatialreferencing/compoundspatialreferencesystem/iscompound/) { get; } | يرجع `true`. |
...
| override [PrimeMeridian](../../aspose.gis.spatialreferencing/compoundspatialreferencesystem/primemeridian/) { get; } | إرجاع خط الزوال الرئيسي لهذا SRS. إذا كان كل من [`Head`](./head/) و[`Tail`](./tail/) يحتويان على خط الزوال الرئيسي - إرجاع خط الزوال الرئيسي للـ head. |
| [Tail](../../aspose.gis.spatialreferencing/compoundspatialreferencesystem/tail/) { get; } | الـ SRS الأساسي الثاني. |
| override [Type](../../aspose.gis.spatialreferencing/compoundspatialreferencesystem/type/) { get; } | نوع هذا الـ Compound SRS. يمكن أن يكون Geographic إذا كان هذا الـ Compound SRS مزيجًا من SRS جغرافي وعمودي، أو Projected إذا كان مزيجًا من SRS مسقّط وعمودي. |
