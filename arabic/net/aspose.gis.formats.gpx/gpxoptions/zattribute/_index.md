...
description: تحديد سمة GPX التي سيتم تصديرها على أنها إحداثي Z للإحداثيات ونقاط المسار ونقاط المسار . إذاnull  لن يتم تصدير أي سمة على أنها إحداثيات Z. الإعدادات الافتراضية إلى ele . القيم المحتملة هي أسماء جميع سمات GPX XML التي يمكن تمثيلها على أنها مزدوجة مثل speed و magvar و geoidheight إلخ. 
type: docs
weight: 50
