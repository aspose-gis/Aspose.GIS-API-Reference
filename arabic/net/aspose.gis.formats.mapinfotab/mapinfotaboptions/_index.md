...
| [IsIgnoreWrongData](../../aspose.gis.formats.mapinfotab/mapinfotaboptions/isignorewrongdata/) { get; set; } | يحدد ما إذا كنا سنرمي استثناءً أثناء العمل ببيانات غير صحيحة أم سنضبط القيم الافتراضية لها |
