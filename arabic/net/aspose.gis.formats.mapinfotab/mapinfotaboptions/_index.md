---
title: "الفئة MapInfoTabOptions"
second_title: "مرجع API لـ Aspose.GIS لـ .NET"
description: "الفئة Aspose.Gis.Formats.MapInfoTab.MapInfoTabOptions. خيارات خاصة بالسائق لتنسيق MapInfo Tab"
type: docs
weight: 2250
...
خيارات خاصة بالمحرك لتنسيق MapInfo Tab.
...
| الاسم | الوصف |
| --- | --- |
| [MapInfoTabOptions](mapinfotaboptions/)() | إنشاء نسخة جديدة. |

## الخصائص

| الاسم | الوصف |
| --- | --- |
| [BlockSize](../../aspose.gis.formats.mapinfotab/mapinfotaboptions/blocksize/) { get; set; } | حجم الكتلة لملفات '*.map' (مضاعفات 512). القيمة الافتراضية 16384. القيم الصالحة: من 512 إلى 32256. |
...
| [IsIgnoreWrongData](../../aspose.gis.formats.mapinfotab/mapinfotaboptions/isignorewrongdata/) { get; set; } | يحدد ما إذا كنا سنرمي استثناءً أثناء العمل مع بيانات غير صحيحة أو نضبط القيم الافتراضية لها |
...
| [TextStringAttribute](../../aspose.gis.formats.mapinfotab/mapinfotaboptions/textstringattribute/) { get; set; } | يحدد اسم السمة التي تمثل نص الكائن الرسومي 'Text'. |
