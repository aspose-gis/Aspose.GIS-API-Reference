...
description: تصف هذه الفئة سياق القيمة عندما يقرأ النطاق النقطي.
type: docs
weight: 1280
...
| اسم | وصف |
| --- | --- |
| [RasterExpressionContext](rasterexpressioncontext)(int, int) | قم بإنشاء مثيل لـ[`RasterExpressionContext`](../rasterexpressioncontext) |
