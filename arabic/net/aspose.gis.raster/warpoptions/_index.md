...
description: خيارات لتزييف البيانات النقطية .
type: docs
weight: 1330
...
| اسم | وصف |
| --- | --- |
| [CellHeight](../../aspose.gis.raster/warpoptions/cellheight) { get; set; } | يحدد ارتفاعًا جديدًا للخلية النقطية (في الوحدات المستهدفة ذات المرجعية الجغرافية) . إذا تم تعيين القيمة على 0 ، فإن[`CellHeight`](./cellheight) يتم حسابها تلقائيًا. القيمة الافتراضية هي "0" . |
