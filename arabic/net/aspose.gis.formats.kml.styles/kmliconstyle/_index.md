...
description: يحدد كيفية رسم رموز kml العلامات الموضعية و kml PhotoOverlay مع kml هندسة النقطة المرسومة في قائمة مستعرض Earth وطرق العرض الجغرافية .
type: docs
weight: 420
...
يحدد كيفية رسم رموز kml: العلامات الموضعية و kml: PhotoOverlay مع kml: هندسة النقطة المرسومة في قائمة مستعرض Earth وطرق العرض الجغرافية .
...
| [HotSpot](../../aspose.gis.formats.kml.styles/kmliconstyle/hotspot) { get; set; } | يحدد موضع النقطة المرجعية على الرمز المرتبط بالنقطة المحددة في العلامة الموضعية . القيمة الافتراضية هي`null`يعني أن نقطة الاتصال مفقودة . |
...
| [Scale](../../aspose.gis.formats.kml.styles/kmliconstyle/scale) { get; set; } | يحدد عامل القياس الذي يجب تطبيقه على عنصر الرسم. القيمة الافتراضية هي "1". |
