...
description: أPrecisionModelaspose.gis/precisionmodelالتي سيتم تطبيقها على إحداثيات X و Y عند إضافة الأشكال الهندسية إلىVectorLayeraspose.gis/vectorlayer أو عندما يتم قراءتها منVectorLayeraspose.gis/vectorlayer . القيمة الافتراضية هيExactaspose.gis/precisionmodel/exact .
type: docs
weight: 110
