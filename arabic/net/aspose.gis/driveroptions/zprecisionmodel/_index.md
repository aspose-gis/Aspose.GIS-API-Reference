...
description: أPrecisionModelaspose.gis/precisionmodel التي سيتم تطبيقها على Z إحداثيات عند إضافة الأشكال الهندسية إلىVectorLayeraspose.gis/vectorlayer أو عندما يتم قراءتها منVectorLayeraspose.gis/vectorlayer . القيمة الافتراضية هيExactaspose.gis/precisionmodel/exact .
type: docs
weight: 120
