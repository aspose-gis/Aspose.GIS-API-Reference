...
description: تحويل رقم إلى رقم مضغوط بدرجة أكبر سواء للنقطة الثابتة أو الترميز العلمي  اعتمادًا على نوع الرقم وما إذا كان محدد الدقة موجودًا أم لا. يوصى باستخدامه.
type: docs
weight: 30
...
تحويل رقم إلى رقم مضغوط بدرجة أكبر سواء للنقطة الثابتة أو الترميز العلمي ، اعتمادًا على نوع الرقم وما إذا كان محدد الدقة موجودًا أم لا. يوصى باستخدامه.
