...
description: تحويل السلسلة التي تحتوي على إحداثيات إلى كائن IPoint. تشير القيمة المرجعة إلى ما إذا كان التحويل قد نجح أو فشل.
type: docs
weight: 30
...
صواب إذا تم تحليل النص بنجاح ، وإلا سيكون خطأ.
