...
description: يمثل طبقة متجه . طبقة المتجهات هي مجموعة من المعالم الجغرافية مخزنة في ملف.
type: docs
weight: 2220
...
يمثل طبقة متجه . طبقة المتجهات هي مجموعة من المعالم الجغرافية مخزنة في ملف.
...
| اسم | وصف |
| --- | --- |
| override [Attributes](../../aspose.gis/vectorlayer/attributes) { get; } | يحصل على مجموعة السمات المخصصة للميزات الموجودة في هذا[`VectorLayer`](../vectorlayer) . |
...
| [Add](../../aspose.gis/vectorlayer/add#add)(Feature) | يضيف معلمًا جديدًا إلى الطبقة ، إذا كان مدعومًا من قبل[`VectorLayer`](../vectorlayer) س[`Driver`](./driver) . |
| virtual [Add](../../aspose.gis/vectorlayer/add#add_1)(Feature, IFeatureStyle) | يضيف معلمًا جديدًا بالنمط المحدد إلى الطبقة ، إذا كان مدعومًا من قبل[`VectorLayer`](../vectorlayer) س[`Driver`](./driver) . |
...
| [CopyAttributes](../../aspose.gis/vectorlayer/copyattributes#copyattributes)(FeaturesSequence) | نسخ سمات أخرى[`VectorLayer`](../vectorlayer) لهذا واحد . |
| [CopyAttributes](../../aspose.gis/vectorlayer/copyattributes#copyattributes_1)(FeaturesSequence, IAttributesConverter) | نسخ سمات أخرى[`VectorLayer`](../vectorlayer) لهذا واحد . |
| [Dispose](../../aspose.gis/vectorlayer/dispose)() | يقوم بإصدار الموارد التي يستخدمها ملف[`VectorLayer`](../vectorlayer) . |
...
| [WhereIntersects](../../aspose.gis/featuressequence/whereintersects)(FeaturesSequence) | ترشح المعالم بناءً على اتحاد كل الأشكال الهندسية في تسلسل المعالم الأخرى. |
...
| virtual [WhereNull](../../aspose.gis/featuressequence/wherenull)(string) | يختار المعالم ذات السمة التي تساوي قيمة خالية. |
