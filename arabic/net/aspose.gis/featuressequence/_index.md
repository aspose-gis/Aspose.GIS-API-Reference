...
description: FeaturesSequence./featuressequence يمثل مجموعة من الميزات المتجهة.
type: docs
weight: 160
...
[`FeaturesSequence`](../featuressequence) يمثل مجموعة من الميزات المتجهة.
...
| [WhereIntersects](../../aspose.gis/featuressequence/whereintersects#whereintersects_1)(FeaturesSequence) | ترشح المعالم بناءً على اتحاد كل الأشكال الهندسية في تسلسل المعالم الأخرى. |
