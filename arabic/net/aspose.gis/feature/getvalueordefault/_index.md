...
description: يحصل على قيمة سمة  أوDefaultValueaspose.gis/featureattribute/defaultvalue إذا كانت القيمة غير محددة أولا شيء .
type: docs
weight: 40
...
يحصل على قيمة سمة ، أو[`DefaultValue`](../../featureattribute/defaultvalue) إذا كانت القيمة غير محددة أو`لا شيء` .
