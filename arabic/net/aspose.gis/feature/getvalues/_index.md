...
description: إرجاع قيم كافة السمات في مصفوفة.
type: docs
weight: 50
...
يتم نسخ سمات قيم الميزة في مصفوفة القيم التي تم تمريرها كمعامل . بالنسبة إلى السمات ذات القيمة غير المحددة ، يتم إرجاع معلمة "unsetValue" المحددة. لا يلزم أن يتطابق طول صفيف القيم مع عدد السمات في الميزة. إذا كان طول المصفوفة أكبر من عدد السمات ، يتم نسخ جميع قيم السمات في المصفوفة ؛ إذا كانت أقل ، يتم نسخ عدد طول المصفوفة لقيم السمة فقط في المصفوفة ، بدءًا من قيمة السمة بالترتيب 0.
