...
description: Aspose.Gis.Formats.SqlServer.SqlServerOptions فصل. خيارات خاصة ببرنامج التشغيل لتنسيق SqlServer . في الوقت الحالي  لا يوفر برنامج التشغيل خيارات قابلة للتخصيص.
type: docs
weight: 690
