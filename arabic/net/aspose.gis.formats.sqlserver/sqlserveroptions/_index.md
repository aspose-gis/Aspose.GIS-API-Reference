...
description: "فئة Aspose.Gis.Formats.SqlServer.SqlServerOptions. خيارات خاصة بالسائق لتنسيق SqlServer. في الوقت الحالي لا يوفر السائق أي خيارات قابلة للتخصيص"
type: docs
weight: 2340
...
خيارات خاصة ببرنامج التشغيل لتنسيق SqlServer. في الوقت الحالي، لا يوفر المحرك أي خيارات قابلة للتخصيص.
