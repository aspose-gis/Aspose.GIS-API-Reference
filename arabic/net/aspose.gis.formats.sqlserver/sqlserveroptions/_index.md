---
title: "الفئة SqlServerOptions"
second_title: "مرجع API لـ Aspose.GIS لـ .NET"
description: "Aspose.Gis.Formats.SqlServer.SqlServerOptions class. خيارات خاصة بالبرنامج تشغيل لتنسيق SqlServer. في الوقت الحالي لا يوفر البرنامج تشغيل أي خيارات قابلة للتخصيص"
type: docs
weight: 2340
...
خيارات خاصة بالمحرك لتنسيق SqlServer. في الوقت الحالي، لا يقدم المحرك أي خيارات قابلة للتخصيص.
...
| الاسم | الوصف |
| --- | --- |
| [SqlServerOptions](sqlserveroptions/)() | إنشاء نسخة جديدة. |
...
| [SpatialReferenceSystemMode](../../aspose.gis/databasedriveroptions/spatialreferencesystemmode/) { get; set; } | يحدد كيفية التعامل مع نظام الإحداثيات المرجعي (SRS) للأشكال غير المعروفة في قاعدة البيانات عند إضافتها إلى الطبقة. القيمة الافتراضية هي ThrowException. |
