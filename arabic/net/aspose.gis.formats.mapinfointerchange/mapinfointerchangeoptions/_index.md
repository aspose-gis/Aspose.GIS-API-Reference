---
title: "الفئة MapInfoInterchangeOptions"
second_title: "مرجع API لـ Aspose.GIS لـ .NET"
description: "الفئة Aspose.Gis.Formats.MapInfoInterchange.MapInfoInterchangeOptions. خيارات خاصة بالسائق لتنسيق MapInfo Interchange"
type: docs
weight: 2230
url: /ar/net/aspose.gis.formats.mapinfointerchange/mapinfointerchangeoptions/
---
## MapInfoInterchangeOptions class

خيارات خاصة ببرنامج التشغيل لتنسيق MapInfo Interchange.
...
| الاسم | الوصف |
| --- | --- |
| [MapInfoInterchangeOptions](mapinfointerchangeoptions/)() | إنشاء نسخة جديدة. |
...
| [TextStringAttribute](../../aspose.gis.formats.mapinfointerchange/mapinfointerchangeoptions/textstringattribute/) { get; set; } | يحدد اسم السمة التي تمثل نص الكائن الرسومي 'Text'. |
