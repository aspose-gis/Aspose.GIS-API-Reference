...
description: Aspose.Gis.Formats.MapInfoInterchange.MapInfoInterchangeOptions فصل. خيارات خاصة ببرنامج التشغيل لتنسيق MapInfo Interchange .
type: docs
weight: 590
...
| اسم | وصف |
| --- | --- |
| [MapInfoInterchangeOptions](mapinfointerchangeoptions/)() | إنشاء مثيل جديد . |
...
| [TextStringAttribute](../../aspose.gis.formats.mapinfointerchange/mapinfointerchangeoptions/textstringattribute/) { get; set; } | يحدد اسم السمة التي تمثل نص كائن رسومي "نص". |
