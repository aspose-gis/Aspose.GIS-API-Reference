...
description: الحصول على أصل إحداثيات Y أو تعيينه. إذا تم التعيين علىnull الافتراضي هو المستخدم.
type: docs
weight: 70
...
الحصول على أصل إحداثيات Y أو تعيينه. إذا تم التعيين على`null` الافتراضي هو المستخدم.
