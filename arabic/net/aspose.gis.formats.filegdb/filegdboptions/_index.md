...
| [ExpectedGeometryType](../../aspose.gis.formats.filegdb/filegdboptions/expectedgeometrytype/) { get; set; } | نوع الهندسة المتوقع للطبقة. إذا تم تعيين هذا الخيار فإننا نسمح بإضافة الهندسات فقط من هذا النوع |
| [GeometryFieldName](../../aspose.gis.formats.filegdb/filegdboptions/geometryfieldname/) { get; set; } | اسم حقل الهندسة. |
| [HasM](../../aspose.gis.formats.filegdb/filegdboptions/hasm/) { get; set; } | هل يمكن للهندسات في الطبقة أن تحتوي على إحداثية 'm'. القيمة الافتراضية هي true |
| [HasZ](../../aspose.gis.formats.filegdb/filegdboptions/hasz/) { get; set; } | هل يمكن للهندسات في الطبقة أن تحتوي على إحداثية 'z'. القيمة الافتراضية هي true |
...
| [XYTolerance](../../aspose.gis.formats.filegdb/filegdboptions/xytolerance/) { get; set; } | تحمل الالتقاط للمحورين X و Y. |
