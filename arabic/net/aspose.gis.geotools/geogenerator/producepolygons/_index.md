...
description: إنشاء عدّاد IPolygon جديد مع عدد معين من العناصر العشوائية  وكلها ضمن نطاق معين.
type: docs
weight: 30
...
| NullReferenceException | يجب أن يحتوي النطاق على قيمة (يجب ألا يكون فارغًا) |
| ArgumentException | يجب أن يكون الحد الأدنى والحد الأقصى للطول غير متساوي وأكبر من 0 |
