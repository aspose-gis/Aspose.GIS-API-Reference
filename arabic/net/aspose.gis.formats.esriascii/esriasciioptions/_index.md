---
title: "الفئة EsriAsciiOptions"
second_title: "مرجع API لـ Aspose.GIS لـ .NET"
description: "الفئة Aspose.Gis.Formats.EsriAscii.EsriAsciiOptions. خيارات خاصة بالسائق لتنسيق EsriAscii"
type: docs
weight: 1810
...
خيارات خاصة بالمحرك لتنسيق EsriAscii.
...
| الاسم | الوصف |
| --- | --- |
| [EsriAsciiOptions](esriasciioptions/)() | إنشاء نسخة جديدة. |
