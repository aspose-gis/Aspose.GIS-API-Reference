...
| [DateAsString](../../aspose.gis.formats.geojson/geojsonoptions/dateasstring/) { get; set; } | ما إذا كان سيتم كشف تاريخ/وقت/تاريخ-وقت JSon كسلسلة. |
...
| [GeometryAsCollection](../../aspose.gis.formats.geojson/geojsonoptions/geometryascollection/) { get; set; } | التحكم في تحويل الأشكال الهندسية: نعم - تغليف الأشكال بـ نوع GeometryCollection |
...
| [ReadBoundingBoxes](../../aspose.gis.formats.geojson/geojsonoptions/readboundingboxes/) { get; set; } | يحدد ما إذا كان يجب قراءة صناديق الحدود ('bbox') كسمات باسم 'bbox_0'، 'bbox_1'، إلخ. القيمة الافتراضية هي `false`. يتم استخدام سلسلة [`NestedPropertiesSeparator`](./nestedpropertiesseparator/) في أسماء bbox_0، bbox_1،.. |
...
| [WriteBoundingBoxes](../../aspose.gis.formats.geojson/geojsonoptions/writeboundingboxes/) { get; set; } | يحدد ما إذا كان يجب تضمين معلومات عن نطاق الإحداثيات لأشكال GeoJSON في الكائنات. إذا تم تعيينه إلى `true`، يتم إنشاء عضو \"bbox\" لكل شكل (ليس null) عند إضافته إلى الطبقة. القيمة الافتراضية هي `false`. |
...
| [WriteUnsetAttribute](../../aspose.gis.formats.geojson/geojsonoptions/writeunsetattribute/) { get; set; } | ما إذا كان سيتم كتابة السمات غير المحددة بإضافة قيمة 'null' |
