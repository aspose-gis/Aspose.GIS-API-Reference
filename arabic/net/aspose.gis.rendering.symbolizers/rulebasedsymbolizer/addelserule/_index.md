...
description: "طريقة RuleBasedSymbolizer. تضيف مُرمّزًا سيُطبق على الميزات التي لا تطابق أي قاعدة تصفية"
type: docs
weight: 50
...
يضيف مُرمّزاً سيُطبق على الميزات التي لا تتطابق مع أي قاعدة تصفية.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| symbolizer | VectorSymbolizer | مُرمّز. |
