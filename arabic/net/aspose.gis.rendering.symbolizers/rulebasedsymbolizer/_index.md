...
description: لتطبيق رمز رمز على الأشكال الهندسية للميزات وفقًا لقواعد يحددها المستخدم.
type: docs
weight: 1830
...
لتطبيق رمز رمز على الأشكال الهندسية للميزات وفقًا لقواعد يحددها المستخدم.
