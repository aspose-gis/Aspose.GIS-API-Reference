...
| الاسم | الوصف |
| --- | --- |
| [MarkerLine](markerline/#constructor)() | ينشئ مثلاً جديداً من الفئة `MarkerLine`. |
| [MarkerLine](markerline/#constructor_1)(MarkerLine) | ينشئ مثلاً جديداً من الفئة `MarkerLine`. |
