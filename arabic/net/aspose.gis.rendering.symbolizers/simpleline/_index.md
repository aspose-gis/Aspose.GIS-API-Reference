...
| [SimpleLine](simpleline#constructor_1)(SimpleLine) | يقوم بتهيئة مثيل جديد لملف[`SimpleLine`](../simpleline) فئة . |
...
| [Offset](../../aspose.gis.rendering.symbolizers/simpleline/offset) { get; set; } | يحدد الإزاحة من السطر الأصلي. بالنسبة للمسافة الموجبة ، ستكون الإزاحة على الجانب الأيسر من خط الإدخال (بالنسبة لاتجاه الخط) . بالنسبة للمسافة السالبة ، ستكون في الجانب الأيمن. |
