...
description: "خاصية RasterImageMarker. تحدد دوران الرمز حول نقطة مركزه بالدرجات العشرية. القيم الموجبة تشير إلى الدوران في اتجاه عقارب الساعة والقيم السالبة تشير إلى الدوران عكس اتجاه عقارب الساعة"
type: docs
weight: 70
url: /ar/net/aspose.gis.rendering.symbolizers/rasterimagemarker/rotation/
---
