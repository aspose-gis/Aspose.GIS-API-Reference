...
description: قائمة مفصولة بمسافة لأزواج URI. أول URI في كل زوج هو URI لمساحة الاسم  والثاني URI هو مسار إلى مخطط XML لمساحة الاسم . إذا تم التعيين علىnull وGmlDriveraspose.gis.formats.gml/gmldriver سيحاول قراءة schemaLocation من العنصر الجذر للمستند. الافتراضي هوnull .
type: docs
weight: 50
...
قائمة مفصولة بمسافة لأزواج URI. أول URI في كل زوج هو URI لمساحة الاسم ، والثاني URI هو مسار إلى مخطط XML لمساحة الاسم . إذا تم التعيين على`null` و[`GmlDriver`](../../gmldriver) سيحاول قراءة schemaLocation من العنصر الجذر للمستند. الافتراضي هو`null` .
