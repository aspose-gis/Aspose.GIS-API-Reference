---
title: "الفئة OsmXmlOptions"
second_title: "مرجع API لـ Aspose.GIS لـ .NET"
description: "الفئة Aspose.Gis.Formats.OsmXml.OsmXmlOptions. خيارات خاصة بالسائق لتنسيق OSM XML"
type: docs
weight: 2270
url: /ar/net/aspose.gis.formats.osmxml/osmxmloptions/
---
## OsmXmlOptions class
...
| الاسم | الوصف |
| --- | --- |
| [OsmXmlOptions](osmxmloptions/)() | إنشاء نسخة جديدة. |
...
| [ReportAllNodes](../../aspose.gis.formats.osmxml/osmxmloptions/reportallnodes/) { get; set; } | الإبلاغ عن جميع العقد كميزات، حتى إذا لم تكن لديها أي وسوم مهمة. |
| [ReportAllWays](../../aspose.gis.formats.osmxml/osmxmloptions/reportallways/) { get; set; } | الإبلاغ عن جميع الطرق كميزات، حتى إذا لم تكن لديها أي وسوم مهمة أو أي عقد. |
| [ReportCommonAttributes](../../aspose.gis.formats.osmxml/osmxmloptions/reportcommonattributes/) { get; set; } | الإبلاغ عن سمات OSM الشائعة: visible، version، changeset، timestamp، user و uid. سيتم الإبلاغ عن السمات الشائعة كسمات للميزات مع بادئة "osm_"، مثل osm_user، osm_timestamp، إلخ. |
...
| [WriteCommonAttributes](../../aspose.gis.formats.osmxml/osmxmloptions/writecommonattributes/) { get; set; } | كتابة سمات OSM الشائعة: visible، version، changeset، timestamp، user و uid. |
