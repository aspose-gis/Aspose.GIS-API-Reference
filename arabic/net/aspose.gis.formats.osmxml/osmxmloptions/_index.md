...
description: خيارات خاصة ببرنامج التشغيل لتنسيق OSM XML .
type: docs
weight: 560
...
| [ReportAllWays](../../aspose.gis.formats.osmxml/osmxmloptions/reportallways) { get; set; } | قم بالإبلاغ عن جميع الطرق كميزات ، حتى إذا لم يكن لديهم أي علامات مهمة أو ليس لديهم أي عقد. |
| [ReportCommonAttributes](../../aspose.gis.formats.osmxml/osmxmloptions/reportcommonattributes) { get; set; } | الإبلاغ عن سمات OSM الشائعة: مرئية ، وإصدار ، ومجموعة تغييرات ، وطابع زمني ، ومستخدم ، و uid. سيتم الإبلاغ عن السمات الشائعة كسمات ميزة مع بادئة "osm_" ، على سبيل المثال ، osm_user ، osm_timestamp ، إلخ . |
