...
description: Aspose.Gis.Formats.OsmXml.OsmXmlOptions فصل. خيارات خاصة ببرنامج التشغيل لتنسيق OSM XML .
type: docs
weight: 630
...
| اسم | وصف |
| --- | --- |
| [OsmXmlOptions](osmxmloptions/)() | إنشاء مثيل جديد . |
...
| [ReportAllNodes](../../aspose.gis.formats.osmxml/osmxmloptions/reportallnodes/) { get; set; } | قم بالإبلاغ عن جميع العقد كميزات ، حتى إذا لم يكن لديها أي علامات مهمة . |
| [ReportAllWays](../../aspose.gis.formats.osmxml/osmxmloptions/reportallways/) { get; set; } | قم بالإبلاغ عن جميع الطرق باعتبارها ميزات ، حتى إذا لم يكن لديهم أي علامات مهمة أو ليس لديهم أي عقد. |
| [ReportCommonAttributes](../../aspose.gis.formats.osmxml/osmxmloptions/reportcommonattributes/) { get; set; } | الإبلاغ عن سمات OSM الشائعة: مرئي ، وإصدار ، ومجموعة تغييرات ، وطابع زمني ، ومستخدم و uid. سيتم الإبلاغ عن السمات الشائعة كسمات ميزة مع بادئة "osm_" ، على سبيل المثال ، osm_user ، osm_timestamp ، إلخ . |
