...
description: Aspose.Gis.Formats.GeoTiff.GeoTiffOptions فصل. خيارات خاصة ببرنامج التشغيل لتنسيق GeoTiff.
type: docs
weight: 330
...
خيارات خاصة ببرنامج التشغيل لتنسيق GeoTiff.
...
| اسم | وصف |
| --- | --- |
| [GeoTiffOptions](geotiffoptions/)() | إنشاء مثيل جديد . |
