...
description: "Aspose.Gis.Formats.GeoJsonSeq.GeoJsonSeqOptions فئة. خيارات خاصة بالسائق لتنسيق GeoJsonSeq"
type: docs
weight: 1920
...
| [DateAsString](../../aspose.gis.formats.geojsonseq/geojsonseqoptions/dateasstring/) { get; set; } | ما إذا كان يجب كشف تاريخ/وقت/تاريخ‑وقت JSon كسلسلة. |
...
| [GeometryAsCollection](../../aspose.gis.formats.geojsonseq/geojsonseqoptions/geometryascollection/) { get; set; } | التحكم في ترجمة الأشكال: نعم - غلف الأشكال بنوع GeometryCollection |
...
| [WriteUnsetAttribute](../../aspose.gis.formats.geojsonseq/geojsonseqoptions/writeunsetattribute/) { get; set; } | ما إذا كان يجب كتابة السمات غير المحددة بإضافة القيمة 'null' |
