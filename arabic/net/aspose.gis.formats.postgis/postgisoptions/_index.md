...
description: Aspose.Gis.Formats.PostGis.PostGisOptions فصل. خيارات خاصة ببرنامج التشغيل لتنسيق PostGis . في الوقت الحالي  لا يوفر برنامج التشغيل خيارات قابلة للتخصيص.
type: docs
weight: 650
...
خيارات خاصة ببرنامج التشغيل لتنسيق PostGis . في الوقت الحالي ، لا يوفر برنامج التشغيل خيارات قابلة للتخصيص.
...
| اسم | وصف |
| --- | --- |
| [PostGisOptions](postgisoptions/)() | إنشاء مثيل جديد. |
