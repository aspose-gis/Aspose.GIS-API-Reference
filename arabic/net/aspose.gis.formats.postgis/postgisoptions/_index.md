---
title: "الفئة PostGisOptions"
second_title: "مرجع API لـ Aspose.GIS لـ .NET"
description: "الفئة Aspose.Gis.Formats.PostGis.PostGisOptions. خيارات خاصة بالمشغل لتنسيق PostGis. في الوقت الحالي لا يوفر المشغل أي خيارات قابلة للتخصيص."
type: docs
weight: 2300
url: /ar/net/aspose.gis.formats.postgis/postgisoptions/
---
## PostGisOptions class

خيارات خاصة ببرنامج التشغيل لتنسيق PostGis. في الوقت الحالي، لا يوفر برنامج التشغيل أي خيارات قابلة للتخصيص.
...
| الاسم | الوصف |
| --- | --- |
| [PostGisOptions](postgisoptions/)() | إنشاء نسخة جديدة. |
