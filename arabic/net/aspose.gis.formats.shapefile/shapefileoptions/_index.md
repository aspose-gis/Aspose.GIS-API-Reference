...
خيارات خاصة بالمحرك لتنسيق Shapefile. في الوقت الحالي، لا يقدم المحرك أي خيارات قابلة للتخصيص.
...
| [IsIgnoreWrongData](../../aspose.gis.formats.shapefile/shapefileoptions/isignorewrongdata/) { get; set; } | يحدد ما إذا كنا يجب أن نرمي استثناءً أثناء تحليل البيانات الخاطئة أو نضع قيمًا افتراضية لها |
