---
title: "الفئة ShapefileOptions"
second_title: "مرجع API لـ Aspose.GIS لـ .NET"
description: "الفئة Aspose.Gis.Formats.Shapefile.ShapefileOptions. خيارات خاصة بالسائق لتنسيق Shapefile. في الوقت الحالي لا يوفر السائق أي خيارات قابلة للتخصيص"
type: docs
weight: 2320
url: /ar/net/aspose.gis.formats.shapefile/shapefileoptions/
---
## ShapefileOptions class

خيارات خاصة ببرنامج التشغيل لتنسيق Shapefile. في الوقت الحالي، لا يوفر المحرك أي خيارات قابلة للتخصيص.
...
| الاسم | الوصف |
| --- | --- |
| [ShapefileOptions](shapefileoptions/)() | إنشاء نسخة جديدة. |
...
| [IsIgnoreWrongData](../../aspose.gis.formats.shapefile/shapefileoptions/isignorewrongdata/) { get; set; } | يحدد ما إذا كان يجب علينا رمي استثناء أثناء تحليل البيانات الخاطئة أو تعيين القيم الافتراضية لها |
