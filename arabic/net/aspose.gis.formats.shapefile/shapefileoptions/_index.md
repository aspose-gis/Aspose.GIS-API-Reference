...
description: Aspose.Gis.Formats.Shapefile.ShapefileOptions فصل. خيارات خاصة ببرنامج التشغيل لتنسيق Shapefile . في الوقت الحالي  لا يوفر برنامج التشغيل خيارات قابلة للتخصيص.
type: docs
weight: 670
...
خيارات خاصة ببرنامج التشغيل لتنسيق Shapefile . في الوقت الحالي ، لا يوفر برنامج التشغيل خيارات قابلة للتخصيص.
...
| اسم | وصف |
| --- | --- |
| [ShapefileOptions](shapefileoptions/)() | إنشاء مثيل جديد . |
