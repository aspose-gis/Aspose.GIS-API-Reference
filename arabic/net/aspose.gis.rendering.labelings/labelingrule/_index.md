...
description: قاعدة معرّفة من قبل المستخدم لـRuleBasedLabeling./rulebasedlabeling .
type: docs
weight: 1530
...
| اسم | وصف |
| --- | --- |
| [Filter](../../aspose.gis.rendering.labelings/labelingrule/filter) { get; } | تحديد ما إذا كان يجب على "قاعدة الفلتر" تطبيق وضع العلامات على الميزة. إذا تم إرجاعها`true` يتم استخدام العلامات ؛ خلاف ذلك ، يتم تخطي الميزة. |
