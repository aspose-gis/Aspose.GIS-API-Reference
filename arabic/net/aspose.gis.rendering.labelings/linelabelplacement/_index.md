...
description: وضع تسمية الخط يضع التسميات على طول الخط.
type: docs
weight: 1550
...
| [MaxAngleDelta](../../aspose.gis.rendering.labelings/linelabelplacement/maxangledelta) { get; set; } | عند استخدامها مع ملفاتCurved يضبط الحد الأقصى للزاوية بالدرجات بين 2 حرفًا متتاليًا في تسمية منحنية. الافتراضي هو 25. |
