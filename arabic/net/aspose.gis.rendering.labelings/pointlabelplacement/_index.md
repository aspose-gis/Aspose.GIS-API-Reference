...
description: وضع ملصق النقاط يضع الملصقات بالقرب من مراكز الهندسة.
type: docs
weight: 1580
...
| [VerticalAnchorPoint](../../aspose.gis.rendering.labelings/pointlabelplacement/verticalanchorpoint) { get; set; } | يحدد أي جانب من التسمية سيتم محاذاته رأسيًا مع موقع النقطة. |
