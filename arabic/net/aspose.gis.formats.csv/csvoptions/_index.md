...
description: "فئة Aspose.Gis.Formats.Csv.CsvOptions. خيارات خاصة بالمشغل لتنسيق CSV"
type: docs
weight: 1700
...
| [ColumnM](../../aspose.gis.formats.csv/csvoptions/columnm/) { get; set; } | يحصل أو يضبط اسم العمود الذي يحتوي على قيمة إحداثي M. القيمة الافتراضية هي `null`. |
| [ColumnWkt](../../aspose.gis.formats.csv/csvoptions/columnwkt/) { get; set; } | يحصل أو يضبط اسم العمود الذي يحتوي على نص معروف جيدًا (Well-Known Text) لتمثيل الهندسة. القيمة الافتراضية هي `null`. |
| [ColumnX](../../aspose.gis.formats.csv/csvoptions/columnx/) { get; set; } | يحصل أو يضبط اسم العمود الذي يحتوي على قيمة إحداثي X. القيمة الافتراضية هي `null`. |
| [ColumnY](../../aspose.gis.formats.csv/csvoptions/columny/) { get; set; } | يحصل أو يضبط اسم العمود الذي يحتوي على قيمة إحداثي Y. القيمة الافتراضية هي `null`. |
| [ColumnZ](../../aspose.gis.formats.csv/csvoptions/columnz/) { get; set; } | يحصل أو يضبط اسم العمود الذي يحتوي على قيمة إحداثي Z. القيمة الافتراضية هي `null`. |
...
| [Delimiter](../../aspose.gis.formats.csv/csvoptions/delimiter/) { get; set; } | يحصل أو يضبط حرفًا يُستخدم كفاصل لتقسيم القيم. القيمة الافتراضية هي ','. |
| [DoubleQuoteEscape](../../aspose.gis.formats.csv/csvoptions/doublequoteescape/) { get; set; } | يحصل أو يضبط حرفًا يُستخدم كحرف هروب للاقتباسات المزدوجة. القيمة الافتراضية هي '\"'. |
...
| [StartLineNumber](../../aspose.gis.formats.csv/csvoptions/startlinenumber/) { get; set; } | يحصل أو يضبط رقم السطر (مبني على الصفر) الذي سيكون الأول عند قراءة البيانات. القيمة الافتراضية هي 0. |
