...
description: خيارات خاصة ببرنامج التشغيل لتنسيق CSV .
type: docs
weight: 190
...
| [Delimiter](../../aspose.gis.formats.csv/csvoptions/delimiter) { get; set; } | الحصول على أو تعيين حرف يُستخدم كمحدد لفصل القيم . الافتراضي هو '،' . |
| [DoubleQuoteEscape](../../aspose.gis.formats.csv/csvoptions/doublequoteescape) { get; set; } | الحصول على أو تعيين حرف يُستخدم كحرف هروب لعلامات الاقتباس المزدوجة. الإعداد الافتراضي هو "" . |
| [HasAttributeNames](../../aspose.gis.formats.csv/csvoptions/hasattributenames) { get; set; } | تحديد ما إذا كان صف الرأس بأسماء السمات موجودًا. الإعداد الافتراضي هو`true` . |
