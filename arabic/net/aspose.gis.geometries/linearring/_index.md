...
description: "فئة Aspose.Gis.Geometries.LinearRing. LinearRing هو LineString يكون مغلقًا وبسيطًا"
type: docs
weight: 2910
...
| الاسم | الوصف |
| --- | --- |
| [LinearRing](linearring/#constructor)() | ينشئ نسخة جديدة من فئة `LinearRing`. |
| [LinearRing](linearring/#constructor_2)(IEnumerable&lt;IPoint&gt;) | ينشئ نسخة جديدة من فئة `LinearRing`. |
| [LinearRing](linearring/#constructor_1)(ILineString) | ينشئ نسخة جديدة من فئة `LinearRing`. |
