---
title: "الفئة LinearRing"
second_title: "مرجع API لـ Aspose.GIS لـ .NET"
description: "الفئة Aspose.Gis.Geometries.LinearRing. LinearRing هي LineString تكون مغلقة وبسيطة"
type: docs
weight: 2910
...
`LinearRing` هو [`LineString`](../linestring/) يكون مغلقًا وبسيطًا.
...
| الاسم | الوصف |
| --- | --- |
| [LinearRing](linearring/#constructor)() | ينشئ مثيلاً جديدًا من الفئة `LinearRing`. |
| [LinearRing](linearring/#constructor_2)(IEnumerable&lt;IPoint&gt;) | ينشئ مثيلاً جديدًا من الفئة `LinearRing`. |
| [LinearRing](linearring/#constructor_1)(ILineString) | ينشئ مثيلاً جديدًا من الفئة `LinearRing`. |
...
| override [GeometryType](../../aspose.gis.geometries/linearring/geometrytype/) { get; } | يحصل على نوع الـ geometry. |
...
| الاسم | الوصف |
| --- | --- |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint/)(IPoint) | يضيف نقطة إلى نهاية الخط. |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint/)(double, double) | يضيف نقطة إلى نهاية الخط. |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint/)(double, double, double) | يضيف نقطة إلى نهاية الخط. |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint/)(double, double, double, double) | يضيف نقطة إلى نهاية الخط. |
...
| override [Clone](../../aspose.gis.geometries/linearring/clone/)() | ينسخ هذا الكائن. |
...
| [Equals](../../aspose.gis.geometries/linestring/equals/)(ILineString) | يشير إلى ما إذا كان الكائن الحالي مساويًا لكائن آخر من نفس النوع. |
...
| [IsClockwise](../../aspose.gis.geometries/linearring/isclockwise/)() | يحدد ما إذا كانت الحلقة لها دوران باتجاه عقارب الساعة. |
...
| [ToEditable](../../aspose.gis.geometries/linearring/toeditable/#toeditable_2)() | يحصل على نسخة قابلة للتحرير من هذه الهندسة. (4 طرق) |
