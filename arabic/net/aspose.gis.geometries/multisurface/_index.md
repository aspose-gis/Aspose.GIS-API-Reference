...
description: "Aspose.Gis.Geometries.MultiSurface الفئة. MultiSurface هو مجموعة هندسية أحادية البعد (GeometryCollection) حيث تكون عناصرها ISurfaces"
type: docs
weight: 2960
...
الـ `MultiSurface` هو مجموعة أحادية البعد [`GeometryCollection`](../geometrycollection/) حيث تكون عناصرها [`ISurface`](../isurface/).
...
| الاسم | الوصف |
| --- | --- |
| [MultiSurface](multisurface/)() | يُنشئ مثيلاً جديداً للفئة `MultiSurface`. |
...
| override [GeometryType](../../aspose.gis.geometries/multisurface/geometrytype/) { get; } | يحصل على نوع الهندسة. |
