...
description: أMultiSurface./multisurface هو بعد واحدGeometryCollection./geometrycollection من العناصرISurface./isurface s.
type: docs
weight: 1080
...
أ[`MultiSurface`](../multisurface) هو بعد واحد[`GeometryCollection`](../geometrycollection) من العناصر[`ISurface`](../isurface) s.
...
| اسم | وصف |
| --- | --- |
| [MultiSurface](multisurface)() | يقوم بتهيئة مثيل جديد لملف[`MultiSurface`](../multisurface) فئة . |
...
| override [Clone](../../aspose.gis.geometries/multisurface/clone)() | استنساخ هذا المثال . |
...
| [ToEditable](../../aspose.gis.geometries/multisurface/toeditable#toeditable_2)() | الحصول على نسخة قابلة للتحرير من هذه الهندسة. (3 methods) |
| [ToEditable&lt;T&gt;](../../aspose.gis.geometries/geometry/toeditable)() | الحصول على نسخة قابلة للتحرير من هذه الهندسة. |
| [ToLinearGeometry](../../aspose.gis.geometries/multisurface/tolineargeometry#tolineargeometry_4)() | الحصول على إصدار تقريبي أو مكافئ غير منحني من هذه الهندسة باستخدام الإعداد الافتراضي`تفاوت` . (3 methods) |
| [ToLinearGeometry](../../aspose.gis.geometries/multisurface/tolineargeometry#tolineargeometry_5)(double) | الحصول على إصدار تقريبي أو مكافئ غير منحني من هذه الهندسة باستخدام المحدد`تفاوت` . (3 methods) |
