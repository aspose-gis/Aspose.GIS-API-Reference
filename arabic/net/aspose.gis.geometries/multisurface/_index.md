---
title: "الفئة MultiSurface"
second_title: "مرجع API لـ Aspose.GIS لـ .NET"
description: "فئة Aspose.Gis.Geometries.MultiSurface. الـ MultiSurface هو مجموعة GeometryCollection أحادية البعد تحتوي عناصرها على ISurfaces"
type: docs
weight: 2960
url: /ar/net/aspose.gis.geometries/multisurface/
---
## MultiSurface class

الـ `MultiSurface` هو مجموعة [`GeometryCollection`](../geometrycollection/) أحادية البعد تحتوي عناصرها على [`ISurface`](../isurface/)s.
...
| الاسم | الوصف |
| --- | --- |
| [MultiSurface](multisurface/)() | يُنشئ مثلاً جديداً من الفئة `MultiSurface`. |
...
| override [GeometryType](../../aspose.gis.geometries/multisurface/geometrytype/) { get; } | يحصل على نوع الـ geometry. |
...
| override [Clone](../../aspose.gis.geometries/multisurface/clone/)() | ينسخ هذا الكائن. |
...
| [ToEditable](../../aspose.gis.geometries/multisurface/toeditable/#toeditable_2)() | يحصل على نسخة قابلة للتحرير من هذه الهندسة. (3 طرق) |
| [ToEditable&lt;T&gt;](../../aspose.gis.geometries/geometry/toeditable/)() | يحصل على نسخة قابلة للتحرير من هذه الهندسة. |
| [ToLinearGeometry](../../aspose.gis.geometries/multisurface/tolineargeometry/#tolineargeometry_4)() | يحصل على نسخة تقريبية أو مكافئة غير منحنية لهذه الهندسة باستخدام `tolerance` الافتراضي. (3 طرق) |
| [ToLinearGeometry](../../aspose.gis.geometries/multisurface/tolineargeometry/#tolineargeometry_5)(double) | يحصل على نسخة تقريبية أو مكافئة غير منحنية لهذه الهندسة باستخدام `tolerance` المحدد. (3 طرق) |
