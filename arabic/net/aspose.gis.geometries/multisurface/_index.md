...
description: Aspose.Gis.Geometries.MultiSurface فصل. أMultiSurface هو بعد واحدGeometryCollection من العناصرISurface s.
type: docs
weight: 1180
...
أ`MultiSurface` هو بعد واحد[`GeometryCollection`](../geometrycollection/) من العناصر[`ISurface`](../isurface/) s.
...
| اسم | وصف |
| --- | --- |
| [MultiSurface](multisurface/)() | يقوم بتهيئة مثيل جديد لملف`MultiSurface` فئة . |
...
| [ToLinearGeometry](../../aspose.gis.geometries/multisurface/tolineargeometry/#tolineargeometry_4)() | الحصول على إصدار تقريبي أو مكافئ غير منحني من هذه الهندسة باستخدام الإعداد الافتراضي`تسامح` . (3 methods) |
| [ToLinearGeometry](../../aspose.gis.geometries/multisurface/tolineargeometry/#tolineargeometry_5)(double) | الحصول على إصدار تقريبي أو مكافئ غير منحني من هذه الهندسة باستخدام المحدد`تسامح` . (3 methods) |
