...
description: سطح مستو  محدد بحد خارجي واحد و 0 أو أكثر من الحدود الداخلية .
type: docs
weight: 810
...
| اسم | وصف |
| --- | --- |
| [CurvePolygon](curvepolygon#constructor)() | يقوم بتهيئة مثيل جديد لملف[`CurvePolygon`](../curvepolygon) فئة . |
| [CurvePolygon](curvepolygon#constructor_1)(ICurve) | يقوم بتهيئة مثيل جديد لملف[`CurvePolygon`](../curvepolygon) فئة . |
| [CurvePolygon](curvepolygon#constructor_2)(ICurve, IEnumerable&lt;ICurve&gt;) | يقوم بتهيئة مثيل جديد لملف[`CurvePolygon`](../curvepolygon) فئة . |
...
| [InteriorRingsCount](../../aspose.gis.geometries/curvepolygon/interiorringscount) { get; } | الحصول على عدد الحلقات الداخلية . |
