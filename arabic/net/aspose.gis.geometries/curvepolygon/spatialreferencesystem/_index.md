...
description: "خاصية CurvePolygon. يحصل على SpatialReferenceSystem لهذا الكائن. يمكن أن تكون هذه الخاصية فارغة إذا كان SpatialReferenceSystem غير معروف. تعيين SpatialReferenceSystem جديد لن يؤدي إلى أي تحويل إحداثي، فقط سيتغير المرجع"
type: docs
weight: 90
url: /ar/net/aspose.gis.geometries/curvepolygon/spatialreferencesystem/
---
