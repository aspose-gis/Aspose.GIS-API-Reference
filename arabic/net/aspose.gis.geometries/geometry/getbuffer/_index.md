...
description: حساب منطقة عازلة حول هذه الهندسة .
type: docs
weight: 210
...
| quadrantSegments | Int32 | عدد المقاطع المستخدمة لتقريب 90 درجة من الانحناء . كلما زاد هذا الرقم ، تم إنتاج تقريب أفضل للمنحنيات . الافتراضي هو 30. |
