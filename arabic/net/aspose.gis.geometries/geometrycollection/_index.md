---
title: "الفئة GeometryCollection"
second_title: "مرجع API لـ Aspose.GIS لـ .NET"
description: "فئة Aspose.Gis.Geometries.GeometryCollection. مجموعة GeometryCollection هي Geometry تُعد مجموعة من هندسة واحدة أو أكثر"
type: docs
weight: 2710
...
مجموعة `GeometryCollection` هي [`Geometry`](../geometry/) تُعد مجموعة من هندسة واحدة أو أكثر.
...
| الاسم | الوصف |
| --- | --- |
| [GeometryCollection](geometrycollection/)() | ينشئ مثيلًا جديدًا من فئة `GeometryCollection`. |
...
| override [Dimension](../../aspose.gis.geometries/geometrycollection/dimension/) { get; } | يحصل على البُعد الطوبولوجي لهذا [`Geometry`](../geometry/). إذا كانت المجموعة فارغة، يتم إرجاع Point. |
| override [GeometryType](../../aspose.gis.geometries/geometrycollection/geometrytype/) { get; } | يحصل على نوع الـ geometry. |
...
| override [Clone](../../aspose.gis.geometries/geometrycollection/clone/)() | ينسخ هذا الكائن. |
...
| [Equals](../../aspose.gis.geometries/geometrycollection/equals/#equals)(IGeometryCollection) | يشير إلى ما إذا كان الكائن الحالي مساويًا لكائن آخر من نفس النوع. |
...
| [ReplacePolygonsByLines](../../aspose.gis.geometries/geometrycollection/replacepolygonsbylines/#replacepolygonsbylines_1)() | يحصل على المضلعات الممثلة كخطوط لهذه الهندسة. (2 طرق) |
...
| [ToEditable](../../aspose.gis.geometries/geometrycollection/toeditable/#toeditable_1)() | يحصل على نسخة قابلة للتحرير من هذه الهندسة. (طريقتان) |
| [ToEditable&lt;T&gt;](../../aspose.gis.geometries/geometry/toeditable/)() | يحصل على نسخة قابلة للتحرير من هذه الهندسة. |
| [ToLinearGeometry](../../aspose.gis.geometries/geometrycollection/tolineargeometry/#tolineargeometry_2)() | يحصل على نسخة تقريبية أو مكافئة غير منحنية لهذه الهندسة باستخدام `tolerance` الافتراضي. (2 طرق) |
| [ToLinearGeometry](../../aspose.gis.geometries/geometrycollection/tolineargeometry/#tolineargeometry_3)(double) | يحصل على نسخة تقريبية أو مكافئة غير منحنية لهذه الهندسة باستخدام `tolerance` المحدد. (2 طرق) |
...
| [operator ==](../../aspose.gis.geometries/geometrycollection/op_equality/) | ينفّذ العامل ==. |
| [operator !=](../../aspose.gis.geometries/geometrycollection/op_inequality/) | ينفّذ العامل !=. |
