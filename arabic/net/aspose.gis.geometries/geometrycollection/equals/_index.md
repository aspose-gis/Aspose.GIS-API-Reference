...
description: "طريقة GeometryCollection. تحدد ما إذا كان الكائن المحدد مساويًا للكائن الحالي"
type: docs
weight: 140
url: /ar/net/aspose.gis.geometries/geometrycollection/equals/
---
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| آخر | IGeometryCollection | كائن للمقارنة مع هذا الكائن. |
