...
description: Aspose.Gis.Geometries.Polygon فصل. أPolygon هو سطح مستو  محدد بحد خارجي واحد و 0 أو أكثر من الحدود الداخلية.
type: docs
weight: 1200
...
أ`Polygon` هو سطح مستو ، محدد بحد خارجي واحد و 0 أو أكثر من الحدود الداخلية.
...
| اسم | وصف |
| --- | --- |
| [Polygon](polygon/#constructor)() | يقوم بتهيئة مثيل جديد لملف`Polygon` فئة . |
| [Polygon](polygon/#constructor_1)(ILinearRing) | يقوم بتهيئة مثيل جديد لملف`Polygon` فئة . |
| [Polygon](polygon/#constructor_2)(ILinearRing, IEnumerable&lt;ILinearRing&gt;) | يقوم بتهيئة مثيل جديد لملف`Polygon` فئة . |
