...
description: أPoint./point يمثل موقعًا واحدًا في مساحة إحداثيات.
type: docs
weight: 1090
...
أ[`Point`](../point) يمثل موقعًا واحدًا في مساحة إحداثيات.
...
| اسم | وصف |
| --- | --- |
| [Point](point#constructor)() | يقوم بتهيئة مثيل جديد لملف[`Point`](../point) فئة . |
| [Point](point#constructor_1)(IPoint) | يقوم بتهيئة مثيل جديد لملف[`Point`](../point) فئة . |
| [Point](point#constructor_2)(double, double) | يقوم بتهيئة مثيل جديد لملف[`Point`](../point) فئة . |
| [Point](point#constructor_3)(double, double, double) | يقوم بتهيئة مثيل جديد لملف[`Point`](../point) فئة . |
| [Point](point#constructor_4)(double, double, double, double) | يقوم بتهيئة مثيل جديد لملف[`Point`](../point) فئة . |
...
| override [HasZ](../../aspose.gis.geometries/point/hasz) { get; set; } | يحصل على قيمة تشير إلى ما إذا كان هذا المثيل يحتوي على إحداثيات Z. |
...
| [M](../../aspose.gis.geometries/point/m) { get; set; } | الحصول على أو تعيين قيمة للإحداثي m . |
| override [SpatialReferenceSystem](../../aspose.gis.geometries/point/spatialreferencesystem) { get; set; } | يحصل على نظام SpatialReference لهذا المثيل. يمكن أن تكون هذه الخاصية`null` ، هل SpatialReferenceSystem غير معروف . لن يؤدي تعيين SpatialReferenceSystem الجديد أي تحويل إحداثي ، سيتغير المرجع فقط. |
| [X](../../aspose.gis.geometries/point/x) { get; set; } | الحصول على أو تعيين قيمة للإحداثي x . |
| [Y](../../aspose.gis.geometries/point/y) { get; set; } | الحصول على أو تعيين قيمة للإحداثي y . |
| [Z](../../aspose.gis.geometries/point/z) { get; set; } | الحصول على أو تعيين قيمة للإحداثي z . |
...
| override [Clone](../../aspose.gis.geometries/point/clone)() | استنساخ هذا المثال . |
...
| [Equals](../../aspose.gis.geometries/point/equals#equals)(IPoint) | يشير إلى ما إذا كان الكائن الحالي يساوي كائنًا آخر من نفس النوع. |
...
| override [GetHashCode](../../aspose.gis.geometries/point/gethashcode)() | بمثابة وظيفة التجزئة الافتراضية. |
...
| override [SetEmpty](../../aspose.gis.geometries/point/setempty)() | يجعل هذا[`Geometry`](../geometry) فارغ . |
...
| [ToEditable](../../aspose.gis.geometries/point/toeditable#toeditable_1)() | الحصول على نسخة قابلة للتحرير من هذه الهندسة. (2 methods) |
| [ToEditable&lt;T&gt;](../../aspose.gis.geometries/geometry/toeditable)() | الحصول على نسخة قابلة للتحرير من هذه الهندسة. |
| [ToLinearGeometry](../../aspose.gis.geometries/geometry/tolineargeometry)() | الحصول على إصدار تقريبي أو مكافئ غير منحني من هذه الهندسة باستخدام الإعداد الافتراضي`تفاوت` . |
| [ToLinearGeometry](../../aspose.gis.geometries/geometry/tolineargeometry)(double) | الحصول على إصدار تقريبي أو مكافئ غير منحني من هذه الهندسة باستخدام المحدد`تفاوت` . |
...
| [operator ==](../../aspose.gis.geometries/point/op_equality) | تنفيذ عامل التشغيل == . |
| [operator !=](../../aspose.gis.geometries/point/op_inequality) | تنفذ عامل التشغيل! = . |
