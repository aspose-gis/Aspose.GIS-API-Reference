...
description: Aspose.Gis.Geometries.Point فصل. أPoint يمثل موقعًا واحدًا في مساحة إحداثيات.
type: docs
weight: 1190
...
أ`Point` يمثل موقعًا واحدًا في مساحة إحداثيات.
...
| اسم | وصف |
| --- | --- |
| [Point](point/#constructor)() | يقوم بتهيئة مثيل جديد لملف`Point` فئة . |
| [Point](point/#constructor_1)(IPoint) | يقوم بتهيئة مثيل جديد لملف`Point` فئة . |
| [Point](point/#constructor_2)(double, double) | يقوم بتهيئة مثيل جديد لملف`Point` فئة . |
| [Point](point/#constructor_3)(double, double, double) | يقوم بتهيئة مثيل جديد لملف`Point` فئة . |
| [Point](point/#constructor_4)(double, double, double, double) | يقوم بتهيئة مثيل جديد لملف`Point` فئة . |
...
| [ToLinearGeometry](../../aspose.gis.geometries/geometry/tolineargeometry/)() | الحصول على إصدار تقريبي أو مكافئ غير منحني من هذه الهندسة باستخدام الإعداد الافتراضي`تسامح` . |
| [ToLinearGeometry](../../aspose.gis.geometries/geometry/tolineargeometry/)(double) | الحصول على إصدار تقريبي أو مكافئ غير منحني من هذه الهندسة باستخدام المحدد`تسامح` . |
