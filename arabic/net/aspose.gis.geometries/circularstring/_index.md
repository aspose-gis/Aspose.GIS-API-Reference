...
| الاسم | الوصف |
| --- | --- |
| [CircularString](circularstring/#constructor)() | ينشئ مثيلًا جديدًا من فئة `CircularString`. |
| [CircularString](circularstring/#constructor_1)(ICircularString) | ينشئ مثيلًا جديدًا من فئة `CircularString`. |
| [CircularString](circularstring/#constructor_2)(IEnumerable&lt;IPoint&gt;) | ينشئ مثيلًا جديدًا من فئة `CircularString`. |
...
| override [GeometryType](../../aspose.gis.geometries/circularstring/geometrytype/) { get; } | يحصل على نوع الـ geometry. |
| override [HasCurveGeometry](../../aspose.gis.geometries/circularstring/hascurvegeometry/) { get; } | يحصل على قيمة تشير إلى ما إذا كانت هذه الـ geometry هي أو تحتوي على هندسة منحنية (غير خطية). |
| [HasM](../../aspose.gis.geometries/circularstring/hasm/) { get; set; } | يحصل على قيمة تشير إلى ما إذا كان هذا الكائن يحتوي على إحداثي M. |
| [HasZ](../../aspose.gis.geometries/circularstring/hasz/) { get; set; } | يحصل على قيمة تشير إلى ما إذا كان هذا الكائن يحتوي على إحداثي Z. |
...
| [Item](../../aspose.gis.geometries/circularstring/item/) { get; set; } | يحصل أو يعيّن الـ [`IPoint`](../ipoint/) عند الفهرس المحدد. |
| [SpatialReferenceSystem](../../aspose.gis.geometries/circularstring/spatialreferencesystem/) { get; set; } | يحصل على SpatialReferenceSystem لهذه المثيلة. يمكن أن تكون هذه الخاصية `null` إذا لم يتم تعيين SpatialReferenceSystem. تعيين SpatialReferenceSystem جديد لن يؤدي إلى أي تحويل إحداثي، بل سيتغير المرجع فقط. |
...
| [GetEnumerator](../../aspose.gis.geometries/circularstring/getenumerator/)() | يرجع عدّادًا يتنقل عبر المجموعة. |
| [GetExtent](../../aspose.gis.geometries/geometry/getextent/)() | يحسب ويعيد نطاقًا محيطًا لهذه الهندسة. |
| override [GetHashCode](../../aspose.gis.geometries/circularstring/gethashcode/)() | يعمل كدالة تجزئة افتراضية. |
...
| override [Reverse](../../aspose.gis.geometries/circularstring/reverse/)() | يعكس ترتيب النقاط في هذه `CircularString`. |
...
| [operator ==](../../aspose.gis.geometries/circularstring/op_equality/) | ينفّذ العامل ==. |
| [operator !=](../../aspose.gis.geometries/circularstring/op_inequality/) | ينفّذ العامل !=. |
