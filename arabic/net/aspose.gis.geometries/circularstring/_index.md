...
| اسم | وصف |
| --- | --- |
| [CircularString](circularstring#constructor)() | يقوم بتهيئة مثيل جديد لملف[`CircularString`](../circularstring) فئة . |
| [CircularString](circularstring#constructor_1)(ICircularString) | يقوم بتهيئة مثيل جديد لملف[`CircularString`](../circularstring) فئة . |
| [CircularString](circularstring#constructor_2)(IEnumerable&lt;IPoint&gt;) | يقوم بتهيئة مثيل جديد لملف[`CircularString`](../circularstring) فئة . |
...
| [Count](../../aspose.gis.geometries/circularstring/count) { get; } | يحصل على عدد النقاط في[`CircularString`](../circularstring) . |
...
| override [Reverse](../../aspose.gis.geometries/circularstring/reverse)() | يعكس ترتيب النقاط في هذا[`CircularString`](../circularstring) . |
