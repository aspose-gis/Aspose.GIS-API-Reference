...
description: Aspose.Gis.Geometries.MultiPoint فصل. أMultiPoint هو بعد واحدGeometryCollection التي تكون عناصرهاPoint s.
type: docs
weight: 1160
...
أ`MultiPoint` هو بعد واحد[`GeometryCollection`](../geometrycollection/) التي تكون عناصرها[`Point`](../point/) s.
...
| اسم | وصف |
| --- | --- |
| [MultiPoint](multipoint/)() | يقوم بتهيئة مثيل جديد لملف`MultiPoint` فئة . |
...
| [ToLinearGeometry](../../aspose.gis.geometries/geometrycollection/tolineargeometry/)() | الحصول على إصدار تقريبي أو مكافئ غير منحني من هذه الهندسة باستخدام الإعداد الافتراضي`تسامح` . (2 methods) |
| [ToLinearGeometry](../../aspose.gis.geometries/geometrycollection/tolineargeometry/)(double) | الحصول على إصدار تقريبي أو مكافئ غير منحني من هذه الهندسة باستخدام المحدد`تسامح` . (2 methods) |
