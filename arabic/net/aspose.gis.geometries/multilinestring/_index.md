...
الـ `MultiLineString` هو [`GeometryCollection`](../geometrycollection/) أحادي البعد تكون عناصره [`LineString`](../linestring/)s.
...
| override [GeometryType](../../aspose.gis.geometries/multilinestring/geometrytype/) { get; } | يحصل على نوع الهندسة. |
