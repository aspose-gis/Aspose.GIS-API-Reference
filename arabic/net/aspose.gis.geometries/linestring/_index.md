...
description: Aspose.Gis.Geometries.LineString فصل. خط متعدد الرؤوس .
type: docs
weight: 1120
...
| اسم | وصف |
| --- | --- |
| [LineString](linestring/#constructor)() | يقوم بتهيئة مثيل جديد لملف`LineString` فئة . |
| [LineString](linestring/#constructor_2)(IEnumerable&lt;IPoint&gt;) | يقوم بتهيئة مثيل جديد لملف`LineString` فئة . |
| [LineString](linestring/#constructor_1)(ILineString) | يقوم بتهيئة مثيل جديد لملف`LineString` فئة . |
...
| [Count](../../aspose.gis.geometries/linestring/count/) { get; } | يحصل على عدد النقاط في ملف`LineString` . |
...
| اسم | وصف |
| --- | --- |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint/#addpoint)(IPoint) | يضيف نقطة إلى نهاية السطر . |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint/#addpoint_1)(double, double) | يضيف نقطة إلى نهاية السطر . |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint/#addpoint_2)(double, double, double) | يضيف نقطة إلى نهاية السطر . |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint/#addpoint_3)(double, double, double, double) | يضيف نقطة إلى نهاية السطر . |
...
| override [Clone](../../aspose.gis.geometries/linestring/clone/)() | استنساخ هذا المثال . |
...
| [Equals](../../aspose.gis.geometries/linestring/equals/#equals)(ILineString) | يشير إلى ما إذا كان الكائن الحالي يساوي كائنًا آخر من نفس النوع. |
...
| [ToEditable](../../aspose.gis.geometries/linestring/toeditable/#toeditable_2)() | الحصول على نسخة قابلة للتحرير من هذه الهندسة. (3 methods) |
...
| [operator ==](../../aspose.gis.geometries/linestring/op_equality/) | تنفيذ عامل التشغيل == . |
| [operator !=](../../aspose.gis.geometries/linestring/op_inequality/) | تنفذ عامل التشغيل! = . |
