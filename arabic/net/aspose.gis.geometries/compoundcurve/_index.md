...
| اسم | وصف |
| --- | --- |
| [CompoundCurve](compoundcurve#constructor)() | يقوم بتهيئة مثيل جديد لملف[`CompoundCurve`](../compoundcurve) فئة . |
| [CompoundCurve](compoundcurve#constructor_1)(ICompoundCurve) | يقوم بتهيئة مثيل جديد لملف[`CompoundCurve`](../compoundcurve) فئة . |
| [CompoundCurve](compoundcurve#constructor_2)(IEnumerable&lt;ICurve&gt;) | يقوم بتهيئة مثيل جديد لملف[`CompoundCurve`](../compoundcurve) فئة . |
...
| اسم | وصف |
| --- | --- |
| [AddCurve](../../aspose.gis.geometries/compoundcurve/addcurve)(ICurve) | يضيف منحنى إلى نهاية هذا[`CompoundCurve`](../compoundcurve) . |
...
| override [Reverse](../../aspose.gis.geometries/compoundcurve/reverse)() | يعكس ذلك[`CompoundCurve`](../compoundcurve) . أي - ترتيب عكسي للمنحنيات وكل منحنى داخل هذا المنحنى المركب. |
