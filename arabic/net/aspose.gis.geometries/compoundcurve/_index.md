...
description: "الفئة Aspose.Gis.Geometries.CompoundCurve. منحنى يمثل تسلسلًا من المنحنيات المتجاورة بحيث تُربط المنحنيات المتجاورة بنقاط نهايتها"
type: docs
weight: 2670
...
| الاسم | الوصف |
| --- | --- |
| [CompoundCurve](compoundcurve/#constructor)() | يُنشئ مثيلاً جديدًا من الفئة `CompoundCurve`. |
| [CompoundCurve](compoundcurve/#constructor_1)(ICompoundCurve) | يُنشئ مثيلاً جديدًا من الفئة `CompoundCurve`. |
| [CompoundCurve](compoundcurve/#constructor_2)(IEnumerable&lt;ICurve&gt;) | يُنشئ مثيلاً جديدًا من الفئة `CompoundCurve`. |
...
| override [GeometryType](../../aspose.gis.geometries/compoundcurve/geometrytype/) { get; } | يحصل على نوع الـ geometry. |
| override [HasCurveGeometry](../../aspose.gis.geometries/compoundcurve/hascurvegeometry/) { get; } | يحصل على قيمة تشير إلى ما إذا كانت هذه الـ geometry هي أو تحتوي على هندسة منحنية (غير خطية). |
| [HasM](../../aspose.gis.geometries/compoundcurve/hasm/) { get; set; } | يحصل على قيمة تشير إلى ما إذا كان هذا الكائن يحتوي على إحداثي M. |
| [HasZ](../../aspose.gis.geometries/compoundcurve/hasz/) { get; set; } | يحصل على قيمة تشير إلى ما إذا كان هذا الكائن يحتوي على إحداثي Z. |
...
| [SpatialReferenceSystem](../../aspose.gis.geometries/compoundcurve/spatialreferencesystem/) { get; set; } | يحصل على SpatialReferenceSystem لهذه المثيلة. يمكن أن تكون هذه الخاصية `null` إذا لم يتم تعيين SpatialReferenceSystem. تعيين SpatialReferenceSystem جديد لن يؤدي إلى أي تحويل إحداثي، بل سيتغير المرجع فقط. |
...
| [GetEnumerator](../../aspose.gis.geometries/compoundcurve/getenumerator/)() | يرجع عدّادًا يتنقل عبر المجموعة. |
| [GetExtent](../../aspose.gis.geometries/geometry/getextent/)() | يحسب ويعيد نطاقًا محيطًا لهذه الهندسة. |
| override [GetHashCode](../../aspose.gis.geometries/compoundcurve/gethashcode/)() | يعمل كدالة تجزئة افتراضية. |
...
| [operator ==](../../aspose.gis.geometries/compoundcurve/op_equality/) | ينفّذ العامل ==. |
| [operator !=](../../aspose.gis.geometries/compoundcurve/op_inequality/) | ينفّذ العامل !=. |
