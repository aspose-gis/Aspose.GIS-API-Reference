...
description: "فئة Aspose.Gis.Geometries.MultiPolygon. الـ MultiPolygon هو مجموعة GeometryCollection أحادية البعد تحتوي عناصرها على Polygons"
type: docs
weight: 2950
...
الـ `MultiPolygon` هو مجموعة [`GeometryCollection`](../geometrycollection/) أحادية البعد تحتوي عناصرها على [`Polygon`](../polygon/)s.
...
| الاسم | الوصف |
| --- | --- |
| [MultiPolygon](multipolygon/)() | يُنشئ مثيلاً جديدًا من الفئة `MultiPolygon`. |
...
| override [GeometryType](../../aspose.gis.geometries/multipolygon/geometrytype/) { get; } | يحصل على نوع الـ geometry. |
