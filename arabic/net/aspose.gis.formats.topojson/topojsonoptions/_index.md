...
description: Aspose.Gis.Formats.TopoJson.TopoJsonOptions فصل. خيارات خاصة ببرنامج التشغيل لتنسيق TopoJSON .
type: docs
weight: 710
...
| [QuantizationNumber](../../aspose.gis.formats.topojson/topojsonoptions/quantizationnumber/) { get; set; } | يحدد رقم التكمية لاستخدامه في تحديد الإحداثيات وترميز دلتا في الإخراج TopoJSON. |
