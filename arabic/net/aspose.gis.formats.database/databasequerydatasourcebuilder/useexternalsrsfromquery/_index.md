...
من المهم معرفة أنه في حالة عدم وجود نظام إحداثيات مكاني في القائمة المستخرجة مسبقًا من قاعدة البيانات ولكن تم استخدامه في الاستعلام الرئيسي، ستحاول المكتبة استخدام نظام الإحداثيات المدمج. مثال الاستعلام: SELECT auth_srid, srtext FROM spatial_ref_sys WHERE srid = 4284
