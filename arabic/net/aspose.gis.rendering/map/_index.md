...
description: الخريطة عبارة عن مجموعة من الطبقات التي يمكن عرضها فوق بعضها البعض عبرRenderer./renderer .
type: docs
weight: 1620
...
| [Extent](../../aspose.gis.rendering/map/extent) { get; set; } | يحدد حدود الخريطة للعرض . إذا تم التعيين على`null` ، يتم حساب المدى أثناء العرض ليشمل كل الأشكال الهندسية في كل الطبقات. |
