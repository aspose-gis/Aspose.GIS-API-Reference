---
title: "SqlServerOptions クラス"
type: docs
weight: 20
url: /ja/python-net/aspose.gis.formats.sqlserver/sqlserveroptions/
---
...
| **Name** | **説明** |
| :- | :- |
| [SqlServerOptions()](#SqlServerOptions__1) | 新しいインスタンスを作成します。 |
## **Properties**
| **Name** | **Type** | **Access** | **説明** |
| :- | :- | :- | :- |
...
| spatial_reference_system_mode | [SpatialReferenceSystemMode](/psd/python-net/aspose.gis/spatialreferencesystemmode) | r/w | 未知のジオメトリのデータベース向け SRS がレイヤーに追加される際の処理方法を決定します。<br/>            デフォルト値は [SpatialReferenceSystemMode.THROW_EXCEPTION](/psd/python-net/aspose.gis/spatialreferencesystemmode/) です。 |
