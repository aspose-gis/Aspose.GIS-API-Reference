---
title: "EsriAsciiDriver クラス"
type: docs
weight: 10
url: /ja/python-net/aspose.gis.formats.esriascii/esriasciidriver/
---
...
| [open_layer(path, options)](#open_layer_path_options_5) | そのレイヤーを読み取り用に開きます。 |
| [open_layer(path, options)](#open_layer_path_options_6) | そのレイヤーを読み取り用に開きます。 |
...
| :- | :- | :- |
| path | string | ファイルへのパス。 |
| options | [EsriAsciiOptions](/psd/python-net/aspose.gis.formats.esriascii/esriasciioptions) | ドライバー固有のオプション。 |
