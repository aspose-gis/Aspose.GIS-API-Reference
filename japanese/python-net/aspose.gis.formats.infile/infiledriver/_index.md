---
title: "InFileDriver クラス"
type: docs
weight: 10
url: /ja/python-net/aspose.gis.formats.infile/infiledriver/
---
...
| :- | :- | :- |
| path | string | ファイルへのパス。 |
| options | [InFileOptions](/psd/python-net/aspose.gis.formats.infile/infileoptions) | ドライバー固有のオプション。 |
