---
title: "InFileOptions クラス"
type: docs
weight: 20
url: /ja/python-net/aspose.gis.formats.infile/infileoptions/
---
...
| **Name** | **説明** |
| :- | :- |
| [InFileOptions()](#InFileOptions__1) | 新しいインスタンスを作成します。 |
## **Properties**
| **Name** | **Type** | **Access** | **説明** |
| :- | :- | :- | :- |
...
| count_of_feature_in_part | int | 読み/書き | ファイルの各パートにおけるフィーチャの最大数 |
