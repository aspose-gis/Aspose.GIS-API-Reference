---
title: "MapInfoInterchangeOptions クラス"
type: docs
weight: 20
url: /ja/python-net/aspose.gis.formats.mapinfointerchange/mapinfointerchangeoptions/
---
...
| **Name** | **説明** |
| :- | :- |
| [MapInfoInterchangeOptions()](#MapInfoInterchangeOptions__1) | 新しいインスタンスを作成します。 |
## **Properties**
| **Name** | **Type** | **Access** | **説明** |
| :- | :- | :- | :- |
| 文字セット | string | 読み/書き | 文字セットを決定します。デフォルトは Neutral です。 |
...
| 区切り文字 | string | 読み/書き | mid ファイル内の属性の区切り文字を決定します。デフォルトはタブ文字です。 |
