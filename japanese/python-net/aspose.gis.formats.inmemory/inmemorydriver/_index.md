---
title: "InMemoryDriver クラス"
type: docs
weight: 10
url: /ja/python-net/aspose.gis.formats.inmemory/inmemorydriver/
---
...
| [create_layer()](#create_layer__5) | レイヤーを作成し、新しいフィーチャの追加のために開きます。 |
| [create_layer(features_sequence)](#create_layer_features_sequence_6) | フィーチャシーケンスからレイヤーを作成し、新しいフィーチャを追加できるように開きます。 |
...
| [create_layer(path, options)](#create_layer_path_options_9) | レイヤーを作成し、追加書き込みのために開きます。 |
| [create_layer(path, options)](#create_layer_path_options_10) | レイヤーを作成し、追加書き込みのために開きます。 |
...
| [create_layer(path, spatial_reference_system)](#create_layer_path_spatial_reference_system_13) | レイヤーを作成し、追加書き込みのために開きます。 |
| [create_layer(path, spatial_reference_system)](#create_layer_path_spatial_reference_system_14) | レイヤーを作成し、追加書き込みのために開きます。 |
| [create_layer(spatial_reference_system)](#create_layer_spatial_reference_system_15) | レイヤーを作成し、新しいフィーチャの追加のために開きます。 |
...
| [supports_spatial_reference_system(spatial_reference_system)](#supports_spatial_reference_system_spatial_reference_system_26) | 指定された空間参照系がドライバーでサポートされているかどうかを判定します。 |
...
フィーチャシーケンスからレイヤーを作成し、新しいフィーチャを追加できるように開きます。
