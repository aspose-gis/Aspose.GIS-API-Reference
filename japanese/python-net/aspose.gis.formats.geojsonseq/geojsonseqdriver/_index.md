---
title: "GeoJsonSeqDriver クラス"
type: docs
weight: 10
url: /ja/python-net/aspose.gis.formats.geojsonseq/geojsonseqdriver/
---
...
| :- | :- | :- |
| path | string | ファイルへのパス。 |
| options | [GeoJsonSeqOptions](/psd/python-net/aspose.gis.formats.geojsonseq/geojsonseqoptions) | ドライバー固有のオプション。 |
