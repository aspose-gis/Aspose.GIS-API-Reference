---
title: "ProjectedSpatialReferenceSystem クラス"
type: docs
weight: 150
url: /ja/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/
---
...
| as_geographic | [GeographicSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/geographicspatialreferencesystem) | r | この SRS を [GeographicSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/geographicspatialreferencesystem/) に変換して返します。<br/>            変換が可能かどうかを確認するには、[SpatialReferenceSystem.type](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem/) を使用してください。 |
...
| as_projected | [ProjectedSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem) | r | これを返します。 |
...
| axises_order | [ProjectedAxisesOrder](/psd/python-net/aspose.gis.spatialreferencing/projectedaxisesorder) | r | この SRS の軸の順序。<br/>            この SRS が無効で軸の方向が間違っている場合、[ProjectedAxisesOrder.INVALID](/psd/python-net/aspose.gis.spatialreferencing/projectedaxisesorder/) が返されます。 |
| base | [GeographicSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/geographicspatialreferencesystem) | r | この SRS を取得するために [ProjectedSpatialReferenceSystem.projection](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/) が適用された地理的 SRS。 |
| dimensions_count | int | r | この SRS の次元数を返します。投影 SRS の場合、次のいずれかです：<br/>            2 - 単一の投影 SRS の場合。<br/>            3 - 複合 SRS の場合で、単一の 2 次元投影 SRS と垂直 SRS から構成され、3 次元が追加されます。 |
...
| has_geographic_datum | bool | r | 投影 SRS は常に本初子午線を持つため、true を返します。 |
| has_prime_meridian | bool | r | 投影 SRS は常に本初子午線を持つため、true を返します。 |
...
| linear_unit | [Unit](/psd/python-net/aspose.gis.spatialreferencing/unit) | r | この SRS の線形次元および [ProjectedSpatialReferenceSystem.projection](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/) の線形パラメータに使用される単位。 |
...
| projection | [Projection](/psd/python-net/aspose.gis.spatialreferencing/projection) | r | この SRS を取得するために [ProjectedSpatialReferenceSystem.base](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/) に適用された投影。 |
| type | [SpatialReferenceSystemType](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype) | r | 返します [SpatialReferenceSystemType.PROJECTED](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/)。 |
