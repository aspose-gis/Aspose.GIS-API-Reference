---
title: "LocalSpatialReferenceSystem クラス"
type: docs
weight: 130
url: /ja/python-net/aspose.gis.spatialreferencing/localspatialreferencesystem/
---
...
| as_local | [LocalSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/localspatialreferencesystem) | r | これを返します。 |
...
| dimensions_count | int | r | この SRS の次元数。 |
...
| geographic_datum | [GeographicDatum](/psd/python-net/aspose.gis.spatialreferencing/geographicdatum) | r | Local SRS には測地系がないため、InvalidOperationException をスローします。 |
| has_geographic_datum | bool | r | Local SRS には測地系がないため、<see langword="false" /> を返します。 |
| has_prime_meridian | bool | r | Local SRS には本初子午線がないため、<see langword="false" /> を返します。 |
...
| local_datum | [LocalDatum](/psd/python-net/aspose.gis.spatialreferencing/localdatum) | r | 測定方法を記述する測地系。 |
...
| prime_meridian | [PrimeMeridian](/psd/python-net/aspose.gis.spatialreferencing/primemeridian) | r | Local SRS には本初子午線がないため、InvalidOperationException をスローします。 |
| type | [SpatialReferenceSystemType](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype) | r | [SpatialReferenceSystemType.LOCAL](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/) を返します。 |
| unit | [Unit](/psd/python-net/aspose.gis.spatialreferencing/unit) | r | この SRS の単位です。 |
...
| [get_unit(dimension)](#get_unit_dimension_12) | 次元の [LocalSpatialReferenceSystem.unit](/psd/python-net/aspose.gis.spatialreferencing/localspatialreferencesystem/) を取得します。 |
...
次元の [LocalSpatialReferenceSystem.unit](/psd/python-net/aspose.gis.spatialreferencing/localspatialreferencesystem/) を取得します。
