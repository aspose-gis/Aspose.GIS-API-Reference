---
title: "CircularArc クラス"
type: docs
weight: 140
url: /ja/python-net/aspose.gis.common/circulararc/
---
...
| **Name** | **説明** |
| :- | :- |
| [CircularArc()](#CircularArc__1) | CircularArc クラスの新しいインスタンスを初期化します |
| [CircularArc(start, mid, end)](#CircularArc_start_mid_end_2) | CircularArc クラスの新しいインスタンスを初期化します |
| [CircularArc(x0, y0, x1, y1, x2, y2)](#CircularArc_x0_y0_x1_y1_x2_y2_3) | CircularArc クラスの新しいインスタンスを初期化します |
## **Properties**
| **Name** | **Type** | **Access** | **説明** |
| :- | :- | :- | :- |
...
CircularArc クラスの新しいインスタンスを初期化します
