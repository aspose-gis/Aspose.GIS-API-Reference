---
title: "ShapefileDriver クラス"
type: docs
weight: 10
url: /ja/python-net/aspose.gis.formats.shapefile/shapefiledriver/
---
...
| :- | :- | :- |
| path | string | ファイルへのパス。 |
| options | [ShapefileOptions](/psd/python-net/aspose.gis.formats.shapefile/shapefileoptions) | ドライバー固有のオプション。 |
