---
title: "ShapefileOptions クラス"
type: docs
weight: 20
url: /ja/python-net/aspose.gis.formats.shapefile/shapefileoptions/
---
...
| **Name** | **説明** |
| :- | :- |
| [ShapefileOptions()](#ShapefileOptions__1) | 新しいインスタンスを作成します。 |
## **Properties**
| **Name** | **Type** | **Access** | **説明** |
| :- | :- | :- | :- |
...
| is_ignore_wrong_data | bool | 読み/書き | 誤ったデータを解析する際に例外をスローするか、既定値を設定するかを決定します |
