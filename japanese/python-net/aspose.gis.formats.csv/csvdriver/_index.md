...
type: docs
weight: 10
url: /ja/python-net/aspose.gis.formats.csv/csvdriver/
---
...
| **Name** | **説明** |
| :- | :- |
| [CsvDriver()](#CsvDriver__1) | CsvDriver クラスの新しいインスタンスを初期化します |
## **Properties**
| **Name** | **Type** | **Access** | **説明** |
| :- | :- | :- | :- |
...
CsvDriver クラスの新しいインスタンスを初期化します
...
| :- | :- | :- |
| path | string | ファイルへのパス。 |
| options | [CsvOptions](/psd/python-net/aspose.gis.formats.csv/csvoptions) | ドライバー固有のオプション。 |
