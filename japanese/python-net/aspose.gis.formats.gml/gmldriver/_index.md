...
type: docs
weight: 10
url: /ja/python-net/aspose.gis.formats.gml/gmldriver/
---
...
| [create_layer(path, options, spatial_reference_system)](#create_layer_path_options_spatial_reference_system_14) | レイヤーを作成し、新しいフィーチャの追加のために開きます。 |
...
| :- | :- | :- |
| path | string | ファイルへのパス。 |
| options | [GmlOptions](/psd/python-net/aspose.gis.formats.gml/gmloptions) | ドライバー固有のオプション。 |
