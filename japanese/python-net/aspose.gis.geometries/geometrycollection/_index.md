---
title: "GeometryCollection クラス"
type: docs
weight: 60
url: /ja/python-net/aspose.gis.geometries/geometrycollection/
---
...
| **Name** | **説明** |
| :- | :- |
| [GeometryCollection()](#GeometryCollection__1) | 新しい [GeometryCollection](/psd/python-net/aspose.gis.geometries/geometrycollection/) クラスのインスタンスを初期化します。 |
## **Properties**
| **Name** | **Type** | **Access** | **説明** |
| :- | :- | :- | :- |
...
| dimension | [GeometryDimension](/psd/python-net/aspose.gis.geometries/geometrydimension) | r | この [Geometry](/psd/python-net/aspose.gis.geometries/geometry/) の位相次元を取得します。<br/> コレクションが空の場合、[GeometryDimension.POINT](/psd/python-net/aspose.gis.geometries/geometrydimension/) が返されます。 |
...
新しい [GeometryCollection](/psd/python-net/aspose.gis.geometries/geometrycollection/) クラスのインスタンスを初期化します。
...
| パラメーター | 型 | 説明 |
| :- | :- | :- |
| 許容誤差 | double | 使用する <c>tolerance</c>。結果は曲線ジオメトリから <c>tolerance</c> 未満の距離になることが保証されています。 |
