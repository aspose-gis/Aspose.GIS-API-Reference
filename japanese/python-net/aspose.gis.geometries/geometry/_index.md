...
type: docs
weight: 50
url: /ja/python-net/aspose.gis.geometries/geometry/
---
...
| dimension | [GeometryDimension](/psd/python-net/aspose.gis.geometries/geometrydimension) | r | この [Geometry](/psd/python-net/aspose.gis.geometries/geometry/) の位相次元を取得します。<br/>            次元が不明な場合（例: 空の GEOMETRYCOLLECTION）[GeometryDimension.POINT](/psd/python-net/aspose.gis.geometries/geometrydimension/) が返されます。 |
...
| 型 | 説明 |
| :- | :- |
| [Geometry](/psd/python-net/aspose.gis.geometries/geometry) | このジオメトリの編集可能なコピー。 |
