---
title: "CircularString クラス"
type: docs
weight: 10
url: /ja/python-net/aspose.gis.geometries/circularstring/
---
...
| **Name** | **説明** |
| :- | :- |
| [CircularString()](#CircularString__1) | 新しい [CircularString](/psd/python-net/aspose.gis.geometries/circularstring/) クラスのインスタンスを初期化します。 |
| [CircularString(collection)](#CircularString_collection_2) | 新しい [CircularString](/psd/python-net/aspose.gis.geometries/circularstring/) クラスのインスタンスを初期化します。 |
| [CircularString(other)](#CircularString_other_3) | 新しい [CircularString](/psd/python-net/aspose.gis.geometries/circularstring/) クラスのインスタンスを初期化します。 |
## **Properties**
| **Name** | **Type** | **Access** | **説明** |
| :- | :- | :- | :- |
...
| **Name** | **説明** |
| :- | :- |
| [add_point(point)](#add_point_point_1) | 円弧文字列の末尾に点を追加します。 |
| [add_point(x, y)](#add_point_x_y_2) | 円弧文字列の末尾に点を追加します。 |
| [add_point(x, y, z)](#add_point_x_y_z_3) | 円弧文字列の末尾に点を追加します。 |
| [add_point(x, y, z, m)](#add_point_x_y_z_m_4) | 円弧文字列の末尾に点を追加します。 |
...
| [overlaps(other)](#overlaps_other_33) | このジオメトリが指定されたジオメトリと重なるかどうかを判定します。 |
| [relate(other, intersection_pattern_matrix)](#relate_other_intersection_pattern_matrix_34) | このジオメトリと指定されたジオメトリの DE-9IM 交差行列が提供されたパターンと一致するかどうかを判定します。 |
| [replace_polygons_by_lines()](#replace_polygons_by_lines__35) | このジオメトリのラインとして表現されたポリゴンを取得します。 |
| reverse() | この [CircularString](/psd/python-net/aspose.gis.geometries/circularstring/) の点の順序を逆にします。 |
...
新しい [CircularString](/psd/python-net/aspose.gis.geometries/circularstring/) クラスのインスタンスを初期化します。
...
| パラメーター | 型 | 説明 |
| :- | :- | :- |
| other | [ICircularString](/psd/python-net/aspose.gis.geometries/icircularstring) | データをコピーする元となる他の文字列。 |
