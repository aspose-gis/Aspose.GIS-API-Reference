---
title: "CurvePolygon クラス"
type: docs
weight: 40
url: /ja/python-net/aspose.gis.geometries/curvepolygon/
---
...
| **Name** | **説明** |
| :- | :- |
| [CurvePolygon()](#CurvePolygon__1) | 新しい [CurvePolygon](/psd/python-net/aspose.gis.geometries/curvepolygon/) クラスのインスタンスを初期化します。 |
| [CurvePolygon(exterior_ring)](#CurvePolygon_exterior_ring_2) | 新しい [CurvePolygon](/psd/python-net/aspose.gis.geometries/curvepolygon/) クラスのインスタンスを初期化します。 |
| [CurvePolygon(exterior_ring, interior_rings)](#CurvePolygon_exterior_ring_interior_rings_3) | 新しい [CurvePolygon](/psd/python-net/aspose.gis.geometries/curvepolygon/) クラスのインスタンスを初期化します。 |
## **Properties**
| **Name** | **Type** | **Access** | **説明** |
| :- | :- | :- | :- |
...
| exterior_ring | [ICurve](/psd/python-net/aspose.gis.geometries/icurve) | r/w | 外部リングを取得します。 |
...
| **Name** | **説明** |
| :- | :- |
| [add_interior_ring(ring)](#add_interior_ring_ring_1) | 内部リングを追加します。 |
...
| [get_interior_ring(index)](#get_interior_ring_index_26) | インデックスで内部リングを取得します。 |
| [get_length()](#get_length__27) | このジオメトリの長さを計算します。 |
| [get_point_on_surface()](#get_point_on_surface__28) | この曲線ポリゴン上に必ず存在する点を検索します。 |
...
| [replace_polygons_by_lines()](#replace_polygons_by_lines__34) | このジオメトリのラインとして表現されたポリゴンを取得します。 |
| [round_m(digits)](#round_m_digits_35) | M 座標を指定された小数桁数に丸めます。 |
| [round_xy(digits)](#round_xy_digits_36) | X および Y 座標を指定された小数桁数に丸めます。 |
| [round_z(digits)](#round_z_digits_37) | Z 座標を指定された小数桁数に丸めます。 |
| set_empty() | この [Geometry](/psd/python-net/aspose.gis.geometries/geometry/) を空にします。 |
| [spatially_contains(other)](#spatially_contains_other_38) | このジオメトリが空間的に指定されたジオメトリを含むかどうかを判定します。 |
| [spatially_equals(other)](#spatially_equals_other_39) | このジオメトリが空間的に指定されたジオメトリと等しいかどうかを判定します。 |
| [sym_difference(other)](#sym_difference_other_40) | このジオメトリと指定されたジオメトリの対称差を構築します。 |
| [to_editable()](#to_editable__41) | このジオメトリの編集可能なコピーを取得します。 |
| [to_linear_geometry()](#to_linear_geometry__42) | デフォルトの<c>tolerance</c>を使用して、このジオメトリの近似または同等の非曲線バージョンを取得します。 |
| [to_linear_geometry(tolerance)](#to_linear_geometry_tolerance_43) | 指定された<c>tolerance</c>を使用して、このジオメトリの近似または同等の非曲線バージョンを取得します。 |
| [to_svg(extent)](#to_svg_extent_44) | このジオメトリをSvg表現に変換します。 |
| [touches(other)](#touches_other_45) | このジオメトリと指定されたジオメトリが接触しているかどうかを判定します。 |
| [union(other)](#union_other_46) | このジオメトリと指定されたジオメトリを結合します。 |
| [union(other)](#union_other_47) | このジオメトリと指定されたジオメトリを結合します。 |
| [within(extent)](#within_extent_48) | このジオメトリが指定された範囲内にあるかどうかを判定します。 |
| [within(other)](#within_other_49) | このジオメトリが指定されたジオメトリ内にあるかどうかを判定します。 |
...
新しい [CurvePolygon](/psd/python-net/aspose.gis.geometries/curvepolygon/) クラスのインスタンスを初期化します。
...
| パラメーター | 型 | 説明 |
| :- | :- | :- |
| exterior_ring | [ICurve](/psd/python-net/aspose.gis.geometries/icurve) | 外部リング。 |
...
| :- | :- | :- |
| exterior_ring | [ICurve](/psd/python-net/aspose.gis.geometries/icurve) | 外部リング。 |
| interior_rings | System.Collections.Generic.IEnumerable<ICurve> | 内部リング。 |
...
| パラメーター | 型 | 説明 |
| :- | :- | :- |
| ring | [ICurve](/psd/python-net/aspose.gis.geometries/icurve) | 追加するリング。 |
...
| 型 | 説明 |
| :- | :- |
| [ICurve](/psd/python-net/aspose.gis.geometries/icurve) | 内部リング。 |
...
この曲線ポリゴン上に必ず存在する点を検索します。

**Returns**

| 型 | 説明 |
| :- | :- |
| [IPoint](/psd/python-net/aspose.gis.geometries/ipoint) | この曲線ポリゴン上の点。内部がない場合は空の点です。 |
...
| 型 | 説明 |
| :- | :- |
| [CurvePolygon](/psd/python-net/aspose.gis.geometries/curvepolygon) | このジオメトリの編集可能なコピー。 |
...
| 型 | 説明 |
| :- | :- |
| [IPolygon](/psd/python-net/aspose.gis.geometries/ipolygon) | A [IPolygon](/psd/python-net/aspose.gis.geometries/ipolygon/) がこの<c>ISurface</c>を近似または同等とするものです。<br/>            これは <DOM Element: class at 0x2a1793609d0>.ISurface.to_linear_geometry()(float) の同等で、デフォルトの <c>tolerance</c> を使用します。デフォルトの <c>tolerance</c> の値はこのジオメトリの [SpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem/) に依存します:<br/>            <ul><br/>            <li> 投影座標系の場合、許容誤差は 0.001 メートル（SRS の単位）です </li><br/>            <li> 地理座標系の場合、許容誤差は <c>1e-5</c> 度（SRS の単位）です </li><br/>            <li> 不明な座標系の場合、許容誤差は <c>1e-5</c> です </li><br/>            </ul><br/>            適用される変換の詳細については、<DOM Element: class at 0x2a1793609d0>.ISurface.to_linear_geometry()(float) 仕様を参照してください。 |
...
| 型 | 説明 |
| :- | :- |
| [IPolygon](/psd/python-net/aspose.gis.geometries/ipolygon) | A [IPolygon](/psd/python-net/aspose.gis.geometries/ipolygon/) がこの<c>ISurface</c>を近似または同等とするもの:<br/>             <ul><br/>             このオブジェクトが [IPolygon](/psd/python-net/aspose.gis.geometries/ipolygon/) 自身である場合、結果はこのオブジェクトと同等です<br/>             このオブジェクトが [IPolygon](/psd/python-net/aspose.gis.geometries/ipolygon/) でない場合、線形化されて [IPolygon](/psd/python-net/aspose.gis.geometries/ipolygon/) が作成されます<br/>            </ul> |
