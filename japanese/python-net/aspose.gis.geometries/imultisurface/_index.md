---
title: "IMultiSurface クラス"
type: docs
weight: 190
url: /ja/python-net/aspose.gis.geometries/imultisurface/
---
...
| 型 | 説明 |
| :- | :- |
| [MultiSurface](/psd/python-net/aspose.gis.geometries/multisurface) | このジオメトリの編集可能なコピー。 |
...
| 型 | 説明 |
| :- | :- |
| [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon) | この [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon/) は、この [IMultiSurface](/psd/python-net/aspose.gis.geometries/imultisurface/) に近似または同等です。<br/>            これは <DOM Element: class at 0x2a1792e8790>.IMultiSurface.to_linear_geometry()(float) の同等で、デフォルトの <c>tolerance</c> を使用します。デフォルトの <c>tolerance</c> の値は、[SpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem/) に依存します。<br/>            このジオメトリの:<br/>            <ul><br/>            <li> 投影 SRS の場合、許容誤差は 0.001 メートル（SRS の単位）です </li><br/>            <li> 地理 SRS の場合、許容誤差は <c>1e-5</c> 度（SRS の単位）です </li><br/>            <li> 不明な SRS の場合、許容誤差は <c>1e-5</c> です </li><br/>            </ul><br/>            適用される変換の詳細については、<DOM Element: class at 0x2a1792e8790>.IMultiSurface.to_linear_geometry()(float) の仕様を参照してください。 |
...
| 型 | 説明 |
| :- | :- |
| [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon) | この [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon/) は、この [IMultiSurface](/psd/python-net/aspose.gis.geometries/imultisurface/) に近似または同等です:<br/>             <ul><br/>             このオブジェクトが [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon/) 自身である場合、結果はこのオブジェクトと同等です<br/>             このオブジェクトが [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon/) でない場合、すべてのサーフェスが直線化され、新しい <c>IMultiPolygon</c> が作成されます<br/>            </ul> |
