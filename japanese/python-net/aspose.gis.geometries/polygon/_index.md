...
type: docs
weight: 310
url: /ja/python-net/aspose.gis.geometries/polygon/
---
...
| **Name** | **説明** |
| :- | :- |
| [Polygon()](#Polygon__1) | 新しい [Polygon](/psd/python-net/aspose.gis.geometries/polygon/) クラスのインスタンスを初期化します。 |
| [Polygon(exterior_ring)](#Polygon_exterior_ring_2) | 新しい [Polygon](/psd/python-net/aspose.gis.geometries/polygon/) クラスのインスタンスを初期化します。 |
| [Polygon(exterior_ring, interior_rings)](#Polygon_exterior_ring_interior_rings_3) | 新しい [Polygon](/psd/python-net/aspose.gis.geometries/polygon/) クラスのインスタンスを初期化します。 |
## **Properties**
| **Name** | **Type** | **Access** | **説明** |
| :- | :- | :- | :- |
...
| exterior_ring | [ILinearRing](/psd/python-net/aspose.gis.geometries/ilinearring) | r/w | 外部リングを取得します。 |
...
| [get_point_on_surface()](#get_point_on_surface__28) | このポリゴン上に必ず存在する点を検索します。 |
...
新しい [Polygon](/psd/python-net/aspose.gis.geometries/polygon/) クラスのインスタンスを初期化します。
...
| パラメーター | 型 | 説明 |
| :- | :- | :- |
| exterior_ring | [ILinearRing](/psd/python-net/aspose.gis.geometries/ilinearring) | 外部リング。 |
...
| :- | :- | :- |
| exterior_ring | [ILinearRing](/psd/python-net/aspose.gis.geometries/ilinearring) | 外部リング。 |
| interior_rings | System.Collections.Generic.IEnumerable<ILinearRing> | 内部リング。 |
...
| パラメーター | 型 | 説明 |
| :- | :- | :- |
| ring | [ILinearRing](/psd/python-net/aspose.gis.geometries/ilinearring) | 追加するリング。 |
...
| 型 | 説明 |
| :- | :- |
| [ILinearRing](/psd/python-net/aspose.gis.geometries/ilinearring) | 内部リング。 |
...
このポリゴン上に必ず存在する点を検索します。

**Returns**

| 型 | 説明 |
| :- | :- |
| [IPoint](/psd/python-net/aspose.gis.geometries/ipoint) | このポリゴン上の点。ポリゴンに内部がない場合は空の点です。 |
...
| 型 | 説明 |
| :- | :- |
| [Polygon](/psd/python-net/aspose.gis.geometries/polygon) | このジオメトリの編集可能なコピー。 |
