...
type: docs
weight: 10
url: /ja/python-net/aspose.gis.formats.kml.specificfields/iconinfo/
---
...
| **Name** | **説明** |
| :- | :- |
| [IconInfo(link)](#IconInfo_link_1) | 新しいインスタンスを初期化します [IconInfo](/psd/python-net/aspose.gis.formats.kml.specificfields/iconinfo/) クラス。 |
## **Properties**
| **Name** | **Type** | **Access** | **説明** |
| :- | :- | :- | :- |
| children | [NodeLink[]](/psd/python-net/aspose.gis/nodelink) | r | 子要素を取得します。 |
| href | string | 読み/書き | href を取得または設定します。 |
...
新しいインスタンスを初期化します [IconInfo](/psd/python-net/aspose.gis.formats.kml.specificfields/iconinfo/) クラス。

**Parameters:**

| パラメーター | 型 | 説明 |
| :- | :- | :- |
| link | [NodeLink](/psd/python-net/aspose.gis/nodelink) | 作成されるノード |
