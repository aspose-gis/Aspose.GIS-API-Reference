---
title: "KmlGroundOverlayInfo クラス"
type: docs
weight: 20
url: /ja/python-net/aspose.gis.formats.kml.specificfields/kmlgroundoverlayinfo/
---
...
| draw_order | double | 読み/書き | DrawOrder の 'GroundOverlay' ノード。 |
| icon | [IconInfo](/psd/python-net/aspose.gis.formats.kml.specificfields/iconinfo) | r/w | IconPath の 'GroundOverlay' ノード。 |
| lat_lon_box | [KmlLatLonBox](/psd/python-net/aspose.gis.formats.kml.specificfields/kmllatlonbox) | r/w | Kml の 'LatLonAltBox' ノードからオブジェクトを指定します。 |
| 名前 | string | 読み/書き | Ground Overlay の名前 |
...
| visibility | bool | 読み/書き | Ground Overlay の可視性 |
## **Methods**
| **Name** | **説明** |
| :- | :- |
