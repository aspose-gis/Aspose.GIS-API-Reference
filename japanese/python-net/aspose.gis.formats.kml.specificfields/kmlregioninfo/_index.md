---
title: "KmlRegionInfo クラス"
type: docs
weight: 70
url: /ja/python-net/aspose.gis.formats.kml.specificfields/kmlregioninfo/
---
...
| id | string | 読み/書き | Id の 'Region' ノード。 |
| lat_lon_alt_box | [KmlLatLonAltBox](/psd/python-net/aspose.gis.formats.kml.specificfields/kmllatlonaltbox) | r/w | Kml の 'LatLonAltBox' ノードからオブジェクトを指定します。 |
| lod | [KmlLodSettings](/psd/python-net/aspose.gis.formats.kml.specificfields/kmllodsettings) | r/w | Kml の 'Lod' ノードからオブジェクトを指定します。 |
