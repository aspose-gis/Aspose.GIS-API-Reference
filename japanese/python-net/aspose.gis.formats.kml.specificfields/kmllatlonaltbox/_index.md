---
title: "KmlLatLonAltBox クラス"
type: docs
weight: 30
url: /ja/python-net/aspose.gis.formats.kml.specificfields/kmllatlonaltbox/
---
...
| 東 | double | 読み/書き | 'LatLonBox' ノードの東。 |
| max_altitude | Nullable<double> | 読み/書き | 'LatLonBox' ノードの MaxAltitude。 |
| min_altitude | Nullable<double> | 読み/書き | 'LatLonBox' ノードの MinAltitude。 |
| name_without_prefix | string | r | プレフィックスなしの名前を取得します。 |
| node_name | string | 読み/書き | 名前を取得または設定します。 |
| node_value | string | 読み/書き | 値を取得または設定します。 |
| 北 | double | 読み/書き | 'LatLonBox' ノードの北。 |
| プレフィックス | string | r | プレフィックスを取得します。 |
| 回転 | Nullable<double> | 読み/書き | 'LatLonBox' ノードの回転。 |
| 南 | double | 読み/書き | 'LatLonBox' ノードの南。 |
| 西 | double | 読み/書き | 'LatLonBox' ノードの西。 |
## **Methods**
| **Name** | **説明** |
| :- | :- |
