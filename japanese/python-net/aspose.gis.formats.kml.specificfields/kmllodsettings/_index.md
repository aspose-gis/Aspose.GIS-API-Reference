---
title: "KmlLodSettings クラス"
type: docs
weight: 50
url: /ja/python-net/aspose.gis.formats.kml.specificfields/kmllodsettings/
---
...
| max_fade_extent | int | 読み/書き | 'Lod' ノードの MaxFadeExtent。 |
| max_lod_pixels | int | 読み/書き | 'Lod' ノードの MaxLodPixels。 |
| min_fade_extent | int | 読み/書き | 'Lod' ノードの MinFadeExtent。 |
| min_lod_pixels | int | 読み/書き | MinLodPixels の 'Lod' ノード。 |
