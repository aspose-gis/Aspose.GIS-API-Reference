---
title: "KmlOptions クラス"
type: docs
weight: 190
url: /ja/python-net/aspose.gis.formats.kml/kmloptions/
---
...
| **Name** | **説明** |
| :- | :- |
| [KmlOptions()](#KmlOptions__1) | 新しいインスタンスを作成します。 |
## **Properties**
| **Name** | **Type** | **Access** | **説明** |
| :- | :- | :- | :- |
| altitude_mode | [AltitudeModes](/psd/python-net/aspose.gis.formats.kml/altitudemodes) | r/w | KML ジオメトリで使用する AltitudeModes を指定できます |
...
| document_id | string | 読み/書き | ルートの 'Document' ノードの ID を指定するために使用します |
...
| symbol_to_replace_invalid_chars | char | 読み/書き | 読み取り時に無効な文字を置換するために使用されるシンボルを決定します。<br/>            値が '\\0' の場合は置換をスキップします。デフォルト値は '\\0' 文字です。 |
