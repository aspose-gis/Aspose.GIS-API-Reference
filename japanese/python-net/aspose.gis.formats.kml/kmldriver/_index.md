...
type: docs
weight: 50
url: /ja/python-net/aspose.gis.formats.kml/kmldriver/
---
...
| [open_as_kml_layer(path, options)](#open_as_kml_layer_path_options_18) | Kml レイヤーを読み取り用に開きます。 |
...
| [open_layer(path)](#open_layer_path_24) | そのレイヤーを読み取り用に開きます。 |
...
| [supports_spatial_reference_system(spatial_reference_system)](#supports_spatial_reference_system_spatial_reference_system_29) | 指定された空間参照系がドライバーでサポートされているかどうかを判定します。 |
...
| :- | :- | :- |
| path | string | ファイルへのパス。 |
| options | [KmlOptions](/psd/python-net/aspose.gis.formats.kml/kmloptions) | ドライバー固有のオプション。 |
...
| 型 | 説明 |
| :- | :- |
| [KmlLayer](/psd/python-net/aspose.gis.formats.kml/kmllayer) | 特定のフィールドを持つ KmlLayer |
