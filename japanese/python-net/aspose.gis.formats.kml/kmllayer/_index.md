...
type: docs
weight: 140
url: /ja/python-net/aspose.gis.formats.kml/kmllayer/
---
...
| driver | [Driver](/psd/python-net/aspose.gis/driver) | r | このレイヤーをインスタンス化した [KmlLayer.driver](/psd/python-net/aspose.gis.formats.kml/kmllayer/) を取得します。 |
| features | [Feature[]](/psd/python-net/aspose.gis/feature) | r | フィーチャのリストを取得します。 |
| geometry_type | [GeometryType](/psd/python-net/aspose.gis.geometries/geometrytype/) | r | レイヤーのジオメトリのタイプを取得します。 |
| ground_overlay_list | System.Collections.Generic.List<Aspose.Gis.Formats.Kml.SpecificFields.KmlGroundOverlayInfo> | r | GroundOverlay ノードから取得した KmlGroundOverlayInfo のリスト |
| network_link_list | System.Collections.Generic.List<Aspose.Gis.Formats.Kml.SpecificFields.KmlNetworkLinkInfo> | r | NetworkLink ノードから取得した KmlNetworkLinkInfo のリスト |
| region_list | System.Collections.Generic.List<Aspose.Gis.Formats.Kml.SpecificFields.KmlRegionInfo> | r | Region ノードから取得した KmlRegionInfo のリスト |
| spatial_reference_system | [SpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem/) | r | このレイヤーの空間参照系を取得します。KML の場合、常に WGS84 です。 |
## **Methods**
| **Name** | **説明** |
| :- | :- |
