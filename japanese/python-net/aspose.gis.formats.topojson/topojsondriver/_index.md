---
title: "TopoJsonDriver クラス"
type: docs
weight: 10
url: /ja/python-net/aspose.gis.formats.topojson/topojsondriver/
---
...
| :- | :- | :- |
| path | string | ファイルへのパス。 |
| options | [TopoJsonOptions](/psd/python-net/aspose.gis.formats.topojson/topojsonoptions) | ドライバー固有のオプション。 |
