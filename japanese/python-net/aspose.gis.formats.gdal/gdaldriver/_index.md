---
title: "GdalDriver クラス"
type: docs
weight: 10
url: /ja/python-net/aspose.gis.formats.gdal/gdaldriver/
---
...
| [create_layer(path, options, spatial_reference_system)](#create_layer_path_options_spatial_reference_system_9) | レイヤーを作成し、新しいフィーチャの追加のために開きます。 |
...
| [open_layer(path, options)](#open_layer_path_options_21) | レイヤーを読み取り用に開きます。 |
| [open_layer(path, options)](#open_layer_path_options_22) | レイヤーを読み取り用に開きます。 |
| [open_layer(path, options)](#open_layer_path_options_23) | レイヤーを読み取り用に開きます。 |
...
| :- | :- | :- |
| path | string | ファイルへのパス。 |
| options | [GdalOptions](/psd/python-net/aspose.gis.formats.gdal/gdaloptions) | ドライバー固有のオプション。 |
