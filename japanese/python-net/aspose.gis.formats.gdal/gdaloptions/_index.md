---
title: "GdalOptions クラス"
type: docs
weight: 20
url: /ja/python-net/aspose.gis.formats.gdal/gdaloptions/
---
...
| **Name** | **説明** |
| :- | :- |
| [GdalOptions(temp_directory)](#GdalOptions_temp_directory_1) | 新しいインスタンスを作成します。 |
## **Properties**
| **Name** | **Type** | **Access** | **説明** |
| :- | :- | :- | :- |
...
| file_name | string | 読み/書き | 起動するアプリケーションの名前 |
...
| path_to_temp_file | string | r | 一時ファイルへのパスです。 |
...
| パラメーター | 型 | 説明 |
| :- | :- | :- |
| temp_directory | string | 一時ファイルへのパスです。デフォルトではユーザーの一時フォルダーです。 |
