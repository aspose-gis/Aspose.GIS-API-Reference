---
title: "MapInfoTabDriver クラス"
type: docs
weight: 10
url: /ja/python-net/aspose.gis.formats.mapinfotab/mapinfotabdriver/
---
...
| :- | :- | :- |
| path | string | ファイルへのパス。 |
| options | [MapInfoTabOptions](/psd/python-net/aspose.gis.formats.mapinfotab/mapinfotaboptions) | ドライバー固有のオプション。 |
