...
type: docs
weight: 830
url: /ja/python-net/aspose.gis/feature/
---
...
| [get_value(attribute_name)](#get_value_attribute_name_2) | 属性の値を取得します。 |
| [get_value_or_default(attribute_name, default_value)](#get_value_or_default_attribute_name_default_value_3) | 属性の値を取得します。値が設定されていないか <c>null</c> の場合は、[FeatureAttribute.default_value](/psd/python-net/aspose.gis/featureattribute/) を返します。 |
| [get_values(values, default_value)](#get_values_values_default_value_4) | すべての属性の値を配列で返します。 |
| [get_values(values_count, default_value)](#get_values_values_count_default_value_5) | すべての属性の値を配列で返します。 |
| [get_values_dump(default_value)](#get_values_dump_default_value_6) | すべての属性の値を配列で返します。<br/>            追加のメモリ割り当てを回避するために Aspose.Gis.Feature.GetValues(int,System.Object) メソッドの使用を検討してください。 |
| [get_values_list(attribute_name, separator, count)](#get_values_list_attribute_name_separator_count_7) | 値のリストを取得します。非ジェネリックのアナログは List T GetValuesList です。 |
| [is_value_null(attribute_name)](#is_value_null_attribute_name_8) | 指定された属性が明示的に <c>null</c> 値に設定されているかどうかを判断します。 |
| [is_value_set(attribute_name)](#is_value_set_attribute_name_9) | この機能で属性値が設定されているかどうかをチェックします。 |
| [set_value(attribute_name, value)](#set_value_attribute_name_value_10) | 値を設定します。非ジェネリックのアナログは void SetValue (string attributeName, T value) です。 |
| [set_value_null(attribute_name)](#set_value_null_attribute_name_11) | 属性の値を <c>null</c> に設定します。 |
| [set_values(values)](#set_values_values_12) | すべての属性に新しい値を設定します。<br/>            また、1回の呼び出しで値の設定を簡素化するために [Feature.copy_values(input_feature)](/psd/python-net/aspose.gis/feature/) メソッドの使用も検討してください。 |
| [unset_value(attribute_name)](#unset_value_attribute_name_13) | この機能から属性値を削除します。 |
...
すべての属性の値を配列で返します。<br/>            追加のメモリ割り当てを回避するために Aspose.Gis.Feature.GetValues(int,System.Object) メソッドの使用を検討してください。
...
値のリストを取得します。非ジェネリックのアナログは List T GetValuesList です。
...
値を設定します。非ジェネリックのアナログは void SetValue (string attributeName, T value) です。
...
すべての属性に新しい値を設定します。<br/>            また、1回の呼び出しで値の設定を簡素化するために [Feature.copy_values(input_feature)](/psd/python-net/aspose.gis/feature/) メソッドの使用も検討してください。
