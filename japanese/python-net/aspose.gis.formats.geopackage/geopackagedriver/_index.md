---
title: "GeoPackageDriver クラス"
type: docs
weight: 20
url: /ja/python-net/aspose.gis.formats.geopackage/geopackagedriver/
---
...
| **Name** | **説明** |
| :- | :- |
| [GeoPackageDriver()](#GeoPackageDriver__1) | GeoPackageDriver クラスの新しいインスタンスを初期化します。 |
## **Properties**
| **Name** | **Type** | **Access** | **説明** |
| :- | :- | :- | :- |
...
| [open_dataset(path, options)](#open_dataset_path_options_19) | データセットを開きます。 |
| [open_layer(path)](#open_layer_path_20) | そのレイヤーを読み取り用に開きます。 |
| [open_layer(path)](#open_layer_path_21) | そのレイヤーを読み取り用に開きます。 |
| [open_layer(path, options)](#open_layer_path_options_22) | そのレイヤーを読み取り用に開きます。 |
| [open_layer(path, options)](#open_layer_path_options_23) | そのレイヤーを読み取り用に開きます。 |
| [supports_spatial_reference_system(spatial_reference_system)](#supports_spatial_reference_system_spatial_reference_system_24) | 指定された空間参照系がドライバーでサポートされているかどうかを判定します。 |
...
GeoPackageDriver クラスの新しいインスタンスを初期化します。
...
| :- | :- | :- |
| path | [AbstractPath](/psd/python-net/aspose.gis/abstractpath) | データセットへのパス。 |
| options | [GeoPackageOptions](/psd/python-net/aspose.gis.formats.geopackage/geopackageoptions) | ドライバー固有のオプション。 |

**Returns**

| 型 | 説明 |
| :- | :- |
| [GeoPackageDataset](/psd/python-net/aspose.gis.formats.geopackage/geopackagedataset) | [Dataset](/psd/python-net/aspose.gis/dataset/) のインスタンス。 |
