...
description: InMemoryDriver 方法. 指定された空間参照系がドライバーでサポートされているかどうかを判断します
type: docs
weight: 60
url: /ja/net/aspose.gis.formats.inmemory/inmemorydriver/supportsspatialreferencesystem/
---
...
EsriJson の場合、サポートされている唯一の空間参照系は WGS84 です。

### 関連項目

* class [SpatialReferenceSystem](../../../aspose.gis.spatialreferencing/spatialreferencesystem/)
* class [InMemoryDriver](../)
* 名前空間 [Aspose.Gis.Formats.InMemory](../../inmemorydriver/)
* 組み立て [Aspose.GIS](../../../)
