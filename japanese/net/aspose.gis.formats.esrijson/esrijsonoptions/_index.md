...
description: Aspose.Gis.Formats.EsriJson.EsriJsonOptions クラス. EsriJson 形式のドライバー固有のオプション
type: docs
weight: 240
url: /ja/net/aspose.gis.formats.esrijson/esrijsonoptions/
---
## EsriJsonOptions class

EsriJson 形式のドライバー固有のオプション。
...
| 名前 | 説明 |
| --- | --- |
| [EsriJsonOptions](esrijsonoptions/)() | 新しいインスタンスを作成します。 |
...
| [NestedPropertiesSeparator](../../aspose.gis.formats.esrijson/esrijsonoptions/nestedpropertiesseparator/) { get; set; } | ネストされた属性のコンポーネントを区切るために使用される文字列を取得または設定します. デフォルトは「_」です. |
