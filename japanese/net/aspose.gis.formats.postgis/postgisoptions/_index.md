...
description: Aspose.Gis.Formats.PostGis.PostGisOptions クラス. PostGis 形式のドライバー固有のオプション. 現時点ではドライバーはカスタマイズ可能なオプションを提供していません.
type: docs
weight: 650
url: /ja/net/aspose.gis.formats.postgis/postgisoptions/
---
## PostGisOptions class

PostGis 形式のドライバー固有のオプション. 現時点では、ドライバーはカスタマイズ可能なオプションを提供していません.
...
| 名前 | 説明 |
| --- | --- |
| [PostGisOptions](postgisoptions/)() | 新しいインスタンスを作成します。 |
