...
description: Aspose.Gis.Formats.GDAL.GdalOptions クラス. GDAL 形式のドライバー固有のオプション
type: docs
weight: 290
url: /ja/net/aspose.gis.formats.gdal/gdaloptions/
---
## GdalOptions class

GDAL 形式のドライバー固有のオプション。
...
| 名前 | 説明 |
| --- | --- |
| [GdalOptions](gdaloptions/)(string) | 新しいインスタンスを作成します。 |
...
| [FileName](../../aspose.gis.formats.gdal/gdaloptions/filename/) { get; set; } | 起動するアプリケーションの名前 |
...
| [PathToTempFile](../../aspose.gis.formats.gdal/gdaloptions/pathtotempfile/) { get; } | 一時ファイルへのパス。 |
