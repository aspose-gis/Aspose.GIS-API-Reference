...
description: Aspose.Gis.Formats.EsriAscii.EsriAsciiOptions クラス. EsriAscii 形式のドライバー固有のオプション
type: docs
weight: 220
url: /ja/net/aspose.gis.formats.esriascii/esriasciioptions/
---
## EsriAsciiOptions class

EsriAscii 形式のドライバー固有のオプション。
...
| 名前 | 説明 |
| --- | --- |
| [EsriAsciiOptions](esriasciioptions/)() | 新しいインスタンスを作成します。 |
