...
description: Aspose.Gis.Geometries.MultiLineString クラス. AMultiLineStringは一次元ですGeometryCollection の要素はLineStrings.
type: docs
weight: 1150
url: /ja/net/aspose.gis.geometries/multilinestring/
---
## MultiLineString class

A`MultiLineString`は一次元です[`GeometryCollection`](../geometrycollection/) の要素は[`LineString`](../linestring/)s.
...
| 名前 | 説明 |
| --- | --- |
| [MultiLineString](multilinestring/)() | の新しいインスタンスを初期化します`MultiLineString`class. |
...
| [Dimension](../../aspose.gis.geometries/multicurve/dimension/) { get; } | このトポロジー次元を取得します[`Geometry`](../geometry/) . |
| override [GeometryType](../../aspose.gis.geometries/multilinestring/geometrytype/) { get; } | ジオメトリのタイプを取得します。 |
...
| virtual [IsClosed](../../aspose.gis.geometries/multicurve/isclosed/) { get; } | この曲線が閉じているかどうかを決定します. |
...
| override [Clone](../../aspose.gis.geometries/multilinestring/clone/)() | このインスタンスを複製します。 |
...
| [ToEditable](../../aspose.gis.geometries/multilinestring/toeditable/#toeditable_3)() | このジオメトリの編集可能なコピーを取得します. (4 methods) |
| [ToEditable&lt;T&gt;](../../aspose.gis.geometries/geometry/toeditable/)() | このジオメトリの編集可能なコピーを取得します. |
| [ToLinearGeometry](../../aspose.gis.geometries/multicurve/tolineargeometry/)() | デフォルトを使用して、このジオメトリの近似バージョンまたは同等の非曲線バージョンを取得します`許容範囲` . (3 methods) |
| [ToLinearGeometry](../../aspose.gis.geometries/multicurve/tolineargeometry/)(double) | 指定された値を使用して、このジオメトリの近似バージョンまたは同等の非曲線バージョンを取得します`許容範囲`. (3 methods) |
