...
description: Aspose.Gis.Geometries.MultiPolygon クラス. AMultiPolygonは 1 次元の ですGeometryCollectionその要素はPolygons.
type: docs
weight: 1170
url: /ja/net/aspose.gis.geometries/multipolygon/
---
## MultiPolygon class

A`MultiPolygon`は 1 次元の です[`GeometryCollection`](../geometrycollection/)その要素は[`Polygon`](../polygon/)s.
...
| 名前 | 説明 |
| --- | --- |
| [MultiPolygon](multipolygon/)() | の新しいインスタンスを初期化します`MultiPolygon`class. |
...
| override [GeometryType](../../aspose.gis.geometries/multipolygon/geometrytype/) { get; } | ジオメトリのタイプを取得します。 |
...
| override [Clone](../../aspose.gis.geometries/multipolygon/clone/)() | このインスタンスを複製します。 |
...
| [ToEditable](../../aspose.gis.geometries/multipolygon/toeditable/#toeditable_2)() | このジオメトリの編集可能なコピーを取得します. (4 methods) |
| [ToEditable&lt;T&gt;](../../aspose.gis.geometries/geometry/toeditable/)() | このジオメトリの編集可能なコピーを取得します. |
| [ToLinearGeometry](../../aspose.gis.geometries/multisurface/tolineargeometry/)() | デフォルトを使用して、このジオメトリの近似バージョンまたは同等の非曲線バージョンを取得します`許容範囲` . (3 methods) |
| [ToLinearGeometry](../../aspose.gis.geometries/multisurface/tolineargeometry/)(double) | 指定された値を使用して、このジオメトリの近似バージョンまたは同等の非曲線バージョンを取得します`許容範囲`. (3 methods) |
