...
description: Aspose.Gis.Geometries.MultiSurface クラス. AMultiSurfaceは一次元ですGeometryCollectionその要素はISurfaces.
type: docs
weight: 1180
url: /ja/net/aspose.gis.geometries/multisurface/
---
## MultiSurface class

A`MultiSurface`は一次元です[`GeometryCollection`](../geometrycollection/)その要素は[`ISurface`](../isurface/)s.
...
| 名前 | 説明 |
| --- | --- |
| [MultiSurface](multisurface/)() | の新しいインスタンスを初期化します`MultiSurface`class. |
...
| [Dimension](../../aspose.gis.geometries/multisurface/dimension/) { get; } | このトポロジー次元を取得します[`Geometry`](../geometry/) . |
| override [GeometryType](../../aspose.gis.geometries/multisurface/geometrytype/) { get; } | ジオメトリのタイプを取得します。 |
...
| override [Clone](../../aspose.gis.geometries/multisurface/clone/)() | このインスタンスを複製します。 |
...
| [ToEditable](../../aspose.gis.geometries/multisurface/toeditable/#toeditable_2)() | このジオメトリの編集可能なコピーを取得します. (3 methods) |
| [ToEditable&lt;T&gt;](../../aspose.gis.geometries/geometry/toeditable/)() | このジオメトリの編集可能なコピーを取得します. |
| [ToLinearGeometry](../../aspose.gis.geometries/multisurface/tolineargeometry/#tolineargeometry_4)() | デフォルトを使用して、このジオメトリの近似バージョンまたは同等の非曲線バージョンを取得します`許容範囲` . (3 methods) |
| [ToLinearGeometry](../../aspose.gis.geometries/multisurface/tolineargeometry/#tolineargeometry_5)(double) | 指定された値を使用して、このジオメトリの近似バージョンまたは同等の非曲線バージョンを取得します`許容範囲`. (3 methods) |
