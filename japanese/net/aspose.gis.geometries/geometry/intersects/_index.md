...
description: Geometry 方法. このジオメトリが指定された範囲と交差するかどうかを決定します.
type: docs
weight: 280
url: /ja/net/aspose.gis.geometries/geometry/intersects/
---
...
このメソッドは、 と同等です。 の否定です。[`Disjoint`](../../igeometry/disjoint/) .見る[`Disjoint`](../../igeometry/disjoint/)詳しくは.
