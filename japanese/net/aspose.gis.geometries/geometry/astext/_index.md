...
description: Geometry 方法. このジオメトリを WellKnown Text 表現に変換します
type: docs
weight: 130
url: /ja/net/aspose.gis.geometries/geometry/astext/
---
## AsText() {#astext}
...
このメソッドの出力はIsoWKT variant. デフォルトの数値形式は[`General`](../../../aspose.gis/numericformat/general/)(精度「0」).
...
デフォルトの数値形式は[`General`](../../../aspose.gis/numericformat/general/)(精度「0」).
