...
description: IGeometry 方法. このジオメトリを WellKnown Binary 表現に変換します
type: docs
weight: 100
url: /ja/net/aspose.gis.geometries/igeometry/asbinary/
---
## AsBinary() {#asbinary}
...
| 例外 | 調子 |
| --- | --- |
| NotSupportedException | 要求された WKB バリアントでジオメトリを表現できません。現在、これは の場合に発生します[`HasCurveGeometry`](../hascurvegeometry/)ジオメトリの`true`および WKB バリアント is SimpleFeatureAccessOutdated . |
