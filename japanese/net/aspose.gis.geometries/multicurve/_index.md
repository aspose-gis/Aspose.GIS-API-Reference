...
description: Aspose.Gis.Geometries.MultiCurve クラス. AMultiCurveは一次元ですGeometryCollection の要素はCurves.
type: docs
weight: 1140
url: /ja/net/aspose.gis.geometries/multicurve/
---
## MultiCurve class

A`MultiCurve`は一次元です[`GeometryCollection`](../geometrycollection/) の要素は[`Curve`](../curve/)s.
...
| 名前 | 説明 |
| --- | --- |
| [MultiCurve](multicurve/)() | の新しいインスタンスを初期化します`MultiCurve`class. |
...
| override [GeometryType](../../aspose.gis.geometries/multicurve/geometrytype/) { get; } | ジオメトリのタイプを取得します。 |
...
| override [Clone](../../aspose.gis.geometries/multicurve/clone/)() | このインスタンスを複製します。 |
...
| [ToEditable](../../aspose.gis.geometries/multicurve/toeditable/#toeditable_2)() | このジオメトリの編集可能なコピーを取得します. (3 methods) |
| [ToEditable&lt;T&gt;](../../aspose.gis.geometries/geometry/toeditable/)() | このジオメトリの編集可能なコピーを取得します. |
| [ToLinearGeometry](../../aspose.gis.geometries/multicurve/tolineargeometry/#tolineargeometry_4)() | デフォルトを使用して、このジオメトリの近似バージョンまたは同等の非曲線バージョンを取得します`許容範囲` . (3 methods) |
| [ToLinearGeometry](../../aspose.gis.geometries/multicurve/tolineargeometry/#tolineargeometry_5)(double) | 指定された値を使用して、このジオメトリの近似バージョンまたは同等の非曲線バージョンを取得します`許容範囲`. (3 methods) |
