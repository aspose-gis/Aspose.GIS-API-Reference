---
title: GeoPackageDataset Class
type: docs
weight: 10
url: /python-net/aspose.gis.formats.geopackage/geopackagedataset/
---
...
| **Name** | **Description** |
| :- | :- |
| [GeoPackageDataset(path, options)](#GeoPackageDataset_path_options_1) | Creates new instance. |
## **Properties**
...
| driver | [Driver](/psd/python-net/aspose.gis/driver) | r | Gets the [GeoPackageDataset.driver](/psd/python-net/aspose.gis.formats.geopackage/geopackagedataset/) that instantiated this dataset. |
| layers_count | int | r | Gets the number of layers in this dataset. |
| tile_layers_count | int | r | Gets the number of tile layers in this dataset. |
## **Methods**
| **Name** | **Description** |
| :- | :- |
...
| [edit_layer(name, options, spatial_reference_system)](#edit_layer_name_options_spatial_reference_system_10) | This method is still under development. |
| [edit_layer_at(index, options, spatial_reference_system)](#edit_layer_at_index_options_spatial_reference_system_11) | This method is still under development. |
| [get_layer_name(index)](#get_layer_name_index_12) | Gets the name of the layer at specified index. |
| [get_tile_layer_name(index)](#get_tile_layer_name_index_13) | Gets the name of the tile layer at specified index. |
| [has_layer_with_name(name)](#has_layer_with_name_name_14) | Check has current dataset a layer with specific name |
| [open(path, driver)](#open_path_driver_15) | Opens the dataset. |
| [open(path, driver)](#open_path_driver_16) | Opens the dataset. |
| [open(path, driver, options)](#open_path_driver_options_17) | Opens the dataset. |
| [open(path, driver, options)](#open_path_driver_options_18) | Opens the dataset. |
| [open(path, options)](#open_path_options_19) | Factory method for creating a dataset from a gpkg file. |
| [open_layer(name, options)](#open_layer_name_options_20) | Opens the layer with specified name for reading. |
| [open_layer_at(index, options)](#open_layer_at_index_options_21) | Opens the layer at specified index for reading. |
| [open_layer_at(index, options)](#open_layer_at_index_options_22) | Opens the layer at specified index for reading. |
| [open_tile_layer(name, options)](#open_tile_layer_name_options_23) | Opens the tile layer with specified name for reading. |
| [open_tile_layer_at(index, options)](#open_tile_layer_at_index_options_24) | Opens the tile layer at specified index for reading. |
| [remove_layer(name)](#remove_layer_name_25) | Removes the vector layer with specified name. |
| [remove_layer_at(index)](#remove_layer_at_index_26) | Removes the vector layer at specified index. |
| [rename_layer(current_name, new_name)](#rename_layer_current_name_new_name_27) | Rename layer in dataset |
...
| :- | :- | :- |
| path | [AbstractPath](/psd/python-net/aspose.gis/abstractpath) | Path to file gpkg. |
| options | [GeoPackageOptions](/psd/python-net/aspose.gis.formats.geopackage/geopackageoptions) | Settings regarding the particularities of reading the gpkg file. |
...
| :- | :- | :- |
| index | int | Index of the layer to open. |
| options | [GeoPackageOptions](/psd/python-net/aspose.gis.formats.geopackage/geopackageoptions) | Open options. |
...
| Type | Description |
| :- | :- |
| [XyzTiles](/psd/python-net/aspose.gis.formats.xyztile/xyztiles/) | The tile layer opened for reading. |
