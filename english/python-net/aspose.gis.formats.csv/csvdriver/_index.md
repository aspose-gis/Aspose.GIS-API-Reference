---
title: CsvDriver Class
type: docs
weight: 10
url: /python-net/aspose.gis.formats.csv/csvdriver/
---
...
| **Name** | **Description** |
| :- | :- |
| [CsvDriver()](#CsvDriver__1) | Initializes a new instance of the CsvDriver class |
## **Properties**
...
Initializes a new instance of the CsvDriver class
...
| :- | :- | :- |
| path | string | Path to the file. |
| options | [CsvOptions](/psd/python-net/aspose.gis.formats.csv/csvoptions) | Driver-specific options. |
