...
type: docs
weight: 60
url: /python-net/aspose.gis.geometries/geometrycollection/
---
...
| **Name** | **Description** |
| :- | :- |
| [GeometryCollection()](#GeometryCollection__1) | Initializes a new instance of the [GeometryCollection](/psd/python-net/aspose.gis.geometries/geometrycollection/) class. |
## **Properties**
...
| dimension | [GeometryDimension](/psd/python-net/aspose.gis.geometries/geometrydimension) | r | Gets the topological dimension of this [Geometry](/psd/python-net/aspose.gis.geometries/geometry/).<br/>            If collection is Empty, [GeometryDimension.POINT](/psd/python-net/aspose.gis.geometries/geometrydimension/) is returned. |
...
Initializes a new instance of the [GeometryCollection](/psd/python-net/aspose.gis.geometries/geometrycollection/) class.
