...
| [open_as_kml_layer(path, options)](#open_as_kml_layer_path_options_18) | Opens a Kml layer for reading. |
...
| Type | Description |
| :- | :- |
| [KmlLayer](/psd/python-net/aspose.gis.formats.kml/kmllayer) | KmlLayer with specific fields |
