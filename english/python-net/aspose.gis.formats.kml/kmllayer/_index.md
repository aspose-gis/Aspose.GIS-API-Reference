---
title: KmlLayer Class
type: docs
weight: 140
url: /python-net/aspose.gis.formats.kml/kmllayer/
---
...
| driver | [Driver](/psd/python-net/aspose.gis/driver) | r | Gets the [KmlLayer.driver](/psd/python-net/aspose.gis.formats.kml/kmllayer/) that instantiated this layer. |
| features | [Feature[]](/psd/python-net/aspose.gis/feature) | r | Gets the list features. |
...
| spatial_reference_system | [SpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem/) | r | Get spatial reference system of this layer. For KML this is always WGS84. |
## **Methods**
| **Name** | **Description** |
| :- | :- |
