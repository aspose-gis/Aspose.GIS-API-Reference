---
title: TopoJsonDriver Class
type: docs
weight: 10
url: /python-net/aspose.gis.formats.topojson/topojsondriver/
---
...
| :- | :- | :- |
| path | string | Path to the file. |
| options | [TopoJsonOptions](/psd/python-net/aspose.gis.formats.topojson/topojsonoptions) | Driver-specific options. |
