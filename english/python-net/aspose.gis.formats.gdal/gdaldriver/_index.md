---
title: GdalDriver Class
type: docs
weight: 10
url: /python-net/aspose.gis.formats.gdal/gdaldriver/
---
...
| [create_layer(path, options, spatial_reference_system)](#create_layer_path_options_spatial_reference_system_9) | Creates a layer and opens it for adding new features. |
...
| [open_layer(path, options)](#open_layer_path_options_21) | Opens a layer for reading. |
| [open_layer(path, options)](#open_layer_path_options_22) | Opens a layer for reading. |
...
| :- | :- | :- |
| path | string | Path to the file. |
| options | [GdalOptions](/psd/python-net/aspose.gis.formats.gdal/gdaloptions) | Driver-specific options. |
