---
title: GdalOptions Class
type: docs
weight: 20
url: /python-net/aspose.gis.formats.gdal/gdaloptions/
---
...
| **Name** | **Description** |
| :- | :- |
| [GdalOptions(temp_directory)](#GdalOptions_temp_directory_1) | Create a new instance. |
## **Properties**
...
| file_name | string | r/w | Name of the application to start |
...
| path_to_temp_file | string | r | Path to temporary files. |
...
| :- | :- | :- |
| temp_directory | string | Path to temporary files. Users's temporary folder by Default. |
