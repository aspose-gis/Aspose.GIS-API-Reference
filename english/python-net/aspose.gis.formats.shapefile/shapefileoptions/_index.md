---
title: ShapefileOptions Class
type: docs
weight: 20
url: /python-net/aspose.gis.formats.shapefile/shapefileoptions/
---
...
| **Name** | **Description** |
| :- | :- |
| [ShapefileOptions()](#ShapefileOptions__1) | Create new instance. |
## **Properties**
...
| is_ignore_wrong_data | bool | r/w | Determines should we throw exception while parse wrong data or set default values for it |
