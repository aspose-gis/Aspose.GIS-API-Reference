---
title: InFileDriver Class
type: docs
weight: 10
url: /python-net/aspose.gis.formats.infile/infiledriver/
---
...
| :- | :- | :- |
| path | string | Path to the file. |
| options | [InFileOptions](/psd/python-net/aspose.gis.formats.infile/infileoptions) | Driver-specific options. |
