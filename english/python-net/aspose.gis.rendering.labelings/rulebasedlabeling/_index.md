---
title: RuleBasedLabeling Class
type: docs
weight: 70
url: /python-net/aspose.gis.rendering.labelings/rulebasedlabeling/
---
...
| **Name** | **Description** |
| :- | :- |
| [RuleBasedLabeling()](#RuleBasedLabeling__1) | Initializes a new instance of the RuleBasedLabeling class |
## **Properties**
...
| [add_else_rule(labeling)](#add_else_rule_labeling_2) | Adds a labeling that will be applied to features that don't match any filtering rule. |
...
| :- | :- | :- |
| rule | [LabelingRule](/psd/python-net/aspose.gis.rendering.labelings/labelingrule) | Rule to add. |

### Method: add_else_rule(labeling) {#add_else_rule_labeling_2}
...
| Parameter | Type | Description |
| :- | :- | :- |
| labeling | [Labeling](/psd/python-net/aspose.gis.rendering.labelings/labeling) | A labeling. |
