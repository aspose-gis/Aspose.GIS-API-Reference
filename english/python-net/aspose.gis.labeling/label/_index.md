...
type: docs
weight: 50
url: /python-net/aspose.gis.labeling/label/
---
...
| **Name** | **Description** |
| :- | :- |
| [Label(text, style, positions, priority)](#Label_text_style_positions_priority_1) | Initializes a new instance of the Label class |
## **Properties**
...
### Constructor: Label(text, style, positions, priority) {#Label_text_style_positions_priority_1}
