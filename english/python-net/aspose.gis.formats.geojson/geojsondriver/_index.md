---
title: GeoJsonDriver Class
type: docs
weight: 10
url: /python-net/aspose.gis.formats.geojson/geojsondriver/
---
...
| :- | :- | :- |
| path | string | Path to the file. |
| options | [GeoJsonOptions](/psd/python-net/aspose.gis.formats.geojson/geojsonoptions) | Driver-specific options. |
