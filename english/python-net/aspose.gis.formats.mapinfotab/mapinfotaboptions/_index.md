---
title: MapInfoTabOptions Class
type: docs
weight: 20
url: /python-net/aspose.gis.formats.mapinfotab/mapinfotaboptions/
---
...
| **Name** | **Description** |
| :- | :- |
| [MapInfoTabOptions()](#MapInfoTabOptions__1) | Create new instance. |
## **Properties**
| **Name** | **Type** | **Access** | **Description** |
| :- | :- | :- | :- |
| block_size | int | r/w | Block size for '*.map' files (multiples of 512). Defaults to 16384. Valid values: 512 to 32256. |
...
| is_ignore_wrong_data | bool | r/w | Determines should we throw exception while work with wrong data or set default values for it |
...
| text_string_attribute | string | r/w | Specifies name of the attribute that represents text of 'Text' graphical object. |
