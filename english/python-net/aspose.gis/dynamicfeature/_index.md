---
title: DynamicFeature Class
type: docs
weight: 650
url: /python-net/aspose.gis/dynamicfeature/
---
...
| [get_as_node()](#get_as_node__2) | Gets the feature as node. This can be helpful for the custom data |
| [get_value(attribute_name)](#get_value_attribute_name_3) | Gets the value of an attribute. |
| [get_value_or_default(attribute_name, default_value)](#get_value_or_default_attribute_name_default_value_4) | Gets the value of an attribute, or [FeatureAttribute.default_value](/psd/python-net/aspose.gis/featureattribute/) if the value is unset or <c>null</c>. |
| [get_values(values, default_value)](#get_values_values_default_value_5) | Returns the values for all the attributes in an array. |
| [get_values(values_count, default_value)](#get_values_values_count_default_value_6) | Returns the values for all the attributes in an array. |
| [get_values_dump(default_value)](#get_values_dump_default_value_7) | Returns the values for all the attributes in an array.<br/>            Consider to use Aspose.Gis.DynamicFeature.GetValues(System.Object,System.Object) method to avoid additional memory allocation. |
| [get_values_list(attribute_name, separator, count)](#get_values_list_attribute_name_separator_count_8) | Gets the values of an attributes sequence as a list. |
| [is_value_null(attribute_name)](#is_value_null_attribute_name_9) | Determines whether the specified attribute has been explicitly set to <c>null</c> value. |
| [is_value_set(attribute_name)](#is_value_set_attribute_name_10) | Checks if the attribute value is set in this feature. |
| [set_value(attribute_name, value)](#set_value_attribute_name_value_11) | Sets a new value of an attribute. |
| [set_value_null(attribute_name)](#set_value_null_attribute_name_12) | Sets value of the attribute to <c>null</c>. |
| [set_values(values)](#set_values_values_13) | Sets new values for all of the attributes.<br/>            Also consider to use [DynamicFeature.copy_values(input_feature)](/psd/python-net/aspose.gis/dynamicfeature/) method to streamline setting values in one call. |
| [unset_value(attribute_name)](#unset_value_attribute_name_14) | Removes the attribute value from this feature. |
...
| Type | Description |
| :- | :- |
| [NodeLink](/psd/python-net/aspose.gis/nodelink) | The NodeLink to feature |
...
Returns the values for all the attributes in an array.<br/>            Consider to use Aspose.Gis.DynamicFeature.GetValues(System.Object,System.Object) method to avoid additional memory allocation.
...
Sets new values for all of the attributes.<br/>            Also consider to use [DynamicFeature.copy_values(input_feature)](/psd/python-net/aspose.gis/dynamicfeature/) method to streamline setting values in one call.
