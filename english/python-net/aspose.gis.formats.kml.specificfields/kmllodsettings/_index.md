---
title: KmlLodSettings Class
type: docs
weight: 50
url: /python-net/aspose.gis.formats.kml.specificfields/kmllodsettings/
---
...
| max_fade_extent | int | r/w | MaxFadeExtent of 'Lod' node. |
| max_lod_pixels | int | r/w | MaxLodPixels of 'Lod' node. |
| min_fade_extent | int | r/w | MinFadeExtent of 'Lod' node. |
| min_lod_pixels | int | r/w | MinLodPixels of 'Lod' node. |
