---
title: KmlGroundOverlayInfo Class
type: docs
weight: 20
url: /python-net/aspose.gis.formats.kml.specificfields/kmlgroundoverlayinfo/
---
...
| draw_order | double | r/w | DrawOrder of 'GroundOverlay' node. |
| icon | [IconInfo](/psd/python-net/aspose.gis.formats.kml.specificfields/iconinfo) | r/w | IconPath of 'GroundOverlay' node. |
| lat_lon_box | [KmlLatLonBox](/psd/python-net/aspose.gis.formats.kml.specificfields/kmllatlonbox) | r/w | Specifies object from Kml 'LatLonAltBox' node. |
| name | string | r/w | Name of Ground Overlay |
...
| visibility | bool | r/w | Visibility of Ground Overlay |
## **Methods**
| **Name** | **Description** |
| :- | :- |
