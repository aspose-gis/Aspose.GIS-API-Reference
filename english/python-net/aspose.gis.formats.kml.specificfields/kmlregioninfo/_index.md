---
title: KmlRegionInfo Class
type: docs
weight: 70
url: /python-net/aspose.gis.formats.kml.specificfields/kmlregioninfo/
---
...
| id | string | r/w | Id of 'Region' node. |
| lat_lon_alt_box | [KmlLatLonAltBox](/psd/python-net/aspose.gis.formats.kml.specificfields/kmllatlonaltbox) | r/w | Specifies object from Kml 'LatLonAltBox' node. |
| lod | [KmlLodSettings](/psd/python-net/aspose.gis.formats.kml.specificfields/kmllodsettings) | r/w | Specifies object from Kml 'Lod' node. |
