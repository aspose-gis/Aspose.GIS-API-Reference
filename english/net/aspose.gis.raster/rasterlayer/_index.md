...
| Name | Description |
| --- | --- |
| [Crop](../../aspose.gis.raster/rasterlayer/crop)(IGeometry) | Crops the raster layer using a shape form. |
| [Dispose](../../aspose.gis.raster/rasterlayer/dispose)() | Releases the resources used by the [`RasterLayer`](../rasterlayer). |
