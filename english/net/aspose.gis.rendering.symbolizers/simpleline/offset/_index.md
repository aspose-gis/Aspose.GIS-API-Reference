...
description: SimpleLine property. Specifies offset from the original line. For positive distance the offset will be at the left side of the input line relative to the line direction. For a negative distance it will be at the right side.
type: docs
weight: 80
url: /net/aspose.gis.rendering.symbolizers/simpleline/offset/
---
