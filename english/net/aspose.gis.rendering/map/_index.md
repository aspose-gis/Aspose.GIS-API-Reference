...
| Name | Description |
| --- | --- |
| [Add](../../aspose.gis.rendering/map/add)(FeaturesSequence) | Creates and adds a [`VectorMapLayer`](../vectormaplayer) to the map. Layers are rendered in addition order. |
| [Add](../../aspose.gis.rendering/map/add)(MapLayer) | Adds a layer to the map. Layers are rendered in addition order. |
| [Add](../../aspose.gis.rendering/map/add)(FeaturesSequence, VectorSymbolizer) | Creates and adds a [`VectorMapLayer`](../vectormaplayer) to the map. Layers are rendered in addition order. |
| [Add](../../aspose.gis.rendering/map/add)(VectorLayer, bool) | Creates a [`VectorMapLayer`](../vectormaplayer) with default symbolizer and adds it to the map. Layers are rendered in addition order. |
| [Add](../../aspose.gis.rendering/map/add)(FeaturesSequence, VectorSymbolizer, Labeling) | Creates and adds a [`VectorMapLayer`](../vectormaplayer) to the map. Layers are rendered in addition order. |
| [Add](../../aspose.gis.rendering/map/add)(RasterLayer, RasterColorizer, bool) | Creates a [`RasterMapLayer`](../rastermaplayer) with default colorizer and adds it to the map. |
| [Add](../../aspose.gis.rendering/map/add)(VectorLayer, VectorSymbolizer, bool) | Creates and adds a [`VectorMapLayer`](../vectormaplayer) to the map. Layers are rendered in addition order. |
| [Add](../../aspose.gis.rendering/map/add)(VectorLayer, VectorSymbolizer, Labeling, bool) | Creates and adds a [`VectorMapLayer`](../vectormaplayer) to the map. Layers are rendered in addition order. |
...
| [Render](../../aspose.gis.rendering/map/render)(AbstractPath, Renderer) | Renders map into a file. |
| [Render](../../aspose.gis.rendering/map/render)(string, Renderer) | Renders map into a file. |
