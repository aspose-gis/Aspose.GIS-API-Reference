...
description: Aspose.Gis.Geometries.MultiSurface class. A MultiSurface is a onedimensional GeometryCollection whose elements are ISurfaces
type: docs
weight: 2960
...
A `MultiSurface` is a one-dimensional [`GeometryCollection`](../geometrycollection/) whose elements are [`ISurface`](../isurface/)s.
...
| Name | Description |
| --- | --- |
| [MultiSurface](multisurface/)() | Initializes a new instance of the `MultiSurface` class. |
...
| [Dimension](../../aspose.gis.geometries/multisurface/dimension/) { get; } | Gets the topological dimension of this [`Geometry`](../geometry/). |
| override [GeometryType](../../aspose.gis.geometries/multisurface/geometrytype/) { get; } | Gets the type of the geometry. |
...
| override [Clone](../../aspose.gis.geometries/multisurface/clone/)() | Clones this instance. |
...
| [ToEditable](../../aspose.gis.geometries/multisurface/toeditable/#toeditable_2)() | Gets an editable copy of this geometry. (3 methods) |
| [ToEditable&lt;T&gt;](../../aspose.gis.geometries/geometry/toeditable/)() | Gets an editable copy of this geometry. |
| [ToLinearGeometry](../../aspose.gis.geometries/multisurface/tolineargeometry/#tolineargeometry_4)() | Gets approximate or equivalent non-curve version of this geometry using the default `tolerance`. (3 methods) |
| [ToLinearGeometry](../../aspose.gis.geometries/multisurface/tolineargeometry/#tolineargeometry_5)(double) | Gets approximate or equivalent non-curve version of this geometry using the specified `tolerance`. (3 methods) |
