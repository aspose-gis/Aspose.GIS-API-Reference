...
| Name | Description |
| --- | --- |
| [AddCurve](../../aspose.gis.geometries/compoundcurve/addcurve)(ICurve) | Adds a curve to the end of this [`CompoundCurve`](../compoundcurve). |
...
| [Equals](../../aspose.gis.geometries/compoundcurve/equals)(ICompoundCurve) | Indicates whether the current object is equal to another object of the same type. |
| override [Equals](../../aspose.gis.geometries/compoundcurve/equals)(object) | Determines whether the specified object is equal to the current object. |
...
| override [Reverse](../../aspose.gis.geometries/compoundcurve/reverse)() | Reverses this [`CompoundCurve`](../compoundcurve). That is - reverse order of curves and every curve inside this compound curve. |
...
| [ToEditable](../../aspose.gis.geometries/compoundcurve/toeditable)() | Gets an editable copy of this geometry. (3 methods) |
