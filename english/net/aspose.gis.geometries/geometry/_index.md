...
| abstract [Dimension](../../aspose.gis.geometries/geometry/dimension) { get; } | Gets the topological dimension of this [`Geometry`](../geometry). If the dimension is unknown (e.g. for an empty GEOMETRYCOLLECTION) Point is returned. |
...
| [ToEditable](../../aspose.gis.geometries/geometry/toeditable)() | Gets an editable copy of this geometry. |
...
| static [FromBinary](../../aspose.gis.geometries/geometry/frombinary)(byte[]) | Creates a geometry from its Well-Known Binary representation. |
| static [FromBinary](../../aspose.gis.geometries/geometry/frombinary)(byte[], SpatialReferenceSystem) | Creates a geometry from its Well-Known Binary representation. |
| static [FromText](../../aspose.gis.geometries/geometry/fromtext)(string) | Creates a geometry from its Well-Known Text representation. |
| static [FromText](../../aspose.gis.geometries/geometry/fromtext)(string, SpatialReferenceSystem) | Creates a geometry from its Well-Known Text representation. |
