...
| Name | Description |
| --- | --- |
| [LineString](linestring/#constructor)() | Initializes a new instance of the `LineString` class. |
| [LineString](linestring/#constructor_2)(IEnumerable&lt;IPoint&gt;) | Initializes a new instance of the `LineString` class. |
| [LineString](linestring/#constructor_1)(ILineString) | Initializes a new instance of the `LineString` class. |
...
| [Count](../../aspose.gis.geometries/linestring/count/) { get; } | Gets the number of points in the `LineString`. |
...
| override [GeometryType](../../aspose.gis.geometries/linestring/geometrytype/) { get; } | Gets the type of the geometry. |
...
| Name | Description |
| --- | --- |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint/#addpoint)(IPoint) | Adds a point to the end of the line. |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint/#addpoint_1)(double, double) | Adds a point to the end of the line. |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint/#addpoint_2)(double, double, double) | Adds a point to the end of the line. |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint/#addpoint_3)(double, double, double, double) | Adds a point to the end of the line. |
...
| override [Clone](../../aspose.gis.geometries/linestring/clone/)() | Clones this instance. |
...
| [Equals](../../aspose.gis.geometries/linestring/equals/#equals)(ILineString) | Indicates whether the current object is equal to another object of the same type. |
| override [Equals](../../aspose.gis.geometries/linestring/equals/#equals_1)(object) | Determines whether the specified object is equal to the current object. |
...
| override [Reverse](../../aspose.gis.geometries/linestring/reverse/)() | Reverses order of points in this `LineString`. |
...
| [ToEditable](../../aspose.gis.geometries/linestring/toeditable/#toeditable_2)() | Gets an editable copy of this geometry. (3 methods) |
...
| [operator ==](../../aspose.gis.geometries/linestring/op_equality/) | Implements the operator ==. |
| [operator !=](../../aspose.gis.geometries/linestring/op_inequality/) | Implements the operator !=. |
