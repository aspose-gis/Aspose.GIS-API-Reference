...
A `MultiPolygon` is a one-dimensional [`GeometryCollection`](../geometrycollection/) whose elements are [`Polygon`](../polygon/)s.
...
| Name | Description |
| --- | --- |
| [MultiPolygon](multipolygon/)() | Initializes a new instance of the `MultiPolygon` class. |
...
| [ToEditable](../../aspose.gis.geometries/multipolygon/toeditable/#toeditable_2)() | Gets an editable copy of this geometry. (4 methods) |
