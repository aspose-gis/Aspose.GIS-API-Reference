...
description: Aspose.Gis.Geometries.MultiPoint class. A MultiPoint is a onedimensional GeometryCollection whose elements are Points
type: docs
weight: 2940
...
A `MultiPoint` is a one-dimensional [`GeometryCollection`](../geometrycollection/) whose elements are [`Point`](../point/)s.
...
| Name | Description |
| --- | --- |
| [MultiPoint](multipoint/)() | Initializes a new instance of the `MultiPoint` class. |
...
| [Dimension](../../aspose.gis.geometries/multipoint/dimension/) { get; } | Gets the topological dimension of this [`Geometry`](../geometry/). |
| override [GeometryType](../../aspose.gis.geometries/multipoint/geometrytype/) { get; } | Gets the type of the geometry. |
...
| override [Clone](../../aspose.gis.geometries/multipoint/clone/)() | Clones this instance. |
...
| [ToEditable](../../aspose.gis.geometries/multipoint/toeditable/#toeditable_2)() | Gets an editable copy of this geometry. (3 methods) |
| [ToEditable&lt;T&gt;](../../aspose.gis.geometries/geometry/toeditable/)() | Gets an editable copy of this geometry. |
| [ToLinearGeometry](../../aspose.gis.geometries/geometrycollection/tolineargeometry/)() | Gets approximate or equivalent non-curve version of this geometry using the default `tolerance`. (2 methods) |
| [ToLinearGeometry](../../aspose.gis.geometries/geometrycollection/tolineargeometry/)(double) | Gets approximate or equivalent non-curve version of this geometry using the specified `tolerance`. (2 methods) |
