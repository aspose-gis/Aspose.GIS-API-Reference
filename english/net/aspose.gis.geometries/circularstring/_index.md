...
| [Count](../../aspose.gis.geometries/circularstring/count) { get; } | Gets the number of points in the [`CircularString`](../circularstring). |
...
| Name | Description |
| --- | --- |
| [AddPoint](../../aspose.gis.geometries/circularstring/addpoint)(IPoint) | Adds a point to the end of the circular string. |
| [AddPoint](../../aspose.gis.geometries/circularstring/addpoint)(double, double) | Adds a point to the end of the circular string. |
| [AddPoint](../../aspose.gis.geometries/circularstring/addpoint)(double, double, double) | Adds a point to the end of the circular string. |
| [AddPoint](../../aspose.gis.geometries/circularstring/addpoint)(double, double, double, double) | Adds a point to the end of the circular string. |
...
| [Equals](../../aspose.gis.geometries/circularstring/equals)(ICircularString) | Indicates whether the current object is equal to another object of the same type. |
| override [Equals](../../aspose.gis.geometries/circularstring/equals)(object) | Determines whether the specified object is equal to the current object. |
...
| override [Reverse](../../aspose.gis.geometries/circularstring/reverse)() | Reverses order of points in this [`CircularString`](../circularstring). |
...
| [ToEditable](../../aspose.gis.geometries/circularstring/toeditable)() | Gets an editable copy of this geometry. (3 methods) |
