...
| [CreateLayer](../../aspose.gis.formats.topojson/topojsondriver/createlayer)(AbstractPath, TopoJsonOptions) | Creates a layer and opens it for adding new features. |
...
| [CreateLayer](../../aspose.gis.formats.topojson/topojsondriver/createlayer)(string, TopoJsonOptions) | Creates a layer and opens it for adding new features. |
| override [CreateLayer](../../aspose.gis.formats.topojson/topojsondriver/createlayer)(AbstractPath, DriverOptions, SpatialReferenceSystem) | Creates a layer and opens it for adding new features. |
| [CreateLayer](../../aspose.gis.formats.topojson/topojsondriver/createlayer)(AbstractPath, TopoJsonOptions, SpatialReferenceSystem) | Creates a layer and opens it for adding new features. |
...
| override [OpenLayer](../../aspose.gis.formats.topojson/topojsondriver/openlayer)(AbstractPath, DriverOptions) | Opens a layer for reading. |
| [OpenLayer](../../aspose.gis.formats.topojson/topojsondriver/openlayer)(AbstractPath, TopoJsonOptions) | Opens a layer for reading. |
| [OpenLayer](../../aspose.gis/filedriver/openlayer)(string, DriverOptions) | Opens the layer for reading. |
| [OpenLayer](../../aspose.gis.formats.topojson/topojsondriver/openlayer)(string, TopoJsonOptions) | Opens a layer for reading. |
