...
| [CreateLayer](../../aspose.gis.formats.geojson/geojsondriver/createlayer)(AbstractPath, GeoJsonOptions) | Creates a layer and opens it for adding new features. |
...
| [CreateLayer](../../aspose.gis.formats.geojson/geojsondriver/createlayer)(string, GeoJsonOptions) | Creates a layer and opens it for adding new features. |
| [CreateLayer](../../aspose.gis/filedriver/createlayer)(string, SpatialReferenceSystem) | Creates the layer and opens it for appending. |
| override [CreateLayer](../../aspose.gis.formats.geojson/geojsondriver/createlayer)(AbstractPath, DriverOptions, SpatialReferenceSystem) | Creates a layer and opens it for adding new features. |
| [CreateLayer](../../aspose.gis.formats.geojson/geojsondriver/createlayer)(AbstractPath, GeoJsonOptions, SpatialReferenceSystem) | Creates a layer and opens it for adding new features. |
...
| override [OpenLayer](../../aspose.gis.formats.geojson/geojsondriver/openlayer)(AbstractPath, DriverOptions) | Opens a layer for reading. |
| [OpenLayer](../../aspose.gis.formats.geojson/geojsondriver/openlayer)(AbstractPath, GeoJsonOptions) | Opens a layer for reading. |
| [OpenLayer](../../aspose.gis/filedriver/openlayer)(string, DriverOptions) | Opens the layer for reading. |
| [OpenLayer](../../aspose.gis.formats.geojson/geojsondriver/openlayer)(string, GeoJsonOptions) | Opens a layer for reading. |
