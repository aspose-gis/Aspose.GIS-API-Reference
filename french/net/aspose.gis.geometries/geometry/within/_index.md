...
description: Détermine si cette géométrie se trouve dans une étendue spécifiée.
type: docs
weight: 440
...
Cette méthode teste si une géométrie est à l'intérieur d'une autre en termes de matrice d'intersection DE-9IM. Une géométrie est à l'intérieur d'une autre, si une autre géométrie contient tous les points de la géométrie et que les géométries intérieures se croisent. Cette méthode équivaut à : Voir OpenGIS Simple Features Specification pour plus de détails sur DE-9IM et la relation "spatialement à l'intérieur".
