...
description: Aspose.Gis.Geometries.CircularString classe. Une courbe à plusieurs sommets avec interpolation circulaire entre les points.
type: docs
weight: 880
...
| Nom | La description |
| --- | --- |
| [CircularString](circularstring/#constructor)() | Initialise une nouvelle instance du`CircularString` classe. |
| [CircularString](circularstring/#constructor_1)(ICircularString) | Initialise une nouvelle instance du`CircularString` classe. |
| [CircularString](circularstring/#constructor_2)(IEnumerable&lt;IPoint&gt;) | Initialise une nouvelle instance du`CircularString` classe. |
...
| [Count](../../aspose.gis.geometries/circularstring/count/) { get; } | Obtient le nombre de points dans le`CircularString` . |
...
| override [Reverse](../../aspose.gis.geometries/circularstring/reverse/)() | Inverse l'ordre des points dans ce`CircularString` . |
