...
description: Aspose.Gis.Geometries.GeometryCollection classe. AGeometryCollection est unGeometry qui est une collection dune ou plusieurs géométries.
type: docs
weight: 930
...
A`GeometryCollection` est un[`Geometry`](../geometry/) qui est une collection d'une ou plusieurs géométries.
...
| Nom | La description |
| --- | --- |
| [GeometryCollection](geometrycollection/)() | Initialise une nouvelle instance du`GeometryCollection` classe. |
