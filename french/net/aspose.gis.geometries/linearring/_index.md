...
description: Aspose.Gis.Geometries.LinearRing classe. ALinearRing est unLineString cest à la fois fermé et simple.
type: docs
weight: 1130
...
A`LinearRing` est un[`LineString`](../linestring/) c'est à la fois fermé et simple.
...
| Nom | La description |
| --- | --- |
| [LinearRing](linearring/#constructor)() | Initialise une nouvelle instance du`LinearRing` classe. |
| [LinearRing](linearring/#constructor_2)(IEnumerable&lt;IPoint&gt;) | Initialise une nouvelle instance du`LinearRing` classe. |
| [LinearRing](linearring/#constructor_1)(ILineString) | Initialise une nouvelle instance du`LinearRing` classe. |
