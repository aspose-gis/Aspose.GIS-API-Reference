...
type: docs
weight: 790
url: /fr/net/aspose.gis.geometries/compoundcurve/
---
## CompoundCurve class
...
| Nom | La description |
| --- | --- |
| [CompoundCurve](compoundcurve#constructor)() | Initialise une nouvelle instance du[`CompoundCurve`](../compoundcurve) classe. |
| [CompoundCurve](compoundcurve#constructor_1)(ICompoundCurve) | Initialise une nouvelle instance du[`CompoundCurve`](../compoundcurve) classe. |
| [CompoundCurve](compoundcurve#constructor_2)(IEnumerable&lt;ICurve&gt;) | Initialise une nouvelle instance du[`CompoundCurve`](../compoundcurve) classe. |
...
| [Count](../../aspose.gis.geometries/compoundcurve/count) { get; } | Obtient le nombre de courbes dans le[`ICompoundCurve`](../icompoundcurve) . |
| [Dimension](../../aspose.gis.geometries/curve/dimension) { get; } | Obtient la dimension topologique de cette[`Geometry`](../geometry) . |
| override [EndPoint](../../aspose.gis.geometries/compoundcurve/endpoint) { get; } | Renvoie une copie du point final de la courbe. |
| override [GeometryType](../../aspose.gis.geometries/compoundcurve/geometrytype) { get; } | Obtient le type de la géométrie. |
| override [HasCurveGeometry](../../aspose.gis.geometries/compoundcurve/hascurvegeometry) { get; } | Obtient une valeur indiquant si cette géométrie est ou contient une géométrie courbe (non linéaire). |
| [HasM](../../aspose.gis.geometries/compoundcurve/hasm) { get; set; } | Obtient une valeur indiquant si cette instance a la coordonnée M. |
| [HasZ](../../aspose.gis.geometries/compoundcurve/hasz) { get; set; } | Obtient une valeur indiquant si cette instance a la coordonnée Z. |
...
| override [IsEmpty](../../aspose.gis.geometries/compoundcurve/isempty) { get; } | Obtient une valeur indiquant si cette instance est vide. |
...
| [Item](../../aspose.gis.geometries/compoundcurve/item) { get; } | Obtient le[`ICurve`](../icurve) à l'index spécifié. |
| [SpatialReferenceSystem](../../aspose.gis.geometries/compoundcurve/spatialreferencesystem) { get; set; } | Obtient SpatialReferenceSystem de cette instance. Cette propriété peut être`null` , si SpatialReferenceSystem n'est pas défini. L'attribution d'un nouveau SpatialReferenceSystem n'effectuera aucune transformation de coordonnées, seule la référence changera. |
| override [StartPoint](../../aspose.gis.geometries/compoundcurve/startpoint) { get; } | Renvoie une copie du point de départ de la courbe. |

## Méthodes

| Nom | La description |
| --- | --- |
| [AddCurve](../../aspose.gis.geometries/compoundcurve/addcurve)(ICurve) | Ajoute une courbe à la fin de cette[`CompoundCurve`](../compoundcurve) . |
...
| override [Clone](../../aspose.gis.geometries/compoundcurve/clone)() | Clone cette instance. |
...
| [Equals](../../aspose.gis.geometries/compoundcurve/equals#equals)(ICompoundCurve) | Indique si l'objet courant est égal à un autre objet du même type. |
| override [Equals](../../aspose.gis.geometries/compoundcurve/equals#equals_1)(object) | Détermine si l'objet spécifié est égal à l'objet actuel. |
...
| [GetEnumerator](../../aspose.gis.geometries/compoundcurve/getenumerator)() | Retourne un énumérateur qui parcourt la collection. |
| [GetExtent](../../aspose.gis.geometries/geometry/getextent)() | Calcule et renvoie une étendue de délimitation de cette géométrie. |
| override [GetHashCode](../../aspose.gis.geometries/compoundcurve/gethashcode)() | Sert de fonction de hachage par défaut. |
...
| override [Reverse](../../aspose.gis.geometries/compoundcurve/reverse)() | Inverse ceci[`CompoundCurve`](../compoundcurve) . C'est-à-dire - l'ordre inverse des courbes et chaque courbe à l'intérieur de cette courbe composée. |
...
| override [SetEmpty](../../aspose.gis.geometries/compoundcurve/setempty)() | Rend ceci[`Geometry`](../geometry) vide. |
...
| [ToEditable](../../aspose.gis.geometries/compoundcurve/toeditable#toeditable)() | Obtient une copie modifiable de cette géométrie. (3 methods) |
...
| [operator ==](../../aspose.gis.geometries/compoundcurve/op_equality) | Implémente l'opérateur ==. |
| [operator !=](../../aspose.gis.geometries/compoundcurve/op_inequality) | Implémente l'opérateur !=. |
