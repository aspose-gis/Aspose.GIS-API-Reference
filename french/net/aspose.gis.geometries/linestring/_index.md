...
description: Aspose.Gis.Geometries.LineString classe. Une ligne multivertex.
type: docs
weight: 1120
url: /fr/net/aspose.gis.geometries/linestring/
---
## LineString class

Une ligne multi-vertex.
...
| Nom | La description |
| --- | --- |
| [LineString](linestring/#constructor)() | Initialise une nouvelle instance du`LineString` classe. |
| [LineString](linestring/#constructor_2)(IEnumerable&lt;IPoint&gt;) | Initialise une nouvelle instance du`LineString` classe. |
| [LineString](linestring/#constructor_1)(ILineString) | Initialise une nouvelle instance du`LineString` classe. |
...
| [Count](../../aspose.gis.geometries/linestring/count/) { get; } | Obtient le nombre de points dans le`LineString` . |
...
| override [GeometryType](../../aspose.gis.geometries/linestring/geometrytype/) { get; } | Obtient le type de la géométrie. |
...
| Nom | La description |
| --- | --- |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint/#addpoint)(IPoint) | Ajoute un point à la fin de la ligne. |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint/#addpoint_1)(double, double) | Ajoute un point à la fin de la ligne. |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint/#addpoint_2)(double, double, double) | Ajoute un point à la fin de la ligne. |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint/#addpoint_3)(double, double, double, double) | Ajoute un point à la fin de la ligne. |
...
| override [Clone](../../aspose.gis.geometries/linestring/clone/)() | Clone cette instance. |
...
| [Equals](../../aspose.gis.geometries/linestring/equals/#equals)(ILineString) | Indique si l'objet courant est égal à un autre objet du même type. |
| override [Equals](../../aspose.gis.geometries/linestring/equals/#equals_1)(object) | Détermine si l'objet spécifié est égal à l'objet actuel. |
...
| override [Reverse](../../aspose.gis.geometries/linestring/reverse/)() | Inverse l'ordre des points dans ce`LineString` . |
...
| [ToEditable](../../aspose.gis.geometries/linestring/toeditable/#toeditable_2)() | Obtient une copie modifiable de cette géométrie. (3 methods) |
...
| [operator ==](../../aspose.gis.geometries/linestring/op_equality/) | Implémente l'opérateur ==. |
| [operator !=](../../aspose.gis.geometries/linestring/op_inequality/) | Implémente l'opérateur !=. |
