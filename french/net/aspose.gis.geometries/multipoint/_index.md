...
description: Aspose.Gis.Geometries.MultiPoint classe. AMultiPoint est unidimensionnelGeometryCollection dont les éléments sontPoint s.
type: docs
weight: 1160
...
A`MultiPoint` est unidimensionnel[`GeometryCollection`](../geometrycollection/) dont les éléments sont[`Point`](../point/) s.
...
| Nom | La description |
| --- | --- |
| [MultiPoint](multipoint/)() | Initialise une nouvelle instance du`MultiPoint` classe. |
