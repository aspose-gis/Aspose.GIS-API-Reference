...
description: AMultiPolygon./multipolygon est un unidimensionnelGeometryCollection./geometrycollection dont les éléments sontPolygon./polygon s.
type: docs
weight: 1070
...
A[`MultiPolygon`](../multipolygon) est un unidimensionnel[`GeometryCollection`](../geometrycollection) dont les éléments sont[`Polygon`](../polygon) s.
...
| Nom | La description |
| --- | --- |
| [MultiPolygon](multipolygon)() | Initialise une nouvelle instance du[`MultiPolygon`](../multipolygon) classe. |
