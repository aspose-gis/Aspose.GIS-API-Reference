...
description: Aspose.Gis.Geometries.Polygon classe. APolygon est une surface plane définie par 1 limite extérieure et 0 ou plusieurs limites intérieures.
type: docs
weight: 1200
...
A`Polygon` est une surface plane, définie par 1 limite extérieure et 0 ou plusieurs limites intérieures.
...
| Nom | La description |
| --- | --- |
| [Polygon](polygon/#constructor)() | Initialise une nouvelle instance du`Polygon` classe. |
| [Polygon](polygon/#constructor_1)(ILinearRing) | Initialise une nouvelle instance du`Polygon` classe. |
| [Polygon](polygon/#constructor_2)(ILinearRing, IEnumerable&lt;ILinearRing&gt;) | Initialise une nouvelle instance du`Polygon` classe. |
