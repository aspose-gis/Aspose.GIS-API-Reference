...
description: Aspose.Gis.Geometries.MultiSurface classe. AMultiSurface est unidimensionnelGeometryCollection dont les éléments sontISurface s.
type: docs
weight: 1180
...
A`MultiSurface` est unidimensionnel[`GeometryCollection`](../geometrycollection/) dont les éléments sont[`ISurface`](../isurface/) s.
...
| Nom | La description |
| --- | --- |
| [MultiSurface](multisurface/)() | Initialise une nouvelle instance du`MultiSurface` classe. |
