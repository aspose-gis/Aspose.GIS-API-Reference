...
description: Aspose.Gis.Geometries.MultiLineString classe. AMultiLineString est unidimensionnelGeometryCollection dont les éléments sontLineString s.
type: docs
weight: 1150
url: /fr/net/aspose.gis.geometries/multilinestring/
---
## MultiLineString class

A`MultiLineString` est unidimensionnel[`GeometryCollection`](../geometrycollection/) dont les éléments sont[`LineString`](../linestring/) s.
...
| Nom | La description |
| --- | --- |
| [MultiLineString](multilinestring/)() | Initialise une nouvelle instance du`MultiLineString` classe. |
...
| override [GeometryType](../../aspose.gis.geometries/multilinestring/geometrytype/) { get; } | Obtient le type de la géométrie. |
...
| override [Clone](../../aspose.gis.geometries/multilinestring/clone/)() | Clone cette instance. |
...
| [ToEditable](../../aspose.gis.geometries/multilinestring/toeditable/#toeditable_3)() | Obtient une copie modifiable de cette géométrie. (4 methods) |
| [ToEditable&lt;T&gt;](../../aspose.gis.geometries/geometry/toeditable/)() | Obtient une copie modifiable de cette géométrie. |
| [ToLinearGeometry](../../aspose.gis.geometries/multicurve/tolineargeometry/)() | Obtient une version non courbe approximative ou équivalente de cette géométrie en utilisant la valeur par défaut`tolérance` . (3 methods) |
| [ToLinearGeometry](../../aspose.gis.geometries/multicurve/tolineargeometry/)(double) | Obtient une version non courbe approximative ou équivalente de cette géométrie en utilisant la valeur spécifiée`tolérance` . (3 methods) |
