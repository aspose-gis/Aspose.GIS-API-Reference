...
description: AIGeometryCollection./igeometrycollection est unIGeometry./igeometry qui est une collection dune ou plusieurs géométries.
type: docs
weight: 910
...
A[`IGeometryCollection`](../igeometrycollection) est un[`IGeometry`](../igeometry) qui est une collection d'une ou plusieurs géométries.
