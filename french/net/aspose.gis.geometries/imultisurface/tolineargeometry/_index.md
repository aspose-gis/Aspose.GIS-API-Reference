...
description: IMultiSurface méthode. Obtient une version non courbe approximative ou équivalente de cette géométrie en utilisant la valeur par défauttolérance .
type: docs
weight: 20
...
A[`IMultiPolygon`](../../imultipolygon/) qui se rapproche ou équivaut à ceci[`IMultiSurface`](../) :  Si cet objet est[`IMultiPolygon`](../../imultipolygon/) lui-même le résultat est équivalent à cet objet Si cet objet n'est pas[`IMultiPolygon`](../../imultipolygon/) - toutes les surfaces sont linéarisées et neuves`IMultiPolygone` est créé
