...
description: Aspose.Gis.Formats.Shapefile.ShapefileOptions classe. Options spécifiques au pilote pour le format Shapefile. Pour le moment le pilote ne fournit aucune option personnalisable.
type: docs
weight: 670
url: /fr/net/aspose.gis.formats.shapefile/shapefileoptions/
---
## ShapefileOptions class

Options spécifiques au pilote pour le format Shapefile. Pour le moment, le pilote ne fournit aucune option personnalisable.
...
| Nom | La description |
| --- | --- |
| [ShapefileOptions](shapefileoptions/)() | Créer une nouvelle instance. |
