...
description: Détermine si Aspose.GIS est autorisé à charger le schéma XML à partir dInternet. Si défini surfalse  les schémas avec des URI absolus qui ne commencent pas par file// ne seraient pas chargés. La valeur par défaut estfalse .
type: docs
weight: 20
