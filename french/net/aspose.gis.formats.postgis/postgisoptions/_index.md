...
description: Aspose.Gis.Formats.PostGis.PostGisOptions classe. Options spécifiques au pilote pour le format PostGis. Pour le moment le pilote ne fournit aucune option personnalisable.
type: docs
weight: 650
url: /fr/net/aspose.gis.formats.postgis/postgisoptions/
---
## PostGisOptions class

Options spécifiques au pilote pour le format PostGis. Pour le moment, le pilote ne fournit aucune option personnalisable.
...
| Nom | La description |
| --- | --- |
| [PostGisOptions](postgisoptions/)() | Créer une nouvelle instance. |
