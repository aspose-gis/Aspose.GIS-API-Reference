...
description: Le système de référence spatiale cartographie les coordonnées des lieux sur Terre. Il existe différents types de SRS voirType./spatialreferencesystem/type . De plus si le type de SRS estGeographic ou Projected SRS peut être composé ou simple voirIsCompound./spatialreferencesystem/iscompound .
type: docs
weight: 2150
