...
description: Aspose.Gis.SpatialReferencing.GeographicSpatialReferenceSystem classe. Un SRS géographique est un SRS basé sur la longitude et la latitude. Un SRS géographique peut être bidimensionnel ou tridimensionnel. Si le SRS géographique est tridimensionnel il sagit en fait dun SRS composé de SRS bidimensionnel et de SRS vertical.
type: docs
weight: 2130
