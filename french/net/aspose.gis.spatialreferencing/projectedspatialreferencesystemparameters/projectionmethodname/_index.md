...
description: Nom de la méthode de projection. Il ny a pas de valeur par défaut et vous DEVEZ définir ce paramètre sur nonnull valeur puisque le SRS projeté sans nom de projection est inutile.
type: docs
weight: 70
