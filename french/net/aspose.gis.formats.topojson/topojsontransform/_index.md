...
description: Un objet de transformation qui peut être utilisé pour quantifier les coordonnées lors de lécriture dun fichier TopoJSON.
type: docs
weight: 650
...
| Nom | La description |
| --- | --- |
| [TopoJsonTransform](topojsontransform)(double, double, double, double) | Créer une nouvelle instance de[`TopoJsonTransform`](../topojsontransform) . |
