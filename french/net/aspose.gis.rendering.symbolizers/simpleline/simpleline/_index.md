...
type: docs
weight: 10
url: /fr/net/aspose.gis.rendering.symbolizers/simpleline/simpleline/
---
...
Initialise une nouvelle instance du[`SimpleLine`](../../simpleline) classe.
...
| --- | --- | --- |
| other | SimpleLine | L'autre[`SimpleLine`](../../simpleline) à partir duquel copier des données. |
