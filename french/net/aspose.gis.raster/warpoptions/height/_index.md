...
description: Spécifie la hauteur du raster en sortie en pixels et en colonnes. Si la valeur est définie sur 0 la hauteur est automatiquement calculée. La valeur par défaut est 0.
type: docs
weight: 50
