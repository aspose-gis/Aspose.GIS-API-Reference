...
description: Convertit la colonne et la ligne spécifiées en coordonnées spatiales.
type: docs
weight: 150
...
Si l'un des paramètres est passé hors de la plage de la dimension respective du raster, il renverra des coordonnées en dehors du raster en supposant que la grille du raster est applicable en dehors des limites du raster.
