...
description: Aspose.Gis.Formats.SqlServer.SqlServerOptions classe. Options spécifiques au pilote pour le format SqlServer. Pour le moment le pilote ne fournit aucune option personnalisable.
type: docs
weight: 690
url: /fr/net/aspose.gis.formats.sqlserver/sqlserveroptions/
---
## SqlServerOptions class

Options spécifiques au pilote pour le format SqlServer. Pour le moment, le pilote ne fournit aucune option personnalisable.
...
| Nom | La description |
| --- | --- |
| [SqlServerOptions](sqlserveroptions/)() | Créer une nouvelle instance. |
