...
description: Détermine si les objets GeoJSON doivent inclure des informations sur la plage de coordonnées pour ses géométries. Si défini surtrue  un membre bbox est généré pour chaque géométrie non nul lorsquil est ajouté à la couche. La valeur par défaut estfalse .
type: docs
weight: 40
