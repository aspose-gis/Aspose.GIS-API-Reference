...
description: Aspose.Gis.Formats.EsriJson.EsriJsonOptions classe. Options spécifiques au pilote pour le format EsriJson.
type: docs
weight: 240
url: /fr/net/aspose.gis.formats.esrijson/esrijsonoptions/
---
## EsriJsonOptions class

Options spécifiques au pilote pour le format EsriJson.
...
| Nom | La description |
| --- | --- |
| [EsriJsonOptions](esrijsonoptions/)() | Créer une nouvelle instance. |
...
| [NestedPropertiesSeparator](../../aspose.gis.formats.esrijson/esrijsonoptions/nestedpropertiesseparator/) { get; set; } | Obtient ou définit une chaîne utilisée pour séparer les composants des attributs imbriqués. La valeur par défaut est "_". |
