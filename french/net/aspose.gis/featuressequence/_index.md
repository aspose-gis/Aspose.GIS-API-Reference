...
description: FeaturesSequence./featuressequence représente un ensemble dentités vectorielles.
type: docs
weight: 160
...
[`FeaturesSequence`](../featuressequence) représente un ensemble d'entités vectorielles.
