...
description: Un convertisseur personnalisé pour les attributs. Cela nous permet de renommer ou dexclure les attributs de destination. Sinonnull  il est appelé pour chaque attribut de la couche source et est censé le modifier si nécessaire.
type: docs
weight: 20
