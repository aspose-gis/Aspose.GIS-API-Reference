...
description: Une entité géographique composée dune géométrie et dattributs définis par lutilisateur.
type: docs
weight: 120
...
| Nom | La description |
| --- | --- |
| [Geometry](../../aspose.gis/feature/geometry) { get; set; } | Obtient ou définit la géométrie de l'entité. Ne peut pas être`null` , utilisation[`Null`](../../aspose.gis.geometries/geometry/null) pour indiquer la géométrie manquante. |
