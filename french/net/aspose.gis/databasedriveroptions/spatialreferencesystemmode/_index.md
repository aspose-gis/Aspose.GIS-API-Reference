...
description: Détermine comment les SRS des géométries inconnues pour la base de données doivent être gérées lorsquelles sont ajoutées à la couche. La valeur par défaut estThrowException .
type: docs
weight: 10
