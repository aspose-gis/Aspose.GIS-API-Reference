...
description: Détermine si cette étendue contient une coordonnée définie par les arguments.
type: docs
weight: 120
...
Coordonnées situées aux limites de ce[`Extent`](../../extent) sont considérés comme contenus par ceci[`Extent`](../../extent) .
...
Coordonnées situées aux limites de ce[`Extent`](../../extent) sont considérés comme contenus par ceci[`Extent`](../../extent) . Pour cette raison, des étendues égales sont considérées pour se contenir.
