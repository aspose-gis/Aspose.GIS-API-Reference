...
type: docs
weight: 130
url: /fr/python-net/aspose.gis.spatialreferencing/localspatialreferencesystem/
---
...
| as_local | [LocalSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/localspatialreferencesystem) | r | Renvoie ceci. |
| as_projected | [ProjectedSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem) | r | Renvoie ce SRS converti en [ProjectedSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/).<br/>            Utilisez [SpatialReferenceSystem.type](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem/) pour savoir si la conversion est possible. |
...
| dimensions_count | int | r | Nombre de dimensions dans ce SRS. |
...
| geographic_datum | [GeographicDatum](/psd/python-net/aspose.gis.spatialreferencing/geographicdatum) | r | Lance InvalidOperationException, car le SRS local n'a pas de datum géographique. |
| has_geographic_datum | bool | r | Renvoie <see langword="false" />, car le SRS local n'a pas de datum géographique. |
| has_prime_meridian | bool | r | Renvoie <see langword="false" />, car le SRS local n'a pas de méridien principal. |
...
| local_datum | [LocalDatum](/psd/python-net/aspose.gis.spatialreferencing/localdatum) | r | Datum qui décrit la méthode de mesures. |
...
| prime_meridian | [PrimeMeridian](/psd/python-net/aspose.gis.spatialreferencing/primemeridian) | r | Lance InvalidOperationException, car le SRS local n'a pas de méridien principal. |
| type | [SpatialReferenceSystemType](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype) | r | Renvoie [SpatialReferenceSystemType.LOCAL](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/). |
| unit | [Unit](/psd/python-net/aspose.gis.spatialreferencing/unit) | r | Unité de ce SRS. |
...
| [get_unit(dimension)](#get_unit_dimension_12) | Obtenir [LocalSpatialReferenceSystem.unit](/psd/python-net/aspose.gis.spatialreferencing/localspatialreferencesystem/) de dimension. |
...
Obtenir [LocalSpatialReferenceSystem.unit](/psd/python-net/aspose.gis.spatialreferencing/localspatialreferencesystem/) de dimension.
