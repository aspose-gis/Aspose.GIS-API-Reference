...
type: docs
weight: 50
url: /fr/python-net/aspose.gis.spatialreferencing/geocentricspatialreferencesystem/
---
...
| as_geocentric | [GeocentricSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/geocentricspatialreferencesystem) | r | Renvoie ceci. |
...
| axises_order | [GeocentricAxisesOrder](/psd/python-net/aspose.gis.spatialreferencing/geocentricaxisesorder) | r | Ordre des axes dans ce SRS.<br/>            Si ce SRS n'est pas valide et possède des directions d'axes incorrectes, [GeocentricAxisesOrder.INVALID](/psd/python-net/aspose.gis.spatialreferencing/geocentricaxisesorder/) est renvoyé. |
| dimensions_count | int | r | Renvoie 3, car le SRS géocentrique est toujours tridimensionnel. |
...
| has_geographic_datum | bool | r | Renvoie <see langword=\"true\" />, car le SRS géocentrique possède toujours un datum géographique. |
| has_prime_meridian | bool | r | Renvoie <see langword=\"true\" />, car le SRS géocentrique possède toujours le méridien principal. |
...
| linear_unit | [Unit](/psd/python-net/aspose.gis.spatialreferencing/unit) | r | Unité, utilisée dans ce SRS. |
...
| type | [SpatialReferenceSystemType](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype) | r | Renvoie [SpatialReferenceSystemType.GEOCENTRIC](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/). |
