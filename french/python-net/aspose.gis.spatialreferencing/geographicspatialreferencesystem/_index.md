...
type: docs
weight: 80
url: /fr/python-net/aspose.gis.spatialreferencing/geographicspatialreferencesystem/
---
...
| :- | :- | :- | :- |
| angular_unit | [Unit](/psd/python-net/aspose.gis.spatialreferencing/unit) | r | Unité, utilisée pour les dimensions angulaires, dans ce SRS. |
...
| as_geographic | [GeographicSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/geographicspatialreferencesystem) | r | Renvoie cet objet. |
...
| axises_order | [GeographicAxisesOrder](/psd/python-net/aspose.gis.spatialreferencing/geographicaxisesorder) | r | Ordre des axes dans ce SRS.<br/>            Si ce SRS n'est pas valide et possède des directions d'axes incorrectes, [GeographicAxisesOrder.INVALID](/psd/python-net/aspose.gis.spatialreferencing/geographicaxisesorder/) est renvoyé. |
| dimensions_count | int | r | Renvoie le nombre de dimensions dans ce SRS. Pour un SRS géographique, cela peut être :<br/>            deux - si c'est un SRS géographique simple.<br/>            trois - si c'est un SRS composé, qui consiste en un SRS géographique simple, bidimensionnel, et un SRS vertical, qui ajoute une troisième dimension. |
...
| has_geographic_datum | bool | r | Renvoie <see langword=\"true\" />, car le SRS géographique possède toujours le méridien principal. |
| has_prime_meridian | bool | r | Renvoie <see langword=\"true\" />, car le SRS géographique possède toujours le méridien principal. |
...
| type | [SpatialReferenceSystemType](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype) | r | Renvoie [SpatialReferenceSystemType.GEOGRAPHIC](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/). |
