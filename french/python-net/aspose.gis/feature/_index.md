...
type: docs
weight: 830
url: /fr/python-net/aspose.gis/feature/
---
...
| [get_value(attribute_name)](#get_value_attribute_name_2) | Obtient la valeur d'un attribut. |
| [get_value_or_default(attribute_name, default_value)](#get_value_or_default_attribute_name_default_value_3) | Obtient la valeur d'un attribut, ou [FeatureAttribute.default_value](/psd/python-net/aspose.gis/featureattribute/) si la valeur n'est pas définie ou <c>null</c>. |
| [get_values(values, default_value)](#get_values_values_default_value_4) | Renvoie les valeurs de tous les attributs dans un tableau. |
| [get_values(values_count, default_value)](#get_values_values_count_default_value_5) | Renvoie les valeurs de tous les attributs dans un tableau. |
| [get_values_dump(default_value)](#get_values_dump_default_value_6) | Renvoie les valeurs de tous les attributs dans un tableau.<br/>            Envisagez d'utiliser la méthode Aspose.Gis.Feature.GetValues(int,System.Object) pour éviter une allocation mémoire supplémentaire. |
| [get_values_list(attribute_name, separator, count)](#get_values_list_attribute_name_separator_count_7) | Obtient la liste des valeurs. Analogue non générique de List T GetValuesList |
| [is_value_null(attribute_name)](#is_value_null_attribute_name_8) | Détermine si l'attribut spécifié a été explicitement défini sur la valeur <c>null</c>. |
| [is_value_set(attribute_name)](#is_value_set_attribute_name_9) | Vérifie si la valeur de l'attribut est définie dans cette fonctionnalité. |
| [set_value(attribute_name, value)](#set_value_attribute_name_value_10) | Définit la valeur. Analogue non générique de void SetValue (string attributeName, T value) |
| [set_value_null(attribute_name)](#set_value_null_attribute_name_11) | Définit la valeur de l'attribut sur <c>null</c>. |
| [set_values(values)](#set_values_values_12) | Définit de nouvelles valeurs pour tous les attributs.<br/>            Envisagez également d'utiliser la méthode [Feature.copy_values(input_feature)](/psd/python-net/aspose.gis/feature/) pour simplifier la définition des valeurs en un seul appel. |
| [unset_value(attribute_name)](#unset_value_attribute_name_13) | Supprime la valeur de l'attribut de cette fonctionnalité. |
...
Renvoie les valeurs de tous les attributs dans un tableau.<br/>            Envisagez d'utiliser la méthode Aspose.Gis.Feature.GetValues(int,System.Object) pour éviter une allocation mémoire supplémentaire.
...
Obtient la liste des valeurs. Analogue non générique de List T GetValuesList
...
Définit la valeur. Analogue non générique de void SetValue (string attributeName, T value)
...
Définit de nouvelles valeurs pour tous les attributs.<br/>            Envisagez également d'utiliser la méthode [Feature.copy_values(input_feature)](/psd/python-net/aspose.gis/feature/) pour simplifier la définition des valeurs en un seul appel.
