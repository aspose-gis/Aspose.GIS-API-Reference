---
title: "Classe MultiStreamPath"
type: docs
weight: 2760
url: /fr/python-net/aspose.gis/multistreampath/
---
...
| **Name** | **Description** |
| :- | :- |
| [MultiStreamPath(entry_file_name, file_names, streams)](#MultiStreamPath_entry_file_name_file_names_streams_1) | Initialise une nouvelle instance de la classe [MultiStreamPath](/psd/python-net/aspose.gis/multistreampath/). |
## **Properties**
| **Name** | **Type** | **Access** | **Description** |
| :- | :- | :- | :- |
| emplacement | string | r | Obtient une représentation sous forme de chaîne de l'emplacement de ce <c>AbstractPath</c>. |
| separator | char | r | Obtient le caractère séparateur utilisé pour séparer les niveaux de répertoires de la chaîne [MultiStreamPath.location](/psd/python-net/aspose.gis/multistreampath/). |
## **Methods**
| **Name** | **Description** |
| :- | :- |
...
| [open(access)](#open_access_9) | Abstrait un ensemble de formats multi‑fichiers en streaming, offrant un chemin pour accéder aux données. |
...
Initialise une nouvelle instance de la classe [MultiStreamPath](/psd/python-net/aspose.gis/multistreampath/).

**Parameters:**

| Paramètre | Type | Description |
| :- | :- | :- |
| entry_file_name | string | Nom du fichier d'entrée. |
| file_names | string | Les noms de fichiers. |
| streams | _io.BufferedRandom[] | Les flux. |
...
Abstrait un ensemble de formats multi‑fichiers en streaming, offrant un chemin pour accéder aux données.
...
| Type | Description |
| :- | :- |
| _io.BufferedRandom | Cela peut être soit un   ou le flux initialement passé par le client. |
