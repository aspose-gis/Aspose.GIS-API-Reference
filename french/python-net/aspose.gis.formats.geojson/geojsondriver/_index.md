...
type: docs
weight: 10
url: /fr/python-net/aspose.gis.formats.geojson/geojsondriver/
---
...
| :- | :- | :- |
| path | string | Chemin vers le fichier. |
| options | [GeoJsonOptions](/psd/python-net/aspose.gis.formats.geojson/geojsonoptions) | Options spécifiques au pilote. |
