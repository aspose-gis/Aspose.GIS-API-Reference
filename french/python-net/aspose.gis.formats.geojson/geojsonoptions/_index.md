...
type: docs
weight: 20
url: /fr/python-net/aspose.gis.formats.geojson/geojsonoptions/
---
...
| **Name** | **Description** |
| :- | :- |
| [GeoJsonOptions()](#GeoJsonOptions__1) | Créer une nouvelle instance. |
## **Properties**
| **Name** | **Type** | **Access** | **Description** |
| :- | :- | :- | :- |
| array_as_string | bool | r/w | Indique s'il faut exposer les tableaux JSon de chaînes, d'entiers ou de réels sous forme de chaîne. |
| attributes_skip | bool | r/w | contrôle la traduction des attributs : oui - ignorer tous les attributs |
| auto_id | [AutoIds](/psd/python-net/aspose.gis/autoids) | r/w | Générer automatiquement les ids |
...
| date_as_string | bool | r/w | Indique s'il faut exposer les dates/horaires/date-heure JSon sous forme de chaîne. |
...
| description | string | r/w | Description au niveau de la collection d'entités (pour la création de couche) |
| geometry_as_collection | bool | r/w | contrôle la traduction des géométries : oui - envelopper les géométries avec le type GeometryCollection |
...
| nom | string | r/w | Nom au niveau de la collection d'entités (pour la création de couche) |
...
| read_bounding_boxes | bool | r/w | Détermine si les boîtes englobantes ('bbox') doivent être lues comme des attributs avec un nom 'bbox_0', 'bbox_1', etc.<br/>            La valeur par défaut est <see langword="false" />.<br/>            La chaîne [GeoJsonOptions.nested_properties_separator](/psd/python-net/aspose.gis.formats.geojson/geojsonoptions/) est utilisée dans les noms bbox_0, bbox_1,.. |
...
| write_bounding_boxes | bool | r/w | Détermine si les objets GeoJSON doivent inclure des informations sur la plage de coordonnées de leurs Géométries.<br/>            Si défini sur <see langword="true" />, un membre "bbox" est généré pour chaque géométrie (non nulle) lorsqu'elle est ajoutée à la couche.<br/>            La valeur par défaut est <see langword="false" />. |
...
| write_unset_attribute | bool | r/w | Indique s'il faut écrire les attributs non définis en ajoutant la valeur 'null' |
