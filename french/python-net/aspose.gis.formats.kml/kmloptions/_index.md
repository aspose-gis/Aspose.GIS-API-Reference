---
title: "Classe KmlOptions"
type: docs
weight: 190
url: /fr/python-net/aspose.gis.formats.kml/kmloptions/
---
...
| **Name** | **Description** |
| :- | :- |
| [KmlOptions()](#KmlOptions__1) | Créer une nouvelle instance. |
## **Properties**
| **Name** | **Type** | **Access** | **Description** |
| :- | :- | :- | :- |
| altitude_mode | [AltitudeModes](/psd/python-net/aspose.gis.formats.kml/altitudemodes) | r/w | Vous permet de spécifier les AltitudeModes à utiliser pour les géométries KML |
...
| document_id | string | r/w | Utilisé pour spécifier l'identifiant du nœud racine 'Document' |
...
| symbol_to_replace_invalid_chars | char | r/w | Détermine quel symbole sera utilisé pour remplacer les caractères invalides lors de la lecture.<br/>            Le remplacement est ignoré si la valeur est '\0'. Par défaut, la valeur est le caractère '\0'. |
