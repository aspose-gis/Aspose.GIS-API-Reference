...
type: docs
weight: 50
url: /fr/python-net/aspose.gis.formats.kml/kmldriver/
---
...
| [open_as_kml_layer(path, options)](#open_as_kml_layer_path_options_18) | Ouvre une couche Kml en lecture. |
...
| [open_layer(path)](#open_layer_path_24) | Ouvre la couche en lecture. |
...
| [supports_spatial_reference_system(spatial_reference_system)](#supports_spatial_reference_system_spatial_reference_system_29) | Détermine si le système de référence spatiale spécifié est pris en charge par le pilote. |
...
| :- | :- | :- |
| path | string | Chemin vers le fichier. |
| options | [KmlOptions](/psd/python-net/aspose.gis.formats.kml/kmloptions) | Options spécifiques au pilote. |
...
Ouvre une couche Kml en lecture.
...
| Type | Description |
| :- | :- |
| [KmlLayer](/psd/python-net/aspose.gis.formats.kml/kmllayer) | KmlLayer avec des champs spécifiques |
