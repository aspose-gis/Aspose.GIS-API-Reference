---
title: "Classe Polygon"
type: docs
weight: 310
url: /fr/python-net/aspose.gis.geometries/polygon/
---
...
| **Name** | **Description** |
| :- | :- |
| [Polygon()](#Polygon__1) | Initialise une nouvelle instance de la classe [Polygon](/psd/python-net/aspose.gis.geometries/polygon/). |
| [Polygon(exterior_ring)](#Polygon_exterior_ring_2) | Initialise une nouvelle instance de la classe [Polygon](/psd/python-net/aspose.gis.geometries/polygon/). |
| [Polygon(exterior_ring, interior_rings)](#Polygon_exterior_ring_interior_rings_3) | Initialise une nouvelle instance de la classe [Polygon](/psd/python-net/aspose.gis.geometries/polygon/). |
## **Properties**
...
| exterior_ring | [ILinearRing](/psd/python-net/aspose.gis.geometries/ilinearring) | r/w | Obtient l'anneau extérieur. |
...
| [get_point_on_surface()](#get_point_on_surface__28) | Trouve un point qui est garanti d'être sur ce polygone. |
...
Initialise une nouvelle instance de la classe [Polygon](/psd/python-net/aspose.gis.geometries/polygon/).
...
| :- | :- | :- |
| exterior_ring | [ILinearRing](/psd/python-net/aspose.gis.geometries/ilinearring) | L'anneau extérieur. |
...
| :- | :- | :- |
| exterior_ring | [ILinearRing](/psd/python-net/aspose.gis.geometries/ilinearring) | L'anneau extérieur. |
| anneaux_internes | System.Collections.Generic.IEnumerable<ILinearRing> | Les anneaux intérieurs. |
...
| Paramètre | Type | Description |
| :- | :- | :- |
| ring | [ILinearRing](/psd/python-net/aspose.gis.geometries/ilinearring) | L'anneau à ajouter. |
...
| Type | Description |
| :- | :- |
| [ILinearRing](/psd/python-net/aspose.gis.geometries/ilinearring) | L'anneau intérieur. |
...
Trouve un point qui est garanti d'être sur ce polygone.

**Returns**

| Type | Description |
| :- | :- |
| [IPoint](/psd/python-net/aspose.gis.geometries/ipoint) | Un point sur ce polygone. Un point vide si ce polygone n'a pas d'intérieur. |
...
| Type | Description |
| :- | :- |
| [Polygon](/psd/python-net/aspose.gis.geometries/polygon) | Une copie modifiable de cette géométrie. |
