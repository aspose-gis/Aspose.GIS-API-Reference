---
title: "Classe LinearRing"
type: docs
weight: 240
url: /fr/python-net/aspose.gis.geometries/linearring/
---
...
| **Name** | **Description** |
| :- | :- |
| [LinearRing()](#LinearRing__1) | Initialise une nouvelle instance de la classe [LinearRing](/psd/python-net/aspose.gis.geometries/linearring/). |
| [LinearRing(collection)](#LinearRing_collection_2) | Initialise une nouvelle instance de la classe [LinearRing](/psd/python-net/aspose.gis.geometries/linearring/). |
| [LinearRing(other)](#LinearRing_other_3) | Initialise une nouvelle instance de la classe [LinearRing](/psd/python-net/aspose.gis.geometries/linearring/). |
## **Properties**
...
| **Name** | **Description** |
| :- | :- |
| [add_point(point)](#add_point_point_1) | Ajoute un point à la fin de la ligne. |
| [add_point(x, y)](#add_point_x_y_2) | Ajoute un point à la fin de la ligne. |
| [add_point(x, y, z)](#add_point_x_y_z_3) | Ajoute un point à la fin de la ligne. |
| [add_point(x, y, z, m)](#add_point_x_y_z_m_4) | Ajoute un point à la fin de la ligne. |
...
| [is_clockwise()](#is_clockwise__33) | Détermine si l'anneau a un enroulement horaire. |
| [overlaps(other)](#overlaps_other_34) | Détermine si cette géométrie se chevauche avec une géométrie spécifiée. |
| [relate(other, intersection_pattern_matrix)](#relate_other_intersection_pattern_matrix_35) | Détermine si la matrice d'intersection DE-9IM de cette géométrie et d'une géométrie spécifiée correspond au modèle fourni. |
| [replace_polygons_by_lines()](#replace_polygons_by_lines__36) | Obtient les polygones représentés comme lignes de cette géométrie. |
| reverse() | Inverse l'ordre des points dans ce [LineString](/psd/python-net/aspose.gis.geometries/linestring/). |
| [round_m(digits)](#round_m_digits_37) | Arrondit la coordonnée M à un nombre spécifié de chiffres fractionnels. |
| [round_xy(digits)](#round_xy_digits_38) | Arrondit les coordonnées X et Y à un nombre spécifié de chiffres fractionnels. |
| [round_z(digits)](#round_z_digits_39) | Arrondit la coordonnée Z à un nombre spécifié de chiffres fractionnels. |
| set_empty() | Rend cette [Geometry](/psd/python-net/aspose.gis.geometries/geometry/) vide. |
| [spatially_contains(other)](#spatially_contains_other_40) | Détermine si cette géométrie contient spatialement une géométrie spécifiée. |
| [spatially_equals(other)](#spatially_equals_other_41) | Détermine si cette géométrie est spatialement égale à une géométrie spécifiée. |
| [sym_difference(other)](#sym_difference_other_42) | Construit une différence symétrique entre cette géométrie et une géométrie spécifiée. |
| [to_editable()](#to_editable__43) | Obtient une copie modifiable de cette géométrie. |
| [to_linear_geometry()](#to_linear_geometry__44) | Obtient une version approximative ou équivalente sans courbe de cette géométrie en utilisant la <c>tolerance</c> par défaut. |
| [to_linear_geometry(tolerance)](#to_linear_geometry_tolerance_45) | Obtient une version approximative ou équivalente sans courbe de cette géométrie en utilisant la <c>tolerance</c> spécifiée. |
| [to_svg(extent)](#to_svg_extent_46) | Traduit cette géométrie en représentation Svg. |
| [touches(other)](#touches_other_47) | Détermine si cette géométrie et une géométrie spécifiée se touchent. |
| [union(other)](#union_other_48) | Unit cette géométrie et une géométrie spécifiée. |
| [union(other)](#union_other_49) | Unit cette géométrie et une géométrie spécifiée. |
| [within(extent)](#within_extent_50) | Détermine si cette géométrie se trouve à l'intérieur d'une étendue spécifiée. |
| [within(other)](#within_other_51) | Détermine si cette géométrie se trouve à l'intérieur d'une géométrie spécifiée. |
...
Initialise une nouvelle instance de la classe [LinearRing](/psd/python-net/aspose.gis.geometries/linearring/).
...
| Paramètre | Type | Description |
| :- | :- | :- |
| other | [ILineString](/psd/python-net/aspose.gis.geometries/ilinestring) | L'autre ligne dont copier les données. |
