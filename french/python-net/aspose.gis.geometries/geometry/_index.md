---
title: "Classe Geometry"
type: docs
weight: 50
url: /fr/python-net/aspose.gis.geometries/geometry/
---
...
| dimension | [GeometryDimension](/psd/python-net/aspose.gis.geometries/geometrydimension) | r | Obtient la dimension topologique de ce [Geometry](/psd/python-net/aspose.gis.geometries/geometry/).<br/>            Si la dimension est inconnue (par ex. pour une GEOMETRYCOLLECTION vide) [GeometryDimension.POINT](/psd/python-net/aspose.gis.geometries/geometrydimension/) est retournée. |
...
| Type | Description |
| :- | :- |
| [Geometry](/psd/python-net/aspose.gis.geometries/geometry) | Une copie modifiable de cette géométrie. |
