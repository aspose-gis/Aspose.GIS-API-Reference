...
type: docs
weight: 290
url: /fr/python-net/aspose.gis.geometries/multisurface/
---
...
| **Name** | **Description** |
| :- | :- |
| [MultiSurface()](#MultiSurface__1) | Initialise une nouvelle instance de la classe [MultiSurface](/psd/python-net/aspose.gis.geometries/multisurface/). |
## **Properties**
...
Initialise une nouvelle instance de la classe [MultiSurface](/psd/python-net/aspose.gis.geometries/multisurface/).
...
| Type | Description |
| :- | :- |
| [MultiSurface](/psd/python-net/aspose.gis.geometries/multisurface) | Une copie modifiable de cette géométrie. |
...
| Type | Description |
| :- | :- |
| [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon) | Un [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon/) qui approxime ou équivaut à ce [IMultiSurface](/psd/python-net/aspose.gis.geometries/imultisurface/).<br/> C'est l'équivalent de <DOM Element: class at 0x2a1792e8790>.IMultiSurface.to_linear_geometry()(float) avec<br/> la <c>tolerance</c> par défaut. La valeur par défaut de la <c>tolerance</c> dépend de [SpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem/) de cette géométrie :<br/> <ul><br/> <li> Pour un SRS projeté, la tolérance est de 0,001 mètres (dans les unités du SRS) </li><br/> <li> Pour un SRS géographique, la tolérance est de <c>1e-5</c> degrés (dans les unités du SRS) </li><br/> <li> Pour un SRS inconnu, la tolérance est de <c>1e-5</c> </li><br/> </ul><br/> Pour plus de détails sur les transformations appliquées, consultez la spécification de <DOM Element: class at 0x2a1792e8790>.IMultiSurface.to_linear_geometry()(float). |
...
| Type | Description |
| :- | :- |
| [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon) | Un [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon/) qui approxime ou équivaut à ce [IMultiSurface](/psd/python-net/aspose.gis.geometries/imultisurface/) :<br/> <ul><br/> Si cet objet est lui‑même un [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon/), le résultat est équivalent à cet objet<br/> Si cet objet n'est pas un [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon/) - toutes les surfaces sont linéarisées et un nouveau <c>IMultiPolygon</c> est créé<br/> </ul> |
