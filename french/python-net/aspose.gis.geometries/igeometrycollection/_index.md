---
title: "Classe IGeometryCollection"
type: docs
weight: 120
url: /fr/python-net/aspose.gis.geometries/igeometrycollection/
---
...
| [get_point_on_surface()](#get_point_on_surface__22) | Trouve un point qui est garanti d'être sur l'une des surfaces de cette collection. |
| [intersection(other)](#intersection_other_23) | Construit une intersection entre cette géométrie et une géométrie spécifiée. |
| [intersects(extent)](#intersects_extent_24) | Détermine si cette géométrie intersecte une étendue spécifiée. |
| [intersects(other)](#intersects_other_25) | Détermine si cette géométrie et une géométrie spécifiée s'intersectent. |
...
| Type | Description |
| :- | :- |
| [GeometryCollection](/psd/python-net/aspose.gis.geometries/geometrycollection) | Une copie modifiable de cette géométrie. |
...
| Type | Description |
| :- | :- |
| [IGeometryCollection](/psd/python-net/aspose.gis.geometries/igeometrycollection) | Une géométrie qui ne possède aucune géométrie de courbe. C’est l’équivalent de <DOM Element: class at 0x2a1791cc040>.IGeometryCollection.to_linear_geometry()(float) avec<br/>            la <c>tolerance</c> par défaut. La valeur par défaut de la <c>tolerance</c> dépend du [SpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem/) de cette géométrie :<br/>            <ul><br/>            <li> Pour un SRS projeté, la tolérance est de 0,001 mètre (dans les unités du SRS) </li><br/>            <li> Pour un SRS géographique, la tolérance est de <c>1e-5</c> degré (dans les unités du SRS) </li><br/>            <li> Pour un SRS inconnu, la tolérance est de <c>1e-5</c> </li><br/>            </ul><br/>            Pour plus de détails sur les transformations appliquées, consultez la spécification de <DOM Element: class at 0x2a1791cc040>.IGeometryCollection.to_linear_geometry()(float). |
...
| Paramètre | Type | Description |
| :- | :- | :- |
| tolerance | double | La <c>tolerance</c> à utiliser. Le résultat est garanti d’être inférieur à <c>tolerance</c> de la<br/>            géométrie courbée, sauf si le nombre de points nécessaire pour linéariser la géométrie dépasse le maximum par quadrant,<br/>            actuellement égal à 10 000 points. |

**Returns**

| Type | Description |
| :- | :- |
| [IGeometryCollection](/psd/python-net/aspose.gis.geometries/igeometrycollection) | Une géométrie qui ne possède aucune géométrie de courbe. Les transformations suivantes sont appliquées :<br/>            <ul><br/>            <li> Les [GeometryType.CIRCULAR_STRING](/psd/python-net/aspose.gis.geometries/geometrytype/) sont linéarisés<br/> (transformés en [GeometryType.LINE_STRING](/psd/python-net/aspose.gis.geometries/geometrytype/) avec la <paramref name="tolerance" /> spécifiée) </li><br/>            <li> Les [GeometryType.COMPOUND_CURVE](/psd/python-net/aspose.gis.geometries/geometrytype/) sont joints en <c>LineString</c> </li><br/>            <li> Les [GeometryType.CURVE_POLYGON](/psd/python-net/aspose.gis.geometries/geometrytype/) sont transformés en [GeometryType.POLYGON](/psd/python-net/aspose.gis.geometries/geometrytype/) </li><br/>            <li> Les [GeometryType.MULTI_CURVE](/psd/python-net/aspose.gis.geometries/geometrytype/) sont transformés en [GeometryType.MULTI_CURVE](/psd/python-net/aspose.gis.geometries/geometrytype/) </li><br/>            <li> Les [GeometryType.MULTI_SURFACE](/psd/python-net/aspose.gis.geometries/geometrytype/) sont transformés en [GeometryType.MULTI_POLYGON](/psd/python-net/aspose.gis.geometries/geometrytype/) </li><br/>            </ul><br/>            En conséquence, [IGeometry.has_curve_geometry](/psd/python-net/aspose.gis.geometries/igeometry/) de la géométrie de sortie est <see langword="false" />. |
