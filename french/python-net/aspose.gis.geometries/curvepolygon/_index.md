---
title: "Classe CurvePolygon"
type: docs
weight: 40
url: /fr/python-net/aspose.gis.geometries/curvepolygon/
---
...
| **Name** | **Description** |
| :- | :- |
| [CurvePolygon()](#CurvePolygon__1) | Initialise une nouvelle instance de la classe [CurvePolygon](/psd/python-net/aspose.gis.geometries/curvepolygon/). |
| [CurvePolygon(exterior_ring)](#CurvePolygon_exterior_ring_2) | Initialise une nouvelle instance de la classe [CurvePolygon](/psd/python-net/aspose.gis.geometries/curvepolygon/). |
| [CurvePolygon(exterior_ring, interior_rings)](#CurvePolygon_exterior_ring_interior_rings_3) | Initialise une nouvelle instance de la classe [CurvePolygon](/psd/python-net/aspose.gis.geometries/curvepolygon/). |
## **Properties**
...
| exterior_ring | [ICurve](/psd/python-net/aspose.gis.geometries/icurve) | r/w | Obtient l'anneau extérieur. |
...
| interior_rings_count | int | r | Obtient le nombre d'anneaux intérieurs. |
...
| **Name** | **Description** |
| :- | :- |
| [add_interior_ring(ring)](#add_interior_ring_ring_1) | Ajoute un anneau intérieur. |
...
| [get_interior_ring(index)](#get_interior_ring_index_26) | Obtient l'anneau intérieur par son indice. |
| [get_length()](#get_length__27) | Calcule la longueur de cette géométrie. |
| [get_point_on_surface()](#get_point_on_surface__28) | Trouve un point qui est garanti d’être sur ce polygone courbé. |
...
| [replace_polygons_by_lines()](#replace_polygons_by_lines__34) | Obtient les polygones représentés comme lignes de cette géométrie. |
| [round_m(digits)](#round_m_digits_35) | Arrondit la coordonnée M à un nombre spécifié de chiffres fractionnels. |
| [round_xy(digits)](#round_xy_digits_36) | Arrondit les coordonnées X et Y à un nombre spécifié de chiffres fractionnels. |
| [round_z(digits)](#round_z_digits_37) | Arrondit la coordonnée Z à un nombre spécifié de chiffres fractionnels. |
| set_empty() | Rend cette [Geometry](/psd/python-net/aspose.gis.geometries/geometry/) vide. |
| [spatially_contains(other)](#spatially_contains_other_38) | Détermine si cette géométrie contient spatialement une géométrie spécifiée. |
| [spatially_equals(other)](#spatially_equals_other_39) | Détermine si cette géométrie est spatialement égale à une géométrie spécifiée. |
| [sym_difference(other)](#sym_difference_other_40) | Construit une différence symétrique entre cette géométrie et une géométrie spécifiée. |
| [to_editable()](#to_editable__41) | Obtient une copie modifiable de cette géométrie. |
| [to_linear_geometry()](#to_linear_geometry__42) | Obtient une version approximative ou équivalente sans courbe de cette géométrie en utilisant la <c>tolerance</c> par défaut. |
| [to_linear_geometry(tolerance)](#to_linear_geometry_tolerance_43) | Obtient une version approximative ou équivalente sans courbe de cette géométrie en utilisant la <c>tolerance</c> spécifiée. |
| [to_svg(extent)](#to_svg_extent_44) | Traduit cette géométrie en représentation Svg. |
| [touches(other)](#touches_other_45) | Détermine si cette géométrie et une géométrie spécifiée se touchent. |
| [union(other)](#union_other_46) | Unit cette géométrie et une géométrie spécifiée. |
| [union(other)](#union_other_47) | Unit cette géométrie et une géométrie spécifiée. |
| [within(extent)](#within_extent_48) | Détermine si cette géométrie se trouve à l'intérieur d'une étendue spécifiée. |
| [within(other)](#within_other_49) | Détermine si cette géométrie se trouve à l'intérieur d'une géométrie spécifiée. |
...
Initialise une nouvelle instance de la classe [CurvePolygon](/psd/python-net/aspose.gis.geometries/curvepolygon/).
...
| :- | :- | :- |
| exterior_ring | [ICurve](/psd/python-net/aspose.gis.geometries/icurve) | L'anneau extérieur. |
...
| :- | :- | :- |
| exterior_ring | [ICurve](/psd/python-net/aspose.gis.geometries/icurve) | L'anneau extérieur. |
| anneaux_internes | System.Collections.Generic.IEnumerable<ICurve> | Les anneaux intérieurs. |
...
| Paramètre | Type | Description |
| :- | :- | :- |
| ring | [ICurve](/psd/python-net/aspose.gis.geometries/icurve) | L'anneau à ajouter. |
...
Obtient l'anneau intérieur par son indice.
...
| Type | Description |
| :- | :- |
| [ICurve](/psd/python-net/aspose.gis.geometries/icurve) | L'anneau intérieur. |
...
Trouve un point qui est garanti d’être sur ce polygone courbé.

**Returns**

| Type | Description |
| :- | :- |
| [IPoint](/psd/python-net/aspose.gis.geometries/ipoint) | Un point sur ce polygone courbé. Un point vide si ce polygone courbé n’a pas d’intérieur. |
...
| Type | Description |
| :- | :- |
| [CurvePolygon](/psd/python-net/aspose.gis.geometries/curvepolygon) | Une copie modifiable de cette géométrie. |
...
| Type | Description |
| :- | :- |
| [IPolygon](/psd/python-net/aspose.gis.geometries/ipolygon) | Un [IPolygon](/psd/python-net/aspose.gis.geometries/ipolygon/) qui approxime ou équivaut à cet <c>ISurface</c>.<br/>            C’est l’équivalent de <DOM Element: class at 0x2a1793609d0>.ISurface.to_linear_geometry()(float) avec<br/>            la <c>tolerance</c> par défaut. La valeur par défaut de la <c>tolerance</c> dépend du [SpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem/)<br/>            de cette géométrie :<br/>            <ul><br/>            <li> Pour un SRS projeté, la tolérance est de 0,001 mètre (dans les unités du SRS) </li><br/>            <li> Pour un SRS géographique, la tolérance est de <c>1e-5</c> degré (dans les unités du SRS) </li><br/>            <li> Pour un SRS inconnu, la tolérance est de <c>1e-5</c> </li><br/>            </ul><br/>            Pour plus de détails sur les transformations appliquées, consultez la spécification de <DOM Element: class at 0x2a1793609d0>.ISurface.to_linear_geometry()(float). |
...
| Type | Description |
| :- | :- |
| [IPolygon](/psd/python-net/aspose.gis.geometries/ipolygon) | Un [IPolygon](/psd/python-net/aspose.gis.geometries/ipolygon/) qui approxime ou équivaut à cet <c>ISurface</c> :<br/>             <ul><br/>             Si cet objet est lui-même un [IPolygon](/psd/python-net/aspose.gis.geometries/ipolygon/), le résultat est équivalent à cet objet<br/>             Si cet objet n’est pas un [IPolygon](/psd/python-net/aspose.gis.geometries/ipolygon/), il est linéarisé et un [IPolygon](/psd/python-net/aspose.gis.geometries/ipolygon/) est créé<br/>            </ul> |
