...
type: docs
weight: 200
url: /fr/python-net/aspose.gis.geometries/ipoint/
---
...
| m | double | r | Obtient la coordonnée m. |
...
| x | double | r | Obtient la coordonnée x. |
| y | double | r | Obtient la coordonnée y. |
| z | double | r | Obtient la coordonnée z. |
## **Methods**
| **Name** | **Description** |
| :- | :- |
...
| [to_editable()](#to_editable__31) | Obtient une copie modifiable de cette géométrie. |
| [to_linear_geometry()](#to_linear_geometry__32) | Obtient une version approximative ou équivalente sans courbe de cette géométrie en utilisant la <c>tolerance</c> par défaut. |
| [to_linear_geometry(tolerance)](#to_linear_geometry_tolerance_33) | Obtient une version approximative ou équivalente sans courbe de cette géométrie en utilisant la <c>tolerance</c> spécifiée. |
| [touches(other)](#touches_other_34) | Détermine si cette géométrie et une géométrie spécifiée se touchent. |
...
| [within(extent)](#within_extent_37) | Détermine si cette géométrie se trouve à l'intérieur d'une étendue spécifiée. |
| [within(other)](#within_other_38) | Détermine si cette géométrie se trouve à l'intérieur d'une géométrie spécifiée. |
