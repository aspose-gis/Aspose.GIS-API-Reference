---
title: "Classe ICurvePolygon"
type: docs
weight: 100
url: /fr/python-net/aspose.gis.geometries/icurvepolygon/
---
...
| exterior_ring | [ICurve](/psd/python-net/aspose.gis.geometries/icurve) | r | Obtient l'anneau extérieur. |
...
| [get_interior_ring(index)](#get_interior_ring_index_21) | Obtient l'anneau intérieur par son indice. |
| [get_length()](#get_length__22) | Calcule la longueur de cette géométrie. |
| [get_point_on_surface()](#get_point_on_surface__23) | Trouve un point qui est garanti d'être sur cette surface. |
| [intersection(other)](#intersection_other_24) | Construit une intersection entre cette géométrie et une géométrie spécifiée. |
| [intersects(extent)](#intersects_extent_25) | Détermine si cette géométrie intersecte une étendue spécifiée. |
| [intersects(other)](#intersects_other_26) | Détermine si cette géométrie et une géométrie spécifiée s'intersectent. |
| [overlaps(other)](#overlaps_other_27) | Détermine si cette géométrie se chevauche avec une géométrie spécifiée. |
| [relate(other, intersection_pattern_matrix)](#relate_other_intersection_pattern_matrix_28) | Détermine si la matrice d'intersection DE-9IM de cette géométrie et d'une géométrie spécifiée correspond au modèle fourni. |
| [replace_polygons_by_lines()](#replace_polygons_by_lines__29) | Obtient les polygones représentés comme lignes de cette géométrie. |
| [spatially_contains(other)](#spatially_contains_other_30) | Détermine si cette géométrie contient spatialement une géométrie spécifiée. |
| [spatially_equals(other)](#spatially_equals_other_31) | Détermine si cette géométrie est spatialement égale à une géométrie spécifiée. |
| [sym_difference(other)](#sym_difference_other_32) | Construit une différence symétrique entre cette géométrie et une géométrie spécifiée. |
| [to_editable()](#to_editable__33) | Obtient une copie modifiable de cette géométrie. |
| [to_linear_geometry()](#to_linear_geometry__34) | Obtient une version approximative ou équivalente sans courbe de cette géométrie en utilisant la <c>tolerance</c> par défaut. |
| [to_linear_geometry(tolerance)](#to_linear_geometry_tolerance_35) | Obtient une version approximative ou équivalente sans courbe de cette géométrie en utilisant la <c>tolerance</c> spécifiée. |
| [touches(other)](#touches_other_36) | Détermine si cette géométrie et une géométrie spécifiée se touchent. |
| [union(other)](#union_other_37) | Unit cette géométrie et une géométrie spécifiée. |
| [union(other)](#union_other_38) | Unit cette géométrie et une géométrie spécifiée. |
| [within(extent)](#within_extent_39) | Détermine si cette géométrie se trouve à l'intérieur d'une étendue spécifiée. |
| [within(other)](#within_other_40) | Détermine si cette géométrie se trouve à l'intérieur d'une géométrie spécifiée. |
...
| Type | Description |
| :- | :- |
| [ICurve](/psd/python-net/aspose.gis.geometries/icurve) | La valeur de l'anneau intérieur |
...
Trouve un point qui est garanti d'être sur cette surface.

**Returns**

| Type | Description |
| :- | :- |
| [IPoint](/psd/python-net/aspose.gis.geometries/ipoint) | Un point sur cette surface. Un point vide si cette surface n'a pas d'intérieur. |
...
| Type | Description |
| :- | :- |
| [Surface](/psd/python-net/aspose.gis.geometries/surface) | Une copie modifiable de cette géométrie. |
