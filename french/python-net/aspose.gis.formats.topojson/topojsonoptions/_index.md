---
title: "Classe TopoJsonOptions"
type: docs
weight: 20
url: /fr/python-net/aspose.gis.formats.topojson/topojsonoptions/
---
...
| **Name** | **Description** |
| :- | :- |
| [TopoJsonOptions()](#TopoJsonOptions__1) | Créer une nouvelle instance. |
## **Properties**
...
| default_object_name | string | r/w | Nom de l'objet où les entités sont placées par défaut. |
...
| object_name_attribute | string | r/w | Nom de l'attribut qui reflète le nom de l'objet contenant une entité. |
| quantization_number | Nullable<int> | r/w | Spécifie le nombre de quantification à utiliser pour quantifier les coordonnées et encoder en delta les arcs dans le TopoJSON de sortie. |
...
| transform | [TopoJsonTransform](/psd/python-net/aspose.gis.formats.topojson/topojsontransform) | r/w | Spécifie l'objet de transformation à utiliser pour quantifier les coordonnées et encoder en delta les arcs dans le TopoJSON de sortie. |
