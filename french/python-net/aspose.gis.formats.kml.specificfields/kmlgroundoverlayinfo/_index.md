...
type: docs
weight: 20
url: /fr/python-net/aspose.gis.formats.kml.specificfields/kmlgroundoverlayinfo/
---
...
| draw_order | double | r/w | DrawOrder du nœud 'GroundOverlay'. |
| icon | [IconInfo](/psd/python-net/aspose.gis.formats.kml.specificfields/iconinfo) | r/w | IconPath du nœud 'GroundOverlay'. |
| lat_lon_box | [KmlLatLonBox](/psd/python-net/aspose.gis.formats.kml.specificfields/kmllatlonbox) | r/w | Spécifie l'objet du nœud Kml 'LatLonAltBox'. |
| nom | string | r/w | Nom du Ground Overlay |
...
| visibility | bool | r/w | Visibilité du Ground Overlay |
## **Methods**
| **Name** | **Description** |
| :- | :- |
