...
type: docs
weight: 30
url: /fr/python-net/aspose.gis.formats.kml.specificfields/kmllatlonaltbox/
---
...
| est | double | r/w | Est du nœud 'LatLonBox'. |
| max_altitude | Nullable<double> | r/w | MaxAltitude du nœud 'LatLonBox'. |
| min_altitude | Nullable<double> | r/w | MinAltitude du nœud 'LatLonBox'. |
...
| nord | double | r/w | Nord du nœud 'LatLonBox'. |
| préfixe | string | r | Obtient le préfixe. |
| rotation | Nullable<double> | r/w | Rotation du nœud 'LatLonBox'. |
| sud | double | r/w | Sud du nœud 'LatLonBox'. |
| ouest | double | r/w | Ouest du nœud 'LatLonBox'. |
## **Methods**
| **Name** | **Description** |
| :- | :- |
