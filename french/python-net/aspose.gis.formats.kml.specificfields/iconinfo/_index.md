---
title: "Classe IconInfo"
type: docs
weight: 10
url: /fr/python-net/aspose.gis.formats.kml.specificfields/iconinfo/
---
...
| **Name** | **Description** |
| :- | :- |
| [IconInfo(link)](#IconInfo_link_1) | Initialise une nouvelle instance de la classe [IconInfo](/psd/python-net/aspose.gis.formats.kml.specificfields/iconinfo/). |
## **Properties**
| **Name** | **Type** | **Access** | **Description** |
| :- | :- | :- | :- |
| children | [NodeLink[]](/psd/python-net/aspose.gis/nodelink) | r | Obtient les enfants. |
| href | string | r/w | Obtient ou définit le href. |
...
Initialise une nouvelle instance de la classe [IconInfo](/psd/python-net/aspose.gis.formats.kml.specificfields/iconinfo/).

**Parameters:**

| Paramètre | Type | Description |
| :- | :- | :- |
| link | [NodeLink](/psd/python-net/aspose.gis/nodelink) | Le nœud à partir duquel il sera créé |
