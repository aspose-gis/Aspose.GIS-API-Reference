---
title: "Classe KmlLodSettings"
type: docs
weight: 50
url: /fr/python-net/aspose.gis.formats.kml.specificfields/kmllodsettings/
---
...
| max_fade_extent | int | r/w | MaxFadeExtent du nœud 'Lod'. |
| max_lod_pixels | int | r/w | MaxLodPixels du nœud 'Lod'. |
| min_fade_extent | int | r/w | MinFadeExtent du nœud 'Lod'. |
| min_lod_pixels | int | r/w | MinLodPixels du nœud 'Lod'. |
