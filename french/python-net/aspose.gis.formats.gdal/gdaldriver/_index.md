---
title: "Classe GdalDriver"
type: docs
weight: 10
url: /fr/python-net/aspose.gis.formats.gdal/gdaldriver/
---
...
| [create_layer(path, options, spatial_reference_system)](#create_layer_path_options_spatial_reference_system_9) | Crée une couche et l'ouvre pour ajouter de nouvelles entités. |
| [create_layer(path, options, spatial_reference_system)](#create_layer_path_options_spatial_reference_system_10) | Crée une couche et l'ouvre pour ajouter de nouvelles entités. |
...
| [open_layer(path)](#open_layer_path_19) | Ouvre la couche en lecture. |
| [open_layer(path)](#open_layer_path_20) | Ouvre la couche en lecture. |
| [open_layer(path, options)](#open_layer_path_options_21) | Ouvre une couche en lecture. |
| [open_layer(path, options)](#open_layer_path_options_22) | Ouvre une couche en lecture. |
| [open_layer(path, options)](#open_layer_path_options_23) | Ouvre une couche en lecture. |
...
| :- | :- | :- |
| path | string | Chemin vers le fichier. |
| options | [GdalOptions](/psd/python-net/aspose.gis.formats.gdal/gdaloptions) | Options spécifiques au pilote. |
