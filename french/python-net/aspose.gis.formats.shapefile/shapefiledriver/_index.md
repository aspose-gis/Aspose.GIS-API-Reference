...
type: docs
weight: 10
url: /fr/python-net/aspose.gis.formats.shapefile/shapefiledriver/
---
...
| :- | :- | :- |
| path | string | Chemin vers le fichier. |
| options | [ShapefileOptions](/psd/python-net/aspose.gis.formats.shapefile/shapefileoptions) | Options spécifiques au pilote. |
