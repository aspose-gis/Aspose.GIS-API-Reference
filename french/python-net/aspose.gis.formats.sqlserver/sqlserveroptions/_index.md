---
title: "Classe SqlServerOptions"
type: docs
weight: 20
url: /fr/python-net/aspose.gis.formats.sqlserver/sqlserveroptions/
---
...
| **Name** | **Description** |
| :- | :- |
| [SqlServerOptions()](#SqlServerOptions__1) | Créer une nouvelle instance. |
## **Properties**
...
| spatial_reference_system_mode | [SpatialReferenceSystemMode](/psd/python-net/aspose.gis/spatialreferencesystemmode) | r/w | Détermine comment le SRS des géométries inconnues pour la base de données doit être géré lorsqu'elles sont ajoutées à la couche.<br/>            La valeur par défaut est [SpatialReferenceSystemMode.THROW_EXCEPTION](/psd/python-net/aspose.gis/spatialreferencesystemmode/). |
