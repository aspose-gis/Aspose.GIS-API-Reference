---
title: "Classe MapInfoTabOptions"
type: docs
weight: 20
url: /fr/python-net/aspose.gis.formats.mapinfotab/mapinfotaboptions/
---
...
| **Name** | **Description** |
| :- | :- |
| [MapInfoTabOptions()](#MapInfoTabOptions__1) | Créer une nouvelle instance. |
## **Properties**
| **Name** | **Type** | **Access** | **Description** |
| :- | :- | :- | :- |
| block_size | int | r/w | Taille de bloc pour les fichiers '*.map' (multiples de 512). La valeur par défaut est 16384. Valeurs valides : de 512 à 32256. |
...
| is_ignore_wrong_data | bool | r/w | Détermine si nous devons lever une exception lors du traitement de données incorrectes ou définir des valeurs par défaut pour celles-ci. |
...
| text_string_attribute | string | r/w | Spécifie le nom de l'attribut qui représente le texte de l'objet graphique 'Text'. |
