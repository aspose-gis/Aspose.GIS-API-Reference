...
type: docs
weight: 10
url: /fr/python-net/aspose.gis.formats.geojsonseq/geojsonseqdriver/
---
...
| :- | :- | :- |
| path | string | Chemin vers le fichier. |
| options | [GeoJsonSeqOptions](/psd/python-net/aspose.gis.formats.geojsonseq/geojsonseqoptions) | Options spécifiques au pilote. |
