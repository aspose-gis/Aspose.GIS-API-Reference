---
title: "Classe GmlDriver"
type: docs
weight: 10
url: /fr/python-net/aspose.gis.formats.gml/gmldriver/
---
...
| [create_layer(path, options, spatial_reference_system)](#create_layer_path_options_spatial_reference_system_14) | Crée une couche et l'ouvre pour ajouter de nouvelles entités. |
...
| :- | :- | :- |
| path | string | Chemin vers le fichier. |
| options | [GmlOptions](/psd/python-net/aspose.gis.formats.gml/gmloptions) | Options spécifiques au pilote. |
