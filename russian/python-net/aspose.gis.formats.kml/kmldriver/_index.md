---
title: "KmlDriver Класс"
type: docs
weight: 50
url: /ru/python-net/aspose.gis.formats.kml/kmldriver/
---
...
| [open_as_kml_layer(path, options)](#open_as_kml_layer_path_options_18) | Открывает слой Kml для чтения. |
...
| :- | :- | :- |
| path | string | Путь к файлу. |
| options | [KmlOptions](/psd/python-net/aspose.gis.formats.kml/kmloptions) | Опции, специфичные для драйвера. |
...
| Тип | Описание |
| :- | :- |
| [KmlLayer](/psd/python-net/aspose.gis.formats.kml/kmllayer) | KmlLayer с конкретными полями |
