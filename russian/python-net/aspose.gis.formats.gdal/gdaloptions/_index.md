---
title: "Класс GdalOptions"
type: docs
weight: 20
url: /ru/python-net/aspose.gis.formats.gdal/gdaloptions/
---
...
| **Name** | **Описание** |
| :- | :- |
| [GdalOptions(temp_directory)](#GdalOptions_temp_directory_1) | Создать новый экземпляр. |
## **Properties**
...
| file_name | string | r/w | Имя приложения для запуска |
...
| path_to_temp_file | string | r | Путь к временным файлам. |
...
| :- | :- | :- |
| temp_directory | string | Путь к временным файлам. Временная папка пользователя по умолчанию. |
