---
title: "Класс FileGdbDriver"
type: docs
weight: 20
url: /ru/python-net/aspose.gis.formats.filegdb/filegdbdriver/
---
...
| [create_dataset(path, options)](#create_dataset_path_options_5) | Создаёт набор данных. |
| [create_dataset(path, options)](#create_dataset_path_options_6) | Создаёт набор данных. |
...
| [create_layer(path, options)](#create_layer_path_options_11) | Создаёт слой и открывает его для добавления новых объектов. |
| [create_layer(path, options, spatial_reference_system)](#create_layer_path_options_spatial_reference_system_12) | Создаёт слой и открывает его для добавления. |
| [create_layer(path, options, spatial_reference_system)](#create_layer_path_options_spatial_reference_system_13) | Создаёт слой и открывает его для добавления. |
| [create_layer(path, options, spatial_reference_system)](#create_layer_path_options_spatial_reference_system_14) | Создаёт слой и открывает его для добавления. |
| [create_layer(path, options, spatial_reference_system)](#create_layer_path_options_spatial_reference_system_15) | Создаёт слой и открывает его для добавления. |
| [create_layer(path, spatial_reference_system)](#create_layer_path_spatial_reference_system_16) | Создаёт слой и открывает его для добавления. |
| [create_layer(path, spatial_reference_system)](#create_layer_path_spatial_reference_system_17) | Создаёт слой и открывает его для добавления. |
| [edit_layer(path, options)](#edit_layer_path_options_18) | Открывает слой для редактирования. |
| [edit_layer(path, options)](#edit_layer_path_options_19) | Открывает слой для редактирования. |
| [open_dataset(path)](#open_dataset_path_20) | Открывает набор данных. |
| [open_dataset(path)](#open_dataset_path_21) | Открывает набор данных. |
| [open_dataset(path, options)](#open_dataset_path_options_22) | Открывает набор данных. |
| [open_dataset(path, options)](#open_dataset_path_options_23) | Открывает набор данных. |
| [open_dataset(path, options)](#open_dataset_path_options_24) | Открывает набор данных. |
| [open_dataset(path, options)](#open_dataset_path_options_25) | Открывает набор данных. |
| [open_layer(path)](#open_layer_path_26) | Открывает слой для чтения. |
| [open_layer(path)](#open_layer_path_27) | Открывает слой для чтения. |
| [open_layer(path, options)](#open_layer_path_options_28) | Открывает слой для чтения. |
| [open_layer(path, options)](#open_layer_path_options_29) | Открывает слой для чтения. |
| [open_layer(path, options)](#open_layer_path_options_30) | Открывает слой для чтения. |
| [open_layer(path, options)](#open_layer_path_options_31) | Открывает слой для чтения. |
| [supports_spatial_reference_system(spatial_reference_system)](#supports_spatial_reference_system_spatial_reference_system_32) | Определяет, поддерживается ли указанная система координат драйвером. |
...
| :- | :- | :- |
| path | string | Путь к набору данных. |
| options | [FileGdbOptions](/psd/python-net/aspose.gis.formats.filegdb/filegdboptions) | Опции, специфичные для драйвера. |
