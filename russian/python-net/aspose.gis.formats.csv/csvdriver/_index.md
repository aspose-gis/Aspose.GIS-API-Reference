---
title: "Класс CsvDriver"
type: docs
weight: 10
url: /ru/python-net/aspose.gis.formats.csv/csvdriver/
---
...
| **Name** | **Описание** |
| :- | :- |
| [CsvDriver()](#CsvDriver__1) | Инициализирует новый экземпляр класса CsvDriver |
## **Properties**
...
Инициализирует новый экземпляр класса CsvDriver
...
| :- | :- | :- |
| path | string | Путь к файлу. |
| options | [CsvOptions](/psd/python-net/aspose.gis.formats.csv/csvoptions) | Опции, специфичные для драйвера. |
