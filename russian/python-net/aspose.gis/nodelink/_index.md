---
title: "Класс NodeLink"
type: docs
weight: 2800
url: /ru/python-net/aspose.gis/nodelink/
---
...
| [find_nodes_by_name(name)](#find_nodes_by_name_name_5) | Находит узлы по имени |
...
| Тип | Описание |
| :- | :- |
| [NodeLink[]](/psd/python-net/aspose.gis/nodelink) | Массив узлов в формате по имени |
