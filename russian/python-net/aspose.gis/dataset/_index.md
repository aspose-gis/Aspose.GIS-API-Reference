...
type: docs
weight: 590
url: /ru/python-net/aspose.gis/dataset/
---
...
| driver | [Driver](/psd/python-net/aspose.gis/driver) | r | Возвращает [Dataset.driver](/psd/python-net/aspose.gis/dataset/), который создал этот набор данных. |
...
| [edit_layer(name, options, spatial_reference_system)](#edit_layer_name_options_spatial_reference_system_10) | Открывает слой с указанным именем для редактирования. |
| [edit_layer_at(index, options, spatial_reference_system)](#edit_layer_at_index_options_spatial_reference_system_11) | Открывает слой с указанным именем для редактирования. |
| [get_layer_name(index)](#get_layer_name_index_12) | Получает имя слоя по указанному индексу. |
| [has_layer_with_name(name)](#has_layer_with_name_name_13) | Проверяет, имеет ли текущий набор данных слой с конкретным именем. |
| [open(path, driver)](#open_path_driver_14) | Открывает набор данных. |
| [open(path, driver)](#open_path_driver_15) | Открывает набор данных. |
| [open(path, driver, options)](#open_path_driver_options_16) | Открывает набор данных. |
| [open(path, driver, options)](#open_path_driver_options_17) | Открывает набор данных. |
| [open_layer(name, options)](#open_layer_name_options_18) | Открывает слой с указанным именем для чтения. |
| [open_layer_at(index, options)](#open_layer_at_index_options_19) | Открывает слой по указанному индексу для чтения. |
| [remove_layer(name)](#remove_layer_name_20) | Удаляет векторный слой с указанным именем. |
| [remove_layer_at(index)](#remove_layer_at_index_21) | Удаляет векторный слой по указанному индексу. |
| [rename_layer(current_name, new_name)](#rename_layer_current_name_new_name_22) | Переименовать слой в наборе данных |
...
| Тип | Описание |
| :- | :- |
| [VectorLayer](/psd/python-net/aspose.gis/vectorlayer) | Слой, открытый для редактирования. |
