---
title: "Класс MultiStreamPath"
type: docs
weight: 2760
url: /ru/python-net/aspose.gis/multistreampath/
---
...
| **Name** | **Описание** |
| :- | :- |
| [MultiStreamPath(entry_file_name, file_names, streams)](#MultiStreamPath_entry_file_name_file_names_streams_1) | Инициализирует новый экземпляр класса [MultiStreamPath](/psd/python-net/aspose.gis/multistreampath/). |
## **Properties**
| **Name** | **Type** | **Access** | **Описание** |
| :- | :- | :- | :- |
| location | string | r | Получает строковое представление местоположения этого <c>AbstractPath</c>. |
| separator | char | r | Получает символ-разделитель, используемый для разделения уровней каталогов строки [MultiStreamPath.location](/psd/python-net/aspose.gis/multistreampath/). |
## **Methods**
| **Name** | **Описание** |
| :- | :- |
...
| [open(access)](#open_access_9) | Абстрагирует набор открытых потоковых многофайловых форматов, предоставляя путь для доступа к данным. |
...
Инициализирует новый экземпляр класса [MultiStreamPath](/psd/python-net/aspose.gis/multistreampath/).

**Parameters:**

| Параметр | Тип | Описание |
| :- | :- | :- |
| entry_file_name | string | Имя входного файла. |
| file_names | string | Имена файлов. |
| streams | _io.BufferedRandom[] | Потоки. |
...
Абстрагирует набор открытых потоковых многофайловых форматов, предоставляя путь для доступа к данным.
...
| Тип | Описание |
| :- | :- |
| _io.BufferedRandom | Это может быть либо   , либо поток, первоначально переданный клиентом. |
