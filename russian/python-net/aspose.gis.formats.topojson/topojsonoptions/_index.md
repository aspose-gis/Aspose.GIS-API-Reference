---
title: "TopoJsonOptions Класс"
type: docs
weight: 20
url: /ru/python-net/aspose.gis.formats.topojson/topojsonoptions/
---
...
| **Name** | **Описание** |
| :- | :- |
| [TopoJsonOptions()](#TopoJsonOptions__1) | Создать новый экземпляр. |
## **Properties**
...
| default_object_name | string | r/w | Имя объекта, в который по умолчанию помещаются объекты. |
...
| object_name_attribute | string | r/w | Имя атрибута, отражающего имя объекта, содержащего элемент. |
| quantization_number | Nullable<int> | r/w | Указывает номер квантования, используемый для квантования координат и дельта‑кодирования дуг в выходном TopoJSON. |
...
| transform | [TopoJsonTransform](/psd/python-net/aspose.gis.formats.topojson/topojsontransform) | r/w | Указывает объект преобразования, используемый для квантования координат и дельта‑кодирования дуг в выходном TopoJSON. |
