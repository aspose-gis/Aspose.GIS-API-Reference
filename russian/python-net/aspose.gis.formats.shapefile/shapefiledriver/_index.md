---
title: "Класс ShapefileDriver"
type: docs
weight: 10
url: /ru/python-net/aspose.gis.formats.shapefile/shapefiledriver/
---
...
| :- | :- | :- |
| path | string | Путь к файлу. |
| options | [ShapefileOptions](/psd/python-net/aspose.gis.formats.shapefile/shapefileoptions) | Опции, специфичные для драйвера. |
