---
title: "Класс ShapefileOptions"
type: docs
weight: 20
url: /ru/python-net/aspose.gis.formats.shapefile/shapefileoptions/
---
...
| **Name** | **Описание** |
| :- | :- |
| [ShapefileOptions()](#ShapefileOptions__1) | Создать новый экземпляр. |
## **Properties**
...
| is_ignore_wrong_data | bool | r/w | Определяет, следует ли бросать исключение при разборе неверных данных или устанавливать для них значения по умолчанию |
