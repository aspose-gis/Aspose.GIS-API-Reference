---
title: "Класс SingleStreamPath"
type: docs
weight: 850
url: /ru/python-net/aspose.gis.common/singlestreampath/
---
...
| **Name** | **Описание** |
| :- | :- |
| [SingleStreamPath(stream)](#SingleStreamPath_stream_1) | Инициализирует новый экземпляр класса SingleStreamPath |
## **Properties**
...
Инициализирует новый экземпляр класса SingleStreamPath
