---
title: "Класс GmlDriver"
type: docs
weight: 10
url: /ru/python-net/aspose.gis.formats.gml/gmldriver/
---
...
| [create_layer(path, options, spatial_reference_system)](#create_layer_path_options_spatial_reference_system_14) | Создаёт слой и открывает его для добавления новых объектов. |
...
| [open_layer(path)](#open_layer_path_24) | Открывает слой для чтения. |
...
| [supports_spatial_reference_system(spatial_reference_system)](#supports_spatial_reference_system_spatial_reference_system_29) | Определяет, поддерживается ли указанная система координат драйвером. |
...
| :- | :- | :- |
| path | string | Путь к файлу. |
| options | [GmlOptions](/psd/python-net/aspose.gis.formats.gml/gmloptions) | Опции, специфичные для драйвера. |
