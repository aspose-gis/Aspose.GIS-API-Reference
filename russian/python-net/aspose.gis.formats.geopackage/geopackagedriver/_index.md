---
title: "GeoPackageDriver Класс"
type: docs
weight: 20
url: /ru/python-net/aspose.gis.formats.geopackage/geopackagedriver/
---
...
| **Name** | **Описание** |
| :- | :- |
| [GeoPackageDriver()](#GeoPackageDriver__1) | Инициализирует новый экземпляр класса GeoPackageDriver |
## **Properties**
...
| [create_layer(path, options, spatial_reference_system)](#create_layer_path_options_spatial_reference_system_9) | Создаёт слой и открывает его для добавления. |
| [create_layer(path, options, spatial_reference_system)](#create_layer_path_options_spatial_reference_system_10) | Создаёт слой и открывает его для добавления. |
...
| [open_dataset(path, options)](#open_dataset_path_options_19) | Открывает набор данных. |
| [open_layer(path)](#open_layer_path_20) | Открывает слой для чтения. |
| [open_layer(path)](#open_layer_path_21) | Открывает слой для чтения. |
...
Инициализирует новый экземпляр класса GeoPackageDriver
...
| :- | :- | :- |
| path | [AbstractPath](/psd/python-net/aspose.gis/abstractpath) | Путь к набору данных. |
| options | [GeoPackageOptions](/psd/python-net/aspose.gis.formats.geopackage/geopackageoptions) | Опции, специфичные для драйвера. |

**Returns**

| Тип | Описание |
| :- | :- |
| [GeoPackageDataset](/psd/python-net/aspose.gis.formats.geopackage/geopackagedataset) | Экземпляр [Dataset](/psd/python-net/aspose.gis/dataset/). |
...
| Тип | Описание |
| :- | :- |
| bool | Логическое значение, указывающее, поддерживается ли указанная система пространственных ссылок драйвером.<br/>            <see langword="null" /> считается поддерживаемой любым драйвером. |
