---
title: "InFileDriver Класс"
type: docs
weight: 10
url: /ru/python-net/aspose.gis.formats.infile/infiledriver/
---
...
| :- | :- | :- |
| path | string | Путь к файлу. |
| options | [InFileOptions](/psd/python-net/aspose.gis.formats.infile/infileoptions) | Опции, специфичные для драйвера. |
