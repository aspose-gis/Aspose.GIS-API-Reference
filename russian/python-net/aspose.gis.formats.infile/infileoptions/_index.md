---
title: "Класс InFileOptions"
type: docs
weight: 20
url: /ru/python-net/aspose.gis.formats.infile/infileoptions/
---
...
| **Name** | **Описание** |
| :- | :- |
| [InFileOptions()](#InFileOptions__1) | Создать новый экземпляр. |
## **Properties**
...
| count_of_feature_in_part | int | r/w | Максимальное количество объектов в каждой части файла |
