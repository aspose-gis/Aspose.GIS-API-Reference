---
title: "Класс LocalSpatialReferenceSystem"
type: docs
weight: 130
url: /ru/python-net/aspose.gis.spatialreferencing/localspatialreferencesystem/
---
...
| as_local | [LocalSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/localspatialreferencesystem) | r | Вернуть это. |
...
| dimensions_count | int | r | Количество измерений в этой SRS. |
...
| geographic_datum | [GeographicDatum](/psd/python-net/aspose.gis.spatialreferencing/geographicdatum) | r | Выбрасывает InvalidOperationException, поскольку у локального SRS нет географического датума. |
| has_geographic_datum | bool | r | Возвращает <see langword="false" />, поскольку у локального SRS нет географического датума. |
| has_prime_meridian | bool | r | Возвращает <see langword="false" />, поскольку у локального SRS нет главного меридиана. |
...
| local_datum | [LocalDatum](/psd/python-net/aspose.gis.spatialreferencing/localdatum) | r | Датум, который описывает метод измерений. |
...
| prime_meridian | [PrimeMeridian](/psd/python-net/aspose.gis.spatialreferencing/primemeridian) | r | Выбрасывает InvalidOperationException, поскольку у локального SRS нет главного меридиана. |
| type | [SpatialReferenceSystemType](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype) | r | Возвращает [SpatialReferenceSystemType.LOCAL](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/). |
| unit | [Unit](/psd/python-net/aspose.gis.spatialreferencing/unit) | r | Единица этой SRS. |
...
| [get_unit(dimension)](#get_unit_dimension_12) | Получить [LocalSpatialReferenceSystem.unit](/psd/python-net/aspose.gis.spatialreferencing/localspatialreferencesystem/) измерения. |
...
Получить [LocalSpatialReferenceSystem.unit](/psd/python-net/aspose.gis.spatialreferencing/localspatialreferencesystem/) измерения.
