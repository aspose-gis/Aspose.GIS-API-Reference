---
title: "Класс ProjectedSpatialReferenceSystem"
type: docs
weight: 150
url: /ru/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/
---
...
| :- | :- | :- | :- |
| angular_unit | [Unit](/psd/python-net/aspose.gis.spatialreferencing/unit) | r | Единица, используемая для угловых значений в этой СРС и для угловых параметров [ProjectedSpatialReferenceSystem.projection](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/).<br/>            Совпадает с угловой единицей свойства [ProjectedSpatialReferenceSystem.base](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/). |
...
| as_geographic | [GeographicSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/geographicspatialreferencesystem) | r | Возвращает эту СРС, преобразованную в [GeographicSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/geographicspatialreferencesystem/).<br/>            Используйте [SpatialReferenceSystem.type](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem/) чтобы узнать, возможна ли конверсия. |
...
| as_projected | [ProjectedSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem) | r | Вернуть это. |
...
| axises_order | [ProjectedAxisesOrder](/psd/python-net/aspose.gis.spatialreferencing/projectedaxisesorder) | r | Порядок осей в этой СРС.<br/>            Если эта СРС недействительна и имеет неправильные направления осей, возвращается [ProjectedAxisesOrder.INVALID](/psd/python-net/aspose.gis.spatialreferencing/projectedaxisesorder/). |
| base | [GeographicSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/geographicspatialreferencesystem) | r | Географическая СРС, к которой была применена [ProjectedSpatialReferenceSystem.projection](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/) для получения этой СРС. |
| dimensions_count | int | r | Возвращает количество измерений в этой СРС. Для проецируемой СРС это может быть:<br/>            два — если это одиночная проецируемая СРС.<br/>            три — если это составная СРС, которая состоит из одиночной, двумерной, проецируемой СРС и вертикальной СРС, добавляющей третье измерение. |
...
| has_geographic_datum | bool | r | Возвращает true, поскольку у проецируемой СРС всегда есть главный меридиан. |
| has_prime_meridian | bool | r | Возвращает true, поскольку у проецируемой СРС всегда есть главный меридиан. |
...
| linear_unit | [Unit](/psd/python-net/aspose.gis.spatialreferencing/unit) | r | Единица измерения, используемая для линейных размеров в этой СРС и для линейных параметров [ProjectedSpatialReferenceSystem.projection](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/). |
...
| projection | [Projection](/psd/python-net/aspose.gis.spatialreferencing/projection) | r | Проекция, которая была применена к [ProjectedSpatialReferenceSystem.base](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/) для получения этой СРС. |
| type | [SpatialReferenceSystemType](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype) | r | Возвращает [SpatialReferenceSystemType.PROJECTED](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/). |
