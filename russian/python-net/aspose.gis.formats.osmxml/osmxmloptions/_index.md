---
title: "Класс OsmXmlOptions"
type: docs
weight: 20
url: /ru/python-net/aspose.gis.formats.osmxml/osmxmloptions/
---
...
| **Name** | **Описание** |
| :- | :- |
| [OsmXmlOptions()](#OsmXmlOptions__1) | Создать новый экземпляр. |
## **Properties**
...
| report_all_nodes | bool | r/w | Отображать все узлы как объекты, даже если у них нет значимых тегов. |
| report_all_ways | bool | r/w | Отображать все пути как объекты, даже если у них нет значимых тегов или узлов. |
| report_common_attributes | bool | r/w | Отображать общие атрибуты OSM: visible, version, changeset, timestamp, user и uid.<br/>            Общие атрибуты будут отображаться как атрибуты объектов с префиксом "osm_", например osm_user, osm_timestamp и т.д. |
...
| write_common_attributes | bool | r/w | Записывать общие атрибуты OSM: visible, version, changeset, timestamp, user и uid. |
