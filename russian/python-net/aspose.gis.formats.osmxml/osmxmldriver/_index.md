---
title: "Класс OsmXmlDriver"
type: docs
weight: 10
url: /ru/python-net/aspose.gis.formats.osmxml/osmxmldriver/
---
...
| :- | :- | :- |
| path | string | Путь к файлу. |
| options | [OsmXmlOptions](/psd/python-net/aspose.gis.formats.osmxml/osmxmloptions) | Опции, специфичные для драйвера. |
