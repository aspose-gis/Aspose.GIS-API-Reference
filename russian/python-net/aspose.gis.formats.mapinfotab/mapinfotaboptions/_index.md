---
title: "MapInfoTabOptions Класс"
type: docs
weight: 20
url: /ru/python-net/aspose.gis.formats.mapinfotab/mapinfotaboptions/
---
...
| **Name** | **Описание** |
| :- | :- |
| [MapInfoTabOptions()](#MapInfoTabOptions__1) | Создать новый экземпляр. |
## **Properties**
| **Name** | **Type** | **Access** | **Описание** |
| :- | :- | :- | :- |
| block_size | int | r/w | Размер блока для файлов '*.map' (кратные 512). По умолчанию 16384. Допустимые значения: от 512 до 32256. |
...
| is_ignore_wrong_data | bool | r/w | Определяет, следует ли бросать исключение при работе с неверными данными или устанавливать значения по умолчанию. |
