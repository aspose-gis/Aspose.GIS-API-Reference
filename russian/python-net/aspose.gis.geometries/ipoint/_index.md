...
type: docs
weight: 200
url: /ru/python-net/aspose.gis.geometries/ipoint/
---
...
| m | double | r | Получает координату m. |
...
| x | double | r | Получает координату x. |
| y | double | r | Получает координату y. |
| z | double | r | Получает координату z. |
## **Methods**
| **Name** | **Описание** |
| :- | :- |
