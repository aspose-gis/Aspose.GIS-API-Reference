---
title: "Класс IMultiSurface"
type: docs
weight: 190
url: /ru/python-net/aspose.gis.geometries/imultisurface/
---
...
| [get_point_on_surface()](#get_point_on_surface__22) | Находит точку, гарантированно находящуюся на одной из поверхностей в этой коллекции. |
...
| Тип | Описание |
| :- | :- |
| [MultiSurface](/psd/python-net/aspose.gis.geometries/multisurface) | Редактируемая копия этой геометрии. |
...
| Тип | Описание |
| :- | :- |
| [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon) | Объект [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon/) приближается или эквивалентен этому [IMultiSurface](/psd/python-net/aspose.gis.geometries/imultisurface/).<br/>            Это эквивалент <DOM Element: class at 0x2a1792e8790>.IMultiSurface.to_linear_geometry()(float) с<br/>            значением по умолчанию <c>tolerance</c>. Значение <c>tolerance</c> по умолчанию зависит от [SpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem/)<br/>            этой геометрии:<br/>            <ul><br/>            <li> Для проецируемой СК допуск составляет 0.001 метра (в единицах СК) </li><br/>            <li> Для географической СК допуск составляет <c>1e-5</c> градусов (в единицах СК) </li><br/>            <li> Для неизвестной СК допуск составляет <c>1e-5</c> </li><br/>            </ul><br/>            Для получения более подробной информации о применяемых преобразованиях см. спецификацию <DOM Element: class at 0x2a1792e8790>.IMultiSurface.to_linear_geometry()(float). |
...
| Тип | Описание |
| :- | :- |
| [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon) | Объект [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon/) приближается или эквивалентен этому [IMultiSurface](/psd/python-net/aspose.gis.geometries/imultisurface/):<br/>             <ul><br/>             Если этот объект является [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon/) сам по себе, результат эквивалентен этому объекту<br/>             Если этот объект не является [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon/) — все поверхности линеаризуются и создаётся новый <c>IMultiPolygon</c><br/>            </ul> |
