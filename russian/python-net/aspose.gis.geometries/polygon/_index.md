...
type: docs
weight: 310
url: /ru/python-net/aspose.gis.geometries/polygon/
---
...
| **Name** | **Описание** |
| :- | :- |
| [Polygon()](#Polygon__1) | Инициализирует новый экземпляр класса [Polygon](/psd/python-net/aspose.gis.geometries/polygon/). |
| [Polygon(exterior_ring)](#Polygon_exterior_ring_2) | Инициализирует новый экземпляр класса [Polygon](/psd/python-net/aspose.gis.geometries/polygon/). |
| [Polygon(exterior_ring, interior_rings)](#Polygon_exterior_ring_interior_rings_3) | Инициализирует новый экземпляр класса [Polygon](/psd/python-net/aspose.gis.geometries/polygon/). |
## **Properties**
...
| exterior_ring | [ILinearRing](/psd/python-net/aspose.gis.geometries/ilinearring) | r/w | Получает внешнее кольцо. |
...
| [get_point_on_surface()](#get_point_on_surface__28) | Находит точку, которая гарантированно находится на этом полигоне. |
...
Инициализирует новый экземпляр класса [Polygon](/psd/python-net/aspose.gis.geometries/polygon/).
...
| :- | :- | :- |
| exterior_ring | [ILinearRing](/psd/python-net/aspose.gis.geometries/ilinearring) | Внешнее кольцо. |
...
| :- | :- | :- |
| exterior_ring | [ILinearRing](/psd/python-net/aspose.gis.geometries/ilinearring) | Внешнее кольцо. |
| interior_rings | System.Collections.Generic.IEnumerable<ILinearRing> | Внутренние кольца. |
...
| Параметр | Тип | Описание |
| :- | :- | :- |
| ring | [ILinearRing](/psd/python-net/aspose.gis.geometries/ilinearring) | Кольцо для добавления. |
...
| Тип | Описание |
| :- | :- |
| [ILinearRing](/psd/python-net/aspose.gis.geometries/ilinearring) | Внутреннее кольцо. |
...
Находит точку, которая гарантированно находится на этом полигоне.

**Returns**

| Тип | Описание |
| :- | :- |
| [IPoint](/psd/python-net/aspose.gis.geometries/ipoint) | Точка на этом полигоне. Пустая точка, если у этого полигона нет внутренней части. |
...
| Тип | Описание |
| :- | :- |
| [Polygon](/psd/python-net/aspose.gis.geometries/polygon) | Редактируемая копия этой геометрии. |
