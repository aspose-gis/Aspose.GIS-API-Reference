---
title: "MultiPolygon Класс"
type: docs
weight: 280
url: /ru/python-net/aspose.gis.geometries/multipolygon/
---
...
| **Name** | **Описание** |
| :- | :- |
| [MultiPolygon()](#MultiPolygon__1) | Инициализирует новый экземпляр класса [MultiPolygon](/psd/python-net/aspose.gis.geometries/multipolygon/). |
## **Properties**
...
| spatial_reference_system | [SpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem/) | r/w | Возвращает SpatialReferenceSystem этого экземпляра.<br/>            Это свойство может быть <see langword="null" />, если SpatialReferenceSystem неизвестна. |
## **Methods**
| **Name** | **Описание** |
| :- | :- |
...
Инициализирует новый экземпляр класса [MultiPolygon](/psd/python-net/aspose.gis.geometries/multipolygon/).
