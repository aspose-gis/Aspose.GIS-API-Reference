---
title: "Класс GeometryCollection"
type: docs
weight: 60
url: /ru/python-net/aspose.gis.geometries/geometrycollection/
---
...
| **Name** | **Описание** |
| :- | :- |
| [GeometryCollection()](#GeometryCollection__1) | Инициализирует новый экземпляр класса [GeometryCollection](/psd/python-net/aspose.gis.geometries/geometrycollection/) . |
## **Properties**
...
| dimension | [GeometryDimension](/psd/python-net/aspose.gis.geometries/geometrydimension) | r | Возвращает топологическое измерение этого [Geometry](/psd/python-net/aspose.gis.geometries/geometry/).<br/>            Если коллекция пуста, возвращается [GeometryDimension.POINT](/psd/python-net/aspose.gis.geometries/geometrydimension/) . |
...
Инициализирует новый экземпляр класса [GeometryCollection](/psd/python-net/aspose.gis.geometries/geometrycollection/) .
