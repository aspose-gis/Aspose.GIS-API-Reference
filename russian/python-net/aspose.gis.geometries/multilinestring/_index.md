---
title: "Класс MultiLineString"
type: docs
weight: 260
url: /ru/python-net/aspose.gis.geometries/multilinestring/
---
...
| **Name** | **Описание** |
| :- | :- |
| [MultiLineString()](#MultiLineString__1) | Инициализирует новый экземпляр класса [MultiLineString](/psd/python-net/aspose.gis.geometries/multilinestring/). |
## **Properties**
...
| is_closed | bool | r | Определяет, замкнута ли эта кривая. |
...
Инициализирует новый экземпляр класса [MultiLineString](/psd/python-net/aspose.gis.geometries/multilinestring/).
