---
title: "Класс IMultiCurve"
type: docs
weight: 150
url: /ru/python-net/aspose.gis.geometries/imulticurve/
---
...
| Тип | Описание |
| :- | :- |
| [MultiCurve](/psd/python-net/aspose.gis.geometries/multicurve) | Редактируемая копия этой геометрии. |
...
| Тип | Описание |
| :- | :- |
| [IMultiLineString](/psd/python-net/aspose.gis.geometries/imultilinestring) | Объект [IMultiLineString](/psd/python-net/aspose.gis.geometries/imultilinestring/) приближается или эквивалентен этому [IMultiCurve](/psd/python-net/aspose.gis.geometries/imulticurve/).<br/>            Это эквивалент <DOM Element: class at 0x2a179241f70>.IMultiCurve.to_linear_geometry()(float) с<br/>            значением по умолчанию <c>tolerance</c>. Значение <c>tolerance</c> по умолчанию зависит от [SpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem/)<br/>            этой геометрии:<br/>            <ul><br/>            <li> Для проецируемой СК допуск составляет 0.001 метра (в единицах СК) </li><br/>            <li> Для географической СК допуск составляет <c>1e-5</c> градусов (в единицах СК) </li><br/>            <li> Для неизвестной СК допуск составляет <c>1e-5</c> </li><br/>            </ul><br/>            Для получения более подробной информации о применяемых преобразованиях см. спецификацию <DOM Element: class at 0x2a179241f70>.IMultiCurve.to_linear_geometry()(float). |
...
| Тип | Описание |
| :- | :- |
| [IMultiLineString](/psd/python-net/aspose.gis.geometries/imultilinestring) | Объект [IMultiLineString](/psd/python-net/aspose.gis.geometries/imultilinestring/) приближается или эквивалентен этому [IMultiCurve](/psd/python-net/aspose.gis.geometries/imulticurve/):<br/>             <ul><br/>             Если этот объект является [IMultiLineString](/psd/python-net/aspose.gis.geometries/imultilinestring/) сам по себе, результат эквивалентен этому объекту<br/>             Если этот объект не является [IMultiLineString](/psd/python-net/aspose.gis.geometries/imultilinestring/) — все кривые линеаризуются и создаётся новый <c>IMultiLineString</c><br/>            </ul> |
