---
title: "Geometry Класс"
type: docs
weight: 50
url: /ru/python-net/aspose.gis.geometries/geometry/
---
...
| dimension | [GeometryDimension](/psd/python-net/aspose.gis.geometries/geometrydimension) | r | Получает топологическое измерение этого [Geometry](/psd/python-net/aspose.gis.geometries/geometry/).<br/>            Если измерение неизвестно (например, для пустого GEOMETRYCOLLECTION) [GeometryDimension.POINT](/psd/python-net/aspose.gis.geometries/geometrydimension/) возвращается. |
...
| Тип | Описание |
| :- | :- |
| [Geometry](/psd/python-net/aspose.gis.geometries/geometry) | Редактируемая копия этой геометрии. |
