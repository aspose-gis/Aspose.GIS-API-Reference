---
title: "Класс LineString"
type: docs
weight: 230
url: /ru/python-net/aspose.gis.geometries/linestring/
---
...
| **Name** | **Описание** |
| :- | :- |
| [LineString()](#LineString__1) | Инициализирует новый экземпляр класса [LineString](/psd/python-net/aspose.gis.geometries/linestring/). |
| [LineString(collection)](#LineString_collection_2) | Инициализирует новый экземпляр класса [LineString](/psd/python-net/aspose.gis.geometries/linestring/). |
| [LineString(other)](#LineString_other_3) | Инициализирует новый экземпляр класса [LineString](/psd/python-net/aspose.gis.geometries/linestring/). |
## **Properties**
...
Инициализирует новый экземпляр класса [LineString](/psd/python-net/aspose.gis.geometries/linestring/).
...
| Тип | Описание |
| :- | :- |
| [LineString](/psd/python-net/aspose.gis.geometries/linestring) | Редактируемая копия этой геометрии. |
