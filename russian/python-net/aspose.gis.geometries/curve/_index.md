...
type: docs
weight: 30
url: /ru/python-net/aspose.gis.geometries/curve/
---
...
| reverse() | Разворачивает эту кривую. |
...
| Тип | Описание |
| :- | :- |
| [Curve](/psd/python-net/aspose.gis.geometries/curve) | Редактируемая копия этой геометрии. |
