---
title: "Класс IGeometryCollection"
type: docs
weight: 120
url: /ru/python-net/aspose.gis.geometries/igeometrycollection/
---
...
| Тип | Описание |
| :- | :- |
| [GeometryCollection](/psd/python-net/aspose.gis.geometries/geometrycollection) | Редактируемая копия этой геометрии. |
...
| Параметр | Тип | Описание |
| :- | :- | :- |
| допуск | double | Параметр <c>tolerance</c>, используемый. Результат гарантировано отличается от кривой геометрии менее чем на <c>tolerance</c>, если только количество точек, необходимое для линейзации геометрии, не превышает максимальное количество точек на квадрант,<br/>            в настоящее время равное 10000 точек. |
