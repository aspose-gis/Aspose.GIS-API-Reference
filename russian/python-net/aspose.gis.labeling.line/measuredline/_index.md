---
title: "Класс MeasuredLine"
type: docs
weight: 60
url: /ru/python-net/aspose.gis.labeling.line/measuredline/
---
...
| **Name** | **Описание** |
| :- | :- |
| [MeasuredLine(line)](#MeasuredLine_line_1) | Инициализирует новый экземпляр класса MeasuredLine |
## **Properties**
...
Инициализирует новый экземпляр класса MeasuredLine
