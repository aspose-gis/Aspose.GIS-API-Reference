---
title: "Класс GeoJsonDriver"
type: docs
weight: 10
url: /ru/python-net/aspose.gis.formats.geojson/geojsondriver/
---
...
| :- | :- | :- |
| path | string | Путь к файлу. |
| options | [GeoJsonOptions](/psd/python-net/aspose.gis.formats.geojson/geojsonoptions) | Опции, специфичные для драйвера. |
