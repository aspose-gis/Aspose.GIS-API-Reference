---
title: "Класс IconInfo"
type: docs
weight: 10
url: /ru/python-net/aspose.gis.formats.kml.specificfields/iconinfo/
---
...
| **Name** | **Описание** |
| :- | :- |
| [IconInfo(link)](#IconInfo_link_1) | Инициализирует новый экземпляр класса [IconInfo](/psd/python-net/aspose.gis.formats.kml.specificfields/iconinfo/). |
## **Properties**
| **Name** | **Type** | **Access** | **Описание** |
| :- | :- | :- | :- |
| children | [NodeLink[]](/psd/python-net/aspose.gis/nodelink) | r | Получает дочерние элементы. |
| href | string | r/w | Получает или задает href. |
...
Инициализирует новый экземпляр класса [IconInfo](/psd/python-net/aspose.gis.formats.kml.specificfields/iconinfo/).

**Parameters:**

| Параметр | Тип | Описание |
| :- | :- | :- |
| link | [NodeLink](/psd/python-net/aspose.gis/nodelink) | Узел, из которого будет создан |
