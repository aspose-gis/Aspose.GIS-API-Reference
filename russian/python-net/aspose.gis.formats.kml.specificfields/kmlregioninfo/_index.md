---
title: "Класс KmlRegionInfo"
type: docs
weight: 70
url: /ru/python-net/aspose.gis.formats.kml.specificfields/kmlregioninfo/
---
...
| id | string | r/w | Id узла 'Region'. |
| lat_lon_alt_box | [KmlLatLonAltBox](/psd/python-net/aspose.gis.formats.kml.specificfields/kmllatlonaltbox) | r/w | Указывает объект из узла Kml 'LatLonAltBox'. |
| lod | [KmlLodSettings](/psd/python-net/aspose.gis.formats.kml.specificfields/kmllodsettings) | r/w | Указывает объект из узла Kml 'Lod'. |
