---
title: "Класс KmlLatLonAltBox"
type: docs
weight: 30
url: /ru/python-net/aspose.gis.formats.kml.specificfields/kmllatlonaltbox/
---
...
| восток | double | r/w | Восток узла 'LatLonBox'. |
| max_altitude | Nullable<double> | r/w | MaxAltitude узла 'LatLonBox'. |
| min_altitude | Nullable<double> | r/w | MinAltitude узла 'LatLonBox'. |
...
| север | double | r/w | Север узла 'LatLonBox'. |
| префикс | string | r | Получает префикс. |
| вращение | Nullable<double> | r/w | Вращение узла 'LatLonBox'. |
| юг | double | r/w | Юг узла 'LatLonBox'. |
| запад | double | r/w | Запад узла 'LatLonBox'. |
## **Methods**
| **Name** | **Описание** |
| :- | :- |
