...
description: Добавляет символизатор который будет применяться к объектам которые не соответствуют ни одному правилу фильтрации.
type: docs
weight: 50
url: /ru/net/aspose.gis.rendering.symbolizers/rulebasedsymbolizer/addelserule/
---
