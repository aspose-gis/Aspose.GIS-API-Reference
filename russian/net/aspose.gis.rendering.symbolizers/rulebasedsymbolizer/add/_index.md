...
| --- | --- | --- |
| filter | Func`2 | Определяет, когда к объекту следует применять символизатор. |
| symbolizer | VectorSymbolizer | Символизатор для применения к объекту, когда*filter*возвращает true. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| rule | Rule | Правило для добавления. |
