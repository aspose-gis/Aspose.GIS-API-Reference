...
description: Aspose.Gis.SpatialReferencing.SpatialReferenceSystem сорт. Пространственная система отсчета отображает координаты мест на Земле. Существуют различные типы SRS см.Type . Более того если тип SRSGeographic или Projected SRS может быть составным или одинарным см.IsCompound .
type: docs
weight: 2250
