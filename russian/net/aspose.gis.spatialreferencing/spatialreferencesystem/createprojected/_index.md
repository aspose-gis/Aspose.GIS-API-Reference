...
description: Создать проекцию SRS из пользовательских параметров.
type: docs
weight: 380
...
Новый прогнозируемый SRS.

### Исключения

| исключение | условие |
| --- | --- |
| InvalidOperationException | Базовый SRS в параметрах:`null`. Метод проекции в параметрах:`null`. |
