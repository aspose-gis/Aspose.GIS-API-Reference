...
description: SpatialReferenceSystem метод. Возвращает представление этой SRS в виде строки WKT. Результирующая строка WKT будет соответствовать спецификации OGC 01009 обычно именуемой WKT1.
type: docs
weight: 190
...
| исключение | условие |
| --- | --- |
| InvalidOperationException | Это представление SRS будет содержатьNaN ,PositiveInfinity илиNegativeInfinity . |
