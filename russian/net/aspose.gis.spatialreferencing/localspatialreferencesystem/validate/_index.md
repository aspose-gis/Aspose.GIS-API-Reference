...
description: LocalSpatialReferenceSystem метод. Определите действительна ли эта SRS. ВидетьValidate для описания действительности.
type: docs
weight: 130
url: /ru/net/aspose.gis.spatialreferencing/localspatialreferencesystem/validate/
---
