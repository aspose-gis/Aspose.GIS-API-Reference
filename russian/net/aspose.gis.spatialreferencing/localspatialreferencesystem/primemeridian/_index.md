...
description: ВыбрасываетInvalidOperationException  так как местный SRS не имеет нулевого меридиана.
type: docs
weight: 70
...
ВыбрасываетInvalidOperationException , так как местный SRS не имеет нулевого меридиана.
