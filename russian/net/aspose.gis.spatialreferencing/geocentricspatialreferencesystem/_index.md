...
description: Aspose.Gis.SpatialReferencing.GeocentricSpatialReferenceSystem сорт. Геоцентрическая SRS представляет собой трехмерную декартову SRS с началом в центре Земли.
type: docs
weight: 2090
