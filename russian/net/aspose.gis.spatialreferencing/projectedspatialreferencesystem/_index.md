...
Спроецированная SRS является результатом применения проекции к географической SRS. Спроецированная SRS может быть двухмерной или трехмерной. Если спроецированная SRS трехмерна, то она на самом деле является составной SRS двухмерной проекции SRS и одномерной вертикальной SRS.
...
| abstract [DimensionsCount](../../aspose.gis.spatialreferencing/projectedspatialreferencesystem/dimensionscount/) { get; } | Возвращает количество измерений в этой SRS. Для проекционной СКР это может быть: два - если это одиночная проекционная СКР. три - если это составная СКР, которая состоит из одинарной, двумерной, спроецированной ССО и вертикальной ССО, добавляющей третье измерение. |
