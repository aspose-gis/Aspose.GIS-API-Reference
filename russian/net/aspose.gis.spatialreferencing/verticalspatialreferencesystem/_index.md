...
| override [GeographicDatum](../../aspose.gis.spatialreferencing/verticalspatialreferencesystem/geographicdatum) { get; } | ВыдаетInvalidOperationException, так как вертикальная SRS не имеет географической точки отсчета. |
| override [HasGeographicDatum](../../aspose.gis.spatialreferencing/verticalspatialreferencesystem/hasgeographicdatum) { get; } | Возвращает`false`, так как вертикальная SRS не имеет географической точки отсчета. |
...
| override [PrimeMeridian](../../aspose.gis.spatialreferencing/verticalspatialreferencesystem/primemeridian) { get; } | ВыдаетInvalidOperationException, поскольку вертикальный SRS не имеет нулевого меридиана. |
| override [Type](../../aspose.gis.spatialreferencing/verticalspatialreferencesystem/type) { get; } | ВозвратVertical. |
| [VerticalDatum](../../aspose.gis.spatialreferencing/verticalspatialreferencesystem/verticaldatum) { get; } | Датум, который используется в этом SRS. |
| [VerticalUnit](../../aspose.gis.spatialreferencing/verticalspatialreferencesystem/verticalunit) { get; } | Блок, который используется в этой SRS. |
...
| override [GetAxis](../../aspose.gis.spatialreferencing/verticalspatialreferencesystem/getaxis)(int) | Get[`Axis`](../axis), описывающий размерность. |
| override [GetUnit](../../aspose.gis.spatialreferencing/verticalspatialreferencesystem/getunit)(int) | Get[`Unit`](../unit)измерения. |
...
| override [Validate](../../aspose.gis.spatialreferencing/verticalspatialreferencesystem/validate)(out string) | Определите, действителен ли этот SRS. См.[`Validate`](../spatialreferencesystem/validate)для описания достоверности. |
