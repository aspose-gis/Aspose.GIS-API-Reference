...
description: Aspose.Gis.Formats.EsriAscii.EsriAsciiOptions сорт. Параметры драйвера для формата EsriAscii.
type: docs
weight: 220
url: /ru/net/aspose.gis.formats.esriascii/esriasciioptions/
---
## EsriAsciiOptions class

Параметры драйвера для формата EsriAscii.
...
| Имя | Описание |
| --- | --- |
| [EsriAsciiOptions](esriasciioptions/)() | Создать новый экземпляр. |
