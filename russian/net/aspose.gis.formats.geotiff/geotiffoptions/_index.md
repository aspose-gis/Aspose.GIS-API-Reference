...
description: Aspose.Gis.Formats.GeoTiff.GeoTiffOptions сорт. Параметры драйвера для формата GeoTiff.
type: docs
weight: 330
url: /ru/net/aspose.gis.formats.geotiff/geotiffoptions/
---
## GeoTiffOptions class

Параметры драйвера для формата GeoTiff.
...
| Имя | Описание |
| --- | --- |
| [GeoTiffOptions](geotiffoptions/)() | Создать новый экземпляр. |
...
* пространство имен [Aspose.Gis.Formats.GeoTiff](../../aspose.gis.formats.geotiff/)
* сборка [Aspose.GIS](../../)
