...
description: Aspose.Gis.FeatureAttributeCollection сорт. АFeatureAttributeCollection определяет какие атрибуты доступны дляFeature .
type: docs
weight: 150
...
А`FeatureAttributeCollection` определяет, какие атрибуты доступны для[`Feature`](../feature/) .
