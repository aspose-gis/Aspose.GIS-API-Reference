...
description: Aspose.Gis.PointFormats перечисление. PointFormats используются для преобразования координат в текст.
type: docs
weight: 1300
...
`PointFormats` используются для преобразования координат в текст.
