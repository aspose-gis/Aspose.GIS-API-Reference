...
description: Aspose.Gis.VectorLayer сорт. Представляет собой векторный слой. Векторный слой представляет собой набор географических объектов хранящихся в файле.
type: docs
weight: 2320
...
| Имя | Описание |
| --- | --- |
| override [Attributes](../../aspose.gis/vectorlayer/attributes/) { get; } | Получает коллекцию настраиваемых атрибутов для объектов в этом`VectorLayer` . |
...
| [Add](../../aspose.gis/vectorlayer/add/#add)(Feature) | Добавляет в слой новый объект, если поддерживается`VectorLayer` с[`Driver`](./driver/) . |
| virtual [Add](../../aspose.gis/vectorlayer/add/#add_1)(Feature, IFeatureStyle) | Добавляет в слой новый объект с указанным стилем, если поддерживается`VectorLayer` с[`Driver`](./driver/) . |
| [AsInMemory](../../aspose.gis/vectorlayer/asinmemory/)() | Создать клон слоя в формате InMemory. |
...
| [CopyAttributes](../../aspose.gis/vectorlayer/copyattributes/#copyattributes)(FeaturesSequence) | Копирует атрибуты других`VectorLayer` к этому. |
| [CopyAttributes](../../aspose.gis/vectorlayer/copyattributes/#copyattributes_1)(FeaturesSequence, IAttributesConverter) | Копирует атрибуты других`VectorLayer` к этому. |
| [Dispose](../../aspose.gis/vectorlayer/dispose/)() | Освобождает ресурсы, используемые`VectorLayer` . |
| override [Equals](../../aspose.gis/vectorlayer/equals/)(object) | Определяет, равен ли указанный объект текущему объекту. |
