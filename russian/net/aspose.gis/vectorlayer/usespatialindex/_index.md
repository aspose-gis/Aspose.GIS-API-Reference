...
description: VectorLayer метод. Загружает пространственный индекс для ускорения фильтрации по значению атрибута в таких методах фильтрации какWhereIntersects иNearestTo. Если индекс не существует сначала создает его. ИспользоватьforceRebuild для принудительного восстановления индекса.
type: docs
weight: 190
