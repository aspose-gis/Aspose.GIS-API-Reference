...
description: Aspose.Gis.DriverOptions сорт. Параметры дляDriver .
type: docs
weight: 100
url: /ru/net/aspose.gis/driveroptions/
---
## DriverOptions class

Параметры для[`Driver`](../driver/) .
...
| [DeleteNearPointsDistance](../../aspose.gis/driveroptions/deletenearpointsdistance/) { get; set; } | Определяет расстояние для[`DeleteNearPoints`](./deletenearpoints/) . По умолчанию`0` . |
...
| [SimplifySegmentsDistance](../../aspose.gis/driveroptions/simplifysegmentsdistance/) { get; set; } | Определяет расстояние для[`SimplifySegments`](./simplifysegments/) . По умолчанию`0` . |
