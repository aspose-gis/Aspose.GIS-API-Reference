...
description: Aspose.Gis.Formats.EsriJson.EsriJsonOptions сорт. Параметры драйвера для формата EsriJson.
type: docs
weight: 240
url: /ru/net/aspose.gis.formats.esrijson/esrijsonoptions/
---
## EsriJsonOptions class

Параметры драйвера для формата EsriJson.
...
| Имя | Описание |
| --- | --- |
| [EsriJsonOptions](esrijsonoptions/)() | Создать новый экземпляр. |
...
| [NestedPropertiesSeparator](../../aspose.gis.formats.esrijson/esrijsonoptions/nestedpropertiesseparator/) { get; set; } | Получает или задает строку, используемую для разделения компонентов вложенных атрибутов. Значение по умолчанию: "_". |
