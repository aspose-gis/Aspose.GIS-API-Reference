...
description: Aspose.Gis.Formats.SqlServer.SqlServerOptions сорт. Параметры драйвера для формата SqlServer. На данный момент драйвер не предоставляет настраиваемых параметров.
type: docs
weight: 690
