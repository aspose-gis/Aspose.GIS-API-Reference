...
description: Параметры драйвера для формата OSM XML.
type: docs
weight: 560
...
| [ReportAllNodes](../../aspose.gis.formats.osmxml/osmxmloptions/reportallnodes) { get; set; } | Сообщать обо всех узлах как о функциях, даже если у них нет значимых тегов. |
| [ReportAllWays](../../aspose.gis.formats.osmxml/osmxmloptions/reportallways) { get; set; } | Сообщать обо всех путях как о функциях, даже если они не имеют значимых тегов или узлов. |
