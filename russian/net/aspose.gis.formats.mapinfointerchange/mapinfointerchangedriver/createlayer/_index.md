...
description: MapInfoInterchangeDriver метод. Создает слой и открывает его для добавления новых объектов.
type: docs
weight: 40
url: /ru/net/aspose.gis.formats.mapinfointerchange/mapinfointerchangedriver/createlayer/
---
...
| options | MapInfoInterchangeOptions | Параметры, зависящие от драйвера. |
