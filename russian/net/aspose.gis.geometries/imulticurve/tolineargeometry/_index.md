...
description: IMultiCurve метод. Получает приблизительную или эквивалентную некривую версию этой геометрии используя значение по умолчанию.толерантность .
type: docs
weight: 20
...
А[`IMultiLineString`](../../imultilinestring/) который приближается или эквивалентен этому[`IMultiCurve`](../) :  Если этот объект[`IMultiLineString`](../../imultilinestring/) сам по себе результат эквивалентен этому объекту Если этот объект не[`IMultiLineString`](../../imultilinestring/) - все кривые линеаризованы и новые`IMultiLineString` создан
