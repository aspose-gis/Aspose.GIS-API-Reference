...
description: АGeometryCollection./geometrycollection этоGeometry./geometry это набор из одной или нескольких геометрий.
type: docs
weight: 830
url: /ru/net/aspose.gis.geometries/geometrycollection/
---
## GeometryCollection class

А[`GeometryCollection`](../geometrycollection) это[`Geometry`](../geometry) это набор из одной или нескольких геометрий.
...
| Имя | Описание |
| --- | --- |
| [GeometryCollection](geometrycollection)() | Инициализирует новый экземпляр[`GeometryCollection`](../geometrycollection) класс. |
...
| override [Dimension](../../aspose.gis.geometries/geometrycollection/dimension) { get; } | Получает топологическую размерность этого[`Geometry`](../geometry) . Если коллекция пуста,Point возвращается. |
| override [GeometryType](../../aspose.gis.geometries/geometrycollection/geometrytype) { get; } | Получает тип геометрии. |
...
| override [Clone](../../aspose.gis.geometries/geometrycollection/clone)() | Клонирует этот экземпляр. |
...
| [Equals](../../aspose.gis.geometries/geometrycollection/equals#equals)(IGeometryCollection) | Указывает, равен ли текущий объект другому объекту того же типа. |
| override [Equals](../../aspose.gis.geometries/geometrycollection/equals#equals_1)(object) | Определяет, равен ли указанный объект текущему объекту. |
...
| [ReplacePolygonsByLines](../../aspose.gis.geometries/geometrycollection/replacepolygonsbylines#replacepolygonsbylines_1)() | Получает многоугольники, представленные в виде линий этой геометрии. (2 methods) |
...
| [ToEditable](../../aspose.gis.geometries/geometrycollection/toeditable#toeditable_1)() | Получает редактируемую копию этой геометрии. (2 methods) |
| [ToEditable&lt;T&gt;](../../aspose.gis.geometries/geometry/toeditable)() | Получает редактируемую копию этой геометрии. |
| [ToLinearGeometry](../../aspose.gis.geometries/geometrycollection/tolineargeometry#tolineargeometry_2)() | Получает приблизительную или эквивалентную некривую версию этой геометрии, используя значение по умолчанию.`толерантность` . (2 methods) |
| [ToLinearGeometry](../../aspose.gis.geometries/geometrycollection/tolineargeometry#tolineargeometry_3)(double) | Получает приблизительную или эквивалентную некривую версию этой геометрии, используя указанный`толерантность` . (2 methods) |
...
| [operator ==](../../aspose.gis.geometries/geometrycollection/op_equality) | Реализует оператор ==. |
| [operator !=](../../aspose.gis.geometries/geometrycollection/op_inequality) | Реализует оператор !=. |
