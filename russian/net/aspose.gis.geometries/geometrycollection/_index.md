...
description: Aspose.Gis.Geometries.GeometryCollection сорт. АGeometryCollection этоGeometry это набор из одной или нескольких геометрий.
type: docs
weight: 930
...
А`GeometryCollection` это[`Geometry`](../geometry/) это набор из одной или нескольких геометрий.
...
| Имя | Описание |
| --- | --- |
| [GeometryCollection](geometrycollection/)() | Инициализирует новый экземпляр`GeometryCollection` класс. |
