...
description: AGeometryCollection./geometrycollectionявляетсяGeometry./geometryэто набор из одной или нескольких геометрий.
type: docs
weight: 820
...
A[`GeometryCollection`](../geometrycollection)является[`Geometry`](../geometry)это набор из одной или нескольких геометрий.
...
| Имя | Описание |
| --- | --- |
| [GeometryCollection](geometrycollection)() | Инициализирует новый экземпляр класса[`GeometryCollection`](../geometrycollection). |
...
| override [Dimension](../../aspose.gis.geometries/geometrycollection/dimension) { get; } | Получает топологическую размерность этого[`Geometry`](../geometry). Если коллекция пуста, возвращаетсяPoint. |
...
| [ToLinearGeometry](../../aspose.gis.geometries/geometrycollection/tolineargeometry#tolineargeometry_2)() | Получает приблизительную или эквивалентную некривую версию этой геометрии, используя допуск по умолчанию . (2 methods) |
| [ToLinearGeometry](../../aspose.gis.geometries/geometrycollection/tolineargeometry#tolineargeometry_3)(double) | Получает приблизительную или эквивалентную некривую версию этой геометрии с использованием указанного допуска . (2 methods) |
