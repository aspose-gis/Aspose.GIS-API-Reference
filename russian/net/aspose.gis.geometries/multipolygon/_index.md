...
description: Aspose.Gis.Geometries.MultiPolygon сорт. АMultiPolygon является одномерным GeometryCollection чьи элементыPolygon с.
type: docs
weight: 1170
...
А`MultiPolygon` является одномерным [`GeometryCollection`](../geometrycollection/) чьи элементы[`Polygon`](../polygon/) с.
...
| Имя | Описание |
| --- | --- |
| [MultiPolygon](multipolygon/)() | Инициализирует новый экземпляр`MultiPolygon` класс. |
