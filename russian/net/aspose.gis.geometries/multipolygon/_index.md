...
description: АMultiPolygon./multipolygon является одномерным GeometryCollection./geometrycollection чьи элементыPolygon./polygon с.
type: docs
weight: 1070
...
А[`MultiPolygon`](../multipolygon) является одномерным [`GeometryCollection`](../geometrycollection) чьи элементы[`Polygon`](../polygon) с.
...
| Имя | Описание |
| --- | --- |
| [MultiPolygon](multipolygon)() | Инициализирует новый экземпляр[`MultiPolygon`](../multipolygon) класс. |
...
| [ToLinearGeometry](../../aspose.gis.geometries/multisurface/tolineargeometry)() | Получает приблизительную или эквивалентную некривую версию этой геометрии, используя значение по умолчанию.`толерантность` . (3 methods) |
| [ToLinearGeometry](../../aspose.gis.geometries/multisurface/tolineargeometry)(double) | Получает приблизительную или эквивалентную некривую версию этой геометрии, используя указанный`толерантность` . (3 methods) |
