...
description: AMultiPolygon./multipolygonявляется одномерным GeometryCollection./geometrycollectionэлементами которого являютсяPolygon./polygons.
type: docs
weight: 1060
url: /ru/net/aspose.gis.geometries/multipolygon/
---
## MultiPolygon class

A[`MultiPolygon`](../multipolygon)является одномерным [`GeometryCollection`](../geometrycollection)элементами которого являются[`Polygon`](../polygon)s.
...
| Имя | Описание |
| --- | --- |
| [MultiPolygon](multipolygon)() | Инициализирует новый экземпляр класса[`MultiPolygon`](../multipolygon). |
...
| override [GeometryType](../../aspose.gis.geometries/multipolygon/geometrytype) { get; } | Получает тип геометрии. |
...
| override [Clone](../../aspose.gis.geometries/multipolygon/clone)() | Клонирует этот экземпляр. |
...
| [ToEditable](../../aspose.gis.geometries/multipolygon/toeditable#toeditable_2)() | Получает редактируемую копию этой геометрии. (4 methods) |
| [ToEditable&lt;T&gt;](../../aspose.gis.geometries/geometry/toeditable)() | Получает редактируемую копию этой геометрии. |
| [ToLinearGeometry](../../aspose.gis.geometries/multisurface/tolineargeometry)() | Получает приблизительную или эквивалентную некривую версию этой геометрии, используя допуск по умолчанию . (3 methods) |
| [ToLinearGeometry](../../aspose.gis.geometries/multisurface/tolineargeometry)(double) | Получает приблизительную или эквивалентную некривую версию этой геометрии с использованием указанного допуска . (3 methods) |
