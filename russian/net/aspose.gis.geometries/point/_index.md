...
description: APoint./pointпредставляет одно место в координатном пространстве.
type: docs
weight: 1080
...
A[`Point`](../point)представляет одно место в координатном пространстве.
...
| Имя | Описание |
| --- | --- |
| [Point](point#constructor)() | Инициализирует новый экземпляр класса[`Point`](../point). |
| [Point](point#constructor_1)(IPoint) | Инициализирует новый экземпляр класса[`Point`](../point). |
| [Point](point#constructor_2)(double, double) | Инициализирует новый экземпляр класса[`Point`](../point). |
| [Point](point#constructor_3)(double, double, double) | Инициализирует новый экземпляр класса[`Point`](../point). |
| [Point](point#constructor_4)(double, double, double, double) | Инициализирует новый экземпляр класса[`Point`](../point). |
...
| override [HasM](../../aspose.gis.geometries/point/hasm) { get; set; } | Получает значение, указывающее, имеет ли данный экземпляр координату М. |
...
| override [GetHashCode](../../aspose.gis.geometries/point/gethashcode)() | Служит хэш-функцией по умолчанию. |
...
| override [SetEmpty](../../aspose.gis.geometries/point/setempty)() | Делает это[`Geometry`](../geometry)пустым. |
...
| [ToLinearGeometry](../../aspose.gis.geometries/geometry/tolineargeometry)() | Получает приблизительную или эквивалентную некривую версию этой геометрии, используя допуск по умолчанию . |
| [ToLinearGeometry](../../aspose.gis.geometries/geometry/tolineargeometry)(double) | Получает приблизительную или эквивалентную некривую версию этой геометрии с использованием указанного допуска . |
