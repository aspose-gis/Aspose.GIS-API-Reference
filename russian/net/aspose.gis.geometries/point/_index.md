...
description: Aspose.Gis.Geometries.Point сорт. АPoint представляет одно место в координатном пространстве.
type: docs
weight: 1190
...
А`Point` представляет одно место в координатном пространстве.
...
| Имя | Описание |
| --- | --- |
| [Point](point/#constructor)() | Инициализирует новый экземпляр`Point` класс. |
| [Point](point/#constructor_1)(IPoint) | Инициализирует новый экземпляр`Point` класс. |
| [Point](point/#constructor_2)(double, double) | Инициализирует новый экземпляр`Point` класс. |
| [Point](point/#constructor_3)(double, double, double) | Инициализирует новый экземпляр`Point` класс. |
| [Point](point/#constructor_4)(double, double, double, double) | Инициализирует новый экземпляр`Point` класс. |
