...
description: АPolygon./polygon представляет собой плоскую поверхность определяемую 1 внешней границей и 0 или более внутренними границами.
type: docs
weight: 1100
...
А[`Polygon`](../polygon) представляет собой плоскую поверхность, определяемую 1 внешней границей и 0 или более внутренними границами.
...
| Имя | Описание |
| --- | --- |
| [Polygon](polygon#constructor)() | Инициализирует новый экземпляр[`Polygon`](../polygon) класс. |
| [Polygon](polygon#constructor_1)(ILinearRing) | Инициализирует новый экземпляр[`Polygon`](../polygon) класс. |
| [Polygon](polygon#constructor_2)(ILinearRing, IEnumerable&lt;ILinearRing&gt;) | Инициализирует новый экземпляр[`Polygon`](../polygon) класс. |
