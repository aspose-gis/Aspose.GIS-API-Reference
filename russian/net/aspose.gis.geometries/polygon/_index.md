...
description: APolygon./polygonплоская поверхность определенная 1 внешней границей и 0 или более внутренних границ.
type: docs
weight: 1090
...
A[`Polygon`](../polygon)плоская поверхность, определенная 1 внешней границей и 0 или более внутренних границ.
...
| Имя | Описание |
| --- | --- |
| [Polygon](polygon#constructor)() | Инициализирует новый экземпляр класса[`Polygon`](../polygon). |
| [Polygon](polygon#constructor_1)(ILinearRing) | Инициализирует новый экземпляр класса[`Polygon`](../polygon). |
| [Polygon](polygon#constructor_2)(ILinearRing, IEnumerable&lt;ILinearRing&gt;) | Инициализирует новый экземпляр класса[`Polygon`](../polygon). |
...
| override [GetHashCode](../../aspose.gis.geometries/polygon/gethashcode)() | Служит хэш-функцией по умолчанию. |
...
| override [SetEmpty](../../aspose.gis.geometries/polygon/setempty)() | Делает это[`Geometry`](../geometry)пустым. |
