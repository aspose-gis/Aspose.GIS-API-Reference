...
description: Aspose.Gis.Geometries.CircularString сорт. Многовершинная кривая с круговой интерполяцией между точками.
type: docs
weight: 880
...
| Имя | Описание |
| --- | --- |
| [CircularString](circularstring/#constructor)() | Инициализирует новый экземпляр`CircularString` класс. |
| [CircularString](circularstring/#constructor_1)(ICircularString) | Инициализирует новый экземпляр`CircularString` класс. |
| [CircularString](circularstring/#constructor_2)(IEnumerable&lt;IPoint&gt;) | Инициализирует новый экземпляр`CircularString` класс. |
...
| [Count](../../aspose.gis.geometries/circularstring/count/) { get; } | Получает количество точек в`CircularString` . |
...
| override [Reverse](../../aspose.gis.geometries/circularstring/reverse/)() | Обратный порядок точек в этом`CircularString` . |
