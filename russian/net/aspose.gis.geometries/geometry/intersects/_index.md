...
description: Geometry метод. Определяет пересекает ли эта геометрия заданный экстент.
type: docs
weight: 280
...
Этот метод эквивалентен: Это отрицание[`Disjoint`](../../igeometry/disjoint/) . Видеть[`Disjoint`](../../igeometry/disjoint/) для более подробной информации.
