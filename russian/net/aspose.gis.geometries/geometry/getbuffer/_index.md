...
Геометрия, представляющая все точки, находящиеся в пределах заданного расстояния от этой геометрии. Тип результата:[`Null`](../null) ,[`IPolygon`](../../ipolygon) или же[`IMultiPolygon`](../../imultipolygon) .
