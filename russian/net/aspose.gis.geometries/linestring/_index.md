...
description: Aspose.Gis.Geometries.LineString сорт. Многовершинная линия.
type: docs
weight: 1120
...
| Имя | Описание |
| --- | --- |
| [LineString](linestring/#constructor)() | Инициализирует новый экземпляр`LineString` класс. |
| [LineString](linestring/#constructor_2)(IEnumerable&lt;IPoint&gt;) | Инициализирует новый экземпляр`LineString` класс. |
| [LineString](linestring/#constructor_1)(ILineString) | Инициализирует новый экземпляр`LineString` класс. |
...
| [Count](../../aspose.gis.geometries/linestring/count/) { get; } | Получает количество точек в`LineString` . |
...
| override [Reverse](../../aspose.gis.geometries/linestring/reverse/)() | Обратный порядок точек в этом`LineString` . |
