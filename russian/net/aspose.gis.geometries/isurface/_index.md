...
description: Aspose.Gis.Geometries.ISurface интерфейс. АISurface представляет собой двумерный геометрический объект.
type: docs
weight: 1110
...
А`ISurface` представляет собой двумерный геометрический объект.
