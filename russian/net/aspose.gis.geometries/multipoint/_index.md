...
description: Aspose.Gis.Geometries.MultiPoint сорт. АMultiPoint является одномернымGeometryCollection  элементы которогоPoint с.
type: docs
weight: 1160
...
А`MultiPoint` является одномерным[`GeometryCollection`](../geometrycollection/) , элементы которого[`Point`](../point/) с.
...
| Имя | Описание |
| --- | --- |
| [MultiPoint](multipoint/)() | Инициализирует новый экземпляр`MultiPoint` класс. |
