...
description: ACurve./curveпредставляет собой последовательность точек.
type: docs
weight: 790
...
A[`Curve`](../curve)представляет собой последовательность точек.
...
| [ToLinearGeometry](../../aspose.gis.geometries/curve/tolineargeometry#tolineargeometry_2)() | Получает приблизительную или эквивалентную некривую версию этой геометрии, используя допуск по умолчанию . (2 methods) |
| [ToLinearGeometry](../../aspose.gis.geometries/curve/tolineargeometry#tolineargeometry_3)(double) | Получает приблизительную или эквивалентную некривую версию этой геометрии с использованием указанного допуска . (2 methods) |
