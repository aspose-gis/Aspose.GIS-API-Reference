...
| Имя | Описание |
| --- | --- |
| [Dimension](../../aspose.gis.geometries/igeometry/dimension) { get; } | Получает топологическую размерность этого[`IGeometry`](../igeometry) . Если размер неизвестен (например, для пустой коллекции GEOMETRYCOLLECTION)Point возвращается. |
