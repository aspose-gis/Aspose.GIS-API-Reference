...
description: IGeometry метод. Вычисляет область буфера вокруг этой геометрии.
type: docs
weight: 200
...
Геометрия, представляющая все точки, находящиеся в пределах заданного расстояния от этой геометрии. Тип результата:[`Null`](../../geometry/null/) ,[`IPolygon`](../../ipolygon/) или[`IMultiPolygon`](../../imultipolygon/) .
