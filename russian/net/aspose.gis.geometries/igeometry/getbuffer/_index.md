...
| --- | --- | --- |
| distance | Double | Ширина области буфера (в единицах пространственной привязки). |
...
Геометрия, представляющая все точки, находящиеся внутри заданное расстояние от этой геометрии. Тип результата:[`Null`](../../geometry/null),[`IPolygon`](../../ipolygon)или[`IMultiPolygon`](../../imultipolygon).
