...
Геометрия, не имеющая кривых геометрий. Применяются следующие преобразования: &lt;ul&gt;&lt;li&gt;CircularStringлинеаризуются (преобразуются вLineStrings с указанным*tolerance*) &lt;/li&gt;&lt;li&gt;CompoundCurves объединяются в` LineString` s &lt;/li&gt;&lt;li&gt;CurvePolygons преобразуются вPolygons &lt;/li&gt;&lt;li&gt;MultiCurves преобразуются вMultiLineStrings &lt;/li&gt;&lt;li&gt;MultiSurfaces преобразуются вMultiPolygons &lt;/li&gt;&lt;/ul&gt; В результате[`HasCurveGeometry`](../hascurvegeometry)выходной геометрии:`false`.
