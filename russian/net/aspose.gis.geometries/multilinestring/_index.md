...
description: Aspose.Gis.Geometries.MultiLineString сорт. АMultiLineString является одномернымGeometryCollection  элементы которогоLineString с.
type: docs
weight: 1150
url: /ru/net/aspose.gis.geometries/multilinestring/
---
## MultiLineString class

А`MultiLineString` является одномерным[`GeometryCollection`](../geometrycollection/) , элементы которого[`LineString`](../linestring/) с.
...
| Имя | Описание |
| --- | --- |
| [MultiLineString](multilinestring/)() | Инициализирует новый экземпляр`MultiLineString` класс. |
...
| [Dimension](../../aspose.gis.geometries/multicurve/dimension/) { get; } | Получает топологическую размерность этого[`Geometry`](../geometry/) . |
| override [GeometryType](../../aspose.gis.geometries/multilinestring/geometrytype/) { get; } | Получает тип геометрии. |
...
| virtual [IsClosed](../../aspose.gis.geometries/multicurve/isclosed/) { get; } | Определяет, замкнута ли эта кривая. |
...
| override [Clone](../../aspose.gis.geometries/multilinestring/clone/)() | Клонирует этот экземпляр. |
...
| [ToEditable](../../aspose.gis.geometries/multilinestring/toeditable/#toeditable_3)() | Получает редактируемую копию этой геометрии. (4 methods) |
| [ToEditable&lt;T&gt;](../../aspose.gis.geometries/geometry/toeditable/)() | Получает редактируемую копию этой геометрии. |
| [ToLinearGeometry](../../aspose.gis.geometries/multicurve/tolineargeometry/)() | Получает приблизительную или эквивалентную некривую версию этой геометрии, используя значение по умолчанию.`толерантность` . (3 methods) |
| [ToLinearGeometry](../../aspose.gis.geometries/multicurve/tolineargeometry/)(double) | Получает приблизительную или эквивалентную некривую версию этой геометрии, используя указанный`толерантность` . (3 methods) |
