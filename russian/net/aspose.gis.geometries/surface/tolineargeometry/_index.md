...
description: Surface метод. Получает приблизительную или эквивалентную некривую версию этой геометрии используя значение по умолчанию.толерантность .
type: docs
weight: 40
url: /ru/net/aspose.gis.geometries/surface/tolineargeometry/
---
