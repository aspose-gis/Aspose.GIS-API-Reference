...
A[`IPolygon`](../../ipolygon)что приблизительно или эквивалент этому` ISurface` : &lt;ul&gt; Если этот объект[`IPolygon`](../../ipolygon)сам результат эквивалентен этому объекту Если этот объект не[`IPolygon`](../../ipolygon)он линеаризуется и[`IPolygon`](../../ipolygon)создается &lt;/ul&gt;
