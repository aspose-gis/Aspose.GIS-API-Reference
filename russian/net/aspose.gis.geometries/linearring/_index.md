...
description: ALinearRing./linearringявляетсяLineString./linestringэто и закрыто и просто.
type: docs
weight: 1020
...
A[`LinearRing`](../linearring)является[`LineString`](../linestring)это и закрыто, и просто.
...
| Имя | Описание |
| --- | --- |
| [LinearRing](linearring#constructor)() | Инициализирует новый экземпляр класса[`LinearRing`](../linearring). |
| [LinearRing](linearring#constructor_2)(IEnumerable&lt;IPoint&gt;) | Инициализирует новый экземпляр класса[`LinearRing`](../linearring). |
| [LinearRing](linearring#constructor_1)(ILineString) | Инициализирует новый экземпляр класса[`LinearRing`](../linearring). |
