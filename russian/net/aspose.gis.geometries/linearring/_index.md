...
description: АLinearRing./linearring этоLineString./linestring это и закрыто и просто.
type: docs
weight: 1030
...
А[`LinearRing`](../linearring) это[`LineString`](../linestring) это и закрыто, и просто.
...
| Имя | Описание |
| --- | --- |
| [LinearRing](linearring#constructor)() | Инициализирует новый экземпляр[`LinearRing`](../linearring) класс. |
| [LinearRing](linearring#constructor_2)(IEnumerable&lt;IPoint&gt;) | Инициализирует новый экземпляр[`LinearRing`](../linearring) класс. |
| [LinearRing](linearring#constructor_1)(ILineString) | Инициализирует новый экземпляр[`LinearRing`](../linearring) класс. |
