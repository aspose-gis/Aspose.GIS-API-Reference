...
description: Aspose.Gis.Geometries.LinearRing сорт. АLinearRing этоLineString это и закрыто и просто.
type: docs
weight: 1130
url: /ru/net/aspose.gis.geometries/linearring/
---
## LinearRing class

А`LinearRing` это[`LineString`](../linestring/) это и закрыто, и просто.
...
| Имя | Описание |
| --- | --- |
| [LinearRing](linearring/#constructor)() | Инициализирует новый экземпляр`LinearRing` класс. |
| [LinearRing](linearring/#constructor_2)(IEnumerable&lt;IPoint&gt;) | Инициализирует новый экземпляр`LinearRing` класс. |
| [LinearRing](linearring/#constructor_1)(ILineString) | Инициализирует новый экземпляр`LinearRing` класс. |
...
| override [GeometryType](../../aspose.gis.geometries/linearring/geometrytype/) { get; } | Получает тип геометрии. |
...
| Имя | Описание |
| --- | --- |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint/)(IPoint) | Добавляет точку в конец строки. |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint/)(double, double) | Добавляет точку в конец строки. |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint/)(double, double, double) | Добавляет точку в конец строки. |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint/)(double, double, double, double) | Добавляет точку в конец строки. |
...
| override [Clone](../../aspose.gis.geometries/linearring/clone/)() | Клонирует этот экземпляр. |
...
| [Equals](../../aspose.gis.geometries/linestring/equals/)(ILineString) | Указывает, равен ли текущий объект другому объекту того же типа. |
| override [Equals](../../aspose.gis.geometries/linestring/equals/)(object) | Определяет, равен ли указанный объект текущему объекту. |
...
| [IsClockwise](../../aspose.gis.geometries/linearring/isclockwise/)() | Определяет, имеет ли кольцо обмотку по часовой стрелке. |
...
| [ToEditable](../../aspose.gis.geometries/linearring/toeditable/#toeditable_2)() | Получает редактируемую копию этой геометрии. (4 methods) |
