...
| Имя | Описание |
| --- | --- |
| [MultiCurve](multicurve)() | Инициализирует новый экземпляр класса[`MultiCurve`](../multicurve). |
...
| [ToLinearGeometry](../../aspose.gis.geometries/multicurve/tolineargeometry#tolineargeometry_4)() | Получает приблизительную или эквивалентную некривую версию этой геометрии, используя допуск по умолчанию . (3 methods) |
| [ToLinearGeometry](../../aspose.gis.geometries/multicurve/tolineargeometry#tolineargeometry_5)(double) | Получает приблизительную или эквивалентную некривую версию этой геометрии с использованием указанного допуска . (3 methods) |
