...
description: Aspose.Gis.Geometries.MultiCurve сорт. АMultiCurve является одномернымGeometryCollection  элементы которогоCurve с.
type: docs
weight: 1140
url: /ru/net/aspose.gis.geometries/multicurve/
---
## MultiCurve class

А`MultiCurve` является одномерным[`GeometryCollection`](../geometrycollection/) , элементы которого[`Curve`](../curve/) с.
...
| Имя | Описание |
| --- | --- |
| [MultiCurve](multicurve/)() | Инициализирует новый экземпляр`MultiCurve` класс. |
...
| override [GeometryType](../../aspose.gis.geometries/multicurve/geometrytype/) { get; } | Получает тип геометрии. |
...
| override [Clone](../../aspose.gis.geometries/multicurve/clone/)() | Клонирует этот экземпляр. |
...
| [ToEditable](../../aspose.gis.geometries/multicurve/toeditable/#toeditable_2)() | Получает редактируемую копию этой геометрии. (3 methods) |
| [ToEditable&lt;T&gt;](../../aspose.gis.geometries/geometry/toeditable/)() | Получает редактируемую копию этой геометрии. |
| [ToLinearGeometry](../../aspose.gis.geometries/multicurve/tolineargeometry/#tolineargeometry_4)() | Получает приблизительную или эквивалентную некривую версию этой геометрии, используя значение по умолчанию.`толерантность` . (3 methods) |
| [ToLinearGeometry](../../aspose.gis.geometries/multicurve/tolineargeometry/#tolineargeometry_5)(double) | Получает приблизительную или эквивалентную некривую версию этой геометрии, используя указанный`толерантность` . (3 methods) |
