...
description: Aspose.Gis.Geometries.ICompoundCurve интерфейс. Кривая представляющая собой последовательность смежных кривых так что соседние кривые соединяются в своих конечных точках.
type: docs
weight: 970
...
| Имя | Описание |
| --- | --- |
| [Count](../../aspose.gis.geometries/icompoundcurve/count/) { get; } | Получает количество кривых в`ICompoundCurve` . |
