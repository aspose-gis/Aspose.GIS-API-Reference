...
description: Aspose.Gis.Geometries.CurvePolygon сорт. Плоская поверхность определяемая 1 внешней границей и 0 или более внутренними границами.
type: docs
weight: 910
...
| Имя | Описание |
| --- | --- |
| [CurvePolygon](curvepolygon/#constructor)() | Инициализирует новый экземпляр`CurvePolygon` класс. |
| [CurvePolygon](curvepolygon/#constructor_1)(ICurve) | Инициализирует новый экземпляр`CurvePolygon` класс. |
| [CurvePolygon](curvepolygon/#constructor_2)(ICurve, IEnumerable&lt;ICurve&gt;) | Инициализирует новый экземпляр`CurvePolygon` класс. |
...
| override [Clone](../../aspose.gis.geometries/curvepolygon/clone/)() | Клонирует этот экземпляр. |
...
| [operator ==](../../aspose.gis.geometries/curvepolygon/op_equality/) | Реализует оператор ==. |
| [operator !=](../../aspose.gis.geometries/curvepolygon/op_inequality/) | Реализует оператор !=. |
