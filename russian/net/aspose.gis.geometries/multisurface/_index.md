...
description: AMultiSurface./multisurfaceявляется одномернымGeometryCollection./geometrycollectionэлементами которого являютсяISurface./isurfaces.
type: docs
weight: 1070
...
A[`MultiSurface`](../multisurface)является одномерным[`GeometryCollection`](../geometrycollection)элементами которого являются[`ISurface`](../isurface)s.
...
| Имя | Описание |
| --- | --- |
| [MultiSurface](multisurface)() | Инициализирует новый экземпляр класса[`MultiSurface`](../multisurface). |
...
| [ToLinearGeometry](../../aspose.gis.geometries/multisurface/tolineargeometry#tolineargeometry_4)() | Получает приблизительную или эквивалентную некривую версию этой геометрии, используя допуск по умолчанию . (3 methods) |
| [ToLinearGeometry](../../aspose.gis.geometries/multisurface/tolineargeometry#tolineargeometry_5)(double) | Получает приблизительную или эквивалентную некривую версию этой геометрии с использованием указанного допуска . (3 methods) |
