...
description: Aspose.Gis.Geometries.MultiSurface сорт. АMultiSurface является одномернымGeometryCollection чьи элементыISurface с.
type: docs
weight: 1180
...
А`MultiSurface` является одномерным[`GeometryCollection`](../geometrycollection/) чьи элементы[`ISurface`](../isurface/) с.
...
| Имя | Описание |
| --- | --- |
| [MultiSurface](multisurface/)() | Инициализирует новый экземпляр`MultiSurface` класс. |
