...
description: IMultiSurface метод. Получает приблизительную или эквивалентную некривую версию этой геометрии используя значение по умолчанию.толерантность .
type: docs
weight: 20
url: /ru/net/aspose.gis.geometries/imultisurface/tolineargeometry/
---
...
А[`IMultiPolygon`](../../imultipolygon/) который приближается или эквивалентен этому[`IMultiSurface`](../) :  Если этот объект[`IMultiPolygon`](../../imultipolygon/) сам по себе результат эквивалентен этому объекту Если этот объект не[`IMultiPolygon`](../../imultipolygon/) - все поверхности линеаризованы и новые`IMultiPolygon` создан
