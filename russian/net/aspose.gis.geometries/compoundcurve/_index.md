...
| Имя | Описание |
| --- | --- |
| [CompoundCurve](compoundcurve#constructor)() | Инициализирует новый экземпляр класса[`CompoundCurve`](../compoundcurve). |
| [CompoundCurve](compoundcurve#constructor_1)(ICompoundCurve) | Инициализирует новый экземпляр класса[`CompoundCurve`](../compoundcurve). |
| [CompoundCurve](compoundcurve#constructor_2)(IEnumerable&lt;ICurve&gt;) | Инициализирует новый экземпляр класса[`CompoundCurve`](../compoundcurve). |
...
| override [HasCurveGeometry](../../aspose.gis.geometries/compoundcurve/hascurvegeometry) { get; } | Получает значение, указывающее, является ли эта геометрия кривой (не линейной) или содержит ее. |
...
| [GetEnumerator](../../aspose.gis.geometries/compoundcurve/getenumerator)() | Возвращает перечислитель, который перебирает коллекцию. |
| [GetExtent](../../aspose.gis.geometries/geometry/getextent)() | Вычисляет и возвращает ограничивающий экстент этой геометрии. |
| override [GetHashCode](../../aspose.gis.geometries/compoundcurve/gethashcode)() | Служит хэш-функцией по умолчанию. |
...
| override [Reverse](../../aspose.gis.geometries/compoundcurve/reverse)() | Отменяет это[`CompoundCurve`](../compoundcurve). То есть - обратный порядок кривых и каждая кривая внутри этой составной кривой. |
...
| override [SetEmpty](../../aspose.gis.geometries/compoundcurve/setempty)() | Делает это[`Geometry`](../geometry)пустым. |
