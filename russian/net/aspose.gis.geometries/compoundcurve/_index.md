...
description: Aspose.Gis.Geometries.CompoundCurve сорт. Кривая представляющая собой последовательность смежных кривых так что соседние кривые соединяются в своих конечных точках.
type: docs
weight: 890
...
| Имя | Описание |
| --- | --- |
| [CompoundCurve](compoundcurve/#constructor)() | Инициализирует новый экземпляр`CompoundCurve` класс. |
| [CompoundCurve](compoundcurve/#constructor_1)(ICompoundCurve) | Инициализирует новый экземпляр`CompoundCurve` класс. |
| [CompoundCurve](compoundcurve/#constructor_2)(IEnumerable&lt;ICurve&gt;) | Инициализирует новый экземпляр`CompoundCurve` класс. |
...
| Имя | Описание |
| --- | --- |
| [AddCurve](../../aspose.gis.geometries/compoundcurve/addcurve/)(ICurve) | Добавляет кривую в конец этого`CompoundCurve` . |
...
| override [Reverse](../../aspose.gis.geometries/compoundcurve/reverse/)() | Отменяет это`CompoundCurve` . То есть - обратный порядок кривых и каждой кривой внутри этой составной кривой. |
