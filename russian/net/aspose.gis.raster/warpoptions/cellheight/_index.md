...
description: Определяет новую высоту растровой ячейки в целевых единицах с географической привязкой. Если установлено значение 0CellHeightaspose.gis.raster/warpoptions/cellheight вычисляется автоматически. Значение по умолчанию  0.
type: docs
weight: 20
