...
description: Aspose.Gis.Formats.Shapefile.ShapefileOptions сорт. Специфичные для драйвера параметры для формата Shapefile. На данный момент драйвер не предоставляет настраиваемых параметров.
type: docs
weight: 670
url: /ru/net/aspose.gis.formats.shapefile/shapefileoptions/
---
## ShapefileOptions class

Специфичные для драйвера параметры для формата Shapefile. На данный момент драйвер не предоставляет настраиваемых параметров.
...
| Имя | Описание |
| --- | --- |
| [ShapefileOptions](shapefileoptions/)() | Создать новый экземпляр. |
