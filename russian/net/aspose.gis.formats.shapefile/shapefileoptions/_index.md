...
description: Параметры драйвера для формата Shapefile. На данный момент драйвер не предоставляет настраиваемых параметров.
type: docs
weight: 600
...
Параметры драйвера для формата Shapefile. На данный момент драйвер не предоставляет настраиваемых параметров.
