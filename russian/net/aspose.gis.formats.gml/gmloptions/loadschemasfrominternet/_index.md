...
description: GmlOptions свойство. Определяет разрешено ли Aspose.GIS загружать схему XML из Интернета. Если установлено значениеfalse схемы с абсолютными URI которые не начинаются с file// не будут загружены. Значение по умолчаниюfalse .
type: docs
weight: 20
