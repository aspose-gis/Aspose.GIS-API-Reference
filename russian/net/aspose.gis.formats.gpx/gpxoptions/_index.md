...
description: Aspose.Gis.Formats.Gpx.GpxOptions сорт. Параметры драйвера для формата GPX.
type: docs
weight: 370
...
| [MAttribute](../../aspose.gis.formats.gpx/gpxoptions/mattribute/) { get; set; } | Определяет, какой атрибут GPX будет экспортироваться как координата «M» путевых точек, точек маршрута и точек трека. Поведение такое же, как и для[`ZAttribute`](./zattribute/) , по умолчанию`null` . |
