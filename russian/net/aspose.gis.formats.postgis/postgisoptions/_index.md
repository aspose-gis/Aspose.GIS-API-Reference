...
description: Aspose.Gis.Formats.PostGis.PostGisOptions сорт. Параметры драйвера для формата PostGis. На данный момент драйвер не предоставляет настраиваемых параметров.
type: docs
weight: 650
url: /ru/net/aspose.gis.formats.postgis/postgisoptions/
---
## PostGisOptions class

Параметры драйвера для формата PostGis. На данный момент драйвер не предоставляет настраиваемых параметров.
...
| Имя | Описание |
| --- | --- |
| [PostGisOptions](postgisoptions/)() | Создать новый экземпляр. |
