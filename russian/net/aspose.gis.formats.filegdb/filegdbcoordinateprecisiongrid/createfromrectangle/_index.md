...
description: FileGdbCoordinatePrecisionGrid метод. Создает новыйFileGdbCoordinatePrecisionGrid так что все значения внутри прямоугольника могут быть представлены.
type: docs
weight: 20
