...
description: Параметры драйвера для формата TopoJSON.
type: docs
weight: 640
...
| [DefaultObjectName](../../aspose.gis.formats.topojson/topojsonoptions/defaultobjectname) { get; set; } | Имя объекта, в который по умолчанию помещаются признаки. |
...
| [NestedPropertiesSeparator](../../aspose.gis.formats.topojson/topojsonoptions/nestedpropertiesseparator) { get; set; } | Получает или задает строку, используемую для разделения компонентов вложенных атрибутов. По умолчанию "_". |
...
| [QuantizationNumber](../../aspose.gis.formats.topojson/topojsonoptions/quantizationnumber) { get; set; } | Указывает номер квантования, используемый для квантования координат и дельта-кодирования дуг в выходных данных TopoJSON. |
