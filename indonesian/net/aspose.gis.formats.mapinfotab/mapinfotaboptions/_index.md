...
description: Aspose.Gis.Formats.MapInfoTab.MapInfoTabOptions kelas. Opsi khusus driver untuk format Tab MapInfo.
type: docs
weight: 610
url: /id/net/aspose.gis.formats.mapinfotab/mapinfotaboptions/
---
## MapInfoTabOptions class

Opsi khusus driver untuk format Tab MapInfo.
...
| Nama | Keterangan |
| --- | --- |
| [MapInfoTabOptions](mapinfotaboptions/)() | Buat instance baru. |

## Properti

| Nama | Keterangan |
| --- | --- |
| [BlockSize](../../aspose.gis.formats.mapinfotab/mapinfotaboptions/blocksize/) { get; set; } | Ukuran blok untuk file '*.map' (kelipatan 512). Default ke 16384. Nilai yang valid: 512 hingga 32256. |
...
| [TextStringAttribute](../../aspose.gis.formats.mapinfotab/mapinfotaboptions/textstringattribute/) { get; set; } | Menentukan nama atribut yang mewakili teks objek grafis 'Teks'. |
...
* ruang nama [Aspose.Gis.Formats.MapInfoTab](../../aspose.gis.formats.mapinfotab/)
