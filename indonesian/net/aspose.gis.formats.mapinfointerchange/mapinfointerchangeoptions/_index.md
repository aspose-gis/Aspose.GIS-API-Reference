...
description: Aspose.Gis.Formats.MapInfoInterchange.MapInfoInterchangeOptions kelas. Opsi khusus driver untuk format MapInfo Interchange.
type: docs
weight: 590
url: /id/net/aspose.gis.formats.mapinfointerchange/mapinfointerchangeoptions/
---
## MapInfoInterchangeOptions class

Opsi khusus driver untuk format MapInfo Interchange.
...
| Nama | Keterangan |
| --- | --- |
| [MapInfoInterchangeOptions](mapinfointerchangeoptions/)() | Buat instance baru. |
...
| [TextStringAttribute](../../aspose.gis.formats.mapinfointerchange/mapinfointerchangeoptions/textstringattribute/) { get; set; } | Menentukan nama atribut yang mewakili teks objek grafis 'Teks'. |
...
* ruang nama [Aspose.Gis.Formats.MapInfoInterchange](../../aspose.gis.formats.mapinfointerchange/)
