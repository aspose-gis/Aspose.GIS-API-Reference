...
description: Aspose.Gis.Formats.GDAL.GdalOptions kelas. Opsi khusus driver untuk format GDAL.
type: docs
weight: 290
url: /id/net/aspose.gis.formats.gdal/gdaloptions/
---
## GdalOptions class

Opsi khusus driver untuk format GDAL.
...
| Nama | Keterangan |
| --- | --- |
| [GdalOptions](gdaloptions/)(string) | Buat instance baru. |
...
| [FileName](../../aspose.gis.formats.gdal/gdaloptions/filename/) { get; set; } | Nama aplikasi yang akan dijalankan |
...
| [PathToTempFile](../../aspose.gis.formats.gdal/gdaloptions/pathtotempfile/) { get; } | Jalur ke file sementara. |
