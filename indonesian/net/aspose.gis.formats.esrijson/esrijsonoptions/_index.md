...
description: Aspose.Gis.Formats.EsriJson.EsriJsonOptions kelas. Opsi khusus driver untuk format EsriJson.
type: docs
weight: 240
url: /id/net/aspose.gis.formats.esrijson/esrijsonoptions/
---
## EsriJsonOptions class

Opsi khusus driver untuk format EsriJson.
...
| Nama | Keterangan |
| --- | --- |
| [EsriJsonOptions](esrijsonoptions/)() | Buat instance baru. |
...
| [NestedPropertiesSeparator](../../aspose.gis.formats.esrijson/esrijsonoptions/nestedpropertiesseparator/) { get; set; } | Mendapat atau menetapkan string yang digunakan untuk memisahkan komponen atribut bersarang. Standarnya adalah "_". |
...
* ruang nama [Aspose.Gis.Formats.EsriJson](../../aspose.gis.formats.esrijson/)
