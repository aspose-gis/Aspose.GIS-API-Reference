...
description: Aspose.Gis.Formats.SqlServer.SqlServerOptions kelas. Opsi khusus driver untuk format SqlServer. Saat ini driver tidak menyediakan opsi yang dapat disesuaikan.
type: docs
weight: 690
url: /id/net/aspose.gis.formats.sqlserver/sqlserveroptions/
---
## SqlServerOptions class

Opsi khusus driver untuk format SqlServer. Saat ini, driver tidak menyediakan opsi yang dapat disesuaikan.
...
| Nama | Keterangan |
| --- | --- |
| [SqlServerOptions](sqlserveroptions/)() | Buat instance baru. |
