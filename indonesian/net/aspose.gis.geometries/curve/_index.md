...
description: Aspose.Gis.Geometries.Curve kelas. ACurve adalah urutan poin.
type: docs
weight: 900
url: /id/net/aspose.gis.geometries/curve/
---
## Curve class

A`Curve` adalah urutan poin.
...
| abstract [EndPoint](../../aspose.gis.geometries/curve/endpoint/) { get; } | Mengembalikan salinan titik akhir kurva. |
...
| abstract [StartPoint](../../aspose.gis.geometries/curve/startpoint/) { get; } | Mengembalikan salinan titik awal kurva. |
...
| abstract [Reverse](../../aspose.gis.geometries/curve/reverse/)() | Membalikkan kurva ini. |
...
| [ToEditable](../../aspose.gis.geometries/curve/toeditable/#toeditable)() | Mendapatkan salinan geometri ini yang dapat diedit. (2 methods) |
| [ToEditable&lt;T&gt;](../../aspose.gis.geometries/geometry/toeditable/)() | Mendapatkan salinan geometri ini yang dapat diedit. |
| [ToLinearGeometry](../../aspose.gis.geometries/curve/tolineargeometry/#tolineargeometry_2)() | Mendapat versi non-kurva perkiraan atau ekuivalen dari geometri ini menggunakan default`toleransi` . (2 methods) |
| [ToLinearGeometry](../../aspose.gis.geometries/curve/tolineargeometry/#tolineargeometry_3)(double) | Mendapatkan perkiraan atau versi non-kurva yang setara dari geometri ini menggunakan yang ditentukan`toleransi` . (2 methods) |
