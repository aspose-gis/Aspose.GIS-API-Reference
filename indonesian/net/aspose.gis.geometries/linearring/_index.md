...
description: Aspose.Gis.Geometries.LinearRing kelas. ALinearRing adalahLineString yang tertutup dan sederhana.
type: docs
weight: 1130
url: /id/net/aspose.gis.geometries/linearring/
---
## LinearRing class

A`LinearRing` adalah[`LineString`](../linestring/) yang tertutup dan sederhana.
...
| Nama | Keterangan |
| --- | --- |
| [LinearRing](linearring/#constructor)() | Menginisialisasi instance baru dari`LinearRing` kelas. |
| [LinearRing](linearring/#constructor_2)(IEnumerable&lt;IPoint&gt;) | Menginisialisasi instance baru dari`LinearRing` kelas. |
| [LinearRing](linearring/#constructor_1)(ILineString) | Menginisialisasi instance baru dari`LinearRing` kelas. |
...
| [Count](../../aspose.gis.geometries/linestring/count/) { get; } | Mendapat jumlah poin di[`LineString`](../linestring/) . |
...
| override [GeometryType](../../aspose.gis.geometries/linearring/geometrytype/) { get; } | Mendapatkan jenis geometri. |
...
| Nama | Keterangan |
| --- | --- |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint/)(IPoint) | Menambahkan titik ke akhir baris. |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint/)(double, double) | Menambahkan titik ke akhir baris. |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint/)(double, double, double) | Menambahkan titik ke akhir baris. |
| [AddPoint](../../aspose.gis.geometries/linestring/addpoint/)(double, double, double, double) | Menambahkan titik ke akhir baris. |
...
| override [Clone](../../aspose.gis.geometries/linearring/clone/)() | Menggandakan instance ini. |
...
| [Equals](../../aspose.gis.geometries/linestring/equals/)(ILineString) | Menunjukkan apakah objek saat ini sama dengan objek lain dari tipe yang sama. |
| override [Equals](../../aspose.gis.geometries/linestring/equals/)(object) | Menentukan apakah objek yang ditentukan sama dengan objek saat ini. |
...
| [IsClockwise](../../aspose.gis.geometries/linearring/isclockwise/)() | Menentukan apakah cincin memiliki putaran searah jarum jam. |
...
| override [Reverse](../../aspose.gis.geometries/linestring/reverse/)() | Membalik urutan poin dalam hal ini[`LineString`](../linestring/) . |
...
| [ToEditable](../../aspose.gis.geometries/linearring/toeditable/#toeditable_2)() | Mendapatkan salinan geometri ini yang dapat diedit. (4 methods) |
