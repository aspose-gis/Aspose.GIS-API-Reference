...
description: Aspose.Gis.Geometries.MultiCurve kelas. AMultiCurve adalah satu dimensiGeometryCollection yang elemennya adalahCurve s.
type: docs
weight: 1140
url: /id/net/aspose.gis.geometries/multicurve/
---
## MultiCurve class

A`MultiCurve` adalah satu dimensi[`GeometryCollection`](../geometrycollection/) yang elemennya adalah[`Curve`](../curve/) s.
...
| Nama | Keterangan |
| --- | --- |
| [MultiCurve](multicurve/)() | Menginisialisasi instance baru dari`MultiCurve` kelas. |
...
| override [GeometryType](../../aspose.gis.geometries/multicurve/geometrytype/) { get; } | Mendapatkan jenis geometri. |
...
| override [Clone](../../aspose.gis.geometries/multicurve/clone/)() | Menggandakan instance ini. |
...
| [ToEditable](../../aspose.gis.geometries/multicurve/toeditable/#toeditable_2)() | Mendapatkan salinan geometri ini yang dapat diedit. (3 methods) |
| [ToEditable&lt;T&gt;](../../aspose.gis.geometries/geometry/toeditable/)() | Mendapatkan salinan geometri ini yang dapat diedit. |
| [ToLinearGeometry](../../aspose.gis.geometries/multicurve/tolineargeometry/#tolineargeometry_4)() | Mendapat versi non-kurva perkiraan atau ekuivalen dari geometri ini menggunakan default`toleransi` . (3 methods) |
| [ToLinearGeometry](../../aspose.gis.geometries/multicurve/tolineargeometry/#tolineargeometry_5)(double) | Mendapatkan perkiraan atau versi non-kurva yang setara dari geometri ini menggunakan yang ditentukan`toleransi` . (3 methods) |
