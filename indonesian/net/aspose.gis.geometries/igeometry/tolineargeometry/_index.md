...
description: IGeometry metode. Mendapat versi nonkurva perkiraan atau ekuivalen dari geometri ini menggunakan defaulttoleransi .
type: docs
weight: 350
url: /id/net/aspose.gis.geometries/igeometry/tolineargeometry/
---
...
Geometri, yang tidak memiliki geometri kurva. Transformasi berikut diterapkan: CircularString s dilinearisasi (diubah menjadiLineString s dengan ditentukan*tolerance* )CompoundCurve s bergabung menjadi`String Garis` SCurvePolygon s diubah menjadiPolygon SMultiCurve s diubah menjadiMultiLineString SMultiSurface s diubah menjadiMultiPolygon S Akibatnya,[`HasCurveGeometry`](../hascurvegeometry/) geometri keluaran adalah`false` .
