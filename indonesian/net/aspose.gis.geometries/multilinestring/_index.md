...
description: Aspose.Gis.Geometries.MultiLineString kelas. AMultiLineString adalah satu dimensiGeometryCollection yang elemennya adalahLineString s.
type: docs
weight: 1150
url: /id/net/aspose.gis.geometries/multilinestring/
---
## MultiLineString class

A`MultiLineString` adalah satu dimensi[`GeometryCollection`](../geometrycollection/) yang elemennya adalah[`LineString`](../linestring/) s.
...
| Nama | Keterangan |
| --- | --- |
| [MultiLineString](multilinestring/)() | Menginisialisasi instance baru dari`MultiLineString` kelas. |
...
| [Dimension](../../aspose.gis.geometries/multicurve/dimension/) { get; } | Mendapat dimensi topologi ini[`Geometry`](../geometry/) . |
| override [GeometryType](../../aspose.gis.geometries/multilinestring/geometrytype/) { get; } | Mendapatkan jenis geometri. |
...
| virtual [IsClosed](../../aspose.gis.geometries/multicurve/isclosed/) { get; } | Menentukan apakah kurva ini tertutup. |
...
| override [Clone](../../aspose.gis.geometries/multilinestring/clone/)() | Menggandakan instance ini. |
...
| [ToEditable](../../aspose.gis.geometries/multilinestring/toeditable/#toeditable_3)() | Mendapatkan salinan geometri ini yang dapat diedit. (4 methods) |
| [ToEditable&lt;T&gt;](../../aspose.gis.geometries/geometry/toeditable/)() | Mendapatkan salinan geometri ini yang dapat diedit. |
| [ToLinearGeometry](../../aspose.gis.geometries/multicurve/tolineargeometry/)() | Mendapat versi non-kurva perkiraan atau ekuivalen dari geometri ini menggunakan default`toleransi` . (3 methods) |
| [ToLinearGeometry](../../aspose.gis.geometries/multicurve/tolineargeometry/)(double) | Mendapatkan perkiraan atau versi non-kurva yang setara dari geometri ini menggunakan yang ditentukan`toleransi` . (3 methods) |
