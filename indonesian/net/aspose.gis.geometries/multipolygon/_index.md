...
description: Aspose.Gis.Geometries.MultiPolygon kelas. AMultiPolygon adalah satu dimensiGeometryCollection yang unsurunsurnyaPolygon s.
type: docs
weight: 1170
url: /id/net/aspose.gis.geometries/multipolygon/
---
## MultiPolygon class

A`MultiPolygon` adalah satu dimensi[`GeometryCollection`](../geometrycollection/) yang unsur-unsurnya[`Polygon`](../polygon/) s.
...
| Nama | Keterangan |
| --- | --- |
| [MultiPolygon](multipolygon/)() | Menginisialisasi instance baru dari`MultiPolygon` kelas. |
...
| override [GeometryType](../../aspose.gis.geometries/multipolygon/geometrytype/) { get; } | Mendapatkan jenis geometri. |
...
| override [Clone](../../aspose.gis.geometries/multipolygon/clone/)() | Menggandakan instance ini. |
...
| [ToEditable](../../aspose.gis.geometries/multipolygon/toeditable/#toeditable_2)() | Mendapatkan salinan geometri ini yang dapat diedit. (4 methods) |
| [ToEditable&lt;T&gt;](../../aspose.gis.geometries/geometry/toeditable/)() | Mendapatkan salinan geometri ini yang dapat diedit. |
| [ToLinearGeometry](../../aspose.gis.geometries/multisurface/tolineargeometry/)() | Mendapat versi non-kurva perkiraan atau ekuivalen dari geometri ini menggunakan default`toleransi` . (3 methods) |
| [ToLinearGeometry](../../aspose.gis.geometries/multisurface/tolineargeometry/)(double) | Mendapatkan perkiraan atau versi non-kurva yang setara dari geometri ini menggunakan yang ditentukan`toleransi` . (3 methods) |
