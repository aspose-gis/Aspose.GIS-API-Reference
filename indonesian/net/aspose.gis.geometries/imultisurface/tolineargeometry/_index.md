...
description: IMultiSurface metode. Mendapat versi nonkurva perkiraan atau ekuivalen dari geometri ini menggunakan defaulttoleransi .
type: docs
weight: 20
url: /id/net/aspose.gis.geometries/imultisurface/tolineargeometry/
---
...
A[`IMultiPolygon`](../../imultipolygon/) yang mendekati atau setara dengan ini[`IMultiSurface`](../) :  Jika objek ini[`IMultiPolygon`](../../imultipolygon/) sendiri hasilnya setara dengan objek ini Jika objek ini tidak[`IMultiPolygon`](../../imultipolygon/) - semua permukaan dilinearisasi dan baru`IMultiPoligon` dibuat
