...
description: Aspose.Gis.Geometries.MultiSurface kelas. AMultiSurface adalah satu dimensiGeometryCollection yang unsurunsurnyaISurface s.
type: docs
weight: 1180
url: /id/net/aspose.gis.geometries/multisurface/
---
## MultiSurface class

A`MultiSurface` adalah satu dimensi[`GeometryCollection`](../geometrycollection/) yang unsur-unsurnya[`ISurface`](../isurface/) s.
...
| Nama | Keterangan |
| --- | --- |
| [MultiSurface](multisurface/)() | Menginisialisasi instance baru dari`MultiSurface` kelas. |
...
| [Dimension](../../aspose.gis.geometries/multisurface/dimension/) { get; } | Mendapat dimensi topologi ini[`Geometry`](../geometry/) . |
| override [GeometryType](../../aspose.gis.geometries/multisurface/geometrytype/) { get; } | Mendapatkan jenis geometri. |
...
| override [Clone](../../aspose.gis.geometries/multisurface/clone/)() | Menggandakan instance ini. |
...
| [ToEditable](../../aspose.gis.geometries/multisurface/toeditable/#toeditable_2)() | Mendapatkan salinan geometri ini yang dapat diedit. (3 methods) |
| [ToEditable&lt;T&gt;](../../aspose.gis.geometries/geometry/toeditable/)() | Mendapatkan salinan geometri ini yang dapat diedit. |
| [ToLinearGeometry](../../aspose.gis.geometries/multisurface/tolineargeometry/#tolineargeometry_4)() | Mendapat versi non-kurva perkiraan atau ekuivalen dari geometri ini menggunakan default`toleransi` . (3 methods) |
| [ToLinearGeometry](../../aspose.gis.geometries/multisurface/tolineargeometry/#tolineargeometry_5)(double) | Mendapatkan perkiraan atau versi non-kurva yang setara dari geometri ini menggunakan yang ditentukan`toleransi` . (3 methods) |
