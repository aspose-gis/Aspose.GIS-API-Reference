---
title: "Kelas ISurface"
type: docs
weight: 220
url: /id/python-net/aspose.gis.geometries/isurface/
---
...
| has_m | bool | r | Mendapatkan nilai yang menunjukkan apakah instance ini memiliki koordinat M. |
| has_z | bool | r | Mendapatkan nilai yang menunjukkan apakah instance ini memiliki koordinat Z. |
| is_empty | bool | r | Mendapatkan nilai yang menunjukkan apakah instance ini kosong (mewakili himpunan titik kosong). |
...
| spatial_reference_system | [SpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem/) | r | Mendapatkan SpatialReferenceSystem dari instance ini.<br/>            Properti ini dapat bernilai <see langword="null" />, jika SpatialReferenceSystem tidak diketahui. |
## **Methods**
| **Name** | **Deskripsi** |
| :- | :- |
...
| [get_area()](#get_area__15) | Menghitung area geometri ini. |
| [get_buffer(distance, quadrant_segments)](#get_buffer_distance_quadrant_segments_16) | Menghitung wilayah buffer di sekitar geometri ini. |
| [get_centroid()](#get_centroid__17) | Menghitung centroid geometri ini. |
| [get_convex_hull()](#get_convex_hull__18) | Menghitung convex hull geometri ini. |
| [get_distance_to(other)](#get_distance_to_other_19) | Menghitung jarak minimum antara geometri ini dan geometri yang ditentukan. |
| [get_extent()](#get_extent__20) | Menghitung dan mengembalikan batas wilayah geometri ini. |
| [get_length()](#get_length__21) | Menghitung panjang geometri ini. |
| [get_point_on_surface()](#get_point_on_surface__22) | Menemukan titik yang dijamin berada pada permukaan ini. |
| [intersection(other)](#intersection_other_23) | Membangun irisan antara geometri ini dan geometri yang ditentukan. |
| [intersects(extent)](#intersects_extent_24) | Menentukan apakah geometri ini beririsan dengan batas yang ditentukan. |
| [intersects(other)](#intersects_other_25) | Menentukan apakah geometri ini dan geometri yang ditentukan beririsan. |
| [overlaps(other)](#overlaps_other_26) | Menentukan apakah geometri ini tumpang tindih dengan geometri yang ditentukan. |
| [relate(other, intersection_pattern_matrix)](#relate_other_intersection_pattern_matrix_27) | Menentukan apakah matriks irisan DE-9IM dari geometri ini dan geometri yang ditentukan cocok dengan pola yang diberikan. |
| [replace_polygons_by_lines()](#replace_polygons_by_lines__28) | Mendapatkan poligon yang direpresentasikan sebagai garis dari geometri ini. |
| [spatially_contains(other)](#spatially_contains_other_29) | Menentukan apakah geometri ini secara spasial mengandung geometri yang ditentukan. |
| [spatially_equals(other)](#spatially_equals_other_30) | Menentukan apakah geometri ini secara spasial sama dengan geometri yang ditentukan. |
| [sym_difference(other)](#sym_difference_other_31) | Membangun selisih simetris antara geometri ini dan geometri yang ditentukan. |
| [to_editable()](#to_editable__32) | Mendapatkan salinan yang dapat diedit dari geometri ini. |
| [to_linear_geometry()](#to_linear_geometry__33) | Mendapatkan versi non-kurva yang kira-kira atau setara dari geometri ini menggunakan <c>tolerance</c> default. |
| [to_linear_geometry(tolerance)](#to_linear_geometry_tolerance_34) | Mendapatkan versi non-kurva yang kira-kira atau setara dari geometri ini menggunakan <c>tolerance</c> yang ditentukan. |
| [touches(other)](#touches_other_35) | Menentukan apakah geometri ini dan geometri yang ditentukan bersentuhan. |
| [union(other)](#union_other_36) | Menggabungkan geometri ini dengan geometri yang ditentukan. |
| [union(other)](#union_other_37) | Menggabungkan geometri ini dengan geometri yang ditentukan. |
| [within(extent)](#within_extent_38) | Menentukan apakah geometri ini berada dalam batas yang ditentukan. |
| [within(other)](#within_other_39) | Menentukan apakah geometri ini berada dalam geometri yang ditentukan. |
...
Menemukan titik yang dijamin berada pada permukaan ini.

**Returns**

| Tipe | Deskripsi |
| :- | :- |
| [IPoint](/psd/python-net/aspose.gis.geometries/ipoint) | Sebuah titik pada permukaan ini. Titik kosong jika permukaan ini tidak memiliki interior. |
...
| Tipe | Deskripsi |
| :- | :- |
| [Surface](/psd/python-net/aspose.gis.geometries/surface) | Salinan yang dapat diedit dari geometri ini. |
