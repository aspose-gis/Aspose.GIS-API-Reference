---
title: "Kelas CircularString"
type: docs
weight: 10
url: /id/python-net/aspose.gis.geometries/circularstring/
---
...
| **Name** | **Deskripsi** |
| :- | :- |
| [CircularString()](#CircularString__1) | Menginisialisasi sebuah instance baru dari kelas [CircularString](/psd/python-net/aspose.gis.geometries/circularstring/) class. |
| [CircularString(collection)](#CircularString_collection_2) | Menginisialisasi sebuah instance baru dari kelas [CircularString](/psd/python-net/aspose.gis.geometries/circularstring/) class. |
| [CircularString(other)](#CircularString_other_3) | Menginisialisasi sebuah instance baru dari kelas [CircularString](/psd/python-net/aspose.gis.geometries/circularstring/) class. |
## **Properties**
...
| **Name** | **Deskripsi** |
| :- | :- |
| [add_point(point)](#add_point_point_1) | Menambahkan sebuah titik ke akhir string melingkar. |
| [add_point(x, y)](#add_point_x_y_2) | Menambahkan sebuah titik ke akhir string melingkar. |
| [add_point(x, y, z)](#add_point_x_y_z_3) | Menambahkan sebuah titik ke akhir string melingkar. |
| [add_point(x, y, z, m)](#add_point_x_y_z_m_4) | Menambahkan sebuah titik ke akhir string melingkar. |
...
| [overlaps(other)](#overlaps_other_33) | Menentukan apakah geometri ini tumpang tindih dengan geometri yang ditentukan. |
| [relate(other, intersection_pattern_matrix)](#relate_other_intersection_pattern_matrix_34) | Menentukan apakah matriks irisan DE-9IM dari geometri ini dan geometri yang ditentukan cocok dengan pola yang diberikan. |
...
| reverse() | Membalik urutan titik dalam [CircularString](/psd/python-net/aspose.gis.geometries/circularstring/) ini. |
...
Menginisialisasi sebuah instance baru dari kelas [CircularString](/psd/python-net/aspose.gis.geometries/circularstring/) class.
...
| Parameter | Tipe | Deskripsi |
| :- | :- | :- |
| other | [ICircularString](/psd/python-net/aspose.gis.geometries/icircularstring) | String lain untuk menyalin data darinya. |
...
Menambahkan sebuah titik ke akhir string melingkar.
