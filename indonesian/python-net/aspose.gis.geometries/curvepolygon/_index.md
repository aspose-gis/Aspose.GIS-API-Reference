---
title: "Kelas CurvePolygon"
type: docs
weight: 40
url: /id/python-net/aspose.gis.geometries/curvepolygon/
---
...
| **Name** | **Deskripsi** |
| :- | :- |
| [CurvePolygon()](#CurvePolygon__1) | Menginisialisasi sebuah instance baru dari kelas [CurvePolygon](/psd/python-net/aspose.gis.geometries/curvepolygon/) |
| [CurvePolygon(exterior_ring)](#CurvePolygon_exterior_ring_2) | Menginisialisasi sebuah instance baru dari kelas [CurvePolygon](/psd/python-net/aspose.gis.geometries/curvepolygon/) |
| [CurvePolygon(exterior_ring, interior_rings)](#CurvePolygon_exterior_ring_interior_rings_3) | Menginisialisasi sebuah instance baru dari kelas [CurvePolygon](/psd/python-net/aspose.gis.geometries/curvepolygon/) |
## **Properties**
...
| exterior_ring | [ICurve](/psd/python-net/aspose.gis.geometries/icurve) | r/w | Mendapatkan cincin luar. |
...
| interior_rings_count | int | r | Mendapatkan jumlah cincin dalam. |
...
| **Name** | **Deskripsi** |
| :- | :- |
| [add_interior_ring(ring)](#add_interior_ring_ring_1) | Menambahkan cincin dalam. |
| [as_binary()](#as_binary__2) | Menerjemahkan geometri ini ke representasi Well-Known Binary-nya. |
| [as_binary(variant)](#as_binary_variant_3) | Menerjemahkan geometri ini ke representasi Well-Known Binary-nya. |
...
| [as_image(width, height, renderer, symbolizer)](#as_image_width_height_renderer_symbolizer_6) | Ekspor geometri ini ke representasi gambar. |
| [as_text()](#as_text__7) | Menerjemahkan geometri ini ke representasi Well-Known Text-nya. |
| [as_text(variant)](#as_text_variant_8) | Menerjemahkan geometri ini ke representasi Well-Known Text-nya. |
| [as_text(variant, format)](#as_text_variant_format_9) | Menerjemahkan geometri ini ke representasi Well-Known Text-nya. |
| [clone()](#clone__10) | Menggandakan instance ini. |
| [covered_by(other)](#covered_by_other_11) | Menentukan apakah geometri ini ditutupi oleh geometri yang ditentukan. |
| [covers(other)](#covers_other_12) | Menentukan apakah geometri ini menutupi geometri yang ditentukan. |
| [crosses(other)](#crosses_other_13) | Menentukan apakah geometri ini dan geometri yang ditentukan saling memotong. |
| [difference(other)](#difference_other_14) | Mengurangi geometri yang ditentukan dari geometri ini. |
| [disjoint(other)](#disjoint_other_15) | Menentukan apakah geometri ini terpisah dari geometri yang ditentukan. |
| [from_binary(wkb)](#from_binary_wkb_16) | Membuat geometri dari representasi Well-Known Binary-nya. |
| [from_binary(wkb, spatial_reference_system)](#from_binary_wkb_spatial_reference_system_17) | Membuat geometri dari representasi Well-Known Binary-nya. |
| [from_text(wkt)](#from_text_wkt_18) | Membuat geometri dari representasi Well-Known Text-nya. |
| [from_text(wkt, spatial_reference_system)](#from_text_wkt_spatial_reference_system_19) | Membuat geometri dari representasi Well-Known Text-nya. |
| [get_area()](#get_area__20) | Menghitung area geometri ini. |
| [get_buffer(distance, quadrant_segments)](#get_buffer_distance_quadrant_segments_21) | Menghitung wilayah buffer di sekitar geometri ini. |
| [get_centroid()](#get_centroid__22) | Menghitung centroid geometri ini. |
| [get_convex_hull()](#get_convex_hull__23) | Menghitung convex hull geometri ini. |
| [get_distance_to(other)](#get_distance_to_other_24) | Menghitung jarak minimum antara geometri ini dan geometri yang ditentukan. |
| [get_extent()](#get_extent__25) | Menghitung dan mengembalikan batas wilayah geometri ini. |
| [get_interior_ring(index)](#get_interior_ring_index_26) | Mendapatkan cincin dalam berdasarkan indeksnya. |
| [get_length()](#get_length__27) | Menghitung panjang geometri ini. |
| [get_point_on_surface()](#get_point_on_surface__28) | Menemukan sebuah titik yang dijamin berada pada poligon melengkung ini. |
...
| [replace_polygons_by_lines()](#replace_polygons_by_lines__34) | Mendapatkan poligon yang direpresentasikan sebagai garis dari geometri ini. |
| [round_m(digits)](#round_m_digits_35) | Membulatkan koordinat M ke sejumlah digit desimal yang ditentukan. |
| [round_xy(digits)](#round_xy_digits_36) | Membulatkan koordinat X dan Y ke sejumlah digit desimal yang ditentukan. |
| [round_z(digits)](#round_z_digits_37) | Membulatkan koordinat Z ke sejumlah digit desimal yang ditentukan. |
| set_empty() | Membuat [Geometry](/psd/python-net/aspose.gis.geometries/geometry/) ini kosong. |
| [spatially_contains(other)](#spatially_contains_other_38) | Menentukan apakah geometri ini secara spasial mengandung geometri yang ditentukan. |
| [spatially_equals(other)](#spatially_equals_other_39) | Menentukan apakah geometri ini secara spasial sama dengan geometri yang ditentukan. |
| [sym_difference(other)](#sym_difference_other_40) | Membangun selisih simetris antara geometri ini dan geometri yang ditentukan. |
| [to_editable()](#to_editable__41) | Mendapatkan salinan yang dapat diedit dari geometri ini. |
| [to_linear_geometry()](#to_linear_geometry__42) | Mendapatkan versi non-kurva yang kira-kira atau setara dari geometri ini menggunakan <c>tolerance</c> default. |
| [to_linear_geometry(tolerance)](#to_linear_geometry_tolerance_43) | Mendapatkan versi non-kurva yang kira-kira atau setara dari geometri ini menggunakan <c>tolerance</c> yang ditentukan. |
| [to_svg(extent)](#to_svg_extent_44) | Menerjemahkan geometri ini ke representasi Svg. |
| [touches(other)](#touches_other_45) | Menentukan apakah geometri ini dan geometri yang ditentukan bersentuhan. |
| [union(other)](#union_other_46) | Menggabungkan geometri ini dengan geometri yang ditentukan. |
| [union(other)](#union_other_47) | Menggabungkan geometri ini dengan geometri yang ditentukan. |
| [within(extent)](#within_extent_48) | Menentukan apakah geometri ini berada dalam batas yang ditentukan. |
| [within(other)](#within_other_49) | Menentukan apakah geometri ini berada dalam geometri yang ditentukan. |
...
Menginisialisasi sebuah instance baru dari kelas [CurvePolygon](/psd/python-net/aspose.gis.geometries/curvepolygon/)
...
| :- | :- | :- |
| exterior_ring | [ICurve](/psd/python-net/aspose.gis.geometries/icurve) | Cincin luar. |
...
| :- | :- | :- |
| exterior_ring | [ICurve](/psd/python-net/aspose.gis.geometries/icurve) | Cincin luar. |
| interior_rings | System.Collections.Generic.IEnumerable<ICurve> | Cincin-cincin dalam. |
...
Menambahkan cincin dalam.

**Parameters:**

| Parameter | Tipe | Deskripsi |
| :- | :- | :- |
| ring | [ICurve](/psd/python-net/aspose.gis.geometries/icurve) | Cincin yang akan ditambahkan. |
...
Mendapatkan cincin dalam berdasarkan indeksnya.
...
| Tipe | Deskripsi |
| :- | :- |
| [ICurve](/psd/python-net/aspose.gis.geometries/icurve) | Cincin dalam. |
...
Menemukan sebuah titik yang dijamin berada pada poligon melengkung ini.

**Returns**

| Tipe | Deskripsi |
| :- | :- |
| [IPoint](/psd/python-net/aspose.gis.geometries/ipoint) | Sebuah titik pada poligon melengkung ini. Titik kosong jika poligon melengkung ini tidak memiliki interior. |
...
| Tipe | Deskripsi |
| :- | :- |
| [CurvePolygon](/psd/python-net/aspose.gis.geometries/curvepolygon) | Salinan yang dapat diedit dari geometri ini. |
...
| Tipe | Deskripsi |
| :- | :- |
| [IPolygon](/psd/python-net/aspose.gis.geometries/ipolygon) | A [IPolygon](/psd/python-net/aspose.gis.geometries/ipolygon/) yang mendekati atau setara dengan <c>ISurface</c> ini.<br/>            Ini setara dengan <DOM Element: class at 0x2a1793609d0>.ISurface.to_linear_geometry()(float) dengan<br/>            <c>tolerance</c> default. Nilai default <c>tolerance</c> bergantung pada [SpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem/)<br/>            dari geometri ini:<br/>            <ul><br/>            <li> Untuk SRS proyeksi, Tolerance adalah 0.001 meter (dalam satuan SRS) </li><br/>            <li> Untuk SRS geografis, Tolerance adalah <c>1e-5</c> derajat (dalam satuan SRS) </li><br/>            <li> Untuk SRS tidak diketahui, Tolerance adalah <c>1e-5</c> </li><br/>            </ul><br/>            Untuk detail lebih lanjut tentang transformasi yang diterapkan, lihat spesifikasi <DOM Element: class at 0x2a1793609d0>.ISurface.to_linear_geometry()(float). |
...
| Tipe | Deskripsi |
| :- | :- |
| [IPolygon](/psd/python-net/aspose.gis.geometries/ipolygon) | Sebuah [IPolygon](/psd/python-net/aspose.gis.geometries/ipolygon/) yang mendekati atau setara dengan <c>ISurface</c> ini:<br/>             <ul><br/>             Jika objek ini adalah [IPolygon](/psd/python-net/aspose.gis.geometries/ipolygon/) sendiri, hasilnya setara dengan objek ini<br/>             Jika objek ini bukan [IPolygon](/psd/python-net/aspose.gis.geometries/ipolygon/), maka objek ini dilinierkan dan [IPolygon](/psd/python-net/aspose.gis.geometries/ipolygon/) dibuat<br/>            </ul> |
