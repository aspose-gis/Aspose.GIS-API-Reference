...
type: docs
weight: 310
url: /id/python-net/aspose.gis.geometries/polygon/
---
...
| **Name** | **Deskripsi** |
| :- | :- |
| [Polygon()](#Polygon__1) | Menginisialisasi sebuah instance baru dari kelas [Polygon](/psd/python-net/aspose.gis.geometries/polygon/). |
| [Polygon(exterior_ring)](#Polygon_exterior_ring_2) | Menginisialisasi sebuah instance baru dari kelas [Polygon](/psd/python-net/aspose.gis.geometries/polygon/). |
| [Polygon(exterior_ring, interior_rings)](#Polygon_exterior_ring_interior_rings_3) | Menginisialisasi sebuah instance baru dari kelas [Polygon](/psd/python-net/aspose.gis.geometries/polygon/). |
## **Properties**
...
| exterior_ring | [ILinearRing](/psd/python-net/aspose.gis.geometries/ilinearring) | r/w | Mendapatkan cincin luar. |
...
| [get_point_on_surface()](#get_point_on_surface__28) | Menemukan titik yang dijamin berada pada poligon ini. |
...
Menginisialisasi sebuah instance baru dari kelas [Polygon](/psd/python-net/aspose.gis.geometries/polygon/).
...
| :- | :- | :- |
| exterior_ring | [ILinearRing](/psd/python-net/aspose.gis.geometries/ilinearring) | Cincin luar. |
...
| :- | :- | :- |
| exterior_ring | [ILinearRing](/psd/python-net/aspose.gis.geometries/ilinearring) | Cincin luar. |
| interior_rings | System.Collections.Generic.IEnumerable<ILinearRing> | Cincin-cincin dalam. |
...
| Parameter | Tipe | Deskripsi |
| :- | :- | :- |
| ring | [ILinearRing](/psd/python-net/aspose.gis.geometries/ilinearring) | Cincin yang akan ditambahkan. |
...
| Tipe | Deskripsi |
| :- | :- |
| [ILinearRing](/psd/python-net/aspose.gis.geometries/ilinearring) | Cincin dalam. |
...
Menemukan titik yang dijamin berada pada poligon ini.

**Returns**

| Tipe | Deskripsi |
| :- | :- |
| [IPoint](/psd/python-net/aspose.gis.geometries/ipoint) | Sebuah titik pada poligon ini. Titik kosong jika poligon ini tidak memiliki interior. |
...
| Tipe | Deskripsi |
| :- | :- |
| [Polygon](/psd/python-net/aspose.gis.geometries/polygon) | Salinan yang dapat diedit dari geometri ini. |
