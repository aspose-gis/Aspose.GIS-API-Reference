---
title: "Kelas IPolygon"
type: docs
weight: 210
url: /id/python-net/aspose.gis.geometries/ipolygon/
---
...
| exterior_ring | [ILinearRing](/psd/python-net/aspose.gis.geometries/ilinearring) | r | Mendapatkan cincin luar. |
...
| [get_interior_ring(index)](#get_interior_ring_index_21) | Mendapatkan cincin dalam berdasarkan indeksnya. |
| [get_length()](#get_length__22) | Menghitung panjang geometri ini. |
| [get_point_on_surface()](#get_point_on_surface__23) | Menemukan titik yang dijamin berada pada permukaan ini. |
| [intersection(other)](#intersection_other_24) | Membangun irisan antara geometri ini dan geometri yang ditentukan. |
| [intersects(extent)](#intersects_extent_25) | Menentukan apakah geometri ini beririsan dengan batas yang ditentukan. |
| [intersects(other)](#intersects_other_26) | Menentukan apakah geometri ini dan geometri yang ditentukan beririsan. |
| [overlaps(other)](#overlaps_other_27) | Menentukan apakah geometri ini tumpang tindih dengan geometri yang ditentukan. |
| [relate(other, intersection_pattern_matrix)](#relate_other_intersection_pattern_matrix_28) | Menentukan apakah matriks irisan DE-9IM dari geometri ini dan geometri yang ditentukan cocok dengan pola yang diberikan. |
| [replace_polygons_by_lines()](#replace_polygons_by_lines__29) | Mendapatkan poligon yang direpresentasikan sebagai garis dari geometri ini. |
| [spatially_contains(other)](#spatially_contains_other_30) | Menentukan apakah geometri ini secara spasial mengandung geometri yang ditentukan. |
| [spatially_equals(other)](#spatially_equals_other_31) | Menentukan apakah geometri ini secara spasial sama dengan geometri yang ditentukan. |
| [sym_difference(other)](#sym_difference_other_32) | Membangun selisih simetris antara geometri ini dan geometri yang ditentukan. |
| [to_editable()](#to_editable__33) | Mendapatkan salinan yang dapat diedit dari geometri ini. |
| [to_linear_geometry()](#to_linear_geometry__34) | Mendapatkan versi non-kurva yang kira-kira atau setara dari geometri ini menggunakan <c>tolerance</c> default. |
| [to_linear_geometry(tolerance)](#to_linear_geometry_tolerance_35) | Mendapatkan versi non-kurva yang kira-kira atau setara dari geometri ini menggunakan <c>tolerance</c> yang ditentukan. |
| [touches(other)](#touches_other_36) | Menentukan apakah geometri ini dan geometri yang ditentukan bersentuhan. |
| [union(other)](#union_other_37) | Menggabungkan geometri ini dengan geometri yang ditentukan. |
| [union(other)](#union_other_38) | Menggabungkan geometri ini dengan geometri yang ditentukan. |
| [within(extent)](#within_extent_39) | Menentukan apakah geometri ini berada dalam batas yang ditentukan. |
| [within(other)](#within_other_40) | Menentukan apakah geometri ini berada dalam geometri yang ditentukan. |
