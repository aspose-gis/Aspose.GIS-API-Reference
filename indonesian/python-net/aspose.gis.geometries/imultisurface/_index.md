---
title: "Kelas IMultiSurface"
type: docs
weight: 190
url: /id/python-net/aspose.gis.geometries/imultisurface/
---
...
| Tipe | Deskripsi |
| :- | :- |
| [MultiSurface](/psd/python-net/aspose.gis.geometries/multisurface) | Salinan yang dapat diedit dari geometri ini. |
...
| Tipe | Deskripsi |
| :- | :- |
| [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon) | Sebuah [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon/) yang mendekati atau setara dengan [IMultiSurface](/psd/python-net/aspose.gis.geometries/imultisurface/).<br/>            Ini adalah setara dengan <DOM Element: class at 0x2a1792e8790>.IMultiSurface.to_linear_geometry()(float) dengan<br/>            <c>tolerance</c> default. Nilai default <c>tolerance</c> bergantung pada [SpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem/)<br/>            dari geometri ini:<br/>            <ul><br/>            <li> Untuk SRS terproyeksi Toleransi adalah 0.001 meter (dalam satuan SRS) </li><br/>            <li> Untuk SRS geografis Toleransi adalah <c>1e-5</c> derajat (dalam satuan SRS) </li><br/>            <li> Untuk SRS tidak diketahui Toleransi adalah <c>1e-5</c> </li><br/>            </ul><br/>            Untuk detail lebih lanjut tentang transformasi yang diterapkan, lihat spesifikasi <DOM Element: class at 0x2a1792e8790>.IMultiSurface.to_linear_geometry()(float). |
...
| Tipe | Deskripsi |
| :- | :- |
| [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon) | Sebuah [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon/) yang mendekati atau setara dengan [IMultiSurface](/psd/python-net/aspose.gis.geometries/imultisurface/):<br/>             <ul><br/>             Jika objek ini adalah [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon/) itu sendiri, hasilnya setara dengan objek ini<br/>             Jika objek ini bukan [IMultiPolygon](/psd/python-net/aspose.gis.geometries/imultipolygon/) - semua permukaan dilineariskan dan <c>IMultiPolygon</c> baru dibuat<br/>            </ul> |
