---
title: "Kelas CompoundCurve"
type: docs
weight: 20
url: /id/python-net/aspose.gis.geometries/compoundcurve/
---
...
| **Name** | **Deskripsi** |
| :- | :- |
| [CompoundCurve()](#CompoundCurve__1) | Menginisialisasi sebuah instance baru dari kelas [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/) |
| [CompoundCurve(curves)](#CompoundCurve_curves_2) | Menginisialisasi sebuah instance baru dari kelas [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/) |
| [CompoundCurve(other)](#CompoundCurve_other_3) | Menginisialisasi sebuah instance baru dari kelas [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/) |
## **Properties**
...
| count | int | r | Mendapatkan jumlah kurva dalam [ICompoundCurve](/psd/python-net/aspose.gis.geometries/icompoundcurve/) |
...
| is_closed | bool | r | Mendapatkan nilai yang menunjukkan apakah sebuah kurva tertutup. <br/>            Sebuah kurva tertutup jika titik mulai sama dengan titik akhir. |
...
| **Name** | **Deskripsi** |
| :- | :- |
| [add_curve(curve)](#add_curve_curve_1) | Menambahkan sebuah kurva ke akhir [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/) ini. |
...
| [get_length()](#get_length__26) | Menghitung panjang geometri ini. |
| [intersection(other)](#intersection_other_27) | Membangun irisan antara geometri ini dan geometri yang ditentukan. |
| [intersects(extent)](#intersects_extent_28) | Menentukan apakah geometri ini beririsan dengan batas yang ditentukan. |
| [intersects(other)](#intersects_other_29) | Menentukan apakah geometri ini dan geometri yang ditentukan beririsan. |
| [overlaps(other)](#overlaps_other_30) | Menentukan apakah geometri ini tumpang tindih dengan geometri yang ditentukan. |
| [relate(other, intersection_pattern_matrix)](#relate_other_intersection_pattern_matrix_31) | Menentukan apakah matriks irisan DE-9IM dari geometri ini dan geometri yang ditentukan cocok dengan pola yang diberikan. |
| [replace_polygons_by_lines()](#replace_polygons_by_lines__32) | Mendapatkan poligon yang direpresentasikan sebagai garis dari geometri ini. |
| reverse() | Membalikkan [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/) ini. Artinya - membalik urutan kurva dan setiap kurva di dalam kurva gabungan ini. |
| [round_m(digits)](#round_m_digits_33) | Membulatkan koordinat M ke sejumlah digit desimal yang ditentukan. |
| [round_xy(digits)](#round_xy_digits_34) | Membulatkan koordinat X dan Y ke sejumlah digit desimal yang ditentukan. |
| [round_z(digits)](#round_z_digits_35) | Membulatkan koordinat Z ke sejumlah digit desimal yang ditentukan. |
| set_empty() | Membuat [Geometry](/psd/python-net/aspose.gis.geometries/geometry/) ini kosong. |
| [spatially_contains(other)](#spatially_contains_other_36) | Menentukan apakah geometri ini secara spasial mengandung geometri yang ditentukan. |
| [spatially_equals(other)](#spatially_equals_other_37) | Menentukan apakah geometri ini secara spasial sama dengan geometri yang ditentukan. |
| [sym_difference(other)](#sym_difference_other_38) | Membangun selisih simetris antara geometri ini dan geometri yang ditentukan. |
| [to_editable()](#to_editable__39) | Mendapatkan salinan yang dapat diedit dari geometri ini. |
| [to_linear_geometry()](#to_linear_geometry__40) | Mendapatkan versi non-kurva yang kira-kira atau setara dari geometri ini menggunakan <c>tolerance</c> default. |
| [to_linear_geometry(tolerance)](#to_linear_geometry_tolerance_41) | Mendapatkan versi non-kurva yang kira-kira atau setara dari geometri ini menggunakan <c>tolerance</c> yang ditentukan. |
| [to_svg(extent)](#to_svg_extent_42) | Menerjemahkan geometri ini ke representasi Svg. |
| [touches(other)](#touches_other_43) | Menentukan apakah geometri ini dan geometri yang ditentukan bersentuhan. |
| [union(other)](#union_other_44) | Menggabungkan geometri ini dengan geometri yang ditentukan. |
| [union(other)](#union_other_45) | Menggabungkan geometri ini dengan geometri yang ditentukan. |
| [within(extent)](#within_extent_46) | Menentukan apakah geometri ini berada dalam batas yang ditentukan. |
| [within(other)](#within_other_47) | Menentukan apakah geometri ini berada dalam geometri yang ditentukan. |
...
Menginisialisasi sebuah instance baru dari kelas [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/)
...
| :- | :- | :- |
| kurva | System.Collections.Generic.IEnumerable<ICurve> | Koleksi kurva. |
...
| Parameter | Tipe | Deskripsi |
| :- | :- | :- |
| other | [ICompoundCurve](/psd/python-net/aspose.gis.geometries/icompoundcurve) | Garis lain untuk menyalin data darinya. |
...
Menambahkan sebuah kurva ke akhir [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/) ini.

**Parameters:**

| Parameter | Tipe | Deskripsi |
| :- | :- | :- |
| curve | [ICurve](/psd/python-net/aspose.gis.geometries/icurve) | Kurva yang akan ditambahkan. |
...
| Tipe | Deskripsi |
| :- | :- |
| [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve) | Salinan yang dapat diedit dari geometri ini. |
