---
title: "Kelas KmlOptions"
type: docs
weight: 190
url: /id/python-net/aspose.gis.formats.kml/kmloptions/
---
...
| **Name** | **Deskripsi** |
| :- | :- |
| [KmlOptions()](#KmlOptions__1) | Buat instance baru. |
## **Properties**
| **Name** | **Type** | **Access** | **Deskripsi** |
| :- | :- | :- | :- |
| altitude_mode | [AltitudeModes](/psd/python-net/aspose.gis.formats.kml/altitudemodes) | r/w | Memungkinkan Anda menentukan AltitudeModes yang akan digunakan untuk geometri KML |
...
| document_id | string | r/w | Digunakan untuk menentukan id dari node root 'Document' |
...
| symbol_to_replace_invalid_chars | char | r/w | Menentukan simbol mana yang akan digunakan untuk mengganti karakter tidak valid saat membaca.<br/>            Penggantian dilewati jika nilai adalah '\0'. Secara default nilai adalah karakter '\0'. |
