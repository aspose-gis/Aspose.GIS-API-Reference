---
title: "Kelas KmlLayer"
type: docs
weight: 140
url: /id/python-net/aspose.gis.formats.kml/kmllayer/
---
...
| driver | [Driver](/psd/python-net/aspose.gis/driver) | r | Mendapatkan [KmlLayer.driver](/psd/python-net/aspose.gis.formats.kml/kmllayer/) yang menginstansiasi lapisan ini. |
| features | [Feature[]](/psd/python-net/aspose.gis/feature) | r | Mendapatkan daftar fitur. |
| geometry_type | [GeometryType](/psd/python-net/aspose.gis.geometries/geometrytype/) | r | Mendapatkan tipe geometri untuk lapisan. |
| ground_overlay_list | System.Collections.Generic.List<Aspose.Gis.Formats.Kml.SpecificFields.KmlGroundOverlayInfo> | r | Daftar KmlGroundOverlayInfo dari node GroundOverlay |
| network_link_list | System.Collections.Generic.List<Aspose.Gis.Formats.Kml.SpecificFields.KmlNetworkLinkInfo> | r | Daftar KmlNetworkLinkInfo dari node NetworkLink |
| region_list | System.Collections.Generic.List<Aspose.Gis.Formats.Kml.SpecificFields.KmlRegionInfo> | r | Daftar KmlRegionInfo dari node Region |
| spatial_reference_system | [SpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem/) | r | Dapatkan sistem referensi spasial lapisan ini. Untuk KML ini selalu WGS84. |
## **Methods**
| **Name** | **Deskripsi** |
| :- | :- |
