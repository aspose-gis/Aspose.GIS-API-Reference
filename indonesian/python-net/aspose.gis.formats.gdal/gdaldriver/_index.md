---
title: "Kelas GdalDriver"
type: docs
weight: 10
url: /id/python-net/aspose.gis.formats.gdal/gdaldriver/
---
...
| [create_layer(path, options, spatial_reference_system)](#create_layer_path_options_spatial_reference_system_9) | Membuat lapisan dan membukanya untuk menambahkan fitur baru. |
...
| [open_layer(path)](#open_layer_path_19) | Membuka lapisan untuk dibaca. |
| [open_layer(path)](#open_layer_path_20) | Membuka lapisan untuk dibaca. |
| [open_layer(path, options)](#open_layer_path_options_21) | Membuka lapisan untuk dibaca. |
...
| :- | :- | :- |
| jalur | string | Jalur ke file. |
| options | [GdalOptions](/psd/python-net/aspose.gis.formats.gdal/gdaloptions) | Opsi khusus driver. |
