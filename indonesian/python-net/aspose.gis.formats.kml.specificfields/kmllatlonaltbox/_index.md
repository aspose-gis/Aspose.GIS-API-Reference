---
title: "KmlLatLonAltBox Kelas"
type: docs
weight: 30
url: /id/python-net/aspose.gis.formats.kml.specificfields/kmllatlonaltbox/
---
...
| timur | double | r/w | Timur dari node 'LatLonBox'. |
| max_altitude | Nullable<double> | r/w | MaxAltitude dari node 'LatLonBox'. |
| min_altitude | Nullable<double> | r/w | MinAltitude dari node 'LatLonBox'. |
...
| utara | double | r/w | Utara dari node 'LatLonBox'. |
| awalan | string | r | Mendapatkan awalan. |
| rotasi | Nullable<double> | r/w | Rotasi dari node 'LatLonBox'. |
| selatan | double | r/w | Selatan dari node 'LatLonBox'. |
| barat | double | r/w | Barat dari node 'LatLonBox'. |
## **Methods**
| **Name** | **Deskripsi** |
| :- | :- |
