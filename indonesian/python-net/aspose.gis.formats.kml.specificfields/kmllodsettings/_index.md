---
title: "Kelas KmlLodSettings"
type: docs
weight: 50
url: /id/python-net/aspose.gis.formats.kml.specificfields/kmllodsettings/
---
...
| max_fade_extent | int | r/w | MaxFadeExtent dari node 'Lod'. |
| max_lod_pixels | int | r/w | MaxLodPixels dari node 'Lod'. |
| min_fade_extent | int | r/w | MinFadeExtent dari node 'Lod'. |
| min_lod_pixels | int | r/w | MinLodPixels dari node 'Lod'. |
