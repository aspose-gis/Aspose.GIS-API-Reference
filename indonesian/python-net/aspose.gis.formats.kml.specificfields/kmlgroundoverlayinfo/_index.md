---
title: "KmlGroundOverlayInfo Kelas"
type: docs
weight: 20
url: /id/python-net/aspose.gis.formats.kml.specificfields/kmlgroundoverlayinfo/
---
...
| draw_order | double | r/w | DrawOrder dari node 'GroundOverlay'. |
| icon | [IconInfo](/psd/python-net/aspose.gis.formats.kml.specificfields/iconinfo) | r/w | IconPath dari node 'GroundOverlay'. |
| lat_lon_box | [KmlLatLonBox](/psd/python-net/aspose.gis.formats.kml.specificfields/kmllatlonbox) | r/w | Menentukan objek dari node Kml 'LatLonAltBox'. |
| nama | string | r/w | Nama dari Ground Overlay |
...
| visibility | bool | r/w | Visibilitas dari Ground Overlay |
## **Methods**
| **Name** | **Deskripsi** |
| :- | :- |
