---
title: "Kelas SqlServerOptions"
type: docs
weight: 20
url: /id/python-net/aspose.gis.formats.sqlserver/sqlserveroptions/
---
...
| **Name** | **Deskripsi** |
| :- | :- |
| [SqlServerOptions()](#SqlServerOptions__1) | Buat instance baru. |
## **Properties**
...
| spatial_reference_system_mode | [SpatialReferenceSystemMode](/psd/python-net/aspose.gis/spatialreferencesystemmode) | r/w | Menentukan bagaimana SRS geometris yang tidak diketahui untuk basis data harus ditangani ketika mereka ditambahkan ke lapisan.<br/>            Nilai default adalah [SpatialReferenceSystemMode.THROW_EXCEPTION](/psd/python-net/aspose.gis/spatialreferencesystemmode/). |
