---
title: "Kelas ProjectedSpatialReferenceSystem"
type: docs
weight: 150
url: /id/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/
---
...
| :- | :- | :- | :- |
| angular_unit | [Unit](/psd/python-net/aspose.gis.spatialreferencing/unit) | r | Satuan yang digunakan untuk nilai sudut dalam SRS ini dan untuk parameter sudut dari [ProjectedSpatialReferenceSystem.projection](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/).<br/>            Cocok dengan satuan sudut dari [ProjectedSpatialReferenceSystem.base](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/). |
| as_compound | [CompoundSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/compoundspatialreferencesystem) | r | Mengembalikan SRS ini yang dikonversi ke [CompoundSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/compoundspatialreferencesystem/).<br/>            Gunakan [SpatialReferenceSystem.is_compound](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem/) untuk mengetahui apakah konversi memungkinkan. |
...
| as_geographic | [GeographicSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/geographicspatialreferencesystem) | r | Mengembalikan SRS ini yang dikonversi ke [GeographicSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/geographicspatialreferencesystem/).<br/> Gunakan [SpatialReferenceSystem.type](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem/) untuk mengetahui apakah konversi memungkinkan. |
...
| as_projected | [ProjectedSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem) | r | Kembalikan ini. |
...
| axises_order | [ProjectedAxisesOrder](/psd/python-net/aspose.gis.spatialreferencing/projectedaxisesorder) | r | Urutan sumbu pada SRS ini.<br/> Jika SRS ini tidak valid dan memiliki arah sumbu yang salah, [ProjectedAxisesOrder.INVALID](/psd/python-net/aspose.gis.spatialreferencing/projectedaxisesorder/) dikembalikan. |
| base | [GeographicSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/geographicspatialreferencesystem) | r | SRS geografis yang mana [ProjectedSpatialReferenceSystem.projection](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/) diterapkan untuk mendapatkan SRS ini. |
| dimensions_count | int | r | Mengembalikan jumlah dimensi pada SRS ini. Untuk SRS terproyeksi ini dapat berupa:<br/> dua - jika ini adalah SRS terproyeksi tunggal.<br/> tiga - jika ini adalah SRS komposit, yang terdiri dari SRS terproyeksi tunggal dua dimensi dan SRS vertikal, yang menambahkan dimensi ketiga. |
...
| geographic_datum | [GeographicDatum](/psd/python-net/aspose.gis.spatialreferencing/geographicdatum) | r | Mengembalikan datum geografis dari SRS ini. |
| has_geographic_datum | bool | r | Mengembalikan true, karena SRS terproyeksi selalu memiliki meridian utama. |
| has_prime_meridian | bool | r | Mengembalikan true, karena SRS terproyeksi selalu memiliki meridian utama. |
...
| is_compound | bool | r | Mengembalikan apakah SRS ini merupakan komposit (gabungan dari dua SRS).<br/> Kombinasi SRS berikut dalam SRS komposit dianggap valid:<br/> Geographic SRS + Vertical SRS, dalam kasus ini tipe SRS komposit akan menjadi [SpatialReferenceSystemType.GEOGRAPHIC](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/).<br/> Projected SRS + Vertical SRS, dalam kasus ini tipe SRS komposit akan menjadi [SpatialReferenceSystemType.PROJECTED](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/).<br/> Jika kombinasi SRS berbeda, tipe SRS komposit akan menjadi [SpatialReferenceSystemType.UNKNOWN](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/). |
...
| linear_unit | [Unit](/psd/python-net/aspose.gis.spatialreferencing/unit) | r | Unit yang digunakan untuk dimensi linear dalam SRS ini dan untuk parameter linear [ProjectedSpatialReferenceSystem.projection](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/). |
...
| prime_meridian | [PrimeMeridian](/psd/python-net/aspose.gis.spatialreferencing/primemeridian) | r | Mengembalikan meridian utama dari SRS ini. |
| projection | [Projection](/psd/python-net/aspose.gis.spatialreferencing/projection) | r | Proyeksi yang diterapkan pada [ProjectedSpatialReferenceSystem.base](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/) untuk mendapatkan SRS ini. |
| type | [SpatialReferenceSystemType](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype) | r | Mengembalikan [SpatialReferenceSystemType.PROJECTED](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/). |
...
| [validate(error_message)](#validate_error_message_18) | Tentukan apakah SRS ini valid. |
...
| Parameter | Tipe | Deskripsi |
| :- | :- | :- |
| pesan_error | String | Jika metode mengembalikan <see langword=\"false\" />, maka ini adalah deskripsi ketidakvalidan. |

**Returns**

| Tipe | Deskripsi |
| :- | :- |
| bool | <see langword=\"true\" /> jika SRS valid, <see langword=\"false\" /> jika tidak. |
