---
title: "Kelas LocalSpatialReferenceSystem"
type: docs
weight: 130
url: /id/python-net/aspose.gis.spatialreferencing/localspatialreferencesystem/
---
...
| as_local | [LocalSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/localspatialreferencesystem) | r | Kembalikan ini. |
...
| dimensions_count | int | r | Jumlah dimensi dalam SRS ini. |
...
| geographic_datum | [GeographicDatum](/psd/python-net/aspose.gis.spatialreferencing/geographicdatum) | r | Melempar InvalidOperationException, karena Local SRS tidak memiliki datum geografis. |
| has_geographic_datum | bool | r | Mengembalikan <see langword="false" />, karena Local SRS tidak memiliki datum geografis. |
| has_prime_meridian | bool | r | Mengembalikan <see langword="false" />, karena Local SRS tidak memiliki meridian utama. |
...
| local_datum | [LocalDatum](/psd/python-net/aspose.gis.spatialreferencing/localdatum) | r | Datum, yang menggambarkan metode pengukuran. |
...
| prime_meridian | [PrimeMeridian](/psd/python-net/aspose.gis.spatialreferencing/primemeridian) | r | Melempar InvalidOperationException, karena Local SRS tidak memiliki meridian utama. |
| type | [SpatialReferenceSystemType](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype) | r | Kembalikan [SpatialReferenceSystemType.LOCAL](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/). |
| unit | [Unit](/psd/python-net/aspose.gis.spatialreferencing/unit) | r | Unit dari SRS ini. |
...
| [get_unit(dimension)](#get_unit_dimension_12) | Dapatkan [LocalSpatialReferenceSystem.unit](/psd/python-net/aspose.gis.spatialreferencing/localspatialreferencesystem/) dimensi. |
...
Dapatkan [LocalSpatialReferenceSystem.unit](/psd/python-net/aspose.gis.spatialreferencing/localspatialreferencesystem/) dimensi.
