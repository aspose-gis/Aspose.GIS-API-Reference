---
title: "Kelas GeographicSpatialReferenceSystem"
type: docs
weight: 80
url: /id/python-net/aspose.gis.spatialreferencing/geographicspatialreferencesystem/
---
...
| :- | :- | :- | :- |
| angular_unit | [Unit](/psd/python-net/aspose.gis.spatialreferencing/unit) | r | Unit, yang digunakan untuk dimensi sudut, dalam SRS ini. |
...
| as_geographic | [GeographicSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/geographicspatialreferencesystem) | r | Mengembalikan ini. |
...
| axises_order | [GeographicAxisesOrder](/psd/python-net/aspose.gis.spatialreferencing/geographicaxisesorder) | r | Urutan sumbu dalam SRS ini.<br/> Jika SRS ini tidak valid dan memiliki arah sumbu yang salah, [GeographicAxisesOrder.INVALID](/psd/python-net/aspose.gis.spatialreferencing/geographicaxisesorder/) dikembalikan. |
| dimensions_count | int | r | Mengembalikan jumlah dimensi dalam SRS ini. Untuk SRS geografis ini dapat berupa:<br/> dua - jika ini adalah SRS geografis tunggal.<br/> tiga - jika ini adalah SRS gabungan, yang terdiri dari satu SRS geografis dua dimensi dan SRS vertikal, yang menambahkan dimensi ketiga. |
...
| has_geographic_datum | bool | r | Mengembalikan <see langword=\"true\" />, karena SRS geografis selalu memiliki meridian utama. |
| has_prime_meridian | bool | r | Mengembalikan <see langword=\"true\" />, karena SRS geografis selalu memiliki meridian utama. |
...
| type | [SpatialReferenceSystemType](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype) | r | Mengembalikan [SpatialReferenceSystemType.GEOGRAPHIC](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/). |
