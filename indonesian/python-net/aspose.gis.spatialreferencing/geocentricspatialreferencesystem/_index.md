---
title: "Kelas GeocentricSpatialReferenceSystem"
type: docs
weight: 50
url: /id/python-net/aspose.gis.spatialreferencing/geocentricspatialreferencesystem/
---
...
| as_geocentric | [GeocentricSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/geocentricspatialreferencesystem) | r | Kembalikan ini. |
...
| axises_order | [GeocentricAxisesOrder](/psd/python-net/aspose.gis.spatialreferencing/geocentricaxisesorder) | r | Urutan sumbu pada SRS ini.<br/>            Jika SRS ini tidak valid dan memiliki arah sumbu yang salah, [GeocentricAxisesOrder.INVALID](/psd/python-net/aspose.gis.spatialreferencing/geocentricaxisesorder/) akan dikembalikan. |
| dimensions_count | int | r | Kembalikan 3, karena SRS geosentrik selalu tiga dimensi. |
...
| geographic_datum | [GeographicDatum](/psd/python-net/aspose.gis.spatialreferencing/geographicdatum) | r | Kembalikan datum geografis dari SRS ini. |
| has_geographic_datum | bool | r | Kembalikan <see langword=\"true\" />, karena SRS geosentrik selalu memiliki datum geografis. |
| has_prime_meridian | bool | r | Kembalikan <see langword=\"true\" />, karena SRS geosentrik selalu memiliki meridian utama. |
...
| linear_unit | [Unit](/psd/python-net/aspose.gis.spatialreferencing/unit) | r | Unit, yang digunakan dalam SRS ini. |
...
| prime_meridian | [PrimeMeridian](/psd/python-net/aspose.gis.spatialreferencing/primemeridian) | r | Kembalikan meridian utama dari SRS ini. |
| type | [SpatialReferenceSystemType](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype) | r | Kembalikan [SpatialReferenceSystemType.GEOCENTRIC](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/). |
