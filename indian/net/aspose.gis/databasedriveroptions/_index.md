...
description: Aspose.Gis.DatabaseDriverOptions कक्ष. के लए वकल्प aDatabaseDriver .
type: docs
weight: 70
url: /hi/net/aspose.gis/databasedriveroptions/
---
## DatabaseDriverOptions class

के लिए विकल्प a[`DatabaseDriver`](../databasedriver/) .
...
| [DeleteNearPointsDistance](../../aspose.gis/driveroptions/deletenearpointsdistance/) { get; set; } | के लिए दूरी निर्धारित करता है[`DeleteNearPoints`](../driveroptions/deletenearpoints/) . करने के लिए चूक`0` . |
...
| [SimplifySegmentsDistance](../../aspose.gis/driveroptions/simplifysegmentsdistance/) { get; set; } | के लिए दूरी निर्धारित करता है[`SimplifySegments`](../driveroptions/simplifysegments/) . करने के लिए चूक`0` . |
