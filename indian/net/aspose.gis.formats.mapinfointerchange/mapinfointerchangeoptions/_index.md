...
description: Aspose.Gis.Formats.MapInfoInterchange.MapInfoInterchangeOptions कक्ष. मैपइन्फ इंटरचेंज प्ररूप के लए ड्रइवरवशष्ट वकल्प
type: docs
weight: 590
url: /hi/net/aspose.gis.formats.mapinfointerchange/mapinfointerchangeoptions/
---
## MapInfoInterchangeOptions class

मैपइन्फो इंटरचेंज प्रारूप के लिए ड्राइवर-विशिष्ट विकल्प।
...
| नाम | विवरण |
| --- | --- |
| [MapInfoInterchangeOptions](mapinfointerchangeoptions/)() | नया उदाहरण बनाएं। |
...
| [TextStringAttribute](../../aspose.gis.formats.mapinfointerchange/mapinfointerchangeoptions/textstringattribute/) { get; set; } | विशेषता का नाम निर्दिष्ट करता है जो 'टेक्स्ट' ग्राफिकल ऑब्जेक्ट के टेक्स्ट का प्रतिनिधित्व करता है। |
