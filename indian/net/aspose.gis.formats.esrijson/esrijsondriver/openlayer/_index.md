---
title: EsriJsonDriver.OpenLayer
second_title: .NET API संदर्भ के लिए Aspose.GIS
description: EsriJsonDriver तरक. पढ़ने के लए एक परत खलत है.
type: docs
weight: 50
url: /hi/net/aspose.gis.formats.esrijson/esrijsondriver/openlayer/
---
## OpenLayer(string, EsriJsonOptions) {#openlayer_5}
...
| options | EsriJsonOptions | चालक-विशिष्ट विकल्प। |
...
* नाम स्थान [Aspose.Gis.Formats.EsriJson](../../esrijsondriver/)
* सभा [Aspose.GIS](../../../)
...
## OpenLayer(AbstractPath, EsriJsonOptions) {#openlayer_2}
