...
description: Aspose.Gis.Formats.EsriJson.EsriJsonOptions कक्ष. EsriJson प्ररूप के लए ड्रइवरवशष्ट वकल्प
type: docs
weight: 240
url: /hi/net/aspose.gis.formats.esrijson/esrijsonoptions/
---
## EsriJsonOptions class

EsriJson प्रारूप के लिए ड्राइवर-विशिष्ट विकल्प।
...
| नाम | विवरण |
| --- | --- |
| [EsriJsonOptions](esrijsonoptions/)() | नया उदाहरण बनाएं। |
...
| [NestedPropertiesSeparator](../../aspose.gis.formats.esrijson/esrijsonoptions/nestedpropertiesseparator/) { get; set; } | एक स्ट्रिंग प्राप्त या सेट करता है जिसका उपयोग नेस्टेड विशेषताओं के घटकों को अलग करने के लिए किया जाता है। डिफ़ॉल्ट "_" है। |
