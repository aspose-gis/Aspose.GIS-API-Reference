...
description: Aspose.Gis.Formats.MapInfoTab.MapInfoTabOptions कक्ष. मैपइन्फ टैब प्ररूप के लए ड्रइवरवशष्ट वकल्प
type: docs
weight: 610
url: /hi/net/aspose.gis.formats.mapinfotab/mapinfotaboptions/
---
## MapInfoTabOptions class

मैपइन्फो टैब प्रारूप के लिए ड्राइवर-विशिष्ट विकल्प।
...
| नाम | विवरण |
| --- | --- |
| [MapInfoTabOptions](mapinfotaboptions/)() | नया उदाहरण बनाएं। |

## गुण

| नाम | विवरण |
| --- | --- |
| [BlockSize](../../aspose.gis.formats.mapinfotab/mapinfotaboptions/blocksize/) { get; set; } | '*.map' फ़ाइलों के लिए ब्लॉक आकार (512 के गुणक)। 16384 के लिए डिफ़ॉल्ट। मान्य मान: 512 से 32256. |
...
| [TextStringAttribute](../../aspose.gis.formats.mapinfotab/mapinfotaboptions/textstringattribute/) { get; set; } | विशेषता का नाम निर्दिष्ट करता है जो 'टेक्स्ट' ग्राफिकल ऑब्जेक्ट के टेक्स्ट का प्रतिनिधित्व करता है। |
