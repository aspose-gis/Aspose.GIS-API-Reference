...
description: Aspose.Gis.Formats.Kml.KmlOptions कक्ष. KML प्ररूप के लए ड्रइवरवशष्ट वकल्प.
type: docs
weight: 410
url: /hi/net/aspose.gis.formats.kml/kmloptions/
---
## KmlOptions class

KML प्रारूप के लिए ड्राइवर-विशिष्ट विकल्प.
...
| नाम | विवरण |
| --- | --- |
| [KmlOptions](kmloptions/)() | नया उदाहरण बनाएं। |

## गुण

| नाम | विवरण |
| --- | --- |
| [AltitudeMode](../../aspose.gis.formats.kml/kmloptions/altitudemode/) { get; set; } | आपको KML ज्यामिति के लिए उपयोग करने के लिए AltitudeModes निर्दिष्ट करने की अनुमति देता है |
| [AutoId](../../aspose.gis.formats.kml/kmloptions/autoid/) { get; set; } | आईडी स्वतः जनरेट करें |
...
| [DocumentId](../../aspose.gis.formats.kml/kmloptions/documentid/) { get; set; } | रूट 'दस्तावेज़' नोड की आईडी निर्दिष्ट करने के लिए उपयोग किया जाता है |
...
| [SymbolToReplaceInvalidChars](../../aspose.gis.formats.kml/kmloptions/symboltoreplaceinvalidchars/) { get; set; } | यह निर्धारित करता है कि पढ़ने पर अमान्य वर्णों को बदलने के लिए किस प्रतीक का उपयोग किया जाएगा। यदि मान '\0' है तो प्रतिस्थापित करना छोड़ दिया जाता है। डिफ़ॉल्ट मान '\0' char. है |
