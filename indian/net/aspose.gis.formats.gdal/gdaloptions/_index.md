...
description: Aspose.Gis.Formats.GDAL.GdalOptions कक्ष. जडएएल प्ररूप के लए ड्रइवरवशष्ट वकल्प
type: docs
weight: 290
url: /hi/net/aspose.gis.formats.gdal/gdaloptions/
---
## GdalOptions class

जीडीएएल प्रारूप के लिए ड्राइवर-विशिष्ट विकल्प।
...
| नाम | विवरण |
| --- | --- |
| [GdalOptions](gdaloptions/)(string) | एक नया उदाहरण बनाएं। |
...
| [FileName](../../aspose.gis.formats.gdal/gdaloptions/filename/) { get; set; } | प्रारंभ करने के लिए आवेदन का नाम |
...
| [PathToTempFile](../../aspose.gis.formats.gdal/gdaloptions/pathtotempfile/) { get; } | अस्थायी फ़ाइलों का पथ. |
