...
description: Surface तरक. डफ़ल्ट क उपयग करके इस ज्यमत क अनुमनत य समतुल्य गैरवक्र संस्करण प्रप्त करत हैसहनशलत .
type: docs
weight: 40
url: /hi/net/aspose.gis.geometries/surface/tolineargeometry/
---
...
ए[`IPolygon`](../../ipolygon/) जो इसके बराबर या इसके बराबर हो`ISurface`. यह इसके बराबर है[`ToLinearGeometry`](../../isurface/tolineargeometry/) with डिफ़ॉल्ट`सहनशीलता` . गलती करना`सहनशीलता` का मान निर्भर करता है[`SpatialReferenceSystem`](../../../aspose.gis.spatialreferencing/spatialreferencesystem/) इस ज्यामिति का :  अनुमानित SRS के लिए सहनशीलता 0.001 मीटर (SRS इकाइयों में) है भौगोलिक एसआरएस सहिष्णुता के लिए है`1e-5` डिग्री (एसआरएस इकाइयों में) अज्ञात एसआरएस के लिए सहिष्णुता है`1e-5` किन परिवर्तनों को लागू किया जाता है, इसके बारे में अधिक जानकारी के लिए देखें[`ToLinearGeometry`](../../isurface/tolineargeometry/) विशिष्टता.
...
ए[`IPolygon`](../../ipolygon/) जो इसके बराबर या इसके बराबर हो`ISurface` :  यदि यह वस्तु है[`IPolygon`](../../ipolygon/) परिणाम स्वयं इस object के समतुल्य है यदि यह वस्तु नहीं है[`IPolygon`](../../ipolygon/) यह रैखिक है और[`IPolygon`](../../ipolygon/) बनाया गया है
