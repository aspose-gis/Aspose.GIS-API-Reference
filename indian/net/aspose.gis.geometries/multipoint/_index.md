...
description: Aspose.Gis.Geometries.MultiPoint कक्ष. एMultiPoint एक आयम हैGeometryCollection जसके तत्व हैंPoint s.
type: docs
weight: 1160
url: /hi/net/aspose.gis.geometries/multipoint/
---
## MultiPoint class

ए`MultiPoint` एक आयामी है[`GeometryCollection`](../geometrycollection/) जिसके तत्व हैं[`Point`](../point/) s.
...
| नाम | विवरण |
| --- | --- |
| [MultiPoint](multipoint/)() | का एक नया उदाहरण प्रारंभ करता है`MultiPoint` वर्ग. |
...
| [Dimension](../../aspose.gis.geometries/multipoint/dimension/) { get; } | इसका सामयिक आयाम प्राप्त करता है[`Geometry`](../geometry/) . |
| override [GeometryType](../../aspose.gis.geometries/multipoint/geometrytype/) { get; } | ज्यामिति का प्रकार प्राप्त करता है। |
...
| override [Clone](../../aspose.gis.geometries/multipoint/clone/)() | इस उदाहरण को क्लोन करता है। |
...
| [ToEditable](../../aspose.gis.geometries/multipoint/toeditable/#toeditable_2)() | इस ज्यामिति की एक संपादन योग्य प्रति प्राप्त करता है। (3 methods) |
| [ToEditable&lt;T&gt;](../../aspose.gis.geometries/geometry/toeditable/)() | इस ज्यामिति की एक संपादन योग्य प्रति प्राप्त करता है। |
| [ToLinearGeometry](../../aspose.gis.geometries/geometrycollection/tolineargeometry/)() | डिफ़ॉल्ट का उपयोग करके इस ज्यामिति का अनुमानित या समतुल्य गैर-वक्र संस्करण प्राप्त करता है`सहनशीलता` . (2 methods) |
| [ToLinearGeometry](../../aspose.gis.geometries/geometrycollection/tolineargeometry/)(double) | निर्दिष्ट का उपयोग करके इस ज्यामिति का अनुमानित या समकक्ष गैर-वक्र संस्करण प्राप्त करता है`सहनशीलता` . (2 methods) |
