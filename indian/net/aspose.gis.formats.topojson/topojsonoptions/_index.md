...
description: Aspose.Gis.Formats.TopoJson.TopoJsonOptions कक्ष. TopoJSON प्ररूप के लए ड्रइवरवशष्ट वकल्प
type: docs
weight: 710
url: /hi/net/aspose.gis.formats.topojson/topojsonoptions/
---
## TopoJsonOptions class

TopoJSON प्रारूप के लिए ड्राइवर-विशिष्ट विकल्प।
...
| नाम | विवरण |
| --- | --- |
| [TopoJsonOptions](topojsonoptions/)() | नया उदाहरण बनाएं। |
...
| [DefaultObjectName](../../aspose.gis.formats.topojson/topojsonoptions/defaultobjectname/) { get; set; } | उस वस्तु का नाम जहां सुविधाओं को डिफ़ॉल्ट रूप से रखा जाता है। |
...
| [NestedPropertiesSeparator](../../aspose.gis.formats.topojson/topojsonoptions/nestedpropertiesseparator/) { get; set; } | एक स्ट्रिंग प्राप्त या सेट करता है जिसका उपयोग नेस्टेड विशेषताओं के घटकों को अलग करने के लिए किया जाता है। डिफ़ॉल्ट "_" है। |
| [ObjectNameAttribute](../../aspose.gis.formats.topojson/topojsonoptions/objectnameattribute/) { get; set; } | विशेषता का नाम, जो उस वस्तु के नाम को दर्शाता है जिसमें एक विशेषता है। |
| [QuantizationNumber](../../aspose.gis.formats.topojson/topojsonoptions/quantizationnumber/) { get; set; } | आउटपुट TopoJSON. में निर्देशांक और डेल्टा-एनकोड आर्क्स को परिमाणित करने के लिए उपयोग करने के लिए परिमाणीकरण संख्या निर्दिष्ट करता है |
...
| [Transform](../../aspose.gis.formats.topojson/topojsonoptions/transform/) { get; set; } | आउटपुट TopoJSON. में निर्देशांक और डेल्टा-एनकोड आर्क्स को मापने के लिए उपयोग करने के लिए ट्रांसफॉर्म ऑब्जेक्ट निर्दिष्ट करता है। |
