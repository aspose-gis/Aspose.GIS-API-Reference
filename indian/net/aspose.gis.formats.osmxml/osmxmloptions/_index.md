...
description: Aspose.Gis.Formats.OsmXml.OsmXmlOptions कक्ष. OSM XML प्ररूप के लए ड्रइवरवशष्ट वकल्प
type: docs
weight: 630
url: /hi/net/aspose.gis.formats.osmxml/osmxmloptions/
---
## OsmXmlOptions class

OSM XML प्रारूप के लिए ड्राइवर-विशिष्ट विकल्प।
...
| नाम | विवरण |
| --- | --- |
| [OsmXmlOptions](osmxmloptions/)() | नया उदाहरण बनाएं। |
...
| [ReportAllNodes](../../aspose.gis.formats.osmxml/osmxmloptions/reportallnodes/) { get; set; } | सभी नोड्स को सुविधाओं के रूप में रिपोर्ट करें, भले ही उनके पास कोई महत्वपूर्ण टैग न हो। |
| [ReportAllWays](../../aspose.gis.formats.osmxml/osmxmloptions/reportallways/) { get; set; } | सुविधाओं के रूप में सभी तरीकों की रिपोर्ट करें, भले ही उनके पास कोई महत्वपूर्ण टैग न हो या कोई नोड न हो। |
| [ReportCommonAttributes](../../aspose.gis.formats.osmxml/osmxmloptions/reportcommonattributes/) { get; set; } | सामान्य OSM विशेषताओं की रिपोर्ट करें: दृश्य, संस्करण, परिवर्तन, टाइमस्टैम्प, उपयोगकर्ता और यूआईडी। |
