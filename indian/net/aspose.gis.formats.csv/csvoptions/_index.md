...
description: Aspose.Gis.Formats.Csv.CsvOptions कक्ष. CSV प्ररूप के लए ड्रइवरवशष्ट वकल्प
type: docs
weight: 200
url: /hi/net/aspose.gis.formats.csv/csvoptions/
---
## CsvOptions class
...
| नाम | विवरण |
| --- | --- |
| [CsvOptions](csvoptions/)() | नया उदाहरण बनाएं। |
...
| [ColumnM](../../aspose.gis.formats.csv/csvoptions/columnm/) { get; set; } | कॉलम का नाम प्राप्त या सेट करता है जिसमें एम समन्वय मान होता है। डिफ़ॉल्ट है`null` . |
| [ColumnWkt](../../aspose.gis.formats.csv/csvoptions/columnwkt/) { get; set; } | कॉलम का नाम प्राप्त या सेट करता है जिसमें ज्यामिति का प्रतिनिधित्व करने के लिए प्रसिद्ध पाठ होता है। डिफ़ॉल्ट है`null` . |
| [ColumnX](../../aspose.gis.formats.csv/csvoptions/columnx/) { get; set; } | कॉलम का नाम प्राप्त या सेट करता है जिसमें एक्स समन्वय मान होता है। डिफ़ॉल्ट है`null` . |
| [ColumnY](../../aspose.gis.formats.csv/csvoptions/columny/) { get; set; } | कॉलम का नाम प्राप्त या सेट करता है जिसमें वाई समन्वय मान होता है। डिफ़ॉल्ट है`null` . |
| [ColumnZ](../../aspose.gis.formats.csv/csvoptions/columnz/) { get; set; } | कॉलम का नाम प्राप्त या सेट करता है जिसमें जेड समन्वय मान होता है। डिफ़ॉल्ट है`null` . |
...
| [Delimiter](../../aspose.gis.formats.csv/csvoptions/delimiter/) { get; set; } | एक वर्ण प्राप्त करता है या सेट करता है जिसका उपयोग मानों को अलग करने के लिए सीमांकक के रूप में किया जाता है। डिफ़ॉल्ट ',' है। |
| [DoubleQuoteEscape](../../aspose.gis.formats.csv/csvoptions/doublequoteescape/) { get; set; } | एक वर्ण प्राप्त या सेट करता है जिसे डबल-कोट्स के लिए एस्केप लेटर के रूप में उपयोग किया जाता है। डिफ़ॉल्ट '"' है। |
| [HasAttributeNames](../../aspose.gis.formats.csv/csvoptions/hasattributenames/) { get; set; } | यह निर्धारित करता है कि विशेषता नामों वाली हेडर पंक्ति मौजूद है या नहीं। डिफ़ॉल्ट है`true` . |
...
| [StartLineNumber](../../aspose.gis.formats.csv/csvoptions/startlinenumber/) { get; set; } | लाइन की एक शून्य-आधारित संख्या प्राप्त या सेट करता है जो डेटा पढ़ते समय सबसे पहले होगी। डिफ़ॉल्ट 0. है |
