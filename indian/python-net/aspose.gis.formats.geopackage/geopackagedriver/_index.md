---
title: "GeoPackageDriver क्लास"
type: docs
weight: 20
url: /hi/python-net/aspose.gis.formats.geopackage/geopackagedriver/
---
...
| **नाम** | **विवरण** |
| :- | :- |
| [GeoPackageDriver()](#GeoPackageDriver__1) | GeoPackageDriver क्लास का एक नया इंस्टेंस प्रारंभ करता है |
## **Properties**
...
| [open_dataset(path, options)](#open_dataset_path_options_19) | डेटासेट खोलता है। |
| [open_layer(path)](#open_layer_path_20) | पढ़ने के लिए लेयर खोलता है। |
| [open_layer(path)](#open_layer_path_21) | पढ़ने के लिए लेयर खोलता है। |
| [open_layer(path, options)](#open_layer_path_options_22) | पढ़ने के लिए लेयर खोलता है। |
| [open_layer(path, options)](#open_layer_path_options_23) | पढ़ने के लिए लेयर खोलता है। |
...
GeoPackageDriver क्लास का एक नया इंस्टेंस प्रारंभ करता है
...
| :- | :- | :- |
| path | [AbstractPath](/psd/python-net/aspose.gis/abstractpath) | डेटासेट का पथ। |
| options | [GeoPackageOptions](/psd/python-net/aspose.gis.formats.geopackage/geopackageoptions) | ड्राइवर-विशिष्ट विकल्प। |

**Returns**

| प्रकार | विवरण |
| :- | :- |
| [GeoPackageDataset](/psd/python-net/aspose.gis.formats.geopackage/geopackagedataset) | एक उदाहरण [Dataset](/psd/python-net/aspose.gis/dataset/) का। |
