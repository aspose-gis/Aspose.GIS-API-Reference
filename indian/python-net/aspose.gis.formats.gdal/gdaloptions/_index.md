---
title: "GdalOptions क्लास"
type: docs
weight: 20
url: /hi/python-net/aspose.gis.formats.gdal/gdaloptions/
---
...
| **नाम** | **विवरण** |
| :- | :- |
| [GdalOptions(temp_directory)](#GdalOptions_temp_directory_1) | एक नया इंस्टेंस बनाएं। |
## **Properties**
...
| file_name | string | r/w | शुरू करने के लिए एप्लिकेशन का नाम |
...
| path_to_temp_file | string | r | अस्थायी फ़ाइलों का पथ। |
...
एक नया इंस्टेंस बनाएं।

**Parameters:**

| पैरामीटर | प्रकार | विवरण |
| :- | :- | :- |
| temp_directory | string | अस्थायी फ़ाइलों का पथ। डिफ़ॉल्ट रूप से उपयोगकर्ता का अस्थायी फ़ोल्डर। |
