---
title: "GdalDriver क्लास"
type: docs
weight: 10
url: /hi/python-net/aspose.gis.formats.gdal/gdaldriver/
---
...
| [create_layer(path, options, spatial_reference_system)](#create_layer_path_options_spatial_reference_system_9) | एक लेयर बनाता है और नई विशेषताएँ जोड़ने के लिए उसे खोलता है। |
| [create_layer(path, options, spatial_reference_system)](#create_layer_path_options_spatial_reference_system_10) | एक लेयर बनाता है और नई विशेषताएँ जोड़ने के लिए उसे खोलता है। |
...
| [open_layer(path, options)](#open_layer_path_options_21) | पढ़ने के लिए एक लेयर खोलता है। |
| [open_layer(path, options)](#open_layer_path_options_22) | पढ़ने के लिए एक लेयर खोलता है। |
| [open_layer(path, options)](#open_layer_path_options_23) | पढ़ने के लिए एक लेयर खोलता है। |
| [supports_spatial_reference_system(spatial_reference_system)](#supports_spatial_reference_system_spatial_reference_system_24) | निर्धारित करता है कि निर्दिष्ट स्पैशियल रेफ़रेंस सिस्टम ड्राइवर द्वारा समर्थित है या नहीं। |
...
| :- | :- | :- |
| path | string | फ़ाइल का पथ। |
| options | [GdalOptions](/psd/python-net/aspose.gis.formats.gdal/gdaloptions) | ड्राइवर-विशिष्ट विकल्प। |
