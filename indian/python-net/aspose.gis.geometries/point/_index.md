...
type: docs
weight: 300
url: /hi/python-net/aspose.gis.geometries/point/
---
...
| **नाम** | **विवरण** |
| :- | :- |
| [Point()](#Point__1) | एक नया उदाहरण प्रारंभ करता है [Point](/psd/python-net/aspose.gis.geometries/point/) क्लास का। |
| [Point(other)](#Point_other_2) | एक नया उदाहरण प्रारंभ करता है [Point](/psd/python-net/aspose.gis.geometries/point/) क्लास का। |
| [Point(x, y)](#Point_x_y_3) | एक नया उदाहरण प्रारंभ करता है [Point](/psd/python-net/aspose.gis.geometries/point/) क्लास का। |
| [Point(x, y, z)](#Point_x_y_z_4) | एक नया उदाहरण प्रारंभ करता है [Point](/psd/python-net/aspose.gis.geometries/point/) क्लास का। |
| [Point(x, y, z, m)](#Point_x_y_z_m_5) | एक नया उदाहरण प्रारंभ करता है [Point](/psd/python-net/aspose.gis.geometries/point/) क्लास का। |
## **Properties**
...
| m | double | r/w | m-निर्देशांक के लिए मान प्राप्त करता है या सेट करता है। |
...
| x | double | r/w | x-निर्देशांक के लिए मान प्राप्त करता है या सेट करता है। |
| y | double | r/w | y-निर्देशांक के लिए मान प्राप्त करता है या सेट करता है। |
| z | double | r/w | z-निर्देशांक के लिए मान प्राप्त करता है या सेट करता है। |
## **Methods**
| **नाम** | **विवरण** |
| :- | :- |
...
| [from_binary(wkb)](#from_binary_wkb_15) | उसके Well-Known Binary प्रतिनिधित्व से एक ज्यामिति बनाता है। |
| [from_binary(wkb, spatial_reference_system)](#from_binary_wkb_spatial_reference_system_16) | उसके Well-Known Binary प्रतिनिधित्व से एक ज्यामिति बनाता है। |
| [from_text(wkt)](#from_text_wkt_17) | उसके Well-Known Text प्रतिनिधित्व से एक ज्यामिति बनाता है। |
| [from_text(wkt, spatial_reference_system)](#from_text_wkt_spatial_reference_system_18) | उसके Well-Known Text प्रतिनिधित्व से एक ज्यामिति बनाता है। |
| [get_area()](#get_area__19) | इस ज्यामिति का क्षेत्रफल गणना करता है। |
| [get_buffer(distance, quadrant_segments)](#get_buffer_distance_quadrant_segments_20) | इस ज्यामिति के चारों ओर एक बफ़र क्षेत्र गणना करता है। |
| [get_centroid()](#get_centroid__21) | इस ज्यामिति का केंद्रबिंदु गणना करता है। |
| [get_convex_hull()](#get_convex_hull__22) | इस ज्यामिति का कॉन्वेक्स हुल गणना करता है। |
| [get_distance_to(other)](#get_distance_to_other_23) | इस ज्यामिति और निर्दिष्ट ज्यामिति के बीच न्यूनतम दूरी गणना करता है। |
| [get_extent()](#get_extent__24) | इस ज्यामिति का बाउंडिंग विस्तार गणना करता है और लौटाता है। |
| [get_length()](#get_length__25) | इस ज्यामिति की लंबाई गणना करता है। |
| [intersection(other)](#intersection_other_26) | इस ज्यामिति और निर्दिष्ट ज्यामिति के बीच प्रतिच्छेदन बनाता है। |
| [intersects(extent)](#intersects_extent_27) | निर्धारित करता है कि यह ज्यामिति निर्दिष्ट विस्तार को प्रतिच्छेद करती है या नहीं। |
| [intersects(other)](#intersects_other_28) | निर्धारित करता है कि यह ज्यामिति और निर्दिष्ट ज्यामिति प्रतिच्छेद करती हैं या नहीं। |
| [overlaps(other)](#overlaps_other_29) | निर्धारित करता है कि यह ज्यामिति निर्दिष्ट ज्यामिति के साथ ओवरलैप करती है या नहीं। |
| [relate(other, intersection_pattern_matrix)](#relate_other_intersection_pattern_matrix_30) | निर्धारित करता है कि इस ज्यामिति और निर्दिष्ट ज्यामिति का DE-9IM प्रतिच्छेद मैट्रिक्स प्रदान किए गए पैटर्न से मेल खाता है या नहीं। |
| [replace_polygons_by_lines()](#replace_polygons_by_lines__31) | इस ज्यामिति की रेखाओं के रूप में प्रतिनिधित्व किए गए बहुभुज प्राप्त करता है। |
| [round_m(digits)](#round_m_digits_32) | M निर्देशांक को निर्दिष्ट दशमलव अंकों की संख्या तक गोल करता है। |
| [round_xy(digits)](#round_xy_digits_33) | X और Y निर्देशांक को निर्दिष्ट दशमलव अंकों की संख्या तक गोल करता है। |
| [round_z(digits)](#round_z_digits_34) | Z निर्देशांक को निर्दिष्ट दशमलव अंकों की संख्या तक गोल करता है। |
| set_empty() | इस [Geometry](/psd/python-net/aspose.gis.geometries/geometry/) को खाली बनाता है। |
| [spatially_contains(other)](#spatially_contains_other_35) | निर्धारित करता है कि यह ज्यामिति स्थानिक रूप से निर्दिष्ट ज्यामिति को शामिल करती है या नहीं। |
| [spatially_equals(other)](#spatially_equals_other_36) | निर्धारित करता है कि यह ज्यामिति स्थानिक रूप से निर्दिष्ट ज्यामिति के बराबर है या नहीं। |
| [sym_difference(other)](#sym_difference_other_37) | इस ज्यामिति और निर्दिष्ट ज्यामिति के बीच सममित अंतर बनाता है। |
| [to_editable()](#to_editable__38) | इस ज्यामिति की एक संपादन योग्य प्रति प्राप्त करता है। |
| [to_linear_geometry()](#to_linear_geometry__39) | डिफ़ॉल्ट <c>tolerance</c> का उपयोग करके इस ज्यामिति का अनुमानित या समतुल्य गैर-वक्र संस्करण प्राप्त करता है। |
| [to_linear_geometry(tolerance)](#to_linear_geometry_tolerance_40) | निर्दिष्ट <c>tolerance</c> का उपयोग करके इस ज्यामिति का अनुमानित या समतुल्य गैर-वक्र संस्करण प्राप्त करता है। |
| [to_svg(extent)](#to_svg_extent_41) | इस ज्यामिति को Svg प्रतिनिधित्व में अनुवादित करता है। |
| [touches(other)](#touches_other_42) | निर्धारित करता है कि यह ज्यामिति और निर्दिष्ट ज्यामिति स्पर्श करती हैं या नहीं। |
| [union(other)](#union_other_43) | इस ज्यामिति और निर्दिष्ट ज्यामिति को मिलाता है। |
| [union(other)](#union_other_44) | इस ज्यामिति और निर्दिष्ट ज्यामिति को मिलाता है। |
| [within(extent)](#within_extent_45) | निर्धारित करता है कि यह ज्यामिति निर्दिष्ट सीमा के भीतर है या नहीं। |
| [within(other)](#within_other_46) | निर्धारित करता है कि यह ज्यामिति निर्दिष्ट ज्यामिति के भीतर है या नहीं। |
...
एक नया उदाहरण प्रारंभ करता है [Point](/psd/python-net/aspose.gis.geometries/point/) क्लास का।
...
| :- | :- | :- |
| other | [IPoint](/psd/python-net/aspose.gis.geometries/ipoint) | डेटा कॉपी करने के लिए अन्य [IPoint](/psd/python-net/aspose.gis.geometries/ipoint/)। |
...
| पैरामीटर | प्रकार | विवरण |
| :- | :- | :- |
| दूरी | double | बफ़र क्षेत्र की चौड़ाई। |
...
| प्रकार | विवरण |
| :- | :- |
| double | यदि दोनों ज्यामितियाँ [Geometry.is_empty](/psd/python-net/aspose.gis.geometries/geometry/) नहीं हैं - तो ज्यामितियों के निकटतम बिंदुओं के बीच दूरी।<br/>            यदि कम से कम एक ज्यामिति खाली है तो -1 लौटाया जाता है। |
...
| प्रकार | विवरण |
| :- | :- |
| [Point](/psd/python-net/aspose.gis.geometries/point) | इस ज्यामिति की एक संपादन योग्य प्रति। |
...
| प्रकार | विवरण |
| :- | :- |
| [IGeometry](/psd/python-net/aspose.gis.geometries/igeometry) | वक्र ज्यामितियों के बिना एक ज्यामिति। यह <DOM Element: class at 0x2a1791a70d0>.IGeometry.to_linear_geometry()(float) के बराबर है जिसमें<br/>            डिफ़ॉल्ट <c>tolerance</c> है। डिफ़ॉल्ट <c>tolerance</c> इस ज्यामिति के [IGeometry.spatial_reference_system](/psd/python-net/aspose.gis.geometries/igeometry/) द्वारा परिभाषित है:<br/>            <ul><br/>            <li> प्रोजेक्टेड SRS के लिए टॉलरेंस 0.001 मीटर (SRS इकाइयों में) </li><br/>            <li> जियोग्राफिक SRS के लिए टॉलरेंस <c>1e-5</c> डिग्री (SRS इकाइयों में) </li><br/>            <li> अज्ञात SRS के लिए टॉलरेंस <c>1e-5</c> </li><br/>            </ul><br/>            लागू किए गए ट्रांसफ़ॉर्मेशन के बारे में अधिक विवरण के लिए <DOM Element: class at 0x2a1791a70d0>.IGeometry.to_linear_geometry()(float) विनिर्देश देखें। |
...
| पैरामीटर | प्रकार | विवरण |
| :- | :- | :- |
| टॉलरेंस | double | उपयोग करने के लिए <c>tolerance</c>। परिणाम <c>tolerance</c> से कम दूरी पर होने की गारंटी है <br/>            वक्र ज्यामिति से, जब तक कि ज्यामिति को रैखिक बनाने के लिए आवश्यक बिंदुओं की संख्या प्रति-चतुर्थांश अधिकतम को पार न कर ले<br/>            जो वर्तमान में 10000 बिंदुओं के बराबर है। |

**Returns**

| प्रकार | विवरण |
| :- | :- |
| [IGeometry](/psd/python-net/aspose.gis.geometries/igeometry) | वक्र ज्यामितियों के बिना एक ज्यामिति। निम्नलिखित रूपांतरण लागू किए जाते हैं:<br/>            <ul><br/>            <li> [GeometryType.CIRCULAR_STRING](/psd/python-net/aspose.gis.geometries/geometrytype/) को रैखिक किया जाता है<br/>            (निर्दिष्ट <paramref name="tolerance" /> के साथ [GeometryType.LINE_STRING](/psd/python-net/aspose.gis.geometries/geometrytype/) में परिवर्तित किया जाता है) </li><br/>            <li> [GeometryType.COMPOUND_CURVE](/psd/python-net/aspose.gis.geometries/geometrytype/) को <c>LineString</c> में जोड़ा जाता है </li><br/>            <li> [GeometryType.CURVE_POLYGON](/psd/python-net/aspose.gis.geometries/geometrytype/) को [GeometryType.POLYGON](/psd/python-net/aspose.gis.geometries/geometrytype/) में परिवर्तित किया जाता है </li><br/>            <li> [GeometryType.MULTI_CURVE](/psd/python-net/aspose.gis.geometries/geometrytype/) को [GeometryType.MULTI_LINE_STRING](/psd/python-net/aspose.gis.geometries/geometrytype/) में परिवर्तित किया जाता है </li><br/>            <li> [GeometryType.MULTI_SURFACE](/psd/python-net/aspose.gis.geometries/geometrytype/) को [GeometryType.MULTI_POLYGON](/psd/python-net/aspose.gis.geometries/geometrytype/) में परिवर्तित किया जाता है </li><br/>            </ul><br/>            परिणामस्वरूप, आउटपुट ज्यामिति का [IGeometry.has_curve_geometry](/psd/python-net/aspose.gis.geometries/igeometry/) <see langword="false" /> होता है। |
