---
title: "CurvePolygon क्लास"
type: docs
weight: 40
url: /hi/python-net/aspose.gis.geometries/curvepolygon/
---
...
| **नाम** | **विवरण** |
| :- | :- |
| [CurvePolygon()](#CurvePolygon__1) | नया उदाहरण प्रारंभ करता है [CurvePolygon](/psd/python-net/aspose.gis.geometries/curvepolygon/) क्लास का। |
| [CurvePolygon(exterior_ring)](#CurvePolygon_exterior_ring_2) | नया उदाहरण प्रारंभ करता है [CurvePolygon](/psd/python-net/aspose.gis.geometries/curvepolygon/) क्लास का। |
| [CurvePolygon(exterior_ring, interior_rings)](#CurvePolygon_exterior_ring_interior_rings_3) | नया उदाहरण प्रारंभ करता है [CurvePolygon](/psd/python-net/aspose.gis.geometries/curvepolygon/) क्लास का। |
## **Properties**
...
| exterior_ring | [ICurve](/psd/python-net/aspose.gis.geometries/icurve) | r/w | बाहरी रिंग प्राप्त करता है। |
...
| interior_rings_count | इंट | r | आंतरिक रिंगों की संख्या प्राप्त करता है। |
...
| **नाम** | **विवरण** |
| :- | :- |
| [add_interior_ring(ring)](#add_interior_ring_ring_1) | एक आंतरिक रिंग जोड़ता है। |
| [as_binary()](#as_binary__2) | इस ज्यामिति को उसके Well-Known Binary प्रतिनिधित्व में परिवर्तित करता है। |
| [as_binary(variant)](#as_binary_variant_3) | इस ज्यामिति को उसके Well-Known Binary प्रतिनिधित्व में परिवर्तित करता है। |
...
| [as_image(width, height, renderer, symbolizer)](#as_image_width_height_renderer_symbolizer_6) | इस ज्यामिति को छवि प्रतिनिधित्व में निर्यात करता है। |
| [as_text()](#as_text__7) | इस ज्यामिति को उसके Well-Known Text प्रतिनिधित्व में परिवर्तित करता है। |
| [as_text(variant)](#as_text_variant_8) | इस ज्यामिति को उसके Well-Known Text प्रतिनिधित्व में परिवर्तित करता है। |
| [as_text(variant, format)](#as_text_variant_format_9) | इस ज्यामिति को उसके Well-Known Text प्रतिनिधित्व में परिवर्तित करता है। |
| [clone()](#clone__10) | इस उदाहरण की प्रतिलिपि बनाता है। |
| [covered_by(other)](#covered_by_other_11) | निर्धारित करता है कि यह ज्यामिति निर्दिष्ट ज्यामिति द्वारा कवर की गई है या नहीं। |
| [covers(other)](#covers_other_12) | निर्धारित करता है कि यह ज्यामिति निर्दिष्ट ज्यामिति को कवर करती है या नहीं। |
| [crosses(other)](#crosses_other_13) | निर्धारित करता है कि यह ज्यामिति और निर्दिष्ट ज्यामिति क्रॉस करती हैं। |
| [difference(other)](#difference_other_14) | इस ज्यामिति से निर्दिष्ट ज्यामिति घटाता है। |
| [disjoint(other)](#disjoint_other_15) | निर्धारित करता है कि यह ज्यामिति निर्दिष्ट ज्यामिति से अलग है। |
| [from_binary(wkb)](#from_binary_wkb_16) | उसके Well-Known Binary प्रतिनिधित्व से एक ज्यामिति बनाता है। |
| [from_binary(wkb, spatial_reference_system)](#from_binary_wkb_spatial_reference_system_17) | उसके Well-Known Binary प्रतिनिधित्व से एक ज्यामिति बनाता है। |
| [from_text(wkt)](#from_text_wkt_18) | उसके Well-Known Text प्रतिनिधित्व से एक ज्यामिति बनाता है। |
| [from_text(wkt, spatial_reference_system)](#from_text_wkt_spatial_reference_system_19) | उसके Well-Known Text प्रतिनिधित्व से एक ज्यामिति बनाता है। |
| [get_area()](#get_area__20) | इस ज्यामिति का क्षेत्रफल गणना करता है। |
| [get_buffer(distance, quadrant_segments)](#get_buffer_distance_quadrant_segments_21) | इस ज्यामिति के चारों ओर एक बफ़र क्षेत्र गणना करता है। |
| [get_centroid()](#get_centroid__22) | इस ज्यामिति का केंद्रबिंदु गणना करता है। |
| [get_convex_hull()](#get_convex_hull__23) | इस ज्यामिति का कॉन्वेक्स हुल गणना करता है। |
| [get_distance_to(other)](#get_distance_to_other_24) | इस ज्यामिति और निर्दिष्ट ज्यामिति के बीच न्यूनतम दूरी गणना करता है। |
| [get_extent()](#get_extent__25) | इस ज्यामिति का बाउंडिंग विस्तार गणना करता है और लौटाता है। |
| [get_interior_ring(index)](#get_interior_ring_index_26) | इंडेक्स द्वारा आंतरिक रिंग प्राप्त करता है। |
| [get_length()](#get_length__27) | इस ज्यामिति की लंबाई गणना करता है। |
| [get_point_on_surface()](#get_point_on_surface__28) | एक बिंदु खोजता है जो इस वक्र बहुभुज पर होने की गारंटी देता है। |
...
| [replace_polygons_by_lines()](#replace_polygons_by_lines__34) | इस ज्यामिति की रेखाओं के रूप में प्रतिनिधित्व किए गए बहुभुज प्राप्त करता है। |
| [round_m(digits)](#round_m_digits_35) | M निर्देशांक को निर्दिष्ट दशमलव अंकों की संख्या तक गोल करता है। |
| [round_xy(digits)](#round_xy_digits_36) | X और Y निर्देशांक को निर्दिष्ट दशमलव अंकों की संख्या तक गोल करता है। |
| [round_z(digits)](#round_z_digits_37) | Z निर्देशांक को निर्दिष्ट दशमलव अंकों की संख्या तक गोल करता है। |
| set_empty() | इस [Geometry](/psd/python-net/aspose.gis.geometries/geometry/) को खाली बनाता है। |
| [spatially_contains(other)](#spatially_contains_other_38) | निर्धारित करता है कि यह ज्यामिति स्थानिक रूप से निर्दिष्ट ज्यामिति को शामिल करती है या नहीं। |
| [spatially_equals(other)](#spatially_equals_other_39) | निर्धारित करता है कि यह ज्यामिति स्थानिक रूप से निर्दिष्ट ज्यामिति के बराबर है या नहीं। |
| [sym_difference(other)](#sym_difference_other_40) | इस ज्यामिति और निर्दिष्ट ज्यामिति के बीच सममित अंतर बनाता है। |
| [to_editable()](#to_editable__41) | इस ज्यामिति की एक संपादन योग्य प्रति प्राप्त करता है। |
| [to_linear_geometry()](#to_linear_geometry__42) | डिफ़ॉल्ट <c>tolerance</c> का उपयोग करके इस ज्यामिति का अनुमानित या समतुल्य गैर-वक्र संस्करण प्राप्त करता है। |
| [to_linear_geometry(tolerance)](#to_linear_geometry_tolerance_43) | निर्दिष्ट <c>tolerance</c> का उपयोग करके इस ज्यामिति का अनुमानित या समतुल्य गैर-वक्र संस्करण प्राप्त करता है। |
| [to_svg(extent)](#to_svg_extent_44) | इस ज्यामिति को Svg प्रतिनिधित्व में अनुवादित करता है। |
| [touches(other)](#touches_other_45) | निर्धारित करता है कि यह ज्यामिति और निर्दिष्ट ज्यामिति स्पर्श करती हैं या नहीं। |
| [union(other)](#union_other_46) | इस ज्यामिति और निर्दिष्ट ज्यामिति को मिलाता है। |
| [union(other)](#union_other_47) | इस ज्यामिति और निर्दिष्ट ज्यामिति को मिलाता है। |
| [within(extent)](#within_extent_48) | निर्धारित करता है कि यह ज्यामिति निर्दिष्ट सीमा के भीतर है या नहीं। |
| [within(other)](#within_other_49) | निर्धारित करता है कि यह ज्यामिति निर्दिष्ट ज्यामिति के भीतर है या नहीं। |
...
नया उदाहरण प्रारंभ करता है [CurvePolygon](/psd/python-net/aspose.gis.geometries/curvepolygon/) क्लास का।
...
| :- | :- | :- |
| exterior_ring | [ICurve](/psd/python-net/aspose.gis.geometries/icurve) | बाहरी रिंग। |
...
| :- | :- | :- |
| exterior_ring | [ICurve](/psd/python-net/aspose.gis.geometries/icurve) | बाहरी रिंग। |
| आंतरिक_रिंग्स | System.Collections.Generic.IEnumerable<ICurve> | आंतरिक रिंगें। |
...
| पैरामीटर | प्रकार | विवरण |
| :- | :- | :- |
| ring | [ICurve](/psd/python-net/aspose.gis.geometries/icurve) | जोड़ने के लिए रिंग। |
...
इंडेक्स द्वारा आंतरिक रिंग प्राप्त करता है।
...
| प्रकार | विवरण |
| :- | :- |
| [ICurve](/psd/python-net/aspose.gis.geometries/icurve) | आंतरिक रिंग। |
...
एक बिंदु खोजता है जो इस वक्र बहुभुज पर होने की गारंटी देता है।

**Returns**

| प्रकार | विवरण |
| :- | :- |
| [IPoint](/psd/python-net/aspose.gis.geometries/ipoint) | इस वक्र बहुभुज पर एक बिंदु। यदि इस वक्र बहुभुज में कोई आंतरिक भाग नहीं है तो एक खाली बिंदु। |
...
| प्रकार | विवरण |
| :- | :- |
| [CurvePolygon](/psd/python-net/aspose.gis.geometries/curvepolygon) | इस ज्यामिति की एक संपादन योग्य प्रति। |
...
| प्रकार | विवरण |
| :- | :- |
| [IPolygon](/psd/python-net/aspose.gis.geometries/ipolygon) | एक [IPolygon](/psd/python-net/aspose.gis.geometries/ipolygon/) जो इस <c>ISurface</c> के बराबर या उसके समतुल्य है।<br/>            यह <DOM Element: class at 0x2a1793609d0>.ISurface.to_linear_geometry()(float) के समतुल्य है जिसमें<br/>            डिफ़ॉल्ट <c>tolerance</c> है। डिफ़ॉल्ट <c>tolerance</c> का मान इस ज्यामिति के [SpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem/) पर निर्भर करता है:<br/>            <ul><br/>            <li> प्रोजेक्टेड SRS के लिए टॉलरेंस 0.001 मीटर (SRS इकाइयों में) है </li><br/>            <li> जियोग्राफिक SRS के लिए टॉलरेंस <c>1e-5</c> डिग्री (SRS इकाइयों में) है </li><br/>            <li> अज्ञात SRS के लिए टॉलरेंस <c>1e-5</c> है </li><br/>            </ul><br/>            लागू किए गए रूपांतरणों के बारे में अधिक विवरण के लिए <DOM Element: class at 0x2a1793609d0>.ISurface.to_linear_geometry()(float) विनिर्देशन देखें। |
...
| प्रकार | विवरण |
| :- | :- |
| [IPolygon](/psd/python-net/aspose.gis.geometries/ipolygon) | एक [IPolygon](/psd/python-net/aspose.gis.geometries/ipolygon/) जो इस <c>ISurface</c> के बराबर या उसके समतुल्य है:<br/>             <ul><br/>             यदि यह वस्तु स्वयं [IPolygon](/psd/python-net/aspose.gis.geometries/ipolygon/) है तो परिणाम इस वस्तु के समान है<br/>             यदि यह वस्तु [IPolygon](/psd/python-net/aspose.gis.geometries/ipolygon/) नहीं है तो इसे रैखिक किया जाता है और [IPolygon](/psd/python-net/aspose.gis.geometries/ipolygon/) बनाया जाता है<br/>            </ul> |
