---
title: "GeometryCollection क्लास"
type: docs
weight: 60
url: /hi/python-net/aspose.gis.geometries/geometrycollection/
---
...
| **नाम** | **विवरण** |
| :- | :- |
| [GeometryCollection()](#GeometryCollection__1) | एक नया उदाहरण प्रारंभ करता है [GeometryCollection](/psd/python-net/aspose.gis.geometries/geometrycollection/) क्लास का। |
## **Properties**
...
| dimension | [GeometryDimension](/psd/python-net/aspose.gis.geometries/geometrydimension) | r | इस [Geometry](/psd/python-net/aspose.gis.geometries/geometry/) की टोपोलॉजिकल आयाम प्राप्त करता है।<br/> यदि संग्रह खाली है, तो [GeometryDimension.POINT](/psd/python-net/aspose.gis.geometries/geometrydimension/) लौटाया जाता है। |
...
एक नया उदाहरण प्रारंभ करता है [GeometryCollection](/psd/python-net/aspose.gis.geometries/geometrycollection/) क्लास का।
...
| प्रकार | विवरण |
| :- | :- |
| [GeometryCollection](/psd/python-net/aspose.gis.geometries/geometrycollection) | इस ज्यामिति की एक संपादन योग्य प्रति। |
...
| प्रकार | विवरण |
| :- | :- |
| [IGeometryCollection](/psd/python-net/aspose.gis.geometries/igeometrycollection) | एक ज्यामिति, जिसमें कोई वक्र ज्यामितियाँ नहीं हैं। यह <DOM Element: class at 0x2a1791cc040>.IGeometryCollection.to_linear_geometry()(float) के समान है डिफ़ॉल्ट <c>tolerance</c> के साथ। डिफ़ॉल्ट <c>tolerance</c> का मान इस ज्यामिति के [SpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem/) पर निर्भर करता है:<br/>            <ul><br/>            <li> प्रोजेक्टेड SRS के लिए टॉलरेंस 0.001 मीटर (SRS इकाइयों में) </li><br/>            <li> भौगोलिक SRS के लिए टॉलरेंस <c>1e-5</c> डिग्री (SRS इकाइयों में) </li><br/>            <li> अज्ञात SRS के लिए टॉलरेंस <c>1e-5</c> </li><br/>            </ul><br/>            लागू किए गए रूपांतरणों के बारे में अधिक विवरण के लिए <DOM Element: class at 0x2a1791cc040>.IGeometryCollection.to_linear_geometry()(float) विनिर्देश देखें। |
