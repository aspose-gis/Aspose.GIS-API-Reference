---
title: "CircularString क्लास"
type: docs
weight: 10
url: /hi/python-net/aspose.gis.geometries/circularstring/
---
...
| **नाम** | **विवरण** |
| :- | :- |
| [CircularString()](#CircularString__1) | एक नया उदाहरण प्रारंभ करता है [CircularString](/psd/python-net/aspose.gis.geometries/circularstring/) क्लास का। |
| [CircularString(collection)](#CircularString_collection_2) | एक नया उदाहरण प्रारंभ करता है [CircularString](/psd/python-net/aspose.gis.geometries/circularstring/) क्लास का। |
| [CircularString(other)](#CircularString_other_3) | एक नया उदाहरण प्रारंभ करता है [CircularString](/psd/python-net/aspose.gis.geometries/circularstring/) क्लास का। |
## **Properties**
...
| **नाम** | **विवरण** |
| :- | :- |
| [add_point(point)](#add_point_point_1) | वृत्ताकार स्ट्रिंग के अंत में एक बिंदु जोड़ता है। |
| [add_point(x, y)](#add_point_x_y_2) | वृत्ताकार स्ट्रिंग के अंत में एक बिंदु जोड़ता है। |
| [add_point(x, y, z)](#add_point_x_y_z_3) | वृत्ताकार स्ट्रिंग के अंत में एक बिंदु जोड़ता है। |
| [add_point(x, y, z, m)](#add_point_x_y_z_m_4) | वृत्ताकार स्ट्रिंग के अंत में एक बिंदु जोड़ता है। |
...
| [overlaps(other)](#overlaps_other_33) | निर्धारित करता है कि यह ज्यामिति निर्दिष्ट ज्यामिति के साथ ओवरलैप करती है या नहीं। |
| [relate(other, intersection_pattern_matrix)](#relate_other_intersection_pattern_matrix_34) | निर्धारित करता है कि इस ज्यामिति और निर्दिष्ट ज्यामिति का DE-9IM प्रतिच्छेद मैट्रिक्स प्रदान किए गए पैटर्न से मेल खाता है या नहीं। |
...
| reverse() | इस [CircularString](/psd/python-net/aspose.gis.geometries/circularstring/) में बिंदुओं का क्रम उलटता है। |
...
एक नया उदाहरण प्रारंभ करता है [CircularString](/psd/python-net/aspose.gis.geometries/circularstring/) क्लास का।
...
| पैरामीटर | प्रकार | विवरण |
| :- | :- | :- |
| other | [ICircularString](/psd/python-net/aspose.gis.geometries/icircularstring) | डेटा कॉपी करने के लिए अन्य स्ट्रिंग। |
...
वृत्ताकार स्ट्रिंग के अंत में एक बिंदु जोड़ता है।
