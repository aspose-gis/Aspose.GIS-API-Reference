---
title: "CompoundCurve क्लास"
type: docs
weight: 20
url: /hi/python-net/aspose.gis.geometries/compoundcurve/
---
...
| **नाम** | **विवरण** |
| :- | :- |
| [CompoundCurve()](#CompoundCurve__1) | नया उदाहरण प्रारंभ करता है [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/) क्लास का। |
| [CompoundCurve(curves)](#CompoundCurve_curves_2) | नया उदाहरण प्रारंभ करता है [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/) क्लास का। |
| [CompoundCurve(other)](#CompoundCurve_other_3) | नया उदाहरण प्रारंभ करता है [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/) क्लास का। |
## **Properties**
...
| count | int | r | [ICompoundCurve](/psd/python-net/aspose.gis.geometries/icompoundcurve/) में वक्रों की संख्या प्राप्त करता है। |
...
| is_closed | bool | r | एक मान प्राप्त करता है जो दर्शाता है कि वक्र बंद है या नहीं।<br/> वक्र तब बंद होता है जब उसका प्रारंभ बिंदु अंत बिंदु के बराबर हो। |
...
| **नाम** | **विवरण** |
| :- | :- |
| [add_curve(curve)](#add_curve_curve_1) | इस [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/) के अंत में एक वक्र जोड़ता है। |
...
| [get_length()](#get_length__26) | इस ज्यामिति की लंबाई गणना करता है। |
| [intersection(other)](#intersection_other_27) | इस ज्यामिति और निर्दिष्ट ज्यामिति के बीच प्रतिच्छेदन बनाता है। |
| [intersects(extent)](#intersects_extent_28) | निर्धारित करता है कि यह ज्यामिति निर्दिष्ट विस्तार को प्रतिच्छेद करती है या नहीं। |
| [intersects(other)](#intersects_other_29) | निर्धारित करता है कि यह ज्यामिति और निर्दिष्ट ज्यामिति प्रतिच्छेद करती हैं या नहीं। |
| [overlaps(other)](#overlaps_other_30) | निर्धारित करता है कि यह ज्यामिति निर्दिष्ट ज्यामिति के साथ ओवरलैप करती है या नहीं। |
| [relate(other, intersection_pattern_matrix)](#relate_other_intersection_pattern_matrix_31) | निर्धारित करता है कि इस ज्यामिति और निर्दिष्ट ज्यामिति का DE-9IM प्रतिच्छेद मैट्रिक्स प्रदान किए गए पैटर्न से मेल खाता है या नहीं। |
| [replace_polygons_by_lines()](#replace_polygons_by_lines__32) | इस ज्यामिति की रेखाओं के रूप में प्रतिनिधित्व किए गए बहुभुज प्राप्त करता है। |
| reverse() | इस [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/) को उल्टा करता है। अर्थात् - वक्रों का क्रम और इस सम्मिलित वक्र के भीतर प्रत्येक वक्र को उलटा करता है। |
| [round_m(digits)](#round_m_digits_33) | M निर्देशांक को निर्दिष्ट दशमलव अंकों की संख्या तक गोल करता है। |
| [round_xy(digits)](#round_xy_digits_34) | X और Y निर्देशांक को निर्दिष्ट दशमलव अंकों की संख्या तक गोल करता है। |
| [round_z(digits)](#round_z_digits_35) | Z निर्देशांक को निर्दिष्ट दशमलव अंकों की संख्या तक गोल करता है। |
| set_empty() | इस [Geometry](/psd/python-net/aspose.gis.geometries/geometry/) को खाली बनाता है। |
| [spatially_contains(other)](#spatially_contains_other_36) | निर्धारित करता है कि यह ज्यामिति स्थानिक रूप से निर्दिष्ट ज्यामिति को शामिल करती है या नहीं। |
| [spatially_equals(other)](#spatially_equals_other_37) | निर्धारित करता है कि यह ज्यामिति स्थानिक रूप से निर्दिष्ट ज्यामिति के बराबर है या नहीं। |
| [sym_difference(other)](#sym_difference_other_38) | इस ज्यामिति और निर्दिष्ट ज्यामिति के बीच सममित अंतर बनाता है। |
| [to_editable()](#to_editable__39) | इस ज्यामिति की एक संपादन योग्य प्रति प्राप्त करता है। |
| [to_linear_geometry()](#to_linear_geometry__40) | डिफ़ॉल्ट <c>tolerance</c> का उपयोग करके इस ज्यामिति का अनुमानित या समतुल्य गैर-वक्र संस्करण प्राप्त करता है। |
| [to_linear_geometry(tolerance)](#to_linear_geometry_tolerance_41) | निर्दिष्ट <c>tolerance</c> का उपयोग करके इस ज्यामिति का अनुमानित या समतुल्य गैर-वक्र संस्करण प्राप्त करता है। |
| [to_svg(extent)](#to_svg_extent_42) | इस ज्यामिति को Svg प्रतिनिधित्व में अनुवादित करता है। |
| [touches(other)](#touches_other_43) | निर्धारित करता है कि यह ज्यामिति और निर्दिष्ट ज्यामिति स्पर्श करती हैं या नहीं। |
| [union(other)](#union_other_44) | इस ज्यामिति और निर्दिष्ट ज्यामिति को मिलाता है। |
| [union(other)](#union_other_45) | इस ज्यामिति और निर्दिष्ट ज्यामिति को मिलाता है। |
| [within(extent)](#within_extent_46) | निर्धारित करता है कि यह ज्यामिति निर्दिष्ट सीमा के भीतर है या नहीं। |
| [within(other)](#within_other_47) | निर्धारित करता है कि यह ज्यामिति निर्दिष्ट ज्यामिति के भीतर है या नहीं। |
...
नया उदाहरण प्रारंभ करता है [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/) क्लास का।
...
| :- | :- | :- |
| वक्र | System.Collections.Generic.IEnumerable<ICurve> | वक्रों का संग्रह। |
...
| पैरामीटर | प्रकार | विवरण |
| :- | :- | :- |
| other | [ICompoundCurve](/psd/python-net/aspose.gis.geometries/icompoundcurve) | डेटा कॉपी करने के लिए दूसरी रेखा। |
...
इस [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve/) के अंत में एक वक्र जोड़ता है।

**Parameters:**

| पैरामीटर | प्रकार | विवरण |
| :- | :- | :- |
| curve | [ICurve](/psd/python-net/aspose.gis.geometries/icurve) | जोड़ने के लिए वक्र। |
...
| प्रकार | विवरण |
| :- | :- |
| [CompoundCurve](/psd/python-net/aspose.gis.geometries/compoundcurve) | इस ज्यामिति की एक संपादन योग्य प्रति। |
