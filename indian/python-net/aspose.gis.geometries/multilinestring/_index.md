---
title: "MultiLineString क्लास"
type: docs
weight: 260
url: /hi/python-net/aspose.gis.geometries/multilinestring/
---
...
| **नाम** | **विवरण** |
| :- | :- |
| [MultiLineString()](#MultiLineString__1) | नए [MultiLineString](/psd/python-net/aspose.gis.geometries/multilinestring/) क्लास का एक नया इंस्टेंस प्रारंभ करता है। |
## **Properties**
...
| spatial_reference_system | [SpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem/) | r/w | इस इंस्टेंस का SpatialReferenceSystem प्राप्त करता है।<br/>            यदि SpatialReferenceSystem अज्ञात है तो यह प्रॉपर्टी <see langword="null" /> हो सकती है। |
## **Methods**
| **नाम** | **विवरण** |
| :- | :- |
...
नए [MultiLineString](/psd/python-net/aspose.gis.geometries/multilinestring/) क्लास का एक नया इंस्टेंस प्रारंभ करता है।
