---
title: "GmlDriver क्लास"
type: docs
weight: 10
url: /hi/python-net/aspose.gis.formats.gml/gmldriver/
---
...
| [create_layer(path, options, spatial_reference_system)](#create_layer_path_options_spatial_reference_system_14) | एक लेयर बनाता है और नई विशेषताएँ जोड़ने के लिए उसे खोलता है। |
...
| [open_layer(path)](#open_layer_path_24) | पढ़ने के लिए लेयर खोलता है। |
...
| [supports_spatial_reference_system(spatial_reference_system)](#supports_spatial_reference_system_spatial_reference_system_29) | निर्धारित करता है कि निर्दिष्ट स्पैशियल रेफ़रेंस सिस्टम ड्राइवर द्वारा समर्थित है या नहीं। |
...
| :- | :- | :- |
| path | string | फ़ाइल का पथ। |
| options | [GmlOptions](/psd/python-net/aspose.gis.formats.gml/gmloptions) | ड्राइवर-विशिष्ट विकल्प। |
