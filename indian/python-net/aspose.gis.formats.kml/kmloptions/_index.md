---
title: "KmlOptions क्लास"
type: docs
weight: 190
url: /hi/python-net/aspose.gis.formats.kml/kmloptions/
---
...
| **नाम** | **विवरण** |
| :- | :- |
| [KmlOptions()](#KmlOptions__1) | नया उदाहरण बनाएं। |
## **Properties**
| **नाम** | **प्रकार** | **पहुँच** | **विवरण** |
| :- | :- | :- | :- |
| altitude_mode | [AltitudeModes](/psd/python-net/aspose.gis.formats.kml/altitudemodes) | r/w | KML ज्योमेट्रीज़ के लिए उपयोग किए जाने वाले AltitudeModes को निर्दिष्ट करने की अनुमति देता है |
...
| document_id | string | r/w | रूट 'Document' नोड की आईडी निर्दिष्ट करने के लिए उपयोग किया जाता है |
...
| symbol_to_replace_invalid_chars | चर | r/w | निर्धारित करता है कि पढ़ने पर अमान्य वर्णों को बदलने के लिए कौन सा प्रतीक उपयोग किया जाएगा।<br/>            यदि मान '\0' है तो प्रतिस्थापन छोड़ दिया जाता है। डिफ़ॉल्ट रूप से मान '\0' अक्षर है। |
