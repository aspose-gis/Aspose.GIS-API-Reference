---
title: "KmlDriver क्लास"
type: docs
weight: 50
url: /hi/python-net/aspose.gis.formats.kml/kmldriver/
---
...
| [open_as_kml_layer(path, options)](#open_as_kml_layer_path_options_18) | पढ़ने के लिए एक Kml लेयर खोलता है। |
...
| :- | :- | :- |
| path | string | फ़ाइल का पथ। |
| options | [KmlOptions](/psd/python-net/aspose.gis.formats.kml/kmloptions) | ड्राइवर-विशिष्ट विकल्प। |
...
पढ़ने के लिए एक Kml लेयर खोलता है।
...
| प्रकार | विवरण |
| :- | :- |
| [KmlLayer](/psd/python-net/aspose.gis.formats.kml/kmllayer) | विशिष्ट फ़ील्ड्स के साथ KmlLayer |
