...
type: docs
weight: 10
url: /hi/python-net/aspose.gis.common.formats.dbase/dbase/
---
...
| :- | :- | :- | :- |
| एन्कोडिंग | System.Text.Encoding | r |  |
| फ़ील्ड्स | System.Collections.Generic.IList<DBaseField> | r |  |
| रिकॉर्ड्स_गणना | लॉन्ग | r |  |
## **Methods**
| **नाम** | **विवरण** |
| :- | :- |
...
| path | [AbstractPathInternal](/psd/python-net/aspose.gis.common/abstractpathinternal) |  |
| options | [DBaseOptions](/psd/python-net/aspose.gis.common.formats.dbase/dbaseoptions) |  |
| एन्कोडिंग | System.Text.Encoding |  |
