---
title: "FileGdbDriver क्लास"
type: docs
weight: 20
url: /hi/python-net/aspose.gis.formats.filegdb/filegdbdriver/
---
...
| [create_dataset(path, options)](#create_dataset_path_options_5) | एक dataset बनाता है। |
| [create_dataset(path, options)](#create_dataset_path_options_6) | एक dataset बनाता है। |
| [create_layer(path)](#create_layer_path_7) | लेयर बनाता है और उसे जोड़ने के लिए खोलता है। |
| [create_layer(path)](#create_layer_path_8) | लेयर बनाता है और उसे जोड़ने के लिए खोलता है। |
...
| [create_layer(path, options)](#create_layer_path_options_11) | एक लेयर बनाता है और नई विशेषताएँ जोड़ने के लिए उसे खोलता है। |
| [create_layer(path, options, spatial_reference_system)](#create_layer_path_options_spatial_reference_system_12) | एक लेयर बनाता है और उसे जोड़ने के लिए खोलता है। |
| [create_layer(path, options, spatial_reference_system)](#create_layer_path_options_spatial_reference_system_13) | एक लेयर बनाता है और उसे जोड़ने के लिए खोलता है। |
| [create_layer(path, options, spatial_reference_system)](#create_layer_path_options_spatial_reference_system_14) | एक लेयर बनाता है और उसे जोड़ने के लिए खोलता है। |
| [create_layer(path, options, spatial_reference_system)](#create_layer_path_options_spatial_reference_system_15) | एक लेयर बनाता है और उसे जोड़ने के लिए खोलता है। |
| [create_layer(path, spatial_reference_system)](#create_layer_path_spatial_reference_system_16) | लेयर बनाता है और उसे जोड़ने के लिए खोलता है। |
| [create_layer(path, spatial_reference_system)](#create_layer_path_spatial_reference_system_17) | लेयर बनाता है और उसे जोड़ने के लिए खोलता है। |
| [edit_layer(path, options)](#edit_layer_path_options_18) | संपादन के लिए एक लेयर खोलता है। |
| [edit_layer(path, options)](#edit_layer_path_options_19) | संपादन के लिए एक लेयर खोलता है। |
| [open_dataset(path)](#open_dataset_path_20) | डेटासेट खोलता है। |
| [open_dataset(path)](#open_dataset_path_21) | डेटासेट खोलता है। |
| [open_dataset(path, options)](#open_dataset_path_options_22) | डेटासेट खोलता है। |
| [open_dataset(path, options)](#open_dataset_path_options_23) | डेटासेट खोलता है। |
| [open_dataset(path, options)](#open_dataset_path_options_24) | डेटासेट खोलता है। |
| [open_dataset(path, options)](#open_dataset_path_options_25) | डेटासेट खोलता है। |
| [open_layer(path)](#open_layer_path_26) | पढ़ने के लिए लेयर खोलता है। |
| [open_layer(path)](#open_layer_path_27) | पढ़ने के लिए लेयर खोलता है। |
| [open_layer(path, options)](#open_layer_path_options_28) | पढ़ने के लिए एक लेयर खोलता है। |
| [open_layer(path, options)](#open_layer_path_options_29) | पढ़ने के लिए एक लेयर खोलता है। |
| [open_layer(path, options)](#open_layer_path_options_30) | पढ़ने के लिए एक लेयर खोलता है। |
| [open_layer(path, options)](#open_layer_path_options_31) | पढ़ने के लिए एक लेयर खोलता है। |
| [supports_spatial_reference_system(spatial_reference_system)](#supports_spatial_reference_system_spatial_reference_system_32) | निर्धारित करता है कि निर्दिष्ट स्पैशियल रेफ़रेंस सिस्टम ड्राइवर द्वारा समर्थित है या नहीं। |
...
| :- | :- | :- |
| path | string | डेटासेट का पथ। |
| options | [FileGdbOptions](/psd/python-net/aspose.gis.formats.filegdb/filegdboptions) | ड्राइवर-विशिष्ट विकल्प। |
...
एक लेयर बनाता है और उसे जोड़ने के लिए खोलता है।
