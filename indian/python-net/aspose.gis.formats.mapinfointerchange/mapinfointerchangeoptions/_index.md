---
title: "MapInfoInterchangeOptions क्लास"
type: docs
weight: 20
url: /hi/python-net/aspose.gis.formats.mapinfointerchange/mapinfointerchangeoptions/
---
...
| **नाम** | **विवरण** |
| :- | :- |
| [MapInfoInterchangeOptions()](#MapInfoInterchangeOptions__1) | नया उदाहरण बनाएं। |
## **Properties**
| **नाम** | **प्रकार** | **पहुँच** | **विवरण** |
| :- | :- | :- | :- |
| charset | string | r/w | charset निर्धारित करता है, डिफ़ॉल्ट रूप से Neutral है। |
...
| delimiter | string | r/w | mid फ़ाइल में गुणों के लिए delimiter निर्धारित करता है, डिफ़ॉल्ट रूप से टैब अक्षर है। |
