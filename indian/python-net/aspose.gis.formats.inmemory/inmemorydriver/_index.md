---
title: "InMemoryDriver क्लास"
type: docs
weight: 10
url: /hi/python-net/aspose.gis.formats.inmemory/inmemorydriver/
---
...
| [create_layer()](#create_layer__5) | एक लेयर बनाता है और नई विशेषताएँ जोड़ने के लिए उसे खोलता है। |
| [create_layer(features_sequence)](#create_layer_features_sequence_6) | फ़ीचर अनुक्रम से एक लेयर बनाता है और नई फ़ीचर जोड़ने के लिए इसे खोलता है। |
...
| [create_layer(path, options)](#create_layer_path_options_9) | लेयर बनाता है और उसे जोड़ने के लिए खोलता है। |
| [create_layer(path, options)](#create_layer_path_options_10) | लेयर बनाता है और उसे जोड़ने के लिए खोलता है। |
...
| [create_layer(path, spatial_reference_system)](#create_layer_path_spatial_reference_system_13) | लेयर बनाता है और उसे जोड़ने के लिए खोलता है। |
...
| [create_layer(spatial_reference_system)](#create_layer_spatial_reference_system_15) | एक लेयर बनाता है और नई विशेषताएँ जोड़ने के लिए उसे खोलता है। |
...
| [supports_spatial_reference_system(spatial_reference_system)](#supports_spatial_reference_system_spatial_reference_system_26) | निर्धारित करता है कि निर्दिष्ट स्पैशियल रेफ़रेंस सिस्टम ड्राइवर द्वारा समर्थित है या नहीं। |
...
फ़ीचर अनुक्रम से एक लेयर बनाता है और नई फ़ीचर जोड़ने के लिए इसे खोलता है।
