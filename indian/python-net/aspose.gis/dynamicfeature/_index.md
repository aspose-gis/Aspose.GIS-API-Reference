---
title: "DynamicFeature क्लास"
type: docs
weight: 650
url: /hi/python-net/aspose.gis/dynamicfeature/
---
...
| [get_as_node()](#get_as_node__2) | फ़ीचर को नोड के रूप में प्राप्त करता है। यह कस्टम डेटा के लिए उपयोगी हो सकता है। |
| [get_value(attribute_name)](#get_value_attribute_name_3) | किसी गुण का मान प्राप्त करता है। |
| [get_value_or_default(attribute_name, default_value)](#get_value_or_default_attribute_name_default_value_4) | किसी गुण का मान प्राप्त करता है, या यदि मान सेट नहीं है या <c>null</c> है तो [FeatureAttribute.default_value](/psd/python-net/aspose.gis/featureattribute/) लौटाता है। |
| [get_values(values, default_value)](#get_values_values_default_value_5) | एक एरे में सभी गुणों के मान लौटाता है। |
| [get_values(values_count, default_value)](#get_values_values_count_default_value_6) | एक एरे में सभी गुणों के मान लौटाता है। |
| [get_values_dump(default_value)](#get_values_dump_default_value_7) | एक एरे में सभी एट्रिब्यूट्स के मान लौटाता है।<br/>            अतिरिक्त मेमोरी आवंटन से बचने के लिए Aspose.Gis.DynamicFeature.GetValues(System.Object,System.Object) मेथड का उपयोग करने पर विचार करें। |
| [get_values_list(attribute_name, separator, count)](#get_values_list_attribute_name_separator_count_8) | एट्रिब्यूट अनुक्रम के मानों को सूची के रूप में प्राप्त करता है। |
| [is_value_null(attribute_name)](#is_value_null_attribute_name_9) | निर्धारित करता है कि निर्दिष्ट विशेषता को स्पष्ट रूप से <c>null</c> मान पर सेट किया गया है या नहीं। |
| [is_value_set(attribute_name)](#is_value_set_attribute_name_10) | जाँचता है कि इस फीचर में विशेषता मान सेट है या नहीं। |
| [set_value(attribute_name, value)](#set_value_attribute_name_value_11) | एट्रिब्यूट का नया मान सेट करता है। |
| [set_value_null(attribute_name)](#set_value_null_attribute_name_12) | विशेषता का मान <c>null</c> पर सेट करता है। |
| [set_values(values)](#set_values_values_13) | सभी एट्रिब्यूट्स के नए मान सेट करता है।<br/>            एक कॉल में मान सेट करने को सरल बनाने के लिए [DynamicFeature.copy_values(input_feature)](/psd/python-net/aspose.gis/dynamicfeature/) मेथड का उपयोग करने पर भी विचार करें। |
| [unset_value(attribute_name)](#unset_value_attribute_name_14) | इस फीचर से विशेषता मान को हटाता है। |
...
फ़ीचर को नोड के रूप में प्राप्त करता है। यह कस्टम डेटा के लिए उपयोगी हो सकता है।

**Returns**

| प्रकार | विवरण |
| :- | :- |
| [NodeLink](/psd/python-net/aspose.gis/nodelink) | फ़ीचर के लिए NodeLink |
...
| पैरामीटर | प्रकार | विवरण |
| :- | :- | :- |
| मान | object | एट्रिब्यूट मानों को कॉपी करने के लिए एरे। |
...
एक एरे में सभी एट्रिब्यूट्स के मान लौटाता है।<br/>            अतिरिक्त मेमोरी आवंटन से बचने के लिए Aspose.Gis.DynamicFeature.GetValues(System.Object,System.Object) मेथड का उपयोग करने पर विचार करें।
...
एट्रिब्यूट अनुक्रम के मानों को सूची के रूप में प्राप्त करता है।
...
एट्रिब्यूट का नया मान सेट करता है।
...
सभी एट्रिब्यूट्स के नए मान सेट करता है।<br/>            एक कॉल में मान सेट करने को सरल बनाने के लिए [DynamicFeature.copy_values(input_feature)](/psd/python-net/aspose.gis/dynamicfeature/) मेथड का उपयोग करने पर भी विचार करें।
