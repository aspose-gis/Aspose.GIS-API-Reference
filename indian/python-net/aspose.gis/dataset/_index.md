...
type: docs
weight: 590
url: /hi/python-net/aspose.gis/dataset/
---
...
| driver | [Driver](/psd/python-net/aspose.gis/driver) | r | इस डेटासेट को इंस्टैंशिएट करने वाले [Dataset.driver](/psd/python-net/aspose.gis/dataset/) को प्राप्त करता है। |
...
| [edit_layer(name, options, spatial_reference_system)](#edit_layer_name_options_spatial_reference_system_10) | निर्दिष्ट नाम वाले लेयर को संपादन के लिए खोलता है। |
| [edit_layer_at(index, options, spatial_reference_system)](#edit_layer_at_index_options_spatial_reference_system_11) | निर्दिष्ट नाम वाले लेयर को संपादन के लिए खोलता है। |
| [get_layer_name(index)](#get_layer_name_index_12) | निर्दिष्ट सूचकांक पर लेयर का नाम प्राप्त करता है। |
| [has_layer_with_name(name)](#has_layer_with_name_name_13) | जाँचें कि वर्तमान डेटासेट में विशिष्ट नाम वाला लेयर है या नहीं |
| [open(path, driver)](#open_path_driver_14) | डेटासेट खोलता है। |
| [open(path, driver)](#open_path_driver_15) | डेटासेट खोलता है। |
| [open(path, driver, options)](#open_path_driver_options_16) | डेटासेट खोलता है। |
| [open(path, driver, options)](#open_path_driver_options_17) | डेटासेट खोलता है। |
| [open_layer(name, options)](#open_layer_name_options_18) | निर्दिष्ट नाम वाले लेयर को पढ़ने के लिए खोलता है। |
| [open_layer_at(index, options)](#open_layer_at_index_options_19) | निर्दिष्ट सूचकांक पर लेयर को पढ़ने के लिए खोलता है। |
| [remove_layer(name)](#remove_layer_name_20) | निर्दिष्ट नाम वाले वेक्टर लेयर को हटाता है। |
| [remove_layer_at(index)](#remove_layer_at_index_21) | निर्दिष्ट सूचकांक पर वेक्टर लेयर को हटाता है। |
| [rename_layer(current_name, new_name)](#rename_layer_current_name_new_name_22) | डेटासेट में लेयर का नाम बदलें |
...
निर्दिष्ट नाम वाले लेयर को संपादन के लिए खोलता है।
...
| प्रकार | विवरण |
| :- | :- |
| [VectorLayer](/psd/python-net/aspose.gis/vectorlayer) | संपादन के लिए खोला गया लेयर। |
