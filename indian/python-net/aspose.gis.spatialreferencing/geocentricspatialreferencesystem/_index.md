---
title: "GeocentricSpatialReferenceSystem क्लास"
type: docs
weight: 50
url: /hi/python-net/aspose.gis.spatialreferencing/geocentricspatialreferencesystem/
---
...
| as_geocentric | [GeocentricSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/geocentricspatialreferencesystem) | r | इसे लौटाएँ। |
...
| axises_order | [GeocentricAxisesOrder](/psd/python-net/aspose.gis.spatialreferencing/geocentricaxisesorder) | r | इस SRS में अक्षों का क्रम।<br/>            यदि यह SRS मान्य नहीं है और अक्षों की दिशा गलत है, तो [GeocentricAxisesOrder.INVALID](/psd/python-net/aspose.gis.spatialreferencing/geocentricaxisesorder/) लौटाया जाता है। |
| dimensions_count | इंट | r | 3 लौटाएँ, क्योंकि जियोसेंट्रिक SRS हमेशा त्रि-आयामी होता है। |
...
| geographic_datum | [GeographicDatum](/psd/python-net/aspose.gis.spatialreferencing/geographicdatum) | r | इस SRS का भौगोलिक डेटम लौटाएँ। |
| has_geographic_datum | bool | r | जियोसेंट्रिक SRS हमेशा भौगोलिक डेटम रखता है, इसलिए <see langword=\"true\" /> लौटाएँ। |
| has_prime_meridian | bool | r | जियोसेंट्रिक SRS हमेशा प्रमुख मेरिडियन रखता है, इसलिए <see langword=\"true\" /> लौटाएँ। |
...
| linear_unit | [Unit](/psd/python-net/aspose.gis.spatialreferencing/unit) | r | इकाई, जो इस SRS में उपयोग होती है। |
...
| prime_meridian | [PrimeMeridian](/psd/python-net/aspose.gis.spatialreferencing/primemeridian) | r | इस SRS का प्रमुख मेरिडियन लौटाएँ। |
| type | [SpatialReferenceSystemType](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype) | r | लौटाएँ [SpatialReferenceSystemType.GEOCENTRIC](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/)। |
