---
title: "ProjectedSpatialReferenceSystem क्लास"
type: docs
weight: 150
url: /hi/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/
---
...
| as_local | [LocalSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/localspatialreferencesystem) | r | इस SRS को [LocalSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/localspatialreferencesystem/) में परिवर्तित करता है। परिवर्तन संभव है या नहीं, यह जानने के लिए [SpatialReferenceSystem.type](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem/) का उपयोग करें। |
| as_projected | [ProjectedSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem) | r | इसे लौटाएँ। |
...
| axises_order | [ProjectedAxisesOrder](/psd/python-net/aspose.gis.spatialreferencing/projectedaxisesorder) | r | इस SRS में अक्षों का क्रम।<br/>            यदि यह SRS मान्य नहीं है और अक्षों की दिशाएँ गलत हैं, तो [ProjectedAxisesOrder.INVALID](/psd/python-net/aspose.gis.spatialreferencing/projectedaxisesorder/) लौटाया जाता है। |
| base | [GeographicSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/geographicspatialreferencesystem) | r | इस SRS को प्राप्त करने के लिए लागू की गई [ProjectedSpatialReferenceSystem.projection](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/) का भौगोलिक SRS। |
| dimensions_count | इंट | r | इस SRS में आयामों की संख्या लौटाता है। प्रोजेक्टेड SRS के लिए यह हो सकता है:<br/>            दो - यदि यह एकल प्रोजेक्टेड SRS है।<br/>            तीन - यदि यह संयुक्त SRS है, जिसमें एकल, दो‑आयामी, प्रोजेक्टेड SRS और वर्टिकल SRS शामिल हैं, जो तीसरा आयाम जोड़ता है। |
...
| geographic_datum | [GeographicDatum](/psd/python-net/aspose.gis.spatialreferencing/geographicdatum) | r | इस SRS का भौगोलिक डेटम लौटाता है। |
| has_geographic_datum | bool | r | सही (true) लौटाता है, क्योंकि प्रोजेक्टेड SRS में हमेशा प्रधान मेरिडियन होता है। |
| has_prime_meridian | bool | r | सही (true) लौटाता है, क्योंकि प्रोजेक्टेड SRS में हमेशा प्रधान मेरिडियन होता है। |
...
| linear_unit | [Unit](/psd/python-net/aspose.gis.spatialreferencing/unit) | r | इकाई, जो इस SRS में रैखिक आयामों और [ProjectedSpatialReferenceSystem.projection](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/) के रैखिक पैरामीटरों के लिए उपयोग की जाती है। |
...
| prime_meridian | [PrimeMeridian](/psd/python-net/aspose.gis.spatialreferencing/primemeridian) | r | इस SRS का प्रधान मेरिडियन लौटाता है। |
| projection | [Projection](/psd/python-net/aspose.gis.spatialreferencing/projection) | r | प्रोजेक्शन, जो इस SRS को प्राप्त करने के लिए [ProjectedSpatialReferenceSystem.base](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem/) पर लागू किया गया था। |
| type | [SpatialReferenceSystemType](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype) | r | वापस करता है [SpatialReferenceSystemType.PROJECTED](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/). |
...
| [get_unit(dimension)](#get_unit_dimension_12) | आयाम की [Unit](/psd/python-net/aspose.gis.spatialreferencing/unit/) प्राप्त करें। |
...
| [validate(error_message)](#validate_error_message_18) | निर्धारित करें कि यह SRS वैध है या नहीं। |
...
आयाम की [Unit](/psd/python-net/aspose.gis.spatialreferencing/unit/) प्राप्त करें।
...
निर्धारित करें कि यह SRS वैध है या नहीं।

**Parameters:**

| पैरामीटर | प्रकार | विवरण |
| :- | :- | :- |
| error_message | String | यदि मेथड <see langword=\"false\" /> लौटाता है, तो यह अमान्यता का विवरण है। |

**Returns**

| प्रकार | विवरण |
| :- | :- |
| bool | <see langword=\"true\" /> यदि SRS मान्य है, अन्यथा <see langword=\"false\" />। |
