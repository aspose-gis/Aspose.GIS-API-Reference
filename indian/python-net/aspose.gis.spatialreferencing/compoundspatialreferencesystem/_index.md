---
title: "CompoundSpatialReferenceSystem वर्ग"
type: docs
weight: 30
url: /hi/python-net/aspose.gis.spatialreferencing/compoundspatialreferencesystem/
---
...
| :- | :- | :- | :- |
| as_compound | [CompoundSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/compoundspatialreferencesystem) | r | इसे लौटाएँ। |
...
| as_geographic | [GeographicSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/geographicspatialreferencesystem) | r | इस SRS का भौगोलिक प्रतिनिधित्व लौटाएँ। यदि यह संयुक्त SRS वास्तव में एक भौगोलिक SRS का प्रतिनिधित्व करता है, तो परिणाम होगा<br/> तीन आयामी भौगोलिक SRS (लॉन्गिट्यूड, लैटिट्यूड, ऊँचाई आयामों के साथ)। अन्यथा एक अपवाद फेंका जाएगा। |
...
| as_projected | [ProjectedSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/projectedspatialreferencesystem) | r | इस SRS का प्रोजेक्टेड प्रतिनिधित्व लौटाएँ। यदि यह संयुक्त SRS वास्तव में एक प्रोजेक्टेड SRS का प्रतिनिधित्व करता है, तो परिणाम होगा<br/> तीन आयामी प्रोजेक्टेड SRS (X, Y, ऊँचाई आयामों के साथ)। अन्यथा एक अपवाद फेंका जाएगा। |
...
| dimensions_count | इंट | r | आयामों की संख्या। संयुक्त SRS के लिए यह अंतर्निहित SRS के आयामों की संख्या का योग है। |
...
| geographic_datum | [GeographicDatum](/psd/python-net/aspose.gis.spatialreferencing/geographicdatum) | r | इस SRS का भौगोलिक डेटा लौटाएँ।<br/>            यदि दोनों [CompoundSpatialReferenceSystem.head](/psd/python-net/aspose.gis.spatialreferencing/compoundspatialreferencesystem/) और [CompoundSpatialReferenceSystem.tail](/psd/python-net/aspose.gis.spatialreferencing/compoundspatialreferencesystem/) के पास भौगोलिक डेटा है - हेड का भौगोलिक डेटा लौटाएँ। |
| has_geographic_datum | bool | r | यदि किसी भी अंतर्निहित SRS के पास भौगोलिक डेटा है तो संयुक्त SRS के पास भौगोलिक डेटा होता है। |
| has_prime_meridian | bool | r | यदि किसी भी अंतर्निहित SRS के पास प्रमुख मेरिडियन है तो संयुक्त SRS के पास प्रमुख मेरिडियन होता है। |
| head | [SpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem) | r | पहला अंतर्निहित SRS। |
| identifier | [Identifier](/psd/python-net/aspose.gis.spatialreferencing/identifier) | r | इस पहचाने जाने योग्य वस्तु का पहचानकर्ता। |
| is_compound | bool | r | वापस देता है <see langword="true" />। |
...
| prime_meridian | [PrimeMeridian](/psd/python-net/aspose.gis.spatialreferencing/primemeridian) | r | इस SRS का प्रमुख मेरिडियन लौटाएँ।<br/>            यदि दोनों [CompoundSpatialReferenceSystem.head](/psd/python-net/aspose.gis.spatialreferencing/compoundspatialreferencesystem/) और [CompoundSpatialReferenceSystem.tail](/psd/python-net/aspose.gis.spatialreferencing/compoundspatialreferencesystem/) के पास प्रमुख मेरिडियन है - तो हेड का प्रमुख मेरिडियन लौटाएँ। |
| tail | [SpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystem) | r | दूसरा अंतर्निहित SRS। |
| type | [SpatialReferenceSystemType](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype) | r | इस संयुक्त SRS का प्रकार। यह [SpatialReferenceSystemType.GEOGRAPHIC](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/) हो सकता है यदि<br/>            यह संयुक्त SRS भौगोलिक और ऊर्ध्वाधर SRS का संयोजन है, या [SpatialReferenceSystemType.PROJECTED](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/) यदि<br/>            यह संयुक्त SRS प्रोजेक्टेड और ऊर्ध्वाधर SRS का संयोजन है। |
