---
title: "GeographicSpatialReferenceSystem वर्ग"
type: docs
weight: 80
url: /hi/python-net/aspose.gis.spatialreferencing/geographicspatialreferencesystem/
---
...
| :- | :- | :- | :- |
| angular_unit | [Unit](/psd/python-net/aspose.gis.spatialreferencing/unit) | r | इकाई, जो इस SRS में कोणीय आयामों के लिए उपयोग की जाती है। |
...
| as_geographic | [GeographicSpatialReferenceSystem](/psd/python-net/aspose.gis.spatialreferencing/geographicspatialreferencesystem) | r | यह लौटाता है। |
...
| axises_order | [GeographicAxisesOrder](/psd/python-net/aspose.gis.spatialreferencing/geographicaxisesorder) | r | इस SRS में अक्षों का क्रम।<br/> यदि यह SRS मान्य नहीं है और अक्षों की दिशाएँ गलत हैं, तो [GeographicAxisesOrder.INVALID](/psd/python-net/aspose.gis.spatialreferencing/geographicaxisesorder/) लौटाया जाता है। |
| dimensions_count | इंट | r | इस SRS में आयामों की गिनती लौटाता है। भौगोलिक SRS के लिए यह हो सकता है:<br/> दो - यदि यह एकल भौगोलिक SRS है।<br/> तीन - यदि यह संयुक्त SRS है, जिसमें एकल दो‑आयामी भौगोलिक SRS और ऊर्ध्वाधर SRS शामिल है, जो तीसरा आयाम जोड़ता है। |
...
| has_geographic_datum | bool | r | <see langword=\"true\" /> लौटाता है, क्योंकि भौगोलिक SRS में हमेशा प्रधान मेरिडियन होता है। |
| has_prime_meridian | bool | r | <see langword=\"true\" /> लौटाता है, क्योंकि भौगोलिक SRS में हमेशा प्रधान मेरिडियन होता है। |
...
| type | [SpatialReferenceSystemType](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype) | r | [SpatialReferenceSystemType.GEOGRAPHIC](/psd/python-net/aspose.gis.spatialreferencing/spatialreferencesystemtype/) लौटाता है। |
