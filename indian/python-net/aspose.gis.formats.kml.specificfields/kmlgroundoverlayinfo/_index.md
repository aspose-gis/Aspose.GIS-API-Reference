---
title: "KmlGroundOverlayInfo क्लास"
type: docs
weight: 20
url: /hi/python-net/aspose.gis.formats.kml.specificfields/kmlgroundoverlayinfo/
---
...
| draw_order | double | r/w | 'GroundOverlay' नोड का DrawOrder। |
| icon | [IconInfo](/psd/python-net/aspose.gis.formats.kml.specificfields/iconinfo) | r/w | 'GroundOverlay' नोड का IconPath। |
| lat_lon_box | [KmlLatLonBox](/psd/python-net/aspose.gis.formats.kml.specificfields/kmllatlonbox) | r/w | Kml 'LatLonAltBox' नोड से वस्तु निर्दिष्ट करता है। |
| नाम | string | r/w | Ground Overlay का नाम |
...
| visibility | bool | r/w | Ground Overlay की Visibility |
## **Methods**
| **नाम** | **विवरण** |
| :- | :- |
