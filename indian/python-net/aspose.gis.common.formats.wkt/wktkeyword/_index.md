---
title: "WktKeyword क्लास"
type: docs
weight: 30
url: /hi/python-net/aspose.gis.common.formats.wkt/wktkeyword/
---
...
**Full Name:** aspose.gis.common.formats.wkt.WktKeyword
...
| **नाम** | **विवरण** |
| :- | :- |
| [WktKeyword(value)](#WktKeyword_value_1) | WktKeyword क्लास का एक नया उदाहरण प्रारंभ करता है |
## **Properties**
...
| [to_string()](#to_string__3) |    |


### Constructor: WktKeyword(value) {#WktKeyword_value_1}
...
WktKeyword क्लास का एक नया उदाहरण प्रारंभ करता है
...
### Method: get_hash_code() {#get_hash_code__2}
